...
Важно: дистрибутивы релизов собираются на Visual Studio 7.10. Связано это с тем, что при попытке
...
Решение содержит 6 конфигураций:
...
\subsection{SString}
Основной класс для представления multibyte-строк в системе.
