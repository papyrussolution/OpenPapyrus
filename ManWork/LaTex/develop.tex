...
\begin{description}
	...
	https://www.agner.org
	\item[zlib] Версия 1.2.11. Библиотека сжатия данных. https://zlib.net
	\item[cairo] Версия 1.16.0. Библиотека векторной 2D-графики. https://www.cairographics.org
...
\begin{description}
	\item[PPOBJ\_CONFIG] ObjID=1      class PPObjSecur              
	Конфигурация системы
	\item[PPOBJ\_STATUS] ObjID=2      class PPObjSecur              
	Текущее состояние
	\item[PPOBJ\_USRGRP] ObjID=3      class PPObjSecur              
	Группы пользователей
	\item[PPOBJ\_USR] ObjID=4      class PPObjSecur              
	Пользователи
	\item[PPOBJ\_UNIT] ObjID=5      class PPObjUnit               
	Единицы измерения
	\item[PPOBJ\_CURRATE] ObjID=6      class PPObjCurRateType        
	Типы валютных курсов      
	\item[PPOBJ\_CITYSTATUS] ObjID=7      class PPObjWorldObjStatus     
	Статусы населенных пунктов        
	\item[PPOBJ\_PRSNKIND] ObjID=8      class PPObjPersonKind         
	Виды персоналий       
	\item[PPOBJ\_PRSNSTATUS] ObjID=9      class PPObjPersonStatus       
	Юридические статусы персоналий        
	\item[PPOBJ\_STAFFRANK] ObjID=10     class PPObjReference          
	\item[PPOBJ\_OPRTYPE] ObjID=11     class PPObjOprType            
	Типы операций
	\item[PPOBJ\_OPRKIND] ObjID=12     class PPObjOprKind            
	Виды операций       
	\item[PPOBJ\_ACCSHEET] ObjID=13     class PPObjAccSheet           
	Таблицы аналитических статей        
	\item[PPOBJ\_BNKACCTYPE] ObjID=14     class PPObjReference          
	Типы банковских счетов
	\item[PPOBJ\_PRICETYPE] ObjID=15     сlass PPObjReference          unused 
	Типы цен 
	\item[PPOBJ\_AMOUNTTYPE] ObjID=16     class PPObjAmountType         
