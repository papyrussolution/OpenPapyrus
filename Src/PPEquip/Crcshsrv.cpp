...
private:
	...
	int    SearchNearest(long tabNum, LDATE dt, uint * pPos = 0) const;
	int    Insert(const CashierEntry * pEntry, uint * pPos = 0)
	{
...
int CashiersArray::SearchNearest(long tabNum, LDATE dt, uint * pPos) const
{
	int    is_found = 0;
	long   tab_num  = tabNum;
