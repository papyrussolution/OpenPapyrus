...
private:
	...
	enum {
		...
		fCheckCreditLim    = 0x0080, // @v7.1.6 Вид операции, возможно, требует проверки кредитного лимита
		fCheckRetLim       = 0x0100  // @v7.1.6 Вид операции, возможно, требует проверки лимита возвратов
	};
	long   Flags;
