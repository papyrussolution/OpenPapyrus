...
SLAPI PPConfigDatabase::CObjTbl::CObjTbl(BDbDatabase * pDb) : BDbTable(BDbTable::Config("ppconfig.db->cobj", BDbTable::idxtypHash, 0), pDb)
{
	SeqID = 0;
	//
	// Индекс по идент
	...
	new BDbTable(BDbTable::Config("ppconfig.db->cobj_idx01", BDbTable::idxtypHash, 0), pDb, new Idx01, this);
	new BDbTable(BDbTable::Config("ppconfig.db->cobj_idx02", BDbTable::idxtypHash, cfDup), pDb, new Idx02, this);
	if(P_Db)
...
SLAPI PPConfigDatabase::CObjTailTbl::CObjTailTbl(BDbDatabase * pDb) : BDbTable(BDbTable::Config("ppconfig.db->cobjtail", BDbTable::idxtypHash, 0), pDb)
{
}
