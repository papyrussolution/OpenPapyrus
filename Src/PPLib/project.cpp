// PROJECT.CPP
// Copyright (c) A.Sobolev 2003, 2004, 2005, 2006, 2007, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025, 2026
// @codepage UTF-8
//
#include <pp.h>
#pragma hdrstop
...
int PPObjPrjTask::Browse(void * extraPtr) { return ViewPrjTask(0); }
int PPObjPrjTask::DeleteObj(PPID id) { return PutPacket(&id, static_cast<PPPrjTaskPacket *>(0), 0); }
