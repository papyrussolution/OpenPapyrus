// V_GDSMOV.CPP
// Copyright (c) A.Sobolev, A.Starodub 2000, 2001, 2002, 2003, 2004, 2005, 2006, 2007, 2008, 2008, 2009, 2010, 2011, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2024, 2025, 2026
//
#include <pp.h>
#pragma hdrstop
...
bool GoodsMovTotal::IsEmpty() const
{
...
/*virtual*/void PPViewGoodsMov::ViewTotal()
{
	...
	if(ok == -2) {
		...
		switch(ppvCmd) {
			case PPVCMD_ADDTOBASKET:
				AddGoodsToBasket(id, Filt.LocList.GetSingle(), 0.0, 0.0);
				break;
