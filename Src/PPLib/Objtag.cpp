	...
	public:
		explicit SelectObjTagTypeDialog(const ObjTagFilt * pObjTagF) : TDialog(DLG_OBJTAGTYP), P_ObjTypeList(0)
		{
			...
			TagObjTypeList.addzlist(PPOBJ_PERSON, PPOBJ_GOODS, PPOBJ_BILL, PPOBJ_LOT, PPOBJ_WORKBOOK,
				...
				PPOBJ_PROJECT, PPOBJ_LOCATION, PPOBJ_PRJTASK, 0); 
			// @v11.2.12 PPOBJ_TRANSPORT, PPOBJ_BRAND // @v11.7.2 PPOBJ_PROCESSOR // @v12.2.6 PPOBJ_PROJECT // @v12.2.10 PPOBJ_LOCATION // @v12.5.2 PPOBJ_PRJTASK
		}
		DECL_DIALOG_SETDTS()
		{
	...
	private:
		...
		void   SetupTagObjType()
		{
			LinkObjTypeList.addzlist(PPOBJ_QCERT, PPOBJ_PERSON, PPOBJ_QUOTKIND, PPOBJ_GLOBALUSERACC, 
				PPOBJ_TAXSYSTEMKIND, PPOBJ_INTERNETACCOUNT, PPOBJ_TRANSPORT, PPOBJ_TAG, PPOBJ_WORLD, PPOBJ_ACCOUNT2, PPOBJ_GOODSTAX, PPOBJ_LOCATION, 
				PPOBJ_PRJTASK, 0); 
			// @v11.2.9 PPOBJ_WORLD // @v12.1.3 PPOBJ_ACCOUNT2 // @v12.1.12 PPOBJ_GOODSTAX // @v12.2.10 PPOBJ_LOCATION // @v12.5.2 PPOBJ_PRJTASK
