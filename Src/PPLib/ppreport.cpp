...
int CrystalReportPrint2_ClientExecution(CrystalReportPrintParamBlock & rBlk, CrystalReportPrintReply & rReply)
{
	...
	const  bool   force_ext_process = LOGIC(CConfig.Flags2__ & CCFLG2_FORCE_CRR32_SUPPORT_SERVER);
	const  bool   use_ext_process = ((force_ext_process || SlDebugMode::CT()) && !(CConfig.Flags2__ & CCFLG2_DISABLE_CRR32_SUPPORT_SERVER));
