// OBJBSKT.CPP
// Copyright (c) A.Sobolev 2003, 2004, 2005, 2007, 2008, 2009, 2010, 2011, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025, 2026
// @codepage UTF-8
//
#include <pp.h>
#pragma hdrstop
...
/*virtual*/void * PPObjGoodsBasket::CreateObjListWin(uint flags, void * extraPtr)
{
	...
	return new PPObjGoodsBasketListWindow(this, flags, extraPtr);
}
//
//
//
...
int SelBasketParam::StoreInReg(const char * pName) const
{
	...
	if(!isempty(pName)) {
		SString temp_buf;
		WinRegKey reg_key(HKEY_CURRENT_USER, PPConst::WrKey_PrefBasketSelSettings, 0);
		StringSet ss(';', 0);
...
int SelBasketParam::RestoreFromReg(const char * pName)
{
	...
	if(!isempty(pName)) {
		SString temp_buf;
		WinRegKey reg_key(HKEY_CURRENT_USER, PPConst::WrKey_PrefBasketSelSettings, 1);
