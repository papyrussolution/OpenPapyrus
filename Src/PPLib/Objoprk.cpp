		...
		switch(P_Data->Rec.OpTypeID) {
			case PPOPT_ACCTURN:
				subtypelist.addzlist((long)OPSUBT_COMMON, OPSUBT_ADVANCEREP, OPSUBT_REGISTER,
					OPSUBT_WARRANT, OPSUBT_DEBTINVENT, OPSUBT_ACCWROFF, 0L);
			...
			case PPOPT_GOODSEXPEND:
				...
				ext_options_list.addzlist(OPKFX_ALLOWPARTSTR, OPKFX_RESTRICTPRICE, OPKFX_CANBEDECLINED, 0L); // @v8.9.6 OPKFX_CANBEDECLINED
			...
			case PPOPT_GOODSRECEIPT:
				...
				ext_options_list.addzlist(OPKFX_ALLOWPARTSTR, OPKFX_RESTRICTPRICE, OPKFX_UNLINKRET, OPKFX_DLVRLOCASWH, 0L); // @v9.1.10 OPKFX_DLVRLOCASWH
			...
			case PPOPT_GOODSMODIF:
				...
				options_list.addzlist(OPKF_PROFITABLE, OPKF_CALCSTAXES, OPKF_AUTOWL, OPKF_USEPAYER, OPKF_NOCALCTIORD,
					OPKF_ATTACHFILES, OPKF_RESTRICTBYMTX, 0L);
				ext_options_list.addzlist(OPKFX_DSBLHALFMODIF, OPKFX_SOURCESERIAL, 0L); // @v9.0.0 // @v9.3.6 OPKFX_SOURCESERIAL
			...
			case PPOPT_GOODSRETURN:
				options_list.addzlist(OPKF_PROFITABLE, OPKF_CALCSTAXES, OPKF_AUTOWL, OPKF_FREIGHT, OPKF_NOUPDLOTREST,
					OPKF_ATTACHFILES, OPKF_RESTRICTBYMTX, 0L);
				ext_options_list.addzlist(OPKFX_ALLOWPARTSTR, OPKFX_RESTRICTPRICE, OPKFX_CANBEDECLINED, 0L); // @v9.2.0
			...
			case PPOPT_DRAFTEXPEND:
				...
				ext_options_list.addzlist(OPKFX_ALLOWPARTSTR, OPKFX_RESTRICTPRICE, OPKFX_CANBEDECLINED, 0L); // @v8.3.3 OPKFX_CANBEDECLINED
...
{
	PPOprKind op_rec;
	return (opID && GetOpData(opID, &op_rec)) ? ((rBuf = op_rec.Name), 1) : ((rBuf = 0), 0);
}
