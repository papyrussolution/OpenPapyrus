			...
			if(p_src_pack) {
					...
					if(p_item) {
						...
						for(k = 0; k < p_item->Amounts.getCount(); k++) {
							...
							if(p_src_amt) {
								...
								p_new_amt->NET_USCOREPR = GetDynamicParamString_(p_src_amt->NetPrice, MKSFMTD(0, 12, NMBF_DECCOMMA|NMBF_NOTRAILZ), arg_str_pool);
								p_new_amt->GROSS_USCOREPR = GetDynamicParamString_(p_src_amt->GrossPrice, MKSFMTD(0, 12, NMBF_DECCOMMA|NMBF_NOTRAILZ), arg_str_pool);
								p_new_amt->NET_USCORESUM = GetDynamicParamString_(p_src_amt->NetSum, MKSFMTD(0, 12, NMBF_DECCOMMA|NMBF_NOTRAILZ), arg_str_pool);
								p_new_amt->DISCOUNT_USCOREAMOUNT = GetDynamicParamString_(p_src_amt->DiscAmount, MKSFMTD(0, 12, NMBF_DECCOMMA|NMBF_NOTRAILZ), arg_str_pool);
								p_new_amt->DISC_USCORENET_USCORESUM = GetDynamicParamString_(p_src_amt->DiscNetSum, MKSFMTD(0, 12, NMBF_DECCOMMA|NMBF_NOTRAILZ), arg_str_pool);
								p_new_amt->VAT_USCORESUM = GetDynamicParamString_(p_src_amt->VatSum, MKSFMTD(0, 12, NMBF_DECCOMMA|NMBF_NOTRAILZ), arg_str_pool);
								p_new_amt->GROSS_USCORESUM = GetDynamicParamString_(p_src_amt->GrossSum, MKSFMTD(0, 12, NMBF_DECCOMMA|NMBF_NOTRAILZ), arg_str_pool);
								p_new_amt->DISC_USCOREGR_USCOREAMOUNT = GetDynamicParamString_(p_src_amt->DiscGrossSum, MKSFMTD(0, 12, NMBF_DECCOMMA|NMBF_NOTRAILZ), arg_str_pool);
							}
						}
						{
				...
				for(j = 0; j < p_src_pack->Amounts.getCount(); j++) {
					...
					if(p_src_amt) {
						...
						THROW(p_new_amt);
						p_new_amt->SET_USCORETYPE = GetDynamicParamString(p_src_amt->SetType, arg_str_pool);
						p_new_amt->NET = GetDynamicParamString_(p_src_amt->NetSum, MKSFMTD(0, 12, NMBF_DECCOMMA|NMBF_NOTRAILZ), arg_str_pool);
						p_new_amt->DISC_USCORESUM = GetDynamicParamString_(p_src_amt->DiscNetSum, MKSFMTD(0, 12, NMBF_DECCOMMA|NMBF_NOTRAILZ), arg_str_pool);
						p_new_amt->VAT = GetDynamicParamString_(p_src_amt->VatSum, MKSFMTD(0, 12, NMBF_DECCOMMA|NMBF_NOTRAILZ), arg_str_pool);
						p_new_amt->GROSS = GetDynamicParamString_(p_src_amt->GrossSum, MKSFMTD(0, 12, NMBF_DECCOMMA|NMBF_NOTRAILZ), arg_str_pool);
						p_new_amt->DISC_USCOREGR_USCORESUM = GetDynamicParamString_(p_src_amt->DiscGrossSum, MKSFMTD(0, 12, NMBF_DECCOMMA|NMBF_NOTRAILZ), arg_str_pool);
					}
				}
				{
