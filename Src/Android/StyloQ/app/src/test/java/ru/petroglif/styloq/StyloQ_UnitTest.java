...
public class StyloQ_UnitTest {
	...
	@Test public void ChZnMarkParsing()
	{
		String test_code_list[] = {
			...
			*/
			"01146400682124151004910121000474", /// сок сан-фрут (эти мудаки gtin начинают с 1 а не с 0)
			"0108019653038072215cM0p!91EE1192RgR1OBZPirULMuxeZobohFynHTZNoVLCyS1tzID044c=", /// косметика
			"0108051732586050215gMle991EE11926oDLBlP9+1brWDVFVIsERDgWT6yPDI9oykgAdGCaacQ=", /// косметика
			"01080517325860742152?PxR91EE1292HZshLACTRf4QXM7O0lkRp2quA3r+JqoESQ4nUsxNu8c=", /// косметика
			"046200811410948nR5aSjAAAAlx74", /// стики (NCP)
			"04605648055175HzI7EeRAAAAScJa", /// сигариллы (альт тобакко)
			"00000046238740U4\"wbD+ADKAxX7j", /// сигареты мрц200
			"00000046238740oYzqL:yADWoz1bP", /// сигареты мрц210
			"0104606532003654215?nf't>bGTe92",
			"0104606532003654215Hhg*NOtgn4\"a91EE11925SLde1/cZbVDiT6oRMjXG/fe4UUsQtirYD56fzNnDxY=",
			"01046700271461262152K10L0RA8JLU91EE119259gOqgfr1wXnZxSuroxB8Zq7dPeNN80K/gs5hDnJktU=", /// Машинное масло - ambiguity: 10 inside of 21
			"0104607161615317215PCINR692EKTZ", /// Машинное масло
			"0104607161615355215NZ2X78L93F0A", /// Машинное масло
			"00146071616190576879", /// Машинное масло упаковка
			"00146071616190577159", /// Машинное масло упаковка
			"00146071616190577166", /// Машинное масло упаковка
			"00146100804010717392", /// Машинное масло упаковка
			"00146100804004164829", /// Машинное масло упаковка
			"00146100804004164874", /// Машинное масло упаковка
			"00146100804004164980", /// Машинное масло упаковка
			"00146100804018939925", /// Машинное масло упаковка
			"00146100804018939956", /// Машинное масло упаковка
			"00146100804018940136", /// Машинное масло упаковка
			"00146100804018940365", /// Машинное масло упаковка
			"00146100804013922670", /// Машинное масло упаковка
			"00146071616191207697", /// Машинное масло упаковка
			"00146071616191207703", /// Машинное масло упаковка
			"00146071616191207796", /// Машинное масло упаковка
			"00146071616191207802", /// Машинное масло упаковка
			"00146100804001298985", /// Машинное масло упаковка
			"00146071616193033454", /// Машинное масло упаковка
			"00146071616193033614", /// Машинное масло упаковка
			"00146071616193033683", /// Машинное масло упаковка
			"010467002714704821e*D9rwpqZ46IZ", /// Машинное масло
			"010467002714704821e+FBURe3&jCDk", /// Машинное масло
			"010467002714704821e-J6h!fl;=1R&", /// Машинное масло
			"010467002714704821e9ehUDVx5ycfm", /// Машинное масло
			"010467002714704821e>/1C8VQYQ&!i", /// Машинное масло
			"010467002714704821eCkk>Ioxb0la:", /// Машинное масло
			"010467002714704821eD7T+4,D'6P9p", /// Машинное масло
			"010467002714704821eNQq0nc5nG?qv", /// Машинное масло
			"010467002714704821eTXST2LI<MYHJ", /// Машинное масло
			"010467002714704821eaFpk8kwdg>P3", /// Машинное масло
			"010467002714704821er)C'aqsY+gOd", /// Машинное масло
			"010467002714704821etE*YeQ13.E3Z", /// Машинное масло
			"010467002714705521e/eS7\"hk/bgmK", /// Машинное масло
			"010467002714705521eRBB,pMaJE;-*", /// Машинное масло
			"010467002714705521eRpscO)w_ylHs", /// Машинное масло
			"010467002714705521eTMN>iYUXx_qG", /// Машинное масло
			"010467002714705521eTUtj;BF0Qk2o", /// Машинное масло
			"010467002714705521eX_hM1QtHSY5-", /// Машинное масло
			"010467002714705521eqlIFiZ,!rrOK", /// Машинное масло
			"010467002714705521ewpmJ7bZENJpg", /// Машинное масло
		...
		}
		{
			...
			for(int i = 0; i < test_chzn_pallet_list.length; i++) {
				...
				if(is_valid_grade01) {
					...
					if(!code.contains("\u001D")) {
						final String org_text = result.GetToken(GTIN.fldOriginalText);
						if(!SLib.AreStringsEqual(org_text, code)) {
							err_count++;
						}
						Assert.assertTrue(SLib.AreStringsEqual(org_text, code));
					}
				}
			}
		}
