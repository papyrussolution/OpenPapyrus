...
int my_connect_async(MARIADB_PVIO * pvio, const struct sockaddr * name, uint namelen, int vio_timeout)
{
	int res;
...
int my_ssl_read_async(struct mysql_async_context * b, SSL * ssl,
    void * buf, int size)
{
	int res;
...
int my_ssl_write_async(struct mysql_async_context * b, SSL * ssl,
...
#define MK_ASYNC_INTERNAL_BODY(call, invoke_args, mysql_val, ret_type, ok_val) \
	...
	ret_type ret;                                                               \
	struct mysql_async_context * b = (mysql_val)->options.extension->async_context; \
...
#define MK_ASYNC_START_BODY(call, mysql_val, parms_assign, err_val, ok_val, extra1) \
	...
	extra1 b = mysql_val->options.extension->async_context;                     \
	parms_assign                                                                \
	b->active = 1;                                                               \
...
{
	MK_ASYNC_INTERNAL_BODY(mysql_real_connect, (parms->mysql, parms->host, parms->user, parms->passwd, parms->db,
		parms->port, parms->unix_socket, parms->client_flags), parms->mysql, MYSQL *, r_ptr)
}
...
static void mysql_real_query_start_internal(void * d)
{
	MK_ASYNC_INTERNAL_BODY(mysql_real_query, (parms->mysql, parms->stmt_str, parms->length), parms->mysql, int, r_int)
}

int STDCALL mysql_real_query_start(int * ret, MYSQL * mysql, const char * stmt_str, ulong length)
{
	int res;
	struct mysql_real_query_params parms;
	struct mysql_async_context * b = mysql->options.extension->async_context;
	{
...
int STDCALL mysql_real_query_cont(int * ret, MYSQL * mysql, int ready_status)
{
	MK_ASYNC_CONT_BODY(mysql, 1, r_int)
}
...
static void mysql_fetch_row_start_internal(void * d)
{
	MK_ASYNC_INTERNAL_BODY(mysql_fetch_row, (parms->result), parms->result->handle, MYSQL_ROW, r_ptr)
}

int STDCALL mysql_fetch_row_start(MYSQL_ROW * ret, MYSQL_RES * result)
{
	MK_ASYNC_START_BODY(mysql_fetch_row, result->handle,
	{
		WIN_SET_NONBLOCKING(result->handle)
		parms.result = result;
	}, NULL, /*r_ptr*/P_RetMsRow,
		/*
		   ...
		   since in this case mysql_fetch_row cannot block anyway. Just return directly.
		 */
		if(!result->handle) {
...
int STDCALL mysql_fetch_row_cont(MYSQL_ROW * ret, MYSQL_RES * result, int ready_status)
{
	MK_ASYNC_CONT_BODY(result->handle, NULL, /*r_ptr*/P_RetMsRow)
}
...
static void mysql_set_character_set_start_internal(void * d)
{
	MK_ASYNC_INTERNAL_BODY(mysql_set_character_set, (parms->mysql, parms->csname), parms->mysql, int, r_int)
}

int STDCALL mysql_set_character_set_start(int * ret, MYSQL * mysql, const char * csname)
{
	MK_ASYNC_START_BODY(mysql_set_character_set, mysql,
	{
		WIN_SET_NONBLOCKING(mysql)
		parms.mysql = mysql;
		parms.csname = csname;
...
static void mysql_select_db_start_internal(void * d)
{
	MK_ASYNC_INTERNAL_BODY(mysql_select_db, (parms->mysql, parms->db), parms->mysql, int, r_int)
}

int STDCALL mysql_select_db_start(int * ret, MYSQL * mysql, const char * db)
{
	MK_ASYNC_START_BODY(mysql_select_db, mysql,
	{
		WIN_SET_NONBLOCKING(mysql)
		parms.mysql = mysql;
		parms.db = db;
...
static void mysql_send_query_start_internal(void * d)
{
	MK_ASYNC_INTERNAL_BODY(mysql_send_query, (parms->mysql, parms->q, parms->length), parms->mysql, int, r_int)
}

int STDCALL mysql_send_query_start(int * ret, MYSQL * mysql, const char * q, ulong length)
{
	MK_ASYNC_START_BODY(mysql_send_query, mysql,
	{
		WIN_SET_NONBLOCKING(mysql)
		parms.mysql = mysql;
		parms.q = q;
...
static void mysql_store_result_start_internal(void * d)
{
	MK_ASYNC_INTERNAL_BODY(mysql_store_result, (parms->mysql), parms->mysql, MYSQL_RES *, r_ptr)
}

int STDCALL mysql_store_result_start(MYSQL_RES ** ret, MYSQL * mysql)
{
	MK_ASYNC_START_BODY(mysql_store_result, mysql,
	{
		WIN_SET_NONBLOCKING(mysql)
		parms.mysql = mysql;
	}, NULL, /*r_ptr*/P_RetMsRes, /*Nothing*/)
}

int STDCALL mysql_store_result_cont(MYSQL_RES ** ret, MYSQL * mysql, int ready_status)
{
	MK_ASYNC_CONT_BODY(mysql, NULL, /*r_ptr*/P_RetMsRes)
}
...
static void mysql_free_result_start_internal(void * d)
{
	MK_ASYNC_INTERNAL_BODY_VOID_RETURN(mysql_free_result, (parms->result), parms->result->handle)
}

int STDCALL mysql_free_result_start(MYSQL_RES * result)
{
	MK_ASYNC_START_BODY_VOID_RETURN(mysql_free_result, result->handle,
	{
		WIN_SET_NONBLOCKING(result->handle)
		parms.result = result;
	},
...
int STDCALL mysql_free_result_cont(MYSQL_RES * result, int ready_status)
{
...
/*
   ...
   part blocking.
 */
static void mysql_close_slow_part_start_internal(void * d)
{
	MK_ASYNC_INTERNAL_BODY_VOID_RETURN(mysql_close_slow_part, (parms->sock), parms->sock)
}

int STDCALL mysql_close_slow_part_start(MYSQL * sock)
{
	MK_ASYNC_START_BODY_VOID_RETURN(mysql_close_slow_part, sock,
	{
...
int STDCALL mysql_close_cont(MYSQL * sock, int ready_status)
{
	int res = mysql_close_slow_part_cont(sock, ready_status);
	if(res)
		return res;
	mysql_close(sock);
	return 0;
...
static void mysql_query_start_internal(void * d)
{
	MK_ASYNC_INTERNAL_BODY(mysql_query, (parms->mysql, parms->q), parms->mysql, int, r_int)
}

int STDCALL mysql_query_start(int * ret, MYSQL * mysql, const char * q)
{
	MK_ASYNC_START_BODY(mysql_query, mysql,
	{
		WIN_SET_NONBLOCKING(mysql)
		parms.mysql = mysql;
		parms.q = q;
...
static void mysql_shutdown_start_internal(void * d)
{
	MK_ASYNC_INTERNAL_BODY(
		mysql_shutdown,
...
int STDCALL mysql_shutdown_start(int * ret, MYSQL * mysql, enum mysql_enum_shutdown_level shutdown_level)
{
	MK_ASYNC_START_BODY(mysql_shutdown, mysql,
	{
		WIN_SET_NONBLOCKING(mysql)
		parms.mysql = mysql;
...
static void mysql_dump_debug_info_start_internal(void * d)
{
	MK_ASYNC_INTERNAL_BODY(
...
{
	MK_ASYNC_START_BODY(mysql_dump_debug_info, mysql,
	{
		WIN_SET_NONBLOCKING(mysql)
		parms.mysql = mysql;
	}, 1, r_int, /*Nothing*/)
...
{
	MK_ASYNC_INTERNAL_BODY(mysql_refresh, (parms->mysql, parms->refresh_options),
		parms->mysql, int, r_int)
}
...
static void mysql_set_server_option_start_internal(void * d)
{
	MK_ASYNC_INTERNAL_BODY(mysql_set_server_option, (parms->mysql, parms->option), parms->mysql, int, r_int)
}

int STDCALL mysql_set_server_option_start(int * ret, MYSQL * mysql, enum enum_mysql_set_option option)
{
	MK_ASYNC_START_BODY(mysql_set_server_option, mysql,
	{
		WIN_SET_NONBLOCKING(mysql)
		parms.mysql = mysql;
		parms.option = option;
...
static void mysql_ping_start_internal(void * d)
{
	MK_ASYNC_INTERNAL_BODY(mysql_ping, (parms->mysql), parms->mysql, int, r_int)
}

int STDCALL mysql_ping_start(int * ret, MYSQL * mysql)
{
	MK_ASYNC_START_BODY(mysql_ping, mysql,
	{
		WIN_SET_NONBLOCKING(mysql)
		parms.mysql = mysql;
	}, 1, r_int, /*Nothing*/)
...
static void mysql_reset_connection_start_internal(void * d)
{
	MK_ASYNC_INTERNAL_BODY(mysql_reset_connection, (parms->mysql), parms->mysql, int, r_int)
}

int STDCALL mysql_reset_connection_start(int * ret, MYSQL * mysql)
{
	MK_ASYNC_START_BODY(mysql_reset_connection, mysql,
	{
		WIN_SET_NONBLOCKING(mysql)
		parms.mysql = mysql;
	}, 1, r_int, /*Nothing*/)
...
static void mysql_stat_start_internal(void * d)
{
	MK_ASYNC_INTERNAL_BODY(mysql_stat, (parms->mysql), parms->mysql, const char *, r_const_ptr)
}

int STDCALL mysql_stat_start(const char ** ret, MYSQL * mysql)
{
	MK_ASYNC_START_BODY(mysql_stat, mysql,
	{
		WIN_SET_NONBLOCKING(mysql)
		parms.mysql = mysql;
	}, NULL, /*r_const_ptr*/P_RetCPtrC, /*Nothing*/)
}

int STDCALL mysql_stat_cont(const char ** ret, MYSQL * mysql, int ready_status)
{
	MK_ASYNC_CONT_BODY(mysql, NULL, /*r_const_ptr*/P_RetCPtrC)
}
...
static void mysql_list_dbs_start_internal(void * d)
{
	MK_ASYNC_INTERNAL_BODY(mysql_list_dbs, (parms->mysql, parms->wild), parms->mysql, MYSQL_RES *, r_ptr)
}

int STDCALL mysql_list_dbs_start(MYSQL_RES ** ret, MYSQL * mysql, const char * wild)
{
	MK_ASYNC_START_BODY(mysql_list_dbs, mysql,
	{
		WIN_SET_NONBLOCKING(mysql)
		parms.mysql = mysql;
		parms.wild = wild;
...
static void mysql_list_tables_start_internal(void * d)
{
	MK_ASYNC_INTERNAL_BODY(mysql_list_tables, (parms->mysql, parms->wild), parms->mysql, MYSQL_RES *, r_ptr)
}

int STDCALL mysql_list_tables_start(MYSQL_RES ** ret, MYSQL * mysql, const char * wild)
{
	MK_ASYNC_START_BODY(mysql_list_tables, mysql,
	{
		WIN_SET_NONBLOCKING(mysql)
		parms.mysql = mysql;
		parms.wild = wild;
...
static void mysql_list_processes_start_internal(void * d)
{
	MK_ASYNC_INTERNAL_BODY(
...
int STDCALL mysql_list_processes_start(MYSQL_RES ** ret, MYSQL * mysql)
{
	MK_ASYNC_START_BODY(mysql_list_processes, mysql,
	{
		WIN_SET_NONBLOCKING(mysql)
		parms.mysql = mysql;
	}, NULL, /*r_ptr*/P_RetMsRes, /*Nothing*/)
...
static void mysql_list_fields_start_internal(void * d)
{
	MK_ASYNC_INTERNAL_BODY(
		mysql_list_fields,
...
int STDCALL mysql_list_fields_start(MYSQL_RES ** ret, MYSQL * mysql, const char * table, const char * wild)
{
	MK_ASYNC_START_BODY(mysql_list_fields, mysql,
	{
		WIN_SET_NONBLOCKING(mysql)
		parms.mysql = mysql;
		parms.table = table;
...
static void mysql_stmt_prepare_start_internal(void * d)
{
	MK_ASYNC_INTERNAL_BODY(mysql_stmt_prepare, (parms->stmt, parms->query, parms->length),
		parms->stmt->mysql, int, r_int)
}

int STDCALL mysql_stmt_prepare_start(int * ret, MYSQL_STMT * stmt, const char * query, ulong length)
{
	MK_ASYNC_START_BODY(mysql_stmt_prepare, stmt->mysql,
	{
...
int STDCALL mysql_stmt_prepare_cont(int * ret, MYSQL_STMT * stmt, int ready_status)
{
	MK_ASYNC_CONT_BODY(stmt->mysql, 1, r_int)
}
...
static void mysql_stmt_execute_start_internal(void * d)
{
	MK_ASYNC_INTERNAL_BODY(mysql_stmt_execute, (parms->stmt), parms->stmt->mysql, int, r_int)
}

int STDCALL mysql_stmt_execute_start(int * ret, MYSQL_STMT * stmt)
{
	MK_ASYNC_START_BODY(mysql_stmt_execute, stmt->mysql,
	{
		WIN_SET_NONBLOCKING(stmt->mysql)
		parms.stmt = stmt;
	},
...
int STDCALL mysql_stmt_execute_cont(int * ret, MYSQL_STMT * stmt, int ready_status)
{
	MK_ASYNC_CONT_BODY(stmt->mysql, 1, r_int)
}
...
static void mysql_stmt_fetch_start_internal(void * d)
{
	MK_ASYNC_INTERNAL_BODY(
		mysql_stmt_fetch,
		(parms->stmt),
...
int STDCALL mysql_stmt_fetch_cont(int * ret, MYSQL_STMT * stmt, int ready_status)
{
	MK_ASYNC_CONT_BODY(stmt->mysql, 1, r_int)
}
...
static void mysql_stmt_store_result_start_internal(void * d)
{
	MK_ASYNC_INTERNAL_BODY(
...
{
	MK_ASYNC_START_BODY(mysql_stmt_store_result, stmt->mysql,
	{
		WIN_SET_NONBLOCKING(stmt->mysql)
		parms.stmt = stmt;
	}, 1, r_int,
...
int STDCALL mysql_stmt_store_result_cont(int * ret, MYSQL_STMT * stmt, int ready_status)
{
	MK_ASYNC_CONT_BODY(stmt->mysql, 1, r_int)
}
...
{
	MK_ASYNC_INTERNAL_BODY(mysql_stmt_send_long_data,
		(parms->stmt, parms->param_number, parms->data, parms->length),
		parms->stmt->mysql, bool, r_my_bool)
}

int STDCALL mysql_stmt_send_long_data_start(bool * ret, MYSQL_STMT * stmt, uint param_number, const char * data, ulong length)
{
...
static void mysql_next_result_start_internal(void * d)
{
	MK_ASYNC_INTERNAL_BODY(mysql_next_result, (parms->mysql), parms->mysql, int, r_int)
}

int STDCALL mysql_next_result_start(int * ret, MYSQL * mysql)
{
	MK_ASYNC_START_BODY(mysql_next_result, mysql,
	{
		WIN_SET_NONBLOCKING(mysql)
		parms.mysql = mysql;
	}, 1, r_int, /*Nothing*/)
...
static void mysql_stmt_next_result_start_internal(void * d)
{
	MK_ASYNC_INTERNAL_BODY(mysql_stmt_next_result, (parms->stmt), parms->stmt->mysql, int, r_int)
}

int STDCALL mysql_stmt_next_result_start(int * ret, MYSQL_STMT * stmt)
{
	MK_ASYNC_START_BODY(mysql_stmt_next_result, stmt->mysql,
	{
		WIN_SET_NONBLOCKING(stmt->mysql)
		parms.stmt = stmt;
	}, 1, r_int, /*Nothing*/)
