...
static int fade(fz_pixmap * tpix, const fz_pixmap * opix, const fz_pixmap * npix, int time)
{
	uchar * t, * o, * n;
	int size;
	int h;
	int tstride, ostride, nstride;
	if(!tpix || !opix || !npix || tpix->w != opix->w || opix->w != npix->w || tpix->h != opix->h || opix->h != npix->h ||
	    tpix->n != opix->n || opix->n != npix->n)
		return 0;
	h = tpix->h;
	size = tpix->w * tpix->n;
...
static int blind_horiz(fz_pixmap * tpix, fz_pixmap * opix, fz_pixmap * npix, int time)
{
	uchar * t, * o, * n;
...
static int blind_vertical(fz_pixmap * tpix, fz_pixmap * opix, fz_pixmap * npix, int time)
{
	uchar * t, * o, * n;
...
static int wipe_tb(fz_pixmap * tpix, fz_pixmap * opix, fz_pixmap * npix, int time)
{
	uchar * t, * o, * n;
	int size, position, y;
	int tstride, ostride, nstride;
...
static int wipe_lr(fz_pixmap * tpix, fz_pixmap * opix, fz_pixmap * npix, int time)
{
	uchar * t, * o, * n;
	int size, position, y;
	int tstride, ostride, nstride;
