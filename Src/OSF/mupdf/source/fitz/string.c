...
static char * twobyte_memmem(const uchar * h, size_t k, const uchar * n)
{
...
static char * threebyte_memmem(const uchar * h, size_t k, const uchar * n)
{
...
static char * fourbyte_memmem(const uchar * h, size_t k, const uchar * n)
{
...
static char * twoway_memmem(const uchar * h, const uchar * z, const uchar * n, size_t l)
{
