...
static int is_rgb_color(float threshold, float r, float g, float b)
{
...
static int is_rgb_color_u8(int threshold_u8, int r, int g, int b)
{
...
static void fz_test_color(fz_context * ctx,
    fz_test_device * t,
...
static void fz_test_fill_path(fz_context * ctx, fz_device * dev_, const fz_path * path, int even_odd, fz_matrix ctm,
...
static void fz_test_stroke_path(fz_context * ctx, fz_device * dev_, const fz_path * path, const fz_stroke_state * stroke,
...
static void fz_test_fill_text(fz_context * ctx, fz_device * dev_, const fz_text * text, fz_matrix ctm,
    fz_colorspace * colorspace, const float * color, float alpha, fz_color_params color_params)
{
	fz_test_device * dev = (fz_test_device*)dev_;
...
static void fz_test_stroke_text(fz_context * ctx, fz_device * dev_, const fz_text * text, const fz_stroke_state * stroke,
    fz_matrix ctm, fz_colorspace * colorspace, const float * color, float alpha, fz_color_params color_params)
{
	fz_test_device * dev = (fz_test_device*)dev_;
...
static void prepare_vertex(fz_context * ctx, void * arg_, fz_vertex * v, const float * color)
{
	struct shadearg * arg = (struct shadearg *)arg_;
...
static void fz_test_fill_shade(fz_context * ctx,
    fz_device * dev_,
    fz_shade * shade,
    fz_matrix ctm,
    float alpha,
...
static void fz_test_fill_compressed_8bpc_image(fz_context * ctx,
    fz_test_device * dev,
    fz_image * image,
    fz_stream * stream,
    fz_color_params color_params)
{
	uint count = (uint)image->w * (uint)image->h;
	uint i;
...
static void fz_test_fill_other_image(fz_context * ctx, fz_test_device * dev, fz_pixmap * pix, fz_color_params color_params)
{
	uint count, i, k, h, sa;
	size_t ss;
	uchar * s;
...
static void fz_test_fill_image(fz_context * ctx,
    fz_device * dev_,
    fz_image * image,
    fz_matrix ctm,
    float alpha,
...
static void fz_test_fill_image_mask(fz_context * ctx, fz_device * dev_, fz_image * image, fz_matrix ctm,
    fz_colorspace * colorspace, const float * color, float alpha, fz_color_params color_params)
{
	fz_test_device * dev = (fz_test_device*)dev_;
...
static void fz_test_clip_path(fz_context * ctx, fz_device * dev_, const fz_path * path, int even_odd, fz_matrix ctm, fz_rect scissor)
{
	fz_test_device * dev = (fz_test_device*)dev_;
...
static void fz_test_clip_stroke_path(fz_context * ctx,
    fz_device * dev_,
    const fz_path * path,
...
static void fz_test_clip_text(fz_context * ctx, fz_device * dev_, const fz_text * text, fz_matrix ctm, fz_rect scissor)
{
	fz_test_device * dev = (fz_test_device*)dev_;
...
static void fz_test_clip_stroke_text(fz_context * ctx,
    fz_device * dev_,
    const fz_text * text,
    const fz_stroke_state * stroke,
    fz_matrix ctm,
...
static void fz_test_ignore_text(fz_context * ctx, fz_device * dev_, const fz_text * text, fz_matrix ctm)
{
	fz_test_device * dev = (fz_test_device*)dev_;
...
static void fz_test_clip_image_mask(fz_context * ctx, fz_device * dev_, fz_image * img, fz_matrix ctm, fz_rect scissor)
{
	fz_test_device * dev = (fz_test_device*)dev_;
...
static void fz_test_pop_clip(fz_context * ctx, fz_device * dev_)
{
	fz_test_device * dev = (fz_test_device*)dev_;
...
static void fz_test_begin_mask(fz_context * ctx,
    fz_device * dev_,
    fz_rect rect,
    int luminosity,
    fz_colorspace * cs,
...
static void fz_test_end_mask(fz_context * ctx, fz_device * dev_)
{
	fz_test_device * dev = (fz_test_device*)dev_;
...
static void fz_test_begin_group(fz_context * ctx,
    fz_device * dev_,
    fz_rect rect,
    fz_colorspace * cs,
    int isolated,
...
static void fz_test_end_group(fz_context * ctx, fz_device * dev_)
{
	fz_test_device * dev = (fz_test_device*)dev_;
...
static int fz_test_begin_tile(fz_context * ctx,
    fz_device * dev_,
    fz_rect area,
    fz_rect view,
    float xstep,
...
static void fz_test_end_tile(fz_context * ctx, fz_device * dev_)
{
	fz_test_device * dev = (fz_test_device*)dev_;
