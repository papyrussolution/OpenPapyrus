...
jpeg_cust_mem_data * jpeg_cust_mem_init(jpeg_cust_mem_data *custm, void * priv, j_custmem_init_ptr init,
    j_custmem_term_ptr term, j_custmem_avail_ptr avail, j_custmem_get_small_ptr get_small, j_custmem_free_small_ptr free_small,
    j_cust_mem_get_large_ptr get_large, j_custmem_free_large_ptr free_large, j_custmem_open_backing_store_ptr open_backing_store)
{
