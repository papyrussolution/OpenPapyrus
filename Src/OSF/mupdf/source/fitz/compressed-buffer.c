...
fz_stream * fz_open_image_decomp_stream(fz_context * ctx, fz_stream * tail, fz_compression_params * params, int * l2factor)
{
...
fz_stream * fz_open_compressed_buffer(fz_context * ctx, fz_compressed_buffer * buffer)
{
