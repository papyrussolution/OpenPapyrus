...
static int next_leech(fz_context * ctx, fz_stream * stm, size_t max)
{
...
static void close_leech(fz_context * ctx, void * state_)
{
...
fz_stream * fz_open_leecher(fz_context * ctx, fz_stream * chain, fz_buffer * buffer)
{
