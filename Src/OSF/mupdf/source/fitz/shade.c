...
static inline void paint_tri(fz_context * ctx, fz_mesh_processor * painter, fz_vertex * v0, fz_vertex * v1, fz_vertex * v2)
{
	if(painter->process) {
...
static inline void paint_quad(fz_context * ctx, fz_mesh_processor * painter, fz_vertex * v0, fz_vertex * v1, fz_vertex * v2, fz_vertex * v3)
{
...
static inline void fz_prepare_color(fz_context * ctx, fz_mesh_processor * painter, fz_vertex * v, float * c)
{
	if(painter->prepare) {
...
static inline void fz_prepare_vertex(fz_context * ctx,
...
static void fz_process_shade_type1(fz_context * ctx, fz_shade * shade, fz_matrix ctm, fz_mesh_processor * painter)
{
...
static void fz_process_shade_type4(fz_context * ctx, fz_shade * shade, fz_matrix ctm, fz_mesh_processor * painter)
{
...
static void fz_process_shade_type5(fz_context * ctx, fz_shade * shade, fz_matrix ctm, fz_mesh_processor * painter)
{
	fz_stream * stream = fz_open_compressed_buffer(ctx, shade->buffer);
	fz_vertex * buf = NULL;
	fz_vertex * ref = NULL;
...
static void triangulate_patch(fz_context * ctx, fz_mesh_processor * painter, tensor_patch * p)
{
	fz_vertex v0, v1, v2, v3;
...
static void split_stripe(tensor_patch * p, tensor_patch * s0, tensor_patch * s1, int n)
{
	/*
...
static void draw_stripe(fz_context * ctx, fz_mesh_processor * painter, tensor_patch * p, int depth)
{
	tensor_patch s0, s1;
...
static void split_patch(tensor_patch * p, tensor_patch * s0, tensor_patch * s1, int n)
{
	/*
...
static void draw_patch(fz_context * ctx, fz_mesh_processor * painter, tensor_patch * p, int depth, int origdepth)
{
	tensor_patch s0, s1;
...
static void fz_process_shade_type6(fz_context * ctx, fz_shade * shade, fz_matrix ctm, fz_mesh_processor * painter)
{
	fz_stream * stream = fz_open_compressed_buffer(ctx, shade->buffer);
...
static void fz_process_shade_type7(fz_context * ctx, fz_shade * shade, fz_matrix ctm, fz_mesh_processor * painter)
{
	fz_stream * stream = fz_open_compressed_buffer(ctx, shade->buffer);
	int bpflag = shade->u.m.bpflag;
	int bpcoord = shade->u.m.bpcoord;
...
static fz_rect fz_bound_mesh_type1(fz_context * ctx, fz_shade * shade)
{
	fz_rect bbox;
...
static fz_rect fz_bound_mesh_type2(fz_context * ctx, fz_shade * shade)
{
...
static fz_rect fz_bound_mesh(fz_context * ctx, fz_shade * shade)
{
	if(shade->type == FZ_FUNCTION_BASED)
...
void fz_drop_shade_imp(fz_context * ctx, fz_storable * shade_)
{
