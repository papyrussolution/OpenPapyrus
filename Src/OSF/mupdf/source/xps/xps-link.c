...
static void xps_load_links_in_path(fz_context * ctx, xps_document * doc, fz_matrix ctm,
...
static void xps_load_links_in_glyphs(fz_context * ctx, xps_document * doc, fz_matrix ctm,
    char * base_uri, xps_resource * dict, fz_xml * root, fz_link ** link)
{
	char * navigate_uri_att = fz_xml_att(root, "FixedPage.NavigateUri");
	if(navigate_uri_att) {
...
static void xps_load_links_in_canvas(fz_context * ctx, xps_document * doc, fz_matrix ctm,
    char * base_uri, xps_resource * dict, fz_xml * root, fz_link ** link)
{
...
static void xps_load_links_in_element(fz_context * ctx,
    xps_document * doc,
    fz_matrix ctm,
    char * base_uri,
    xps_resource * dict,
...
fz_link * xps_load_links(fz_context * ctx, fz_page * page_)
{
