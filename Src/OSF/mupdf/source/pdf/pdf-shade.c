...
static void pdf_sample_composite_shade_function(fz_context * ctx, fz_shade * shade, pdf_function * func, float t0, float t1)
{
	int i;
	float t;
...
static void pdf_sample_component_shade_function(fz_context * ctx, fz_shade * shade, int funcs, pdf_function ** func, float t0, float t1)
{
	int i, k;
	float t;
	for(i = 0; i < 256; i++) {
...
static void pdf_load_function_based_shading(fz_context * ctx, pdf_document * doc, fz_shade * shade, pdf_obj * dict, pdf_function * func)
{
	pdf_obj * obj;
	float x0, y0, x1, y1;
	float fv[2];
	...
	shade->u.f.fn_vals = (float *)Memento_label(fz_malloc(ctx, (FUNSEGS+1)*(FUNSEGS+1)*n*sizeof(float)), "shade_fn_vals");
...
static void pdf_load_linear_shading(fz_context * ctx, pdf_document * doc, fz_shade * shade, pdf_obj * dict, int funcs, pdf_function ** func)
{
	pdf_obj * obj;
	float d0, d1;
	int e0, e1;
...
static void pdf_load_radial_shading(fz_context * ctx, pdf_document * doc, fz_shade * shade, pdf_obj * dict, int funcs, pdf_function ** func)
{
	pdf_obj * obj;
	float d0, d1;
	int e0, e1;
...
static void pdf_load_mesh_params(fz_context * ctx, pdf_document * doc, fz_shade * shade, pdf_obj * dict)
{
	pdf_obj * obj;
	int i, n;
...
static void pdf_load_type4_shade(fz_context * ctx, pdf_document * doc, fz_shade * shade, pdf_obj * dict, int funcs, pdf_function ** func)
{
...
static void pdf_load_type5_shade(fz_context * ctx, pdf_document * doc, fz_shade * shade, pdf_obj * dict, int funcs, pdf_function ** func)
{
	pdf_load_mesh_params(ctx, doc, shade, dict);
...
static void pdf_load_type6_shade(fz_context * ctx, pdf_document * doc, fz_shade * shade, pdf_obj * dict, int funcs, pdf_function ** func)
{
	pdf_load_mesh_params(ctx, doc, shade, dict);
...
static void pdf_load_type7_shade(fz_context * ctx, pdf_document * doc, fz_shade * shade, pdf_obj * dict, int funcs, pdf_function ** func)
{
	pdf_load_mesh_params(ctx, doc, shade, dict);
...
static fz_shade * pdf_load_shading_dict(fz_context * ctx, pdf_document * doc, pdf_obj * dict, fz_matrix transform)
{
	fz_shade * shade = NULL;
