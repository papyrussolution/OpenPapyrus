...
static void pdf_out_w(fz_context * ctx, pdf_processor * proc, float linewidth)
{
...
static void pdf_out_j(fz_context * ctx, pdf_processor * proc, int linejoin)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
	if(!((pdf_output_processor*)proc)->extgstate)
...
static void pdf_out_J(fz_context * ctx, pdf_processor * proc, int linecap)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
	if(!((pdf_output_processor*)proc)->extgstate)
		fz_write_printf(ctx, out, "%d J\n", linecap);
...
static void pdf_out_M(fz_context * ctx, pdf_processor * proc, float a)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
	if(!((pdf_output_processor*)proc)->extgstate)
...
static void pdf_out_d(fz_context * ctx, pdf_processor * proc, pdf_obj * array, float phase)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
...
static void pdf_out_ri(fz_context * ctx, pdf_processor * proc, const char * intent)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
	if(!((pdf_output_processor*)proc)->extgstate)
...
static void pdf_out_i(fz_context * ctx, pdf_processor * proc, float flatness)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
	if(!((pdf_output_processor*)proc)->extgstate)
...
static void pdf_out_gs_begin(fz_context * ctx, pdf_processor * proc, const char * name, pdf_obj * extgstate)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
...
static void pdf_out_gs_end(fz_context * ctx, pdf_processor * proc)
{
...
static void pdf_out_q(fz_context * ctx, pdf_processor * proc)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
...
static void pdf_out_cm(fz_context * ctx, pdf_processor * proc, float a, float b, float c, float d, float e, float f)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
...
static void pdf_out_m(fz_context * ctx, pdf_processor * proc, float x, float y)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
	fz_write_printf(ctx, out, "%g %g m\n", x, y);
}

static void pdf_out_l(fz_context * ctx, pdf_processor * proc, float x, float y)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
	fz_write_printf(ctx, out, "%g %g l\n", x, y);
}

static void pdf_out_c(fz_context * ctx, pdf_processor * proc, float x1, float y1, float x2, float y2, float x3, float y3)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
	fz_write_printf(ctx, out, "%g %g %g %g %g %g c\n", x1, y1, x2, y2, x3, y3);
}

static void pdf_out_v(fz_context * ctx, pdf_processor * proc, float x2, float y2, float x3, float y3)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
	fz_write_printf(ctx, out, "%g %g %g %g v\n", x2, y2, x3, y3);
}

static void pdf_out_y(fz_context * ctx, pdf_processor * proc, float x1, float y1, float x3, float y3)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
	fz_write_printf(ctx, out, "%g %g %g %g y\n", x1, y1, x3, y3);
}

static void pdf_out_h(fz_context * ctx, pdf_processor * proc)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
	fz_write_string(ctx, out, "h\n");
}

static void pdf_out_re(fz_context * ctx, pdf_processor * proc, float x, float y, float w, float h)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
...
static void pdf_out_S(fz_context * ctx, pdf_processor * proc)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
...
static void pdf_out_F(fz_context * ctx, pdf_processor * proc)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
...
static void pdf_out_fstar(fz_context * ctx, pdf_processor * proc)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
	fz_write_string(ctx, out, "f*\n");
}

static void pdf_out_B(fz_context * ctx, pdf_processor * proc)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
	fz_write_string(ctx, out, "B\n");
}

static void pdf_out_Bstar(fz_context * ctx, pdf_processor * proc)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
	fz_write_string(ctx, out, "B*\n");
}
...
static void pdf_out_n(fz_context * ctx, pdf_processor * proc)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
...
static void pdf_out_W(fz_context * ctx, pdf_processor * proc)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
	fz_write_string(ctx, out, "W\n");
}

static void pdf_out_Wstar(fz_context * ctx, pdf_processor * proc)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
	fz_write_string(ctx, out, "W*\n");
}
...
static void pdf_out_BT(fz_context * ctx, pdf_processor * proc)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
	fz_write_string(ctx, out, "BT\n");
}

static void pdf_out_ET(fz_context * ctx, pdf_processor * proc)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
...
static void pdf_out_Tc(fz_context * ctx, pdf_processor * proc, float charspace)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
	fz_write_printf(ctx, out, "%g Tc\n", charspace);
}

static void pdf_out_Tw(fz_context * ctx, pdf_processor * proc, float wordspace)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
	fz_write_printf(ctx, out, "%g Tw\n", wordspace);
}

static void pdf_out_Tz(fz_context * ctx, pdf_processor * proc, float scale)
{
...
static void pdf_out_TL(fz_context * ctx, pdf_processor * proc, float leading)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
	fz_write_printf(ctx, out, "%g TL\n", leading);
}

static void pdf_out_Tf(fz_context * ctx, pdf_processor * proc, const char * name, pdf_font_desc * font, float size)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
	if(!((pdf_output_processor*)proc)->extgstate) {
...
static void pdf_out_Tr(fz_context * ctx, pdf_processor * proc, int render)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
	fz_write_printf(ctx, out, "%d Tr\n", render);
}

static void pdf_out_Ts(fz_context * ctx, pdf_processor * proc, float rise)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
...
static void pdf_out_Td(fz_context * ctx, pdf_processor * proc, float tx, float ty)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
...
static void pdf_out_Tm(fz_context * ctx, pdf_processor * proc, float a, float b, float c, float d, float e, float f)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
	fz_write_printf(ctx, out, "%g %g %g %g %g %g Tm\n", a, b, c, d, e, f);
}

static void pdf_out_Tstar(fz_context * ctx, pdf_processor * proc)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
...
static void fz_write_pdf_string(fz_context * ctx, fz_output * out, const uchar * str, size_t len)
{
	size_t i;
...
static void pdf_out_TJ(fz_context * ctx, pdf_processor * proc, pdf_obj * array)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
	int ahx = ((pdf_output_processor*)proc)->ahxencode;
	pdf_print_obj(ctx, out, array, 1, ahx);
...
static void pdf_out_Tj(fz_context * ctx, pdf_processor * proc, char * str, size_t len)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
	fz_write_pdf_string(ctx, out, (const uchar*)str, len);
	fz_write_string(ctx, out, " Tj\n");
}

static void pdf_out_squote(fz_context * ctx, pdf_processor * proc, char * str, size_t len)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
	fz_write_pdf_string(ctx, out, (const uchar*)str, len);
...
static void pdf_out_dquote(fz_context * ctx, pdf_processor * proc, float aw, float ac, char * str, size_t len)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
...
static void pdf_out_d0(fz_context * ctx, pdf_processor * proc, float wx, float wy)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
	fz_write_printf(ctx, out, "%g %g d0\n", wx, wy);
}

static void pdf_out_d1(fz_context * ctx, pdf_processor * proc, float wx, float wy, float llx, float lly, float urx, float ury)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
...
static void pdf_out_CS(fz_context * ctx, pdf_processor * proc, const char * name, fz_colorspace * cs)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
...
static void pdf_out_SC_pattern(fz_context * ctx, pdf_processor * proc, const char * name, pdf_pattern * pat, int n, float * color)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
	int i;
	for(i = 0; i < n; ++i)
...
static void pdf_out_SC_shade(fz_context * ctx, pdf_processor * proc, const char * name, fz_shade * shade)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
	fz_write_printf(ctx, out, "%n SCN\n", name);
}
...
static void pdf_out_SC_color(fz_context * ctx, pdf_processor * proc, int n, float * color)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
	int i;
	for(i = 0; i < n; ++i)
...
static void pdf_out_G(fz_context * ctx, pdf_processor * proc, float g)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
...
static void pdf_out_RG(fz_context * ctx, pdf_processor * proc, float r, float g, float b)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
...
static void pdf_out_K(fz_context * ctx, pdf_processor * proc, float c, float m, float y, float k)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
...
static void pdf_out_BI(fz_context * ctx, pdf_processor * proc, fz_image * img, const char * colorspace)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
	int ahx = ((pdf_output_processor*)proc)->ahxencode;
...
static void pdf_out_sh(fz_context * ctx, pdf_processor * proc, const char * name, fz_shade * shade)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
	fz_write_printf(ctx, out, "%n sh\n", name);
}

static void pdf_out_Do_image(fz_context * ctx, pdf_processor * proc, const char * name, fz_image * image)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
	fz_write_printf(ctx, out, "%n Do\n", name);
}

static void pdf_out_Do_form(fz_context * ctx, pdf_processor * proc, const char * name, pdf_obj * xobj, pdf_obj * page_resources)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
	fz_write_printf(ctx, out, "%n Do\n", name);
}
...
static void pdf_out_MP(fz_context * ctx, pdf_processor * proc, const char * tag)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
	fz_write_printf(ctx, out, "%n MP\n", tag);
}

static void pdf_out_DP(fz_context * ctx, pdf_processor * proc, const char * tag, pdf_obj * raw, pdf_obj * cooked)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
	int ahx = ((pdf_output_processor*)proc)->ahxencode;
...
static void pdf_out_BMC(fz_context * ctx, pdf_processor * proc, const char * tag)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
	fz_write_printf(ctx, out, "%n BMC\n", tag);
}

static void pdf_out_BDC(fz_context * ctx, pdf_processor * proc, const char * tag, pdf_obj * raw, pdf_obj * cooked)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
	int ahx = ((pdf_output_processor*)proc)->ahxencode;
	fz_write_printf(ctx, out, "%n ", tag);
...
static void pdf_out_EMC(fz_context * ctx, pdf_processor * proc)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
...
static void pdf_out_BX(fz_context * ctx, pdf_processor * proc)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
	fz_write_string(ctx, out, "BX\n");
}

static void pdf_out_EX(fz_context * ctx, pdf_processor * proc)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
	fz_write_string(ctx, out, "EX\n");
}

static void pdf_close_output_processor(fz_context * ctx, pdf_processor * proc)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
	fz_close_output(ctx, out);
}

static void pdf_drop_output_processor(fz_context * ctx, pdf_processor * proc)
{
	fz_output * out = ((pdf_output_processor*)proc)->out;
