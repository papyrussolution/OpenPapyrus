...
typedef struct {
	...
	uchar marked;	/* marked to keep alive with pdf_mark_xref */
	ushort gen;	/* generation / objstm index */
...
pdf_obj * FASTCALL pdf_resolve_indirect_chain(fz_context *ctx, pdf_obj *ref);
