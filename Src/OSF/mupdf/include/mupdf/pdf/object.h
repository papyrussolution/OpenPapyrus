...
int STDCALL pdf_array_len(fz_context *ctx, pdf_obj *array);
pdf_obj * STDCALL pdf_array_get(fz_context *ctx, pdf_obj *array, int i);
...
pdf_obj * STDCALL pdf_dict_get(fz_context *ctx, pdf_obj *dict, pdf_obj *key);
...
pdf_obj * STDCALL pdf_dict_gets(fz_context *ctx, pdf_obj *dict, const char *key);
