...
pdf_obj *pdf_find_font_resource(fz_context *ctx, pdf_document *doc, int type, int encoding, fz_font *item, uchar md5[16]);
pdf_obj *pdf_insert_font_resource(fz_context *ctx, pdf_document *doc, uchar md5[16], pdf_obj *obj);
