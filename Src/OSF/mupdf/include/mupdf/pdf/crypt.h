...
uchar *pdf_crypt_owner_password(fz_context *ctx, pdf_crypt *crypt);
uchar *pdf_crypt_user_password(fz_context *ctx, pdf_crypt *crypt);
uchar *pdf_crypt_owner_encryption(fz_context *ctx, pdf_crypt *crypt);
uchar *pdf_crypt_user_encryption(fz_context *ctx, pdf_crypt *crypt);
uchar *pdf_crypt_permissions_encryption(fz_context *ctx, pdf_crypt *crypt);
...
void pdf_encrypt_data(fz_context *ctx, pdf_crypt *crypt, int num, int gen, void (*fmt_str_out)(fz_context *, void *, const uchar *, size_t), void *arg, const uchar *s, size_t n);
