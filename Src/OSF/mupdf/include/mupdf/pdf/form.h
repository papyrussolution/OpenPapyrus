...
typedef int (pdf_pkcs7_create_digest_fn)(fz_context * ctx, pdf_pkcs7_signer * signer, fz_stream * in, uchar * digest,
    size_t digest_len);
...
typedef pdf_signature_error (pdf_pkcs7_check_certificate_fn)(fz_context * ctx, pdf_pkcs7_verifier * verifier, uchar * signature,
    size_t len);
typedef pdf_signature_error (pdf_pkcs7_check_digest_fn)(fz_context * ctx, pdf_pkcs7_verifier * verifier, fz_stream * in,
    uchar * signature, size_t len);
typedef pdf_pkcs7_designated_name *(pdf_pkcs7_get_signatory_fn)(fz_context * ctx, pdf_pkcs7_verifier * verifier, uchar * signature,
    size_t len);
