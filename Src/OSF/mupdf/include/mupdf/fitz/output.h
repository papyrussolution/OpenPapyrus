...
void fz_write_uint16_le(fz_context *ctx, fz_output *out, uint x);
void fz_write_char(fz_context *ctx, fz_output *out, char x);
void fz_write_byte(fz_context *ctx, fz_output *out, uchar x);
...
/**
	...
	newlines.
*/
void fz_write_base64(fz_context *ctx, fz_output *out, const uchar *data, size_t size, int newline);
...
fz_output *fz_new_arc4_output(fz_context *ctx, fz_output *chain, uchar *key, size_t keylen);
