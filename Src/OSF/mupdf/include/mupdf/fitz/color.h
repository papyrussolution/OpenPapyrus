 ...
 */
fz_colorspace * FASTCALL fz_keep_colorspace(fz_context * ctx, const fz_colorspace * colorspace);
/**
 ...
 */
fz_colorspace * FASTCALL fz_device_gray(fz_context * ctx);
fz_colorspace * FASTCALL fz_device_rgb(fz_context * ctx);
fz_colorspace * FASTCALL fz_device_bgr(fz_context * ctx);
fz_colorspace * FASTCALL fz_device_cmyk(fz_context * ctx);
fz_colorspace * FASTCALL fz_device_lab(fz_context * ctx);
/**
