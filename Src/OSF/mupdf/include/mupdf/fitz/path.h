...
/**
	...
	modify a packed path.
*/
void STDCALL fz_curveto(fz_context *ctx, fz_path *path, float x0, float y0, float x1, float y1, float x2, float y2);
/**
	...
	modify a packed path.
*/
void STDCALL fz_curvetov(fz_context *ctx, fz_path *path, float x1, float y1, float x2, float y2);
/**
