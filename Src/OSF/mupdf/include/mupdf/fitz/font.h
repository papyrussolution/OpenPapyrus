...
extern const ushort fz_unicode_from_iso8859_1[256];
extern const ushort fz_unicode_from_iso8859_7[256];
extern const ushort fz_unicode_from_koi8u[256];
extern const ushort fz_unicode_from_pdf_doc_encoding[256];
extern const ushort fz_unicode_from_windows_1250[256];
extern const ushort fz_unicode_from_windows_1251[256];
extern const ushort fz_unicode_from_windows_1252[256];
...
*/
const uchar *fz_lookup_builtin_font(fz_context *ctx, const char *name, int bold, int italic, int *len);
...
/**
	...
	Returns a pointer to the font file data, or NULL if not present.
*/
const uchar *fz_lookup_base14_font(fz_context *ctx, const char *name, int *len);
...
/**
	...
	Returns a pointer to the font file data, or NULL if not present.
*/
const uchar *fz_lookup_cjk_font(fz_context *ctx, int ordering, int *len, int *index);
...
/**
	...
	Returns a pointer to the font file data, or NULL if not present.
*/
const uchar *fz_lookup_cjk_font_by_language(fz_context *ctx, const char *lang, int *len, int *subfont);
...
/**
	...
	Returns a pointer to the font file data, or NULL if not present.
*/
const uchar *fz_lookup_noto_font(fz_context *ctx, int script, int lang, int *len, int *subfont);
...
/**
	...
	configuration in which MuPDF is built.
*/
const uchar *fz_lookup_noto_math_font(fz_context *ctx, int *len);
const uchar *fz_lookup_noto_music_font(fz_context *ctx, int *len);
const uchar *fz_lookup_noto_symbol1_font(fz_context *ctx, int *len);
const uchar *fz_lookup_noto_symbol2_font(fz_context *ctx, int *len);
const uchar *fz_lookup_noto_emoji_font(fz_context *ctx, int *len);
...
struct fz_font {
	...
	ushort *t3flags; /* has 256 entries if used */
