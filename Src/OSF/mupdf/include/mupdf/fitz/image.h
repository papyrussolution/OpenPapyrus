...
/**
	Exposed for PDF.
*/
fz_pixmap *fz_load_jpx(fz_context *ctx, const uchar *data, size_t size, fz_colorspace *cs);
...
int fz_load_pnm_subimage_count(fz_context *ctx, const uchar *buf, size_t len);
fz_pixmap *fz_load_pnm_subimage(fz_context *ctx, const uchar *buf, size_t len, int subimage);
