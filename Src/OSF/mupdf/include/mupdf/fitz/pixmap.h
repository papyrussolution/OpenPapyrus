...
/**
	...
	allocate.
*/
fz_pixmap *fz_new_pixmap_with_data(fz_context *ctx, fz_colorspace *colorspace, int w, int h, fz_separations *seps, int alpha, int stride, uchar *samples);
...
/**
	...
	to allocate.
*/
fz_pixmap *fz_new_pixmap_with_bbox_and_data(fz_context *ctx, fz_colorspace *colorspace, fz_irect rect, fz_separations *seps, int alpha, uchar *samples);
...
/**
	...
	Returns the pointer.
*/
uchar *fz_pixmap_samples(fz_context *ctx, const fz_pixmap *pix);
...
void fz_md5_pixmap(fz_context *ctx, fz_pixmap *pixmap, uchar digest[16]);
