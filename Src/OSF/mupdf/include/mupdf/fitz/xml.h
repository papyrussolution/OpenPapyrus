...
*/
fz_xml * FASTCALL fz_xml_root(fz_xml_doc *xml);
/**
	Return previous sibling of XML node.
*/
fz_xml * FASTCALL fz_xml_prev(fz_xml *item);
/**
	Return next sibling of XML node.
*/
fz_xml * FASTCALL fz_xml_next(fz_xml *item);
/**
	Return parent of XML node.
*/
fz_xml * FASTCALL fz_xml_up(fz_xml *item);

/**
	Return first child of XML node.
*/
fz_xml * FASTCALL fz_xml_down(fz_xml *item);

/**
	Return true if the tag name matches.
*/
int FASTCALL fz_xml_is_tag(fz_xml *item, const char *name);
/**
	Return tag of XML node. Return NULL for text nodes.
*/
char * FASTCALL fz_xml_tag(fz_xml *item);
/**
	Return the value of an attribute of an XML node.
	NULL if the attribute doesn't exist.
*/
char * FASTCALL fz_xml_att(fz_xml *item, const char *att);
/**
	Return the value of an attribute of an XML node.
	If the first attribute doesn't exist, try the second.
	NULL if neither attribute exists.
*/
char * FASTCALL fz_xml_att_alt(fz_xml *item, const char *one, const char *two);
/**
...
*/
char * FASTCALL fz_xml_text(fz_xml *item);
...
*/
fz_xml * FASTCALL fz_xml_find(fz_xml *item, const char *tag);
...
/**
	...
	Return NULL if none found.
*/
fz_xml * FASTCALL fz_xml_find_next(fz_xml *item, const char *tag);
...
/**
	...
	Return NULL if none found.
*/
fz_xml * FASTCALL fz_xml_find_down(fz_xml *item, const char *tag);
/**
	Search the siblings of XML nodes starting with item looking for
