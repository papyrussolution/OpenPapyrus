...
/**
	...
	Never throws an exception.
*/
void fz_md5_update(fz_md5 *state, const uchar *input, size_t inlen);
...
/**
	...
	Never throws an exception.
*/
void fz_md5_final(fz_md5 *state, uchar digest[16]);
...
/**
	...
	Never throws an exception.
*/
void fz_sha256_update(fz_sha256 *state, const uchar *input, size_t inlen);
...
/**
	...
	Never throws an exception.
*/
void fz_sha256_final(fz_sha256 *state, uchar digest[32]);
...
/**
	...
	Never throws an exception.
*/
void fz_sha512_update(fz_sha512 *state, const uchar *input, size_t inlen);
...
/**
	...
	Never throws an exception.
*/
void fz_sha512_final(fz_sha512 *state, uchar digest[64]);
...
/**
	...
	Never throws an exception.
*/
void fz_sha384_update(fz_sha384 *state, const uchar *input, size_t inlen);
...
/**
	...
	Never throws an exception.
*/
void fz_sha384_final(fz_sha384 *state, uchar digest[64]);
...
/**
	...
	Never throws an exception.
*/
void fz_arc4_init(fz_arc4 *state, const uchar *key, size_t len);
...
/**
	...
	Never throws an exception.
*/
void fz_arc4_encrypt(fz_arc4 *state, uchar *dest, const uchar *src, size_t len);
...
/**
	...
	Never throws an exception.
*/
int fz_aes_setkey_enc(fz_aes *ctx, const uchar *key, int keysize);
...
/**
	...
	Never throws an exception.
*/
int fz_aes_setkey_dec(fz_aes *ctx, const uchar *key, int keysize);
