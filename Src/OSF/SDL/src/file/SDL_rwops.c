...
static Sint64 SDLCALL windows_file_read(SDL_RWops * context, void * ptr, Sint64 size)
{
...
static Sint64 SDLCALL windows_file_write(SDL_RWops * context, const void * ptr, Sint64 size)
{
...
static Sint64 SDLCALL stdio_read(SDL_RWops * context, void * ptr, Sint64 size)
{
	size_t nread;
...
static Sint64 SDLCALL stdio_write(SDL_RWops * context, const void * ptr, Sint64 size)
{
	size_t nwrote;
...
static Sint64 SDLCALL mem_read(SDL_RWops * context, void * ptr, Sint64 size)
{
	return mem_io(context, ptr, context->hidden.mem.here, size);
}

static Sint64 SDLCALL mem_write(SDL_RWops * context, const void * ptr, Sint64 size)
{
	return mem_io(context, context->hidden.mem.here, ptr, size);
}

static Sint64 SDLCALL mem_writeconst(SDL_RWops * context, const void * ptr, Sint64 size)
{
...
{
	SDL_RWops * area = (SDL_RWops *)SDL_malloc(sizeof(*area));
	if(area == NULL) {
		SDL_OutOfMemory();
	}
	else {
