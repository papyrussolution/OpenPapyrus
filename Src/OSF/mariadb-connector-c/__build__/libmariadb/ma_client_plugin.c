...
extern /*struct st_mysql_client_plugin*/struct st_mysql_client_plugin_AUTHENTICATION mysql_old_password_client_plugin;
...
struct st_mysql_client_plugin * STDCALL mysql_client_register_plugin(MYSQL * mysql, struct st_mysql_client_plugin * plugin)
{
	...
	if(find_plugin(plugin->name, plugin->type)) {
		my_set_error(mysql, CR_AUTH_PLUGIN_CANNOT_LOAD, SQLSTATE_UNKNOWN, ER(CR_AUTH_PLUGIN_CANNOT_LOAD), plugin->name, "it is already loaded");
		plugin = NULL;
	}
	else
