...
/**
   ...
   @todo
     see if it is possible to get rid of SAlloc::M().
     this constant is sufficient to avoid SAlloc::M() on all inputs I have tried.
 */
    ...
    char ** rve, char * buf, size_t buf_size)
{
	...
	memzero(alloc.freelist, sizeof(alloc.freelist));
	u.d = dd;
	if(word0(&u) & Sign_bit) {
