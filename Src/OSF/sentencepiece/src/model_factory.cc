...
namespace sentencepiece {
	...
	std::unique_ptr<ModelInterface> ModelFactory::Create(const ModelProto& model_proto) 
	{
		...
		switch(trainer_spec.model_type()) {
			...
			case TrainerSpec::WORD: return absl::make_unique<word::Model>(model_proto); break;
			case TrainerSpec::CHAR: return absl::make_unique<character::Model>(model_proto); break;
			default:
