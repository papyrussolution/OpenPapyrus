...
public:
	...
	NBestEncodeResult SampleEncodeAndScore(absl::string_view normalized, float theta, int samples, bool wor, bool include_best) const override;
	...
	EncoderVersion GetEncoderVersion() const {
