...
ABSL_FLAG(bool, use_internal_normalization, false, "Use NormalizerSpec \"as-is\" to run the normalizer for SentencePiece segmentation");
ABSL_FLAG(std::string, normalization_rule_name, "", "Normalization rule name. Choose from nfkc or identity");
