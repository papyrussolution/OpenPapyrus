...
struct TestEmbedOptimizedForSizeDefaultTypeInternal {
	constexpr TestEmbedOptimizedForSizeDefaultTypeInternal() : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable * descriptor_table_google_2fprotobuf_2funittest_5fembed_5foptimize_5ffor_2eproto_getter() { return &descriptor_table_google_2fprotobuf_2funittest_5fembed_5foptimize_5ffor_2eproto; }
...
uint8_t* TestEmbedOptimizedForSize::_InternalSerialize(
  ...
  if(cached_has_bits & 0x00000001u) {
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::InternalWriteMessage(1, _Internal::optional_message(this), target, stream);
  }

  // repeated .protobuf_unittest.TestOptimizedForSize repeated_message = 2;
  for(unsigned int i = 0, n = static_cast<unsigned int>(this->_internal_repeated_message_size()); i < n; i++) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::InternalWriteMessage(2, this->_internal_repeated_message(i), target, stream);
  }
...
// @@protoc_insertion_point(message_byte_size_start:protobuf_unittest.TestEmbedOptimizedForSize)
  ...
  cached_has_bits = _has_bits_[0];
  if(cached_has_bits & 0x00000001u) {
    total_size += 1 + ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::MessageSize(*optional_message_);
  }
