...
class LazyMessage final :
 ...
 public:
  ...
  LazyMessage(LazyMessage&& from) noexcept : LazyMessage() {
    *this = ::std::move(from);
  }
  ...
  static const LazyMessage& default_instance() { return *internal_default_instance(); }
  static inline const LazyMessage* internal_default_instance() {
    return reinterpret_cast<const LazyMessage*>(&_LazyMessage_default_instance_); }
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() { return "protobuf_unittest.lazy_imports.LazyMessage"; }
  protected:
  explicit LazyMessage(::PROTOBUF_NAMESPACE_ID::Arena* arena, bool is_message_owned = false);
  private:
...
inline int32_t LazyMessage::_internal_a() const { return a_; }
