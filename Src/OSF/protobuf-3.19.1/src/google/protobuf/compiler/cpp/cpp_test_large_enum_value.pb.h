...
#ifndef GOOGLE_PROTOBUF_INCLUDED_cpp_5ftest_5flarge_5fenum_5fvalue_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_cpp_5ftest_5flarge_5fenum_5fvalue_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_cpp_5ftest_5flarge_5fenum_5fvalue_2eproto
...
struct TableStruct_cpp_5ftest_5flarge_5fenum_5fvalue_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_cpp_5ftest_5flarge_5fenum_5fvalue_2eproto;
...
class TestLargeEnumValue final :
 ...
 public:
  ...
  TestLargeEnumValue(TestLargeEnumValue&& from) noexcept : TestLargeEnumValue() {
    *this = ::std::move(from);
  }
  ...
  static const TestLargeEnumValue& default_instance() { return *internal_default_instance(); }
  static inline const TestLargeEnumValue* internal_default_instance() {
    return reinterpret_cast<const TestLargeEnumValue*>(&_TestLargeEnumValue_default_instance_); }
  ...
  inline void CopyFrom(const TestLargeEnumValue& from) { ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::CopyImpl(this, from); }
  using ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::MergeFrom;
  void MergeFrom(const TestLargeEnumValue& from) { ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::MergeImpl(this, from); }
  public:

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() { return "protobuf_unittest.TestLargeEnumValue"; }
  protected:
  explicit TestLargeEnumValue(::PROTOBUF_NAMESPACE_ID::Arena* arena, bool is_message_owned = false);
  private:
  public:
 ...
 private:
  ...
  friend struct ::TableStruct_cpp_5ftest_5flarge_5fenum_5fvalue_2eproto;
};
// ===================================================================
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_cpp_5ftest_5flarge_5fenum_5fvalue_2eproto
