...
class PublicImportMessage final :
 ...
 public:
  ...
  static const PublicImportMessage& default_instance() { return *internal_default_instance(); }
  static inline const PublicImportMessage* internal_default_instance() {
    return reinterpret_cast<const PublicImportMessage*>(&_PublicImportMessage_default_instance_); }
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() { return "protobuf_unittest_import.PublicImportMessage"; }
  protected:
  explicit PublicImportMessage(::PROTOBUF_NAMESPACE_ID::Arena* arena, bool is_message_owned = false);
  private:
...
inline int32_t PublicImportMessage::_internal_e() const { return e_; }
