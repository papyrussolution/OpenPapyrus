...
struct OneOfsRequestDefaultTypeInternal {
	constexpr OneOfsRequestDefaultTypeInternal() : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
struct RequestWithSimpleOneofDefaultTypeInternal {
	constexpr RequestWithSimpleOneofDefaultTypeInternal() : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable * descriptor_table_google_2fprotobuf_2futil_2finternal_2ftestdata_2foneofs_2eproto_getter() { return &descriptor_table_google_2fprotobuf_2futil_2finternal_2ftestdata_2foneofs_2eproto; }
...
uint8_t* OneOfsRequest::_InternalSerialize(
  ...
  if(_internal_has_str_data()) {
    ...
    target = stream->WriteStringMaybeAliased(2, this->_internal_str_data(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:proto_util_converter.testing.oneofs.OneOfsRequest)
  ...
  switch(data_case()) {
    // string str_data = 2;
    case kStrData: {
      total_size += 1 + ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::StringSize(this->_internal_str_data());
      break;
    }
    // int32 int_data = 3;
    case kIntData: {
...
::PROTOBUF_NAMESPACE_ID::Metadata OneOfsRequest::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_google_2fprotobuf_2futil_2finternal_2ftestdata_2foneofs_2eproto_getter, &descriptor_table_google_2fprotobuf_2futil_2finternal_2ftestdata_2foneofs_2eproto_once, file_level_metadata_google_2fprotobuf_2futil_2finternal_2ftestdata_2foneofs_2eproto[0]);
}
...
MoreData::MoreData(const MoreData& from)
  ...
  if(!from._internal_str_value().empty()) {
    str_value_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, from._internal_str_value(), GetArenaForAllocation());
  }
...
uint8_t* MoreData::_InternalSerialize(
  ...
  if(!this->_internal_str_value().empty()) {
    ...
    target = stream->WriteStringMaybeAliased(1, this->_internal_str_value(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:proto_util_converter.testing.oneofs.MoreData)
  ...
  // string str_value = 1;
  if(!this->_internal_str_value().empty()) {
    total_size += 1 + ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::StringSize(this->_internal_str_value());
  }
