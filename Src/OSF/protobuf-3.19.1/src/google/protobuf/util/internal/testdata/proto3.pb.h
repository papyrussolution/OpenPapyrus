...
class Proto3Message final :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() { return "proto_util_converter.testing.Proto3Message"; }
  protected:
  explicit Proto3Message(::PROTOBUF_NAMESPACE_ID::Arena* arena, bool is_message_owned = false);
  private:
...
inline ::proto_util_converter::testing::Proto3Message_NestedEnum Proto3Message::_internal_enum_value() const { return static_cast< ::proto_util_converter::testing::Proto3Message_NestedEnum >(enum_value_); }
