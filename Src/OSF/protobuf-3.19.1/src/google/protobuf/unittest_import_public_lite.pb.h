...
class PublicImportMessageLite final :
 ...
 public:
  ...
  PublicImportMessageLite(PublicImportMessageLite&& from) noexcept : PublicImportMessageLite() {
    *this = ::std::move(from);
  }
  ...
  static const PublicImportMessageLite& default_instance() { return *internal_default_instance(); }
  static inline const PublicImportMessageLite* internal_default_instance() {
    return reinterpret_cast<const PublicImportMessageLite*>(&_PublicImportMessageLite_default_instance_); }
