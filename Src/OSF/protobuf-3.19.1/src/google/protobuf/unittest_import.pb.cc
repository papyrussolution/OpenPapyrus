...
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable * descriptor_table_google_2fprotobuf_2funittest_5fimport_2eproto_getter() { return &descriptor_table_google_2fprotobuf_2funittest_5fimport_2eproto; }
