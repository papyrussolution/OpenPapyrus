...
class MyMessage final :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() { return "proto3_preserve_unknown_enum_unittest.MyMessage"; }
  protected:
...
class MyMessagePlusExtra final :
 ...
 public:
  ...
  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() { return "proto3_preserve_unknown_enum_unittest.MyMessagePlusExtra"; }
  protected:
  explicit MyMessagePlusExtra(::PROTOBUF_NAMESPACE_ID::Arena* arena, bool is_message_owned = false);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
...
inline ::proto3_preserve_unknown_enum_unittest::MyEnum MyMessage::_internal_e() const { return static_cast< ::proto3_preserve_unknown_enum_unittest::MyEnum >(e_); }
...
inline ::proto3_preserve_unknown_enum_unittest::MyEnumPlusExtra MyMessagePlusExtra::_internal_e() const { return static_cast< ::proto3_preserve_unknown_enum_unittest::MyEnumPlusExtra >(e_); }
