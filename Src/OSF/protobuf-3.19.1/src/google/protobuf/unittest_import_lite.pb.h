...
class ImportMessageLite final :
 ...
 public:
  ...
  ImportMessageLite(ImportMessageLite&& from) noexcept : ImportMessageLite() {
    *this = ::std::move(from);
  }
  ...
  static const ImportMessageLite& default_instance() { return *internal_default_instance(); }
  static inline const ImportMessageLite* internal_default_instance() {
    return reinterpret_cast<const ImportMessageLite*>(&_ImportMessageLite_default_instance_); }
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() { return "protobuf_unittest_import.ImportMessageLite"; }
  protected:
  explicit ImportMessageLite(::PROTOBUF_NAMESPACE_ID::Arena* arena, bool is_message_owned = false);
  private:
...
inline int32_t ImportMessageLite::_internal_d() const { return d_; }
