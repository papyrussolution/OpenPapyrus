...
static cairo_quartz_surface_t * _cairo_quartz_surface_create_internal(CGContextRef cgContext,
...
CGImageRef CairoQuartzCreateCGImage(cairo_format_t format,
    uint width,
    uint height,
    uint stride,
    void * data,
...
static cairo_status_t _cairo_path_to_quartz_context_move_to(void * closure,
...
static cairo_status_t _cairo_path_to_quartz_context_line_to(void * closure,
    const cairo_point_t * point)
{
...
static cairo_status_t _cairo_path_to_quartz_context_curve_to(void * closure,
...
static cairo_status_t _cairo_path_to_quartz_context_close_path(void * closure)
{
	//ND ((stderr, "closepath\n"));
...
static cairo_int_status_t _cairo_quartz_surface_set_cairo_operator(cairo_quartz_surface_t * surface, cairo_operator_t op)
{
...
static inline CGLineCap _cairo_quartz_cairo_line_cap_to_quartz(cairo_line_cap_t ccap)
{
	switch(ccap) {
		default:
		    ASSERT_NOT_REACHED;
...
static inline CGLineJoin _cairo_quartz_cairo_line_join_to_quartz(cairo_line_join_t cjoin)
{
	switch(cjoin) {
		default:
		    ASSERT_NOT_REACHED;
...
static inline CGInterpolationQuality _cairo_quartz_filter_to_quartz(cairo_filter_t filter)
{
...
static inline void _cairo_quartz_cairo_matrix_to_quartz(const cairo_matrix_t * src,
...
static void ComputeGradientValue(void * info,
    ...
    CGImageRef * image_out)
{
	...
	source_img = SAlloc::M_zon0(sizeof(quartz_source_image_t));
...
static void SurfacePatternReleaseInfoFunc(void * ainfo)
{
	SurfacePatternDrawInfo * info = (SurfacePatternDrawInfo*)ainfo;
    ...
    CGPatternRef * cgpat)
{
	...
	info = SAlloc::M_zon0(sizeof(SurfacePatternDrawInfo));
	if(UNLIKELY(!info))
	...
	ND((stderr, "  pattern xform: t: %f %f xx: %f xy: %f yx: %f yy: %f\n", ptransform.tx, ptransform.ty, ptransform.a, ptransform.b,
 ...
 */
static cairo_int_status_t _cairo_quartz_setup_gradient_source(cairo_quartz_drawing_state_t * state,
...
static cairo_int_status_t _cairo_quartz_setup_state(cairo_quartz_drawing_state_t * state,
...
static void _cairo_quartz_teardown_state(cairo_quartz_drawing_state_t * state,
...
static void _cairo_quartz_draw_source(cairo_quartz_drawing_state_t * state,
    cairo_operator_t op)
{
...
static cairo_image_surface_t * _cairo_quartz_surface_map_to_image(void * abstract_surface,
    const cairo_rectangle_int_t * extents)
{
	cairo_quartz_surface_t * surface = (cairo_quartz_surface_t*)abstract_surface;
	uint stride, bitinfo, bpp, color_comps;
...
static cairo_int_status_t _cairo_quartz_surface_unmap_image(void * abstract_surface,
...
static void _cairo_quartz_surface_release_source_image(void * abstract_surface,
    cairo_image_surface_t * image,
    void * image_extra)
{
...
static cairo_surface_t * _cairo_quartz_surface_create_similar(void * abstract_surface,
    cairo_content_t content,
    int width,
    int height)
{
...
static cairo_int_status_t _cairo_quartz_cg_paint(const cairo_compositor_t * compositor,
    cairo_composite_rectangles_t * extents)
{
...
static cairo_int_status_t _cairo_quartz_cg_mask_with_surface(cairo_composite_rectangles_t * extents,
...
static cairo_int_status_t _cairo_quartz_cg_mask_with_solid(cairo_quartz_surface_t * surface,
    cairo_composite_rectangles_t * extents)
{
	cairo_quartz_drawing_state_t state;
...
static cairo_int_status_t _cairo_quartz_cg_mask(const cairo_compositor_t * compositor,
    cairo_composite_rectangles_t * extents)
{
	cairo_quartz_surface_t * surface = (cairo_quartz_surface_t*)extents->surface;
...
static cairo_int_status_t _cairo_quartz_cg_fill(const cairo_compositor_t * compositor,
    cairo_composite_rectangles_t * extents,
...
static cairo_int_status_t _cairo_quartz_cg_stroke(const cairo_compositor_t * compositor,
    cairo_composite_rectangles_t * extents,
    const cairo_path_fixed_t * path,
    ...
    cairo_antialias_t antialias)
{
	...
	if(style->dash && style->num_dashes) {
		...
		uint max_dashes = style->num_dashes;
		uint k;
...
static cairo_int_status_t _cairo_quartz_cg_glyphs(const cairo_compositor_t * compositor,
    cairo_composite_rectangles_t * extents,
...
static cairo_int_status_t _cairo_quartz_surface_paint(void * surface,
    cairo_operator_t op,
...
static cairo_int_status_t _cairo_quartz_surface_mask(void * surface,
    cairo_operator_t op,
    const cairo_pattern_t * source,
...
static cairo_int_status_t _cairo_quartz_surface_fill(void * surface,
    cairo_operator_t op,
    const cairo_pattern_t * source,
    const cairo_path_fixed_t * path,
    cairo_fill_rule_t fill_rule,
...
static cairo_int_status_t _cairo_quartz_surface_stroke(void * surface,
    cairo_operator_t op,
    const cairo_pattern_t * source,
    const cairo_path_fixed_t * path,
    const cairo_stroke_style_t * style,
...
static cairo_int_status_t _cairo_quartz_surface_glyphs(void * surface,
    cairo_operator_t op,
    const cairo_pattern_t * source,
    cairo_glyph_t * glyphs,
    int num_glyphs,
...
cairo_quartz_surface_t * _cairo_quartz_surface_create_internal(CGContextRef cgContext, cairo_content_t content, uint width, uint height)
{
	cairo_quartz_surface_t * surface;
	quartz_ensure_symbols();
	/* Init the base surface */
	surface = SAlloc::M_zon0(sizeof(cairo_quartz_surface_t));
	if(UNLIKELY(!surface))
...
void quartz_image_to_png(CGImageRef imgref, char * dest)
{
	static int sctr = 0;
...
void quartz_surface_to_png(cairo_quartz_surface_t * nq, char * dest)
{
	static int sctr = 0;
...
#endif /* QUARTZ_DEBUG */
#endif // } 0 CAIRO_HAS_QUARTZ_SURFACE