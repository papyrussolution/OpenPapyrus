 ...
 * Since: 1.12
 **/
void cairo_raster_source_pattern_set_callback_data(cairo_pattern_t * abstract_pattern, void * data)
{
	cairo_raster_source_pattern_t * pattern;
 ...
 * Since: 1.12
 **/
void cairo_raster_source_pattern_set_acquire(cairo_pattern_t * abstract_pattern, cairo_raster_source_acquire_func_t acquire, cairo_raster_source_release_func_t release)
{
	cairo_raster_source_pattern_t * pattern;
	if(abstract_pattern->type != CAIRO_PATTERN_TYPE_RASTER_SOURCE)
		return;
 ...
 * Since: 1.12
 **/
void cairo_raster_source_pattern_get_acquire(cairo_pattern_t * abstract_pattern, cairo_raster_source_acquire_func_t * acquire, cairo_raster_source_release_func_t * release)
{
	cairo_raster_source_pattern_t * pattern;
	if(abstract_pattern->type != CAIRO_PATTERN_TYPE_RASTER_SOURCE)
		return;
 ...
 * Since: 1.12
 **/
void cairo_raster_source_pattern_set_snapshot(cairo_pattern_t * abstract_pattern, cairo_raster_source_snapshot_func_t snapshot)
{
	cairo_raster_source_pattern_t * pattern;
	if(abstract_pattern->type != CAIRO_PATTERN_TYPE_RASTER_SOURCE)
		return;
 ...
 * Since: 1.12
 **/
void cairo_raster_source_pattern_set_copy(cairo_pattern_t * abstract_pattern, cairo_raster_source_copy_func_t copy)
{
	cairo_raster_source_pattern_t * pattern;
	if(abstract_pattern->type != CAIRO_PATTERN_TYPE_RASTER_SOURCE)
		return;
 ...
 * Since: 1.12
 **/
void cairo_raster_source_pattern_set_finish(cairo_pattern_t * abstract_pattern, cairo_raster_source_finish_func_t finish)
{
	cairo_raster_source_pattern_t * pattern;
	if(abstract_pattern->type != CAIRO_PATTERN_TYPE_RASTER_SOURCE)
		return;
