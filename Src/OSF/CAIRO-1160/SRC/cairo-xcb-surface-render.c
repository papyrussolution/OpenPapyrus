...
static cairo_status_t _clip_and_composite_boxes(cairo_xcb_surface_t * dst,
    cairo_operator_t op,
    const cairo_pattern_t * src,
    cairo_boxes_t * boxes,
    cairo_composite_rectangles_t * extents);

static inline cairo_xcb_connection_t * _picture_to_connection(cairo_xcb_picture_t * picture)
{
...
static cairo_status_t _cairo_xcb_picture_finish(void * abstract_surface)
{
...
{
	cairo_xcb_picture_t * surface = SAlloc::M_zon0(sizeof(cairo_xcb_picture_t));
	if(UNLIKELY(!surface))
...
static int _render_operator(cairo_operator_t op)
{
...
static void _cairo_xcb_surface_set_precision(cairo_xcb_surface_t * surface,
...
static cairo_xcb_picture_t * _picture_from_image(cairo_xcb_surface_t * target,
...
static void _cairo_xcb_picture_set_matrix(cairo_xcb_picture_t * picture,
...
static cairo_xcb_picture_t * _solid_picture(cairo_xcb_surface_t * target,
...
static cairo_xcb_picture_t * _cairo_xcb_transparent_picture(cairo_xcb_surface_t * target)
{
	cairo_xcb_picture_t * picture;
...
static cairo_xcb_picture_t * _cairo_xcb_black_picture(cairo_xcb_surface_t * target)
{
	cairo_xcb_picture_t * picture;
...
static cairo_xcb_picture_t * _cairo_xcb_white_picture(cairo_xcb_surface_t * target)
{
	cairo_xcb_picture_t * picture;
...
static cairo_xcb_picture_t * _cairo_xcb_solid_picture(cairo_xcb_surface_t * target,
...
static cairo_xcb_picture_t * _render_to_picture(cairo_xcb_surface_t * target,
    const cairo_pattern_t * pattern,
...
static xcb_render_fixed_t * _gradient_to_xcb(const cairo_gradient_pattern_t * gradient,
    uint * n_stops,
...
static cairo_xcb_picture_t * _cairo_xcb_linear_picture(cairo_xcb_surface_t * target,
...
static cairo_xcb_picture_t * _cairo_xcb_radial_picture(cairo_xcb_surface_t * target,
...
static cairo_xcb_picture_t * _cairo_xcb_surface_picture(cairo_xcb_surface_t * target,
...
static cairo_xcb_picture_t * _cairo_xcb_picture_for_pattern(cairo_xcb_surface_t * target,
    const cairo_pattern_t * pattern,
    const cairo_rectangle_int_t * extents)
{
	if(pattern == NULL)
...
static cairo_status_t _render_fill_boxes(void * abstract_dst,
    cairo_operator_t op,
    const cairo_color_t * color,
    cairo_boxes_t * boxes)
{
...
static cairo_int_status_t _render_composite_boxes(cairo_xcb_surface_t * dst, cairo_operator_t op,
    const cairo_pattern_t * src_pattern, const cairo_pattern_t * mask_pattern, const cairo_rectangle_int_t * extents,
...
static cairo_int_status_t _composite_traps(void * closure,
...
static cairo_xcb_surface_t * get_clip_surface(const cairo_clip_t * clip,
...
static cairo_xcb_surface_t * _create_composite_mask(cairo_clip_t * clip,
...
static cairo_status_t _cairo_xcb_surface_fixup_unbounded(cairo_xcb_surface_t * dst,
...
static cairo_status_t _cairo_xcb_surface_fixup_unbounded_with_mask(cairo_xcb_surface_t * dst,
    const cairo_composite_rectangles_t * rects,
    cairo_clip_t * clip)
{
	cairo_xcb_surface_t * mask;
    ...
    cairo_boxes_t * boxes)
{
	...
	if(LIKELY(status == CAIRO_STATUS_SUCCESS)) {
		if(dst->connection->flags & CAIRO_XCB_RENDER_HAS_FILL_RECTANGLES)
			...
			status = _cairo_xcb_surface_core_fill_boxes(dst, CAIRO_COLOR_TRANSPARENT, &clear);
	}
	_cairo_boxes_fini(&clear);
	return status;
}

cairo_status_t _cairo_xcb_surface_clear(cairo_xcb_surface_t * dst)
{
	xcb_gcontext_t gc;
	xcb_rectangle_t rect;
	cairo_status_t status;
...
static cairo_status_t _clip_and_composite(cairo_xcb_surface_t * dst,
    cairo_operator_t op,
    const cairo_pattern_t * src,
    xcb_draw_func_t draw_func,
    xcb_draw_func_t mask_func,
...
static cairo_status_t _core_boxes(cairo_xcb_surface_t * dst,
    cairo_operator_t op,
    const cairo_pattern_t * src,
    cairo_boxes_t * boxes,
    const cairo_composite_rectangles_t * extents)
...
static cairo_status_t _composite_boxes(cairo_xcb_surface_t * dst,
    cairo_operator_t op,
    const cairo_pattern_t * src,
    cairo_boxes_t * boxes,
    const cairo_composite_rectangles_t * extents)
...
static cairo_status_t _upload_image_inplace(cairo_xcb_surface_t * surface,
...
static cairo_int_status_t _composite_mask(void * closure,
    cairo_xcb_surface_t * dst,
    cairo_operator_t op,
...
static cairo_int_status_t _composite_mask_clip_boxes(void * closure,
    cairo_xcb_surface_t * dst,
    cairo_operator_t op,
    const cairo_pattern_t * src_pattern,
    int dst_x,
...
static cairo_int_status_t _composite_mask_clip(void * closure,
    cairo_xcb_surface_t * dst,
    cairo_operator_t op,
    const cairo_pattern_t * src_pattern,
    int dst_x,
...
static cairo_int_status_t _composite_opacity_boxes(void * closure,
    cairo_xcb_surface_t * dst,
    cairo_operator_t op,
    const cairo_pattern_t * src_pattern,
    int dst_x,
...
cairo_int_status_t _cairo_xcb_render_compositor_paint(const cairo_compositor_t * compositor,
...
cairo_int_status_t _cairo_xcb_render_compositor_mask(const cairo_compositor_t * compositor,
    cairo_composite_rectangles_t * composite)
{
	cairo_xcb_surface_t * surface = (cairo_xcb_surface_t*)composite->surface;
	cairo_operator_t op = composite->op;
...
static cairo_int_status_t _cairo_xcb_surface_render_stroke_as_polygon(cairo_xcb_surface_t * dst,
    cairo_operator_t op,
    const cairo_pattern_t * source,
...
static cairo_status_t _cairo_xcb_surface_render_stroke_via_mask(cairo_xcb_surface_t * dst,
    cairo_operator_t op,
    const cairo_pattern_t * source,
    const cairo_path_fixed_t * path,
    const cairo_stroke_style_t * stroke_style,
...
cairo_int_status_t _cairo_xcb_render_compositor_stroke(const cairo_compositor_t * compositor,
    cairo_composite_rectangles_t * composite,
    const cairo_path_fixed_t * path,
...
static cairo_status_t _cairo_xcb_surface_render_fill_as_polygon(cairo_xcb_surface_t * dst,
    cairo_operator_t op,
    const cairo_pattern_t* source,
    const cairo_path_fixed_t * path,
    cairo_fill_rule_t fill_rule,
...
static cairo_status_t _cairo_xcb_surface_render_fill_via_mask(cairo_xcb_surface_t * dst,
    cairo_operator_t op,
    const cairo_pattern_t * source,
    const cairo_path_fixed_t * path,
    cairo_fill_rule_t fill_rule,
...
cairo_int_status_t _cairo_xcb_render_compositor_fill(const cairo_compositor_t * compositor,
    cairo_composite_rectangles_t * composite,
    const cairo_path_fixed_t * path,
    cairo_fill_rule_t fill_rule,
    double tolerance,
...
static cairo_status_t _cairo_xcb_surface_render_glyphs_via_mask(cairo_xcb_surface_t * dst,
    cairo_operator_t op,
    const cairo_pattern_t * source,
...
#define GLYPH_CACHE_SIZE 64
	...
	ulong glyph_cache[GLYPH_CACHE_SIZE];
...
static void _cairo_xcb_font_destroy(cairo_xcb_font_t * font)
{
	int i;
...
static cairo_xcb_font_t * _cairo_xcb_font_create(cairo_xcb_connection_t * connection,
    cairo_scaled_font_t * font)
{
	cairo_xcb_font_t * priv;
	int i;

	priv = SAlloc::M_zon0(sizeof(cairo_xcb_font_t));
...
void _cairo_xcb_font_close(cairo_xcb_font_t * font)
{
	cairo_scaled_font_t * scaled_font;
...
static void _cairo_xcb_render_free_glyphs(cairo_xcb_connection_t * connection,
...
static int _cairo_xcb_get_glyphset_index_for_format(cairo_format_t format)
{
...
static inline cairo_xcb_font_t * _cairo_xcb_font_get(const cairo_xcb_connection_t * c,
    cairo_scaled_font_t * font)
{
	return (cairo_xcb_font_t*)_cairo_scaled_font_find_private(font, c);
}

static cairo_xcb_font_glyphset_info_t * _cairo_xcb_scaled_font_get_glyphset_info_for_format(cairo_xcb_connection_t * c,
    cairo_scaled_font_t * font,
    cairo_format_t format)
{
	cairo_xcb_font_t * priv;
...
static cairo_xcb_font_glyphset_info_t * _cairo_xcb_scaled_font_get_glyphset_info_for_pending_free_glyph(cairo_xcb_connection_t * c,
    cairo_scaled_font_t * font,
    ulong glyph_index,
    ...
    cairo_scaled_glyph_t * glyph, cairo_scaled_font_t * font)
{
	...
	if(!font->finished) {
		...
		if(to_free == NULL) {
			to_free = SAlloc::M_zon0(sizeof(cairo_xcb_font_glyphset_free_glyphs_t));
...
static cairo_status_t _cairo_xcb_surface_add_glyph(cairo_xcb_connection_t * connection,
    cairo_scaled_font_t * font,
    ...
    xcb_render_pictformat_t mask_format)
{
	...
	if(estimated_req_size > ARRAY_LENGTH(stack_buf)) {
		buf = SAlloc::M_zon0(estimated_req_size);
...
static cairo_int_status_t _composite_glyphs(void * closure,
    cairo_xcb_surface_t * dst,
    cairo_operator_t op,
    const cairo_pattern_t * pattern,
    int dst_x,
    ...
    cairo_clip_t * clip)
{
	...
	const uint max_request_size = dst->connection->maximum_request_length - 64;
	cairo_xcb_picture_t * src;
...
cairo_int_status_t _cairo_xcb_render_compositor_glyphs(const cairo_compositor_t * compositor,
    cairo_composite_rectangles_t * composite,
    cairo_scaled_font_t * scaled_font,
    cairo_glyph_t * glyphs,
    int num_glyphs,
