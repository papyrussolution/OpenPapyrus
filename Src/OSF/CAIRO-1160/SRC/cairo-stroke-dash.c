...
void _cairo_stroker_dash_step(cairo_stroker_dash_t * dash, double step)
{
...
void _cairo_stroker_dash_init(cairo_stroker_dash_t * dash, const cairo_stroke_style_t * style)
{
