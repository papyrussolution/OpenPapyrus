...
static cairo_status_t _cairo_gl_bounded_opaque_spans(void * abstract_renderer,
    int y, int height,
...
static cairo_status_t _cairo_gl_bounded_spans(void * abstract_renderer,
    int y, int height,
    const cairo_half_open_span_t * spans,
    unsigned num_spans)
{
...
static cairo_status_t _cairo_gl_unbounded_spans(void * abstract_renderer,
    int y, int height,
    const cairo_half_open_span_t * spans,
    unsigned num_spans)
{
...
/* XXX */
static cairo_status_t _cairo_gl_clipped_spans(void * abstract_renderer,
    int y, int height,
    const cairo_half_open_span_t * spans,
    unsigned num_spans)
{
...
static void emit_aligned_boxes(cairo_gl_context_t * ctx, const cairo_boxes_t * boxes)
{
...
static cairo_int_status_t fill_boxes(void * _dst,
    cairo_operator_t op,
...
static void _cairo_gl_span_renderer_fini(cairo_abstract_span_renderer_t * _r,
    cairo_int_status_t status)
{
	cairo_gl_span_renderer_t * r = (cairo_gl_span_renderer_t*)_r;
...
const cairo_compositor_t * _cairo_gl_span_compositor_get(void)
{
