...
#if CAIRO_HAS_DLSYM
static void * _cairo_gl_dispatch_open_lib(void)
{
	return dlopen(NULL, RTLD_LAZY);
}

static void _cairo_gl_dispatch_close_lib(void * handle)
{
	dlclose(handle);
}

static cairo_gl_generic_func_t _cairo_gl_dispatch_get_proc_addr(void * handle, const char * name)
{
...
static void _cairo_gl_dispatch_init_entries(cairo_gl_dispatch_t * dispatch,
...
static cairo_status_t _cairo_gl_dispatch_init_buffers(cairo_gl_dispatch_t * dispatch,
    cairo_gl_get_proc_addr_func_t get_proc_addr,
...
static cairo_status_t _cairo_gl_dispatch_init_shaders(cairo_gl_dispatch_t * dispatch,
    cairo_gl_get_proc_addr_func_t get_proc_addr,
    int gl_version, cairo_gl_flavor_t gl_flavor)
{
	cairo_gl_dispatch_name_t dispatch_name;
...
static cairo_status_t _cairo_gl_dispatch_init_fbo(cairo_gl_dispatch_t * dispatch,
    cairo_gl_get_proc_addr_func_t get_proc_addr,
    int gl_version, cairo_gl_flavor_t gl_flavor)
{
	cairo_gl_dispatch_name_t dispatch_name;
...
static cairo_status_t _cairo_gl_dispatch_init_multisampling(cairo_gl_dispatch_t * dispatch,
    cairo_gl_get_proc_addr_func_t get_proc_addr,
    int gl_version,
...
cairo_status_t _cairo_gl_dispatch_init(cairo_gl_dispatch_t * dispatch, cairo_gl_get_proc_addr_func_t get_proc_addr)
{
	...
	status = _cairo_gl_dispatch_init_buffers(dispatch, get_proc_addr, gl_version, gl_flavor);
	if(status != CAIRO_STATUS_SUCCESS)
		return status;
	status = _cairo_gl_dispatch_init_shaders(dispatch, get_proc_addr, gl_version, gl_flavor);
	if(status != CAIRO_STATUS_SUCCESS)
		return status;
	status = _cairo_gl_dispatch_init_fbo(dispatch, get_proc_addr, gl_version, gl_flavor);
	if(status != CAIRO_STATUS_SUCCESS)
		return status;
	status = _cairo_gl_dispatch_init_multisampling(dispatch, get_proc_addr, gl_version, gl_flavor);
	if(status != CAIRO_STATUS_SUCCESS)
		return status;
