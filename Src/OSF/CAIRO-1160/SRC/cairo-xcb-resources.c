...
static void parse_integer(const char * v, int * out)
{
	char * e;
	int value;
...
static int resource_parse_lines(struct resource_parser * parser)
{
	char * newline;
...
static void resource_parser_init(struct resource_parser * parser, cairo_xcb_resources_t * resources)
{
...
static void resource_parser_done(struct resource_parser * parser)
{
...
void _cairo_xcb_resources_get(cairo_xcb_screen_t * screen, cairo_xcb_resources_t * resources)
{
	...
	if(resources->xft_rgba == FC_RGBA_UNKNOWN) {
		switch(screen->subpixel_order) {
			case XCB_RENDER_SUB_PIXEL_UNKNOWN: resources->xft_rgba = FC_RGBA_UNKNOWN; break;
			case XCB_RENDER_SUB_PIXEL_HORIZONTAL_RGB: resources->xft_rgba = FC_RGBA_RGB; break;
			case XCB_RENDER_SUB_PIXEL_HORIZONTAL_BGR: resources->xft_rgba = FC_RGBA_BGR; break;
			case XCB_RENDER_SUB_PIXEL_VERTICAL_RGB: resources->xft_rgba = FC_RGBA_VRGB; break;
			case XCB_RENDER_SUB_PIXEL_VERTICAL_BGR: resources->xft_rgba = FC_RGBA_VBGR; break;
			case XCB_RENDER_SUB_PIXEL_NONE: resources->xft_rgba = FC_RGBA_NONE; break;
		}
	}
}
