...
cairo_surface_t * cairo_quartz_image_surface_create(cairo_surface_t * surface)
{
	...
	qisurf = SAlloc::M_zon0(sizeof(cairo_quartz_image_surface_t));
	if(qisurf == NULL)
	...
	_cairo_surface_init(&qisurf->base, &cairo_quartz_image_surface_backend, NULL/* device */, _cairo_content_from_format(format), FALSE/* is_vector */);
	qisurf->width = width;
