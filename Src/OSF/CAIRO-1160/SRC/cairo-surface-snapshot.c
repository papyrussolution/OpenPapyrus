...
static cairo_status_t _cairo_surface_snapshot_acquire_source_image(void * abstract_surface, cairo_image_surface_t ** image_out, void ** extra_out)
{
	...
	struct snapshot_extra * extra = (struct snapshot_extra *)SAlloc::M_zon0(sizeof(*extra));
...
static void _cairo_surface_snapshot_release_source_image(void * abstract_surface, cairo_image_surface_t * image, void * _extra)
{
...
cairo_surface_t * _cairo_surface_snapshot(cairo_surface_t * surface)
{
	...
	snapshot = (cairo_surface_snapshot_t *)SAlloc::M_zon0(sizeof(cairo_surface_snapshot_t));
