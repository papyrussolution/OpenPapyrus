...
static cairo_pattern_t * _cairo_default_context_pop_group(void * abstract_cr)
{
	...
	// If we have a current path, we need to adjust it to compensate for the device offset just removed. 
	_cairo_path_fixed_translate(cr->path,
	    _cairo_fixed_from_int(static_cast<int>(parent_surface->device_transform.x0 - group_surface->device_transform.x0)),
	    _cairo_fixed_from_int(static_cast<int>(parent_surface->device_transform.y0 - group_surface->device_transform.y0)));
done:
	cairo_surface_destroy(group_surface);
...
static cairo_status_t _cairo_default_context_set_fill_rule(void * abstract_cr, cairo_fill_rule_t fill_rule)
{
	cairo_default_context_t * cr = static_cast<cairo_default_context_t *>(abstract_cr);
...
static cairo_fill_rule_t _cairo_default_context_get_fill_rule(void * abstract_cr)
{
	cairo_default_context_t * cr = static_cast<cairo_default_context_t *>(abstract_cr);
...
{
	const cairo_default_context_t * cr = static_cast<const cairo_default_context_t *>(abstract_cr);
...
static cairo_status_t _cairo_default_context_curve_to(void * abstract_cr, double x1, double y1, double x2, double y2, double x3, double y3)
{
	cairo_default_context_t * cr = static_cast<cairo_default_context_t *>(abstract_cr);
...
static cairo_status_t _cairo_default_context_paint_with_alpha(void * abstract_cr, double alpha)
{
	...
	if(CAIRO_ALPHA_IS_OPAQUE(alpha))
		return _cairo_gstate_paint(cr->gstate);
	if(CAIRO_ALPHA_IS_ZERO(alpha) && _cairo_operator_bounded_by_mask(cr->gstate->op)) {
		return CAIRO_STATUS_SUCCESS;
	}
...
static cairo_status_t _cairo_default_context_fill_extents(void * abstract_cr, double * x1, double * y1, double * x2, double * y2)
{
	cairo_default_context_t * cr = static_cast<cairo_default_context_t *>(abstract_cr);
...
static cairo_status_t _cairo_default_context_clip_extents(void * abstract_cr, double * x1, double * y1, double * x2, double * y2)
{
	cairo_default_context_t * cr = static_cast<cairo_default_context_t *>(abstract_cr);
...
static cairo_status_t _cairo_default_context_tag_begin(void * abstract_cr, const char * tag_name, const char * attributes)
{
	cairo_default_context_t * cr = static_cast<cairo_default_context_t *>(abstract_cr);
	return _cairo_gstate_tag_begin(cr->gstate, tag_name, attributes);
}

static cairo_status_t _cairo_default_context_tag_end(void * abstract_cr, const char * tag_name)
{
	cairo_default_context_t * cr = static_cast<cairo_default_context_t *>(abstract_cr);
