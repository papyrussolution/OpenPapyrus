...
static inline cairo_bo_intersect_ordinate_t round_to_nearest(cairo_quorem64_t d, int64 den)
{
	cairo_bo_intersect_ordinate_t ordinate;
	int32 quo = static_cast<int32>(d.quo);
	int64 drem_2 = _cairo_int64_mul(d.rem, _cairo_int32_to_int64(2));
	...
	ordinate.approx = _cairo_int64_is_zero(drem_2) ? _cairo_bo_intersect_ordinate::EXACT : _cairo_int64_negative(drem_2) ? 
 ...
 */
static boolint _cairo_bo_edge_intersect(cairo_bo_edge_t * a, cairo_bo_edge_t * b, cairo_bo_intersect_point_t * intersection)
{
...
static void edges_end(cairo_bo_edge_t * left, int32 bot, cairo_polygon_t * polygon)
{
...
static inline void active_edges(cairo_bo_edge_t * left, int32 top, cairo_polygon_t * polygon)
{
