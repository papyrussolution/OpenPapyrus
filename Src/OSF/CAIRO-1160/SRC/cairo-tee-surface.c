...
cairo_surface_t * cairo_tee_surface_index(cairo_surface_t * abstract_surface, uint index)
{
	cairo_tee_surface_t * surface;
	if(unlikely(abstract_surface->status))
...
cairo_surface_t * _cairo_tee_surface_find_match(void * abstract_surface, const cairo_surface_backend_t * backend, cairo_content_t content)
{
	cairo_tee_surface_t * surface = abstract_surface;
	cairo_surface_wrapper_t * slaves;
	int num_slaves, n;
