...
static cairo_status_t stroker_init(struct stroker * stroker,
...
static void join(struct stroker * stroker,
...
static void add_cap(struct stroker * stroker, cairo_stroke_face_t * f)
{
...
static void add_trailing_cap(struct stroker * stroker, cairo_stroke_face_t * face)
{
