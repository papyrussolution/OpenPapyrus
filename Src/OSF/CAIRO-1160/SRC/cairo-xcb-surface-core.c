...
static cairo_status_t _cairo_xcb_shm_image_create_shm(cairo_xcb_connection_t * connection,
...
cairo_status_t _cairo_xcb_shm_image_create(cairo_xcb_connection_t * connection,
    pixman_format_code_t pixman_format,
    int width, int height,
    cairo_image_surface_t ** image_out,
    cairo_xcb_shm_info_t ** shm_info_out)
...
static cairo_xcb_pixmap_t * _pixmap_from_image(cairo_xcb_surface_t * target,
...
static cairo_xcb_pixmap_t * _render_to_pixmap(cairo_xcb_surface_t * target,
...
static cairo_xcb_pixmap_t * _copy_to_pixmap(cairo_xcb_surface_t * source)
{
	cairo_xcb_pixmap_t * pixmap;
...
static cairo_xcb_pixmap_t * _cairo_xcb_surface_pixmap(cairo_xcb_surface_t * target,
...
static cairo_xcb_pixmap_t * _cairo_xcb_pixmap_for_pattern(cairo_xcb_surface_t * target,
    const cairo_pattern_t * pattern,
    const cairo_rectangle_int_t * extents)
{
	int tx, ty;
...
cairo_status_t _cairo_xcb_surface_core_copy_boxes(cairo_xcb_surface_t * dst,
...
cairo_status_t _cairo_xcb_surface_core_fill_boxes(cairo_xcb_surface_t * dst, const cairo_color_t * color, cairo_boxes_t * boxes)
{
	...
	for(chunk = &boxes->chunks; chunk != NULL; chunk = chunk->next) {
		...
		_cairo_xcb_connection_poly_fill_rectangle(dst->connection, dst->drawable, gc, chunk->count, xcb_rects);
	}
