...
struct _cairo_vg_context {
	...
	void * display;
	void * context;
	cairo_status_t (* create_target) (cairo_vg_context_t *, cairo_vg_surface_t *);
	cairo_status_t (* set_target) (cairo_vg_context_t *, cairo_vg_surface_t *);
...
static cairo_vg_context_t * _vg_context_reference(cairo_vg_context_t * context)
{
...
static cairo_vg_context_t * _vg_context_lock(cairo_vg_context_t * context)
{
	/* XXX if we need to add locking, then it has to be recursive */
	return context;
}

static cairo_int_status_t _vg_context_set_target(cairo_vg_context_t * context,
...
static void _vg_context_destroy_target(cairo_vg_context_t * context,
    cairo_vg_surface_t * surface)
{
	if(surface->target_id == 0)
		return;
...
static void _vg_snapshot_cache_remove(void * cache_entry)
{
...
static pixman_format_code_t _vg_format_to_content(VGImageFormat format)
{
...
static VGImageFormat _vg_format_from_pixman(pixman_format_code_t format)
{
...
static VGImageFormat _vg_format_for_content(cairo_content_t content)
{
	switch(content) {
...
static cairo_surface_t * _vg_surface_create_similar(void * abstract_surface,
...
static cairo_status_t _vg_surface_clipper_intersect_clip_path(cairo_surface_clipper_t * clipper,
...
static cairo_status_t _vg_move_to(void * closure,
...
static cairo_status_t _vg_line_to(void * closure,
    const cairo_point_t * point)
{
	vg_path_t * path = closure;
	double x = _cairo_fixed_to_double(point->x);
...
static cairo_status_t _vg_curve_to(void * closure,
...
static cairo_status_t _vg_close_path(void * closure)
{
	vg_path_t * path = closure;
...
static VGFillRule _vg_fill_rule_from_cairo(cairo_fill_rule_t rule)
{
	switch(rule) {
...
static VGRenderingQuality _vg_rendering_quality_from_cairo(cairo_antialias_t aa)
{
	switch(aa) {
...
static VGJoinStyle _vg_line_join_from_cairo(cairo_line_join_t join)
{
	switch(join) {
...
static void _vg_matrix_from_cairo(VGfloat * dst, const cairo_matrix_t * src)
{
	dst[0] = /* sx  */ src->xx;
	dst[1] = /* shy */ src->yx;
	dst[2] = /* w0  */ 0;
...
static cairo_status_t _vg_setup_gradient_stops(cairo_vg_context_t * context,
...
static void _vg_set_source_matrix(const cairo_pattern_t * pat)
{
	cairo_matrix_t mat;
	cairo_status_t status;
	VGfloat vmat[9];
...
static cairo_status_t _vg_setup_linear_source(cairo_vg_context_t * context,
...
static cairo_status_t _vg_setup_radial_source(cairo_vg_context_t * context,
...
static cairo_status_t _vg_setup_solid_source(cairo_vg_context_t * context,
...
static cairo_vg_surface_t * _vg_clone_recording_surface(cairo_vg_context_t * context,
...
static cairo_vg_surface_t * _vg_clone_image_surface(cairo_vg_context_t * context,
    cairo_surface_t * surface)
{
...
static void _vg_surface_remove_from_cache(cairo_surface_t * abstract_surface)
{
...
static cairo_status_t _vg_setup_surface_source(cairo_vg_context_t * context,
...
static cairo_status_t setup_source(cairo_vg_context_t * context,
...
static cairo_int_status_t _vg_surface_stroke(void * abstract_surface,
    cairo_operator_t op,
    const cairo_pattern_t * source,
...
static cairo_int_status_t _vg_surface_fill(void * abstract_surface,
    cairo_operator_t op,
    const cairo_pattern_t * source,
    const cairo_path_fixed_t * path,
    cairo_fill_rule_t fill_rule,
...
static cairo_int_status_t _vg_surface_paint(void * abstract_surface,
    cairo_operator_t op,
    const cairo_pattern_t * source,
    const cairo_clip_t * clip)
{
...
static cairo_int_status_t _vg_surface_mask(void * abstract_surface,
    cairo_operator_t op,
    const cairo_pattern_t * source,
...
static void _vg_surface_get_font_options(void * abstract_surface,
...
static cairo_int_status_t _vg_surface_show_glyphs(void * abstract_surface,
    cairo_operator_t op,
    const cairo_pattern_t * source,
...
static cairo_int_status_t _vg_get_image(cairo_vg_surface_t * surface,
    int x, int y,
...
static void _vg_surface_release_source_image(void * abstract_surface,
    cairo_image_surface_t * image,
    void * image_extra)
{
...
static cairo_status_t _vg_surface_finish(void * abstract_surface)
{
	cairo_vg_surface_t * surface = abstract_surface;
	cairo_vg_context_t * context = _vg_context_lock(surface->context);
...
cairo_surface_t * cairo_vg_surface_create(cairo_vg_context_t * context,
    cairo_content_t content,
    int width,
    int height)
{
...
VGImage cairo_vg_surface_get_image(cairo_surface_t * abstract_surface)
{
	cairo_vg_surface_t * surface;
...
int cairo_vg_surface_get_width(cairo_surface_t * abstract_surface)
{
	cairo_vg_surface_t * surface;
...
int cairo_vg_surface_get_height(cairo_surface_t * abstract_surface)
{
	cairo_vg_surface_t * surface;
...
VGImageFormat cairo_vg_surface_get_format(cairo_surface_t * abstract_surface)
{
	cairo_vg_surface_t * surface;
...
static cairo_status_t glx_create_target(cairo_vg_context_t * context,
    cairo_vg_surface_t * surface)
{
...
static cairo_status_t glx_set_target(cairo_vg_context_t * context,
    cairo_vg_surface_t * surface)
{
#if 0
...
static void glx_destroy_target(cairo_vg_context_t * context,
    cairo_vg_surface_t * surface)
{
}

cairo_vg_context_t * cairo_vg_context_create_for_glx(Display * dpy, GLXContext ctx)
{
	cairo_vg_context_t * context;
	cairo_status_t status;
...
static cairo_status_t egl_create_target(cairo_vg_context_t * context,
    cairo_vg_surface_t * surface)
{
...
#define ALPHA 7
	...
	egl_surface =
		...
		config,
		NULL);
	surface->target_id = (ulong)egl_surface;

	return CAIRO_STATUS_SUCCESS;
}

static cairo_status_t egl_set_target(cairo_vg_context_t * context,
    cairo_vg_surface_t * surface)
{
...
static void egl_destroy_target(cairo_vg_context_t * context, cairo_vg_surface_t * surface)
{
	eglDestroySurface(context->display, (EGLSurface*)surface->target_id);
}
...
cairo_status_t cairo_vg_context_status(cairo_vg_context_t * context)
{
	return context->status;
}

void cairo_vg_context_destroy(cairo_vg_context_t * context)
{
	if(context == NULL || CAIRO_REFERENCE_COUNT_IS_INVALID(&context->ref_count))
		return;
	_vg_context_destroy(context);
}
#endif // } 0 CAIRO_HAS_VG_SURFACE 