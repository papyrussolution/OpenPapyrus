...
static cairo_surface_t * _cairo_dfb_surface_create_similar(void * abstract_src,
...
static cairo_status_t _cairo_dfb_surface_finish(void * abstract_surface)
{
...
static cairo_image_surface_t * _cairo_dfb_surface_map_to_image(void * abstract_surface,
...
static cairo_int_status_t _cairo_dfb_surface_unmap_image(void * abstract_surface,
    cairo_image_surface_t * image)
{
	cairo_dfb_surface_t * surface = abstract_surface;
...
static cairo_status_t _cairo_dfb_surface_flush(void * abstract_surface,
    unsigned flags)
{
	cairo_dfb_surface_t * surface = abstract_surface;
...
static cairo_int_status_t _cairo_dfb_surface_fill_rectangles(void * abstract_surface,
    cairo_operator_t op,
...
#endif // } 0 CAIRO_HAS_DIRECTFB_SURFACE 