...
static cairo_int_status_t _cairo_xlib_shm_compositor_paint(const cairo_compositor_t * _compositor,
...
static cairo_int_status_t _cairo_xlib_shm_compositor_mask(const cairo_compositor_t * _compositor,
    cairo_composite_rectangles_t * extents)
{
	cairo_xlib_surface_t * xlib = (cairo_xlib_surface_t*)extents->surface;
	cairo_int_status_t status;
...
static cairo_int_status_t _cairo_xlib_shm_compositor_stroke(const cairo_compositor_t * _compositor,
    cairo_composite_rectangles_t * extents,
...
static cairo_int_status_t _cairo_xlib_shm_compositor_fill(const cairo_compositor_t * _compositor,
    cairo_composite_rectangles_t * extents,
    const cairo_path_fixed_t * path,
...
static cairo_int_status_t _cairo_xlib_shm_compositor_glyphs(const cairo_compositor_t * _compositor,
    cairo_composite_rectangles_t * extents,
...
const cairo_compositor_t * _cairo_xlib_fallback_compositor_get(void)
{
