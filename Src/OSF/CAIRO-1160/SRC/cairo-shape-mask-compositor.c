...
static cairo_int_status_t _cairo_shape_mask_compositor_fill(const cairo_compositor_t * _compositor,
    cairo_composite_rectangles_t * extents,
    const cairo_path_fixed_t * path,
...
static cairo_int_status_t _cairo_shape_mask_compositor_glyphs(const cairo_compositor_t * _compositor,
    cairo_composite_rectangles_t * extents,
...
void _cairo_shape_mask_compositor_init(cairo_compositor_t * compositor, const cairo_compositor_t * delegate)
{
