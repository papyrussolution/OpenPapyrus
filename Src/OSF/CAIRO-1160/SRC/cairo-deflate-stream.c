 ...
 *
 * Author(s): Adrian Johnson <ajohnson@redneon.com>
 */
#include "cairoint.h"
#pragma hdrstop
...
static cairo_status_t _cairo_deflate_stream_close(cairo_output_stream_t * base)
{
	cairo_deflate_stream_t * stream = (cairo_deflate_stream_t*)base;
...
cairo_output_stream_t * _cairo_deflate_stream_create(cairo_output_stream_t * output)
{
	...
	stream = (cairo_deflate_stream_t *)SAlloc::M_zon0(sizeof(cairo_deflate_stream_t));
