...
static void _cairo_xcb_shm_process_pending(cairo_xcb_connection_t * connection, shm_wait_type_t wait)
{
    ...
    cairo_xcb_shm_info_t ** shm_info_out)
{
	...
	pool = SAlloc::M_zon0(sizeof(cairo_xcb_shm_mem_pool_t));
...
void _cairo_xcb_connection_shm_mem_pools_flush(cairo_xcb_connection_t * connection)
{
	CAIRO_MUTEX_LOCK(connection->shm_mutex);
...
void _cairo_xcb_connection_shm_mem_pools_fini(cairo_xcb_connection_t * connection)
{
