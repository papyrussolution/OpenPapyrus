 ...
 **/
cairo_device_t * _cairo_xlib_device_create(Display * dpy)
{
	...
	display = SAlloc::M_zon0(sizeof(cairo_xlib_display_t));
...
cairo_status_t _cairo_xlib_display_acquire(cairo_device_t * device, cairo_xlib_display_t ** display)
{
...
XRenderPictFormat * _cairo_xlib_display_get_xrender_format_for_pixman(cairo_xlib_display_t * display,
...
XRenderPictFormat * _cairo_xlib_display_get_xrender_format(cairo_xlib_display_t * display,
...
cairo_xlib_screen_t * _cairo_xlib_display_get_screen(cairo_xlib_display_t * display,
    Screen * screen)
{
