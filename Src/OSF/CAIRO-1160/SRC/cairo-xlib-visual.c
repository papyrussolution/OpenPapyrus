...
static inline int _color_distance(unsigned short r1, unsigned short g1, unsigned short b1,
...
void _cairo_xlib_visual_info_destroy(cairo_xlib_visual_info_t * info)
{
