...
static EGLSurface _egl_get_current_surface(cairo_egl_context_t * ctx)
{
...
static void _egl_query_current_state(cairo_egl_context_t * ctx)
{
...
static void _egl_acquire(void * abstract_ctx)
{
...
static void _egl_release(void * abstract_ctx)
{
	cairo_egl_context_t * ctx = abstract_ctx;
...
static void _egl_make_current(void * abstract_ctx,
...
static void _egl_swap_buffers(void * abstract_ctx,
    cairo_gl_surface_t * abstract_surface)
{
	cairo_egl_context_t * ctx = abstract_ctx;
	cairo_egl_surface_t * surface = (cairo_egl_surface_t*)abstract_surface;
...
static void _egl_destroy(void * abstract_ctx)
{
	cairo_egl_context_t * ctx = abstract_ctx;
...
cairo_public EGLContext cairo_egl_device_get_context(cairo_device_t * device)
{
	if(!is_egl_device(device)) {
		_cairo_error_throw(CAIRO_STATUS_DEVICE_TYPE_MISMATCH);
