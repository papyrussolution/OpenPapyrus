...
static inline int64_t rounded_sdiv_128_by_49(int64_t hi,
    uint64_t lo,
    int64_t div,
 ...
 * to 128-bit integer.
 */
static force_inline void fixed_64_16_to_int128(int64_t hi,
    int64_t lo,
    int64_t * rhi,
    int64_t * rlo,
    int scalebits)
 ...
 */
PIXMAN_EXPORT pixman_bool_t pixman_transform_point_31_16(const pixman_transform_t * t,
