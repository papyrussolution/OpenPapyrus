...
static force_inline vector unsigned int splat_alpha(vector unsigned int pix)
{
...
static force_inline vector unsigned int splat_pixel(vector unsigned int pix)
{
	return vec_perm(pix, pix,
		   (vector unsigned char)AVV(
...
static force_inline vector unsigned int pix_multiply(vector unsigned int p, vector unsigned int a)
{
...
static force_inline vector unsigned int pix_add(vector unsigned int a, vector unsigned int b)
{
	return (vector unsigned int)vec_adds((vector unsigned char)a,
		   (vector unsigned char)b);
}

static force_inline vector unsigned int pix_add_mul(vector unsigned int x,
...
static force_inline vector unsigned int negate(vector unsigned int src)
{
	return vec_nor(src, src);
}

/* dest*~srca + src */
static force_inline vector unsigned int over(vector unsigned int src, vector unsigned int srca, vector unsigned int dest)
{
	vector unsigned char tmp = (vector unsigned char)pix_multiply(dest, negate(srca));
...
static force_inline vector unsigned int load_128_aligned(const uint32_t* src)
{
	return *((vector unsigned int*)src);
}

/* load 4 pixels from a unaligned address */
static force_inline vector unsigned int load_128_unaligned(const uint32_t* src)
{
...
static force_inline void save_128_aligned(uint32_t* data,
    vector unsigned int vdata)
{
	STORE_VECTOR(data)
}

static force_inline vector unsigned int create_mask_1x32_128(const uint32_t * src)
{
	vector unsigned int vsrc;
	DECLARE_SRC_MASK_VAR;
...
static force_inline vector unsigned int create_mask_32_128(uint32_t mask)
{
	return create_mask_1x32_128(&mask);
}

static force_inline vector unsigned int unpacklo_128_16x8(vector unsigned int data1, vector unsigned int data2)
{
...
static force_inline vector unsigned int unpackhi_128_16x8(vector unsigned int data1, vector unsigned int data2)
{
...
static force_inline vector unsigned int unpacklo_128_8x16(vector unsigned int data1, vector unsigned int data2)
{
...
static force_inline vector unsigned int unpackhi_128_8x16(vector unsigned int data1, vector unsigned int data2)
{
...
static force_inline void unpack_128_2x128(vector unsigned int data1, vector unsigned int data2,
...
static force_inline void unpack_128_2x128_16(vector unsigned int data1, vector unsigned int data2,
    vector unsigned int* data_lo, vector unsigned int* data_hi)
{
...
static force_inline vector unsigned int unpack_565_to_8888(vector unsigned int lo)
{
...
static force_inline int is_opaque(vector unsigned int x)
{
	uint32_t cmp_result;
...
static force_inline int is_zero(vector unsigned int x)
{
	uint32_t cmp_result;
...
static force_inline int is_transparent(vector unsigned int x)
{
	uint32_t cmp_result;
...
static force_inline uint32_t core_combine_over_u_pixel_vmx(uint32_t src, uint32_t dst)
{
	uint32_t a;
...
static force_inline vector unsigned int combine4(const uint32_t* ps, const uint32_t* pm)
{
...
static void vmx_combine_atop_u_mask(uint32_t * dest,
    const uint32_t * src,
    const uint32_t * mask,
    int width)
{
...
static void vmx_combine_atop_reverse_u_mask(uint32_t * dest,
    const uint32_t * src,
    const uint32_t * mask,
    int width)
{
...
static void vmx_combine_xor_u_mask(uint32_t * dest,
    const uint32_t * src,
    const uint32_t * mask,
    int width)
{
...
static void vmx_combine_add_u(pixman_implementation_t * imp,
    pixman_op_t op,
    uint32_t * dest,
    const uint32_t * src,
    const uint32_t * mask,
...
static void vmx_combine_src_ca(pixman_implementation_t * imp,
    pixman_op_t op,
    uint32_t * dest,
    const uint32_t * src,
    const uint32_t * mask,
...
static void vmx_combine_over_ca(pixman_implementation_t * imp,
    pixman_op_t op,
    uint32_t * dest,
    const uint32_t * src,
    const uint32_t * mask,
...
static void vmx_combine_over_reverse_ca(pixman_implementation_t * imp,
    pixman_op_t op,
    uint32_t * dest,
    const uint32_t * src,
    const uint32_t * mask,
...
static void vmx_combine_in_ca(pixman_implementation_t * imp,
    pixman_op_t op,
    uint32_t * dest,
    const uint32_t * src,
    const uint32_t * mask,
...
static void vmx_combine_in_reverse_ca(pixman_implementation_t * imp,
    pixman_op_t op,
    uint32_t * dest,
    const uint32_t * src,
    const uint32_t * mask,
...
static void vmx_combine_out_ca(pixman_implementation_t * imp,
    pixman_op_t op,
    uint32_t * dest,
    const uint32_t * src,
    const uint32_t * mask,
...
static void vmx_combine_out_reverse_ca(pixman_implementation_t * imp,
    pixman_op_t op,
    uint32_t * dest,
    const uint32_t * src,
    const uint32_t * mask,
...
static void vmx_combine_atop_ca(pixman_implementation_t * imp,
    pixman_op_t op,
    uint32_t * dest,
    const uint32_t * src,
    const uint32_t * mask,
...
static void vmx_combine_atop_reverse_ca(pixman_implementation_t * imp,
    pixman_op_t op,
    uint32_t * dest,
    const uint32_t * src,
    const uint32_t * mask,
...
static void vmx_combine_xor_ca(pixman_implementation_t * imp,
    pixman_op_t op,
    uint32_t * dest,
    const uint32_t * src,
    const uint32_t * mask,
...
static void vmx_combine_add_ca(pixman_implementation_t * imp,
    pixman_op_t op,
    uint32_t * dest,
    const uint32_t * src,
    const uint32_t * mask,
...
static void vmx_composite_over_n_8_8888(pixman_implementation_t * imp,
...
static void vmx_composite_src_x888_8888(pixman_implementation_t * imp,
    pixman_composite_info_t * info)
{
	PIXMAN_COMPOSITE_ARGS(info);
	uint32_t    * dst_line, * dst;
...
static void vmx_composite_over_n_8888(pixman_implementation_t * imp,
    pixman_composite_info_t * info)
{
	PIXMAN_COMPOSITE_ARGS(info);
	uint32_t * dst_line, * dst;
...
static void vmx_composite_over_8888_8888(pixman_implementation_t * imp,
    pixman_composite_info_t * info)
{
	PIXMAN_COMPOSITE_ARGS(info);
	int dst_stride, src_stride;
...
static void vmx_composite_over_n_8888_8888_ca(pixman_implementation_t * imp,
    pixman_composite_info_t * info)
{
	PIXMAN_COMPOSITE_ARGS(info);
	uint32_t src, ia;
...
static void vmx_composite_add_8_8(pixman_implementation_t * imp,
    pixman_composite_info_t * info)
{
	PIXMAN_COMPOSITE_ARGS(info);
...
static void vmx_composite_add_8888_8888(pixman_implementation_t * imp,
    pixman_composite_info_t * info)
{
	PIXMAN_COMPOSITE_ARGS(info);
	uint32_t    * dst_line, * dst;
...
static force_inline void scaled_nearest_scanline_vmx_8888_8888_OVER(uint32_t*       pd,
    const uint32_t* ps,
    int32_t w,
    pixman_fixed_t vx,
