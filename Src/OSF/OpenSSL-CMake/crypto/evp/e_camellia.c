...
void cmll_t4_encrypt(const uchar *in, uchar *out,
                     const CAMELLIA_KEY *key);
void cmll_t4_decrypt(const uchar *in, uchar *out,
                     const CAMELLIA_KEY *key);

void cmll128_t4_cbc_encrypt(const uchar *in, uchar *out,
                            size_t len, const CAMELLIA_KEY *key,
                            uchar *ivec);
void cmll128_t4_cbc_decrypt(const uchar *in, uchar *out,
                            size_t len, const CAMELLIA_KEY *key,
                            uchar *ivec);
void cmll256_t4_cbc_encrypt(const uchar *in, uchar *out,
                            size_t len, const CAMELLIA_KEY *key,
                            uchar *ivec);
void cmll256_t4_cbc_decrypt(const uchar *in, uchar *out,
                            size_t len, const CAMELLIA_KEY *key,
                            uchar *ivec);
void cmll128_t4_ctr32_encrypt(const uchar *in, uchar *out,
                              size_t blocks, const CAMELLIA_KEY *key,
                              uchar *ivec);
void cmll256_t4_ctr32_encrypt(const uchar *in, uchar *out,
                              size_t blocks, const CAMELLIA_KEY *key,
                              uchar *ivec);

static int cmll_t4_init_key(EVP_CIPHER_CTX *ctx, const uchar *key,
                            const uchar *iv, int enc)
{
    int ret, mode, bits;
