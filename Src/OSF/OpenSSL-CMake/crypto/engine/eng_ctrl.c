    ...
    void (* f)(void))
{
	...
	if(oneof3(cmd, ENGINE_CTRL_GET_CMD_FROM_NAME, ENGINE_CTRL_GET_NAME_FROM_CMD, ENGINE_CTRL_GET_DESC_FROM_CMD)) {
		if(s == NULL) {
	 ...
	 */
	if((e->cmd_defns == NULL) || ((idx = int_ctrl_cmd_by_num(e->cmd_defns, (uint)i)) < 0)) {
