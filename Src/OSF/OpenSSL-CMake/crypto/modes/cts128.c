...
static const uchar test_input[64] =
    "I would like the" " General Gau's C"
    "hicken, please, " "and wonton soup.";
static const uchar test_iv[16] =
...
void test_vector(const uchar * vector, size_t len)
{
	uchar iv[sizeof(test_iv)];
	uchar cleartext[64], ciphertext[64];
	size_t tail;
...
void test_nistvector(const uchar * vector, size_t len)
{
	uchar iv[sizeof(test_iv)];
	uchar cleartext[64], ciphertext[64], nistvector[64];
	size_t tail;
