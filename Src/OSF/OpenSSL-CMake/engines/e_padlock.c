...
static int
padlock_ecb_cipher(EVP_CIPHER_CTX *ctx, uchar *out_arg,
...
static int
padlock_cbc_cipher(EVP_CIPHER_CTX *ctx, uchar *out_arg,
                   const uchar *in_arg, size_t nbytes)
{
...
static int
padlock_cfb_cipher(EVP_CIPHER_CTX *ctx, uchar *out_arg,
                   const uchar *in_arg, size_t nbytes)
{
    struct padlock_cipher_data *cdata = ALIGNED_CIPHER_DATA(ctx);
    size_t chunk;
...
static int
padlock_ofb_cipher(EVP_CIPHER_CTX *ctx, uchar *out_arg,
                   const uchar *in_arg, size_t nbytes)
{
    struct padlock_cipher_data *cdata = ALIGNED_CIPHER_DATA(ctx);
    size_t chunk;
...
static int
padlock_ctr_cipher(EVP_CIPHER_CTX *ctx, uchar *out_arg,
                   const uchar *in_arg, size_t nbytes)
{
    struct padlock_cipher_data *cdata = ALIGNED_CIPHER_DATA(ctx);
...
static int
padlock_aes_init_key(EVP_CIPHER_CTX *ctx, const uchar *key,
                     const uchar *iv, int enc)
{
