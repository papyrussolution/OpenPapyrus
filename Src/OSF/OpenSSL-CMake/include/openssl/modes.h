...
extern "C" {
#endif
typedef void (*block128_f) (const uchar in[16],
                            uchar out[16], const void *key);

typedef void (*cbc128_f) (const uchar *in, uchar *out,
                          size_t len, const void *key,
                          uchar ivec[16], int enc);

typedef void (*ctr128_f) (const uchar *in, uchar *out,
                          size_t blocks, const void *key,
                          const uchar ivec[16]);

typedef void (*ccm128_f) (const uchar *in, uchar *out,
                          size_t blocks, const void *key,
                          const uchar ivec[16],
                          uchar cmac[16]);
...
int CRYPTO_gcm128_decrypt_ctr32(GCM128_CONTEXT *ctx,
                                const uchar *in, uchar *out,
                                size_t len, ctr128_f stream);
int CRYPTO_gcm128_finish(GCM128_CONTEXT *ctx, const uchar *tag,
                         size_t len);
...
void CRYPTO_ccm128_init(CCM128_CONTEXT *ctx,
                        ...
                        block128_f block);
int CRYPTO_ccm128_setiv(CCM128_CONTEXT *ctx, const uchar *nonce,
                        size_t nlen, size_t mlen);
void CRYPTO_ccm128_aad(CCM128_CONTEXT *ctx, const uchar *aad,
                       size_t alen);
int CRYPTO_ccm128_encrypt(CCM128_CONTEXT *ctx, const uchar *inp,
                          uchar *out, size_t len);
int CRYPTO_ccm128_decrypt(CCM128_CONTEXT *ctx, const uchar *inp,
                          uchar *out, size_t len);
int CRYPTO_ccm128_encrypt_ccm64(CCM128_CONTEXT *ctx, const uchar *inp,
                                uchar *out, size_t len,
                                ccm128_f stream);
int CRYPTO_ccm128_decrypt_ccm64(CCM128_CONTEXT *ctx, const uchar *inp,
                                uchar *out, size_t len,
                                ccm128_f stream);
...
typedef void (*ocb128_f) (const uchar *in, uchar *out,
                          size_t blocks, const void *key,
...
int CRYPTO_ocb128_setiv(OCB128_CONTEXT *ctx, const uchar *iv,
                        size_t len, size_t taglen);
int CRYPTO_ocb128_aad(OCB128_CONTEXT *ctx, const uchar *aad,
                      size_t len);
int CRYPTO_ocb128_encrypt(OCB128_CONTEXT *ctx, const uchar *in,
                          uchar *out, size_t len);
int CRYPTO_ocb128_decrypt(OCB128_CONTEXT *ctx, const uchar *in,
                          uchar *out, size_t len);
