...
typedef uint KEY_TABLE_TYPE[CAMELLIA_TABLE_WORD_LEN]; // to match with WORD 
...
void Camellia_cbc_encrypt(const uchar * in, uchar * out, size_t length, const CAMELLIA_KEY * key, uchar * ivec, const int enc);
...
void Camellia_ofb128_encrypt(const uchar * in, uchar * out, size_t length, const CAMELLIA_KEY * key, uchar * ivec, int * num);
void Camellia_ctr128_encrypt(const uchar *in, uchar *out, size_t length, const CAMELLIA_KEY *key, uchar ivec[CAMELLIA_BLOCK_SIZE], uchar ecount_buf[CAMELLIA_BLOCK_SIZE], uint *num);
