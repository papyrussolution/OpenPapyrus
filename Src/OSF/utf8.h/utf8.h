...
#if defined(_MSC_VER)
	#pragma warning(push)
	#pragma warning(disable : 4255) /* disable warning: no function prototype given: converting '()' to '(void)' */
	#pragma warning(disable : 4668) /* disable warning: '__cplusplus' is not defined as a preprocessor macro, replacing with '0' for '#if/#elif' */
	#pragma warning(disable : 4820) /* disable warning: bytes padding added after construct */
#endif
#include <stddef.h>
#include <stdlib.h>
...
extern "C" {
...
#if defined(_MSC_VER)
	#define utf8_nonnull
	// @v11.9.2 (replaced with CXX_FUNC_PURE) #define utf8_pure_Removed
	// @v11.9.2 #define utf8_restrict_Removed __restrict
	#define utf8_weak __inline
#elif defined(__clang__) || defined(__GNUC__)
	#define utf8_nonnull __attribute__((nonnull))
	// @v11.9.2 (replaced with CXX_FUNC_PURE) #define utf8_pure_Removed __attribute__((pure))
	// @v11.9.2 #define utf8_restrict_Removed __restrict__
	...
	#define utf8_constexpr14_Removed constexpr
	#define utf8_constexpr14_impl_Removed constexpr
#else
	/* constexpr and weak are incompatible. so only enable one of them */
	#define utf8_constexpr14_Removed /*utf8_weak8*/constexpr
	#define utf8_constexpr14_impl_Removed /**/constexpr
#endif
...
constexpr utf8_nonnull CXX_FUNC_PURE int utf8casecmp(const utf8_int8_t * src1, const utf8_int8_t * src2);

/* Append the utf8 string src onto the utf8 string dst. */
utf8_nonnull utf8_weak utf8_int8_t *utf8cat(utf8_int8_t * _RESTRICT dst, const utf8_int8_t * _RESTRICT src);

/* Find the first match of the utf8 codepoint chr in the utf8 string src. */
constexpr utf8_nonnull CXX_FUNC_PURE utf8_int8_t *utf8chr(const utf8_int8_t * src, utf8_int32_t chr);

/* Return less than 0, 0, greater than 0 if src1 < src2,
 * src1 == src2, src1 > src2 respectively. */
constexpr utf8_nonnull CXX_FUNC_PURE int utf8cmp(const utf8_int8_t * src1, const utf8_int8_t * src2);

/* Copy the utf8 string src onto the memory allocated in dst. */
utf8_nonnull utf8_weak utf8_int8_t *utf8cpy(utf8_int8_t * _RESTRICT dst, const utf8_int8_t * _RESTRICT src);

/* Number of utf8 codepoints in the utf8 string src that consists entirely
 * of utf8 codepoints not from the utf8 string reject. */
constexpr utf8_nonnull CXX_FUNC_PURE size_t utf8cspn(const utf8_int8_t * src, const utf8_int8_t * reject);
...
constexpr utf8_nonnull CXX_FUNC_PURE size_t utf8len(const utf8_int8_t * str);
/* Similar to utf8len, except that only at most n bytes of src are looked. */
constexpr utf8_nonnull CXX_FUNC_PURE size_t utf8nlen(const utf8_int8_t * str, size_t n);

/* Return less than 0, 0, greater than 0 if src1 < src2, src1 == src2, src1 >
 * src2 respectively, case insensitive. Checking at most n bytes of each utf8
 * string. */
constexpr utf8_nonnull CXX_FUNC_PURE int utf8ncasecmp(const utf8_int8_t * src1, const utf8_int8_t * src2, size_t n);

/* Append the utf8 string src onto the utf8 string dst,
 * writing at most n+1 bytes. Can produce an invalid utf8
 * string if n falls partway through a utf8 codepoint. */
utf8_nonnull utf8_weak utf8_int8_t *utf8ncat(utf8_int8_t * _RESTRICT dst, const utf8_int8_t * _RESTRICT src,
    size_t n);

/* Return less than 0, 0, greater than 0 if src1 < src2,
 * src1 == src2, src1 > src2 respectively. Checking at most n
 * bytes of each utf8 string. */
constexpr utf8_nonnull CXX_FUNC_PURE int utf8ncmp(const utf8_int8_t * src1, const utf8_int8_t * src2, size_t n);
...
utf8_nonnull utf8_weak utf8_int8_t *utf8ncpy(utf8_int8_t * _RESTRICT dst, const utf8_int8_t * _RESTRICT src,
    size_t n);
...
constexpr utf8_nonnull CXX_FUNC_PURE utf8_int8_t *utf8pbrk(const utf8_int8_t * str, const utf8_int8_t * accept);

/* Find the last match of the utf8 codepoint chr in the utf8 string src. */
constexpr utf8_nonnull CXX_FUNC_PURE utf8_int8_t *utf8rchr(const utf8_int8_t * src, int chr);

/* Number of bytes in the utf8 string str,
 * including the null terminating byte. */
constexpr utf8_nonnull CXX_FUNC_PURE size_t utf8size(const utf8_int8_t * str);

/* Similar to utf8size, except that the null terminating byte is excluded. */
constexpr utf8_nonnull CXX_FUNC_PURE size_t utf8size_lazy(const utf8_int8_t * str);

/* Similar to utf8size, except that only at most n bytes of src are looked and
 * the null terminating byte is excluded. */
constexpr utf8_nonnull CXX_FUNC_PURE size_t utf8nsize_lazy(const utf8_int8_t * str, size_t n);

/* Number of utf8 codepoints in the utf8 string src that consists entirely
 * of utf8 codepoints from the utf8 string accept. */
constexpr utf8_nonnull CXX_FUNC_PURE size_t utf8spn(const utf8_int8_t * src, const utf8_int8_t * accept);

/* The position of the utf8 string needle in the utf8 string haystack. */
constexpr utf8_nonnull CXX_FUNC_PURE utf8_int8_t *utf8str(const utf8_int8_t * haystack, const utf8_int8_t * needle);

/* The position of the utf8 string needle in the utf8 string haystack, case
 * insensitive. */
constexpr utf8_nonnull CXX_FUNC_PURE utf8_int8_t *utf8casestr(const utf8_int8_t * haystack, const utf8_int8_t * needle);

/* Return 0 on success, or the position of the invalid
 * utf8 codepoint on failure. */
constexpr utf8_nonnull CXX_FUNC_PURE utf8_int8_t *utf8valid(const utf8_int8_t * str);

/* Similar to utf8valid, except that only at most n bytes of src are looked. */
constexpr utf8_nonnull CXX_FUNC_PURE utf8_int8_t *utf8nvalid(const utf8_int8_t * str, size_t n);
...
constexpr utf8_nonnull utf8_int8_t *utf8codepoint(const utf8_int8_t * _RESTRICT str,
    utf8_int32_t * _RESTRICT out_codepoint);

/* Calculates the size of the next utf8 codepoint in str. */
constexpr utf8_nonnull size_t utf8codepointcalcsize(const utf8_int8_t * str);

/* Returns the size of the given codepoint in bytes. */
constexpr size_t utf8codepointsize(utf8_int32_t chr);
...
constexpr int utf8islower(utf8_int32_t chr);

/* Returns 1 if the given character is uppercase, or 0 if it is not. */
constexpr int utf8isupper(utf8_int32_t chr);

/* Transform the given string into all lowercase codepoints. */
utf8_nonnull utf8_weak void utf8lwr(utf8_int8_t * _RESTRICT str);

/* Transform the given string into all uppercase codepoints. */
utf8_nonnull utf8_weak void utf8upr(utf8_int8_t * _RESTRICT str);

/* Make a codepoint lower case if possible. */
constexpr utf8_int32_t utf8lwrcodepoint(utf8_int32_t cp);

/* Make a codepoint upper case if possible. */
constexpr utf8_int32_t utf8uprcodepoint(utf8_int32_t cp);

/* Sets out_codepoint to the current utf8 codepoint in str, and returns the
 * address of the previous utf8 codepoint before the current one in str. */
constexpr utf8_nonnull utf8_int8_t *utf8rcodepoint(const utf8_int8_t * _RESTRICT str,
    utf8_int32_t * _RESTRICT out_codepoint);
...
#undef utf8_weak
//#undef utf8_pure_Removed
#undef utf8_nonnull

constexpr int utf8casecmp(const utf8_int8_t * src1, const utf8_int8_t * src2) 
{
...
utf8_int8_t *utf8cat(utf8_int8_t * _RESTRICT dst, const utf8_int8_t * _RESTRICT src) 
{
	utf8_int8_t * d = dst;
...
constexpr utf8_int8_t *utf8chr(const utf8_int8_t * src, utf8_int32_t chr) 
{
...
constexpr int utf8cmp(const utf8_int8_t * src1, const utf8_int8_t * src2) 
{
	while(('\0' != *src1) || ('\0' != *src2)) {
		if(*src1 < *src2) {
			return -1;
...
constexpr int utf8coll(const utf8_int8_t * src1, const utf8_int8_t * src2);

utf8_int8_t *utf8cpy(utf8_int8_t * _RESTRICT dst, const utf8_int8_t * _RESTRICT src) 
{
	utf8_int8_t * d = dst;
...
constexpr size_t utf8cspn(const utf8_int8_t * src, const utf8_int8_t * reject) 
{
	size_t chars = 0;
	while('\0' != *src) {
...
utf8_int8_t *utf8dup_ex(const utf8_int8_t * src, utf8_int8_t * (*alloc_func_ptr)(utf8_int8_t *, size_t), utf8_int8_t * user_data) 
{
	...
	if(utf8_null == n) {
		return utf8_null; /* out of memory so we bail */
	}
	else {
		bytes = 0;
...
constexpr utf8_int8_t *utf8fry(const utf8_int8_t * str);

constexpr size_t utf8len(const utf8_int8_t * str) { return utf8nlen(str, SIZE_MAX); }

constexpr size_t utf8nlen(const utf8_int8_t * str, size_t n) 
{
	...
	while((size_t)(str - t) < n && '\0' != *str) {
		...
		/* no matter the bytes we marched s forward by, it was only 1 utf8 codepoint */
		length++;
	}
	if((size_t)(str - t) > n) {
		length--;
...
constexpr int utf8ncasecmp(const utf8_int8_t * src1, const utf8_int8_t * src2, size_t n) 
{
	...
	do {
		...
		/* first check that we have enough bytes left in n to contain an entire codepoint */
		if(0 == n) {
			return 0;
		}
...
utf8_int8_t *utf8ncat(utf8_int8_t * _RESTRICT dst, const utf8_int8_t * _RESTRICT src, size_t n) 
{
	utf8_int8_t * d = dst;
	/* find the null terminating byte in dst */
	while('\0' != *d) {
...
constexpr int utf8ncmp(const utf8_int8_t * src1, const utf8_int8_t * src2, size_t n) 
{
...
utf8_int8_t *utf8ncpy(utf8_int8_t * _RESTRICT dst, const utf8_int8_t * _RESTRICT src, size_t n) 
{
	utf8_int8_t * d = dst;
	...
	if(check_index < index && ((index - check_index) < utf8codepointcalcsize(&d[check_index]) || (index - check_index) == n)) {
		index = check_index;
	}
	/* append null terminating byte */
	for(; index < n; index++) {
...
constexpr utf8_int8_t *utf8rchr(const utf8_int8_t * src, int chr) 
{
...
constexpr utf8_int8_t *utf8pbrk(const utf8_int8_t * str, const utf8_int8_t * accept) 
{
	while('\0' != *str) {
...
constexpr size_t utf8size(const utf8_int8_t * str) { return utf8size_lazy(str) + 1; }
constexpr size_t utf8size_lazy(const utf8_int8_t * str) { return utf8nsize_lazy(str, SIZE_MAX); }

constexpr size_t utf8nsize_lazy(const utf8_int8_t * str, size_t n) 
{
	size_t size = 0;
...
constexpr size_t utf8spn(const utf8_int8_t * src, const utf8_int8_t * accept) 
{
	size_t chars = 0;
	while('\0' != *src) {
		const utf8_int8_t * a = accept;
...
constexpr utf8_int8_t *utf8str(const utf8_int8_t * haystack, const utf8_int8_t * needle) 
{
...
constexpr utf8_int8_t *utf8casestr(const utf8_int8_t * haystack, const utf8_int8_t * needle) 
{
	/* if needle has no utf8 codepoints before the null terminating
	 * byte then return haystack */
	if('\0' == *needle) {
...
constexpr utf8_int8_t *utf8valid(const utf8_int8_t * str) { return utf8nvalid(str, SIZE_MAX); }

constexpr utf8_int8_t *utf8nvalid(const utf8_int8_t * str, size_t n) 
{
	const utf8_int8_t * t = str;
	size_t consumed = 0;
...
constexpr utf8_int8_t * utf8codepoint(const utf8_int8_t * _RESTRICT str, utf8_int32_t * _RESTRICT out_codepoint) 
{
	if(0xf0 == (0xf8 & str[0])) {
...
constexpr size_t utf8codepointcalcsize(const utf8_int8_t * str) 
{
	if(0xf0 == (0xf8 & str[0]))
		return 4; /* 4 byte utf8 codepoint */
	else if(0xe0 == (0xf0 & str[0]))
		return 3; /* 3 byte utf8 codepoint */
	else if(0xc0 == (0xe0 & str[0]))
		return 2; /* 2 byte utf8 codepoint */
	else 
...
constexpr int utf8islower(utf8_int32_t chr) { return chr != utf8uprcodepoint(chr); }
constexpr int utf8isupper(utf8_int32_t chr) { return chr != utf8lwrcodepoint(chr); }

void utf8lwr(utf8_int8_t * _RESTRICT str) 
{
	utf8_int32_t cp = 0;
...
void utf8upr(utf8_int8_t * _RESTRICT str) 
{
	utf8_int32_t cp = 0;
	utf8_int8_t * pn = utf8codepoint(str, &cp);
	while(cp != 0) {
...
constexpr utf8_int8_t *utf8rcodepoint(const utf8_int8_t * _RESTRICT str, utf8_int32_t * _RESTRICT out_codepoint) 
{
...
#undef utf8_restrict_Removed
#undef utf8_constexpr14_Removed
#undef utf8_null
