...
CURLcode Curl_auth_create_digest_http_message(struct Curl_easy *data, const char *userp, const char *passwdp, const uchar *request,
	const uchar *uri, struct digestdata *digest, char **outptr, size_t *outlen);
...
CURLcode Curl_auth_create_oauth_bearer_message(struct Curl_easy *data, const char *user, const char *host, const long port, const char *bearer, char **outptr, size_t *outlen);
	...
	// This is used to generate a base64 encoded GSSAPI (Kerberos V5) user token message 
	CURLcode Curl_auth_create_gssapi_user_message(struct Curl_easy *data, const char *userp, const char *passwdp,
		const char *service, const char *host, const bool mutual, const char *chlg64, struct kerberos5data *krb5, char **outptr, size_t *outlen);
	// This is used to generate a base64 encoded GSSAPI (Kerberos V5) security token message 
	...
	// This is used to decode a base64 encoded SPNEGO (Negotiate) challenge message 
	CURLcode Curl_auth_decode_spnego_message(struct Curl_easy *data, const char *user, const char *passwood, const char *service,
	 const char *host, const char *chlg64, struct negotiatedata *nego);
	// This is used to generate a base64 encoded SPNEGO (Negotiate) response message 
