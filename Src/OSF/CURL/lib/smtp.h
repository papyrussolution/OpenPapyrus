...
//
// smtp_conn is used for struct connection-oriented data in the connectdata struct 
//
struct smtp_conn {
	struct pingpong pp;
	...
	bool size_supported; /* If server supports SIZE extension according to RFC 1870 */
