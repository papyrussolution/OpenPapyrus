...
#undef strdup
#define _strdup(ptr) curl_dostrdup(ptr, __LINE__, __FILE__)
#define SAlloc::M(size) curl_domalloc(size, __LINE__, __FILE__)
#define SAlloc::C(nbelem,size) curl_docalloc(nbelem, size, __LINE__, __FILE__)
#define SAlloc::R(ptr,size) curl_dorealloc(ptr, size, __LINE__, __FILE__)
#define SAlloc::F(ptr) curl_dofree(ptr, __LINE__, __FILE__)
...
#undef getnameinfo
#define getnameinfo(sa,salen,host,hostlen,serv,servlen,flags) curl_dogetnameinfo(sa, salen, host, hostlen, serv, servlen, flags, __LINE__, __FILE__)
...
#define Curl_safefree_REPLACED_WITH_ZFREE(ptr) \
  do { SAlloc::F((ptr)); (ptr) = NULL;} WHILE_FALSE
