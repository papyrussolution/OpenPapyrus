...
static CURLcode telnet_do(struct connectdata * conn, bool * done)
{
...
#ifdef USE_WINSOCK
	HMODULE wsock2;
	/*WSOCK2_FUNC*/Fn_CloseEvent close_event_func;
	/*WSOCK2_FUNC*/Fn_CreateEvent create_event_func;
	/*WSOCK2_FUNC*/Fn_EventSelect event_select_func;
	/*WSOCK2_FUNC*/Fn_EnumNetevents enum_netevents_func;
	...
	*/
	...
	objs[0] = event_handle;
	objs[1] = stdin_handle;
	// If stdin_handle is a pipe, use PeekNamedPipe() method to check it, else use the old WaitForMultipleObjects() way 
