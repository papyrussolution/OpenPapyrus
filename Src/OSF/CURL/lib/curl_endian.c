...
{
	buffer[0] = (uchar)(value & 0x000000FF);
	buffer[1] = (uchar)((value & 0x0000FF00) >> 8);
	buffer[2] = (uchar)((value & 0x00FF0000) >> 16);
	buffer[3] = (uchar)((value & 0xFF000000) >> 24);
}
