 ...
 * that use memory related functions sstrdup, malloc, calloc, realloc
 ...
 *
 * File lib/sstrdup.c is an exception, given that it provides a sstrdup
...
/*
 * libcurl's 'memory tracking' system defines sstrdup, malloc, calloc,
