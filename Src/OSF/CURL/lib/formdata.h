...
enum formtype {
	...
	FORM_FILE // 'line' points to a file name we should read from to create the form data (never convert) 
};
...
struct Form {
	...
	size_t sent;     /* number of bytes of the current line that has already been sent in a previous invoke */
...
typedef struct FormInfo {
	...
	size_t bufferlength;
	char * showfilename; // The file name to show. If not set, the actual file name will be used 
