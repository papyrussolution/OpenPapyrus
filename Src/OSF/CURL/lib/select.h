...
int Curl_socket_check(curl_socket_t readfd, curl_socket_t readfd2, curl_socket_t writefd, long timeout_ms);

/* provide the former API internally */
#define Curl_socket_ready(x,y,z) Curl_socket_check(x, CURL_SOCKET_BAD, y, z)
