...
int Curl_gtls_random(struct SessionHandle *data, uchar *entropy, size_t length);
void Curl_gtls_md5sum(uchar *tmp, /* input */ size_t tmplen, uchar *md5sum, /* output */ size_t md5len);
void Curl_gtls_sha256sum(const uchar *tmp, /* input */ size_t tmplen, uchar *sha256sum, /* output */ size_t sha256len);
