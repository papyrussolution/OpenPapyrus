...
void Curl_polarssl_close(struct connectdata *conn, int sockindex); // close a SSL connection
void Curl_polarssl_session_free(void *ptr);
size_t Curl_polarssl_version(char *buffer, size_t size);
int Curl_polarssl_shutdown(struct connectdata *conn, int sockindex);

#define CURL_SSL_BACKEND CURLSSLBACKEND_POLARSSL // Set the API backend definition to PolarSSL
