...
static CURLcode schannel_connect_common(struct connectdata * conn, int sockindex,
...
static ssize_t schannel_send(struct connectdata * conn, int sockindex,
...
static ssize_t schannel_recv(struct connectdata * conn, int sockindex,
...
CURLcode Curl_schannel_connect_nonblocking(struct connectdata * conn, int sockindex,
    bool * done)
{
