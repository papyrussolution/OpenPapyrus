...
static void sasl_digest_md5_to_ascii(uchar * source, /* 16 bytes */
    uchar * dest)                                 /* 33 bytes */
{
	int i;
	for(i = 0; i < 16; i++)
 ...
 */
static bool sasl_digest_get_key_value(const char * chlg, const char * key, char * value, size_t max_val_len, char end_char)
{
	size_t i;
