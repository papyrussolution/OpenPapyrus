...
#if defined(_MSC_VER) && (_MSC_VER >= 1300) // 1800-->1300
...
/* Define if you have the sstrdup function. */
...
#endif
//
// VS2005 and later dafault size for time_t is 64-bit, unless _USE_32BIT_TIME_T has been defined to get a 32-bit time_t.
//
#if defined(_MSC_VER) && (_MSC_VER >= 1400)
...
//
   ...
   /* Officially, Microsoft's Windows SDK versions 6.X does not support Windows
	...
	//
	// The minimum build target for VS2012 is Vista unless Update 1 is installed and the v110_xp toolset is choosen.
	//
	...
	//
	// VS2012 default build target is Windows Vista unless Update 1 is installed and the v110_xp toolset is choosen.
	//
	#if defined(_USING_V110_SDK71_)
...
#endif
//
// Availability of freeaddrinfo, getaddrinfo and getnameinfo functions is quite convoluted, 
// compiler dependent and even build target dependent.
//
