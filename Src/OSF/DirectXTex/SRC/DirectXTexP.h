...
#pragma \
	warning(disable : 4619 4616 4061 4265 4365 4571 4623 4625 4626 4628 4668 4710 4711 4746 4774 4820 4987 5026 5027 5031 5032 5039 5045 5219 5246 5264 26812)
...
#define HRESULT_E_ARITHMETIC_OVERFLOW static_cast<HRESULT>(0x80070216L) // HRESULT_FROM_WIN32(ERROR_ARITHMETIC_OVERFLOW)
#define HRESULT_E_NOT_SUPPORTED static_cast<HRESULT>(0x80070032L) // HRESULT_FROM_WIN32(ERROR_NOT_SUPPORTED)
#define HRESULT_E_HANDLE_EOF static_cast<HRESULT>(0x80070026L) // HRESULT_FROM_WIN32(ERROR_HANDLE_EOF)
#define HRESULT_E_INVALID_DATA static_cast<HRESULT>(0x8007000DL) // HRESULT_FROM_WIN32(ERROR_INVALID_DATA)
#define HRESULT_E_FILE_TOO_LARGE static_cast<HRESULT>(0x800700DFL) // HRESULT_FROM_WIN32(ERROR_FILE_TOO_LARGE)
#define HRESULT_E_CANNOT_MAKE static_cast<HRESULT>(0x80070052L) // HRESULT_FROM_WIN32(ERROR_CANNOT_MAKE)
#ifndef E_NOT_SUFFICIENT_BUFFER
	#define E_NOT_SUFFICIENT_BUFFER static_cast<HRESULT>(0x8007007AL) // HRESULT_FROM_WIN32(ERROR_INSUFFICIENT_BUFFER)
#endif
...
//
HRESULT __cdecl DetermineImageArray(_In_ const TexMetadata& metadata, _In_ CP_FLAGS cpFlags, _Out_ size_t& nImages, _Out_ size_t& pixelSize) noexcept;
_Success_(return ) bool __cdecl SetupImageArray(_In_reads_bytes_(pixelSize) uint8_t* pMemory, _In_ size_t pixelSize, _In_ const TexMetadata &metadata, _In_ CP_FLAGS cpFlags,
...
void __cdecl ConvertScanline(_Inout_updates_all_(count) XMVECTOR* pBuffer, _In_ size_t count, _In_ DXGI_FORMAT outFormat, _In_ DXGI_FORMAT inFormat, _In_ TEX_FILTER_FLAGS flags) noexcept;
