...
HRESULT PerformResizeUsingWIC(const Image& srcImage, TEX_FILTER_FLAGS filter, const WICPixelFormatGUID& pfGUID, const Image& destImage) noexcept
{
...
HRESULT PerformResizeViaF32(const Image& srcImage,
