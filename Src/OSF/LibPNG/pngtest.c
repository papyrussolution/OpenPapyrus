...
static void PNGCBAPI read_row_callback(png_structp png_ptr, png_uint_32 row_number, int pass)
{
...
static void PNGCBAPI write_row_callback(png_structp png_ptr, png_uint_32 row_number, int pass)
{
...
void pngtest_check_io_state(png_structp png_ptr, png_size_t data_length,
    png_uint_32 io_op);
void pngtest_check_io_state(png_structp png_ptr, png_size_t data_length,
    png_uint_32 io_op)
{
...
/* Test one file */
static int test_one_file(PNG_CONST char * inname, PNG_CONST char * outname)
{
