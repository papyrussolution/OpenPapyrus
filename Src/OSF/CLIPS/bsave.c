...
globle intBool EnvBsave(void * theEnv, char * fileName)
{
	...
	for(biPtr = BsaveData(theEnv)->ListOfBinaryItems; biPtr != NULL; biPtr = biPtr->next) {
...
static void InitializeFunctionNeededFlags(void * theEnv)
{
	...
	for(functionList = GetFunctionList(theEnv); functionList != NULL; functionList = functionList->next) {
...
/*********************************************/
static unsigned long int FunctionBinarySize(void * theEnv)
{
...
/*   binary file.                                         */
/**********************************************************/
globle intBool AddBinaryItem(void * theEnv, char * name, int priority,
