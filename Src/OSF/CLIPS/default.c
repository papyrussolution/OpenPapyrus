...
/*   maximum value.                                                    */
/************************************************************************/
static void * FindDefaultValue(void * theEnv, int theType, CONSTRAINT_RECORD * theConstraints, void * standardDefault)
{
	/*=====================================================*/
	...
	/*=====================================================*/
	struct expr * theList = theConstraints->restrictionList;
	while(theList != NULL) {
