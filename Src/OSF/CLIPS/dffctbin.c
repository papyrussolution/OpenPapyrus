	...
	void * theEnv)
{
	...
	for(theModule = (struct defmodule *)EnvGetNextDefmodule(theEnv, NULL);
		...
		for(theDeffacts = (struct deffacts *)EnvGetNextDeffacts(theEnv, NULL);
			...
			MarkConstructHeaderNeededItems(&theDeffacts->header, DeffactsBinaryData(
...
static void BsaveExpressions(void * theEnv, FILE * fp)
{
	...
	for(theModule = (struct defmodule *)EnvGetNextDefmodule(theEnv, NULL); theModule != NULL; theModule = (struct defmodule *)EnvGetNextDefmodule(theEnv, theModule)) {
		/*======================================================*/
...
static void BsaveStorage(void * theEnv, FILE * fp)
{
	...
	/*=================================================================*/
	unsigned long space = sizeof(long)*2;
...
static void BsaveBinaryItem(void * theEnv, FILE * fp)
{
	...
	for(theModule = (struct defmodule *)EnvGetNextDefmodule(theEnv, NULL);
		...
		theModuleItem = (struct deffactsModule *)GetModuleItem(theEnv, NULL, DeffactsData(
				theEnv)->DeffactsModuleIndex);
	...
	for(theModule = (struct defmodule *)EnvGetNextDefmodule(theEnv, NULL);
		...
		for(theDeffacts = (struct deffacts *)EnvGetNextDeffacts(theEnv, NULL);
			...
			else {newDeffacts.assertList = -1L; }
...
{
	struct bsaveDeffactsModule * bdmPtr = (struct bsaveDeffactsModule *)buf;
...
{
	struct bsaveDeffacts * bdp = (struct bsaveDeffacts *)buf;
