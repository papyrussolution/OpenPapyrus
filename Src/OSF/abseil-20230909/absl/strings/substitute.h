...
public:
	...
	Arg(const char* value) : piece_(absl::NullSafeStringView(value)) 
	{
	} // NOLINT(google-explicit-constructor)
	template <typename Allocator> Arg(const std::basic_string<char, std::char_traits<char>, Allocator> & value) noexcept : piece_(value) 
	{
	} // NOLINT
	Arg(absl::string_view value) : piece_(value) 
	{
	} // NOLINT(google-explicit-constructor)
	...
	// what to do.
	Arg(char value) : piece_(scratch_, 1) 
	{
		scratch_[0] = value;
	} // NOLINT(google-explicit-constructor)
	Arg(short value) : piece_(scratch_, static_cast<size_t>(numbers_internal::FastIntToBuffer(value, scratch_) - scratch_)) 
	{
	} // NOLINT(*)
	Arg(unsigned short value) : piece_(scratch_, static_cast<size_t>(numbers_internal::FastIntToBuffer(value, scratch_) - scratch_)) 
	{
	} // NOLINT(*)
