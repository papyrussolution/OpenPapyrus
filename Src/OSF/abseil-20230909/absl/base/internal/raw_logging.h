...
#else  // NDEBUG
    #define ABSL_RAW_DLOG(severity, ...) while(false) ABSL_RAW_LOG(severity, __VA_ARGS__)
    #define ABSL_RAW_DCHECK(condition, message) while(false) ABSL_RAW_CHECK(condition, message)
#endif  // NDEBUG
