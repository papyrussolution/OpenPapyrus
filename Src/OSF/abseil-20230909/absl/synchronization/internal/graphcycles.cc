...
ABSL_CONST_INIT static absl::base_internal::SpinLock arena_mu(absl::kConstInit, base_internal::SCHEDULE_KERNEL_ONLY);
...
private:
	...
	static uint32_t Hash(int32_t a) {
		return static_cast<uint32_t>(a * 41);
	}
