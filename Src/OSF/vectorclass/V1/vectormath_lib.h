...
*
*****************************************************************************/
//#include <ia32intrin.h>    // intel svml functions. Now in immintrin.h
...
#else
// gcc. Change this if gcc supports __vectorcall
...
// complex functions
/*
static inline Vec16f cexp(Vec16f const & x) {   // complex exponential function
    return  __svml_cexpf8(x);
}
static inline Vec8d cexp(Vec8d const & x) {   // complex exponential function
    return  __svml_cexp2(x);
} */
...
// to do: check later versions ov SVML
static inline Vec16f cexp (Vec16f const & x) {   // complex exponential function
    return Vec16f(cexp(x.get_low()), cexp(x.get_high()));
}
static inline Vec8d cexp (Vec8d const & x) {   // complex exponential function
    return Vec8d(cexp(x.get_low()), cexp(x.get_high()));
} 
