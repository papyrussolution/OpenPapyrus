...
static void _svg_parser_sax_start_element(void * closure, const XML_Char * name, const XML_Char ** atts);
static void _svg_parser_sax_end_element(void * closure, const XML_Char * name);
static void _svg_parser_sax_characters(void * closure, const XML_Char * ch, int len);
...
svg_status_t _svg_parser_init(svg_parser_t * parser, svg_t * svg)
{
	parser->svg = svg;
	parser->ctxt = NULL;
...
svg_status_t _svg_parser_deinit(svg_parser_t * parser)
{
	parser->svg = NULL;
	parser->ctxt = NULL;
	parser->status = SVG_STATUS_SUCCESS;
...
svg_status_t _svg_parser_begin(svg_parser_t * parser)
{
...
svg_status_t _svg_parser_parse_chunk(svg_parser_t * parser, const char * buf, size_t count)
{
	if(parser->status)
		return parser->status;
	if(parser->ctxt == NULL)
...
svg_status_t _svg_parser_end(svg_parser_t * parser)
{
	if(parser->ctxt == NULL)
		return SVG_STATUS_INVALID_CALL;
