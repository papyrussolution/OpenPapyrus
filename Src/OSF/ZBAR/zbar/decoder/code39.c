...
static const uchar code39_hi[32] = {
	0x80 | 0x00, /* 2 next */
	0x40 | 0x02, /* 4 */
	0x80 | 0x06, /* 2 next */
	0xc0 | 0x08, /* 2 skip */
...
static inline int8 code39_decode9(zbar_decoder_t * dcode)
{
...
static inline int8 code39_decode_start(zbar_decoder_t * dcode)
{
	code39_decoder_t * dcode39 = &dcode->code39;
