...
private:
	...
	/*
	class ZBarSymbolIterator : public ZBarSymbolIterator {
	public:
		/// default constructor.
		ZBarSymbolIterator () : ZBarSymbolIterator()
		{
		}
		/// constructor.
		ZBarSymbolIterator(const SymbolSet &syms) : zbar::ZBarSymbolIterator(syms)
		{
		}
		/// copy constructor.
		ZBarSymbolIterator(const ZBarSymbolIterator& iter) : zbar::ZBarSymbolIterator(iter)
		{
		}
	};
	*/
	...
	void set_data(const void * data, ulong length)
	{
		zbar_image_set_data(_img, data, length, _cleanup);
	}
	/// image format conversion.
	/// see zbar_image_convert()
	Image convert(ulong format) const
	{
