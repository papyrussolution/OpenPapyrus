...
#define CURL_TIMEOUT_RESOLVE 300 // when using asynch methods, we allow this many seconds for a name resolve 
 ...
 */
struct Curl_dns_entry *Curl_cache_addr(struct Curl_easy * data, struct Curl_addrinfo * addr,
