    ...
    struct Curl_easy * data)
{
	...
	alpn[0].data = (uchar*)H3_ALPN_H3_29 + 1;
	alpn[0].size = sizeof(H3_ALPN_H3_29) - 2;
	alpn[1].data = (uchar*)H3_ALPN_H3 + 1;
...
static CURLcode recv_pkt(const uchar * pkt, size_t pktlen,
 ...
 */
static ssize_t read_pkt_to_send(void * userp, uchar * buf, size_t buflen, CURLcode * err)
{
