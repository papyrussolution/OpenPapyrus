...
#define HAVE_CTYPE_H /* Define to 1 if you have the <ctype.h> header file. */
...
#define HAVE_ERRNO_H   /* Define to 1 if you have the <errno.h> header file. */
...
#define HAVE_FCNTL_H /* Define to 1 if you have the <fcntl.h> header file. */
...
/* #undef HAVE_PTHREAD_H */ /* Define to 1 if you have the <pthread.h> header file. */
...
#define HAVE_STDARG_H /* Define to 1 if you have the <stdarg.h> header file. */
/* #undef HAVE_STDINT_H */ /* Define to 1 if you have the <stdint.h> header file. */
#define HAVE_STDLIB_H /* Define to 1 if you have the <stdlib.h> header file. */
...
#define HAVE_STRING_H /* Define to 1 if you have the <string.h> header file. */
...
#define HAVE_SYS_STAT_H /* Define to 1 if you have the <sys/stat.h> header file. */
...
#define HAVE_TIME_H /* Define to 1 if you have the <time.h> header file. */
...
#define HAVE_ZLIB_H // Define to 1 if you have the <zlib.h> header file. 
/* #undef HAVE_ZSTD_H */ /* Define to 1 if you have the <zstd.h> header file. */
