 ...
 */
static bool U_CALLCONV zoneMeta_cleanup(void)
{
 ...
 * Deleter for UVector
 */
static void U_CALLCONV deleteUVector(void * obj) {
...
UnicodeString &
U_EXPORT2 ZoneMeta::getCanonicalCountry(const UnicodeString & tzid, UnicodeString & country, bool * isPrimary /* = NULL
      */       ) {
	if(isPrimary != NULL) {
		*isPrimary = FALSE;
	}
