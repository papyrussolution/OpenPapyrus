...
NumberParserImpl* NumberParserImpl::createSimpleParser(const Locale & locale, const UnicodeString & patternString,
	...
	dfs.setSymbol(DecimalFormatSymbols::kCurrencySymbol, UnicodeString(u"IU$"));
	dfs.setSymbol(DecimalFormatSymbols::kIntlCurrencySymbol, UnicodeString(u"ICU"));
	...
	parser->addMatcher(parser->fLocalMatchers.padding = {UnicodeString(u"@")});
...
NumberParserImpl* NumberParserImpl::createParserFromProperties(const number::impl::DecimalFormatProperties& properties,
