...
CECalendar::CECalendar (const CECalendar& other) :   Calendar(other)
{
}
...
bool CECalendar::inDaylightTime(UErrorCode & status) const
{
...
bool CECalendar::haveDefaultCentury() const
{
	return TRUE;
}
//
...
void CECalendar::jdToCE(int32_t julianDay, int32_t jdEpochOffset, int32_t& year, int32_t& month, int32_t& day)
{
	...
	c4 = ClockMath::floorDivide(julianDay - jdEpochOffset, SlConst::DaysPer4Years, r4);
