...
UnicodeString RequireAffixValidator::toString() const {
	return UnicodeString(u"<ReqAffix>");
}
...
UnicodeString RequireCurrencyValidator::toString() const {
	return UnicodeString(u"<ReqCurrency>");
}
...
UnicodeString RequireDecimalSeparatorValidator::toString() const { return UnicodeString(u"<ReqDecimal>"); }
...
UnicodeString RequireNumberValidator::toString() const { return UnicodeString(u"<ReqNumber>"); }
...
UnicodeString MultiplierParseHandler::toString() const { return UnicodeString(u"<Scale>"); }
