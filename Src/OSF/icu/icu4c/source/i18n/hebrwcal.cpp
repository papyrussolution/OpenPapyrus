 ...
 */
static const int8 MONTH_LENGTH[][3] = {
...
static const int16 MONTH_START[][3] = {
	// Deficient  Normal     Complete
	{    0,          0,          0  }, // (placeholder)
	{   30,         30,         30  }, // Tishri
	{   59,         59,         60  }, // Heshvan
 ...
 */
static const int16 LEAP_MONTH_START[][3] = {
	// Deficient  Normal     Complete
	{    0,          0,          0  }, // (placeholder)
	{   30,         30,         30  }, // Tishri
	{   59,         59,         60  }, // Heshvan
...
bool HebrewCalendar::inDaylightTime(UErrorCode & status) const
{
...
bool HebrewCalendar::haveDefaultCentury() const
{
	return TRUE;
}
