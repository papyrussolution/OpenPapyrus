...
#include "uprops.h"
#include "ucln_in.h"
#include "regexcst.h"   // Contains state table for the regex pattern parser. generated by a Perl script.
#include "regexst.h"
...
U_CDECL_BEGIN
static bool U_CALLCONV regex_cleanup() 
{
	ZDELETE(RegexStaticSets::gStaticSets);
