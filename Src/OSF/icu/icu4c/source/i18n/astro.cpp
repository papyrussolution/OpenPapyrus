...
static inline bool isINVALID(double d) { return(uprv_isNaN(d)); }

static icu::UMutex ccLock;

U_CDECL_BEGIN
	static bool calendar_astro_cleanup() { return TRUE; }
U_CDECL_END
 ...
 */
inline static double normalize(double value, double range) { return value - range * ClockMath::floorDivide(value, range); }
/**
 ...
 * @deprecated ICU 2.4. This class may be removed or modified.
 */
CalendarAstronomer::CalendarAstronomer() : fTime(Calendar::getNow()), fLongitude(0.0), fLatitude(0.0), fGmtOffset(0.0), moonPosition(0, 0), moonPositionSet(FALSE) 
{
	clearCache();
}
 ...
 * @deprecated ICU 2.4. This class may be removed or modified.
 */
CalendarAstronomer::CalendarAstronomer(UDate d) : fTime(d), fLongitude(0.0), fLatitude(0.0), fGmtOffset(0.0), moonPosition(0, 0),
 ...
 * @deprecated ICU 2.4. This class may be removed or modified.
 */
UDate CalendarAstronomer::getTime() { return fTime; }
/**
 * Get the current time of this <code>CalendarAstronomer</code> object,
 ...
 * @deprecated ICU 2.4. This class may be removed or modified.
 */
CalendarAstronomer::Equatorial& CalendarAstronomer::eclipticToEquatorial(CalendarAstronomer::Equatorial& result,
    const CalendarAstronomer::Ecliptic& ecliptic)
{
...
UDate CalendarAstronomer::getSunTime(double desired, bool next)
{
...
UDate CalendarAstronomer::getSunRiseSet(bool rise)
{
	UDate t0 = fTime;
 ...
 * @deprecated ICU 2.4. This class may be removed or modified.
 */
UDate CalendarAstronomer::getMoonTime(double desired, bool next)
{
 ...
 * @deprecated ICU 2.4. This class may be removed or modified.
 */
UDate CalendarAstronomer::getMoonTime(const CalendarAstronomer::MoonAge& desired, bool next) {
 ...
 * @deprecated ICU 2.4. This class may be removed or modified.
 */
UDate CalendarAstronomer::getMoonRiseSet(bool rise)
{
	MoonRiseSetCoordFunc func;
	return riseOrSet(func, rise, .533 * DEG_RAD/*Angular Diameter*/, 34 /60.0 * DEG_RAD/*Refraction correction*/, MINUTE_MS/*Desired accuracy*/);
}
//
// Interpolation methods for finding the time at which a given event occurs
//
UDate CalendarAstronomer::timeOfAngle(AngleFunc& func, double desired, double periodDays, double epsilon, bool next)
{
...
UDate CalendarAstronomer::riseOrSet(CoordFunc& func, bool rise, double diameter, double refraction, double epsilon)
{
	Equatorial pos;
	double tanL   = ::tan(fLatitude);
	double deltaT = 0;
