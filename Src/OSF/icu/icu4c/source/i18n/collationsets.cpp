...
static bool U_CALLCONV enumTailoredRange(const void * context, UChar32 start, UChar32 end, uint32_t ce32) {
...
static bool U_CALLCONV enumCnERange(const void * context, UChar32 start, UChar32 end, uint32_t ce32) {
