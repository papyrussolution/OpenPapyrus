...
U_NAMESPACE_BEGIN UOBJECT_DEFINE_RTTI_IMPLEMENTATION(TimeUnit)
 ...
 */
TimeUnit* U_EXPORT2 TimeUnit::createInstance(TimeUnit::UTimeUnitFields timeUnitField,
    UErrorCode & status) {
	if(U_FAILURE(status)) {
		return NULL;
	}
...
TimeUnit::UTimeUnitFields TimeUnit::getTimeUnitField() const {
