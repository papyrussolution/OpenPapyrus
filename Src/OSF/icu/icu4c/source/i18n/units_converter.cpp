 ...
 */
bool checkSimpleUnit(const MeasureUnitImpl &unit, UErrorCode & status) {
...
bool checkAllDimensionsAreZeros(const MaybeStackVector<UnitIndexAndDimension> &dimensionVector) {
