...
namespace {
const char16_t* doGetPattern(UResourceBundle * res, const char * nsName, const char * patternKey, UErrorCode & publicStatus,
...
const char16_t* utils::getPatternForStyle(const Locale & locale, const char * nsName, CldrPatternStyle style,
	...
	switch(style) {
		case CLDR_PATTERN_STYLE_DECIMAL: patternKey = "decimalFormat"; break;
		case CLDR_PATTERN_STYLE_CURRENCY: patternKey = "currencyFormat"; break;
		case CLDR_PATTERN_STYLE_ACCOUNTING: patternKey = "accountingFormat"; break;
		case CLDR_PATTERN_STYLE_PERCENT: patternKey = "percentFormat"; break;
		case CLDR_PATTERN_STYLE_SCIENTIFIC: patternKey = "scientificFormat"; break;
		default: patternKey = "decimalFormat"; // silence compiler error
...
bool DecNum::isSpecial() const { return decNumberIsSpecial(fData.getAlias()); }
bool DecNum::isInfinity() const { return decNumberIsInfinite(fData.getAlias()); }
bool DecNum::isNaN() const { return decNumberIsNaN(fData.getAlias()); }
