...
U_NAMESPACE_END UPRV_FORMATTED_VALUE_CAPI_NO_IMPLTYPE_AUTO_IMPL(UFormattedNumberRange,
    UFormattedNumberRangeImpl,
...
U_CAPI void U_EXPORT2 unumrf_formatDoubleRange(const UNumberRangeFormatter* uformatter,
    double first,
    double second,
...
U_CAPI void U_EXPORT2 unumrf_formatDecimalRange(const UNumberRangeFormatter* uformatter,
...
U_CAPI UNumberRangeIdentityResult U_EXPORT2 unumrf_resultGetIdentityResult(const UFormattedNumberRange* uresult,
    UErrorCode * ec) {
	auto* result = UFormattedNumberRangeApiHelper::validate(uresult, *ec);
	if(U_FAILURE(*ec)) {
...
U_CAPI int32_t U_EXPORT2 unumrf_resultGetFirstDecimalNumber(const UFormattedNumberRange* uresult,
    char * dest,
...
U_CAPI int32_t U_EXPORT2 unumrf_resultGetSecondDecimalNumber(const UFormattedNumberRange* uresult,
    char * dest,
    int32_t destCapacity,
    UErrorCode * ec) {
	const auto* result = UFormattedNumberRangeApiHelper::validate(uresult, *ec);
