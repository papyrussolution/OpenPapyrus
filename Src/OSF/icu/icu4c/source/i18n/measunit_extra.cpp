...
enum CompoundPart {
	COMPOUND_PART_PER = kCompoundPartOffset, // Represents "-per-"
	COMPOUND_PART_TIMES, // Represents "-"
	COMPOUND_PART_AND, // Represents "-and-"
};
...
bool U_CALLCONV cleanupUnitExtras() 
{
...
void U_CALLCONV initUnitExtras(UErrorCode & status) 
{
	...
	memzero(gCategories, quantitiesMallocSize);
	...
	memzero(gSimpleUnits, arrayMallocSize);
	...
	memzero(gSimpleUnitCategories, arrayMallocSize);
