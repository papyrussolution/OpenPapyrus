...
U_NAMESPACE_BEGIN UOBJECT_DEFINE_RTTI_IMPLEMENTATION(Measure)

Measure::Measure() : unit(nullptr) 
{
}

Measure::Measure(const Formattable& _number, MeasureUnit* adoptedUnit, UErrorCode & ec) : number(_number), unit(adoptedUnit) 
{
...
Measure::Measure(const Measure& other) : UObject(other), unit(nullptr) 
{
	*this = other;
}
