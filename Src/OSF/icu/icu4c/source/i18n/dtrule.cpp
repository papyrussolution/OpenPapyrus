...
U_NAMESPACE_BEGIN UOBJECT_DEFINE_RTTI_IMPLEMENTATION(DateTimeRule)
...
DateTimeRule::DateRuleType DateTimeRule::getDateRuleType() const {
	return fDateRuleType;
}

DateTimeRule::TimeRuleType DateTimeRule::getTimeRuleType() const {
	return fTimeRuleType;
}

int32_t DateTimeRule::getRuleMonth() const {
	return fMonth;
}

int32_t DateTimeRule::getRuleDayOfMonth() const {
	return fDayOfMonth;
}

int32_t DateTimeRule::getRuleDayOfWeek() const {
	return fDayOfWeek;
}

int32_t DateTimeRule::getRuleWeekInMonth() const {
	return fWeekInMonth;
}

int32_t DateTimeRule::getRuleMillisInDay() const {
	return fMillisInDay;
}
