...
const char * CharsetRecog_2022JP::getName() const { return "ISO-2022-JP"; }
...
const char * CharsetRecog_2022KR::getName() const { return "ISO-2022-KR"; }

bool CharsetRecog_2022KR::match(InputText * textIn, CharsetMatch * results) const 
{
...
const char * CharsetRecog_2022CN::getName() const { return "ISO-2022-CN"; }
