...
BuddhistCalendar::BuddhistCalendar(const Locale & aLocale, UErrorCode & success) : GregorianCalendar(aLocale, success)
{
...
BuddhistCalendar* BuddhistCalendar::clone() const { return new BuddhistCalendar(*this); }
const char * BuddhistCalendar::getType() const { return "buddhist"; }
...
int32_t BuddhistCalendar::handleGetExtendedYear()
{
	...
	if(newerField(UCAL_EXTENDED_YEAR, UCAL_YEAR) == UCAL_EXTENDED_YEAR) {
		...
		year = internalGet(UCAL_YEAR, kGregorianEpoch - kBuddhistEraStart) + kBuddhistEraStart;
	}
	return year;
}

int32_t BuddhistCalendar::handleComputeMonthStart(int32_t eyear, int32_t month, bool useMonth) const
{
...
#if 0
void BuddhistCalendar::timeToFields(UDate theTime, bool quick, UErrorCode & status)
{
...
bool BuddhistCalendar::haveDefaultCentury() const
{
	return TRUE;
}
