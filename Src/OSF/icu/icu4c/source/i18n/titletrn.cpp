...
U_NAMESPACE_BEGIN UOBJECT_DEFINE_RTTI_IMPLEMENTATION(TitlecaseTransliterator)
 ...
 */
void TitlecaseTransliterator::handleTransliterate(Replaceable& text, UTransPosition& offsets,
    bool isIncremental) const
{
	...
	for(textPos = offsets.start; textPos<offsets.limit;) {
		...
		if(type>=0) { // not case-ignorable
			...
			doTitle = (bool)(type==0); // doTitle=isUncased
