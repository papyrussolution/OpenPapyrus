...
public:
	...
	const SimpleFormatter * getCombinedDateAndTime() const { return combinedDateAndTime; }
private:
...
const UnicodeString & RelativeDateTimeCacheData::getAbsoluteUnitString(int32_t fStyle, UDateAbsoluteUnit unit,
...
const SimpleFormatter* RelativeDateTimeCacheData::getRelativeUnitFormatter(int32_t fStyle,
...
const SimpleFormatter* RelativeDateTimeCacheData::getRelativeDateTimeUnitFormatter(int32_t fStyle,
...
struct RelDateTimeFmtDataSink : public ResourceSink {
	...
	static int32_t relUnitFromGeneric(RelAbsUnit genUnit) {
		...
		switch(genUnit) {
			case SECOND: return UDAT_REL_UNIT_SECOND;
			case MINUTE: return UDAT_REL_UNIT_MINUTE;
			case HOUR: return UDAT_REL_UNIT_HOUR;
			case DAY: return UDAT_REL_UNIT_DAY;
			case WEEK: return UDAT_REL_UNIT_WEEK;
			case MONTH: return UDAT_REL_UNIT_MONTH;
			case QUARTER: return UDAT_REL_UNIT_QUARTER;
			case YEAR: return UDAT_REL_UNIT_YEAR;
			case SUNDAY: return UDAT_REL_UNIT_SUNDAY;
			case MONDAY: return UDAT_REL_UNIT_MONDAY;
			case TUESDAY: return UDAT_REL_UNIT_TUESDAY;
			case WEDNESDAY: return UDAT_REL_UNIT_WEDNESDAY;
			case THURSDAY: return UDAT_REL_UNIT_THURSDAY;
			case FRIDAY: return UDAT_REL_UNIT_FRIDAY;
			case SATURDAY: return UDAT_REL_UNIT_SATURDAY;
			default: return -1;
		}
	}
	...
	static int32_t absUnitFromGeneric(RelAbsUnit genUnit) {
		// Converts the generic units to UDAT_RELATIVE version.
		switch(genUnit) {
			case DAY: return UDAT_ABSOLUTE_DAY;
			case WEEK: return UDAT_ABSOLUTE_WEEK;
			case MONTH: return UDAT_ABSOLUTE_MONTH;
			case QUARTER: return UDAT_ABSOLUTE_QUARTER;
			case YEAR: return UDAT_ABSOLUTE_YEAR;
			case SUNDAY: return UDAT_ABSOLUTE_SUNDAY;
			case MONDAY: return UDAT_ABSOLUTE_MONDAY;
			case TUESDAY: return UDAT_ABSOLUTE_TUESDAY;
			case WEDNESDAY: return UDAT_ABSOLUTE_WEDNESDAY;
			case THURSDAY: return UDAT_ABSOLUTE_THURSDAY;
			case FRIDAY: return UDAT_ABSOLUTE_FRIDAY;
			case SATURDAY: return UDAT_ABSOLUTE_SATURDAY;
			case HOUR: return UDAT_ABSOLUTE_HOUR;
			case MINUTE: return UDAT_ABSOLUTE_MINUTE;
			default: return -1;
		}
	}
	...
	// Constructor
	RelDateTimeFmtDataSink(RelativeDateTimeCacheData& cacheData) : outputData(cacheData) 
	{
...
template <> U_I18N_API
const RelativeDateTimeCacheData * LocaleCacheKey<RelativeDateTimeCacheData>::createObject(const void * /*unused*/,
...
RelativeDateTimeFormatter::RelativeDateTimeFormatter(const Locale & locale,
...
UnicodeString & RelativeDateTimeFormatter::doFormat(F callback,
...
template <typename F, typename ... Args>
FormattedRelativeDateTime RelativeDateTimeFormatter::doFormatToValue(F callback,
    UErrorCode & status,
    Args ... args) const {
...
UnicodeString & RelativeDateTimeFormatter::combineDateAndTime(const UnicodeString & relativeDateString, const UnicodeString & timeString,
...
bool RelativeDateTimeFormatter::checkNoAdjustForContext(UErrorCode & status) const {
...
UPRV_FORMATTED_VALUE_CAPI_AUTO_IMPL(FormattedRelativeDateTime,
...
U_CAPI URelativeDateTimeFormatter* U_EXPORT2 ureldatefmt_open(const char * locale,
    UNumberFormat * nfToAdopt, UDateRelativeDateTimeFormatterStyle width, UDisplayContext capitalizationContext, UErrorCode * status)
{
	if(U_FAILURE(*status)) {
		return nullptr;
	}
	LocalPointer<RelativeDateTimeFormatter> formatter(new RelativeDateTimeFormatter(Locale(locale), (NumberFormat*)nfToAdopt, width,
...
U_CAPI void U_EXPORT2 ureldatefmt_formatNumericToResult(const URelativeDateTimeFormatter* reldatefmt, double offset,
...
U_CAPI void U_EXPORT2 ureldatefmt_formatToResult(const URelativeDateTimeFormatter* reldatefmt, double offset,
    URelativeDateTimeUnit unit, UFormattedRelativeDateTime *       result, UErrorCode * status) 
{
	if(U_FAILURE(*status)) {
		return;
    ...
    UErrorCode * status)
{
	...
	UnicodeString relDateStr((bool)(relativeDateStringLen == -1), relativeDateString, relativeDateStringLen);
	UnicodeString timeStr((bool)(timeStringLen == -1), timeString, timeStringLen);
