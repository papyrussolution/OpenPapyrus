...
UPRV_FORMATTED_VALUE_CAPI_AUTO_IMPL(FormattedDateInterval,
...
U_CAPI UDateIntervalFormat* U_EXPORT2 udtitvfmt_open(const char * locale, const char16_t * skeleton, int32_t skeletonLength,
    const char16_t * tzID, int32_t tzIDLength, UErrorCode *  status)
{
	if(U_FAILURE(*status)) {
		return NULL;
	}
...
U_CAPI void U_EXPORT2 udtitvfmt_setContext(UDateIntervalFormat* formatter,
...
U_CAPI UDisplayContext U_EXPORT2 udtitvfmt_getContext(const UDateIntervalFormat* formatter,
