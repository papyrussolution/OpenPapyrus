...
FormattedValueFieldPositionIteratorImpl::FormattedValueFieldPositionIteratorImpl(int32_t initialFieldCapacity,
    UErrorCode & status)
...
Appendable& FormattedValueFieldPositionIteratorImpl::appendTo(Appendable& appendable,
    UErrorCode&) const {
