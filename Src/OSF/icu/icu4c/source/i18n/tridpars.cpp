 ...
 */
TransliteratorIDParser::SingleID* TransliteratorIDParser::parseSingleID(const UnicodeString & id, int32_t& pos,
 ...
 */
bool TransliteratorIDParser::parseCompoundID(const UnicodeString & id, int32_t dir,
    UnicodeString & canonID,
    UVector& list,
 ...
 * NULL is returned.
 */
TransliteratorIDParser::Specs* TransliteratorIDParser::parseFilterID(const UnicodeString & id, int32_t& pos,
    bool allowFilter) {
	UnicodeString first;
	UnicodeString source;
	UnicodeString target;
