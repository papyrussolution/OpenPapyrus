...
U_CAPI bool U_EXPORT2 zrule_equals(const ZRule* rule1, const ZRule* rule2) {
...
U_CAPI bool U_EXPORT2 izrule_equals(const IZRule* rule1, const IZRule* rule2) {
...
U_CAPI bool U_EXPORT2 izrule_isEquivalentTo(IZRule* rule1,  IZRule* rule2) {
	return ((InitialTimeZoneRule*)rule1)->InitialTimeZoneRule::isEquivalentTo(*(InitialTimeZoneRule*)rule2);
}

U_CAPI bool U_EXPORT2 izrule_getFirstStart(IZRule* rule, int32_t prevRawOffset, int32_t prevDSTSavings,
    UDate& result) {
	return ((const InitialTimeZoneRule*)rule)->InitialTimeZoneRule::getFirstStart(prevRawOffset, prevDSTSavings, result);
}

U_CAPI bool U_EXPORT2 izrule_getFinalStart(IZRule* rule, int32_t prevRawOffset, int32_t prevDSTSavings,
    UDate& result) {
	return ((InitialTimeZoneRule*)rule)->InitialTimeZoneRule::getFinalStart(prevRawOffset, prevDSTSavings, result);
}

U_CAPI bool U_EXPORT2 izrule_getNextStart(IZRule* rule, UDate base, int32_t prevRawOffset,
    int32_t prevDSTSavings, bool inclusive, UDate& result) {
	return ((InitialTimeZoneRule*)rule)->InitialTimeZoneRule::getNextStart(base, prevRawOffset, prevDSTSavings, inclusive, result);
}

U_CAPI bool U_EXPORT2 izrule_getPreviousStart(IZRule* rule, UDate base, int32_t prevRawOffset,
    int32_t prevDSTSavings, bool inclusive, UDate& result) {
