...
void IndianCalendar::handleComputeFields(int32_t julianDay, UErrorCode & /* status */) {
	...
	if(yday < INDIAN_YEAR_START) {
		...
		IndianYear -= 1;
		leapMonth = isGregorianLeap(gregorianYear - 1) ? 31 : 30; // Days in leapMonth this year, previous
		                                                          // Gregorian year
...
bool IndianCalendar::inDaylightTime(UErrorCode & status) const
{
...
bool IndianCalendar::haveDefaultCentury() const
{
	return TRUE;
}
