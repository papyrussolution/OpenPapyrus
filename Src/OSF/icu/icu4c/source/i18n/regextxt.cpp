...
U_CFUNC char16_t U_CALLCONV uregex_utext_unescape_charAt(int32_t offset, void * ct) 
{
...
U_CFUNC char16_t U_CALLCONV uregex_ucstr_unescape_charAt(int32_t offset, void * context) 
{
