...
bool ScriptSet::contains(const ScriptSet &other) const {
	ScriptSet t(*this);
	t.intersect(other);
	return (t == other);
}
...
U_CAPI bool U_EXPORT2 uhash_equalsScriptSet(const UElement key1, const UElement key2) 
{
