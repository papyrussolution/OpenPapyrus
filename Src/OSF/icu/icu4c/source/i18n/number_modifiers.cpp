...
bool U_CALLCONV cleanupDefaultCurrencySpacing() 
{
	ZDELETE(UNISET_DIGIT);
	ZDELETE(UNISET_NOTSZ);
...
Modifier::Parameters::Parameters() : obj(nullptr) 
{
}

Modifier::Parameters::Parameters(const ModifierStore* _obj, Signum _signum, StandardPlural::Form _plural) : obj(_obj), signum(_signum), plural(_plural) 
{
}
...
int32_t ConstantAffixModifier::apply(FormattedStringBuilder &output, int leftIndex, int rightIndex, UErrorCode & status) const 
{
...
int32_t ConstantAffixModifier::getPrefixLength() const { return fPrefix.length(); }
int32_t ConstantAffixModifier::getCodePointCount() const { return fPrefix.countChar32() + fSuffix.countChar32(); }
bool ConstantAffixModifier::isStrong() const { return fStrong; }
...
int32_t SimpleModifier::formatTwoArgPattern(const SimpleFormatter& compiled, FormattedStringBuilder& result,
...
int32_t CurrencySpacingEnabledModifier::applyCurrencySpacing(FormattedStringBuilder &output, int32_t prefixStart,
...
int32_t CurrencySpacingEnabledModifier::applyCurrencySpacingAffix(FormattedStringBuilder &output, int32_t index,
    EAffix affix,
    const DecimalFormatSymbols &symbols,
    UErrorCode & status) {
...
UnicodeSet CurrencySpacingEnabledModifier::getUnicodeSet(const DecimalFormatSymbols &symbols, EPosition position,
...
UnicodeString CurrencySpacingEnabledModifier::getInsertString(const DecimalFormatSymbols &symbols, EAffix affix,
    UErrorCode & status) {
