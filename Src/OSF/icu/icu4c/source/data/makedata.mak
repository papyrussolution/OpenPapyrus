...
ICUSRCDATA=$(ICUMAKE)\..\osf\icu\icu4c\source\data
...
$(TOOLS_TS): "$(ICUTOOLS)\genrb.exe" "$(ICUTOOLS)\gencnval.exe" "$(ICUTOOLS)\gencfu.exe" "$(ICUTOOLS)\icupkg.exe" "$(ICUTOOLS)\makeconv.exe" "$(ICUPBIN)\pkgdata.exe"
