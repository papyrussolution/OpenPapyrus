...
RunArray::RunArray(le_int32 initialCapacity) : fClientArrays(FALSE), fLimits(NULL), fCount(0), fCapacity(initialCapacity)
{
...
FontRuns::FontRuns(le_int32 initialCapacity) : RunArray(initialCapacity), fFonts(NULL)
{
	if(initialCapacity > 0) {
...
ValueRuns::ValueRuns(le_int32 initialCapacity) : RunArray(initialCapacity), fValues(NULL)
{
	if(initialCapacity > 0) {
