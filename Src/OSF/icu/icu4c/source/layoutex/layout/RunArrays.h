...
private:
	...
	inline RunArray &operator=(const RunArray & /*other*/) {
		return *this;
	};
...
private:
	...
	inline FontRuns &operator=(const FontRuns & /*other*/) {
		return *this;
	};
...
inline ValueRuns::ValueRuns() : RunArray(0), fValues(NULL)
{
	// nothing else to do...
}

inline ValueRuns::ValueRuns(const ValueRuns & /*other*/) : RunArray(0), fValues(NULL)
{
	// nothing else to do...
}

inline ValueRuns::ValueRuns(const le_int32 * values, const le_int32 * limits, le_int32 count) : RunArray(limits, count), fValues(values)
{
	// nothing else to do...
}
