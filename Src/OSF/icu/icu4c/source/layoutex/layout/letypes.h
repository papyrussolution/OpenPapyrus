...
#define __LETYPES_H
	...
	defined(U_STATIC_IMPLEMENTATION) || defined(U_COMBINED_IMPLEMENTATION))
 ...
 * @internal
 */
// @sobolev #define LE_ARRAY_SIZE(array) (sizeof array / sizeof array[0])
 ...
 * @internal
 */
#define LE_NEW_ARRAY(type, count) LE_RANGE_CHECK(type, count, (type*)SAlloc::M((count) * sizeof(type)))
/**
 * Re-allocate an array of basic types. This is used to isolate the rest of
 * the LayoutEngine code from cmemory.h.
 *
 * @internal
 */
#define LE_GROW_ARRAY(array, newSize) SAlloc::R((void*)(array), (newSize) * sizeof(array)[0])
/**
 * Free an array of basic types. This is used to isolate the rest of
 * the LayoutEngine code from cmemory.h.
 *
 * @internal
 */
#define LE_DELETE_ARRAY(array) SAlloc::F((void*)(array))
