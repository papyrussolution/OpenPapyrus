...
U_CAPI pl_fontRuns * U_EXPORT2 pl_openFontRuns(const le_font ** fonts,
...
U_CAPI pl_fontRuns * U_EXPORT2 pl_openEmptyFontRuns(le_int32 initialCapacity)
{
	return (pl_fontRuns*)new FontRuns(initialCapacity);
}

U_CAPI void U_EXPORT2 pl_closeFontRuns(pl_fontRuns * fontRuns)
{
...
U_CAPI le_int32 U_EXPORT2 pl_getFontRunCount(const pl_fontRuns * fontRuns)
{
...
U_CAPI void U_EXPORT2 pl_resetFontRuns(pl_fontRuns * fontRuns)
{
	FontRuns * fr = (FontRuns*)fontRuns;
...
U_CAPI le_int32 U_EXPORT2 pl_getFontRunLastLimit(const pl_fontRuns * fontRuns)
{
	const FontRuns * fr = (const FontRuns*)fontRuns;
...
U_CAPI le_int32 U_EXPORT2 pl_getFontRunLimit(const pl_fontRuns * fontRuns,
    le_int32 run)
{
	const FontRuns * fr = (const FontRuns*)fontRuns;
...
U_CAPI const le_font * U_EXPORT2 pl_getFontRunFont(const pl_fontRuns * fontRuns,
    le_int32 run)
{
	const FontRuns * fr = (const FontRuns*)fontRuns;
...
U_CAPI le_int32 U_EXPORT2 pl_addFontRun(pl_fontRuns * fontRuns,
    const le_font * font,
    le_int32 limit)
{
	FontRuns * fr = (FontRuns*)fontRuns;
...
U_CAPI pl_valueRuns * U_EXPORT2 pl_openValueRuns(const le_int32 * values,
    const le_int32 * limits,
    le_int32 count)
{
...
U_CAPI pl_valueRuns * U_EXPORT2 pl_openEmptyValueRuns(le_int32 initialCapacity)
{
	return (pl_valueRuns*)new ValueRuns(initialCapacity);
}

U_CAPI void U_EXPORT2 pl_closeValueRuns(pl_valueRuns * valueRuns)
{
...
U_CAPI le_int32 U_EXPORT2 pl_getValueRunCount(const pl_valueRuns * valueRuns)
{
...
U_CAPI void U_EXPORT2 pl_resetValueRuns(pl_valueRuns * valueRuns)
{
	ValueRuns * vr = (ValueRuns*)valueRuns;
...
U_CAPI le_int32 U_EXPORT2 pl_getValueRunLastLimit(const pl_valueRuns * valueRuns)
{
	const ValueRuns * vr = (const ValueRuns*)valueRuns;
...
U_CAPI le_int32 U_EXPORT2 pl_getValueRunLimit(const pl_valueRuns * valueRuns,
    le_int32 run)
{
	const ValueRuns * vr = (const ValueRuns*)valueRuns;
...
U_CAPI le_int32 U_EXPORT2 pl_getValueRunValue(const pl_valueRuns * valueRuns,
    le_int32 run)
{
	const ValueRuns * vr = (const ValueRuns*)valueRuns;
...
U_CAPI le_int32 U_EXPORT2 pl_addValueRun(pl_valueRuns * valueRuns,
    le_int32 value,
    le_int32 limit)
{
	ValueRuns * vr = (ValueRuns*)valueRuns;
...
private:
	...
	inline ULocRuns &operator=(const ULocRuns & /*other*/) {
		return *this;
	};
...
U_CAPI pl_localeRuns * U_EXPORT2 pl_openLocaleRuns(const char ** locales,
    const le_int32 * limits,
    le_int32 count)
{
...
U_CAPI void U_EXPORT2 pl_closeLocaleRuns(pl_localeRuns * localeRuns)
{
...
U_CAPI le_int32 U_EXPORT2 pl_getLocaleRunCount(const pl_localeRuns * localeRuns)
{
...
U_CAPI void U_EXPORT2 pl_resetLocaleRuns(pl_localeRuns * localeRuns)
{
	ULocRuns * lr = (ULocRuns*)localeRuns;
...
U_CAPI le_int32 U_EXPORT2 pl_getLocaleRunLastLimit(const pl_localeRuns * localeRuns)
{
	const ULocRuns * lr = (const ULocRuns*)localeRuns;
...
U_CAPI le_int32 U_EXPORT2 pl_getLocaleRunLimit(const pl_localeRuns * localeRuns,
    le_int32 run)
{
	const ULocRuns * lr = (const ULocRuns*)localeRuns;
...
U_CAPI const char * U_EXPORT2 pl_getLocaleRunLocale(const pl_localeRuns * localeRuns,
    le_int32 run)
{
	const ULocRuns * lr = (const ULocRuns*)localeRuns;
...
U_CAPI le_int32 U_EXPORT2 pl_addLocaleRun(pl_localeRuns * localeRuns,
    const char * locale,
    le_int32 limit)
{
	ULocRuns * lr = (ULocRuns*)localeRuns;
