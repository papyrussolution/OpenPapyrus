...
static void get_symbols(const UDateFormat * fmt, UDateFormatSymbolType type, UChar * array[],
    int32_t arrayLength, int32_t lowestIndex, int32_t firstIndex, UErrorCode * status);
...
#define CAL_VERSION "1.0" /* The version of cal */
#define DAY_COUNT 7 /* Number of days in a week */
#define MONTH_COUNT 13 /* Number of months in a year (yes, 13) */
#define MARGIN_WIDTH 4 /* Separation between months in year view */
#define BUF_SIZE 64 /* Size of stack buffers */

/* Patterm string - "MMM yyyy" */
static const UChar sShortPat [] = { 0x004D, 0x004D, 0x004D, 0x0020, 0x0079, 0x0079, 0x0079, 0x0079 };
/* Pattern string - "MMMM yyyy" */
static const UChar sLongPat [] = { 0x004D, 0x004D, 0x004D, 0x004D, 0x0020, 0x0079, 0x0079, 0x0079, 0x0079 };
 ...
 */
static void get_symbols(const UDateFormat * fmt, UDateFormatSymbolType type, UChar * array[], int32_t arrayLength,
    int32_t lowestIndex, int32_t firstIndex, UErrorCode * status)
{
	int32_t count, i;
	if(U_FAILURE(*status)) {
		return;
