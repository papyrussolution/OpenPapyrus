...
// 03/27/2002  Mark Schneckloth Many fixes regarding alignment, null termination (mschneckloth@atomz.com) and other various problems.
...
U_CAPI int32_t U_EXPORT2 u_sprintf(char16_t * buffer, const char * patternSpecification, ...)
{
	va_list ap;
	int32_t written;
...
U_CAPI int32_t U_EXPORT2 /* U_CAPI ... U_EXPORT2 added by Peter Kirk 17 Nov 2001 */ u_vsprintf(char16_t * buffer, const char * patternSpecification, va_list ap)
{
	return u_vsnprintf(buffer, INT32_MAX, patternSpecification, ap);
}

U_CAPI int32_t U_EXPORT2 u_snprintf(char16_t * buffer, int32_t count, const char * patternSpecification, ...)
{
	va_list ap;
	int32_t written;
	va_start(ap, patternSpecification);
...
U_CAPI int32_t U_EXPORT2  /* U_CAPI ... U_EXPORT2 added by Peter Kirk 17 Nov 2001 */ u_vsnprintf(char16_t * buffer, int32_t count, const char * patternSpecification, va_list ap)
{
	int32_t written;
	char16_t * pattern;
...
U_CAPI int32_t U_EXPORT2 u_vsprintf_u(char16_t * buffer, const char16_t * patternSpecification, va_list ap)
{
...
U_CAPI int32_t U_EXPORT2  /* U_CAPI ... U_EXPORT2 added by Peter Kirk 17 Nov 2001 */ u_vsnprintf_u(char16_t * buffer,
    int32_t count, const char16_t * patternSpecification, va_list ap)
{
