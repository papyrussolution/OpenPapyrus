...
#define IS_FIRST_STRING_DELIMITER(c1) \
	(bool)((DELIM_LF <= (c1) && (c1) <= DELIM_CR) \
	|| (c1) == DELIM_NEL \
	|| (c1) == DELIM_LS \
	|| (c1) == DELIM_PS)
#define CAN_HAVE_COMBINED_STRING_DELIMITER(c1) (bool)((c1) == DELIM_CR)
#define IS_COMBINED_STRING_DELIMITER(c1, c2) \
	(bool)((c1) == DELIM_CR && (c2) == DELIM_LF)
...
U_CFUNC bool U_EXPORT2 ufile_getch32(UFILE * f, UChar32 * c32)
{
	bool isValidChar = FALSE;
	u_localized_string * str;
