...
public:
    ...
    bool didReorder() const { return fDidReorder; }
...
struct Norm {
    ...
    bool hasMapping() const { return mappingType>REMOVED; }
    ...
    bool combinesBack;
    bool hasCompBoundaryBefore, hasCompBoundaryAfter;
...
public:
    ...
    bool combinesBack(UChar32 c) const {
    ...
    bool combinesWithCCBetween(const Norm &norm, uint8_t lowCC, int32_t highCC) const;
