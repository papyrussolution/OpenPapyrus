...
bool Normalizer2DataBuilder::mappingRecomposes(const BuilderReorderingBuffer &buffer) const {
...
void Normalizer2DataBuilder::writeNorm16(UMutableCPTrie * norm16Trie, UChar32 start, UChar32 end, Norm &norm) {
	...
	bool isCompNoMaybe = norm.type>=Norm::NO_NO_COMP_YES;
...
void Normalizer2DataBuilder::computeDiff(const Normalizer2DataBuilder &b1,
