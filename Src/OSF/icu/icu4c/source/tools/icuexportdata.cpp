...
static bool haveCopyright = true;
static UCPTrieType trieType = UCPTRIE_TYPE_SMALL;
...
int main(int argc, char * argv[]) 
{
	...
	if(propNames.empty() || options[OPT_HELP_H].doesOccur || options[OPT_HELP_QUESTION_MARK].doesOccur || !options[OPT_MODE].doesOccur) {
