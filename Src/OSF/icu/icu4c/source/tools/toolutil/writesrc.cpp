...
U_CAPI void U_EXPORT2 usrc_writeFileNameGeneratedBy(FILE * f,
    const char * prefix,
    const char * filename,
...
U_CAPI void U_EXPORT2 usrc_writeArray(FILE * f,
    const char * prefix,
	...
	for(i = col = 0; i<length; ++i, ++col) {
		...
		switch(width) {
			case 8: value = p8[i]; break;
			case 16: value = p16[i]; break;
			case 32: value = p32[i]; break;
			default: value = 0; /* unreachable */ break;
		}
...
U_CAPI void U_EXPORT2 usrc_writeUTrie2Struct(FILE * f, const char * prefix, const UTrie2 * pTrie, const char * indexName, const char * data32Name, const char * postfix) 
{
	if(prefix) {
		fputs(prefix, f);
	}
...
U_CAPI void U_EXPORT2 usrc_writeUCPTrieArrays(FILE * f,
...
U_CAPI void U_EXPORT2 usrc_writeUCPTrieStruct(FILE * f,
    const char * prefix,
    const UCPTrie * pTrie,
...
U_CAPI void U_EXPORT2 usrc_writeUCPMap(FILE * f,
    const UCPMap * pMap,
