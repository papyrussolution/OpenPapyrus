...
U_CAPI void U_EXPORT2 u_parseDelimitedFile(const char * filename, char delimiter,
 ...
 */
U_CAPI int32_t U_EXPORT2 u_parseCodePoints(const char * s,
...
U_CAPI int32_t U_EXPORT2 u_parseCodePointRangeAnyTerminator(const char * s,
...
{
	const char * terminator;
	int32_t rangeLength = u_parseCodePointRangeAnyTerminator(s, pStart, pEnd, &terminator, pErrorCode);
