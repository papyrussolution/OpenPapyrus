...
static bool isListTextFile(const char * listname) {
 ...
 */
U_CAPI Package * U_EXPORT2 readList(const char * filesPath, const char * listname, bool readContents, Package * listPkgIn) {
...
U_CAPI int U_EXPORT2 writePackageDatFile(const char * outFilename,
