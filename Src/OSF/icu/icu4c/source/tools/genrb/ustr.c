...
U_CFUNC void ustr_cpy(struct UString * dst,
...
U_CFUNC void ustr_setlen(struct UString * s,
    int32_t len,
    UErrorCode * status)
{
	if(U_FAILURE(*status))
...
U_CFUNC void ustr_cat(struct UString * dst,
    const struct UString * src,
    UErrorCode * status)
{
...
U_CFUNC void ustr_ncat(struct UString * dst,
    const struct UString * src,
    int32_t n,
    UErrorCode * status)
{
...
static void ustr_resize(struct UString * s,
    int32_t len,
    UErrorCode * status)
{
	if(U_FAILURE(*status))
