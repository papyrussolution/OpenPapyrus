...
void res_write_xml(struct SResource * res, const char * id, const char * language, bool isTopLevel, UErrorCode * status);
...
static void trim(char ** src, int32_t * len) {
	char * s = NULL;
	int32_t i = 0;
...
static void print(char16_t * src, int32_t srcLen, const char * tagStart, const char * tagEnd,  UErrorCode * status) {
...
static void printNoteElements(const UString * src, UErrorCode * status) {
...
static void printComments(struct UString * src, const char * resName, bool printTranslate, UErrorCode * status) {
#if UCONFIG_NO_REGULAR_EXPRESSIONS==0 /* donot compile when no RegularExpressions are available */
 ...
 */
static char * printContainer(SResource * res,
...
static void string_write_xml(StringResource * res, const char * id, const char * /*language*/, UErrorCode * status) {
	char * sid = NULL;
	char * buf = NULL;
	int32_t bufLen = 0;
...
static void alias_write_xml(AliasResource * res, const char * id, const char * /*language*/, UErrorCode * status) {
	char * sid = NULL;
	char * buf = NULL;
	int32_t bufLen = 0;
...
static void array_write_xml(ArrayResource * res, const char * id, const char * language, UErrorCode * status) {
	char * sid = NULL;
	int index = 0;
...
static void intvector_write_xml(IntVectorResource * res, const char * id, const char * /*language*/, UErrorCode * status) {
	char * sid = NULL;
	char * ivd = NULL;
	uint32_t i = 0;
	uint32_t len = 0;
...
static void int_write_xml(IntResource * res, const char * id, const char * /*language*/, UErrorCode * status) {
	char * sid = NULL;
	char buf[256] = {0};
	uint32_t len = 0;
...
static void bin_write_xml(BinaryResource * res, const char * id, const char * /*language*/, UErrorCode * status) {
...
static void table_write_xml(TableResource * res, const char * id, const char * language, bool isTopLevel, UErrorCode * status) {
	struct SResource * current = NULL;
	char * sid = NULL;
...
void bundle_write_xml(struct SRBRoot * bundle, const char * outputDir, const char * outputEnc, const char * filename,
