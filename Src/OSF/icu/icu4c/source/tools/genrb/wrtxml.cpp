...
static void
printComments(struct UString *src, const char *resName, bool printTranslate, UErrorCode *status) {
...
static void
table_write_xml(TableResource *res, const char * id, const char * language, bool isTopLevel, UErrorCode *status) {
