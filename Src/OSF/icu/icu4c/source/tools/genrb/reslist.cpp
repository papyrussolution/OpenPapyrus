...
static bool gIncludeCopyright = FALSE;
static bool gUsePoolBundle = FALSE;
static bool gIsDefaultFormatVersion = TRUE;
...
void setIncludeCopyright(bool val) {
	gIncludeCopyright = val;
}

bool getIncludeCopyright() {
...
void setUsePoolBundle(bool use) {
	gUsePoolBundle = use;
}
...
static bool U_CALLCONV string_comp(const UElement key1, const UElement key2) {
...
void StringResource::handlePreflightStrings(SRBRoot * bundle, UHashtable * stringSet,
    UErrorCode &errorCode) {
	assert(fSame == NULL);
...
void SResource::handlePreflightStrings(SRBRoot * /*bundle*/, UHashtable * /*stringSet*/,
    UErrorCode & /*errorCode*/) {
