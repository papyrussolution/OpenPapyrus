...
static void parseMappings(const char * filename, bool reportError, UErrorCode * pErrorCode);
...
static void U_CALLCONV normalizationCorrectionsLineFn(void * context,
