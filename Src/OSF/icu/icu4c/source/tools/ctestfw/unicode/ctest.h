...
U_CDECL_BEGIN
typedef void (U_CALLCONV *TestFunctionPtr)();
 ...
 * @internal Internal APIs for testing purpose only
 */
T_CTEST_API void T_CTEST_EXPORT2 addTest(TestNode** root,
 ...
 * @internal Internal APIs for testing purpose only
 */
T_CTEST_API const TestNode* T_CTEST_EXPORT2 getTest(const TestNode* root,
    const char * path);
 ...
 */
T_CTEST_API bool
T_CTEST_EXPORT2 log_knownIssue(const char * ticket, const char * fmt, ...);
 ...
 * @internal Internal APIs for testing purpose only
 */
T_CTEST_API int T_CTEST_EXPORT2 runTestRequest(const TestNode* root,
    int argc,
    const char * const argv[]);

T_CTEST_API const char * T_CTEST_EXPORT2 getTestName();
 ...
 * @return 0 on success, 1 on failure.
 */
T_CTEST_API int32_t T_CTEST_EXPORT2 ctest_xml_fini();
 ...
 */
T_CTEST_API int32_t
T_CTEST_EXPORT2 ctest_xml_testcase(const char * classname, const char * name, const char * time, const char * failMsg);
