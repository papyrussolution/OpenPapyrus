...
public:
	 ...
	 */
	virtual bool getInfo(const DataMap *& info, UErrorCode & status) const = 0;
	 ...
	 *          settings.
	 */
	virtual bool nextSettings(const DataMap *& settings, UErrorCode & status) = 0;
	 ...
	 *          cases.
	 */
	virtual bool nextCase(const DataMap *& data, UErrorCode & status) = 0;
};
...
public:
	virtual ~RBTestData();
	virtual bool getInfo(const DataMap *& info, UErrorCode & status) const override;
	virtual bool nextSettings(const DataMap *& settings, UErrorCode & status) override;
	virtual bool nextCase(const DataMap *& nextCase, UErrorCode & status) override;
};
