...
extern int main(int argc, char * argv[]) 
{
	...
	if(argc<0 || options[0].doesOccur || options[1].doesOccur) {
		slfprintf_stderr("usage: %s [-options]\n"
...
/* Create data file ----------------------------------------------------- */
static void createData(const char * outputDirectory, UErrorCode * errorCode) {
			...
			switch(t) {
				...
				case UDBG_UCalendarMonths:
				    ...
				    if(t == UDBG_UCalendarDateFields && i == 22) {
					    fprintf(out,
						"com.ibm.icu.util.ChineseCalendar.%s, /* %d */",
						udbg_enumName((UDebugEnumType)t, i),
						i);
				    }
				    else {
