...
int32_t UCharsDictionaryMatcher::getType() const { return DictionaryData::TRIE_TYPE_UCHARS; }

int32_t UCharsDictionaryMatcher::matches(UText * text, int32_t maxLength, int32_t limit, int32_t * lengths, int32_t * cpLengths, int32_t * values,
...
int32_t BytesDictionaryMatcher::getType() const { return DictionaryData::TRIE_TYPE_BYTES; }

int32_t BytesDictionaryMatcher::matches(UText * text, int32_t maxLength, int32_t limit,
    int32_t * lengths, int32_t * cpLengths, int32_t * values, int32_t * prefix) const 
{
...
U_CAPI int32_t U_EXPORT2 udict_swap(const UDataSwapper * ds, const void * inData, int32_t length, void * outData, UErrorCode * pErrorCode) 
{
	...
	if(!(pInfo->dataFormat[0] == 0x44 && pInfo->dataFormat[1] == 0x69 && pInfo->dataFormat[2] == 0x63 && pInfo->dataFormat[3] == 0x74 && pInfo->formatVersion[0] == 1)) {
