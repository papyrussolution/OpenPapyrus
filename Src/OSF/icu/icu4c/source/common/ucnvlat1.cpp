...
static void U_CALLCONV ucnv_Latin1FromUTF8(UConverterFromUnicodeArgs * pFromUArgs,
...
static void U_CALLCONV _Latin1GetUnicodeSet(const UConverter * cnv,
    const USetAdder * sa,
...
static void U_CALLCONV _ASCIIGetUnicodeSet(const UConverter * cnv,
    const USetAdder * sa,
    UConverterUnicodeSet which,
    UErrorCode * pErrorCode) {
	(void)cnv;
