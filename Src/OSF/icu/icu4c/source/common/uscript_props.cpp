...
U_CAPI int32_t U_EXPORT2 uscript_getSampleString(UScriptCode script, char16_t * dest, int32_t capacity, UErrorCode * pErrorCode) {
...
U_CAPI bool U_EXPORT2 uscript_isRightToLeft(UScriptCode script) {
	return (getScriptProps(script) & RTL) != 0;
}

U_CAPI bool U_EXPORT2 uscript_breaksBetweenLetters(UScriptCode script) {
	return (getScriptProps(script) & LB_LETTERS) != 0;
}

U_CAPI bool U_EXPORT2 uscript_isCased(UScriptCode script) {
