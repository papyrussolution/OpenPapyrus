 ...
 * not.
 */
typedef bool (* UBiDiAction)(UBiDiTransform *, UErrorCode *);
 ...
 * value, the caller should also check <code>U_SUCCESS(*pErrorCode)</code>.
 */
static bool action_setInverse(UBiDiTransform * pTransform, UErrorCode * pErrorCode)
{
	(void)pErrorCode;
 ...
 * value, the caller should also check <code>U_SUCCESS(*pErrorCode)</code>.
 */
static bool action_setRunsOnly(UBiDiTransform * pTransform, UErrorCode * pErrorCode)
{
	(void)pErrorCode;
 ...
 * value, the caller should also check <code>U_SUCCESS(*pErrorCode)</code>.
 */
static bool action_reverse(UBiDiTransform * pTransform, UErrorCode * pErrorCode)
{
 ...
 * value, the caller should also check <code>U_SUCCESS(*pErrorCode)</code>.
 */
static bool action_shapeArabic(UBiDiTransform * pTransform, UErrorCode * pErrorCode)
{
 ...
 * value, the caller should also check <code>U_SUCCESS(*pErrorCode)</code>.
 */
static bool action_mirror(UBiDiTransform * pTransform, UErrorCode * pErrorCode)
{
	UChar32 c;
	uint32_t i = 0, j = 0;
	...
	do {
		bool isOdd = ubidi_getLevelAt(pTransform->pBidi, i) & 1;
 ...
 */
static const ReorderingScheme* findMatchingScheme(UBiDiLevel inLevel, UBiDiLevel outLevel,
