...
public:
	...
	bool isBoundary(int32_t offset) U_OVERRIDE;
...
bool WholeStringBreakIterator::isBoundary(int32_t /*offset*/) {
	return FALSE;
}
...
WholeStringBreakIterator * WholeStringBreakIterator::createBufferClone(void * /*stackBuffer*/,
    int32_t & /*BufferSize*/,
...
U_CFUNC
BreakIterator * ustrcase_getTitleBreakIterator(const Locale * locale, const char * locID, uint32_t options, BreakIterator * iter,
