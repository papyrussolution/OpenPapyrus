...
U_CAPI void U_EXPORT2 ulist_addItemEndList(UList * list, const void * data, bool forceDelete, UErrorCode * status) {
...
U_CAPI void U_EXPORT2 ulist_addItemBeginList(UList * list, const void * data, bool forceDelete, UErrorCode * status) {
	UListNode * newItem = NULL;
