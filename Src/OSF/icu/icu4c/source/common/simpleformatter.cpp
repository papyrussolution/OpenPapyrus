...
inline bool isInvalidArray(const void * array, int32_t length) {
...
bool SimpleFormatter::applyPatternMinMaxArguments(const UnicodeString & pattern,
...
UnicodeString & SimpleFormatter::format(const UnicodeString & value0,
...
UnicodeString & SimpleFormatter::formatAndAppend(const UnicodeString * const * values, int32_t valuesLength,
...
UnicodeString & SimpleFormatter::formatAndReplace(const UnicodeString * const * values, int32_t valuesLength,
