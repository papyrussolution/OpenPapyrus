...
static int32_t U_CALLCONV uprv_copyArray16(const UDataSwapper * ds,
    const void * inData, int32_t length, void * outData,
    UErrorCode * pErrorCode) {
	if(!pErrorCode || U_FAILURE(*pErrorCode)) {
		return 0;
...
static int32_t U_CALLCONV uprv_swapArray32(const UDataSwapper * ds,
    const void * inData, int32_t length, void * outData,
    UErrorCode * pErrorCode) {
	const uint32_t * p;
	uint32_t * q;
...
static int32_t U_CALLCONV uprv_copyArray32(const UDataSwapper * ds,
    const void * inData, int32_t length, void * outData,
    UErrorCode * pErrorCode) {
	if(!pErrorCode || U_FAILURE(*pErrorCode)) {
		return 0;
...
static int32_t U_CALLCONV uprv_swapArray64(const UDataSwapper * ds,
    const void * inData, int32_t length, void * outData,
    UErrorCode * pErrorCode) {
	const uint64_t * p;
	uint64_t * q;
...
static int32_t U_CALLCONV uprv_copyArray64(const UDataSwapper * ds,
    const void * inData, int32_t length, void * outData,
    UErrorCode * pErrorCode) {
	if(!pErrorCode || U_FAILURE(*pErrorCode)) {
		return 0;
...
U_CAPI UDataSwapper * U_EXPORT2 udata_openSwapper(bool inIsBigEndian, uint8 inCharset,
	...
	memzero(swapper, sizeof(UDataSwapper));
