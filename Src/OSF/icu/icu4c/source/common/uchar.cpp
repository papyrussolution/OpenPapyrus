...
U_CAPI bool U_EXPORT2 u_isblank(UChar32 c) {
	if((uint32_t)c<=0x9f) {
		...
		uint32_t props;
		GET_PROPS(c, props);
		return (bool)(GET_CATEGORY(props)==U_SPACE_SEPARATOR);
	}
}
...
U_CAPI bool U_EXPORT2 u_isprint(UChar32 c) {
	...
	return (bool)((CAT_MASK(props)&U_GC_C_MASK)==0);
}
 ...
 * @internal
 */
U_CFUNC bool u_isprintPOSIX(UChar32 c) {
	uint32_t props;
	GET_PROPS(c, props);
	/*
	 ...
	 */
	return (bool)((GET_CATEGORY(props)==U_SPACE_SEPARATOR) || u_isgraphPOSIX(c));
}
 ...
 * @internal
 */
U_CFUNC bool u_isgraphPOSIX(UChar32 c) {
	uint32_t props;
	GET_PROPS(c, props);
...
U_CAPI bool U_EXPORT2 u_isIDStart(UChar32 c) {
	...
	uint32_t props;
	GET_PROPS(c, props);
	return (bool)((CAT_MASK(props)&(U_GC_L_MASK|U_GC_NL_MASK))!=0);
}
...
U_CAPI bool U_EXPORT2 u_isIDIgnorable(UChar32 c) {
	if(c<=0x9f) {
		...
		uint32_t props;
		GET_PROPS(c, props);
		return (bool)(GET_CATEGORY(props)==U_FORMAT_CHAR);
	}
}
...
U_CAPI bool U_EXPORT2 uscript_hasScript(UChar32 c, UScriptCode sc) {
	uint32_t scriptX = u_getUnicodeProperties(c, 0)&UPROPS_SCRIPT_X_MASK;
	uint32_t codeOrIndex = uprops_mergeScriptCodeOrIndex(scriptX);
	if(scriptX<UPROPS_SCRIPT_X_WITH_COMMON) {
...
U_CAPI int32_t U_EXPORT2 uscript_getScriptExtensions(UChar32 c,
