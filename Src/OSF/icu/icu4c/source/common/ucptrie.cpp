...
U_CAPI UCPTrie * U_EXPORT2 ucptrie_openFromBinary(UCPTrieType type, UCPTrieValueWidth valueWidth,
	...
	UCPTrie tempTrie;
	memzero(&tempTrie, sizeof(tempTrie));
...
U_CFUNC UChar32 ucptrie_internalGetRange(UCPTrieGetRange * getRange,
...
U_CAPI UChar32 U_EXPORT2 ucpmap_getRange(const UCPMap * map, UChar32 start,
    UCPMapRangeOption option, uint32_t surrogateValue,
    UCPMapValueFilter * filter, const void * context, uint32_t * pValue) {
