...
static bool U_CALLCONV _enumPropertyStartsRange(const void * context, UChar32 start, UChar32 end, uint32_t value) {
	(void)end;
	(void)value;
...
U_CFUNC UCharDirection u_charDirection(UChar32 c) {
	return ubidi_getClass(c);
}

U_CFUNC bool u_isMirrored(UChar32 c) {
	return ubidi_isMirrored(c);
}

U_CFUNC UChar32 u_charMirror(UChar32 c) {
