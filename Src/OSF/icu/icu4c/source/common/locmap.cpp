...
ILCID_POSIX_SUBTABLE(en) {
	...
	{0x1c09, "en_ZA"},
	{0x3009, "en_ZW"},
	{0x2409, "en_VI"}, /* Virgin Islands AKA Caribbean Islands (en_CB). On Windows8+ This is 0x1000 or dynamically
	                      assigned */
...
ILCID_POSIX_SUBTABLE(no) {
	{0x14,   "no"}, /* really nb_NO - actually Windows differentiates between neutral (no region) and specific (with
	                   region) */
	{0x7c14, "nb"}, /* really nb */
