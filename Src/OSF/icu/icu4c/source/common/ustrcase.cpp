...
UChar32 U_CALLCONV utf16_caseContextIterator(void * context, int8 dir) {
	...
	for(;;) {
		...
		while(srcIndex < srcLimit) {
			...
			if(lead < LatinCase::LONG_S) {
				...
				uint16 props = UTRIE2_GET16_FROM_U16_SINGLE_LEAD(trie, lead);
...
// U+2126 Ohm sign
static const uint16 data2126 = 0x03A9 | HAS_VOWEL;
