...
U_CAPI int32_t U_EXPORT2 utrie_swap(const UDataSwapper * ds,
	...
	dataIs32 = (bool)((trie.options&UTRIE_OPTIONS_DATA_IS_32_BIT)!=0);
...
U_CAPI int32_t U_EXPORT2 utrie2_swap(const UDataSwapper * ds,
    const void * inData, int32_t length, void * outData,
    UErrorCode * pErrorCode) {
...
U_CAPI int32_t U_EXPORT2 ucptrie_swap(const UDataSwapper * ds,
    const void * inData, int32_t length, void * outData,
    UErrorCode * pErrorCode) {
 ...
 */
int32_t getVersion(const void * data, int32_t length, bool anyEndianOk) {
	uint32_t signature;
...
U_CAPI int32_t U_EXPORT2 utrie_swapAnyVersion(const UDataSwapper * ds,
    const void * inData, int32_t length, void * outData,
    UErrorCode * pErrorCode) {
	if(U_FAILURE(*pErrorCode)) {
		return 0;
