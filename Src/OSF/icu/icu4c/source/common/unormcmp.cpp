...
/* internal function */
static int32_t unorm_cmpEquivFold(const UChar * s1, int32_t length1,
...
static
bool _normalize(const Normalizer2 * n2, const UChar * s, int32_t length,
...
U_CAPI int32_t U_EXPORT2 unorm_compare(const UChar * s1, int32_t length1,
    const UChar * s2, int32_t length2,
    uint32_t options,
    UErrorCode * pErrorCode) {
	/* argument checking */
