...
static const char * _ConvertBCP47(const char * id, char * buffer, int32_t length,
...
U_CFUNC void ulocimp_getKeywords(const char * localeID,
    char prev,
    ByteSink& sink,
    bool valuesToo,
    UErrorCode * status)
...
U_CAPI int32_t U_EXPORT2 uloc_getKeywordValue(const char * localeID,
...
U_CAPI void U_EXPORT2 ulocimp_getKeywordValue(const char * localeID,
    const char * keywordName,
    icu::ByteSink& sink,
    UErrorCode * status)
{
...
U_CAPI int32_t U_EXPORT2 uloc_setKeywordValue(const char * keywordName,
 ...
 */
CharString U_EXPORT2 ulocimp_getLanguage(const char * localeID,
    const char ** pEnd,
    UErrorCode & status) {
	CharString result;
...
CharString U_EXPORT2 ulocimp_getScript(const char * localeID,
    const char ** pEnd,
    UErrorCode & status) {
	CharString result;
	int32_t idLen = 0;
...
CharString U_EXPORT2 ulocimp_getCountry(const char * localeID,
    const char ** pEnd,
    UErrorCode & status) {
	CharString result;
	int32_t idLen = 0;
 ...
 */
static void _getVariant(const char * localeID,
    char prev,
    ByteSink& sink,
    bool needSeparator) {
...
static const char * U_CALLCONV uloc_kw_nextKeyword(UEnumeration* en,
...
static void U_CALLCONV uloc_kw_resetKeywords(UEnumeration* en,
    UErrorCode * /*status*/) {
 ...
 */
static void _canonicalize(const char * localeID,
    ByteSink& sink,
    uint32_t options,
    UErrorCode * err) {
	if(U_FAILURE(*err)) {
...
U_CAPI void U_EXPORT2 ulocimp_getName(const char * localeID,
    ByteSink& sink,
    UErrorCode * err)
{
...
U_CAPI int32_t U_EXPORT2 uloc_getBaseName(const char * localeID,
    char * name,
    int32_t nameCapacity,
    UErrorCode * err)
{
...
U_CAPI void U_EXPORT2 ulocimp_getBaseName(const char * localeID,
    ByteSink& sink,
    UErrorCode * err)
{
...
U_CAPI void U_EXPORT2 ulocimp_canonicalize(const char * localeID,
    ByteSink& sink,
    UErrorCode * err)
{
...
U_CAPI int32_t U_EXPORT2 uloc_getLocaleForLCID(uint32_t hostid, char * locale, int32_t localeCapacity,
    UErrorCode * status)
{
...
U_CAPI void U_EXPORT2 uloc_setDefault(const char * newDefaultLocale,
    UErrorCode * err)
{
	if(U_FAILURE(*err))
		return;
