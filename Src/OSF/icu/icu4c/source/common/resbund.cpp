...
ResourceBundle * ResourceBundle::clone() const { return new ResourceBundle(*this); }
...
UResType ResourceBundle::getType() const { return ures_getType(fResource); }
int32_t ResourceBundle::getSize() const { return ures_getSize(fResource); }
bool ResourceBundle::hasNext() const { return ures_hasNext(fResource); }
void ResourceBundle::resetIterator() { ures_resetIterator(fResource); }
