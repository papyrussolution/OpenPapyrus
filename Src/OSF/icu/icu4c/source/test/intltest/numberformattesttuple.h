 ...
 * test. The bool fields ending in "Flag" indicate whether the corresponding
...
public:
    ...
    bool outputFlag;
    bool commentFlag;
    bool minIntegerDigitsFlag;
    bool maxIntegerDigitsFlag;
    bool minFractionDigitsFlag;
    bool maxFractionDigitsFlag;
    bool minGroupingDigitsFlag;
    bool breaksFlag;
    bool useSigDigitsFlag;
    bool minSigDigitsFlag;
    bool maxSigDigitsFlag;
    bool useGroupingFlag;
    bool multiplierFlag;
    bool roundingIncrementFlag;
    bool formatWidthFlag;
    bool padCharacterFlag;
    bool useScientificFlag;
    bool groupingFlag;
    bool grouping2Flag;
    bool roundingModeFlag;
    bool currencyUsageFlag;
    bool minimumExponentDigitsFlag;
    bool exponentSignAlwaysShownFlag;
    bool decimalSeparatorAlwaysShownFlag;
    bool padPositionFlag;
    bool positivePrefixFlag;
    bool positiveSuffixFlag;
    bool negativePrefixFlag;
    bool negativeSuffixFlag;
    bool signAlwaysShownFlag;
    bool localizedPatternFlag;
    bool toPatternFlag;
    bool toLocalizedPatternFlag;
    bool styleFlag;
    bool parseFlag;
    bool lenientFlag;
    bool pluralFlag;
    bool parseIntegerOnlyFlag;
    bool decimalPatternMatchRequiredFlag;
    bool parseNoExponentFlag;
    bool parseCaseSensitiveFlag;
    bool outputCurrencyFlag;
...
private:
    ...
    void setFlag(int32_t fieldId, bool value);
    bool isFlag(int32_t fieldId) const;
};
