...
public:
	...
	virtual UChar32 setIndex32(int32_t /*pos*/) override {
		return DONE;
	}
...
void CharIterTest::runIndexedTest(int32_t index, bool exec, const char *& name, char * /*par*/)
{
...
void CharIterTest::TestConstructionAndEquality() 
{
	...
	if(test1->hashCode() == test2->hashCode() || test1->hashCode() == test3->hashCode() || test1->hashCode() == test4->hashCode())
