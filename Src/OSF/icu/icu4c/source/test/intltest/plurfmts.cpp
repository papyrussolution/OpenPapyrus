...
void PluralFormatTest::runIndexedTest(int32_t index, bool exec, const char *& name, char * /*par*/)
{
...
void PluralFormatTest::pluralFormatUnitTest(/*char *par*/)
{
	...
	status = U_ZERO_ERROR;
	bool overwrite[PLURAL_PATTERN_DATA] = {FALSE, FALSE, TRUE, TRUE};
 ...
 */
void PluralFormatTest::pluralFormatLocaleTest(/*char *par*/)
{
	...
	memset(pluralResults, -1, sizeof(pluralResults));
...
void PluralFormatTest::pluralFormatExtendedTest() {
	const char * targets[] = {
...
void PluralFormatTest::pluralFormatExtendedParseTest() {
	const char * failures[] = {
		"offset:1..0 =0 {Foo}",
		"offset:1.0 {Foo}",
		"=0= {Foo}",
...
void PluralFormatTest::ordinalFormatTest() {
...
void PluralFormatTest::TestDecimals() {
...
void PluralFormatTest::numberFormatTest(PluralFormat* plFmt,
    NumberFormat * numFmt,
    int32_t start,
    int32_t end,
    UnicodeString * numOddAppendStr,
    UnicodeString * numEvenAppendStr,
    bool overwrite,                                 // overwrite the numberFormat.format result
...
void PluralFormatTest::helperTestResults(const char ** localeArray,
