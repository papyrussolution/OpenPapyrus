...
void CollationKanaTest::TestKatakanaHiragana(void)
{
	...
	for(int32_t i = 0; i < 3; i++) {
		doTest(myCollation, testKatakanaHiraganaCases[i], testKatakanaHiraganaCases[i + 1], Collator::LESS);
	}
}
...
void CollationKanaTest::runIndexedTest(int32_t index, bool exec, const char *& name, char * /*par*/)
{
