...
private:
    static bool strEqual(const UnicodeString & lhs, const UnicodeString & rhs) {
        return lhs == rhs;
    }
};
...
void PluralMapTest::runIndexedTest(int32_t index, bool exec, const char *& name, char * /*par*/) {
  TESTCASE_AUTO_BEGIN;
