...
void IntlTestDateFormatSymbols::runIndexedTest(int32_t index, bool exec, const char *& name, char * /*par*/)
{
...
bool IntlTestDateFormatSymbols::UnicodeStringsArePrefixes(int32_t count,
    int32_t prefixLen,
    const UnicodeString * prefixArray,
    const UnicodeString * baseArray)
{
	int32_t i;
	for(i = 0; i < count; i++) {
...
void IntlTestDateFormatSymbols::TestGetSetSpecificItems()
{
	...
	const UnicodeString * wdFmtAbbrev     =
	    symbol->getWeekdays(cntFmtAbbrev, DateFormatSymbols::FORMAT, DateFormatSymbols::ABBREVIATED);
	const UnicodeString * wdFmtShort      = symbol->getWeekdays(cntFmtShort, DateFormatSymbols::FORMAT, DateFormatSymbols::SHORT);
	const UnicodeString * wdStdAloneShort = symbol->getWeekdays(cntStdAloneShort,
...
void IntlTestDateFormatSymbols::TestSymbols(/* char *par */)
{
	...
	const UnicodeString * standaloneShortWeekdays =
	    en.getWeekdays(count, DateFormatSymbols::STANDALONE, DateFormatSymbols::ABBREVIATED);
	...
	const UnicodeString * standaloneShortQuarters =
	    en.getQuarters(count, DateFormatSymbols::STANDALONE, DateFormatSymbols::ABBREVIATED);
