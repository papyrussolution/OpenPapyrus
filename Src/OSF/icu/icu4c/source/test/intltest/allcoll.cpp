	...
	: myCollation(0)
{
	/*UErrorCode status = U_ZERO_ERROR;
	   UnicodeString rules(TRUE, DEFAULTRULEARRAY, SIZEOFARRAYi(DEFAULTRULEARRAY));
...
void CollationDummyTest::runIndexedTest(int32_t index, bool exec, const char *& name, char * /*par*/)
{
