...
void RbnfRoundTripTest::runIndexedTest(int32_t index, bool exec, const char *& name, char * /*par*/)
{
...
void RbnfRoundTripTest::doTest(const RuleBasedNumberFormat* formatter,
    double lowLimit,
    double highLimit)
{
	char buf[128];
