...
public:
	 ...
	 */
	bool readLine(UnicodeString & line, UErrorCode & ec);
	/**
	 ...
	 * was reached or an error occurred
	 */
	bool readLineSkippingComments(UnicodeString & line, UErrorCode & ec, bool trim = FALSE);
	/**
...
private:
	...
	bool setBuffer(int32_t index, char c, UErrorCode & ec);
...
inline int32_t TextFile::getLineNumber() const { return lineNo; }
