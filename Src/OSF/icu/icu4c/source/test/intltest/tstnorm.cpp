...
BasicNormalizerTest::BasicNormalizerTest()
{
	...
	canonTests[3][0] = str("D\\u0307");  canonTests[3][1] = str("D\\u0307"); canonTests[3][2] = str("\\u1e0a");        // D
	                                                                                                                   // dot_above

	canonTests[4][0] = str("\\u1e0c\\u0307"); canonTests[4][1] = str("D\\u0323\\u0307");  canonTests[4][2] = str("\\u1e0c\\u0307");     // D-dot_below
	                                                                                                                                    // dot_above

	canonTests[5][0] = str("\\u1e0a\\u0323"); canonTests[5][1] = str("D\\u0323\\u0307");  canonTests[5][2] = str("\\u1e0c\\u0307");    // D-dot_above
	                                                                                                                                   // dot_below

	canonTests[6][0] = str("D\\u0307\\u0323"); canonTests[6][1] = str("D\\u0323\\u0307");  canonTests[6][2] = str("\\u1e0c\\u0307");     // D
	                                                                                                                                     // dot_below
	                                                                                                                                     // dot_above

	canonTests[7][0] = str("\\u1e10\\u0307\\u0323");  canonTests[7][1] = str("D\\u0327\\u0323\\u0307"); canonTests[7][2] = str(
		"\\u1e10\\u0323\\u0307");                                                                                                                    // D
	                                                                                                                                                     // dot_below
	                                                                                                                                                     // cedilla
	                                                                                                                                                     // dot_above

	canonTests[8][0] = str("D\\u0307\\u0328\\u0323"); canonTests[8][1] = str("D\\u0328\\u0323\\u0307"); canonTests[8][2] = str(
		"\\u1e0c\\u0328\\u0307");                                                                                                                    // D
	                                                                                                                                                     // dot_above
	                                                                                                                                                     // ogonek
	                                                                                                                                                     // dot_below
	...
	canonTests[10][0] = str("\\u0112\\u0300"); canonTests[10][1] = str("E\\u0304\\u0300");  canonTests[10][2] = str("\\u1E14");        // E-macron
	                                                                                                                                   // +
	                                                                                                                                   // grave

	canonTests[11][0] = str("\\u00c8\\u0304"); canonTests[11][1] = str("E\\u0300\\u0304");  canonTests[11][2] = str("\\u00c8\\u0304");     // E-grave
	                                                                                                                                       // +
	                                                                                                                                       // macron
	...
	canonTests[18][0] = str("\\u30AC");  canonTests[18][1] = str("\\u30AB\\u3099");  canonTests[18][2] = str("\\u30AC");          // ga
	                                                                                                                              // (Katakana)

	canonTests[19][0] = str("\\u30AB\\u3099"); canonTests[19][1] = str("\\u30AB\\u3099");  canonTests[19][2] = str("\\u30AC");        // ka
	                                                                                                                                  // +
	                                                                                                                                  // ten

	canonTests[20][0] = str("\\uFF76\\uFF9E"); canonTests[20][1] = str("\\uFF76\\uFF9E");  canonTests[20][2] = str("\\uFF76\\uFF9E");   // hw_ka
	                                                                                                                                    // +
	                                                                                                                                    // hw_ten

	canonTests[21][0] = str("\\u30AB\\uFF9E"); canonTests[21][1] = str("\\u30AB\\uFF9E");  canonTests[21][2] = str("\\u30AB\\uFF9E");     // ka
	                                                                                                                                      // +
	                                                                                                                                      // hw_ten

	canonTests[22][0] = str("\\uFF76\\u3099"); canonTests[22][1] = str("\\uFF76\\u3099");  canonTests[22][2] = str("\\uFF76\\u3099");     // hw_ka
	                                                                                                                                      // +
	                                                                                                                                      // ten
	...
	compatTests[1][0] = str("\\uFB4f");  compatTests[1][1] = str("\\u05D0\\u05DC"); compatTests[1][2] = str("\\u05D0\\u05DC");// Alef-Lamed
	                                                                                                                          // vs.
	                                                                                                                          // Alef,
	                                                                                                                          // Lamed
	...
	compatTests[3][0] = str("\\u00C4\\uFB03n"); compatTests[3][1] = str("A\\u0308ffin"); compatTests[3][2] = str("\\u00C4ffin"); // ffi
	                                                                                                                             // ligature
	                                                                                                                             // ->
	                                                                                                                             // f
	                                                                                                                             // +
	...
	compatTests[6][0] = str("\\u30AC"); compatTests[6][1] = str("\\u30AB\\u3099"); compatTests[6][2] = str("\\u30AC"); // ga
	                                                                                                                   // (Katakana)

	compatTests[7][0] = str("\\u30AB\\u3099"); compatTests[7][1] = str("\\u30AB\\u3099"); compatTests[7][2] = str("\\u30AC"); // ka
	                                                                                                                          // +
	                                                                                                                          // ten

	compatTests[8][0] = str("\\uFF76\\u3099"); compatTests[8][1] = str("\\u30AB\\u3099"); compatTests[8][2] = str("\\u30AC"); // hw_ka
	                                                                                                                          // +
	                                                                                                                          // ten

	/* These two are broken in Unicode 2.1.2 but fixed in 2.1.5 and later */
	compatTests[9][0] = str("\\uFF76\\uFF9E"); compatTests[9][1] = str("\\u30AB\\u3099"); compatTests[9][2] = str("\\u30AC"); // hw_ka
	                                                                                                                          // +
	                                                                                                                          // hw_ten

	compatTests[10][0] = str("\\u30AB\\uFF9E"); compatTests[10][1] = str("\\u30AB\\u3099"); compatTests[10][2] = str("\\u30AC"); // ka
	                                                                                                                             // +
	                                                                                                                             // hw_ten
	...
	hangulCanon[1][0] = str("\\u1111\\u1171\\u11b6"), hangulCanon[1][1] = str("\\u1111\\u1171\\u11b6"),   hangulCanon[1][2] = str(
		"\\ud4db");
}
...
void BasicNormalizerTest::staticTest(UNormalizationMode mode, int options, UnicodeString tests[][3], int length, int outCol)
{
	UErrorCode status = U_ZERO_ERROR;
...
void BasicNormalizerTest::iterateTest(Normalizer* iter, UnicodeString tests[][3], int length, int outCol)
{
	UErrorCode status = U_ZERO_ERROR;
	for(int i = 0; i < length; i++) {
		UnicodeString & input = tests[i][0];
...
void BasicNormalizerTest::assertEqual(const UnicodeString & input, const UnicodeString & expected, Normalizer*        iter, const UnicodeString & errPrefix)
{
	UnicodeString result;
...
void BasicNormalizerTest::TestPreviousNext(const char16_t * src, int32_t srcLength,
...
void BasicNormalizerTest::TestPreviousNext() {
...
static int32_t ref_norm_compare(const UnicodeString & s1, const UnicodeString & s2, uint32_t options, UErrorCode &errorCode) {
...
static int32_t _norm_compare(const UnicodeString & s1, const UnicodeString & s2, uint32_t options, UErrorCode &errorCode) {
	int32_t normOptions = (int32_t)(options>>UNORM_COMPARE_NORM_OPTIONS_SHIFT);
...
static int32_t ref_case_compare(const UnicodeString & s1, const UnicodeString & s2, uint32_t options) {
	UnicodeString t1, t2;
...
static inline int32_t _sign(int32_t value) {
	if(value==0) {
		return 0;
	}
	else {
...
static const char * _signString(int32_t value) {
	if(value<0) {
		return "<0";
	}
	else if(value==0) {
...
int32_t BasicNormalizerTest::countFoldFCDExceptions(uint32_t foldingOptions) {
	...
	for(c = 0; c<=0x10ffff; ++c) {
		...
		if(qcResult!=UNORM_YES ||
			...
			dataerrln("  cc %02x trailCC %02x    foldCC(U+%04lx) %02x foldTrailCC(U+%04lx) %02x   quickCheck(folded)=%d",
			    cc,
			    trailCC,
			    d.char32At(0),
			    foldCC,
			    d.char32At(d.length()-1),
			    foldTrailCC,
			    qcResult);
			continue;
		}
...
void BasicNormalizerTest::FindFoldFCDExceptions() {
	int32_t count;
...
static void initExpectedSkippables(UnicodeSet skipSets[UNORM_MODE_COUNT], UErrorCode &errorCode) {
...
void BasicNormalizerTest::TestSkippable() {
...
struct Local_StringPair { 
	const char * input;
	const char * expected; 
};

void BasicNormalizerTest::TestCustomComp() 
{
	static const Local_StringPair pairs[] = {
...
void BasicNormalizerTest::TestCustomFCC() 
{
	static const Local_StringPair pairs[] = {
		// ICU 63 normalization with UCPTrie requires inert surrogate code points.
		// { "\\uD801\\uE000\\uDFFE", "" },
...
void BasicNormalizerTest::TestFilteredNormalizer2Coverage() 
{
	...
	for(UChar32 c = 0; c<=0x3ff; ++c) {
		uint8_t expectedCC = filter.contains(c) ? nfcNorm2->getCombiningClass(c) : 0;
		uint8_t cc = fn2.getCombiningClass(c);
		if(cc!=expectedCC) {
			errln(UnicodeString("FilteredNormalizer2(NFC, ^A0-FF,310-31F).getCombiningClass(U+")+ hex(c)+ ")==filtered NFC.getCC()");
		}
	}
...
void BasicNormalizerTest::TestComposeUTF8WithEdits() 
{
...
void BasicNormalizerTest::TestDecomposeUTF8WithEdits() {
...
void BasicNormalizerTest::TestLowMappingToEmpty_D() {
...
void BasicNormalizerTest::TestLowMappingToEmpty_FCD() {
...
void BasicNormalizerTest::checkLowMappingToEmpty(const Normalizer2 &n2) {
...
void BasicNormalizerTest::TestNormalizeIllFormedText() {
...
void BasicNormalizerTest::TestComposeJamoTBase() {
...
void BasicNormalizerTest::TestComposeBoundaryAfter() {
