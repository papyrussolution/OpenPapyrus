...
static UnicodeString & getWindowsFormat(int32_t lcid, bool currency, UnicodeString & appendTo, const wchar_t * fmt, ...)
{
...
static void testLocale(const char * localeID, int32_t lcid, NumberFormat * wnf, bool currency, TestLog * log)
{
