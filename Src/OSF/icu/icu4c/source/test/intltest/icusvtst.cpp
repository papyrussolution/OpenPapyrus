...
public:
	bool acceptsListener(const EventListener& /*l*/) const override {
		return TRUE;
...
public:
	...
	virtual ICUServiceFactory* createSimpleFactory(UObject* obj, const UnicodeString & id, bool visible, UErrorCode & status) override
	{
		Integer* i;
...
void ICUServiceTest::runIndexedTest(int32_t index, bool exec, const char *& name,
    char * /*par*/)
{
	switch(index) {
...
UnicodeString &ICUServiceTest::lrmsg(UnicodeString & result, const UnicodeString & message, const UObject* lhs, const UObject* rhs) const
{
...
void ICUServiceTest::confirmBoolean(const UnicodeString & message, bool val)
{
	if(val) {
		logln(message);
	}
...
#if 0
void ICUServiceTest::confirmEqual(const UnicodeString & message, const UObject* lhs, const UObject* rhs)
{
	bool equ = (lhs == NULL)
	    ? (rhs == NULL)
...
#else
void ICUServiceTest::confirmEqual(const UnicodeString & message, const Integer* lhs, const Integer* rhs)
{
	bool equ = (lhs == NULL)
	    ? (rhs == NULL)
	    : (rhs != NULL && lhs->operator==(*rhs));
...
void ICUServiceTest::confirmEqual(const UnicodeString & message, const UnicodeString * lhs, const UnicodeString * rhs)
{
	bool equ = (lhs == NULL)
	    ? (rhs == NULL)
	    : (rhs != NULL && lhs->operator==(*rhs));
...
void ICUServiceTest::confirmEqual(const UnicodeString & message, const Locale* lhs, const Locale* rhs)
{
	bool equ = (lhs == NULL)
	    ? (rhs == NULL)
	    : (rhs != NULL && lhs->operator==(*rhs));
...
// use these for now
void ICUServiceTest::confirmStringsEqual(const UnicodeString & message, const UnicodeString & lhs, const UnicodeString & rhs)
{
	bool equ = lhs == rhs;
...
void ICUServiceTest::confirmIdentical(const UnicodeString & message, const UObject* lhs, const UObject * rhs)
{
	UnicodeString temp;
	lrmsg(temp, message, lhs, rhs);
	if(lhs == rhs) {
...
void ICUServiceTest::confirmIdentical(const UnicodeString & message, int32_t lhs, int32_t rhs)
{
	if(lhs == rhs) {
...
void ICUServiceTest::msgstr(const UnicodeString & message, UObject* obj, bool err)
{
	if(obj) {
...
void ICUServiceTest::testAPI_One()
{
...
public:
	...
	virtual ICUServiceFactory* createSimpleFactory(UObject* obj, const UnicodeString & id, bool visible,
...
public:
	...
	virtual UnicodeString & getDisplayName(const UnicodeString & /*id*/, const Locale & /*locale*/,
...
void ICUServiceTest::testAPI_Two()
{
	UErrorCode status = U_ZERO_ERROR;
...
void ICUServiceTest::testNotification()
{
...
void ICUServiceTest::testWrapFactory()
{
