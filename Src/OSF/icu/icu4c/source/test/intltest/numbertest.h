...
private:
	 ...
	 */
	void assertFormatDescending(const char16_t* message,
	...
	void assertFormatDescendingBig(const char16_t* message,
	    const char16_t* skeleton,
	    const char16_t* conciseSkeleton,
	    const UnlocalizedNumberFormatter& f,
	    Locale locale,
	...
	/** See notes above regarding skeleton vs conciseSkeleton */
	FormattedNumber assertFormatSingle(const char16_t* message,
	    const char16_t* skeleton,
	    const char16_t* conciseSkeleton,
	    const UnlocalizedNumberFormatter& f,
	    Locale locale,
	...
	void assertNumberFieldPositions(const char16_t* message,
...
private:
	...
	void assertFormatRange(const char16_t* message,
	...
	FormattedNumberRange assertFormattedRangeEquals(const char16_t* message,
