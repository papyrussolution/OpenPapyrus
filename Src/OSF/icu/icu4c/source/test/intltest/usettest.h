...
private:
    ...
    bool toPatternAux(UChar32 start, UChar32 end);
    
    bool checkPat(const UnicodeString & source,
                   const UnicodeSet & testSet);

    bool checkPat(const UnicodeString & source, const UnicodeSet & testSet, const UnicodeString & pat);
  ...
  * get the same thing back
    ...
    void copyWithIterator(UnicodeSet & t, const UnicodeSet & s, bool withRange);
    
    bool checkEqual(const UnicodeSet & s, const UnicodeSet & t, const char * message);
    ...
    void doAssert(bool, const char *);

    void testSpan(const UnicodeSetWithStrings *sets[4], const void *s, int32_t length, bool isUTF16,
                  uint32_t whichSpans,
