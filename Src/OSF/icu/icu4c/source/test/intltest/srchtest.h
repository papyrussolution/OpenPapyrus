...
private:
    ...
    bool           assertEqualWithStringSearch(      StringSearch *strsrch,
                                                const SearchData   *search);
    bool           assertEqual(const SearchData *search);
    bool           assertCanonicalEqual(const SearchData *search);
    bool           assertEqualWithAttribute(const SearchData *search, 
