...
public:
    ...
    virtual bool doRegexLMTest(const char *pat, const char *text, bool looking, bool match, int32_t line);
    virtual bool doRegexLMTestUTF8(const char *pat, const char *text, bool looking, bool match, int32_t line);
    ...
    virtual void TestCase11049(const char *pattern, const char *data, bool expectMatch, int32_t lineNumber);
