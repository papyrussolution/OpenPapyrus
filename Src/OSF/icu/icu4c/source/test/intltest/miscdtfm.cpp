...
bool DateFormatMiscTests::failure(UErrorCode status, const char * msg)
{
	if(U_FAILURE(status)) {
 ...
 * @bug 4097450
 */
void DateFormatMiscTests::test4097450()
{
	//
 ...
 * @bug 4099975
 */
void DateFormatMiscTests::test4099975()
{
	/**
 ...
 * @bug 4117335
 */
void DateFormatMiscTests::test4117335()
{
