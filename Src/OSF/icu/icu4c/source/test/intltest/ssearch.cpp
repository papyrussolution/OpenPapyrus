...
void SSearchTest::runIndexedTest(int32_t index, bool exec, const char *& name, char * params)
{
...
public:
	...
	void reverse();
	bool compare(const OrderList &other) const;
	bool matchesAt(int32_t offset, const OrderList &other) const;
...
bool OrderList::compare(const OrderList &other) const
{
...
bool OrderList::matchesAt(int32_t offset, const OrderList &other) const
{
...
void SSearchTest::offsetTest()
{
	const char * test[] = {
		...
		"\\u0340\\u0341\\u0342\\u0343\\u0344\\u0345\\u0346\\u0347\\u0348\\u0349\\u034A\\u034B\\u034C\\u034D\\u034E", // currently
		                                                                                                             // not
		                                                                                                             // working,
		                                                                                                             // see
		                                                                                                             // #8081
...
void SSearchTest::sharpSTest()
{
	...
	UnicodeString targets[]  =
	{"fu\\u00DF", "fu\\u00DFball", "1fu\\u00DFball", "12fu\\u00DFball", "123fu\\u00DFball", "1234fu\\u00DFball",
	     "ffu\\u00DF", "fufu\\u00DF", "fusfu\\u00DF",
	     "fuss", "ffuss", "fufuss", "fusfuss", "1fuss", "12fuss", "123fuss", "1234fuss", "fu\\u00DF",
	     "1fu\\u00DF", "12fu\\u00DF", "123fu\\u00DF", "1234fu\\u00DF"};
	...
	LocalUStringSearchPointer ussLong(usearch_openFromCollator(lpUnescaped.getBuffer(), lpUnescaped.length(),
	    lpUnescaped.getBuffer(), lpUnescaped.length(),                                                  // actual
	                                                                                                    // test data
	                                                                                                    // will be
	                                                                                                    // set later
	    coll,
	...
	LocalUStringSearchPointer ussShort(usearch_openFromCollator(spUnescaped.getBuffer(), spUnescaped.length(),
	    spUnescaped.getBuffer(), spUnescaped.length(),                                                  // actual
	                                                                                                    // test data
	                                                                                                    // will be
	                                                                                                    // set later
	    coll,
...
static bool simpleSearch(UCollator * coll,
	...
	for(int32_t i = 0; i < targetSize; i += 1) {
		if(targetOrders.matchesAt(i, patternOrders)) {
			...
			if(minLimit < maxLimit) {
				...
				if(minLimit == targetOrders.getHighOffset(i + patternSize - 1) &&
...
#if !UCONFIG_NO_COLLATION
int32_t SSearchTest::monkeyTestCase(UCollator * coll,
    const UnicodeString & testCase,
    const UnicodeString & pattern,
