...
UCAConformanceTest::UCAConformanceTest() : rbUCA(NULL), testFile(NULL), status(U_ZERO_ERROR)
{
...
void UCAConformanceTest::runIndexedTest(int32_t index, bool exec, const char *& name, char * /*par */)
{
	if(exec) {
...
static UCollationResult normalizeResult(int32_t result) {
