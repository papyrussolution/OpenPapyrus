...
template <> U_EXPORT
const UCTItem2 * LocaleCacheKey<UCTItem2>::createObject(const void * /*unused*/, UErrorCode & /*status*/) const {
	return NULL;
}
...
void UnifiedCacheTest::runIndexedTest(int32_t index, bool exec, const char *& name, char * /*par*/) {
	TESTCASE_AUTO_BEGIN;
...
extern IntlTest * createUnifiedCacheTest() { return new UnifiedCacheTest(); }
