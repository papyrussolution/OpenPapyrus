...
void IntlTestRBNFParse::runIndexedTest(int32_t index, bool exec, const char *& name, char * /*par*/)
{
...
void IntlTestRBNFParse::TestParse() 
{
	...
	const char * okrules[] = { "", "random text", "%foo:bar", "%foo: bar", "0:", "0::", ";", ";;", "%%foo:;", ":", "::", ":1",
		":;", ":;:;", "-", "-1", "-:", ".", ".1", "[", "]", "[]", "[foo]", "[[]", "[]]", "[[]]", "[][]", "<", "<<", "<<<", "10:;9:;",
		">", ">>", ">>>", "=", "==", "===", "=foo=", NULL,
	};
	...
	const char ** allrules[] = { okrules, exceptrules, NULL,
	};
...
void IntlTestRBNFParse::testfmt(RuleBasedNumberFormat* formatter, double val, UErrorCode & status) 
{
	UnicodeString us;
...
void IntlTestRBNFParse::testfmt(RuleBasedNumberFormat* formatter, int val, UErrorCode & status) 
{
	UnicodeString us;
...
/* U_HAVE_RBNF */
#else
void IntlTestRBNF::TestRBNFParseDisabled() { errln("*** RBNF currently disabled on this platform ***\n"); }
/* U_HAVE_RBNF */
#endif
