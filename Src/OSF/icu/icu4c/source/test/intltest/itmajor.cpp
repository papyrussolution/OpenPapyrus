...
void MajorTestLevel::runIndexedTest(int32_t index, bool exec, const char *& name, char * par)
{
	switch(index) {
		case 0: name = "utility";
		    if(exec) {
...
void IntlTestNormalize::runIndexedTest(int32_t index, bool exec, const char *& name, char * par)
{
