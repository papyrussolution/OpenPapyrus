...
void TransliteratorErrorTest::runIndexedTest(int32_t index, bool exec,
...
public:
	...
	virtual void handleTransliterate(Replaceable&, UTransPosition& offsets, bool) const override {
