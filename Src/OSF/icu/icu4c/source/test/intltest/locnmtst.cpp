...
void LocaleDisplayNamesTest::runIndexedTest(int32_t index, bool exec, const char *& name,
    char * /*par*/) {
	switch(index) {
...
void LocaleDisplayNamesTest::TestUldnOpen() {
	...
	if(0 != strcmp(uloc_getDefault(), locale)) {
...
static const LocNameDispContextItem ctxtItems[] = {
	...
	{ "da", UDISPCTX_STANDARD_NAMES, UDISPCTX_CAPITALIZATION_FOR_MIDDLE_OF_SENTENCE,    UDISPCTX_LENGTH_FULL,   en_cabud,
	  daFor_en_cabud },
	...
	{ "da", UDISPCTX_STANDARD_NAMES, UDISPCTX_CAPITALIZATION_FOR_BEGINNING_OF_SENTENCE, UDISPCTX_LENGTH_FULL,   en_cabud,
	  daFor_en_cabudT },
	...
	{ "ru", UDISPCTX_STANDARD_NAMES, UDISPCTX_CAPITALIZATION_FOR_BEGINNING_OF_SENTENCE, UDISPCTX_LENGTH_FULL,   uz_Latn,
	  ruFor_uz_Latn_T },

	{ "da", UDISPCTX_STANDARD_NAMES, UDISPCTX_CAPITALIZATION_FOR_UI_LIST_OR_MENU,       UDISPCTX_LENGTH_FULL,   en,    daFor_en_T },
	{ "da", UDISPCTX_STANDARD_NAMES, UDISPCTX_CAPITALIZATION_FOR_UI_LIST_OR_MENU,       UDISPCTX_LENGTH_FULL,   en_cabud,
	  daFor_en_cabudT },
	...
	{ "ru", UDISPCTX_STANDARD_NAMES, UDISPCTX_CAPITALIZATION_FOR_UI_LIST_OR_MENU,       UDISPCTX_LENGTH_FULL,   uz_Latn,
	  ruFor_uz_Latn_T },

	{ "da", UDISPCTX_STANDARD_NAMES, UDISPCTX_CAPITALIZATION_FOR_STANDALONE,            UDISPCTX_LENGTH_FULL,   en,    daFor_en },
	{ "da", UDISPCTX_STANDARD_NAMES, UDISPCTX_CAPITALIZATION_FOR_STANDALONE,            UDISPCTX_LENGTH_FULL,   en_cabud,
	  daFor_en_cabud },
	...
	{ "ru", UDISPCTX_STANDARD_NAMES, UDISPCTX_CAPITALIZATION_FOR_STANDALONE,            UDISPCTX_LENGTH_FULL,   uz_Latn,
	  ruFor_uz_Latn_T },
 #endif /* #if !UCONFIG_NO_BREAK_ITERATION */
			...
			if(U_FAILURE(status)) {
				...
				if(U_FAILURE(status)) {
					...
					dataerrln(UnicodeString(
						    "FAIL: uldn_localeDisplayName, capitalization ") + ctxtItemPtr->capitalization +
