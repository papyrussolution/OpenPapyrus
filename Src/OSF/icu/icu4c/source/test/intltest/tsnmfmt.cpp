 ...
 * NumberFormat.
 */
void IntlTestNumberFormat::runIndexedTest(int32_t index, bool exec, const char *& name, char * /*par*/)
{
...
void IntlTestNumberFormat::testLocale(/* char * par, */ const Locale & locale, const UnicodeString & localeName)
{
	const char * name;
...
void IntlTestNumberFormat::testFormat(/* char * par */)
{
	...
	tryIt(3.88057859588817e-68); // Test rounding when only some digits are shown because exponent is close to
	                             // -maxfrac
	...
	tryIt(3.88057859588817e-096); // Test rounding when only some digits are shown because exponent is close to
	                              // -maxfrac
...
void IntlTestNumberFormat::tryIt(double aNumber)
{
...
void IntlTestNumberFormat::tryIt(int32_t aNumber)
{
