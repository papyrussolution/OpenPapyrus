...
public: // package
  ...
  * @param status error code
     */
    static UDate minDateOfCalendar(const Calendar& cal, bool &isGregorian, UErrorCode & status);
  ...
  * @param status error code
     */
    static UDate minDateOfCalendar(const Locale & locale, bool &isGregorian, UErrorCode & status);
