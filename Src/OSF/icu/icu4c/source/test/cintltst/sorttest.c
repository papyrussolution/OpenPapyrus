...
{
	uint16_t small_[] = { 8, 1, 2, 5, 4, 3, 7, 6 }; // @sobolev small-->small_ name conflict resolution
	int32_t medium[] = { 10, 8, 1, 2, 5, 5, -1, 6, 4, 3, 9, 7, 5 };
	uint32_t large[] = { 21, 10, 20, 19, 11, 12, 13, 10, 10, 10, 10, 8, 1, 2, 5, 10, 10, 4, 17, 18, 3, 9, 10, 7, 6, 14, 15, 16 };
	int32_t i;
...
static void printLines(const Line * lines) {
...
static int32_t U_EXPORT2 linesComparator(const void * context, const void * left, const void * right) {
