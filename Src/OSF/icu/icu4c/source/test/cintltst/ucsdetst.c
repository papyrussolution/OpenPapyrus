...
#define NEW_ARRAY(type, count) (type*)SAlloc::M((count) * sizeof(type))
#define DELETE_ARRAY(array) SAlloc::F(array)

static void TestConstruction();
static void TestUTF8();
static void TestUTF16();
static void TestC1Bytes();
static void TestInputFilter();
static void TestChaining();
static void TestBufferOverflow();
static void TestIBM424();
static void TestIBM420();
...
static void TestBufferOverflow() {
	...
	static const char * testStrings[] = {
		"\x80\x20\x54\x68\x69\x73\x20\x69\x73\x20\x45\x6E\x67\x6C\x69\x73\x68\x20\x1b", /* A partial ISO-2022
		                                                                                   shift state at the
		                                                                                   end */
		"\x80\x20\x54\x68\x69\x73\x20\x69\x73\x20\x45\x6E\x67\x6C\x69\x73\x68\x20\x1b\x24", /* A partial
		                                                                                       ISO-2022 shift
		                                                                                       state at the end
		      */
		"\x80\x20\x54\x68\x69\x73\x20\x69\x73\x20\x45\x6E\x67\x6C\x69\x73\x68\x20\x1b\x24\x28", /* A partial
		                                                                                           ISO-2022
		                                                                                           shift state
		                                                                                           at the end */
		"\x80\x20\x54\x68\x69\x73\x20\x69\x73\x20\x45\x6E\x67\x6C\x69\x73\x68\x20\x1b\x24\x28\x44", /* A
		                                                                                               complete
		                                                                                               ISO-2022
		                                                                                               shift
		                                                                                               state at
