 ...
 * @param status
 */
int32_t nfs4_prepare(const char * src, int32_t srcLength,
 ...
 * @param status
 */
int32_t nfs4_mixed_prepare(const char * src, int32_t srcLength,
    char * dest, int32_t destCapacity,
    UParseError* parseError,
    UErrorCode *  status);
 ...
 * @param status
 */
int32_t nfs4_cis_prepare(const char * src, int32_t srcLength,
    char * dest, int32_t destCapacity,
    UParseError* parseError,
    UErrorCode *  status);
