...
static void U_CALLCONV chArrayClose(UEnumeration * en) {
	if(cont->currUChar != NULL) {
		SAlloc::F(cont->currUChar);
		cont->currUChar = NULL;
	}
	SAlloc::F(en);
}

static int32_t U_CALLCONV chArrayCount(UEnumeration * en, UErrorCode * status) {
...
static const char * U_CALLCONV chArrayNext(UEnumeration * en, int32_t * resultLength, UErrorCode * status) {
	(void)status; // suppress compiler warnings about unused variable
	if(cont->currIndex >= cont->maxIndex) {
		return NULL;
	}
...
static void U_CALLCONV chArrayReset(UEnumeration * en, UErrorCode * status) {
	(void)status; // suppress compiler warnings about unused variable
	cont->currIndex = 0;
}
...
static void U_CALLCONV uchArrayClose(UEnumeration * en) {
	SAlloc::F(en);
}

static int32_t U_CALLCONV uchArrayCount(UEnumeration * en, UErrorCode * status) {
	(void)status; // suppress compiler warnings about unused variable
...
static void U_CALLCONV uchArrayReset(UEnumeration * en, UErrorCode * status) {
	(void)status; // suppress compiler warnings about unused variable
	ucont->currIndex = 0;
}
