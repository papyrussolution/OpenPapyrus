...
/*  text           numeric           text                    numeric */
	{UDAT_REL_NUMERIC_FIELD,  0,  1}, {UDAT_REL_NUMERIC_FIELD,  0,  1},/* "5 seconds ago",        "5 seconds ago",
	                                                                         -5   */
	{UDAT_REL_NUMERIC_FIELD,  0,  3}, {UDAT_REL_NUMERIC_FIELD,  0,  3},/* "2.2 seconds ago",      "2.2 seconds ago",
	                                                                       -2.2 */
	{UDAT_REL_NUMERIC_FIELD,  0,  1}, {UDAT_REL_NUMERIC_FIELD,  0,  1},/* "2 seconds ago",        "2 seconds ago",
	                                                                         -2   */
	{UDAT_REL_NUMERIC_FIELD,  0,  1}, {UDAT_REL_NUMERIC_FIELD,  0,  1},/* "1 second ago",         "1 second ago",
	                                                                          -1   */
	{UDAT_REL_NUMERIC_FIELD,  0,  3}, {UDAT_REL_NUMERIC_FIELD,  0,  3},/* "0.7 seconds ago",      "0.7 seconds ago",
	                                                                       -0.7 */
	{ -1, -1, -1}, {UDAT_REL_NUMERIC_FIELD,  0,  1},/* "now",                  "0 seconds ago",        -0  */
	{ -1, -1, -1}, {UDAT_REL_NUMERIC_FIELD,  3,  4},/* "now",                  "in 0 seconds",         0   */
	{UDAT_REL_NUMERIC_FIELD,  3,  6}, {UDAT_REL_NUMERIC_FIELD,  3,  6},/* "in 0.7 seconds",       "in 0.7 seconds",
	                                                                         0.7 */
	{UDAT_REL_NUMERIC_FIELD,  3,  4}, {UDAT_REL_NUMERIC_FIELD,  3,  4},/* "in 1 second",          "in 1 second",
	                                                                            1   */
	{UDAT_REL_NUMERIC_FIELD,  3,  4}, {UDAT_REL_NUMERIC_FIELD,  3,  4},/* "in 2 seconds",         "in 2 seconds",
	                                                                           2   */
	{UDAT_REL_NUMERIC_FIELD,  3,  4}, {UDAT_REL_NUMERIC_FIELD,  3,  4},/* "in 5 seconds",         "in 5 seconds"
	                                                                            5   */
};
...
/*  text           numeric           text                    numeric */
	{UDAT_REL_NUMERIC_FIELD,  0,  1}, {UDAT_REL_NUMERIC_FIELD,  0,  1},/* "5 weeks ago",          "5 weeks ago",
	                                                                           -5   */
	{UDAT_REL_NUMERIC_FIELD,  0,  3}, {UDAT_REL_NUMERIC_FIELD,  0,  3},/* "2.2 weeks ago",        "2.2 weeks ago",
	                                                                         -2.2 */
	{UDAT_REL_NUMERIC_FIELD,  0,  1}, {UDAT_REL_NUMERIC_FIELD,  0,  1},/* "2 weeks ago",          "2 weeks ago",
	                                                                           -2   */
	{ -1, -1, -1}, {UDAT_REL_NUMERIC_FIELD,  0,  1},/* "last week",            "1 week ago",          -1   */
	{UDAT_REL_NUMERIC_FIELD,  0,  3}, {UDAT_REL_NUMERIC_FIELD,  0,  3},/* "0.7 weeks ago",        "0.7 weeks ago",
	                                                                         -0.7 */
	{ -1, -1, -1}, {UDAT_REL_NUMERIC_FIELD,  0,  1},/* "this week",            "0 weeks ago",          -0  */
	{ -1, -1, -1}, {UDAT_REL_NUMERIC_FIELD,  3,  4},/* "this week",            "in 0 weeks",           0   */
	{UDAT_REL_NUMERIC_FIELD,  3,  6}, {UDAT_REL_NUMERIC_FIELD,  3,  6},/* "in 0.7 weeks",         "in 0.7 weeks",
	                                                                           0.7 */
	{ -1, -1, -1}, {UDAT_REL_NUMERIC_FIELD,  3,  4},/* "next week",            "in 1 week",            1   */
	{UDAT_REL_NUMERIC_FIELD,  3,  4}, {UDAT_REL_NUMERIC_FIELD,  3,  4},/* "in 2 weeks",           "in 2 weeks",
	                                                                             2   */
	{UDAT_REL_NUMERIC_FIELD,  3,  4}, {UDAT_REL_NUMERIC_FIELD,  3,  4},/* "in 5 weeks",           "in 5 weeks"
	                                                                              5   */
};
...
/*  text           numeric           text                    numeric */
	...
	{UDAT_REL_NUMERIC_FIELD,  0,  1}, {UDAT_REL_NUMERIC_FIELD,  0,  1},/* "2 weeks ago",          "2 weeks ago",
	                                                                           -2  */
	{ -1, -1, -1}, {UDAT_REL_NUMERIC_FIELD,  0,  1},/* "last week",            "1 week ago",          -1   */
	{UDAT_REL_NUMERIC_FIELD,  0,  1}, {UDAT_REL_NUMERIC_FIELD,  0,  1},/* "0 weeks ago",          "0 weeks ago",
	                                                                           -0.7 */
	{ -1, -1, -1}, {UDAT_REL_NUMERIC_FIELD,  0,  1},/* "this week",            "0 weeks ago",         -0  */
	{ -1, -1, -1}, {UDAT_REL_NUMERIC_FIELD,  3,  4},/* "this week",            "in 0 weeks",           0   */
	{UDAT_REL_NUMERIC_FIELD,  3,  4}, {UDAT_REL_NUMERIC_FIELD,  3,  4},/* "in 0 weeks",           "in 0 weeks",
	                                                                             0.7 */
	{ -1, -1, -1}, {UDAT_REL_NUMERIC_FIELD,  3,  4},/* "next week",            "in 1 week",            1   */
	{UDAT_REL_NUMERIC_FIELD,  3,  4}, {UDAT_REL_NUMERIC_FIELD,  3,  4},/* "in 2 weeks",           "in 2 weeks",
	                                                                             2   */
...
/*  text           numeric           text                    numeric */
	{UDAT_REL_NUMERIC_FIELD,  0,  1}, {UDAT_REL_NUMERIC_FIELD,  0,  1},/* "5 wk. ago",            "5 wk. ago",
	                                                                             -5   */
	{UDAT_REL_NUMERIC_FIELD,  0,  3}, {UDAT_REL_NUMERIC_FIELD,  0,  3},/* "2.2 wk. ago",          "2.2 wk. ago",
	                                                                           -2.2 */
	{UDAT_REL_NUMERIC_FIELD,  0,  1}, {UDAT_REL_NUMERIC_FIELD,  0,  1},/* "2 wk. ago",            "2 wk. ago",
	                                                                             -2   */
	{ -1, -1, -1}, {UDAT_REL_NUMERIC_FIELD,  0,  1},/* "last wk.",             "1 wk. ago",           -1   */
	{UDAT_REL_NUMERIC_FIELD,  0,  3}, {UDAT_REL_NUMERIC_FIELD,  0,  3},/* "0.7 wk. ago",          "0.7 wk. ago",
	                                                                           -0.7 */
	{ -1, -1, -1}, {UDAT_REL_NUMERIC_FIELD,  0,  1},/* "this wk.",             "0 wk. ago",           -0   */
	{ -1, -1, -1}, {UDAT_REL_NUMERIC_FIELD,  3,  4},/* "this wk.",             "in 0 wk.",             0   */
	{UDAT_REL_NUMERIC_FIELD,  3,  6}, {UDAT_REL_NUMERIC_FIELD,  3,  6},/* "in 0.7 wk.",           "in 0.7 wk.",
	                                                                             0.7 */
	{ -1, -1, -1}, {UDAT_REL_NUMERIC_FIELD,  3,  4},/* "next wk.",             "in 1 wk.",             1   */
	{UDAT_REL_NUMERIC_FIELD,  3,  4}, {UDAT_REL_NUMERIC_FIELD,  3,  4},/* "in 2 wk.",             "in 2 wk.",
	                                                                               2   */
	{UDAT_REL_NUMERIC_FIELD,  3,  4}, {UDAT_REL_NUMERIC_FIELD,  3,  4},/* "in 5 wk.",             "in 5 wk."
	                                                                                5   */
};
...
/*  text           numeric           text                    numeric */
	{UDAT_REL_NUMERIC_FIELD,  0,  1}, {UDAT_REL_NUMERIC_FIELD,  0,  1},/* "5 minutes ago",        "5 minutes ago",
	                                                                         -5   */
	{UDAT_REL_NUMERIC_FIELD,  0,  3}, {UDAT_REL_NUMERIC_FIELD,  0,  3},/* "2.2 minutes ago",      "2.2 minutes ago",
	                                                                       -2.2 */
	{UDAT_REL_NUMERIC_FIELD,  0,  1}, {UDAT_REL_NUMERIC_FIELD,  0,  1},/* "2 minutes ago",        "2 minutes ago",
	                                                                         -2   */
	{UDAT_REL_NUMERIC_FIELD,  0,  1}, {UDAT_REL_NUMERIC_FIELD,  0,  1},/* "1 minute ago",         "1 minute ago",
	                                                                          -1   */
	{UDAT_REL_NUMERIC_FIELD,  0,  3}, {UDAT_REL_NUMERIC_FIELD,  0,  3},/* "0.7 minutes ago",      "0.7 minutes ago",
	                                                                       -0.7 */
	{-1,  -1,  -1}, {UDAT_REL_NUMERIC_FIELD,  0,  1},/* "this minute",        "0 minutes ago",       -0   */
	{-1,  -1,  -1}, {UDAT_REL_NUMERIC_FIELD,  3,  4},/* "this minute",         "in 0 minutes",         0   */
	{UDAT_REL_NUMERIC_FIELD,  3,  6}, {UDAT_REL_NUMERIC_FIELD,  3,  6},/* "in 0.7 minutes",       "in 0.7 minutes",
	                                                                         0.7 */
	{UDAT_REL_NUMERIC_FIELD,  3,  4}, {UDAT_REL_NUMERIC_FIELD,  3,  4},/* "in 1 minute",          "in 1 minute",
	                                                                            1   */
	{UDAT_REL_NUMERIC_FIELD,  3,  4}, {UDAT_REL_NUMERIC_FIELD,  3,  4},/* "in 2 minutes",         "in 2 minutes",
	                                                                           2   */
	{UDAT_REL_NUMERIC_FIELD,  3,  4}, {UDAT_REL_NUMERIC_FIELD,  3,  4},/* "in 5 minutes",         "in 5 minutes"
	                                                                            5   */
};
...
/*  text           numeric           text                    numeric */
	{UDAT_REL_NUMERIC_FIELD,  0,  1}, {UDAT_REL_NUMERIC_FIELD,  0,  1},/* "5 Tuesdays ago",       "5 Tuesdays ago",
	                                                                        -5   */
	{ -1, -1, -1}, { -1, -1, -1}, /* ""            ,         ""            ,        -2.2 */
	{UDAT_REL_NUMERIC_FIELD,  0,  1}, {UDAT_REL_NUMERIC_FIELD,  0,  1},/* "2 Tuesdays ago",       "2 Tuesdays ago",
	                                                                        -2   */
	...
	{UDAT_REL_NUMERIC_FIELD,  0,  1}, {UDAT_REL_NUMERIC_FIELD,  3,  4},/* "in 2 Tuesdays",        "in 2 Tuesdays",
	                                                                          2   */
	{UDAT_REL_NUMERIC_FIELD,  0,  1}, {UDAT_REL_NUMERIC_FIELD,  3,  4},/* "in 5 Tuesdays",        "in 5 Tuesdays",
	                                                                          5   */
};
...
/*  text           numeric           text                    numeric */
	{UDAT_REL_NUMERIC_FIELD,  7,  8}, {UDAT_REL_NUMERIC_FIELD,  7,  8},/* "il y a 5 jours",       "il y a 5 jours",
	                                                                        -5   */
	{UDAT_REL_NUMERIC_FIELD,  7, 10}, {UDAT_REL_NUMERIC_FIELD,  7, 10},/* "il y a 2,2 jours",     "il y a 2,2
	                                                                     jours",    -2.2 */
	{ -1, -1, -1}, {UDAT_REL_NUMERIC_FIELD,  7,  8},/* "avant-hier",           "il y a 2 jours",      -2   */
	{ -1, -1, -1}, {UDAT_REL_NUMERIC_FIELD,  7,  8},/* "hier",                 "il y a 1 jour",       -1   */
	{UDAT_REL_NUMERIC_FIELD,  7, 10}, {UDAT_REL_NUMERIC_FIELD,  7, 10},/* "il y a 0,7 jour",      "il y a 0,7 jour",
	                                                                         -0.7 */
	{ -1, -1, -1}, {UDAT_REL_NUMERIC_FIELD,  7,  8},/* "aujourd\\u2019hui",    "il y a 0 jour",       -0   */
	{ -1, -1, -1}, {UDAT_REL_NUMERIC_FIELD,  5,  6},/* "aujourd\\u2019hui",    "dans 0 jour",          0   */
	{UDAT_REL_NUMERIC_FIELD,  5,  8}, {UDAT_REL_NUMERIC_FIELD,  5,  8},/* "dans 0,7 jour",        "dans 0,7 jour",
	                                                                          0.7 */
	{ -1, -1, -1}, {UDAT_REL_NUMERIC_FIELD,  5,  6},/* "demain",               "dans 1 jour",          1   */
	{ -1, -1, -1}, {UDAT_REL_NUMERIC_FIELD,  5,  6},/* "apr\\u00E8s-demain",   "dans 2 jours",         2   */
	{UDAT_REL_NUMERIC_FIELD,  5,  6}, {UDAT_REL_NUMERIC_FIELD,  5,  6},/* "dans 5 jours",         "dans 5 jours"
	                                                                            5   */
};
...
static const RelDateTimeFormatTestItem fmtTestItems[] = {
	...
	{ NULL,  0, (UDateRelativeDateTimeFormatterStyle)0, (UDisplayContext)0, (URelativeDateTimeUnit)0, NULL, NULL }/*
	                                                                                                                 terminator
	     */
};
		...
		for(iOffset = 0; iOffset < kNumOffsets; iOffset++) {
			...
			if(U_FAILURE(status) ) {
				...
				if(ulenget != ulenexp || u_strncmp(ubufget, ubufexp, ulenexp) != 0) {
					...
					log_err(
						"ERROR: ureldatefmt_format() for locale %s, decPlaces %d, width %d, capContext %d, offset %.2f, unit %d;\n      expected %s\n      get      %s\n",
						itemPtr->locale,
						itemPtr->decPlaces,
						(int)itemPtr->width,
						(int)itemPtr->capContext,
			...
			if(U_FAILURE(status) ) {
				...
				if(expectedAttr.field == -1) {
					...
					if(!foundNumeric ||
						...
						log_err(
							"ureldatefmt_formatForFields as \"%s\"; expect field %d range %d-%d, get range %d-%d\n",
							itemPtr->expectedResults[iOffset*2],
							expectedAttr.field,
							expectedAttr.beginPos,
							expectedAttr.endPos,
							beginPos,
							endPos);
					}
			...
			if(U_FAILURE(status) ) {
				...
				if(expectedAttr.field == -1) {
					...
					if(!foundNumeric ||
						...
						log_err(
							"ureldatefmt_formatForFields as \"%s\"; expect field %d range %d-%d, get field %d range %d-%d\n",
							itemPtr->expectedResults[iOffset*2 + 1],
							expectedAttr.field,
							expectedAttr.beginPos,
							expectedAttr.endPos,
...
static void TestFields() 
{
	...
	URelativeDateTimeFormatter* fmt = ureldatefmt_open("en-us", NULL, UDAT_STYLE_SHORT, UDISPCTX_CAPITALIZATION_NONE, &ec);
