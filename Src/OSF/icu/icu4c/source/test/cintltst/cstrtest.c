...
static void TestCompareInvEbcdicAsAscii();
static void TestLocaleAtSign();
static void TestNoInvariantAtSign();
static void TestInvCharToAscii();
...
static void TestInvariant() {
	...
	const char16_t invariantUChars[] = {
	...
	const char16_t variantUChars[] = {
		0x0a, 0x21, 0x23, 0x24, 0x40, 0x5b, 0x5c, 0x5d, 0x5e, 0x60, 0x7b, 0x7c, 0x7d, 0x7e, 0
	};

	const char16_t nonASCIIUChars[] = { 0x80, 0xa0, 0x900, 0xff51 };
...
static const char * nativeInvChars =
    ...
    "abcdefghijklmnopqrstuvwxyz"
    "0123456789 \"%&'()*+,-./:;<=>?_";
static const char16_t * asciiInvChars =
