...
static void U_CALLCONV TestStream(void)
{
	...
	static const char testStr[] =
	    "\x42\x65\x67\x69\x6E\x6E\x69\x6E\x67\x20\x6F\x66\x20\x74\x65\x73\x74\x20\x73\x74\x72\x31\x20\x20\x20\x3C\x3C\x32\x31\x20"
	    UTF8_NEW_LINE "\x20\x55\x54\x46\x2D\x38\x20\xCE\xBC\xF0\x90\x80\x81\xF0\x90\x80\x82";
...
void printBits(const iostream&  stream)
{
...
void testString(UnicodeString & str,
...
static void U_CALLCONV TestStreamEOF(void)
{
	...
	/* The test cases needs to be converted to the default codepage.  However, the stream operator needs char * so
	   U_STRING_* is called. */
