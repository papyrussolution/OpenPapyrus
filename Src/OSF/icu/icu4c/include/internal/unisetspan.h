...
public:
  ...
  *         false if not (use a BMPSet for best performance).
     */
    inline bool needsStringSpanUTF16();
    inline bool needsStringSpanUTF8();
...
bool UnicodeSetStringSpan::needsStringSpanUTF16() {
    return (bool)(maxLength16!=0);
}

bool UnicodeSetStringSpan::needsStringSpanUTF8() {
    return (bool)(maxLength8!=0);
}

bool UnicodeSetStringSpan::contains(UChar32 c) const {
