...
// Some zone display names involving supplementary characters can be over 50 chars, 100 UTF-16 code units, 200 UTF-8
// bytes
...
inline bool CharacterNode::hasValues() const { return (bool)(fValues != NULL); }
...
public:
	virtual bool handleMatch(int32_t matchLength,
...
public:
	TextTrieMap(bool ignoreCase, UObjectDeleter * valeDeleter);
	virtual ~TextTrieMap();
...
public:
	...
	void getDisplayNames(const UnicodeString & tzID, const UTimeZoneNameType types[], int32_t numTypes,
	    UDate date, UnicodeString dest[], UErrorCode & status) const override;
...
private:
	...
	bool fNamesTrieFullyLoaded;
	bool fNamesFullyLoaded;
