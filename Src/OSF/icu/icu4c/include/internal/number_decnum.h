...
// When building DLLs for Windows this is required even though no direct access to the MaybeStackHeaderAndArray leaks
// out of the i18n library.
...
public:
	...
	inline const decNumber* getRawDecNumber() const { return fData.getAlias(); }
private:
