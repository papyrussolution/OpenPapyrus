...
public:
	...
	bool      intersects(const ScriptSet &other) const;// Sets contain at least one script in common.
	bool      contains(const ScriptSet &other) const;// All set bits in other are also set in this.
	ScriptSet &setAll();
	ScriptSet &resetAll();
