...
struct U_I18N_API CollationDataReader /* all static */ {
	...
	enum {
		...
		/**
		 * Byte offset to uint8 reorderTable[].
 ...
 *
 * uint8 reorderTable[256]; -- empty in root; can be longer to include padding bytes
 ...
 *
 * bool compressibleBytes[]; -- empty in all tailorings
