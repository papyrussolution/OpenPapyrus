...
public:
	...
	bool equals(const UVector32 &other) const;
	inline int32_t lastElementi() const;
	int32_t indexOf(int32_t elem, int32_t startIndex = 0) const;
	inline bool contains(int32_t elem) const;
	bool containsAll(const UVector32& other) const;
	bool removeAll(const UVector32& other);
	bool retainAll(const UVector32& other);
	 ...
	 */
	bool containsNone(const UVector32& other) const;
...
public:
	inline bool empty() const; // TODO:  redundant, same as empty().  Remove it?
...
inline int32_t UVector32::size() const { return count; }
inline bool UVector32::isEmpty() const { return count == 0; }
inline bool UVector32::contains(int32_t obj) const { return indexOf(obj) >= 0; }
inline int32_t UVector32::lastElementi() const { return elementAti(count-1); }
inline bool UVector32::operator !=(const UVector32& other) { return !operator ==(other); }
inline int32_t * UVector32::getBuffer() const { return elements; }

// UStack inlines
inline bool UVector32::empty() const { return isEmpty(); }
inline int32_t UVector32::peeki() const { return lastElementi(); }
