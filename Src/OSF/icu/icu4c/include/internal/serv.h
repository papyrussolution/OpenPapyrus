...
class U_COMMON_API ICUServiceKey : public UObject {
  ...
  */
  virtual bool isFallbackOf(const UnicodeString & id) const;
...
class U_COMMON_API SimpleFactory : public ICUServiceFactory {
 ...
 public:
   ...
   */
  SimpleFactory(UObject* instanceToAdopt, const UnicodeString & id, bool visible = true);
...
class U_COMMON_API ICUService : public ICUNotifier {
  ...
  * @return the result vector.  */
    ...
    /**
  * <p>A convenience override of registerInstance(UObject*, const UnicodeString &, bool)
  ...
  * (and discard) this instance.
     */
    virtual URegistryKey registerInstance(UObject* objToAdopt, const UnicodeString & id, bool visible, UErrorCode & status);
  ...
  * @return true if the call successfully unregistered the factory.
     */
    virtual bool unregister(URegistryKey rkey, UErrorCode & status);
  ...
  * @return an instance of ICUServiceFactory that maps this instance to the provided ID.
     */
    virtual ICUServiceFactory* createSimpleFactory(UObject* instanceToAdopt, const UnicodeString & id, bool visible, UErrorCode & status);
  ...
  * @return true if the service accepts the listener.
     */
    virtual bool acceptsListener(const EventListener& l) const override;
