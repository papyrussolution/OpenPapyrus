...
public:
    UIterCollationIterator(const CollationData *d, bool numeric, UCharIterator &ui)
...
public:
    FCDUIterCollationIterator(const CollationData *data, bool numeric, UCharIterator &ui, int32_t startIndex)
