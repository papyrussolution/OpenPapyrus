...
private:
	...
	bool fCombinedHasDateAtStart;
	bool fCapitalizationInfoSet;
	bool fCapitalizationOfRelativeUnitsForUIListMenu;
	bool fCapitalizationOfRelativeUnitsForStandAlone;
