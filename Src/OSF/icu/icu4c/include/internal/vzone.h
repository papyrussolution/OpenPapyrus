...
struct VZone;
// 
// A UnicodeSet.  Use the vzone_* API to manipulate.  
// Create with vzone_open*, and destroy with vzone_close.
// 
 ...
 */
U_CAPI bool U_EXPORT2 vzone_equals(const VZone* zone1, const VZone* zone2);
 ...
 */
U_CAPI bool U_EXPORT2 vzone_getLastModified(VZone* zone, UDate& lastModified);
 ...
 */
U_CAPI void U_EXPORT2 vzone_getOffset3(VZone* zone, UDate date, bool local, int32_t& rawOffset,
 ...
 * false, otherwise.
 */
U_CAPI bool U_EXPORT2 vzone_useDaylightTime(VZone* zone);
 ...
 * false, otherwise.
 */
U_CAPI bool U_EXPORT2 vzone_inDaylightTime(VZone* zone, UDate date, UErrorCode & status);
 ...
 */
U_CAPI bool U_EXPORT2 vzone_hasSameRules(VZone* zone, const VZone* other);
 ...
 */
U_CAPI bool U_EXPORT2 vzone_getNextTransition(VZone* zone, UDate base, bool inclusive, ZTrans* result);
 ...
 * @return  true if the transition is found.
 */
U_CAPI bool U_EXPORT2 vzone_getPreviousTransition(VZone* zone, UDate base, bool inclusive, ZTrans* result);
