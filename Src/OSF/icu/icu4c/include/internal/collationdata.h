...
private:
	...
	void makeReorderRanges(const int32_t * reorder, int32_t length, bool latinMustMove, UVector32 &ranges, UErrorCode & errorCode) const;
	int32_t addLowScriptRange(uint8 table[], int32_t index, int32_t lowStart) const;
	int32_t addHighScriptRange(uint8 table[], int32_t index, int32_t highLimit) const;
};
