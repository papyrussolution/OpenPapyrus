...
public:
	...
	bool equals(const UVector &other) const;
	...
	inline bool contains(void * obj) const { return indexOf(obj) >= 0; }
	inline bool contains(int32_t obj) const { return indexOf(obj) >= 0; }
	bool containsAll(const UVector& other) const;
	bool removeAll(const UVector& other);
	bool retainAll(const UVector& other);
	void removeElementAt(int32_t index);
	bool removeElement(void * obj);
	 ...
	 */
	bool ensureCapacityX(int32_t minimumCapacity, UErrorCode & status);
	bool ensureCapacity(int32_t minimumCapacity, UErrorCode & status);
	/**
	 ...
	 */
	bool containsNone(const UVector& other) const;
	/**
