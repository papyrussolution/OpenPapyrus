...
struct UConverterSharedData {
    ...
    bool                sharedDataCached; /* true:  shared data is in cache, don't destroy on ucnv_close() if 0 ref.  false: shared data isn't in the cache, do attempt to clean it up if the ref is 0 */
