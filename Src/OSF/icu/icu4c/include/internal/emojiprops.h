...
public:
    ...
    static bool hasBinaryProperty(const UChar *s, int32_t length, UProperty which);
...
private:
    ...
    bool hasBinaryPropertyImpl(const UChar *s, int32_t length, UProperty which) const;
