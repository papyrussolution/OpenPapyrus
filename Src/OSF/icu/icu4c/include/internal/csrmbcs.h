...
public:
  ...
  * @return the charset name.
    ...
    bool match(InputText* input, CharsetMatch *results) const override = 0;
  ...
  * @return    True if a character was returned, false at end of input.
     */
    virtual bool nextChar(IteratedChar *it, InputText *textIn) const = 0;
...
public:
    ...
    bool nextChar(IteratedChar *it, InputText *det) const override;

    bool match(InputText* input, CharsetMatch *results) const override;
