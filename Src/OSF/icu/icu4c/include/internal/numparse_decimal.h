...
public:
	...
	bool match(StringSegment& segment, ParsedNumber& result, int8 exponentSign, UErrorCode & status) const;
	bool smokeTest(const StringSegment& segment) const override;
	UnicodeString toString() const override;
private:
	bool requireGroupingMatch; /** If true, only accept strings whose grouping sizes match the locale */
	bool groupingDisabled; /** If true, do not accept grouping separators at all */
	...
	bool integerOnly; /** If true, do not accept numbers in the fraction */
	int16 grouping1;
	int16 grouping2;
