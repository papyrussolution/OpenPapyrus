...
#ifndef UCNV_H
// 
// A TimeZoneTransition.  Use the ztrans_* API to manipulate.  
// Create with ztrans_open*, and destroy with ztrans_close.
// 
struct ZTrans;
 ...
 */
U_CAPI bool U_EXPORT2 ztrans_equals(const ZTrans* trans1, const ZTrans* trans2);
/**
 ...
 * @param from The time zone rule used before the transition.
 */
U_CAPI void U_EXPORT2 ztrans_adoptFrom(ZTrans* trans, void * from);
