...
public:
	 ...
	 * Copy constructor.
	 *
	 * If memory allocation fails during copying, no values are copied and status is set to
...
struct MicroProps : public MicroPropsGenerator {
	...
	// UMEASURE_UNIT_MIXED complexity, in which case mixedMeasures comes into play.
	...
	int32_t indexOfQuantity = -1; // Points to quantity position, -1 if the position is not set yet.
	int32_t mixedMeasuresCount = 0; // Number of mixedMeasures that have been populated
