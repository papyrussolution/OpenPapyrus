...
protected:
	virtual bool handlesKey(const ICUServiceKey& key, UErrorCode & status) const;
...
public:
	 ...
	 */
	virtual URegistryKey registerInstance(UObject * objToAdopt,
	    const Locale & locale,
	    int32_t kind,
	    int32_t coverage,
	    UErrorCode & status);
	 ...
	 * hidden overrides.
	 */
	virtual URegistryKey registerInstance(UObject * objToAdopt, const UnicodeString & locale, bool visible,
