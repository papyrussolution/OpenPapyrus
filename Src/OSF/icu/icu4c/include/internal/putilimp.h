 ...
 * @internal
 */
U_CAPI bool U_EXPORT2 uprv_isNaN(double d);
/**
 * Floating point utility to determine if a double has an infinite value.
 * @internal
 */
U_CAPI bool U_EXPORT2 uprv_isInfinite(double d);
/**
 * Floating point utility to determine if a double has a positive infinite value.
 * @internal
 */
U_CAPI bool U_EXPORT2 uprv_isPositiveInfinity(double d);
/**
 * Floating point utility to determine if a double has a negative infinite value.
 * @internal
 */
U_CAPI bool U_EXPORT2 uprv_isNegativeInfinity(double d);
/**
 ...
 * @internal
 */
U_CAPI double U_EXPORT2 uprv_maxMantissa();
 ...
 * @internal
 */
U_CAPI bool U_EXPORT2 uprv_add32_overflow(int32_t a, int32_t b, int32_t* res);
 ...
 * @internal
 */
U_CAPI bool U_EXPORT2 uprv_mul32_overflow(int32_t a, int32_t b, int32_t* res);
 ...
 * @internal
 */
U_CAPI void uprv_tzname_clear_cache();
...
/**
 * Get UTC (GMT) time measured in milliseconds since 0:00 on 1/1/1970.
 * This function is not affected by 'faketime', so it should only be used by low level test functions- not by anything
 *that
 ...
 * @internal (ICU 3.0)
 */
U_CAPI bool U_EXPORT2 uprv_pathIsAbsolute(const char * path);
...
#define uprv_default_malloc_Removed(x) _C_TS_malloc(x)
#define uprv_default_realloc_Removed(x, y) _C_TS_realloc(x, y)
#define uprv_default_free_Removed(x) _C_TS_free(x)
/* also _C_TS_calloc(x) */
#else
/* C defaults */
#define uprv_default_malloc_Removed(x) SAlloc::M(x)
#define uprv_default_realloc_Removed(x, y) SAlloc::R(x, y)
#define uprv_default_free_Removed(x) SAlloc::F(x)
#endif
#endif
