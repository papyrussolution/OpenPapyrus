...
protected:
	 ...
	 */
	virtual void handleTransliterate(Replaceable& text, UTransPosition& idx, bool incremental) const override;
public:
	/**
...
private:
	...
	void init(const UnicodeString & id, UTransDirection direction, bool fixReverseID, UErrorCode & status);
	void init(UVector& list, UTransDirection direction, bool fixReverseID, UErrorCode & status);
	/**
