...
inline bool ustrcase_checkTitleAdjustmentOptions(uint32_t options, UErrorCode & errorCode) 
{
...
inline bool ustrcase_isLNS(UChar32 c) 
{
...
U_CFUNC BreakIterator * ustrcase_getTitleBreakIterator(const Locale * locale, const char * locID, uint32_t options, BreakIterator * iter,
