...
public:
	 ...
	 * @stable ICU 2.0
	 */
	virtual bool contains(UChar32 start, UChar32 end) const;
	 ...
	 * @stable ICU 2.4
	 */
	bool contains(const UnicodeString & s) const;
	 ...
	 * @stable ICU 2.4
	 */
	virtual bool containsAll(const UnicodeSet & c) const;
	 ...
	 * @stable ICU 2.4
	 */
	bool containsAll(const UnicodeString & s) const;
	 ...
	 * @stable ICU 2.4
	 */
	bool containsNone(UChar32 start, UChar32 end) const;
	 ...
	 * @stable ICU 2.4
	 */
	bool containsNone(const UnicodeSet & c) const;
	 ...
	 * @stable ICU 2.4
	 */
	bool containsNone(const UnicodeString & s) const;
	 ...
	 * @stable ICU 2.4
	 */
	inline bool containsSome(UChar32 start, UChar32 end) const;
	 ...
	 * @stable ICU 2.4
	 */
	inline bool containsSome(const UnicodeSet & s) const;
	 ...
	 * @stable ICU 2.4
	 */
	inline bool containsSome(const UnicodeString & s) const;
...
private:
	...
	UnicodeSet(const UnicodeSet &o, bool /* asThawed */);
	UnicodeSet & copyFrom(const UnicodeSet & o, bool asThawed);
	...
	bool allocateStrings(UErrorCode & status);
	int32_t stringsSize() const;
	bool stringsContains(const UnicodeString & s) const;
	...
	static void _appendToPat(UnicodeString & buf, const UnicodeString & s, bool escapeUnprintable);

	static void _appendToPat(UnicodeString & buf, UChar32 c, bool escapeUnprintable);
	 ...
	 * \\P{foo}, or \\N{name}.
	 */
	static bool resemblesPropertyPattern(const UnicodeString & pattern,
	    int32_t pos);

	static bool resemblesPropertyPattern(RuleCharacterIterator& chars,
	    int32_t iterOpts);
	 ...
	 */
	typedef bool (* Filter)(UChar32 codePoint, void * context);
	 ...
	 */
	void applyFilter(Filter filter, void * context, const UnicodeSet* inclusions, UErrorCode & status);
	// UCPMap is now stable ICU 63
	void applyIntPropertyValue(const UCPMap * map, UCPMapValueFilter * filter, const void * context, UErrorCode & errorCode);
	/**
	 * Set the new pattern to cache.
	 */
	void setPattern(const UnicodeString & newPat) { setPattern(newPat.getBuffer(), newPat.length()); }
...
inline bool UnicodeSet::isBogus() const { return (bool)(fFlags & kIsBogus); }
inline UnicodeSet * UnicodeSet::fromUSet(USet * uset) { return reinterpret_cast<UnicodeSet *>(uset); }
inline const UnicodeSet * UnicodeSet::fromUSet(const USet * uset) { return reinterpret_cast<const UnicodeSet *>(uset); }
inline USet * UnicodeSet::toUSet() { return reinterpret_cast<USet *>(this); }
inline const USet * UnicodeSet::toUSet() const { return reinterpret_cast<const USet *>(this); }
