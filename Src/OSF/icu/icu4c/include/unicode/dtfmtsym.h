...
public:
	 ...
	 * zones.
	 * @param strings       The timezone strings as a 2-d array to be copied. (not adopted; caller retains
	 *ownership)
...
private:
	 ...
	 */
	bool fCapitalization[kCapContextUsageTypeCount][2];
...
private:
	 ...
	 *                 identical (pointers are equal).
	 */
	static bool arrayCompare(const UnicodeString * array1,
	 ...
	 */
	static bool U_EXPORT2 isNumericField(UDateFormatField f, int32_t count);

	/**
	 * Returns true if c (repeated count times) is the pattern character for a numeric field.
	 */
	static bool U_EXPORT2 isNumericPatternChar(char16_t c, int32_t count);
public:
#ifndef U_HIDE_INTERNAL_API
	/**
