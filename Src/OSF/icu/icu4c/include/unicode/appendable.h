...
public:
	 ...
	 * @stable ICU 4.8
	 */
	virtual bool appendCodePoint(UChar32 c);
	 ...
	 * @stable ICU 4.8
	 */
	virtual bool appendString(const char16_t * s, int32_t length);
	 ...
	 * @stable ICU 4.8
	 */
	virtual bool reserveAppendCapacity(int32_t appendCapacity);
...
public:
	 ...
	 * @stable ICU 4.8
	 */
	virtual bool appendCodePoint(UChar32 c) override;
	 ...
	 * @stable ICU 4.8
	 */
	virtual bool appendString(const char16_t * s, int32_t length) override;
	 ...
	 * @stable ICU 4.8
	 */
	virtual bool reserveAppendCapacity(int32_t appendCapacity) override;
