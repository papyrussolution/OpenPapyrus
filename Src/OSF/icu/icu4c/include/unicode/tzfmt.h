...
private:
    ...
    bool fAbuttingOffsetHoursAndMinutes;
     ...
     *         (no under/overflow).
     */
    static bool toCodePoints(const UnicodeString & str, UChar32* codeArray, int32_t capacity);
     ...
     *      time zone string.
     */
    int32_t parseOffsetISO8601(const UnicodeString & text, ParsePosition& pos, bool extendedOnly,
    ...
    int32_t parseOffsetLocalizedGMT(const UnicodeString & text, ParsePosition& pos,
        bool isShort, bool* hasDigitOffset) const;
    ...
    int32_t parseOffsetLocalizedGMTPattern(const UnicodeString & text, int32_t start,
        bool isShort, int32_t& parsedLen) const;
     ...
     * @return the parsed offset in milliseconds.
     */
    int32_t parseOffsetFields(const UnicodeString & text, int32_t start, bool isShort, int32_t& parsedLen) const;
    ...
    static int32_t parseAbuttingAsciiOffsetFields(const UnicodeString & text, ParsePosition& pos,
        OffsetFields minFields, OffsetFields maxFields, bool fixedHourWidth);
