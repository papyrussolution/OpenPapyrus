 ...
 * @stable ICU 62
 */
U_CAPI UFormattedNumber* U_EXPORT2 unumf_openResult(UErrorCode* ec);
 ...
 * @stable ICU 62
 */
U_CAPI void U_EXPORT2 unumf_formatInt(const UNumberFormatter* uformatter, int64_t value, UFormattedNumber* uresult,
    UErrorCode* ec);
 ...
 * @stable ICU 62
 */
U_CAPI void U_EXPORT2 unumf_formatDouble(const UNumberFormatter* uformatter, double value, UFormattedNumber* uresult,
    UErrorCode* ec);
 ...
 * @stable ICU 62
 */
U_CAPI void U_EXPORT2 unumf_formatDecimal(const UNumberFormatter* uformatter, const char * value, int32_t valueLen,
 ...
 * @stable ICU 62
 */
U_CAPI bool U_EXPORT2 unumf_resultNextFieldPosition(const UFormattedNumber* uresult, UFieldPosition* ufpos, UErrorCode* ec);
 ...
 * @stable ICU 62
 */
U_CAPI void U_EXPORT2 unumf_resultGetAllFieldPositions(const UFormattedNumber* uresult, UFieldPositionIterator* ufpositer,
    UErrorCode* ec);
 ...
 * @stable ICU 68
 */
U_CAPI int32_t U_EXPORT2 unumf_resultToDecimalNumber(const UFormattedNumber* uresult,
    char * dest,
 ...
 * @stable ICU 62
 */
U_CAPI void U_EXPORT2 unumf_close(UNumberFormatter* uformatter);
 ...
 * @stable ICU 62
 */
U_CAPI void U_EXPORT2 unumf_closeResult(UFormattedNumber* uresult);
