...
/* Enum: fann_errno_enum
	Used to define error events on <Fann> and <FannTrainData>.
	...
	FANN_E_TRAIN_DATA_MISMATCH - Irreconcilable differences between two <FannTrainData> structures
...
/* Section: FANN Datatypes
   ...
   which represents an artificial neural network, and <FannTrainData>,
...
/* Enum: fann_train_enum
        The Training algorithms used when training on <FannTrainData> with functions like
...
/* Type: fann_callback_type
   ...
   <fann_train_on_file> or <fann_cascadetrain_on_data>.
        ...
        >typedef int (FANN_API * fann_callback_type) (Fann *ann, FannTrainData *train,
        >											  uint
           max_epochs,
        ...
        Example of a callback function:
                >int FANN_API test_callback(Fann *ann, FannTrainData *train,
 ...
 */
FANN_EXTERNAL typedef int (FANN_API * fann_callback_type)(Fann * ann, FannTrainData * train,
    uint max_epochs, uint epochs_between_reports, float desired_error, uint epochs);
...
struct Fann {
	...
	int    IsError() const
	{
		return (Err.errno_f != FANN_E_NO_ERROR);
	}
	int    IsError(fann_errno_enum errCode) const
	{
	...
	//
	// Descr: Get the mean square error.
	//
	float   GetMSE() const
	{
	...
	FannNeuron ** connections; // The connection array
	//
	...
	enum fann_train_enum training_algorithm; // Training algorithm used when calling fann_train_on_..
#ifdef FIXEDFANN
...
/* Function: fann_read_train_from_file
   ...
   See also:
    ...
    This function appears in FANN >= 1.0.0
*/
FANN_EXTERNAL FannTrainData *FANN_API fann_read_train_from_file(const char *filename);
...
*/
FANN_EXTERNAL FannTrainData * FANN_API fann_create_train_pointer_array(uint num_data, uint num_input, fann_type **input, uint num_output, fann_type **output);
/* Function: fann_create_train_array
   ...
   See also:
    ...
    This function appears in FANN >= 2.3.0
*/
FANN_EXTERNAL FannTrainData * FANN_API fann_create_train_array(uint num_data, uint num_input, fann_type *input, uint num_output, fann_type *output);
...
/* Function: fann_destroy_train
   ...
   Be sure to call this function when finished using the training data.
    ...
    This function appears in FANN >= 1.0.0
 */
FANN_EXTERNAL void FANN_API fann_destroy_train(FannTrainData * train_data);
...
/* Function: fann_set_input_scaling_params
   ...
   See also: <fann_set_output_scaling_params>
    This function appears in FANN >= 2.1.0
 */
FANN_EXTERNAL int FANN_API fann_set_input_scaling_params(Fann *ann, const FannTrainData *data, float new_input_min, float new_input_max);
/* Function: fann_set_output_scaling_params
   ...
   See also: <fann_set_input_scaling_params>
    This function appears in FANN >= 2.1.0
 */
FANN_EXTERNAL int FANN_API fann_set_output_scaling_params(Fann *ann, const FannTrainData *data, float new_output_min, float new_output_max);
/* Function: fann_set_scaling_params
   ...
   See also: <fann_set_input_scaling_params>, <fann_set_output_scaling_params>
    This function appears in FANN >= 2.1.0
 */
FANN_EXTERNAL int FANN_API fann_set_scaling_params(Fann * ann, const FannTrainData *data, float new_input_min, float new_input_max,
...
/*
   ...
   Merges the data from *data1* and *data2* into a new <FannTrainData>.
   This function appears in FANN >= 1.1.0.
 */
...
/*
   ...
   Returns an exact copy of a <FannTrainData>.
   This function appears in FANN >= 1.1.0.
 */
FANN_EXTERNAL FannTrainData * FANN_API fann_duplicate_train_data(FannTrainData * data);
/*
	Function: fann_subset_train_data
   Returns an copy of a subset of the <FannTrainData>, starting at position *pos*
...
/* Function: fann_length_train_data
   Returns the number of training patterns in the <FannTrainData>.
   This function appears in FANN >= 2.0.0.
 */
FANN_EXTERNAL uint FANN_API fann_length_train_data(FannTrainData *data);
/* Function: fann_num_input_train_data
   Returns the number of inputs in each of the training patterns in the <FannTrainData>.
...
/* Function: fann_num_output_train_data
   Returns the number of outputs in each of the training patterns in the <FannTrainData>.
...
/* Function: fann_get_training_algorithm
   ...
   This function appears in FANN >= 1.0.0.
 */
FANN_EXTERNAL enum fann_train_enum FANN_API fann_get_training_algorithm(Fann *ann);
...
/* Function: fann_set_training_algorithm
   ...
   This function appears in FANN >= 1.0.0.
 */
FANN_EXTERNAL void FANN_API fann_set_training_algorithm(Fann *ann, enum fann_train_enum training_algorithm);
/*
...
/*
   ...
   This function appears in FANN >= 1.0.0.
 */
FANN_EXTERNAL void FANN_API fann_set_learning_rate(Fann *ann, float learning_rate);
/*
...
/*
   ...
   This function appears in FANN >= 2.0.0.
 */
FANN_EXTERNAL void FANN_API fann_set_activation_function(Fann *ann, enum fann_activationfunc_enum activation_function, int layer, int neuron);
/*
   ...
   This function appears in FANN >= 2.0.0.
 */
FANN_EXTERNAL void FANN_API fann_set_activation_function_layer(Fann *ann, enum fann_activationfunc_enum activation_function, int layer);
/*
...
/*
   ...
   This function appears in FANN >= 1.2.0.
  */
FANN_EXTERNAL enum fann_errorfunc_enum FANN_API fann_get_train_error_function(Fann *ann);
/*
   ...
   This function appears in FANN >= 1.2.0.
 */
FANN_EXTERNAL void FANN_API fann_set_train_error_function(Fann *ann, enum fann_errorfunc_enum  train_error_function);
/*
   ...
   This function appears in FANN >= 2.0.0.
 */
FANN_EXTERNAL enum fann_stopfunc_enum FANN_API fann_get_train_stop_function(Fann *ann);
/* Function: fann_set_train_stop_function
   ...
   See also: <fann_get_train_stop_function>
	This function appears in FANN >= 2.0.0.
 */
FANN_EXTERNAL void FANN_API fann_set_train_stop_function(Fann *ann, enum fann_stopfunc_enum train_stop_function);
/* Function: fann_get_bit_fail_limit
   ...
   This function appears in FANN >= 2.0.0.
 */
FANN_EXTERNAL fann_type FANN_API fann_get_bit_fail_limit(Fann *ann);
/* Function: fann_set_bit_fail_limit
   Set the bit fail limit used during training.
   See also: <fann_get_bit_fail_limit>
   This function appears in FANN >= 2.0.0.
 */
FANN_EXTERNAL void FANN_API fann_set_bit_fail_limit(Fann *ann, fann_type bit_fail_limit);
/* Function: fann_set_callback
   ...
   This function appears in FANN >= 2.0.0.
 */
FANN_EXTERNAL void FANN_API fann_set_callback(Fann *ann, fann_callback_type callback);
...
/* Function: fann_get_cascade_weight_multiplier
   ...
   See also:
	...
	This function appears in FANN >= 2.0.0.
 */
FANN_EXTERNAL fann_type FANN_API fann_get_cascade_weight_multiplier(Fann *ann);
/* Function: fann_set_cascade_weight_multiplier
   ...
   See also:
	...
	This function appears in FANN >= 2.0.0.
 */
FANN_EXTERNAL void FANN_API fann_set_cascade_weight_multiplier(Fann *ann, fann_type cascade_weight_multiplier);
/* Function: fann_get_cascade_candidate_limit
   ...
   See also:
	...
	This function appears in FANN >= 2.0.0.
 */
FANN_EXTERNAL fann_type FANN_API fann_get_cascade_candidate_limit(Fann *ann);
/* Function: fann_set_cascade_candidate_limit
   ...
   See also:
	...
	This function appears in FANN >= 2.0.0.
 */
FANN_EXTERNAL void FANN_API fann_set_cascade_candidate_limit(Fann *ann, fann_type cascade_candidate_limit);
...
/* Function: fann_get_cascade_activation_functions
   ...
   See also:
	...
	This function appears in FANN >= 2.0.0.
 */
FANN_EXTERNAL enum fann_activationfunc_enum * FANN_API fann_get_cascade_activation_functions(Fann *ann);
/*
...
/* Function: fann_get_cascade_activation_steepnesses
   ...
   See also:
	...
	This function appears in FANN >= 2.0.0.
 */
FANN_EXTERNAL fann_type * FANN_API fann_get_cascade_activation_steepnesses(Fann *ann);
...
/* Function: fann_create_shortcut_array
   ...
   instead of individual parameters.
	...
	This function appears in FANN >= 2.0.0.
*/
FANN_EXTERNAL Fann *FANN_API fann_create_shortcut_array(uint num_layers,
															   const uint *layers);
...
/* Function: fann_get_num_layers
   ...
   This function appears in FANN >= 2.1.0
*/
FANN_EXTERNAL uint FANN_API fann_get_num_layers(Fann *ann);
