...
/* Function: fann_set_rprop_increase_factor
   ...
   This function appears in FANN >= 1.2.0.
*/ 
FANN_EXTERNAL void FANN_API fann_set_rprop_increase_factor(Fann *ann,
...
/* Function: fann_set_rprop_decrease_factor
   ...
   This function appears in FANN >= 1.2.0.
*/
FANN_EXTERNAL void FANN_API fann_set_rprop_decrease_factor(Fann *ann,
