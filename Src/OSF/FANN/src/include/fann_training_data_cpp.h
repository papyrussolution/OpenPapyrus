...
namespace FANN {
    ...
    */
    ...
    Encapsulation of a training data set <FannTrainData> and
    ...
    */
    ...
    public:
        ...
        */
        ...
        /* Method: save_train_to_fixed
           ...
           This function appears in FANN >= 1.0.0.
         */
        bool save_train_to_fixed(const std::string &filename, uint decimal_point) {
            if (train_data == NULL) {
                return false;
            }
        ...
        */
        fann_type *get_train_input(uint position) {
        ...
        /* Method: get_train_output
           ...
           This function appears in FANN >= 2.3.0.
        */
        fann_type *get_train_output(uint position) {
        ...
        */
        void set_train_data(uint num_data,
                            uint num_input, fann_type **input,
    ...
    private:
        /* Set the training data to the struct fann_training_data pointer.
            ...
            with fann_destroy. */
        void set_train_data(FannTrainData *data) {
            destroy_train();
            train_data = data;
        }
    ...
    public:
        ...
        */
        void create_train_from_callback(uint num_data,
                                        uint num_input,
                                        uint num_output,
                                        void (FANN_API *user_function)(uint,
                                                                       uint,
                                                                       uint,
                                                                       fann_type *,
                                                                       fann_type *)) {
        ...
        */
        ...
        /* Method: subset_train_data
           ...
           This function appears in FANN >= 2.0.0.
         */
        void subset_train_data(uint pos, uint length) {
            if (train_data != NULL) {
                FannTrainData *temp = fann_subset_train_data(train_data, pos, length);
                destroy_train();
                train_data = temp;
            }
        }
