...
float train_epoch_batch_parallel(struct fann *ann, FannTrainData *data, const uint threadnumb)
{
	fann_reset_MSE(ann);
...
float train_epoch_irpropm_parallel(struct fann *ann, FannTrainData *data, const uint threadnumb)
{
...
float train_epoch_quickprop_parallel(struct fann *ann, FannTrainData *data, const uint threadnumb)
{
...
float train_epoch_sarprop_parallel(struct fann *ann, FannTrainData *data, const uint threadnumb)
{
	if(ann->prev_train_slopes == NULL)
	{
		fann_clear_train_arrays(ann);
...
float train_epoch_incremental_mod(struct fann *ann, FannTrainData *data)
{
	uint i;
...
float train_epoch_batch_parallel(struct fann *ann, FannTrainData *data, const uint threadnumb,vector< vector<fann_type> >& predicted_outputs)
{
	fann_reset_MSE(ann);
...
float train_epoch_irpropm_parallel(struct fann *ann, FannTrainData *data, const uint threadnumb, vector< vector<fann_type> >& predicted_outputs)
{
...
float train_epoch_quickprop_parallel(struct fann *ann, FannTrainData *data, const uint threadnumb, vector< vector<fann_type> >& predicted_outputs)
{
...
float train_epoch_sarprop_parallel(struct fann *ann, FannTrainData *data, const uint threadnumb, vector< vector<fann_type> >& predicted_outputs)
{
...
float train_epoch_incremental_mod(struct fann *ann, FannTrainData *data, vector< vector<fann_type> >& predicted_outputs)
{
...
float test_data_parallel(struct fann *ann, FannTrainData *data, const uint threadnumb)
{
...
float test_data_parallel(struct fann *ann, FannTrainData *data, const uint threadnumb, vector< vector<fann_type> >& predicted_outputs)
{
	if(fann_check_input_output_sizes(ann, data) == -1)
		return 0;
	predicted_outputs.resize(data->num_data,vector<fann_type> (data->num_output));
