...
#include <time.h>      /* localtime(), strftime() */
	...
	#pragma warning(disable:4127) /* FD_SET() and FD_CLR(): conditional expression is constant */
	#pragma warning(disable:4244) /* conversion from 'type1' to 'type2', possible loss of data */
	#pragma warning(disable:4267) /* conversion from 'size_t' to 'type', possible loss of data */
	#pragma warning(disable:4295) /* array is too small to include a terminating null character */
#endif
#ifdef __WATCOMC__
	#pragma disable_message(202) /* symbol 'ngx_rbtree_min' has been defined, but not referenced */
#endif
#ifdef __BORLANDC__
	#pragma hdrstop /* the end of the precompiled headers */
	#pragma warn -8027 /* functions containing (for|while|some if) are not expanded inline */
	#pragma warn -8057 /* unreferenced formal parameter */
...
typedef unsigned __int64    uint64_t;
	...
	// @sobolev typedef __int64             off_t_sobolev; 
	typedef __int64             nginx_off_t; // @sobolev
...
#elif __BORLANDC__
	#define __TYPES_H /* off_t is redefined by sys/types.h used by zlib.h */
	typedef int                 dev_t;
	typedef unsigned int        ino_t;
#endif
#ifndef __GNUC__
...
#define NGX_LISTEN_BACKLOG           511
	...
	#define NGX_HAVE_SO_SNDLOWAT         0 /* setsockopt(SO_SNDLOWAT) returns error WSAENOPROTOOPT */
#endif
