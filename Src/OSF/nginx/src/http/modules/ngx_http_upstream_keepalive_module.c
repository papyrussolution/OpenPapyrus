    ...
    ngx_http_upstream_srv_conf_t * us)
{
	...
	kcf = (ngx_http_upstream_keepalive_srv_conf_t*)ngx_http_conf_upstream_srv_conf(us,
	...
	cached = (ngx_http_upstream_keepalive_cache_t *)ngx_pcalloc(cf->pool,
    ...
    ngx_http_upstream_srv_conf_t * us)
{
	...
	kp = (ngx_http_upstream_keepalive_peer_data_t *)ngx_palloc(r->pool, sizeof(ngx_http_upstream_keepalive_peer_data_t));
	if(kp == NULL) {
		return NGX_ERROR;
	}
...
static void ngx_http_upstream_free_keepalive_peer(ngx_peer_connection_t * pc, void * data, ngx_uint_t state)
{
	...
	c->P_EvWr->F_EvHandler = ngx_http_upstream_keepalive_dummy_handler;
	c->P_EvRd->F_EvHandler = ngx_http_upstream_keepalive_close_handler;
	c->data = item;
	c->idle = 1;
	c->log = ngx_cycle->log;
