...
static ngx_int_t ngx_http_gzip_static_handler(ngx_http_request_t * r)
{
	...
	gzcf = (ngx_http_gzip_static_conf_t *)ngx_http_get_module_loc_conf(r, ngx_http_gzip_static_module);
...
static void * ngx_http_gzip_static_create_conf(ngx_conf_t * cf)
{
	ngx_http_gzip_static_conf_t * conf = (ngx_http_gzip_static_conf_t *)ngx_palloc(cf->pool, sizeof(ngx_http_gzip_static_conf_t));
	if(conf)
...
static char * ngx_http_gzip_static_merge_conf(ngx_conf_t * cf, void * parent, void * child)
{
	ngx_http_gzip_static_conf_t * prev = (ngx_http_gzip_static_conf_t *)parent;
	ngx_http_gzip_static_conf_t * conf = (ngx_http_gzip_static_conf_t *)child;
