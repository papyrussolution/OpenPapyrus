...
static ngx_int_t ngx_http_main_request_charset(ngx_http_request_t * r, ngx_str_t * src)
{
	...
	ngx_http_charset_ctx_t  * ctx;
	ctx = (ngx_http_charset_ctx_t *)ngx_http_get_module_ctx(r->main, ngx_http_charset_filter_module);
	if(ctx) {
...
static ngx_int_t ngx_http_charset_body_filter(ngx_http_request_t * r, ngx_chain_t * in)
{
	...
	ctx = (ngx_http_charset_ctx_t *)ngx_http_get_module_ctx(r, ngx_http_charset_filter_module);
...
{
	ngx_http_charset_main_conf_t  * mcf;
	mcf = (ngx_http_charset_main_conf_t *)ngx_pcalloc(cf->pool, sizeof(ngx_http_charset_main_conf_t));
	if(mcf == NULL) {
		return NULL;
	}
...
static void * ngx_http_charset_create_loc_conf(ngx_conf_t * cf)
{
	...
	lcf = (ngx_http_charset_loc_conf_t *)ngx_pcalloc(cf->pool, sizeof(ngx_http_charset_loc_conf_t));
	if(lcf == NULL) {
		return NULL;
	}
