...
static ngx_int_t ngx_http_random_index_handler(ngx_http_request_t * r)
{
	...
	rlcf = (ngx_http_random_index_loc_conf_t *)ngx_http_get_module_loc_conf(r, ngx_http_random_index_module);
...
static char * ngx_http_random_index_merge_loc_conf(ngx_conf_t * cf, void * parent, void * child)
{
	ngx_http_random_index_loc_conf_t * prev = (ngx_http_random_index_loc_conf_t *)parent;
	ngx_http_random_index_loc_conf_t * conf = (ngx_http_random_index_loc_conf_t *)child;
