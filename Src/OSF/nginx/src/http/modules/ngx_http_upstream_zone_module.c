...
static char * ngx_http_upstream_zone(ngx_conf_t * cf, ngx_command_t * cmd, void * conf)
{
	...
	umcf = (ngx_http_upstream_main_conf_t *)ngx_http_conf_get_module_main_conf(cf, ngx_http_upstream_module);
    ...
    ngx_http_upstream_srv_conf_t * uscf)
{
	...
	for(peerp = &peers->peer; *peerp; peerp = &peer->next) {
		/* pool is unlocked */
		peer = (ngx_http_upstream_rr_peer_t *)ngx_slab_calloc_locked(shpool,
