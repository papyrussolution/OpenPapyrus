...
static ngx_int_t ngx_stream_ssl_preread_handler(ngx_stream_session_t * s)
{
	...
	sscf = (ngx_stream_ssl_preread_srv_conf_t *)ngx_stream_get_module_srv_conf(s, ngx_stream_ssl_preread_module);
	if(!sscf->enabled) {
		return NGX_DECLINED;
	}
...
{
	ngx_stream_ssl_preread_srv_conf_t * prev = (ngx_stream_ssl_preread_srv_conf_t *)parent;
	ngx_stream_ssl_preread_srv_conf_t * conf = (ngx_stream_ssl_preread_srv_conf_t *)child;
