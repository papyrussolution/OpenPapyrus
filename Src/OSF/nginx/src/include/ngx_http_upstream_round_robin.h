...
struct /*ngx_http_upstream_rr_peer_s*/ngx_http_upstream_rr_peer_t {
...
struct /*ngx_http_upstream_rr_peers_s*/ngx_http_upstream_rr_peers_t {
	ngx_uint_t number;
#if (NGX_HTTP_UPSTREAM_ZONE)
...
struct ngx_http_upstream_rr_peer_data_t {
	ngx_uint_t config;
