...
static bitset_bindex abitset_small_list(bitset src, bitset_bindex * list,
...
static void abitset_reset(bitset dst ATTRIBUTE_UNUSED,
...
static bool abitset_test(bitset src ATTRIBUTE_UNUSED,
	bitset_bindex bitno ATTRIBUTE_UNUSED)
{
...
/* Find list of up to NUM bits set in BSET in reverse order, starting
   ...
   stopped.  */
static bitset_bindex abitset_list_reverse(bitset src, bitset_bindex * list,
	bitset_bindex num, bitset_bindex * next)
{
	bitset_bindex bitno;
	...
	bitcnt = (unsigned int)(bitno%BITSET_WORD_BITS);
...
/* Find list of up to NUM bits set in BSET starting from and including
   *NEXT and store in array LIST.  Return with actual number of bits
   found and with *NEXT indicating where search stopped.  */
static bitset_bindex abitset_list(bitset src, bitset_bindex * list,
	bitset_bindex num, bitset_bindex * next)
{
	bitset_bindex bitno;
	bitset_bindex count;
...
static void abitset_unused_clear(bitset dst)
{
	unsigned int last_bit = (unsigned int)(BITSET_SIZE_(dst)%BITSET_WORD_BITS);
	if(last_bit)
