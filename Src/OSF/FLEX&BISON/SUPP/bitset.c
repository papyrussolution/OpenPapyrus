...
bool bitset_only_set_p(bitset src, bitset_bindex bitno)
{
	bitset_bindex val[2];
...
static void bitset_print(FILE * file, bitset bset, bool verbose)
{
	unsigned int pos;
	bitset_bindex i;
...
bool bitset_toggle_(bitset bset, bitset_bindex bitno)
{
...
/* DST = SRC.  Return true if DST != SRC.
   ...
   bitset types.  */
bool bitset_copy_(bitset dst, bitset src)
{
	bitset_bindex i;
	bitset_iterator iter;
...
/* DST = (SRC1 & SRC2) | SRC3.  Return non-zero if
   DST != (SRC1 & SRC2) | SRC3.  */
bool bitset_and_or_cmp_(bitset dst, bitset src1, bitset src2, bitset src3)
{
...
/* DST = (SRC1 & ~SRC2) | SRC3.  Return non-zero if
   DST != (SRC1 & ~SRC2) | SRC3.  */
bool bitset_andn_or_cmp_(bitset dst, bitset src1, bitset src2, bitset src3)
{
...
/* DST = (SRC1 | SRC2) & SRC3.  Return non-zero if
   DST != (SRC1 | SRC2) & SRC3.  */
bool bitset_or_and_cmp_(bitset dst, bitset src1, bitset src2, bitset src3)
{
