...
static lbitset_elt * lbitset_elt_alloc(void)
{
	lbitset_elt * elt;
...
static lbitset_elt * lbitset_elt_calloc(void)
{
	lbitset_elt * elt;
...
static void lbitset_elt_free(lbitset_elt * elt)
{
...
static void lbitset_elt_unlink(bitset bset, lbitset_elt * elt)
{
...
/* Cut the chain of bitset BSET before element ELT and free the
   elements.  */
static void lbitset_prune(bitset bset, lbitset_elt * elt)
{
	lbitset_elt * next;
...
static bool lbitset_elt_zero_p(lbitset_elt * elt)
{
	int i;
...
static void lbitset_elt_link(bitset bset, lbitset_elt * elt)
{
...
static void lbitset_weed(bitset bset)
{
	lbitset_elt * elt;
	lbitset_elt * next;
...
/* Is DST == SRC?  */
static bool lbitset_equal_p(bitset dst, bitset src)
{
	lbitset_elt * selt;
	lbitset_elt * delt;
	int j;
...
static void lbitset_copy(bitset dst, bitset src)
{
	lbitset_elt * elt;
	lbitset_elt * head;
	lbitset_elt * prev;
...
/* Copy bits from bitset SRC to bitset DST.  Return true if
   bitsets different.  */
static bool lbitset_copy_cmp(bitset dst, bitset src)
{
	if(src == dst)
		return false;
...
static void lbitset_unused_clear(bitset dst)
{
...
{
	return sizeof(bitset_union::lbitset_struct);
}
