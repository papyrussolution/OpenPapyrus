 ...
 */
static void flag_argmatch(const char * option,
 ...
 */
static void flags_argmatch(const char * option,
    const char * const keys[], const int values[],
...
void skeleton_arg(char const * arg, int prio, BFLocation loc)
{
...
static BFLocation command_line_location(void)
{
	BFLocation res;
