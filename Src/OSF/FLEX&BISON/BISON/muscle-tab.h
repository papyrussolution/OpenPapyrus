...
void muscle_code_grow (const char *key, const char *value, BFLocation loc);
...
void muscle_percent_define_insert (char const *variable, BFLocation variable_loc,
                                   muscle_kind kind,
                                   char const *value,
...
void muscle_percent_define_ensure (char const *variable, BFLocation variable_loc, bool value);
