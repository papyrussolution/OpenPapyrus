...
static vector_number state_number_to_vector_number(state_number s)
{
	return s;
}
...
static vector_number symbol_number_to_vector_number(symbol_number sym)
{
