...
#define NILCONSTANT     {NULL}, LUA_TNIL /* macro defining a nil value */
#define val_(o)         ((o)->value_)
#define rttype(o)       ((o)->tt_) /* raw type tag of a TValue */
#define novariant(x)    ((x) & 0x0F) /* tag with no variants (bits 0-3) */
#define ttype(o)        (rttype(o) & 0x3F) /* type tag of a TValue (bits 0-3 for tags + variant bits 4-5) */
#define ttnov(o)        (novariant(rttype(o))) /* type tag of a TValue with no variants (bits 0-3) */
/* Macros to test type */
...
#define settt_(o, t)     ((o)->tt_ = (t)) /* Macros to set values */
