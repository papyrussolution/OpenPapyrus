...
public:
	...
	LRESULT AddString(LPCTSTR s) 
	{
		return SendMsg(CB_ADDSTRING, 0, (LPARAM)s);
	}
  #ifndef _UNICODE
	...
	public:
		...
		{
			return LRESULTToBool(SendMsg(CBEM_SETUNICODEFORMAT, BOOLToBool(fUnicode), 0));
		}
		...
		{
			return (HIMAGELIST)SendMsg(CBEM_SETIMAGELIST, 0, (LPARAM)imageList);
		}
	};
#endif
}
