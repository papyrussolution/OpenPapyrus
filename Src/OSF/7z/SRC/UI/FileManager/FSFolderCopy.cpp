...
static DWORD CALLBACK CopyProgressRoutine(LARGE_INTEGER TotalFileSize,          // file size
...
struct CCopyState {
	...
	bool IsCallbackProgressError() {
		return ProgressInfo.ProgressResult != S_OK;
	}
};
...
static HRESULT CopyFile_Ask(CCopyState &state,
...
static HRESULT CopyFolder(CCopyState &state,
