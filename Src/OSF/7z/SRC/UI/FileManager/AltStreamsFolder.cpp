...
static HRESULT CopyStream(NFsFolder::CCopyStateIO &state,
	    ...
	    const wchar_t * path, IFolderOperationsExtractCallback * callback)
{
	...
	/*
	   ...
	   for (UInt32 i = 0; i < numItems; i++)
	   {
	    ...
	    RINOK(ExtractToStreamCallback->SetOperationResult7(NArchive::NExtract::NOperationResult::kOK,
	       BoolToInt(false))); // _encrypted
...
STDMETHODIMP CAltStreamsFolder::CopyFromFile(UInt32 /* index */, const wchar_t * /* fullFilePath */, IProgress * /*
	                                                                                                           progress
	                                                                                                           */          )
{
	return E_NOTIMPL;
