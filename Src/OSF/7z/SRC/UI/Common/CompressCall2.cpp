...
HRESULT CompressFiles(const UString &arcPathPrefix,
    ...
    bool email, bool showDialog, bool /* waitFinish */)
{
	...
	result = UpdateGUI(codecs, formatIndices, arcPath, censor, uo, showDialog, messageWasDisplayed, &callback, g_HWND);
	if(result != S_OK) {
