...
#define R(a, b, c, d, e, f, g, h, i) h += S1(e) + Ch(e, f, g) + K[(i)+(size_t)(j)] + (j ? blk2(i) : blk0(i)); d += h; h += S0(a) + Maj(a, b, c)
#define RX_8(i)	\
	R(a, b, c, d, e, f, g, h, i); R(h, a, b, c, d, e, f, g, i+1); R(g, h, a, b, c, d, e, f, i+2); \
	R(f, g, h, a, b, c, d, e, i+3);	R(e, f, g, h, a, b, c, d, i+4);	R(d, e, f, g, h, a, b, c, i+5);	\
	R(c, d, e, f, g, h, a, b, i+6);	R(b, c, d, e, f, g, h, a, i+7)
#define RX_16  RX_8(0); RX_8(8);
	...
	#define R(i) \
		...
		#define RX_16  RX_8(0); RX_8(8);
	#else
		#define RX_16  uint i; for(i = 0; i < 16; i++) { R(i); }
	#endif
#endif
