...
// So allow that.
#define S16_ISPOW2_NEG(denom) (denom==-2 || denom==-4 || denom==-8 || denom==-16 || denom==-32 || denom==-64 || denom==-128 || \
	denom==-256 || denom==-512 || denom==-1024 || denom==-2048 || denom==-4096 || denom==-8192 || denom==-16384)
#define S16_ISPOW2_POS(denom) (denom==2 || denom==4 || denom==8 || denom==16 || denom==32 || denom==64 || denom==128 || \
	denom==256 || denom==512 || denom==1024 || denom==2048 || denom==4096 || denom==8192 || denom==16384)
