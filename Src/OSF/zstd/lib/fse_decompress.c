...
FSE_DTable* FSE_createDTable(unsigned tableLog)
{
	...
	return (FSE_DTable*)SAlloc::M(FSE_DTABLE_SIZE_U32(tableLog) * sizeof(U32) );
}

void FSE_freeDTable(FSE_DTable* dt) { SAlloc::F(dt); }

static size_t FSE_buildDTable_internal(FSE_DTable* dt, const short* normalizedCounter, unsigned maxSymbolValue,
...
FORCE_INLINE_TEMPLATE size_t FSE_decompress_wksp_body(void* dst, size_t dstCapacity,
    const void* cSrc, size_t cSrcSize,
