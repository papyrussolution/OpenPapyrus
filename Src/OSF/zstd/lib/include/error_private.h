...
#define CHECK_V_F(e, f) const size_t e = f; if(ERR_isError(e)) return e
...
/*ERR_STATIC*/inline const char * ERR_getErrorName(size_t code) { return ERR_getErrorString(ERR_getErrorCode(code)); }
