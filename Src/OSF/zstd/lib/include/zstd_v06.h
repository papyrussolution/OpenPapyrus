...
/**
   ZSTDv06_findFrameSizeInfoLegacy() : get the source length and decompressed bound of a ZSTD frame compliant with
      v0.6.x format
...
// Error Management
//
ZSTDLIBv06_API uint ZSTDv06_isError(size_t code);          /*!< tells if a `size_t` function result is an error code */
...
// Tool functions
//
ZSTDLIBv06_API uint ZBUFFv06_isError(size_t errorCode);
