    ...
    ZSTD_dictContentType_e dictContentType, ZSTD_customMem customMem)
{
	...
	{   
	    ...
	    {   
			const size_t initResult = ZSTD_initDDict_internal(ddict, dict, dictSize, dictLoadMethod, dictContentType);
...
const ZSTD_DDict* ZSTD_initStaticDDict(void * sBuffer, size_t sBufferSize,
    ...
    ZSTD_dictContentType_e dictContentType)
{
	const size_t neededSpace = sizeof(ZSTD_DDict) + (dictLoadMethod == ZSTD_dlm_byRef ? 0 : dictSize);
