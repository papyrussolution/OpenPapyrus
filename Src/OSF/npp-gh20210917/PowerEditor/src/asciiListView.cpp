...
{
	switch(value) {
		case 0: return TEXT("NULL");
		case 1: return TEXT("SOH");
		case 2: return TEXT("STX");
		case 3: return TEXT("ETX");
		case 4: return TEXT("EOT");
		case 5: return TEXT("ENQ");
		case 6: return TEXT("ACK");
		case 7: return TEXT("BEL");
		case 8: return TEXT("BS");
		case 9: return TEXT("TAB");
		case 10: return TEXT("LF");
		case 11: return TEXT("VT");
		case 12: return TEXT("FF");
		case 13: return TEXT("CR");
		case 14: return TEXT("SO");
		case 15: return TEXT("SI");
		case 16: return TEXT("DLE");
		case 17: return TEXT("DC1");
		case 18: return TEXT("DC2");
		case 19: return TEXT("DC3");
		case 20: return TEXT("DC4");
		case 21: return TEXT("NAK");
		case 22: return TEXT("SYN");
		case 23: return TEXT("ETB");
		case 24: return TEXT("CAN");
		case 25: return TEXT("EM");
		case 26: return TEXT("SUB");
		case 27: return TEXT("ESC");
		case 28: return TEXT("FS");
		case 29: return TEXT("GS");
		case 30: return TEXT("RS");
		case 31: return TEXT("US");
		case 32: return TEXT("Space");
		case 127: return TEXT("DEL");
		default:
			{
				TCHAR charStr[10];
				char ascii[2];
...
generic_string AsciiListView::getHtmlName(uchar value)
{
	switch(value) {
		case 34: return TEXT("&quot;");
		case 38: return TEXT("&amp;");
		case 60: return TEXT("&lt;");
		case 62: return TEXT("&gt;");
		case 128: return TEXT("&euro;");
		case 160: return TEXT("&nbsp;");
		case 161: return TEXT("&iexcl;");
		case 162: return TEXT("&cent;");
		case 163: return TEXT("&pound;");
		case 164: return TEXT("&curren;");
		case 165: return TEXT("&yen;");
		case 166: return TEXT("&brvbar;");
		case 167: return TEXT("&sect;");
		case 168: return TEXT("&uml;");
		case 169: return TEXT("&copy;");
		case 170: return TEXT("&ordf;");
		case 171: return TEXT("&laquo;");
		case 172: return TEXT("&not;");
		case 173: return TEXT("&shy;");
		case 174: return TEXT("&reg;");
		case 175: return TEXT("&macr;");
		case 176: return TEXT("&deg;");
		case 177: return TEXT("&plusmn;");
		case 178: return TEXT("&sup2;");
		case 179: return TEXT("&sup3;");
		case 180: return TEXT("&acute;");
		case 181: return TEXT("&micro;");
		case 182: return TEXT("&para;");
		case 183: return TEXT("&middot;");
		case 184: return TEXT("&cedil;");
...
int AsciiListView::getHtmlNumber(uchar value)
{
	switch(value) {
...
void AsciiListView::setValues(int codepage)
{
	...
	for(int i = 0; i < 256; ++i) {
		...
		generic_string s = getAscii(static_cast<uchar>(i));
		...
		if(codepage == 0 || codepage == 1252) {
			if((i >= 32 && i <= 126) || (i >= 160 && i <= 255)) {
				...
				int n = getHtmlNumber(static_cast<uchar>(i));
				if(n > -1) {
