...
public:
	...
	TiXmlAttribute() : document(0), prev(0), next(0)
	{
	}
	#ifdef TIXML_USE_STL
	/// string constructor.
	TiXmlAttribute(const generic_string& _name, const generic_string& _value) : name(_name), value(_value), document(0), prev(0), next(0)
	{
	}
	#endif
...
public:
	...
	TiXmlHandle(TiXmlNode * pNode) : node(pNode)
	{
	}
	/// Copy constructor
