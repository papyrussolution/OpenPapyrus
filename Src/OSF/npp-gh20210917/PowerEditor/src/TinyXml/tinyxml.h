...
public:
	...
	static const TCHAR* ReadText(const TCHAR* in,                                   // where to start
	    TIXML_STRING* text,                                                                                 // the
	                                                                                                        // generic_string
	                                                                                                        // read
	    bool ignoreWhiteSpace,                                                                      // whether to
	                                                                                                // keep the
	                                                                                                // white space
	    const TCHAR* endTag,                                                                                // what
	                                                                                                        // ends
	                                                                                                        // this
	                                                                                                        // text
...
public:
	...
	TiXmlNode* FirstChild() const {
		return firstChild;
	}                                                               ///< The first child of this node. Will be null
	                                                                // if there are no children.

	TiXmlNode* FirstChild(const TCHAR * value) const;                       ///< The first child of this node with
	...
	TiXmlNode* LastChild(const TCHAR * value) const;                        /// The last child of this node matching
