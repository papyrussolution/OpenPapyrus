    ...
    WordList * keywordlists[], Accessor &styler)
{
	...
	//	For Harbour code, determines whether all preprocessor code is styled in the preprocessor style (0) or
	// only from the
	//	initial # to the end of the command word(1, the default). It also determines how to present text, dump,
	// and disabled code.
