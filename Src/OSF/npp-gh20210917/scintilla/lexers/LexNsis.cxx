...
static int classifyWordNsis(Sci_PositionU start, Sci_PositionU end, WordList * keywordLists[], Accessor &styler)
{
	...
	if(NsisCmp(s, "!macro", bIgnoreCase) == 0 || NsisCmp(s, "!macroend", bIgnoreCase) == 0)    // Covers !macro and
		                                                                                   // !macroend
		return SCE_NSIS_MACRODEF;

	if(NsisCmp(s, "!ifdef", bIgnoreCase) == 0 ||  NsisCmp(s, "!ifndef", bIgnoreCase) == 0 ||  NsisCmp(s, "!endif", bIgnoreCase) == 0)    // Covers
		                                                                                                                             // !ifdef,
		                                                                                                                             // !ifndef
		                                                                                                                             // and
		                                                                                                                             // !endif
