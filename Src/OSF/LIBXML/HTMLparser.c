 ...
 *         in case of error.
 */
static int FASTCALL htmlCheckParagraph(htmlParserCtxtPtr ctxt) 
{
	if(!ctxt)
		return -1;
	else {
 ...
 */
static htmlDocPtr FASTCALL htmlDoRead(htmlParserCtxtPtr ctxt, const char * URL, const char * encoding, int options, int reuse)
{
	htmlDocPtr ret;
