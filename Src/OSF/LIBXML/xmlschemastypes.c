...
#define DEBUG_DATE(dt)							\
	xmlGenericError(xmlGenericErrorContext, "type=%o %04ld-%02u-%02uT%02u:%02u:%03f",			    \
 ...
 *         number otherwise
 */
static int xmlSchemaValAtomicListNode(xmlSchemaTypePtr type, const xmlChar * value,
