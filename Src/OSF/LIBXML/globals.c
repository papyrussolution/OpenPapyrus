...
// 
// The bottom of this file is automatically generated by build_glob.py based on the description file global.data
...
#undef xmlRealloc
xmlReallocFunc * __xmlRealloc() { return IS_MAIN_THREAD ? (&xmlRealloc) : (&xmlGetGlobalState()->xmlRealloc); }
#undef free
xmlFreeFunc * __xmlFree() { return IS_MAIN_THREAD ? (&free) : (&xmlGetGlobalState()->free); }
xmlStrdupFunc * __xmlMemStrdup() { return IS_MAIN_THREAD ? (&xmlMemStrdup_Removed) : (&xmlGetGlobalState()->xmlMemStrdup_Removed); }
#endif
/*
