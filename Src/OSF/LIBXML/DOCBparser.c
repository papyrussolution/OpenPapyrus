	...
	const uchar * in ATTRIBUTE_UNUSED, int * inlen ATTRIBUTE_UNUSED, int quoteChar ATTRIBUTE_UNUSED)
{
	...
	if(!deprecated) {
		xmlGenericError(0, "docbEncodeEntities() deprecated function reached\n");
		deprecated = 1;
	}
	return -1;
}
...
int docbParseDocument(docbParserCtxtPtr ctxt ATTRIBUTE_UNUSED)
{
	static int deprecated = 0;
	if(!deprecated) {
		xmlGenericError(0, "docbParseDocument() deprecated function reached\n");
		deprecated = 1;
	}
...
void docbFreeParserCtxt(docbParserCtxtPtr ctxt ATTRIBUTE_UNUSED)
{
	static int deprecated = 0;
	if(!deprecated) {
		xmlGenericError(0, "docbFreeParserCtxt() deprecated function reached\n");
		deprecated = 1;
	}
...
docbParserCtxtPtr docbCreateFileParserCtxt(const char * filename ATTRIBUTE_UNUSED, const char * encoding ATTRIBUTE_UNUSED)
{
	static int deprecated = 0;
	if(!deprecated) {
		xmlGenericError(0, "docbCreateFileParserCtxt() deprecated function reached\n");
		deprecated = 1;
	}
    ...
    void * userData ATTRIBUTE_UNUSED)
{
	static int deprecated = 0;
	if(!deprecated) {
		xmlGenericError(0, "docbSAXParseFile() deprecated function reached\n");
		deprecated = 1;
	}
...
docbDocPtr docbParseFile(const char * filename ATTRIBUTE_UNUSED, const char * encoding ATTRIBUTE_UNUSED)
{
	static int deprecated = 0;
	if(!deprecated) {
		xmlGenericError(0, "docbParseFile() deprecated function reached\n");
		deprecated = 1;
	}
