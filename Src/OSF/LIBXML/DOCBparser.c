...
int docbEncodeEntities(uchar * out ATTRIBUTE_UNUSED, int * outlen ATTRIBUTE_UNUSED, 
	const uchar * in ATTRIBUTE_UNUSED, int * inlen ATTRIBUTE_UNUSED, int quoteChar ATTRIBUTE_UNUSED)
{
	static int deprecated = 0;
	if(!deprecated) {
		xmlGenericError(xmlGenericErrorContext, "docbEncodeEntities() deprecated function reached\n");
		deprecated = 1;
	}
	return -1;
}
...
int docbParseDocument(docbParserCtxtPtr ctxt ATTRIBUTE_UNUSED)
{
	static int deprecated = 0;
	if(!deprecated) {
		xmlGenericError(xmlGenericErrorContext, "docbParseDocument() deprecated function reached\n");
		deprecated = 1;
	}
...
void docbFreeParserCtxt(docbParserCtxtPtr ctxt ATTRIBUTE_UNUSED)
{
	static int deprecated = 0;
	if(!deprecated) {
		xmlGenericError(xmlGenericErrorContext, "docbFreeParserCtxt() deprecated function reached\n");
		deprecated = 1;
	}
...
int docbParseChunk(docbParserCtxtPtr ctxt ATTRIBUTE_UNUSED,
    const char * chunk ATTRIBUTE_UNUSED, int size ATTRIBUTE_UNUSED, int terminate ATTRIBUTE_UNUSED)
{
	static int deprecated = 0;
	if(!deprecated) {
		xmlGenericError(xmlGenericErrorContext, "docbParseChunk() deprecated function reached\n");
		deprecated = 1;
	}
 ...
 */
docbParserCtxtPtr docbCreatePushParserCtxt(docbSAXHandlerPtr sax ATTRIBUTE_UNUSED,
    ...
    void * userData ATTRIBUTE_UNUSED)
{
	...
	return (xmlSAXParseMemoryWithData(sax, (const char*)cur, xmlStrlen((const xmlChar*)cur), 0,  userData));
}
 ...
 * Returns the new parser context or NULL
 */
docbParserCtxtPtr docbCreateFileParserCtxt(const char * filename ATTRIBUTE_UNUSED, const char * encoding ATTRIBUTE_UNUSED)
{
	static int deprecated = 0;
	if(!deprecated) {
		xmlGenericError(xmlGenericErrorContext, "docbCreateFileParserCtxt() deprecated function reached\n");
		deprecated = 1;
	}
    ...
    void * userData ATTRIBUTE_UNUSED)
{
	static int deprecated = 0;
	if(!deprecated) {
		xmlGenericError(xmlGenericErrorContext, "docbSAXParseFile() deprecated function reached\n");
		deprecated = 1;
	}
...
docbDocPtr docbParseFile(const char * filename ATTRIBUTE_UNUSED, const char * encoding ATTRIBUTE_UNUSED)
{
	static int deprecated = 0;
	if(!deprecated) {
		xmlGenericError(xmlGenericErrorContext, "docbParseFile() deprecated function reached\n");
		deprecated = 1;
	}
