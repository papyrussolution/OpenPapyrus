 ...
 * Init/Cleanup
 */
XMLPUBFUN void XMLCALL xmlInitParser();
XMLPUBFUN void XMLCALL xmlCleanupParser();
 ...
 */
XMLPUBFUN xmlParserCtxtPtr XMLCALL xmlCreatePushParserCtxt(xmlSAXHandlerPtr sax,
    void * user_data,
    const char * chunk,
    int size,
    const char * filename);
