...
const char * skel[] = {
  ...
  "    // We will address this in a future release of flex, or omit the C++ scanner altogether.",
  ...
  "            do { \\",
  "                for(int yyl = n; yyl < yyleng; ++yyl)\\",
  "                    if(yytext[yyl] == '\\n')\\",
  "                        --yylineno;\\",
  "            } while(0)",
  "    #define YY_LINENO_REWIND_TO(dst) \\",
  "            do {\\",
  "                for(const char * p = yy_cp-1; p >= (dst); --p)\\",
  "                    if(*p == '\\n' )\\",
  "                        --yylineno;\\",
  "            } while(0)",
  "    ]],",
  ...
  " */",
  "#define YY_DO_BEFORE_ACTION YY_G(yytext_ptr) = yy_bp; \\",
  ...
  "    char * yy_full_match;",
  "    int    yy_lp;",
  "    // These are only needed for trailing context rules, but there's no conditional variable for that yet.",
  ...
  "dnl",
  "dnl  This code is derived from software contributed to Berkeley by Vern Paxson.",
  "dnl",
  ...
  "#endif",
  "",
  "/* Structures and prototypes for serializing flex tables. The binary format is documented in the manual.",
  " *",
  ...
  "        (((td_flags) & YYTD_DATA8) ? sizeof(flex_int8_t) : (((td_flags) & YYTD_DATA16) ? sizeof(flex_int16_t) : sizeof(flex_int32_t)))",
  "#endif",
  "",
  "#ifdef FLEX_SCANNER",
  "%not-for-header",
  ...
  "				YY_G(yy_c_buf_p) = &YY_CURRENT_BUFFER_LVALUE->yy_ch_buf[YY_G(yy_n_chars)];",
  "				yy_current_state = yy_get_previous_state( M4_YY_CALL_ONLY_ARG );",
  "				yy_cp = YY_G(yy_c_buf_p);",
  "				yy_bp = YY_G(yytext_ptr) + YY_MORE_ADJ;",
  "				goto yy_find_action;",
  ...
  "					yyrealloc( (void *) b->yy_ch_buf, (yy_size_t) (b->yy_buf_size + 2) M4_YY_CALL_LAST_ARG );",
  "				}",
  "			else",
  ...
  "		YY_CURRENT_BUFFER_LVALUE->yy_ch_buf = (char *)yyrealloc((void *)YY_CURRENT_BUFFER_LVALUE->yy_ch_buf, (yy_size_t)new_size M4_YY_CALL_LAST_ARG);",
  ...
  "",
  "",
  "		memzero(YY_G(yy_buffer_stack), num_to_alloc * sizeof(struct yy_buffer_state*));",
  "",
  ...
  "		memzero(YY_G(yy_buffer_stack) + YY_G(yy_buffer_stack_max), grow_size * sizeof(struct yy_buffer_state*));",
  "		YY_G(yy_buffer_stack_max) = num_to_alloc;",
  "	}",
  "}",
  "%endif",
  ...
  "		else",
  "			YY_G(yy_start_stack) = (int *) yyrealloc((void *)YY_G(yy_start_stack), new_size M4_YY_CALL_LAST_ARG);",
  "		if(!YY_G(yy_start_stack))",
  ...
  "        return -1;",
  "    }",
  "    if(yytbl_read32 (&(th->th_hsize), rd) != 0 || yytbl_read32 (&(th->th_ssize), rd) != 0 || yytbl_read16 (&(th->th_flags), rd) != 0)",
  "        return -1;",
  ...
  "    if(yytbl_read16 (&td.td_id, rd) != 0 || yytbl_read16 (&td.td_flags, rd) != 0 || yytbl_read32 (&td.td_hilen, rd) != 0 || yytbl_read32 (&td.td_lolen, rd) != 0)",
  "        return -1;",
  "    /* Lookup the map for the transition table so we have it in case we need it",
  "     * inside the loop below. This scanner might not even have a transition table, which is ok.",
  "     */",
  ...
  "    inner_loop_count = (td.td_flags & YYTD_STRUCT) ? 2 : 1",
  ...
  "                void * v = (j == 0) ? &(((struct yy_trans_info *) p)->yy_verify) : &(((struct yy_trans_info *) p)->yy_nxt);",
  "                switch(dmap->dm_sz) {",
  "                case sizeof (flex_int32_t):",
  "                    if(M4_YY_TABLES_VERIFY) {",
