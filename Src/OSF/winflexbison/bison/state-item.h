...
extern state_item * state_items; /** Array mapping state_item_numbers to state_items */
state_item * state_item_lookup(state_number s, state_item_number off);

static inline state_item_number state_item_index_lookup(state_number s, state_item_number off)
{
...
static inline bool state_item_list_next(gl_list_iterator_t * it, state_item ** si)
{
	const void * p = NULL;
