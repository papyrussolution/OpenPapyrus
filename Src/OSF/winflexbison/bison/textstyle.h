...
static inline void ostream_write_mem(ostream_t stream, const void * data, size_t len)
{
	if(len > 0)
		fwrite(data, 1, len, stream);
}

static inline void ostream_flush(ostream_t stream, ostream_flush_scope_t scope)
{
	fflush(stream);
	if(scope == FLUSH_ALL) {
...
static inline void ostream_free(ostream_t stream)
{
...
static inline void ostream_write_str(ostream_t stream, const char * string)
{
	ostream_write_mem(stream, string, strlen(string));
}

static inline ptrdiff_t ostream_printf(ostream_t stream, const char * format, ...)
...
static inline ptrdiff_t ostream_vprintf(ostream_t stream, const char * format, va_list args)
#if (__GNUC__ == 3 && __GNUC_MINOR__ >= 1) || __GNUC__ > 3
...
static inline void styled_ostream_begin_use_class(styled_ostream_t stream _GL_UNUSED, const char * classname _GL_UNUSED)
{
}

static inline void styled_ostream_end_use_class(styled_ostream_t stream _GL_UNUSED, const char * classname _GL_UNUSED)
{
}

static inline const char * styled_ostream_get_hyperlink_ref(styled_ostream_t stream _GL_UNUSED)
{
	return NULL;
}

static inline const char * styled_ostream_get_hyperlink_id(styled_ostream_t stream _GL_UNUSED)
{
	return NULL;
}

static inline void styled_ostream_set_hyperlink(styled_ostream_t stream _GL_UNUSED, const char * ref _GL_UNUSED, const char * id _GL_UNUSED)
{
}

static inline void styled_ostream_flush_to_current_style(styled_ostream_t stream _GL_UNUSED)
{
}
...
static inline file_ostream_t file_ostream_create(FILE * fp)
{
	return fp;
}
...
static inline fd_ostream_t fd_ostream_create(int fd, const char * filename _GL_UNUSED, bool buffered _GL_UNUSED)
{
	if(fd == 1)
		return stdout;
	else if(fd == 2)
...
static inline term_color_t term_ostream_get_color(term_ostream_t stream _GL_UNUSED)
{
	return COLOR_DEFAULT;
}

static inline void term_ostream_set_color(term_ostream_t stream _GL_UNUSED, term_color_t color _GL_UNUSED)
{
}

static inline term_color_t term_ostream_get_bgcolor(term_ostream_t stream _GL_UNUSED)
{
	return COLOR_DEFAULT;
}

static inline void term_ostream_set_bgcolor(term_ostream_t stream _GL_UNUSED, term_color_t color _GL_UNUSED)
{
}

static inline term_weight_t term_ostream_get_weight(term_ostream_t stream _GL_UNUSED)
{
	return WEIGHT_DEFAULT;
}

static inline void term_ostream_set_weight(term_ostream_t stream _GL_UNUSED, term_weight_t weight _GL_UNUSED)
{
}

static inline term_posture_t term_ostream_get_posture(term_ostream_t stream _GL_UNUSED)
{
	return POSTURE_DEFAULT;
}

static inline void term_ostream_set_posture(term_ostream_t stream _GL_UNUSED, term_posture_t posture _GL_UNUSED)
{
}

static inline term_underline_t term_ostream_get_underline(term_ostream_t stream _GL_UNUSED)
{
	return UNDERLINE_DEFAULT;
}

static inline void term_ostream_set_underline(term_ostream_t stream _GL_UNUSED, term_underline_t underline _GL_UNUSED)
{
}

static inline const char * term_ostream_get_hyperlink_ref(term_ostream_t stream _GL_UNUSED)
{
	return NULL;
}

static inline const char * term_ostream_get_hyperlink_id(term_ostream_t stream _GL_UNUSED)
{
	return NULL;
}

static inline void term_ostream_set_hyperlink(term_ostream_t stream _GL_UNUSED, const char * ref _GL_UNUSED, const char * id _GL_UNUSED)
{
}

static inline void term_ostream_flush_to_current_style(term_ostream_t stream)
{
	fflush(stream);
}
...
static inline term_ostream_t term_ostream_create(int fd, const char * filename, ttyctl_t tty_control _GL_UNUSED)
{
...
static inline term_styled_ostream_t term_styled_ostream_create(int fd, const char * filename,
    ttyctl_t tty_control _GL_UNUSED, const char * css_filename _GL_UNUSED)
{
	return fd_ostream_create(fd, filename, true);
}
...
static inline html_styled_ostream_t html_styled_ostream_create(ostream_t destination _GL_UNUSED, const char * css_filename _GL_UNUSED)
{
	abort();
	return NULL;
}
...
static inline bool handle_color_option(const char * option _GL_UNUSED)
{
	return false;
}

static inline void handle_style_option(const char * option _GL_UNUSED)
{
}

static inline void print_color_test(void)
{
	abort();
}

static inline void style_file_prepare(const char * style_file_envvar _GL_UNUSED, const char * stylesdir_envvar _GL_UNUSED,
    const char * stylesdir_after_install _GL_UNUSED, const char * default_style_file _GL_UNUSED)
{
}

/* ------------------------------ From misc.h ------------------------------ */

static inline styled_ostream_t styled_ostream_create(int fd, const char * filename, ttyctl_t tty_control _GL_UNUSED, const char * css_filename _GL_UNUSED)
{
	return fd_ostream_create(fd, filename, true);
}

static inline void libtextstyle_set_failure_exit_code(int exit_code _GL_UNUSED)
{
}
