/* Closures for Bison
   ...
   Copyright (C) 1984, 1989, 2000-2002, 2004-2005, 2007, 2009-2015, 2018-2020 Free Software Foundation, Inc.
...
{
	itemset = (item_index *)xnmalloc(n, sizeof *itemset);
	ruleset = bitset_create(nrules, BITSET_FIXED);
	set_fderives();
}

void closure(item_index const * core, size_t n)
{
