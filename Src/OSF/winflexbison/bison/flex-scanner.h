...
#define FLEX_VERSION ((YY_FLEX_MAJOR_VERSION) * 1000000 + (YY_FLEX_MINOR_VERSION) * 1000 + (YY_FLEX_SUBMINOR_VERSION))
...
/* Pacify "gcc -Wmissing-prototypes" when flex 2.5.31 is used.  */
	...
	int FLEX_PREFIX(get_lineno)();
	FILE * FLEX_PREFIX(get_in)();
	FILE * FLEX_PREFIX(get_out)();
	int FLEX_PREFIX(get_leng)();
	char * FLEX_PREFIX(get_text)();
	void FLEX_PREFIX(set_lineno)(int);
	void FLEX_PREFIX(set_in)(FILE *);
	void FLEX_PREFIX(set_out)(FILE *);
	int FLEX_PREFIX(get_debug)();
	void FLEX_PREFIX(set_debug)(int);
	int FLEX_PREFIX(lex_destroy)();
#endif
...
#define STRING_GROW()      obstack_grow(&obstack_for_string, yytext, yyleng)
#define STRING_FINISH()    (last_string = obstack_finish0(&obstack_for_string))
