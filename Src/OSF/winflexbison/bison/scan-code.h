 ...
 */
void code_props_rule_action_init(code_props * self, char const * code, Location code_loc, struct symbol_list * rule,
    named_ref * name, uniqstr type, bool is_predicate);
/**
 * \pre
