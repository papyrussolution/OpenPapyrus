...
/* The parser tables consist of these tables.
   ...
   YYTABLE = a vector filled with portions for different uses, found via YYPACT and YYPGOTO, described below.
   ...
   YYTABLE doesn't specify something else to do.  Zero means the default is an error.
...
extern base_number table_ninf; /* The value used in TABLE to denote explicit syntax errors (%nonassoc), a negative infinite.  */
