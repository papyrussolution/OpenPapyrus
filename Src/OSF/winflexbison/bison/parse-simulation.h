...
static inline bool parse_state_list_next(gl_list_iterator_t * it, parse_state ** ps)
{
	const void * p = NULL;
...
void parse_state_lists(parse_state * ps, state_item_list * state_items, derivation_list * derivs);
