...
/* Given an unsigned 16-bit argument X, return the value corresponding
   ...
   before shifting. */
static uint16_t rotl16(uint16_t x, int n) { return ((x << n) | (x >> (16 - n))) & UINT16_MAX; }
...
/* Given an unsigned 16-bit argument X, return the value corresponding
   ...
   because 'int' is at least 32 bits and the arguments must widen
   before shifting. */
static uint16_t rotr16(uint16_t x, int n) { return ((x >> n) | (x << (16 - n))) & UINT16_MAX; }
...
/* Given an unsigned 8-bit argument X, return the value corresponding
   ...
   because 'int' is at least 32 bits and the arguments must widen
   before shifting. */
static uint8_t rotl8(uint8_t x, int n) { return ((x << n) | (x >> (8 - n))) & UINT8_MAX; }
...
/* Given an unsigned 8-bit argument X, return the value corresponding
   ...
   because 'int' is at least 32 bits and the arguments must widen
   before shifting. */
static uint8_t rotr8(uint8_t x, int n) { return ((x >> n) | (x << (8 - n))) & UINT8_MAX; }
