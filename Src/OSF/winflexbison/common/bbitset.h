 ...
 */
enum bitset_type { BITSET_ARRAY, BITSET_LIST, BITSET_TABLE, BITSET_VARRAY, BITSET_TYPE_NUM, BITSET_STATS };
...
#define BITSET_CHECK2_(DST, SRC)  if(!BITSET_COMPATIBLE_(DST, SRC)) abort();
#define BITSET_CHECK3_(DST, SRC1, SRC2) if(!BITSET_COMPATIBLE_(DST, SRC1) || !BITSET_COMPATIBLE_(DST, SRC2)) abort();
#define BITSET_CHECK4_(DST, SRC1, SRC2, SRC3) if(!BITSET_COMPATIBLE_(DST, SRC1) || !BITSET_COMPATIBLE_(DST, SRC2) || !BITSET_COMPATIBLE_(DST, SRC3)) abort();
#define BITSET_RESIZE_(DST, SIZE) (DST)->b.vtable->resize(DST, SIZE) /* Redefine number of bits in bitset DST.  */
#define BITSET_SIZE_(SRC) (SRC)->b.vtable->size(SRC) /* Return size in bits of bitset SRC.  */
#define BITSET_COUNT_(SRC) (SRC)->b.vtable->count(SRC) /* Return number of bits set in bitset SRC.  */
#define BITSET_TYPE_(DST) (DST)->b.vtable->type /* Return type of bitset SRC.  */
#define BITSET_SET_(DST, BITNO) (DST)->b.vtable->set(DST, BITNO) /* Set bit BITNO in bitset DST.  */
#define BITSET_RESET_(DST, BITNO) (DST)->b.vtable->reset(DST, BITNO) /* Reset bit BITNO in bitset DST.  */
#define BITSET_TOGGLE_(DST, BITNO) (DST)->b.vtable->toggle(DST, BITNO) /* Toggle bit BITNO in bitset DST.  */
#define BITSET_TEST_(SRC, BITNO) (SRC)->b.vtable->test(SRC, BITNO) /* Return non-zero if bit BITNO in bitset SRC is set.  */
#define BITSET_FREE_(SRC) ((SRC)->b.vtable->free ? (SRC)->b.vtable->SAlloc::F(SRC) : (void)0) /* Free bitset SRC.  */
#define BITSET_EMPTY_P_(SRC) (SRC)->b.vtable->empty_p(SRC) /* Return SRC == 0.  */
#define BITSET_ONES_(DST) (DST)->b.vtable->ones(DST) /* DST = ~0.  */
#define BITSET_ZERO_(DST) (DST)->b.vtable->zero(DST) /* DST = 0.  */
#define BITSET_COPY_(DST, SRC) (SRC)->b.vtable->copy(DST, SRC) /* DST = SRC.  */
#define BITSET_DISJOINT_P_(DST, SRC) (SRC)->b.vtable->disjoint_p(DST, SRC) /* Return DST & SRC == 0.  */
#define BITSET_EQUAL_P_(DST, SRC) (SRC)->b.vtable->equal_p(DST, SRC) /* Return DST == SRC.  */
#define BITSET_NOT_(DST, SRC) (SRC)->b.vtable->not_(DST, SRC) /* DST = ~SRC.  */
#define BITSET_SUBSET_P_(DST, SRC) (SRC)->b.vtable->subset_p(DST, SRC) /* Return DST == DST | SRC.  */
#define BITSET_AND_(DST, SRC1, SRC2) (SRC1)->b.vtable->and_(DST, SRC1, SRC2) /* DST = SRC1 & SRC2.  */
#define BITSET_AND_CMP_(DST, SRC1, SRC2) (SRC1)->b.vtable->and_cmp(DST, SRC1, SRC2)
#define BITSET_ANDN_(DST, SRC1, SRC2) (SRC1)->b.vtable->andn(DST, SRC1, SRC2) /* DST = SRC1 & ~SRC2.  */
#define BITSET_ANDN_CMP_(DST, SRC1, SRC2) (SRC1)->b.vtable->andn_cmp(DST, SRC1, SRC2)
#define BITSET_OR_(DST, SRC1, SRC2) (SRC1)->b.vtable->or_(DST, SRC1, SRC2) /* DST = SRC1 | SRC2.  */
#define BITSET_OR_CMP_(DST, SRC1, SRC2) (SRC1)->b.vtable->or_cmp(DST, SRC1, SRC2)
#define BITSET_XOR_(DST, SRC1, SRC2) (SRC1)->b.vtable->xor_(DST, SRC1, SRC2) /* DST = SRC1 ^ SRC2.  */
...
#define BITSET_AND_OR_(DST, SRC1, SRC2, SRC3)     (SRC1)->b.vtable->and_or(DST, SRC1, SRC2, SRC3)
#define BITSET_AND_OR_CMP_(DST, SRC1, SRC2, SRC3) (SRC1)->b.vtable->and_or_cmp(DST, SRC1, SRC2, SRC3)
/* DST = (SRC1 & ~SRC2) | SRC3.  Return non-zero if DST != (SRC1 & ~SRC2) | SRC3.  */
#define BITSET_ANDN_OR_(DST, SRC1, SRC2, SRC3)     (SRC1)->b.vtable->andn_or(DST, SRC1, SRC2, SRC3)
#define BITSET_ANDN_OR_CMP_(DST, SRC1, SRC2, SRC3) (SRC1)->b.vtable->andn_or_cmp(DST, SRC1, SRC2, SRC3)
/* DST = (SRC1 | SRC2) & SRC3.  Return non-zero if DST != (SRC1 | SRC2) & SRC3.  */
#define BITSET_OR_AND_(DST, SRC1, SRC2, SRC3)     (SRC1)->b.vtable->or_and(DST, SRC1, SRC2, SRC3)
#define BITSET_OR_AND_CMP_(DST, SRC1, SRC2, SRC3) (SRC1)->b.vtable->or_and_cmp(DST, SRC1, SRC2, SRC3)

/* Find list of up to NUM bits set in BSET starting from and including
 * NEXT.  Return with actual number of bits found and with *NEXT
   indicating where search stopped.  */
#define BITSET_LIST_(BSET, LIST, NUM, NEXT) (BSET)->b.vtable->list(BSET, LIST, NUM, NEXT)

/* Find reverse list of up to NUM bits set in BSET starting from and
   including NEXT.  Return with actual number of bits found and with
 * NEXT indicating where search stopped.  */
#define BITSET_LIST_REVERSE_(BSET, LIST, NUM, NEXT) (BSET)->b.vtable->list_reverse(BSET, LIST, NUM, NEXT)
