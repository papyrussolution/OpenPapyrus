...
static_inline void * xnmalloc(size_t n, size_t s) _GL_ATTRIBUTE_MALLOC _GL_ATTRIBUTE_ALLOC_SIZE((1, 2));
...
static_inline void * xnrealloc(void * p, size_t n, size_t s) _GL_ATTRIBUTE_ALLOC_SIZE((2, 3));
...
static_inline void * x2nrealloc(void * p, size_t * pn, size_t s)
{
	size_t n = *pn;
	if(!p) {
		if(!n) {
...
static_inline char * xcharalloc(size_t n) _GL_ATTRIBUTE_MALLOC _GL_ATTRIBUTE_ALLOC_SIZE((1));
