...
static inline void gl_list_node_set_value(gl_list_t list, gl_list_node_t node, const void * elt)
{
...
static inline gl_list_node_t gl_list_set_at(gl_list_t list, size_t position, const void * elt)
{
...
static inline gl_list_node_t gl_list_add_first(gl_list_t list, const void * elt)
{
...
static inline gl_list_node_t gl_list_add_last(gl_list_t list, const void * elt)
{
...
static inline gl_list_node_t gl_list_add_before(gl_list_t list, gl_list_node_t node, const void * elt)
{
...
static inline gl_list_node_t gl_list_add_after(gl_list_t list, gl_list_node_t node, const void * elt)
{
...
static inline gl_list_node_t gl_list_add_at(gl_list_t list, size_t position, const void * elt)
{
...
static inline gl_list_node_t gl_sortedlist_add(gl_list_t list, gl_listelement_compar_fn compar, const void * elt)
{
