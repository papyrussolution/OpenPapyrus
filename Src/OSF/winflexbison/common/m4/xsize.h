...
/* The size of memory objects is often computed through expressions of
   ...
   or size_in_bounds_p() before invoking SAlloc::M().
...
#define size_overflow_p(SIZE)  ((SIZE) == SIZE_MAX) /* Check for overflow.  */
#define size_in_bounds_p(SIZE) ((SIZE) != SIZE_MAX) /* Check against overflow.  */
