...
static size_t node_position(gl_list_node_t node)
{
	size_t position = 0;
...
static int compare_by_position(const void * x1, const void * x2)
{
...
static bool compare_position_threshold(const void * x, const void * threshold)
{
...
static gl_list_node_t gl_oset_first(gl_oset_t set)
{
...
static int add_to_bucket(gl_list_t list, gl_list_node_t new_node)
{
...
static void remove_from_bucket(gl_list_t list, gl_list_node_t old_node)
{
...
static int add_nodes_to_buckets(gl_list_t list)
{
