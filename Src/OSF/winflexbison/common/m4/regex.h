...
struct re_pattern_buffer {
	...
	/* Pointer to a fastmap, if any, otherwise zero.  re_search uses the
	   fastmap, if there is one, to skip over impossible starting points for matches.  */
...
extern regoff_t re_match_2(struct re_pattern_buffer * __buffer, const char * __string1, __re_idx_t __length1, const char * __string2, __re_idx_t __length2,
    __re_idx_t __start, struct re_registers * __regs, __re_idx_t __stop);
...
/* Set REGS to hold NUM_REGS registers, storing them in STARTS and
   ...
   data.  */
extern void re_set_registers(struct re_pattern_buffer * __buffer, struct re_registers * __regs, __re_size_t __num_regs, regoff_t * __starts, regoff_t * __ends);
...
// mishandles gcc -ansi -pedantic.
	...
	#if ((199901L <= __STDC_VERSION__ || ((3 < __GNUC__ || (3 == __GNUC__ && 1 <= __GNUC_MINOR__)) && !__STRICT_ANSI__)) && !defined __GNUG__)
		#define _Restrict_arr_ _RESTRICT
	#else
...
/* POSIX compatibility.  */
extern int regcomp(regex_t * _RESTRICT __preg, const char * _RESTRICT __pattern, int __cflags);
extern int regexec(const regex_t * _RESTRICT __preg, const char * _RESTRICT __string, size_t __nmatch, regmatch_t __pmatch[_Restrict_arr_], int __eflags);
extern size_t regerror(int __errcode, const regex_t * _RESTRICT __preg, char * _RESTRICT __errbuf, size_t __errbuf_size);
