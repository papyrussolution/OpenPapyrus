...
static NODE_T rotate_left(NODE_T b_node, NODE_T d_node)
{
...
static NODE_T rotate_right(NODE_T b_node, NODE_T d_node)
{
...
static void rebalance_after_add(CONTAINER_T container, NODE_T node, NODE_T parent)
{
	for(;;) {
...
static void rebalance_after_remove(CONTAINER_T container, NODE_T child, NODE_T parent)
{
	for(;;) {
...
static NODE_T gl_tree_nx_add_first(CONTAINER_T container, NODE_PAYLOAD_PARAMS)
{
	/* Create new node.  */
	NODE_T new_node = (struct NODE_IMPL *)SAlloc::M(sizeof(struct NODE_IMPL));
	if(new_node == NULL)
		return NULL;
	new_node->left = NULL;
	new_node->right = NULL;
...
static void gl_tree_add_node_before(CONTAINER_T container, NODE_T node, NODE_T new_node)
{
	new_node->left = NULL;
	new_node->right = NULL;
...
static NODE_T gl_tree_nx_add_before(CONTAINER_T container, NODE_T node, NODE_PAYLOAD_PARAMS)
{
	/* Create new node.  */
	NODE_T new_node = (struct NODE_IMPL *)SAlloc::M(sizeof(struct NODE_IMPL));
	if(new_node == NULL)
...
static void gl_tree_add_node_after(CONTAINER_T container, NODE_T node, NODE_T new_node)
{
	new_node->left = NULL;
	new_node->right = NULL;
	/* Add it to the tree.  */
...
static NODE_T gl_tree_nx_add_after(CONTAINER_T container, NODE_T node, NODE_PAYLOAD_PARAMS)
{
	/* Create new node.  */
	NODE_T new_node = (struct NODE_IMPL *)SAlloc::M(sizeof(struct NODE_IMPL));
	if(new_node == NULL)
...
static void gl_tree_remove_node_no_free(CONTAINER_T container, NODE_T node)
{
...
static bool gl_tree_remove_node(CONTAINER_T container, NODE_T node)
{
