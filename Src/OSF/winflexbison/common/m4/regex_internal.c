...
static reg_errcode_t internal_function __attribute_warn_unused_result__ re_string_construct(re_string_t * pstr, const char * str, Idx len,
    RE_TRANSLATE_TYPE trans, bool icase, const re_dfa_t * dfa)
{
	reg_errcode_t ret;
	memzero(pstr, sizeof(re_string_t));
	re_string_construct_common(str, len, pstr, trans, icase, dfa);
	if(len > 0) {
...
internal_function __attribute_warn_unused_result__ build_wcs_upper_buffer(re_string_t * pstr)
{
	mbstate_t prev_st;
...
#ifdef RE_ENABLE_I18N
		if(pstr->mb_cur_max > 1)
			memzero(&pstr->cur_state, sizeof(mbstate_t));
#endif /* RE_ENABLE_I18N */
...
static reg_errcode_t
internal_function __attribute_warn_unused_result__ re_node_set_alloc(re_node_set * set, Idx size)
{
	set->alloc = size;
	set->nelem = 0;
...
static reg_errcode_t
internal_function __attribute_warn_unused_result__ re_node_set_init_2(re_node_set * set, Idx elem1, Idx elem2)
{
	set->alloc = 2;
...
static reg_errcode_t
internal_function __attribute_warn_unused_result__ re_node_set_init_copy(re_node_set * dest, const re_node_set * src)
{
...
static reg_errcode_t
internal_function __attribute_warn_unused_result__ re_node_set_add_intersect(re_node_set * dest, const re_node_set * src1,
...
static reg_errcode_t
internal_function __attribute_warn_unused_result__ re_node_set_init_union(re_node_set * dest, const re_node_set * src1,
    const re_node_set * src2)
{
	Idx i1, i2, id;
...
static reg_errcode_t
internal_function __attribute_warn_unused_result__ re_node_set_merge(re_node_set * dest, const re_node_set * src)
{
...
static bool
internal_function __attribute_warn_unused_result__ re_node_set_insert(re_node_set * set, Idx elem)
{
	Idx idx;
