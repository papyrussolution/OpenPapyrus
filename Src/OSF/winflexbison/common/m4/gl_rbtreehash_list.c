...
#include "gl_anyhash1.h" /* Generic hash-table code: Type definitions.  */
#include "gl_anyrbtree_list1.h" /* Generic red-black tree code: Type definitions.  */
/* Generic hash-table code: Low-level code.  */
#define CONTAINER_T gl_list_t
#define CONTAINER_COUNT(list) ((list)->root != NULL ? (list)->root->branch_size : 0)
#include "gl_anyhash2.h"
#include "gl_anytree_list1.h" /* Generic binary tree code: Type definitions.  */
#include "gl_anytreehash_list1.h" /* Hash-table with binary tree code: Handling of hash buckets.  */
#include "gl_anyrbtree_list2.h" /* Generic red-black tree code: Insertion/deletion algorithms.  */
#include "gl_anytreehash_list2.h" /* Generic binary tree code: Functions taking advantage of the hash table.  */
...
void gl_rbtreehash_list_check_invariants(gl_list_t list)
{
	if(list->root != NULL)
