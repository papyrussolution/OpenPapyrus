...
char * quotearg_style(enum quoting_style s, char const * arg); /* Equivalent to quotearg_n_style (0, S, ARG).  */
char * quotearg_style_mem(enum quoting_style s, char const * arg, size_t argsize); /* Equivalent to quotearg_n_style_mem (0, S, ARG, ARGSIZE).  */
/* Like quotearg (ARG), except also quote any instances of CH. See set_char_quoting for a description of acceptable CH values.  */
char * quotearg_char(char const * arg, char ch);

/* Like quotearg_char (ARG, CH), except it can quote null bytes.  */
char * quotearg_char_mem(char const * arg, size_t argsize, char ch);
char * quotearg_colon(char const * arg); /* Equivalent to quotearg_char (ARG, ':').  */
char * quotearg_colon_mem(char const * arg, size_t argsize); /* Like quotearg_colon (ARG), except it can quote null bytes.  */
...
/* Equivalent to quotearg_n_custom_mem (0, LEFT_QUOTE, RIGHT_QUOTE, ARG, ARGSIZE).  */
char * quotearg_custom_mem(char const * left_quote, char const * right_quote, char const * arg, size_t argsize);
void quotearg_free(void); /* Free any dynamically allocated memory.  */
