...
/* Summary:
   ...
   buffer, SAlloc::R()ating the buffer every time you try to read a symbol
...
struct obstack { /* control current object in current chunk */
	...
	struct _obstack_chunk *(* ChunkFunc) (void *, long);
	void (* FreeFunc)(void *, struct _obstack_chunk *);
...
extern int obstack_exit_failure; /* Exit value used when 'print_and_abort' is used.  */
...
#define obstack_alignment_mask(h) ((h)->alignment_mask) /* Mask specifying low bits that should be clear in address of an object.  */
...
#define obstack_specify_allocation_with_arg(h, size, alignment, chunkfun, freefun, arg) \
	_obstack_begin_1((h), (size), (alignment), (void *(*)(void *, long))(chunkfun), (void (*)(void *, void *))(freefun), (arg))
