...
/* You can set the DEFAULT_TEXT_DOMAIN macro to specify the domain used by
   ...
   textdomain(), and is useful for libraries.  */
	...
	#undef ngettext
	#define ngettext(Msgid1, Msgid2, N) ((N) == 1 ? ((void)(Msgid2), (const char*)(Msgid1)) : ((void)(Msgid1), (const char*)(Msgid2)))
	#undef dngettext
...
#ifdef DEFAULT_TEXT_DOMAIN
	#define pgettext(Msgctxt, Msgid) pgettext_aux(DEFAULT_TEXT_DOMAIN, Msgctxt GETTEXT_CONTEXT_GLUE Msgid, Msgid, LC_MESSAGES)
#else
...
#ifdef DEFAULT_TEXT_DOMAIN
	#define npgettext(Msgctxt, Msgid, MsgidPlural, N) npgettext_aux(DEFAULT_TEXT_DOMAIN, Msgctxt GETTEXT_CONTEXT_GLUE Msgid, Msgid, MsgidPlural, N, LC_MESSAGES)
#else
...
static const char * pgettext_aux(const char * domain, const char * msg_ctxt_id, const char * msgid, int category)
{
	...
	#endif
#endif
static const char * npgettext_aux(const char * domain, const char * msg_ctxt_id, const char * msgid, const char * msgid_plural, ulong n, int category)
{
...
#else
	char buf[1024];
	char * msg_ctxt_id = (msgctxt_len + msgid_len <= sizeof(buf) ? buf : (char *)SAlloc::M(msgctxt_len + msgid_len));
	if(msg_ctxt_id != NULL)
#endif
	{
...
#define dnpgettext_expr(Domainname, Msgctxt, Msgid, MsgidPlural, N) dcnpgettext_expr(Domainname, Msgctxt, Msgid, MsgidPlural, N, LC_MESSAGES)
	...
	#endif
#endif
static const char * dcnpgettext_expr(const char * domain, const char * msgctxt, const char * msgid, const char * msgid_plural, ulong n, int category)
{
	size_t msgctxt_len = strlen(msgctxt) + 1;
	size_t msgid_len = strlen(msgid) + 1;
	const char * translation;
