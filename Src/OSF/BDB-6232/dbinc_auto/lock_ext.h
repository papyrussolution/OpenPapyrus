...
int __lock_id_pp __P((DB_ENV *, uint32 *));
int  __lock_id __P((ENV *, uint32 *, DB_LOCKER **));
void __lock_set_thread_id __P((void *, pid_t, db_threadid_t));
int __lock_id_free_pp __P((DB_ENV *, uint32));
int  __lock_id_free __P((ENV *, DB_LOCKER *));
int __lock_id_set __P((ENV *, uint32, uint32));
int __lock_getlocker __P((DB_LOCKTAB *, uint32, int, DB_LOCKER **));
...
int __lock_get_lk_detect __P((DB_ENV *, uint32 *));
int __lock_set_lk_detect __P((DB_ENV *, uint32));
int __lock_get_lk_max_locks __P((DB_ENV *, uint32 *));
int __lock_set_lk_max_locks __P((DB_ENV *, uint32));
int __lock_get_lk_max_lockers __P((DB_ENV *, uint32 *));
int __lock_set_lk_max_lockers __P((DB_ENV *, uint32));
int __lock_get_lk_max_objects __P((DB_ENV *, uint32 *));
int __lock_set_lk_max_objects __P((DB_ENV *, uint32));
int __lock_get_lk_partitions __P((DB_ENV *, uint32 *));
int __lock_set_lk_partitions __P((DB_ENV *, uint32));
int __lock_get_lk_tablesize __P((DB_ENV *, uint32 *));
int __lock_set_lk_tablesize __P((DB_ENV *, uint32));
int __lock_set_lk_priority __P((DB_ENV *, uint32, uint32));
int __lock_get_lk_priority __P((DB_ENV *, uint32, uint32 *));
int __lock_get_env_timeout __P((DB_ENV *, db_timeout_t *, uint32));
int __lock_set_env_timeout __P((DB_ENV *, db_timeout_t, uint32));
int __lock_open __P((ENV *));
int __lock_env_refresh __P((ENV *));
int __lock_region_detach __P((ENV *, DB_LOCKTAB *));
uint32 __lock_region_mutex_count __P((ENV *));
uint32 __lock_region_mutex_max __P((ENV *));
...
int __lock_stat_print_pp __P((DB_ENV *, uint32));
int  __lock_stat_print __P((ENV *, uint32));
