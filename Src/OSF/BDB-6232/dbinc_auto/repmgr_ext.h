...
void __repmgr_handshake_marshal __P((ENV *, __repmgr_handshake_args *, uint8 *));
int __repmgr_handshake_unmarshal __P((ENV *, __repmgr_handshake_args *, uint8 *, size_t, uint8 **));
void __repmgr_v3handshake_marshal __P((ENV *, __repmgr_v3handshake_args *, uint8 *));
int __repmgr_v3handshake_unmarshal __P((ENV *, __repmgr_v3handshake_args *, uint8 *, size_t, uint8 **));
void __repmgr_v2handshake_marshal __P((ENV *, __repmgr_v2handshake_args *, uint8 *));
int __repmgr_v2handshake_unmarshal __P((ENV *, __repmgr_v2handshake_args *, uint8 *, size_t, uint8 **));
void __repmgr_parm_refresh_marshal __P((ENV *, __repmgr_parm_refresh_args *, uint8 *));
int __repmgr_parm_refresh_unmarshal __P((ENV *, __repmgr_parm_refresh_args *, uint8 *, size_t, uint8 **));
void __repmgr_permlsn_marshal __P((ENV *, __repmgr_permlsn_args *, uint8 *));
int __repmgr_permlsn_unmarshal __P((ENV *, __repmgr_permlsn_args *, uint8 *, size_t, uint8 **));
void __repmgr_version_proposal_marshal __P((ENV *, __repmgr_version_proposal_args *, uint8 *));
int __repmgr_version_proposal_unmarshal __P((ENV *, __repmgr_version_proposal_args *, uint8 *, size_t, uint8 **));
void __repmgr_version_confirmation_marshal __P((ENV *, __repmgr_version_confirmation_args *, uint8 *));
int __repmgr_version_confirmation_unmarshal __P((ENV *, __repmgr_version_confirmation_args *, uint8 *, size_t, uint8 **));
void __repmgr_msg_hdr_marshal __P((ENV *, __repmgr_msg_hdr_args *, uint8 *));
int __repmgr_msg_hdr_unmarshal __P((ENV *, __repmgr_msg_hdr_args *, uint8 *, size_t, uint8 **));
void __repmgr_msg_metadata_marshal __P((ENV *, __repmgr_msg_metadata_args *, uint8 *));
int __repmgr_msg_metadata_unmarshal __P((ENV *, __repmgr_msg_metadata_args *, uint8 *, size_t, uint8 **));
int __repmgr_membership_key_marshal __P((ENV *, __repmgr_membership_key_args *, uint8 *, size_t, size_t *));
int __repmgr_membership_key_unmarshal __P((ENV *, __repmgr_membership_key_args *, uint8 *, size_t, uint8 **));
void __repmgr_membership_data_marshal __P((ENV *, __repmgr_membership_data_args *, uint8 *));
int __repmgr_membership_data_unmarshal __P((ENV *, __repmgr_membership_data_args *, uint8 *, size_t, uint8 **));
void __repmgr_v4membership_data_marshal __P((ENV *, __repmgr_v4membership_data_args *, uint8 *));
int __repmgr_v4membership_data_unmarshal __P((ENV *, __repmgr_v4membership_data_args *, uint8 *, size_t, uint8 **));
void __repmgr_member_metadata_marshal __P((ENV *, __repmgr_member_metadata_args *, uint8 *));
int __repmgr_member_metadata_unmarshal __P((ENV *, __repmgr_member_metadata_args *, uint8 *, size_t, uint8 **));
int __repmgr_gm_fwd_marshal __P((ENV *, __repmgr_gm_fwd_args *, uint8 *, size_t, size_t *));
int __repmgr_gm_fwd_unmarshal __P((ENV *, __repmgr_gm_fwd_args *, uint8 *, size_t, uint8 **));
void __repmgr_membr_vers_marshal __P((ENV *, __repmgr_membr_vers_args *, uint8 *));
int __repmgr_membr_vers_unmarshal __P((ENV *, __repmgr_membr_vers_args *, uint8 *, size_t, uint8 **));
int __repmgr_site_info_marshal __P((ENV *, __repmgr_site_info_args *, uint8 *, size_t, size_t *));
int __repmgr_site_info_unmarshal __P((ENV *, __repmgr_site_info_args *, uint8 *, size_t, uint8 **));
int __repmgr_v4site_info_marshal __P((ENV *, __repmgr_v4site_info_args *, uint8 *, size_t, size_t *));
int __repmgr_v4site_info_unmarshal __P((ENV *, __repmgr_v4site_info_args *, uint8 *, size_t, uint8 **));
void __repmgr_connect_reject_marshal __P((ENV *, __repmgr_connect_reject_args *, uint8 *));
int __repmgr_connect_reject_unmarshal __P((ENV *, __repmgr_connect_reject_args *, uint8 *, size_t, uint8 **));
void __repmgr_v4connect_reject_marshal __P((ENV *, __repmgr_v4connect_reject_args *, uint8 *));
int __repmgr_v4connect_reject_unmarshal __P((ENV *, __repmgr_v4connect_reject_args *, uint8 *, size_t, uint8 **));
void __repmgr_lsnhist_match_marshal __P((ENV *, __repmgr_lsnhist_match_args *, uint8 *));
int __repmgr_lsnhist_match_unmarshal __P((ENV *, __repmgr_lsnhist_match_args *, uint8 *, size_t, uint8 **));
int __repmgr_member_print __P((ENV *, DBT *, DB_LSN *, db_recops, void *));
int __repmgr_init_print __P((ENV *, DB_DISTAB *));
int __repmgr_init_election __P((ENV *, uint32));
int __repmgr_claim_victory __P((ENV *));
int __repmgr_turn_on_elections __P((ENV *));
int __repmgr_start_pp __P((DB_ENV *, int, uint32));
int __repmgr_start_int __P((ENV *, int, uint32));
int __repmgr_valid_config __P((ENV *, uint32));
int __repmgr_prefmas_auto_config __P((DB_ENV *, uint32 *));
...
void __repmgr_set_incoming_queue_redzone __P((void *, uint32, uint32));
...
int __repmgr_send_msg __P((DB_CHANNEL *, DBT *, uint32, uint32));
int __repmgr_send_request __P((DB_CHANNEL *, DBT *, uint32, DBT *, db_timeout_t, uint32));
int __repmgr_send_response __P((DB_CHANNEL *, DBT *, uint32, uint32));
int __repmgr_channel_close __P((DB_CHANNEL *, uint32));
int __repmgr_channel_timeout __P((DB_CHANNEL *, db_timeout_t));
int __repmgr_send_request_inval __P((DB_CHANNEL *, DBT *, uint32, DBT *, db_timeout_t, uint32));
int __repmgr_channel_close_inval __P((DB_CHANNEL *, uint32));
...
int __repmgr_get_config __P((DB_SITE *, uint32, uint32 *));
int __repmgr_site_config_pp __P((DB_SITE *, uint32, uint32));
int __repmgr_site_config_int __P((DB_SITE *, uint32, uint32));
...
int __repmgr_update_membership __P((ENV *, DB_THREAD_INFO *, int, uint32, uint32));
int __repmgr_set_gm_version __P((ENV *, DB_THREAD_INFO *, DB_TXN *, uint32));
int __repmgr_setup_gmdb_op __P((ENV *, DB_THREAD_INFO *, DB_TXN **, uint32));
int __repmgr_cleanup_gmdb_op __P((ENV *, int));
int __repmgr_hold_master_role __P((ENV *, REPMGR_CONNECTION *, uint32));
...
int __repmgr_send __P((DB_ENV *, const DBT *, const DBT *, const DB_LSN *, int, uint32));
int __repmgr_sync_siteaddr __P((ENV *));
int __repmgr_send_broadcast __P((ENV *, u_int, const DBT *, const DBT *, uint *, uint *, int *));
...
int __repmgr_send_own_msg __P((ENV *, REPMGR_CONNECTION *, uint32, uint8 *, uint32));
...
int __repmgr_send_handshake __P((ENV *, REPMGR_CONNECTION *, void *, size_t, uint32));
...
int __repmgr_stat_print __P((ENV *, uint32));
...
int __repmgr_get_nsites __P((ENV *, uint32 *));
...
int __repmgr_repstart __P((ENV *, uint32, uint32));
int __repmgr_become_master __P((ENV *, uint32));
...
int __repmgr_send_sync_msg __P((ENV *, REPMGR_CONNECTION *, uint32, uint8 *, uint32));
int __repmgr_read_own_msg __P((ENV *, REPMGR_CONNECTION *, uint32 *, uint8 **, size_t *));
int __repmgr_prefmas_connected __P((ENV *));
int __repmgr_restart_site_as_client __P((ENV *, int));
int __repmgr_make_site_readonly_master __P((ENV *, int, uint32 *, DB_LSN *));
int __repmgr_lsnhist_match __P((ENV *, DB_THREAD_INFO *, int, int *));
int __repmgr_prefmas_get_wait __P((ENV *, uint32 *, u_long *));
int __repmgr_marshal_member_list __P((ENV *, uint32, uint8 **, size_t *));
int __repmgr_refresh_membership __P((ENV *, uint8 *, size_t, uint32));
int __repmgr_reload_gmdb __P((ENV *));
int __repmgr_gmdb_version_cmp __P((ENV *, uint32, uint32));
int __repmgr_init_save __P((ENV *, DBT *));
int __repmgr_init_restore __P((ENV *, DBT *));
int __repmgr_defer_op __P((ENV *, uint32));
...
int __repmgr_set_membership __P((ENV *, const char *, u_int, uint32, uint32));
int __repmgr_bcast_parm_refresh __P((ENV *));
int __repmgr_chg_prio __P((ENV *, uint32, uint32));
int __repmgr_bcast_own_msg __P((ENV *, uint32, uint8 *, size_t));
int __repmgr_bcast_member_list __P((ENV *));
int __repmgr_forward_single_write __P((uint32, DB *, DBT *, DBT *, uint32));
void __repmgr_msgdispatch __P((DB_ENV *, DB_CHANNEL *, DBT *, uint32, uint32));
