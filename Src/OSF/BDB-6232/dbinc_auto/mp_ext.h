...
int __memp_backup_open __P((ENV *, DB_MPOOLFILE *, const char *, const char *, uint32, DB_FH **, void**));
int __memp_backup_mpf __P((ENV *, DB_MPOOLFILE *, DB_THREAD_INFO *, db_pgno_t, db_pgno_t, DB_FH *, void *,  uint32));
...
void __memp_set_maxpgno __P((MPOOLFILE *, uint32, uint32));
...
int __memp_get_mp_pagesize __P((DB_ENV *, uint32 *));
int __memp_set_mp_pagesize __P((DB_ENV *, uint32));
int __memp_get_reg_dir __P((DB_ENV *, const char **));
int __memp_set_reg_dir __P((DB_ENV *, const char *));
int __memp_get_mp_tablesize __P((DB_ENV *, uint32 *));
int __memp_set_mp_tablesize __P((DB_ENV *, uint32));
int __memp_get_mp_mtxcount __P((DB_ENV *, uint32 *));
int __memp_set_mp_mtxcount __P((DB_ENV *, uint32));
...
int	__memp_init __P((ENV *, DB_MPOOL *, u_int, uint32, u_int));
uint32 __memp_max_regions __P((ENV *));
uint32 __memp_region_mutex_count __P((ENV *));
...
int __memp_stat_print_pp __P((DB_ENV *, uint32));
