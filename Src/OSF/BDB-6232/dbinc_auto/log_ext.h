...
uint32 __log_region_mutex_count __P((ENV *));
uint32 __log_region_mutex_max __P((ENV *));
...
void __log_set_version __P((ENV *, uint32));
...
int __log_get_lg_bsize __P((DB_ENV *, uint32 *));
int __log_set_lg_bsize __P((DB_ENV *, uint32));
int __log_get_lg_filemode __P((DB_ENV *, int *));
int __log_set_lg_filemode __P((DB_ENV *, int));
int __log_get_lg_max __P((DB_ENV *, uint32 *));
int __log_set_lg_max __P((DB_ENV *, uint32));
int __log_get_lg_regionmax __P((DB_ENV *, uint32 *));
int __log_set_lg_regionmax __P((DB_ENV *, uint32));
int __log_get_lg_dir __P((DB_ENV *, const char **));
int __log_set_lg_dir __P((DB_ENV *, const char *));
void __log_get_flags __P((DB_ENV *, uint32 *));
...
int __log_stat_print_pp __P((DB_ENV *, uint32));
int __log_stat_print __P((ENV *, uint32));
