...
int __db_needswap __P((uint32));
uint32 __db_compress_count_int __P((uint64));
int __db_compress_int __P((uint8 *, uint64));
uint32 __db_decompress_count_int __P((const uint8 *));
int __db_decompress_int __P((const uint8 *, uint64 *));
int __db_decompress_int32 __P((const uint8 *, uint32 *));
int __db_fchk __P((ENV *, const char *, uint32, uint32));
int __db_fcchk __P((ENV *, const char *, uint32, uint32, uint32));
...
int __db_unknown_flag __P((ENV *, char *, uint32));
...
int __db_rec_toobig __P((ENV *, uint32, uint32));
int __db_rec_repl __P((ENV *, uint32, uint32));
...
void __db_idspace __P((uint32 *, int, uint32 *, uint32 *));
uint32 __db_log2 __P((uint32));
uint32 __db_tablesize __P((uint32));
void __db_hashinit __P((void *, uint32));
...
int __db_util_cache __P((DB *, uint32 *, int *));
int __db_util_env_create __P((DB_ENV **, const char *, const char *, const char *));
int __db_util_env_open __P((DB_ENV *, const char *, int, int, int, uint32, int *));
...
int __db_zero_extend __P((ENV *, DB_FH *, db_pgno_t, db_pgno_t, uint32));
