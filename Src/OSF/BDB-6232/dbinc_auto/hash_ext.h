...
uint32 __ham_func6 __P((DB *, const void *, uint32));
...
void __ham_copy_config __P((const DB *, DB*, uint32));
...
int __ham_60_hashmeta __P((DB *, char *, uint32, DB_FH *, PAGE *, int *));
int __ham_60_hash __P((DB *, char *, uint32, DB_FH *, PAGE *, int *));
