...
int __txn_begin_pp __P((DB_ENV *, DB_TXN *, DB_TXN **, uint32));
int __txn_allocate __P((ENV *, DB_TXN **));
int __txn_begin __P((ENV *, DB_THREAD_INFO *, DB_TXN *, DB_TXN **, uint32));
int __txn_recycle_id __P((ENV *, int));
int __txn_continue __P((ENV *, DB_TXN *, TXN_DETAIL *, DB_THREAD_INFO *, int));
int __txn_commit __P((DB_TXN *, uint32));
int __txn_abort __P((DB_TXN *));
int __txn_discard_int __P((DB_TXN *, uint32 flags));
int __txn_prepare __P((DB_TXN *, uint8 *));
uint32 __txn_id __P((DB_TXN *));
int __txn_get_name __P((DB_TXN *, const char **));
int __txn_set_name __P((DB_TXN *, const char *));
int __txn_get_priority __P((DB_TXN *, uint32 *));
int __txn_set_priority __P((DB_TXN *, uint32));
int  __txn_set_timeout __P((DB_TXN *, db_timeout_t, uint32));
int __txn_activekids __P((ENV *, uint32, DB_TXN *));
int __txn_force_abort __P((ENV *, uint8 *));
int __txn_preclose __P((ENV *));
int __txn_reset __P((ENV *));
int __txn_applied_pp __P((DB_ENV *, DB_TXN_TOKEN *, db_timeout_t, uint32));
...
int __txn_checkpoint_pp __P((DB_ENV *, uint32, uint32, uint32));
int __txn_checkpoint __P((ENV *, uint32, uint32, uint32));
...
int __txn_get_tx_max __P((DB_ENV *, uint32 *));
int __txn_set_tx_max __P((DB_ENV *, uint32));
...
int __txn_recover_pp __P((DB_ENV *, DB_PREPLIST *, long, long *, uint32));
int __txn_recover __P((ENV *, DB_PREPLIST *, long, long *, uint32));
int __txn_get_prepared __P((ENV *, XID *, DB_PREPLIST *, long, long *, uint32));
...
uint32 __txn_region_mutex_count __P((ENV *));
uint32 __txn_region_mutex_max __P((ENV *));
size_t __txn_region_size __P((ENV *));
size_t __txn_region_max __P((ENV *));
int __txn_id_set __P((ENV *, uint32, uint32));
...
int __txn_stat_pp __P((DB_ENV *, DB_TXN_STAT **, uint32));
int __txn_stat_print_pp __P((DB_ENV *, uint32));
int  __txn_stat_print __P((ENV *, uint32));
int __txn_closeevent __P((ENV *, DB_TXN *, DB *));
int __txn_remevent __P((ENV *, DB_TXN *, const char *, uint8 *, int));
