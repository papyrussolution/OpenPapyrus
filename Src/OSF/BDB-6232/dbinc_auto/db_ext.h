...
void __db_copy_config __P((const DB *, DB *, uint32));
...
int __db_secondary_get __P((DB *, DB_TXN *, DBT *, DBT *, uint32));
...
int __db_dbbackup_pp __P((DB_ENV *, const char *, const char *, uint32));
int __db_dbbackup __P((DB_ENV *, DB_THREAD_INFO *, const char *, const char *, uint32, uint32, const char *));
int backup_data_copy __P(( DB_ENV *, const char *, const char *, const char *, int));
int __db_backup_pp __P((DB_ENV *, const char *, uint32));
int __dbc_close __P((DBC *));
int __dbc_destroy __P((DBC *));
int __dbc_cmp __P((DBC *, DBC *, int *));
int __dbc_count __P((DBC *, db_recno_t *));
int __dbc_del __P((DBC *, uint32));
int __dbc_idel __P((DBC *, uint32));
int __dbc_db_stream __P((DBC *, DB_STREAM **, uint32));
...
int __dbc_get __P((DBC *, DBT *, DBT *, uint32));
int __dbc_iget __P((DBC *, DBT *, DBT *, uint32));
int __dbc_put __P((DBC *, DBT *, DBT *, uint32));
int __dbc_iput __P((DBC *, DBT *, DBT *, uint32));
int __db_duperr __P((DB *, uint32));
int __dbc_cleanup __P((DBC *, DBC *, int));
int __dbc_secondary_get_pp __P((DBC *, DBT *, DBT *, uint32));
...
int __db_truncate_root __P((DBC *, PAGE *, uint32, db_pgno_t *, uint32, int *));
...
int __db_convert_pp __P((DB *, const char *, uint32));
int __db_convert __P((DB *, const char *, uint32));
...
int __db_open_arg __P((DB *, DB_TXN *, const char *, const char *, DBTYPE, uint32));
...
int __dbc_del_pp __P((DBC *, uint32));
int __dbc_dup_pp __P((DBC *, DBC **, uint32));
int __dbc_get_pp __P((DBC *, DBT *, DBT *, uint32));
int __dbc_get_arg __P((DBC *, DBT *, DBT *, uint32));
int __db_secondary_close_pp __P((DB *, uint32));
int __dbc_pget_pp __P((DBC *, DBT *, DBT *, DBT *, uint32));
int __dbc_put_pp __P((DBC *, DBT *, DBT *, uint32));
...
int __db_get_blob_threshold __P((DB *, uint32 *));
int __db_set_blob_threshold __P((DB *, uint32, uint32));
...
int __db_get_metaflags __P((ENV *, const char *, uint32 *));
int __db_reopen __P((DBC *));
int __db_alloc_dbt __P((ENV *, DBT *, uint32, uint32 *, uint32 *, void **, uint32 *));
...
int __db_moff __P((DBC *, const DBT *, db_pgno_t, uint32, int (*)(DB *, const DBT *, const DBT *, size_t *), int *, size_t *));
...
int __db_slice_open_pp __P((DB *, DB_TXN *, const char *, const char *, DBTYPE, uint32, int));
int __db_slice_alloc __P((DB *, DB_THREAD_INFO *, DB_TXN *));
int __db_slice_free __P((DB *, uint32));
...
int __db_slice_open __P((DB *, DB_THREAD_INFO *, DB_TXN *, const char *, DBTYPE, uint32, int));
int __db_slice_close_pp __P((DB *, uint32));
DB *__db_slice_iterate __P((DB *, int *));
int __db_slice_sync_pp __P((DB *, uint32));
int __db_slice_map __P((DB *, const DBT *, db_slice_t *));
int __db_slice_lookup_pp __P((DB *, const DBT *, DB **, uint32));
int __db_slice_build __P((const DB *, const DBT *, DBT *));
int __db_slice_activate __P((DB *, DB_TXN *, const DBT *, DB **, DB_TXN **));
int __db_slice_get_pp __P((DB *, DB_TXN *, DBT *, DBT *, uint32));
int __db_slice_exists_pp __P((DB *, DB_TXN *, DBT *, uint32));
int __db_slice_pget_pp __P((DB *, DB_TXN *, DBT *, DBT *, DBT *, uint32));
int __db_slice_put_pp __P((DB *, DB_TXN *, DBT *, DBT *, uint32));
int __db_slice_del_pp __P((DB *, DB_TXN *, DBT *, uint32));
int __db_slice_secondary_get_pp __P((DB *, DB_TXN *, DBT *, DBT *, uint32));
int __dbc_slice_init __P((DBC *));
int __dbc_slice_close __P((DBC *));
int __dbc_slice_activate __P((DBC *, const DBT *, DBC **, uint32));
int __dbc_slice_get_pp __P((DBC *, DBT *, DBT *, uint32));
int __dbc_slice_fetch_all __P((DBC *, DBT *, DBT *, DBT *, uint32));
int __dbc_slice_get_all_pp __P((DBC *, DBT *, DBT *, uint32));
int __dbc_slice_pget_pp __P((DBC *, DBT *, DBT *, DBT *, uint32));
int __dbc_slice_put_pp __P((DBC *, DBT *, DBT *, uint32));
int __dbc_slice_del_pp __P((DBC *, uint32));
int __db_slice_remove __P((DB_ENV *, DB_TXN *, const char *, const char *, uint32));
int __db_slice_associate __P((DB *, DB_TXN *, DB *, int (*)(DB *, const DBT *, const DBT *, DBT *), uint32));
int __db_slice_compact __P((DB *, DB_TXN *, DBT *, DBT *, DB_COMPACT *, uint32, DBT *));
int __db_slice_rename __P((DB *, DB_TXN *, const char *, const char *, const char *, uint32));
int __db_slice_truncate __P((DB *, DB_TXN *, uint32 *, uint32));
int __db_slice_process __P((DB *, const char *, uint32, int (*)(DB *, const char *, uint32), const char *));
int __dbc_slice_dump_get __P((DBC *, DBT *, DBT *, uint32));
int __db_slice_verify __P((DB *, const char *, const char *, void *, int (*)(void *, const void *), uint32));
...
int __db_page_pass __P((DB *, char *, uint32, int (* const []) (DB *, char *, uint32, DB_FH *, PAGE *, int *), DB_FH *, int));
...
int __partc_get __P((DBC*, DBT *, DBT *, uint32));
