...
#define SETPRECOMP(g, type, pre) g->pre_comp_type = ec_group_st::PCT_ ## type, g->pre_comp.type = pre
#define HAVEPRECOMP(g, type) g->pre_comp_type == ec_group_st::PCT_ ## type && g->pre_comp.type != NULL
