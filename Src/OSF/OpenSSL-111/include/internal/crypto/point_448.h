 ...
 */
__owur c448_bool_t curve448_point_eq(const curve448_point_t a, const curve448_point_t b);
/*
 ...
 * small subgroup.
 */
__owur c448_error_t x448_int(uint8_t out[X448_PUBLIC_BYTES], const uint8_t base[X448_PUBLIC_BYTES], const uint8_t scalar[X448_PRIVATE_BYTES]);
/*
 ...
 */
void curve448_point_mul_by_ratio_and_encode_like_x448(uint8_t out[X448_PUBLIC_BYTES],
 ...
 * scalar (in): The scalar to multiply by.
 */
void x448_derive_public_key(uint8_t out[X448_PUBLIC_BYTES], const uint8_t scalar[X448_PRIVATE_BYTES]);
/*
 ...
 * scalar (in): The scalar to multiply by.
 */
void curve448_precomputed_scalarmul(curve448_point_t scaled, const curve448_precomputed_s * base, const curve448_scalar_t scalar);
/*
