...
#define IDP_PRESENT     0x1 /* IDP present */
#define IDP_INVALID     0x2 /* IDP values inconsistent */
#define IDP_ONLYUSER    0x4 /* onlyuser true */
#define IDP_ONLYCA      0x8 /* onlyCA true */
#define IDP_ONLYATTR    0x10 /* onlyattr true */
#define IDP_INDIRECT    0x20 /* indirectCRL true */
#define IDP_REASONS     0x40 /* onlysomereasons present */
...
#define X509_CHECK_FLAG_NO_WILDCARDS    0x2 /* Disable wildcard matching for dnsName fields and common name. */
#define X509_CHECK_FLAG_NO_PARTIAL_WILDCARDS 0x4 /* Wildcards must not match a partial label. */
#define X509_CHECK_FLAG_MULTI_LABEL_WILDCARDS 0x8 /* Allow (non-partial) wildcards to match multiple labels. */
#define X509_CHECK_FLAG_SINGLE_LABEL_SUBDOMAINS 0x10 /* Constraint verifier subdomain patterns to match a single labels. */
#define X509_CHECK_FLAG_NEVER_CHECK_SUBJECT    0x20 /* Never check the subject CN */
/*
...
int X509V3_NAME_from_section(X509_NAME * nm, STACK_OF(CONF_VALUE) *dn_sk, ulong chtype);
