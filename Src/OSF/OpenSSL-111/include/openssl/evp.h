...
__owur int FASTCALL EVP_DigestFinal_ex(EVP_MD_CTX * ctx, unsigned char * md, unsigned int * s);
...
__owur int FASTCALL EVP_DigestFinal(EVP_MD_CTX * ctx, unsigned char * md, unsigned int * s);
