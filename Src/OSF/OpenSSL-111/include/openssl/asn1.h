...
#define DECLARE_ASN1_ENCODE_FUNCTIONS(type, itname, name) type *d2i_ ## name(type **a, const uchar ** in, long len); \
	int i2d_ ## name(type *a, uchar ** out); DECLARE_ASN1_ITEM(itname)
#define DECLARE_ASN1_ENCODE_FUNCTIONS_const(type, name) type *d2i_ ## name(type **a, const uchar ** in, long len); \
	int i2d_ ## name(const type *a, uchar ** out); DECLARE_ASN1_ITEM(name)
#define DECLARE_ASN1_NDEF_FUNCTION(name) int i2d_ ## name ## _NDEF(name *a, uchar ** out);
...
DEPRECATEDIN_1_1_0(uchar * ASN1_STRING_data(ASN1_STRING * x))
...
int ASN1_OCTET_STRING_set(ASN1_OCTET_STRING * str, const uchar * data,
    int len);
...
int ASN1_PRINTABLE_type(const uchar * s, int max);
...
#define M_ASN1_free_of(x, type) ASN1_item_free(static_cast<ASN1_VALUE *>(CHECKED_PTR_OF(type, x)), ASN1_ITEM_rptr(type))
...
#define ASN1_i2d_bio_of(type, i2d, out, x) (ASN1_i2d_bio(CHECKED_I2D_OF(type, i2d), out, static_cast<uchar *>(CHECKED_PTR_OF(type, x))))
#define ASN1_i2d_bio_of_const(type, i2d, out, x) (ASN1_i2d_bio(CHECKED_I2D_OF(const type, i2d), out, static_cast<uchar *>(CHECKED_PTR_OF(const type, x))))
...
int ASN1_buf_print(BIO * bp, const uchar * buf, size_t buflen, int off);
int ASN1_bn_print(BIO * bp, const char * number, const BIGNUM * num, uchar * buf, int off);
...
int ASN1_TYPE_get_octetstring(const ASN1_TYPE * a, uchar * data, int max_len);
int ASN1_TYPE_set_int_octetstring(ASN1_TYPE * a, long num, uchar * data, int len);
int ASN1_TYPE_get_int_octetstring(const ASN1_TYPE * a, long * num, uchar * data, int max_len);
...
int ASN1_mbstring_ncopy(ASN1_STRING ** out, const uchar * in, int len, int inform, ulong mask, long minsize, long maxsize);
ASN1_STRING * ASN1_STRING_set_by_NID(ASN1_STRING ** out, const uchar * in, int inlen, int inform, int nid);
ASN1_STRING_TABLE * ASN1_STRING_TABLE_get(int nid);
int ASN1_STRING_TABLE_add(int, long, long, ulong, ulong);
