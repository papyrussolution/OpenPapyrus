...
int OBJ_add_object(const ASN1_OBJECT * obj)
{
	...
	if((o = OBJ_dup(obj)) == NULL)
		goto err;
	if((ao[ADDED_NID] = static_cast<ADDED_OBJ *>(OPENSSL_malloc(sizeof(*ao[0])))) == NULL)
		goto err2;
	if((o->length != 0) && (obj->data != NULL))
		if((ao[ADDED_DATA] = static_cast<ADDED_OBJ *>(OPENSSL_malloc(sizeof(*ao[0])))) == NULL)
			goto err2;
	if(o->sn != NULL)
		if((ao[ADDED_SNAME] = static_cast<ADDED_OBJ *>(OPENSSL_malloc(sizeof(*ao[0])))) == NULL)
			goto err2;
	if(o->ln != NULL)
		if((ao[ADDED_LNAME] = static_cast<ADDED_OBJ *>(OPENSSL_malloc(sizeof(*ao[0])))) == NULL)
			goto err2;
