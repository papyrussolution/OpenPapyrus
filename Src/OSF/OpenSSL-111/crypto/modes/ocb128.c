...
static OCB_BLOCK * ocb_lookup_l(OCB128_CONTEXT * ctx, size_t idx)
{
	...
	if(idx >= ctx->max_l_index) {
		...
		if(tmp_ptr == NULL) /* prevent ctx->l from being clobbered */
			return NULL;
		ctx->l = static_cast<OCB_BLOCK *>(tmp_ptr);
	}
	while(l_index < idx) {
...
OCB128_CONTEXT * CRYPTO_ocb128_new(void * keyenc, void * keydec, block128_f encrypt, block128_f decrypt, ocb128_f stream)
{
	OCB128_CONTEXT * octx;
	int ret;
	if((octx = static_cast<OCB128_CONTEXT *>(OPENSSL_malloc(sizeof(*octx)))) != NULL) {
...
int CRYPTO_ocb128_init(OCB128_CONTEXT * ctx, void * keyenc, void * keydec, block128_f encrypt, block128_f decrypt, ocb128_f stream)
{
	...
	ctx->l_index = 0;
	ctx->max_l_index = 5;
	if((ctx->l = static_cast<OCB_BLOCK *>(OPENSSL_malloc(ctx->max_l_index * 16))) == NULL) {
...
int CRYPTO_ocb128_copy_ctx(OCB128_CONTEXT * dest, OCB128_CONTEXT * src, void * keyenc, void * keydec)
{
	...
	if(keydec)
		dest->keydec = keydec;
	if(src->l) {
		if((dest->l = static_cast<OCB_BLOCK *>(OPENSSL_malloc(src->max_l_index * 16))) == NULL) {
