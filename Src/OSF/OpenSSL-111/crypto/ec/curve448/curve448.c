...
void curve448_point_mul_by_ratio_and_encode_like_eddsa(uint8_t enc[EDDSA_448_PUBLIC_BYTES],
...
c448_error_t curve448_point_decode_like_eddsa_and_mul_by_ratio(curve448_point_t p,
