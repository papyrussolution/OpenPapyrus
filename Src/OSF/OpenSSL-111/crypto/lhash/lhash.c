...
{
	OPENSSL_LHASH * ret;
	if((ret = static_cast<OPENSSL_LHASH *>(OPENSSL_zalloc(sizeof(*ret)))) == NULL) {
		/*
	...
	if((ret->b = static_cast<OPENSSL_LH_NODE **>(OPENSSL_zalloc(sizeof(*ret->b) * MIN_NODES))) == NULL)
		goto err;
...
void * OPENSSL_LH_insert(OPENSSL_LHASH * lh, void * data)
{
	...
	if(*rn == NULL) {
		if((nn = static_cast<OPENSSL_LH_NODE *>(OPENSSL_malloc(sizeof(*nn)))) == NULL) {
			lh->error++;
			return NULL;
		}
		nn->data = data;
