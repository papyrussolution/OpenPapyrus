...
static const ERR_STRING_DATA ASYNC_str_functs[] = {
	...
	{ERR_PACK(ERR_LIB_ASYNC, ASYNC_F_ASYNC_INIT_THREAD, 0), "ASYNC_init_thread"},
	...
	{ERR_PACK(ERR_LIB_ASYNC, ASYNC_F_ASYNC_WAIT_CTX_SET_WAIT_FD, 0), "ASYNC_WAIT_CTX_set_wait_fd"},
	{0, NULL}
};
