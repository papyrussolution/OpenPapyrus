...
int SHA512_Final(uchar * md, SHA512_CTX * c)
{
	...
	memzero(p + n, sizeof(c->u) - 16 - n);
#ifdef  B_ENDIAN
	c->u.d[SHA_LBLOCK - 2] = c->Nh;
	c->u.d[SHA_LBLOCK - 1] = c->Nl;
#else
	p[sizeof(c->u) - 1] = (uchar)(c->Nl);
	p[sizeof(c->u) - 2] = (uchar)(c->Nl >> 8);
	p[sizeof(c->u) - 3] = (uchar)(c->Nl >> 16);
	p[sizeof(c->u) - 4] = (uchar)(c->Nl >> 24);
	p[sizeof(c->u) - 5] = (uchar)(c->Nl >> 32);
	p[sizeof(c->u) - 6] = (uchar)(c->Nl >> 40);
	p[sizeof(c->u) - 7] = (uchar)(c->Nl >> 48);
	p[sizeof(c->u) - 8] = (uchar)(c->Nl >> 56);
	p[sizeof(c->u) - 9] = (uchar)(c->Nh);
	p[sizeof(c->u) - 10] = (uchar)(c->Nh >> 8);
	p[sizeof(c->u) - 11] = (uchar)(c->Nh >> 16);
	p[sizeof(c->u) - 12] = (uchar)(c->Nh >> 24);
	p[sizeof(c->u) - 13] = (uchar)(c->Nh >> 32);
	p[sizeof(c->u) - 14] = (uchar)(c->Nh >> 40);
	p[sizeof(c->u) - 15] = (uchar)(c->Nh >> 48);
	p[sizeof(c->u) - 16] = (uchar)(c->Nh >> 56);
#endif
