...
{
	ENGINE * ret;
	if(!RUN_ONCE(&engine_lock_init, do_engine_lock_init) || (ret = static_cast<ENGINE *>(OPENSSL_zalloc(sizeof(*ret)))) == NULL) {
...
static ENGINE_CLEANUP_ITEM * int_cleanup_item(ENGINE_CLEANUP_CB * cb)
{
	...
	if((item = static_cast<ENGINE_CLEANUP_ITEM *>(OPENSSL_malloc(sizeof(*item)))) == NULL) {
