...
int ASN1_mbstring_ncopy(ASN1_STRING ** out, const uchar * in, int len,
    int inform, ulong mask,
    long minsize, long maxsize)
{
	...
	if((p = static_cast<uchar *>(OPENSSL_malloc(outlen + 1))) == NULL) {
		if(free_out)
