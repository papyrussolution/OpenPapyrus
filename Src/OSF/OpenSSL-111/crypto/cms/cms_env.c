    ...
    CMS_RecipientInfo * ri)
{
	...
	ek = static_cast<uchar *>(OPENSSL_malloc(eklen));
    ...
    CMS_RecipientInfo * ri)
{
	...
	wkey = static_cast<uchar *>(OPENSSL_malloc(ec->keylen + 8));
    ...
    CMS_RecipientInfo * ri)
{
	...
	ukey = static_cast<uchar *>(OPENSSL_malloc(kekri->encryptedKey->length - 8));
