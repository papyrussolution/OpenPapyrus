...
{
	if(X509at_add1_attr_by_OBJ(&si->signedAttrs, obj, type, static_cast<const uchar *>(bytes), len))
		return 1;
	return 0;
}
...
{
	if(X509at_add1_attr_by_NID(&si->signedAttrs, nid, type, static_cast<const uchar *>(bytes), len))
		return 1;
	return 0;
}
...
int CMS_signed_add1_attr_by_txt(CMS_SignerInfo * si,
    ...
    const void * bytes, int len)
{
	if(X509at_add1_attr_by_txt(&si->signedAttrs, attrname, type, static_cast<const uchar *>(bytes), len))
		return 1;
	return 0;
}
...
int CMS_unsigned_add1_attr_by_OBJ(CMS_SignerInfo * si,
    ...
    const void * bytes, int len)
{
	if(X509at_add1_attr_by_OBJ(&si->unsignedAttrs, obj, type, static_cast<const uchar *>(bytes), len))
		return 1;
	return 0;
}
...
int CMS_unsigned_add1_attr_by_NID(CMS_SignerInfo * si,
    ...
    const void * bytes, int len)
{
	if(X509at_add1_attr_by_NID(&si->unsignedAttrs, nid, type, static_cast<const uchar *>(bytes), len))
		return 1;
	return 0;
}
...
int CMS_unsigned_add1_attr_by_txt(CMS_SignerInfo * si,
    ...
    const void * bytes, int len)
{
	if(X509at_add1_attr_by_txt(&si->unsignedAttrs, attrname, type, static_cast<const uchar *>(bytes), len))
		return 1;
	return 0;
}
