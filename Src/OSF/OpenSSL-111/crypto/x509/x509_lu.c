...
{
	X509_LOOKUP * ret = static_cast<X509_LOOKUP *>(OPENSSL_zalloc(sizeof(*ret)));
	if(ret == NULL) {
...
{
	X509_STORE * ret = static_cast<X509_STORE *>(OPENSSL_zalloc(sizeof(*ret)));
	if(ret == NULL) {
...
{
	X509_OBJECT * ret = static_cast<X509_OBJECT *>(OPENSSL_zalloc(sizeof(*ret)));
	if(ret == NULL) {
