	...
	#define set_sys_error(e)        SetLastError(e)
        ...
        */
		...
		#include <malloc.h>
			...
			#if _MSC_VER>1310 && _MSC_VER<1600 // @sobolev (_MSC_VER>=1300)-->(_MSC_VER>1310)
				#undef stdin
				#undef stdout
				#undef stderr
				FILE * __iob_func();
			...
			#elif _MSC_VER<=1310 && defined(I_CAN_LIVE_WITH_LNK4049) // @sobolev (_MSC_VER<1300)-->(_MSC_VER<=1310)
				#undef stdin
				#undef stdout
				#undef stderr
				 /*
...
#if !defined(OPENSSL_NO_SECURE_MEMORY) && defined(OPENSSL_SYS_UNIX) && ( (defined(_POSIX_VERSION) && _POSIX_VERSION >= 200112L)      \
	|| defined(__sun) || defined(__hpux) || defined(__sgi) || defined(__osf__) )
