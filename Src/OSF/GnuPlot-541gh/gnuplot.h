...
//#include <gadgets.h>
	...
	struct GpView {
		GpView() : P_ClipArea(&BbPlot), XSize(1.0f), YSize(1.0f), ZSize(1.0f), XOffset(0.0f), YOffset(0.0f)
		{
			MEMSZERO(BbPlot);
			MEMSZERO(BbPage);
			MEMSZERO(BbCanvas);
...
//#include <plot2d.h>
	...
	text_label *store_label(struct text_label *, struct coordinate *, int i, char * string, double colorval);
