...
double GetColorValueFromFormula(int formula, double x)
{
	...
	switch(formula) {
		...
		case 9: x = sin(90 * x * SMathConst::PiDiv180); break;
		case 10: x = cos(90 * x * SMathConst::PiDiv180); break;
		case 11: x = fabs(x - 0.5); break;
		case 12: x = (2 * x - 1) * (2.0 * x - 1); break;
		case 13: x = sin(180 * x * SMathConst::PiDiv180); break;
		case 14: x = fabs(cos(180 * x * SMathConst::PiDiv180)); break;
		case 15: x = sin(360 * x * SMathConst::PiDiv180); break;
		case 16: x = cos(360 * x * SMathConst::PiDiv180); break;
		case 17: x = fabs(sin(360 * x * SMathConst::PiDiv180)); break;
		case 18: x = fabs(cos(360 * x * SMathConst::PiDiv180)); break;
		case 19: x = fabs(sin(720 * x * SMathConst::PiDiv180)); break;
		case 20: x = fabs(cos(720 * x * SMathConst::PiDiv180)); break;
		case 21: x = 3 * x; break;
