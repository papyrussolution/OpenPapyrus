...
void set_rgbcolor_var __PROTO((uint rgbvalue));
void set_rgbcolor_const __PROTO((uint rgbvalue));
...
void filled_polygon_3dcoords __PROTO((int points, GpCoordinate  coords));
/*
 ...
 */
void filled_polygon_3dcoords_zfixed __PROTO((int points, GpCoordinate  coords, double z));
/*
 ...
 */
void f_hsv2rgb __PROTO((GpArgument*));
