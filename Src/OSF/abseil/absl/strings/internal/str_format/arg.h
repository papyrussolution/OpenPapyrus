...
typename std::enable_if<std::is_enum<T>::value &&
    ...
    IntegralConvertResult>::type FormatConvertImpl(T v, FormatConversionSpecImpl conv, FormatSinkImpl* sink);
...
struct FormatCountCaptureHelper {
	...
	static ArgConvertResult<FormatConversionCharSetInternal::n> ConvertHelper(const FormatCountCapture& v,
	    FormatConversionSpecImpl conv,
	    FormatSinkImpl* sink) {
...
template <class T = int>
ArgConvertResult<FormatConversionCharSetInternal::n> FormatConvertImpl(const FormatCountCapture& v, FormatConversionSpecImpl conv,
    FormatSinkImpl* sink) {
