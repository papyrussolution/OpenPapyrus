...
template <>
inline void CordRepBtree::Add<CordRepBtree::kBack>(absl::Span<CordRep* const> edges) {
	AlignBegin();
	size_t new_end = end();
...
template <>
inline void CordRepBtree::Add<CordRepBtree::kFront>(absl::Span<CordRep* const> edges) {
	AlignEnd();
...
inline CordRepBtree::Position CordRepBtree::IndexBeyond(const size_t offset) const {
