...
public:
	...
	ExceptionSafetyTestBuilder<Factory, absl::decay_t<NewOperation>,
	    Contracts ...>WithOperation(const NewOperation& new_operation) const {
	...
	ExceptionSafetyTestBuilder<Factory, Operation, Contracts ...,
	    absl::decay_t<MoreContracts>...>WithContracts(const MoreContracts& ... more_contracts) const {
		return {
			       factory_, operation_,
