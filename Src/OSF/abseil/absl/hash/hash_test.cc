...
TEST(HashValueTest, Strings) {
	...
	EXPECT_TRUE(absl::VerifyTypeImplementsAbslHashCorrectly(std::make_tuple( //
		    ...
		    std::string(""), absl::string_view(""), absl::Cord(""), //
		    std::string(_small), absl::string_view(_small), absl::Cord(_small), //
	...
	EXPECT_TRUE(absl::VerifyTypeImplementsAbslHashCorrectly(std::make_tuple( //
		    ...
		    t(std::string("")), t(absl::string_view("")), t(absl::Cord("")), //
		    t(std::string(_small)), t(absl::string_view(_small)),     //
		    t(absl::Cord(_small)),                                   //
...
struct StructWithPadding {
	...
	template <typename H> friend H AbslHashValue(H hash_state, const StructWithPadding& s) { return H::combine(std::move(hash_state), s.c, s.i); }
};
...
struct ConvertibleFromNoOp {
	...
	template <typename H> friend H AbslHashValue(H hash_state, ConvertibleFromNoOp) { return H::combine(std::move(hash_state), 1); }
};
...
template <typename T> std::true_type HashOfExplicitParameter(decltype(absl::HashOf<T>(0))) { return {}; }
template <typename T> std::false_type HashOfExplicitParameter(size_t) { return {}; }
