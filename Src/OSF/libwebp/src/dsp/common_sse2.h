...
#if 0
//#include <stdio.h>
static FORCEINLINE void PrintReg(const __m128i r, const char* const name, int size) 
{
	int n;
	union {
		__m128i r;
...
static FORCEINLINE int VP8HorizontalAdd8b(const __m128i* const a) {
...
static FORCEINLINE void VP8Transpose_2_4x4_16b(const __m128i* const in0, const __m128i* const in1,
...
static FORCEINLINE void VP8PlanarTo24b_SSE2(__m128i* const in0, __m128i* const in1, __m128i* const in2,
...
static FORCEINLINE void VP8L32bToPlanar_SSE2(__m128i* const in0,
    __m128i* const in1,
    __m128i* const in2,
    __m128i* const in3) {
