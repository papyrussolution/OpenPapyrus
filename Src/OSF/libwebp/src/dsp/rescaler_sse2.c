...
static void LoadTwoPixels_SSE2(const uint8* const src, __m128i* out) {
...
static void LoadEightPixels_SSE2(const uint8* const src, __m128i* out) {
	const __m128i zero = _mm_setzero_si128();
	const __m128i A = _mm_loadl_epi64((const __m128i*)(src)); // ABCDEFGH
...
static FORCEINLINE void LoadDispatchAndMult_SSE2(const rescaler_t* const src,
...
static FORCEINLINE void ProcessRow_SSE2(const __m128i* const A0,
