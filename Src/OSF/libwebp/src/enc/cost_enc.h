...
static FORCEINLINE int VP8RecordStats(int bit, proba_t* const stats) {
	proba_t p = *stats;
...
static FORCEINLINE int VP8BitCost(int bit, uint8 proba) {
...
static FORCEINLINE int VP8LevelCost(const uint16_t* const table, int level) {
