...
// 'dec_options' object.
static FORCEINLINE int WebPAnimDecoderOptionsInit(WebPAnimDecoderOptions* dec_options) 
{
...
static FORCEINLINE WebPAnimDecoder* WebPAnimDecoderNew(const WebPData* webp_data, const WebPAnimDecoderOptions* dec_options) 
{
...
WEBP_EXTERN int WebPAnimDecoderGetNext(WebPAnimDecoder* dec, uint8** buf, int* timestamp);
