 ...
 */
LIBSSH_API const char *sftp_extensions_get_name(sftp_session sftp, uint indexn);
 ...
 */
LIBSSH_API const char *sftp_extensions_get_data(sftp_session sftp, uint indexn);
...
LIBSSH_API uint8 sftp_client_message_get_type(sftp_client_message msg);
