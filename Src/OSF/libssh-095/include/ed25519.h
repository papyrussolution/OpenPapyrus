...
typedef uint8 ed25519_pubkey[ED25519_PK_LEN];
typedef uint8 ed25519_privkey[ED25519_SK_LEN];
typedef uint8 ed25519_signature[ED25519_SIG_LEN];
 ...
 * @return    0 on success.
 */
int crypto_sign_ed25519(uchar *sm, uint64_t *smlen, const uchar *m, uint64_t mlen, const ed25519_privkey sk);
 ...
 */
int crypto_sign_ed25519_open(uchar *m, uint64_t *mlen, const uchar *sm, uint64_t smlen, const ed25519_pubkey pk);
