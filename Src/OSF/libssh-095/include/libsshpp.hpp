...
public:
	 ...
	 */
	int userauthKbdintSetAnswer(uint index, const char * answer)
	{
...
public:
	...
	int openForward(const char * remotehost, int remoteport, const char * sourcehost = NULL, int localport = 0)
	{
