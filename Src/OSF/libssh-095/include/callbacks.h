 ...
 */
typedef int (* ssh_packet_callback) (ssh_session session, uint8 type, ssh_buffer packet, void * user);
...
#define SSH_PACKET_CALLBACK(name) \
	int name(ssh_session session, uint8 type, ssh_buffer packet, void * user)

struct ssh_packet_callbacks_struct {
	uint8 start; /** Index of the first packet type being handled */
	uint8 n_callbacks; /** Number of packets being handled by this callback struct */
	ssh_packet_callback * callbacks; /** A pointer to n_callbacks packet callbacks */
	void * user; /** User-provided data. User is free to set anything he wants here */
};
...
typedef ulong (* ssh_thread_id_callback)();
 ...
 */
LIBSSH_API struct ssh_threads_callbacks_struct * ssh_threads_get_default();
/**
 ...
 * @see ssh_threads_set_callbacks
 */
LIBSSH_API struct ssh_threads_callbacks_struct * ssh_threads_get_pthread();
 ...
 * @see ssh_threads_set_callbacks
 */
LIBSSH_API struct ssh_threads_callbacks_struct * ssh_threads_get_noop();
 ...
 */
LIBSSH_API ssh_logging_callback ssh_get_log_callback();
