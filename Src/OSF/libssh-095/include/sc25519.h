...
void sc25519_from32bytes(sc25519 * r, const uchar x[32]);
void shortsc25519_from16bytes(shortsc25519 * r, const uchar x[16]);
void sc25519_from64bytes(sc25519 * r, const uchar x[64]);
void sc25519_from_shortsc(sc25519 * r, const shortsc25519 * x);
void sc25519_to32bytes(uchar r[32], const sc25519 * x);
...
void sc25519_2interleave2(uchar r[127], const sc25519 * s1, const sc25519 * s2);
