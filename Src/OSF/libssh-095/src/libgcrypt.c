...
void sha256_update(SHACTX c, const void * data, ulong len) 
{
	gcry_md_write(c, data, len);
}

void sha256_final(uchar * md, SHACTX c) {
	gcry_md_final(c);
...
void sha384_update(SHACTX c, const void * data, ulong len) 
{
	gcry_md_write(c, data, len);
}

void sha384_final(uchar * md, SHACTX c) 
{
	gcry_md_final(c);
...
void sha512_update(SHACTX c, const void * data, ulong len) {
	gcry_md_write(c, data, len);
}

void sha512_final(uchar * md, SHACTX c) {
	gcry_md_final(c);
...
static void blowfish_encrypt(struct ssh_cipher_struct * cipher, void * in, void * out, ulong len) 
{
	gcry_cipher_encrypt(cipher->key[0], out, len, in, len);
}

static void blowfish_decrypt(struct ssh_cipher_struct * cipher, void * in, void * out, ulong len) 
{
...
static void aes_encrypt(struct ssh_cipher_struct * cipher, void * in, void * out, size_t len)
{
	gcry_cipher_encrypt(cipher->key[0], out, len, in, len);
}

static void aes_decrypt(struct ssh_cipher_struct * cipher, void * in, void * out, size_t len)
{
	gcry_cipher_decrypt(cipher->key[0], out, len, in, len);
}

static int aes_aead_get_length(struct ssh_cipher_struct * cipher, void * in, uint8 * out, size_t len, uint64_t seq)
{
	(void)cipher;
	(void)seq;
...
static void aes_gcm_encrypt(struct ssh_cipher_struct * cipher, void * in, void * out, size_t len, uint8 * tag, uint64_t seq)
{
	gpg_error_t err;
	...
	/* increment IV */
	err = gcry_cipher_setiv(cipher->key[0], cipher->last_iv, AES_GCM_IVLEN);
...
static int aes_gcm_decrypt(struct ssh_cipher_struct * cipher, void * complete_packet, uint8 * out,
...
static void des3_encrypt(struct ssh_cipher_struct * cipher, void * in, void * out, ulong len) 
{
	gcry_cipher_encrypt(cipher->key[0], out, len, in, len);
}

static void des3_decrypt(struct ssh_cipher_struct * cipher, void * in, void * out, ulong len)
{
	gcry_cipher_decrypt(cipher->key[0], out, len, in, len);
}
