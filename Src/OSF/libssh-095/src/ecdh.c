...
static ssh_packet_callback ecdh_client_callbacks[] = { ssh_packet_client_ecdh_reply };
struct ssh_packet_callbacks_struct ssh_ecdh_client_callbacks = { SSH2_MSG_KEX_ECDH_REPLY, 1, ecdh_client_callbacks, NULL };
...
static ssh_packet_callback ecdh_server_callbacks[] = { ssh_packet_server_ecdh_init };
struct ssh_packet_callbacks_struct ssh_ecdh_server_callbacks = { SSH2_MSG_KEX_ECDH_INIT, 1, ecdh_server_callbacks, NULL };
