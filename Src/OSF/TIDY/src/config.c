...
/* parser for 't'/'f', 'true'/'false', 'y'/'n', 'true'/'false' or '1'/'0' */
static ParseProperty ParseBool;

/* parser for 't'/'f', 'true'/'false', 'y'/'n', 'true'/'false', '1'/'0'
   or 'auto' */
...
{
	{ TidyUnknownOption,           MS, "unknown!",                    TIDYINT, 0,               NULL,              NULL            },
	{ TidyIndentSpaces,            PP, "indent-spaces",               TIDYINT, 2,               ParseInt,          NULL            },
	{ TidyWrapLen,                 PP, "wrap",                        TIDYINT, 68,              ParseInt,          NULL            },
	{ TidyTabSize,                 PP, "tab-size",                    TIDYINT, 8,               ParseInt,          NULL            },
	{ TidyCharEncoding,            CE, "char-encoding",               TIDYINT, ASCII,           ParseCharEnc,      charEncPicks    },
	{ TidyInCharEncoding,          CE, "input-encoding",              TIDYINT, LATIN1,          ParseCharEnc,      charEncPicks    },
	{ TidyOutCharEncoding,         CE, "output-encoding",             TIDYINT, ASCII,           ParseCharEnc,      charEncPicks    },
	{ TidyNewline,                 CE, "newline",                     TIDYINT, DLF,             ParseNewline,      newlinePicks    },
	{ TidyDoctypeMode,             MU, "doctype-mode",                TIDYINT, TidyDoctypeAuto, NULL,              doctypePicks    },
	{ TidyDoctype,                 MU, "doctype",                     ST, 0,               ParseDocType,      doctypePicks    },
	{ TidyDuplicateAttrs,          MU, "repeated-attributes",         TIDYINT, TidyKeepLast,    ParseRepeatAttr,   repeatAttrPicks },
	...
	{ TidyWriteBack,               MS, "write-back",                  BL, false,              ParseBool,         boolPicks       },
	{ TidyShowMarkup,              PP, "markup",                      BL, true,             ParseBool,         boolPicks       },
	{ TidyShowWarnings,            DG, "show-warnings",               BL, true,             ParseBool,         boolPicks       },
	{ TidyQuiet,                   MS, "quiet",                       BL, false,              ParseBool,         boolPicks       },
	{ TidyIndentContent,           PP, "indent",                      TIDYINT, TidyNoState,     ParseAutoBool,     autoBoolPicks   },
	{ TidyHideEndTags,             MU, "hide-endtags",                BL, false,              ParseBool,         boolPicks       },
	{ TidyXmlTags,                 MU, "input-xml",                   BL, false,              ParseBool,         boolPicks       },
	{ TidyXmlOut,                  MU, "output-xml",                  BL, false,              ParseBool,         boolPicks       },
	{ TidyXhtmlOut,                MU, "output-xhtml",                BL, false,              ParseBool,         boolPicks       },
	{ TidyHtmlOut,                 MU, "output-html",                 BL, false,              ParseBool,         boolPicks       },
	{ TidyXmlDecl,                 MU, "add-xml-decl",                BL, false,              ParseBool,         boolPicks       },
	{ TidyUpperCaseTags,           MU, "uppercase-tags",              BL, false,              ParseBool,         boolPicks       },
	{ TidyUpperCaseAttrs,          MU, "uppercase-attributes",        BL, false,              ParseBool,         boolPicks       },
	{ TidyMakeBare,                MU, "bare",                        BL, false,              ParseBool,         boolPicks       },
	{ TidyMakeClean,               MU, "clean",                       BL, false,              ParseBool,         boolPicks       },
	{ TidyLogicalEmphasis,         MU, "logical-emphasis",            BL, false,              ParseBool,         boolPicks       },
	{ TidyDropPropAttrs,           MU, "drop-proprietary-attributes", BL, false,              ParseBool,         boolPicks       },
	{ TidyDropFontTags,            MU, "drop-font-tags",              BL, false,              ParseBool,         boolPicks       },
	{ TidyDropEmptyParas,          MU, "drop-empty-paras",            BL, true,             ParseBool,         boolPicks       },
	{ TidyFixComments,             MU, "fix-bad-comments",            BL, true,             ParseBool,         boolPicks       },
	{ TidyBreakBeforeBR,           PP, "break-before-br",             BL, false,              ParseBool,         boolPicks       },

	/* obsolete */
	{ TidyBurstSlides,             PP, "split",                       BL, false,              ParseBool,         boolPicks       },

	{ TidyNumEntities,             MU, "numeric-entities",            BL, false,              ParseBool,         boolPicks       },
	{ TidyQuoteMarks,              MU, "quote-marks",                 BL, false,              ParseBool,         boolPicks       },
	{ TidyQuoteNbsp,               MU, "quote-nbsp",                  BL, true,             ParseBool,         boolPicks       },
	{ TidyQuoteAmpersand,          MU, "quote-ampersand",             BL, true,             ParseBool,         boolPicks       },
	{ TidyWrapAttVals,             PP, "wrap-attributes",             BL, false,              ParseBool,         boolPicks       },
	{ TidyWrapScriptlets,          PP, "wrap-script-literals",        BL, false,              ParseBool,         boolPicks       },
	{ TidyWrapSection,             PP, "wrap-sections",               BL, true,             ParseBool,         boolPicks       },
	{ TidyWrapAsp,                 PP, "wrap-asp",                    BL, true,             ParseBool,         boolPicks       },
	{ TidyWrapJste,                PP, "wrap-jste",                   BL, true,             ParseBool,         boolPicks       },
	{ TidyWrapPhp,                 PP, "wrap-php",                    BL, true,             ParseBool,         boolPicks       },
	{ TidyFixBackslash,            MU, "fix-backslash",               BL, true,             ParseBool,         boolPicks       },
	{ TidyIndentAttributes,        PP, "indent-attributes",           BL, false,              ParseBool,         boolPicks       },
	{ TidyXmlPIs,                  MU, "assume-xml-procins",          BL, false,              ParseBool,         boolPicks       },
	{ TidyXmlSpace,                MU, "add-xml-space",               BL, false,              ParseBool,         boolPicks       },
	{ TidyEncloseBodyText,         MU, "enclose-text",                BL, false,              ParseBool,         boolPicks       },
	{ TidyEncloseBlockText,        MU, "enclose-block-text",          BL, false,              ParseBool,         boolPicks       },
	{ TidyKeepFileTimes,           MS, "keep-time",                   BL, false,              ParseBool,         boolPicks       },
	{ TidyWord2000,                MU, "word-2000",                   BL, false,              ParseBool,         boolPicks       },
	{ TidyMark,                    MS, "tidy-mark",                   BL, true,             ParseBool,         boolPicks       },
	{ TidyEmacs,                   MS, "gnu-emacs",                   BL, false,              ParseBool,         boolPicks       },
	{ TidyEmacsFile,               MS, "gnu-emacs-file",              ST, 0,               ParseString,       NULL            },
	{ TidyLiteralAttribs,          MU, "literal-attributes",          BL, false,              ParseBool,         boolPicks       },
	{ TidyBodyOnly,                MU, "show-body-only",              TIDYINT, false,              ParseAutoBool,     autoBoolPicks   },
	{ TidyFixUri,                  MU, "fix-uri",                     BL, true,             ParseBool,         boolPicks       },
	{ TidyLowerLiterals,           MU, "lower-literals",              BL, true,             ParseBool,         boolPicks       },
	{ TidyHideComments,            MU, "hide-comments",               BL, false,              ParseBool,         boolPicks       },
	{ TidyIndentCdata,             MU, "indent-cdata",                BL, false,              ParseBool,         boolPicks       },
	{ TidyForceOutput,             MS, "force-output",                BL, false,              ParseBool,         boolPicks       },
	{ TidyShowErrors,              DG, "show-errors",                 TIDYINT, 6,               ParseInt,          NULL            },
	{ TidyAsciiChars,              CE, "ascii-chars",                 BL, false,              ParseBool,         boolPicks       },
	{ TidyJoinClasses,             MU, "join-classes",                BL, false,              ParseBool,         boolPicks       },
	{ TidyJoinStyles,              MU, "join-styles",                 BL, true,             ParseBool,         boolPicks       },
	{ TidyEscapeCdata,             MU, "escape-cdata",                BL, false,              ParseBool,         boolPicks       },
#if SUPPORT_ASIAN_ENCODINGS
	{ TidyLanguage,                CE, "language",                    ST, 0,               ParseName,         NULL            },
	{ TidyNCR,                     MU, "ncr",                         BL, true,             ParseBool,         boolPicks       },
#endif
#if SUPPORT_UTF16_ENCODINGS
	{ TidyOutputBOM,               CE, "output-bom",                  TIDYINT, TidyAutoState,   ParseAutoBool,     autoBoolPicks   },
#endif
	{ TidyReplaceColor,            MU, "replace-color",               BL, false,              ParseBool,         boolPicks       },
	...
	{ TidyAccessibilityCheckLevel, DG, "accessibility-check",         TIDYINT, 0,               ParseAcc,          accessPicks     },
	{ TidyVertSpace,               PP, "vertical-space",              BL, false,              ParseBool,         boolPicks       },
#if SUPPORT_ASIAN_ENCODINGS
	{ TidyPunctWrap,               PP, "punctuation-wrap",            BL, false,              ParseBool,         boolPicks       },
#endif
	{ TidyMergeDivs,               MU, "merge-divs",                  TIDYINT, TidyAutoState,   ParseAutoBool,     autoBoolPicks   },
	{ TidyDecorateInferredUL,      MU, "decorate-inferred-ul",        BL, false,              ParseBool,         boolPicks       },
	{ TidyPreserveEntities,        MU, "preserve-entities",           BL, false,              ParseBool,         boolPicks       },
	{ TidySortAttributes,          PP, "sort-attributes",             TIDYINT, TidySortAttrNone, ParseSorter,       sorterPicks     },
	{ TidyMergeSpans,              MU, "merge-spans",                 TIDYINT, TidyAutoState,   ParseAutoBool,     autoBoolPicks   },
	{ TidyAnchorAsName,            MU, "anchor-as-name",              BL, true,             ParseBool,         boolPicks       },
...
static bool NeedReparseTagDecls(const TidyOptionValue* current, const TidyOptionValue * pNew, uint * changedUserTags)
{
	bool ret = false;
	uint ixVal;
...
#define TEST_USERTAGS(USERTAGOPTION, USERTAGTYPE) \
	case USERTAGOPTION: \
	    if(!OptionValueIdentical(option, &current[ixVal], &pNew[ixVal])) { \
...
TidyTriState    TY_(_cfgGetAutoBool) (TidyDocImpl* doc, TidyOptionId optId)
{
	ulong val = TY_(_cfgGet) (doc, optId);
	const TidyOptionImpl* opt = &option_defs[ optId ];
	assert(opt && opt->type == TidyInteger && opt->parser == ParseAutoBool);
...
{
	return (config->cfgIn) ? TY_(ReadChar)(config->cfgIn) : EndOfStream;
}
...
int TY_(ParseConfigFileEnc) (TidyDocImpl* doc, ctmbstr file, ctmbstr charenc)
{
	...
	if(fin == NULL || enc < 0) {
			...
			if(c == ':') {
				...
				if(option)
					...
					if(NULL != doc->pOptCallback) {
						...
						buf[i] = '\0';
						if(false == (*doc->pOptCallback)(name, buf))
		...
		TY_(freeFileSource) (&cfg->cfgIn->source, true);
...
void AdjustConfig(TidyDocImpl* doc)
{
	if(cfgBool(doc, TidyEncloseBlockText) )
		TY_(SetOptionBool) (doc, TidyEncloseBodyText, true);
	...
	*/
	if(cfg(doc, TidyOutCharEncoding) != ASCII &&
		...
		TY_(SetOptionBool) (doc, TidyXmlDecl, true);
	}
	...
	if(cfgBool(doc, TidyXmlOut) ) {
		...
		if(enc == UTF16LE || enc == UTF16BE || enc == UTF16)
			TY_(SetOptionInt) (doc, TidyOutputBOM, true);
#endif
		TY_(SetOptionBool) (doc, TidyQuoteAmpersand, true);
		TY_(SetOptionBool) (doc, TidyHideEndTags, false);
	}
}
...
/* true/false or true/false or 0/1 or "auto" only looks at 1st char */
...
{
	int diff = memcmp(&doc->config.value, &doc->config.snapshot, N_TIDY_OPTIONS * sizeof(uint));
	return ( diff != 0 );
}
