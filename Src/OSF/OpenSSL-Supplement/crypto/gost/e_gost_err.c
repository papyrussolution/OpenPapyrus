...
static ERR_STRING_DATA GOST_str_functs[] = {
	{ERR_PACK(0, GOST_F_DECODE_GOST_ALGOR_PARAMS, 0), "decode_gost_algor_params"},
	{ERR_PACK(0, GOST_F_ENCODE_GOST_ALGOR_PARAMS, 0), "encode_gost_algor_params"},
	...
	{ERR_PACK(0, GOST_F_GOST89_GET_ASN1_PARAMETERS, 0), "gost89_get_asn1_parameters"},
	{ERR_PACK(0, GOST_F_GOST89_SET_ASN1_PARAMETERS, 0), "gost89_set_asn1_parameters"},
	...
	{ERR_PACK(0, GOST_F_GOST_GRASSHOPPER_CIPHER_CTL, 0), "gost_grasshopper_cipher_ctl"},
	{ERR_PACK(0, GOST_F_GOST_GRASSHOPPER_SET_ASN1_PARAMETERS, 0), "gost_grasshopper_set_asn1_parameters"},
	...
	{ERR_PACK(0, GOST_F_PKEY_GOST_EC_CTRL_STR_256, 0), "pkey_gost_ec_ctrl_str_256"},
	{ERR_PACK(0, GOST_F_PKEY_GOST_EC_CTRL_STR_512, 0), "pkey_gost_ec_ctrl_str_512"},
	{ERR_PACK(0, GOST_F_PKEY_GOST_EC_DERIVE, 0), "pkey_gost_ec_derive"},
	{ERR_PACK(0, GOST_F_PKEY_GOST_ENCRYPT, 0), "pkey_gost_encrypt"},
	{ERR_PACK(0, GOST_F_PKEY_GOST_GRASSHOPPER_MAC_SIGNCTX_INIT, 0), "pkey_gost_grasshopper_mac_signctx_init"},
	...
	{ERR_PACK(0, GOST_F_PKEY_GOST_MAC_KEYGEN_BASE, 0), "pkey_gost_mac_keygen_base"},
	{ERR_PACK(0, GOST_F_PKEY_GOST_MAC_SIGNCTX_INIT, 0), "pkey_gost_mac_signctx_init"},
	{ERR_PACK(0, GOST_F_PKEY_GOST_MAGMA_MAC_SIGNCTX_INIT, 0), "pkey_gost_magma_mac_signctx_init"},
...
static ERR_STRING_DATA GOST_str_reasons[] = {
	{ERR_PACK(0, 0, GOST_R_BAD_KEY_PARAMETERS_FORMAT), "bad key parameters format"},
	{ERR_PACK(0, 0, GOST_R_BAD_MAC), "bad mac"},
	{ERR_PACK(0, 0, GOST_R_BAD_ORDER), "bad order"},
	{ERR_PACK(0, 0, GOST_R_BAD_PKEY_PARAMETERS_FORMAT), "bad pkey parameters format"},
	{ERR_PACK(0, 0, GOST_R_CANNOT_PACK_EPHEMERAL_KEY), "cannot pack ephemeral key"},
	{ERR_PACK(0, 0, GOST_R_CANNOT_UNPACK_EPHEMERAL_KEY), "cannot unpack ephemeral key"},
	{ERR_PACK(0, 0, GOST_R_CIPHER_NOT_FOUND), "cipher not found"},
	{ERR_PACK(0, 0, GOST_R_CTRL_CALL_FAILED), "ctrl call failed"},
	{ERR_PACK(0, 0, GOST_R_ERROR_COMPUTING_EXPORT_KEYS), "error computing export keys"},
	{ERR_PACK(0, 0, GOST_R_ERROR_COMPUTING_SHARED_KEY), "error computing shared key"},
	{ERR_PACK(0, 0, GOST_R_ERROR_PARSING_KEY_TRANSPORT_INFO), "error parsing key transport info"},
	...
	{ERR_PACK(0, 0, GOST_R_INVALID_CIPHER_PARAM_OID), "invalid cipher param oid"},
	...
	{ERR_PACK(0, 0, GOST_R_NO_PRIVATE_PART_OF_NON_EPHEMERAL_KEYPAIR), "no private part of non ephemeral keypair"},
	...
	{ERR_PACK(0, 0, GOST_R_SIGNATURE_PARTS_GREATER_THAN_Q), "signature parts greater than q"},
	{ERR_PACK(0, 0, GOST_R_UKM_NOT_SET), "ukm not set"},
	{ERR_PACK(0, 0, GOST_R_UNSUPPORTED_CIPHER_CTL_COMMAND), "unsupported cipher ctl command"},
	{ERR_PACK(0, 0, GOST_R_UNSUPPORTED_PARAMETER_SET), "unsupported parameter set"},
	{0, NULL}
};
