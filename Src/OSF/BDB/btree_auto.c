...
{
	int ret = 0;
	THROW_BDBI(ret = __db_add_recovery_int(env, dtabp, __bam_split_recover, DB___bam_split));
	THROW_BDBI(ret = __db_add_recovery_int(env, dtabp, __bam_rsplit_recover, DB___bam_rsplit));
	THROW_BDBI(ret = __db_add_recovery_int(env, dtabp, __bam_adj_recover, DB___bam_adj));
	THROW_BDBI(ret = __db_add_recovery_int(env, dtabp, __bam_cadjust_recover, DB___bam_cadjust));
	THROW_BDBI(ret = __db_add_recovery_int(env, dtabp, __bam_cdel_recover, DB___bam_cdel));
	THROW_BDBI(ret = __db_add_recovery_int(env, dtabp, __bam_repl_recover, DB___bam_repl));
	THROW_BDBI(ret = __db_add_recovery_int(env, dtabp, __bam_irep_recover, DB___bam_irep));
	THROW_BDBI(ret = __db_add_recovery_int(env, dtabp, __bam_root_recover, DB___bam_root));
	THROW_BDBI(ret = __db_add_recovery_int(env, dtabp, __bam_curadj_recover, DB___bam_curadj));
	THROW_BDBI(ret = __db_add_recovery_int(env, dtabp, __bam_rcuradj_recover, DB___bam_rcuradj));
	CATCH
		;
	ENDCATCH
	return ret;
