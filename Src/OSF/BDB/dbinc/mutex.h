...
#if !defined(HAVE_MUTEX_HYBRID) && (defined(HAVE_MUTEX_PTHREADS) || defined(HAVE_MUTEX_SOLARIS_LWP) || defined(HAVE_MUTEX_UI_THREADS))
 ...
 */
#define	MUTEX_TRYLOCK(env, mutex) (((mutex) == MUTEX_INVALID) ? 0 : __mutex_trylock(env, mutex))
