...
int __memp_fget(DB_MPOOLFILE *, db_pgno_t *, DB_THREAD_INFO *, DB_TXN *, uint32, void *);
...
int __memp_fput(DB_MPOOLFILE *, DB_THREAD_INFO *, void *, DB_CACHE_PRIORITY);
int __memp_unpin_buffers(ENV *, DB_THREAD_INFO *);
int __memp_dirty(DB_MPOOLFILE *, void *, DB_THREAD_INFO *, DB_TXN *, DB_CACHE_PRIORITY, uint32);
