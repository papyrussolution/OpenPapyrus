...
int __memp_get_fileid(const DB_MPOOLFILE *, uint8 *);
...
int __memp_get_ftype(const DB_MPOOLFILE *, int *);
int __memp_set_ftype(DB_MPOOLFILE *, int);
int __memp_set_lsn_offset(DB_MPOOLFILE *, int32);
int __memp_get_pgcookie(const DB_MPOOLFILE *, DBT *);
int __memp_set_pgcookie(DB_MPOOLFILE *, DBT *);
int __memp_get_priority(const DB_MPOOLFILE *, DB_CACHE_PRIORITY *);
int __memp_get_last_pgno(DB_MPOOLFILE *, db_pgno_t *);
char * FASTCALL __memp_fn(DB_MPOOLFILE *);
...
int FASTCALL __memp_fclose(DB_MPOOLFILE *, uint32);
...
int	__memp_init(ENV *, DB_MPOOL *, uint, uint32, uint);
