...
int __log_cursor(ENV *, DB_LOGC **);
int __logc_close(DB_LOGC *);
int __logc_version(DB_LOGC *, uint32 *);
int __logc_get(DB_LOGC *, DB_LSN *, DBT *, uint32);
...
int __log_read_record (ENV *, DB **, void *, void *, DB_LOG_RECSPEC *, uint32, void **);
