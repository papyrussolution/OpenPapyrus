...
int __log_verify_wrap __P((ENV *, const char *, uint32, const char *, const char *, __time64_t, __time64_t, uint32, uint32, uint32, uint32, int, int));
...
int __find_lsnrg_by_timerg __P((DB_LOG_VRFY_INFO *, __time64_t, __time64_t, DB_LSN *, DB_LSN *));
