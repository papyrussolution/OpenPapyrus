...
static inline int __ham_insdel_42_read(ENV *env, DB **dbpp, void *td, void *data, __ham_insdel_42_args **arg)
{
	*arg = NULL;
	return (__log_read_record(env, dbpp, td, data, __ham_insdel_42_desc, sizeof(__ham_insdel_42_args), reinterpret_cast<void **>(arg)));
}
...
{
	*arg = NULL;
	return (__log_read_record(env, dbpp, td, data, __ham_groupalloc_desc, sizeof(__ham_groupalloc_args), reinterpret_cast<void **>(arg)));
}
...
{
	*arg = NULL;
	return (__log_read_record(env, dbpp, td, data, __ham_changeslot_desc, sizeof(__ham_changeslot_args), reinterpret_cast<void **>(arg)));
}
...
{
	*arg = NULL;
	return (__log_read_record(env, dbpp, td, data, __ham_contract_desc, sizeof(__ham_contract_args), reinterpret_cast<void **>(arg)));
}
...
static inline int __ham_curadj_read(ENV *env, DB **dbpp, void *td, void *data, __ham_curadj_args **arg)
{
	*arg = NULL;
	return (__log_read_record(env, dbpp, td, data, __ham_curadj_desc, sizeof(__ham_curadj_args), reinterpret_cast<void **>(arg)));
}
...
static inline int __ham_chgpg_log(DB *dbp, DB_TXN *txnp, DB_LSN *ret_lsnp, uint32 flags, db_ham_mode mode, db_pgno_t old_pgno, db_pgno_t new_pgno, uint32 old_indx, uint32 new_indx)
{
	return (__log_put_record((dbp)->env, dbp, txnp, ret_lsnp, flags, DB___ham_chgpg, 0,
	    sizeof(uint32) + sizeof(uint32) + sizeof(DB_LSN) + sizeof(uint32) + sizeof(uint32) + sizeof(uint32) + sizeof(uint32) + sizeof(uint32) + sizeof(uint32),
	    __ham_chgpg_desc, mode, old_pgno, new_pgno, old_indx, new_indx));
}

static inline int __ham_chgpg_read(ENV *env, DB **dbpp, void *td, void *data, __ham_chgpg_args **arg)
{
	*arg = NULL;
	return (__log_read_record(env, dbpp, td, data, __ham_chgpg_desc, sizeof(__ham_chgpg_args), reinterpret_cast<void **>(arg)));
}
#endif /* HAVE_HASH */
#endif
