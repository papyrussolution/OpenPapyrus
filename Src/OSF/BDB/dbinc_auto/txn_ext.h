...
int __txn_get_tx_timestamp(DB_ENV *, __time64_t *);
int __txn_set_tx_timestamp(DB_ENV *, __time64_t *);
...
int __txn_regop_42_recover(ENV *, DBT *, DB_LSN *, db_recops, void *);
int __txn_ckp_42_recover(ENV *, DBT *, DB_LSN *, db_recops, void *);
...
int __txn_oldest_reader(ENV *, DB_LSN *);
