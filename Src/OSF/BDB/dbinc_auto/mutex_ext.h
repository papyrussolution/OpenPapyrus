...
int __mutex_alloc __P((ENV *, int, uint32, db_mutex_t *));
int __mutex_alloc_int __P((ENV *, int, int, uint32, db_mutex_t *));
...
int __db_fcntl_mutex_init __P((ENV *, db_mutex_t, uint32));
...
int __mutex_alloc_pp __P((DB_ENV *, uint32, db_mutex_t *));
...
#endif
int __db_pthread_mutex_init __P((ENV *, db_mutex_t, uint32));
...
int __mutex_stat_pp __P((DB_ENV *, DB_MUTEX_STAT **, uint32));
int __mutex_stat_print_pp(DB_ENV *, uint32);
int __mutex_stat_print __P((ENV *, uint32));
void __mutex_print_debug_single __P((ENV *, const char *, db_mutex_t, uint32));
void __mutex_print_debug_stats __P((ENV *, DB_MSGBUF *, db_mutex_t, uint32));
void __mutex_set_wait_info __P((ENV *, db_mutex_t, uintmax_t *, uintmax_t *));
void __mutex_clear __P((ENV *, db_mutex_t));
int __db_tas_mutex_init __P((ENV *, db_mutex_t, uint32));
...
int __db_win32_mutex_init __P((ENV *, db_mutex_t, uint32));
