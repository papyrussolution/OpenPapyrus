...
int __dbreg_stat_print __P((ENV *, uint32));
...
int __dbreg_log_files __P((ENV *, uint32));
...
int __dbreg_do_open __P((ENV *, DB_TXN *, DB_LOG *, uint8 *, char *, DBTYPE, int32, db_pgno_t, void *, uint32, uint32));
