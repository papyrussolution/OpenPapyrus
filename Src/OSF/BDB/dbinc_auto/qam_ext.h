...
int __qam_position __P((DBC *, db_recno_t *, uint32, int *));
int __qam_pitem __P((DBC *,  QPAGE *, uint32, db_recno_t, DBT *));
int __qam_append __P((DBC *, DBT *, DBT *));
int __qamc_dup __P((DBC *, DBC *));
int __qamc_init(DBC *);
int __qam_truncate __P((DBC *, uint32 *));
int __qam_delete __P((DBC *,  DBT *, uint32));
...
int __qam_fprobe __P((DBC *, db_pgno_t, void *, qam_probe_mode, DB_CACHE_PRIORITY, uint32));
...
void __qam_exid __P((DB *, uint8 *, uint32));
int __qam_nameop __P((DB *, DB_TXN *, const char *, qam_name_op));
int __qam_lsn_reset __P((DB *, DB_THREAD_INFO *));
int __qam_db_create __P((DB *));
int __qam_db_close __P((DB *, uint32));
int __qam_get_extentsize __P((DB *, uint32 *));
int __queue_pageinfo __P((DB *, db_pgno_t *, db_pgno_t *, int *, int, uint32));
int __db_prqueue __P((DB *, uint32));
int __qam_remove __P((DB *, DB_THREAD_INFO *, DB_TXN *, const char *, const char *, uint32));
int __qam_rename __P((DB *, DB_THREAD_INFO *, DB_TXN *, const char *, const char *, const char *));
void __qam_map_flags __P((DB *, uint32 *, uint32 *));
int __qam_set_flags __P((DB *, uint32 *flagsp));
int __qam_open __P((DB *, DB_THREAD_INFO *, DB_TXN *, const char *, db_pgno_t, int, uint32));
...
int __qam_stat __P((DBC *, void *, uint32));
int __qam_stat_print __P((DBC *, uint32));
int __db_no_queue_am(ENV *);
int __qam_31_qammeta __P((DB *, char *, uint8 *));
int __qam_32_qammeta __P((DB *, char *, uint8 *));
int __qam_vrfy_meta __P((DB *, VRFY_DBINFO *, QMETA *, db_pgno_t, uint32));
int __qam_meta2pgset __P((DB *, VRFY_DBINFO *, DB *));
int __qam_vrfy_data __P((DB *, VRFY_DBINFO *, QPAGE *, db_pgno_t, uint32));
int __qam_vrfy_structure __P((DB *, VRFY_DBINFO *, uint32));
int __qam_vrfy_walkqueue __P((DB *, VRFY_DBINFO *, void *, int (*)(void *, const void *), uint32));
int __qam_salvage __P((DB *, VRFY_DBINFO *, db_pgno_t, PAGE *, void *, int (*)(void *, const void *), uint32));
