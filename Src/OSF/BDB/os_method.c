 ...
 */
int db_env_set_func_assert(void (*func_assert)__P((const char *, const char *, int)))
{
 ...
 */
int db_env_set_func_dirfree(void (*func_dirfree)__P((char **, int)))
{
 ...
 */
int db_env_set_func_dirlist(int (*func_dirlist)__P((const char *, char ***, int *)))
{
 ...
 */
int db_env_set_func_exists(int (*func_exists)__P((const char *, int *)))
{
 ...
 */
int db_env_set_func_free(void (*func_free)__P((void *)))
{
 ...
 */
int db_env_set_func_ftruncate(int (*func_ftruncate)__P((int, off_t)))
{
 ...
 */
int db_env_set_func_malloc(void *(*func_malloc)__P((size_t)))
{
 ...
 */
int db_env_set_func_file_map(int (*func_file_map)__P((DB_ENV*, char *, size_t, int, void **)),
 ...
 * EXTERN:    int (*)(DB_ENV *, void *)));
 */
int db_env_set_func_region_map(
 ...
 */
int db_env_set_func_pread(ssize_t(*func_pread) __P((int, void *, size_t, off_t)))
{
 ...
 */
int db_env_set_func_pwrite(ssize_t(*func_pwrite) __P((int, const void *, size_t, off_t)))
{
 ...
 */
int db_env_set_func_open(int (*func_open)__P((const char *, int, ...)))
{
 ...
 */
int db_env_set_func_read(ssize_t(*func_read) __P((int, void *, size_t)))
{
 ...
 */
int db_env_set_func_realloc(void *(*func_realloc)__P((void *, size_t)))
{
 ...
 */
int db_env_set_func_rename(int (*func_rename)__P((const char *, const char *)))
{
 ...
 */
int db_env_set_func_seek(int (*func_seek)__P((int, off_t, int)))
{
 ...
 */
int db_env_set_func_unlink(int (*func_unlink)__P((const char *)))
{
 ...
 */
int db_env_set_func_write(ssize_t(*func_write) __P((int, const void *, size_t)))
{
	DB_GLOBAL(j_write) = func_write;
	return 0;
}
/*
 * EXTERN: int db_env_set_func_yield __P((int (*)(ulong, ulong)));
 */
int db_env_set_func_yield(int (*func_yield)__P((ulong, ulong)))
{
