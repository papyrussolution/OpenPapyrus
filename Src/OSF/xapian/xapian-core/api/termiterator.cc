...
void TermIterator::post_advance(Internal * res)
{
	if(res) {
...
string TermIterator::operator*() const
{
...
Xapian::termcount TermIterator::get_wdf() const
{
...
Xapian::doccount TermIterator::get_termfreq() const
{
...
Xapian::termcount TermIterator::positionlist_count() const
{
...
PositionIterator TermIterator::positionlist_begin() const
{
...
void TermIterator::skip_to(const string & term)
{
...
std::string TermIterator::get_description() const
{
