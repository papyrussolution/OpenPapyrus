...
Xapian::docid PostingIterator::operator*() const
{
...
PostingIterator &PostingIterator::operator++()
{
...
Xapian::termcount PostingIterator::get_wdf() const
{
...
Xapian::termcount PostingIterator::get_doclength() const
{
...
Xapian::termcount PostingIterator::get_unique_terms() const
{
...
Xapian::termcount PostingIterator::get_wdfdocmax() const
{
...
Xapian::termcount PostingIterator::positionlist_count() const
{
...
PositionIterator PostingIterator::positionlist_begin() const
{
...
void PostingIterator::skip_to(Xapian::docid did)
{
...
std::string PostingIterator::get_description() const
{
