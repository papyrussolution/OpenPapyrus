...
namespace Xapian {
	...
	ValueIterator::ValueIterator(const ValueIterator & o) : internal(o.internal)
	{
	...
	string ValueIterator::operator*() const
	{
	...
	Xapian::docid ValueIterator::get_docid() const
	{
	...
	Xapian::valueno ValueIterator::get_valueno() const
	{
	...
	void ValueIterator::skip_to(Xapian::docid docid_or_slot)
	{
	...
	bool ValueIterator::check(Xapian::docid did)
	{
	...
	std::string ValueIterator::get_description() const
	{
