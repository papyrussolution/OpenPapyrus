...
namespace Xapian {
Xapian::docid MSetIterator::operator*() const
{
...
Xapian::Document MSetIterator::get_document() const
{
...
double MSetIterator::get_weight() const
{
...
string MSetIterator::get_collapse_key() const
{
...
Xapian::doccount MSetIterator::get_collapse_count() const
{
...
string MSetIterator::get_sort_key() const
{
...
std::string MSetIterator::get_description() const
{
