...
#pragma hdrstop
#include "lovins.sbl.h"

static int tr_CC(Xapian::StemImplementation * this_ptr) { return (static_cast<Xapian::InternalStemLovins *>(this_ptr))->r_CC(); }

static int tr_BB(Xapian::StemImplementation * this_ptr) { return (static_cast<Xapian::InternalStemLovins *>(this_ptr))->r_BB(); }

static int tr_AA(Xapian::StemImplementation * this_ptr) { return (static_cast<Xapian::InternalStemLovins *>(this_ptr))->r_AA(); }

static int tr_Z(Xapian::StemImplementation * this_ptr) { return (static_cast<Xapian::InternalStemLovins *>(this_ptr))->r_Z(); }

static int tr_Y(Xapian::StemImplementation * this_ptr) { return (static_cast<Xapian::InternalStemLovins *>(this_ptr))->r_Y(); }

static int tr_X(Xapian::StemImplementation * this_ptr) { return (static_cast<Xapian::InternalStemLovins *>(this_ptr))->r_X(); }

static int tr_W(Xapian::StemImplementation * this_ptr) { return (static_cast<Xapian::InternalStemLovins *>(this_ptr))->r_W(); }

static int tr_V(Xapian::StemImplementation * this_ptr) { return (static_cast<Xapian::InternalStemLovins *>(this_ptr))->r_V(); }

static int tr_U(Xapian::StemImplementation * this_ptr) { return (static_cast<Xapian::InternalStemLovins *>(this_ptr))->r_U(); }

static int tr_T(Xapian::StemImplementation * this_ptr) { return (static_cast<Xapian::InternalStemLovins *>(this_ptr))->r_T(); }

static int tr_S(Xapian::StemImplementation * this_ptr) { return (static_cast<Xapian::InternalStemLovins *>(this_ptr))->r_S(); }

static int tr_R(Xapian::StemImplementation * this_ptr) { return (static_cast<Xapian::InternalStemLovins *>(this_ptr))->r_R(); }

static int tr_Q(Xapian::StemImplementation * this_ptr) { return (static_cast<Xapian::InternalStemLovins *>(this_ptr))->r_Q(); }

static int tr_P(Xapian::StemImplementation * this_ptr) { return (static_cast<Xapian::InternalStemLovins *>(this_ptr))->r_P(); }

static int tr_O(Xapian::StemImplementation * this_ptr) { return (static_cast<Xapian::InternalStemLovins *>(this_ptr))->r_O(); }

static int tr_N(Xapian::StemImplementation * this_ptr) { return (static_cast<Xapian::InternalStemLovins *>(this_ptr))->r_N(); }

static int tr_M(Xapian::StemImplementation * this_ptr) { return (static_cast<Xapian::InternalStemLovins *>(this_ptr))->r_M(); }

static int tr_L(Xapian::StemImplementation * this_ptr) { return (static_cast<Xapian::InternalStemLovins *>(this_ptr))->r_L(); }

static int tr_K(Xapian::StemImplementation * this_ptr) { return (static_cast<Xapian::InternalStemLovins *>(this_ptr))->r_K(); }

static int tr_J(Xapian::StemImplementation * this_ptr) { return (static_cast<Xapian::InternalStemLovins *>(this_ptr))->r_J(); }

static int tr_I(Xapian::StemImplementation * this_ptr) { return (static_cast<Xapian::InternalStemLovins *>(this_ptr))->r_I(); }

static int tr_H(Xapian::StemImplementation * this_ptr) { return (static_cast<Xapian::InternalStemLovins *>(this_ptr))->r_H(); }

static int tr_G(Xapian::StemImplementation * this_ptr) { return (static_cast<Xapian::InternalStemLovins *>(this_ptr))->r_G(); }

static int tr_F(Xapian::StemImplementation * this_ptr) { return (static_cast<Xapian::InternalStemLovins *>(this_ptr))->r_F(); }

static int tr_E(Xapian::StemImplementation * this_ptr) { return (static_cast<Xapian::InternalStemLovins *>(this_ptr))->r_E(); }

static int tr_D(Xapian::StemImplementation * this_ptr) { return (static_cast<Xapian::InternalStemLovins *>(this_ptr))->r_D(); }

static int tr_C(Xapian::StemImplementation * this_ptr) { return (static_cast<Xapian::InternalStemLovins *>(this_ptr))->r_C(); }

static int tr_B(Xapian::StemImplementation * this_ptr) { return (static_cast<Xapian::InternalStemLovins *>(this_ptr))->r_B(); }

static int tr_A(Xapian::StemImplementation * this_ptr) { return (static_cast<Xapian::InternalStemLovins *>(this_ptr))->r_A(); }
...
int Xapian::InternalStemLovins::r_AA() {
	...
	if(c <= lb || p[c-1] >> 5 != 3 || !((1839440 >> (p[c-1] & 0x1f)) & 1)) return 0;
...
int Xapian::InternalStemLovins::r_BB() {
	...
	{   int m2 = l - c; (void)m2;
		if(!(eq_s_b(3, s_3))) goto lab0;
		return 0;
	lab0:
		c = l - m2;
	}
	{   int m3 = l - c; (void)m3;
		if(!(eq_s_b(4, s_4))) goto lab1;
		return 0;
	lab1:
		c = l - m3;
	}
...
int Xapian::InternalStemLovins::r_endings() {
	ket = c;
	if(!(find_among_b(s_pool, a_1, 294, af_1, af))) return 0;
	bra = c;
	{    int ret = slice_del();
		if(ret < 0) return ret;
	}
...
int Xapian::InternalStemLovins::r_undouble() {
	{   int m_test1 = l - c;
		if(c - 1 <= lb || p[c-1] >> 5 != 3 || !((1929364 >> (p[c-1] & 0x1f)) & 1)) return 0;
...
int Xapian::InternalStemLovins::r_respell() {
	int among_var;
	ket = c;
	if(c - 1 <= lb || p[c-1] >> 5 != 3 || !((89919504 >> (p[c-1] & 0x1f)) & 1)) return 0;
	...
	switch(among_var) {
		...
		case 5:
			...
			break;
		case 6:
			{    int ret = slice_from_s(5, s_10);
				if(ret < 0) return ret;
			}
			break;
		case 7:
			{    int ret = slice_from_s(5, s_11);
				if(ret < 0) return ret;
			}
			break;
		case 8:
...
std::string Xapian::InternalStemLovins::get_description() const { return "lovins.sbl"; }
