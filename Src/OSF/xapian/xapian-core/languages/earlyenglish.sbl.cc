...
int Xapian::InternalStemEarlyenglish::r_shortv() {
...
int Xapian::InternalStemEarlyenglish::r_R1() {
	if(!(I_p1 <= c)) return 0;
	return 1;
}

int Xapian::InternalStemEarlyenglish::r_R2() {
	if(!(I_p2 <= c)) return 0;
	return 1;
}

int Xapian::InternalStemEarlyenglish::r_Step_1a() {
	int among_var;
	ket = c;
...
int Xapian::InternalStemEarlyenglish::r_Step_1b() {
	int among_var;
	ket = c;
	if(c - 1 <= lb || p[c-1] >> 5 != 3 || !((1048976 >> (p[c-1] & 0x1f)) & 1)) return 0;
...
int Xapian::InternalStemEarlyenglish::r_Step_1c() {
	ket = c;
	{   int m1 = l - c; (void)m1;
...
int Xapian::InternalStemEarlyenglish::r_Step_2() {
	int among_var;
	ket = c;
...
int Xapian::InternalStemEarlyenglish::r_Step_3() {
	int among_var;
	ket = c;
...
int Xapian::InternalStemEarlyenglish::r_Step_4() {
	int among_var;
	ket = c;
...
int Xapian::InternalStemEarlyenglish::r_Step_5a() {
	ket = c;
...
int Xapian::InternalStemEarlyenglish::r_Step_5b() {
	ket = c;
...
int Xapian::InternalStemEarlyenglish::stem() {
	I_Y_found = 0;
	{   int c1 = c;
		bra = c;
...
std::string Xapian::InternalStemEarlyenglish::get_description() const { return "earlyenglish.sbl"; }
