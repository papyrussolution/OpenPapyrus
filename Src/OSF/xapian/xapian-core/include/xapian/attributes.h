...
#ifdef __GNUC__
	#define XAPIAN_CONST_FUNCTION __attribute__((__const__)) // __attribute__((__const__)) is available at least as far back as GCC 2.95.
	#define XAPIAN_PURE_FUNCTION __attribute__((__pure__)) // __attribute__((__pure__)) is available from GCC 2.96 onwards.
