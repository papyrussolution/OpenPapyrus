...
class XAPIAN_VISIBILITY_DEFAULT Database {
	...
	void compact_(const std::string* output_ptr, int fd, uint flags, int block_size, Xapian::Compactor* compactor) const;
protected:
