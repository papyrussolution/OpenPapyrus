...
public:
	...
	Document(Document&& o); /// Move constructor.
	Document& operator = (Document&& o); /// Move assignment operator.
	/** Default constructor.
	 *
	...
	TermIterator termlist_end() const noexcept { return TermIterator(); }
	...
	ValueIterator values_end() const noexcept { return ValueIterator(); }
