...
public:
	...
	bool operator()(const std::string & term) const { return stop_words.find(term) != stop_words.end(); }
 ...
 */
class XAPIAN_VISIBILITY_DEFAULT Clusterer : public Xapian::Internal::opt_intrusive_base {
public:
	virtual ~Clusterer();
