...
/* Define to 1 if you have the declaration of `__builtin_popcount(unsigned)',
   and to 0 if you don't. */
/* #undef HAVE_DECL___BUILTIN_POPCOUNT */
...
#define PACKAGE_STRING "xapian-core 1.4.9"
