 ...
 */
template <class U>
inline bool unpack_uint_last(const char ** p, const char * end, U * result)
{
	static_assert(std::is_unsigned<U>::value, "Unsigned type required");
	Assert(result);
 ...
 */
template <class U>
inline void pack_uint_preserving_sort(std::string & s, U value)
{
	static_assert(std::is_unsigned<U>::value, "Unsigned type required");
 ...
 */
template <class U>
inline bool unpack_uint_preserving_sort(const char ** p, const char * end, U * result)
{
	static_assert(std::is_unsigned<U>::value, "Unsigned type required");
	static_assert(sizeof(U) <= 8,
	    "Template type U too wide for database format");
 ...
 */
template <class U>
inline void pack_uint(std::string & s, U value)
{
	static_assert(std::is_unsigned<U>::value, "Unsigned type required");
 ...
 */
template <>
inline void pack_uint(std::string & s, bool value)
{
	s += static_cast<char>(value);
}
 ...
 */
template <class U>
inline bool unpack_uint(const char ** p, const char * end, U * result)
{
	static_assert(std::is_unsigned<U>::value, "Unsigned type required");
 ...
 */
template <class U>
inline bool unpack_uint_backwards(const char ** p, const char * start, U * result)
{
	static_assert(std::is_unsigned<U>::value, "Unsigned type required");
