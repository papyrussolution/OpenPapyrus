...
Xapian::termpos PositionIterator::operator*() const
{
...
void PositionIterator::skip_to(Xapian::termpos pos)
{
...
std::string PositionIterator::get_description() const
{
