...
public:
	...
	DebugLogFuncVoid(const void* this_ptr_, debuglog_categories category_, const std::string & params, const char * class_name) : 
		this_ptr(this_ptr_), category(category_), uncaught_exceptions(get_uncaught_exceptions())
	{
		if(is_category_wanted()) {
	...
	DebugLogFuncVoid(const void* this_ptr_, debuglog_categories category_, const char * class_name) : 
		this_ptr(this_ptr_), category(category_), uncaught_exceptions(get_uncaught_exceptions())
	{
		if(is_category_wanted()) {
			func.assign(class_name);
...
#define LOGCALL(CATEGORY, TYPE, FUNC, PARAMS) \
	...
	DebugLogFunc xapian_logcall_(static_cast<const void*>(this), \
	    DEBUGLOG_CATEGORY_ ## CATEGORY, #TYPE, FUNC, xapian_logcall_parameters_)
...
#define LOGCALL_VOID(CATEGORY, FUNC, PARAMS) \
	...
	DebugLogFuncVoid xapian_logcall_(static_cast<const void*>(this), \
	    DEBUGLOG_CATEGORY_ ## CATEGORY, FUNC, xapian_logcall_parameters_)
...
#define LOGCALL_CTOR(CATEGORY, CLASS, PARAMS) \
	...
	DebugLogFuncVoid xapian_logcall_(static_cast<const void*>(this), \
	    DEBUGLOG_CATEGORY_ ## CATEGORY, xapian_logcall_parameters_, CLASS)
