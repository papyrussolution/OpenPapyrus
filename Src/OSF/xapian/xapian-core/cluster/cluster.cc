...
void DocumentSet::Internal::add_document(const Document &document)
{
	documents.push_back(document);
}

Document & DocumentSet::operator[](doccount i)
{
	return internal->get_document(i);
}

Document & DocumentSet::Internal::get_document(doccount i)
{
	return documents[i];
}

const Document & DocumentSet::operator[](doccount i) const
{
	return internal->get_document(i);
}

const Document & DocumentSet::Internal::get_document(doccount i) const
{
	return documents[i];
}
