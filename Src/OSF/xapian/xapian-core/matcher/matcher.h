...
public:
	 ...
	 *  @param collapse_key	value slot to collapse on (Xapian::BAD_VALUENO which means no collapsing)
	 *  @param collapse_max	Maximum number of documents with the same key to allow
	 ...
	 *  @param time_limit	time in seconds after which to disable check_at_least (0.0 means don't).
	 ...
	 *  @param matchspies	MatchSpy objects to use
	 */
	Xapian::MSet get_mset(Xapian::doccount first, Xapian::doccount maxitems, Xapian::doccount check_at_least, Xapian::Weight::Internal& stats,
	    const Xapian::Weight& wtscheme, const Xapian::MatchDecider* mdecider, const Xapian::KeyMaker* sorter, Xapian::valueno collapse_key,
