...
Xapian::termcount NearPostList::get_wdf() const
{
...
Xapian::doccount NearPostList::get_termfreq_est() const
{
...
TermFreqs NearPostList::get_termfreq_est_using_stats(const Xapian::Weight::Internal & stats) const
{
...
string NearPostList::get_description() const
{
	string m = "(Near ";
	m += str(window);
	m += ' ';
