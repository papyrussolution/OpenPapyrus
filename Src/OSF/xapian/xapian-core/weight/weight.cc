...
namespace Xapian {
void Weight::init_(const Internal & stats, Xapian::termcount query_length,
...
Weight * Weight::unserialise(const string &) const
{
	throw Xapian::UnimplementedError("unserialise() not supported for this Xapian::Weight subclass");
}

const Weight * Weight::create(const string & s, const Registry & reg)
{
...
Weight * Weight::create_from_parameters(const char *) const
{
