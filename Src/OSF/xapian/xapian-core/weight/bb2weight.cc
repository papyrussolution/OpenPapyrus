...
BB2Weight * BB2Weight::clone() const
{
...
double BB2Weight::get_sumpart(Xapian::termcount wdf, Xapian::termcount len,
...
double BB2Weight::get_maxpart() const
{
	return upper_bound;
}

double BB2Weight::get_sumextra(Xapian::termcount, Xapian::termcount, Xapian::termcount) const
{
	return 0;
}

double BB2Weight::get_maxextra() const
{
	return 0;
}
