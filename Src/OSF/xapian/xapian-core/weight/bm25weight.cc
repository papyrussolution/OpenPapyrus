...
string BM25Weight::name() const
{
	return "Xapian::BM25Weight";
}

string BM25Weight::short_name() const
{
	return "bm25";
}
...
double BM25Weight::get_sumpart(Xapian::termcount wdf, Xapian::termcount len,
...
double BM25Weight::get_maxpart() const
{
...
double BM25Weight::get_maxextra() const
{
...
BM25Weight * BM25Weight::create_from_parameters(const char * p) const
{
	if(*p == '\0')
