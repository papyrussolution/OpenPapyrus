...
namespace Xapian {
Weight::Internal &Weight::Internal::operator+=(const Weight::Internal & inc)
{
...
void Weight::Internal::merge(const Weight::Internal& o)
{
	if(!o.have_max_part) 
		return;
...
string Weight::Internal::get_description() const
{
