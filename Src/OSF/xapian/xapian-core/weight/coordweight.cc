...
namespace Xapian {
CoordWeight * CoordWeight::clone() const
{
	return new CoordWeight;
}

void CoordWeight::init(double factor_)
{
	factor = factor_;
}

string CoordWeight::name() const
{
	return "Xapian::CoordWeight";
}

string CoordWeight::short_name() const
{
	return "coord";
}

string CoordWeight::serialise() const
{
...
double CoordWeight::get_sumpart(Xapian::termcount, Xapian::termcount,
    Xapian::termcount, Xapian::termcount) const
{
	return factor;
}

double CoordWeight::get_maxpart() const
{
	return factor;
}

double CoordWeight::get_sumextra(Xapian::termcount, Xapian::termcount, Xapian::termcount) const
{
	return 0;
}

double CoordWeight::get_maxextra() const
{
	return 0;
}
