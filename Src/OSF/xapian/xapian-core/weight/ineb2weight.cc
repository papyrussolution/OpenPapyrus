...
string IneB2Weight::name() const
{
	return "Xapian::IneB2Weight";
}

string IneB2Weight::short_name() const
{
	return "ineb2";
}

string IneB2Weight::serialise() const
{
...
double IneB2Weight::get_sumpart(Xapian::termcount wdf, Xapian::termcount len,
...
double IneB2Weight::get_maxpart() const
{
	return upper_bound;
}

double IneB2Weight::get_sumextra(Xapian::termcount,
    Xapian::termcount,
...
double IneB2Weight::get_maxextra() const
{
	return 0;
}
