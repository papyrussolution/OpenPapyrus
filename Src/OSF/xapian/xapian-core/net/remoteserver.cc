...
void RemoteServer::send_message(reply_type type, const string &message)
{
	double end_time = RealTime::end_time(active_timeout);
	uchar type_as_char = static_cast<uchar>(type);
		...
		try {
			...
			switch(type) {
				...
				case MSG_RECONSTRUCTTEXT:
				    ...
				    continue;
				case MSG_SYNONYMTERMLIST:
				    msg_synonymtermlist(message);
				    continue;
				case MSG_SYNONYMKEYLIST:
				    msg_synonymkeylist(message);
				    continue;
				case MSG_ADDSYNONYM:
				    msg_addsynonym(message);
				    continue;
				case MSG_REMOVESYNONYM:
				    msg_removesynonym(message);
				    continue;
				case MSG_CLEARSYNONYMS:
				    msg_clearsynonyms(message);
				    continue;
				default: {
...
void RemoteServer::msg_termlist(const string &message)
{
...
void RemoteServer::msg_positionlist(const string &message)
{
	const char * p = message.data();
	const char * p_end = p + message.size();
	Xapian::docid did;
...
void RemoteServer::msg_positionlistcount(const string &message)
{
	const char * p = message.data();
	const char * p_end = p + message.size();
	Xapian::docid did;
...
void RemoteServer::msg_postlist(const string &message)
{
...
void RemoteServer::msg_writeaccess(const string & msg)
{
	if(!writable)
		throw_read_only();
...
void RemoteServer::msg_reopen(const string & msg)
{
	if(!db->reopen()) {
...
void RemoteServer::msg_update(const string &)
{
...
void RemoteServer::msg_query(const string &message_in)
{
...
void RemoteServer::msg_document(const string &message)
{
	const char * p = message.data();
	const char * p_end = p + message.size();
	Xapian::docid did;
...
void RemoteServer::msg_keepalive(const string &)
{
...
void RemoteServer::msg_termexists(const string &term)
{
	send_message((db->term_exists(term) ? REPLY_TERMEXISTS : REPLY_TERMDOESNTEXIST), string());
}

void RemoteServer::msg_collfreq(const string &term)
{
	string reply;
...
void RemoteServer::msg_termfreq(const string &term)
{
	string reply;
...
void RemoteServer::msg_freqs(const string &term)
{
	string msg;
...
void RemoteServer::msg_valuestats(const string & message)
{
	const char * p = message.data();
	const char * p_end = p + message.size();
	Xapian::valueno slot;
...
void RemoteServer::msg_doclength(const string &message)
{
	const char * p = message.data();
	const char * p_end = p + message.size();
	Xapian::docid did;
...
void RemoteServer::msg_uniqueterms(const string &message)
{
	const char * p = message.data();
	const char * p_end = p + message.size();
	Xapian::docid did;
...
void RemoteServer::msg_commit(const string &)
{
	if(!wdb)
		throw_read_only();
...
void RemoteServer::msg_cancel(const string &)
{
	if(!wdb)
		throw_read_only();
...
void RemoteServer::msg_adddocument(const string & message)
{
	if(!wdb)
		throw_read_only();
...
void RemoteServer::msg_deletedocument(const string & message)
{
	if(!wdb)
		throw_read_only();
...
void RemoteServer::msg_deletedocumentterm(const string & message)
{
	if(!wdb)
		throw_read_only();
...
void RemoteServer::msg_replacedocument(const string & message)
{
	if(!wdb)
		throw_read_only();
...
void RemoteServer::msg_replacedocumentterm(const string & message)
{
	if(!wdb)
		throw_read_only();
...
void RemoteServer::msg_getmetadata(const string & message)
{
...
void RemoteServer::msg_setmetadata(const string & message)
{
	if(!wdb)
		throw_read_only();
	const char * p = message.data();
...
void RemoteServer::msg_addspelling(const string & message)
{
	if(!wdb)
		throw_read_only();
	const char * p = message.data();
...
void RemoteServer::msg_removespelling(const string & message)
{
	if(!wdb)
		throw_read_only();
	const char * p = message.data();
