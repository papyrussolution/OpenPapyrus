...
public:
	 ...
	 */
	bool data_modified() const { return LOGIC(data); }
	 ...
	 *  compared to an empty database.
	 */
	bool terms_modified() const { return LOGIC(terms); }
	 ...
	 *  compared to an empty database.
	 */
	bool values_modified() const { return LOGIC(values); }
	 ...
	 *  compared to an empty database.
	 */
	bool modified() const { return data_modified() || terms_modified() || values_modified(); }
