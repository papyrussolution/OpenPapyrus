...
TermList * GlassTermList::next()
{
	...
	if(!current_term.empty()) {
		...
		size_t len = static_cast<uchar>(*pos++);
	...
	size_t append_len = static_cast<uchar>(*pos++);
...
TermList * GlassTermList::skip_to(const string & term)
{
...
PositionList* GlassTermList::positionlist_begin() const
{
