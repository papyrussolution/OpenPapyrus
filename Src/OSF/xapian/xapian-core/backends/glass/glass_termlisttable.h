...
public:
	 ...
	 */
	GlassTermListTable(const std::string & dbdir, bool readonly, bool lazy_) : GlassTable("termlist", dbdir + "/termlist.", readonly, lazy_) 
	{
	}
	GlassTermListTable(int fd, off_t offset_, bool readonly, bool lazy_) : GlassTable("termlist", fd, offset_, readonly, lazy_) 
	{
	}
