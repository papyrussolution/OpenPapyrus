...
GLOBAL(int) jsimd_can_rgb_ycc(void)
{
	init_simd();
...
GLOBAL(int) jsimd_can_rgb_gray(void)
{
	init_simd();
...
GLOBAL(int) jsimd_can_ycc_rgb(void)
{
	init_simd();
...
GLOBAL(int) jsimd_can_ycc_rgb565(void)
{
	return 0;
}

GLOBAL(void) jsimd_rgb_ycc_convert(j_compress_ptr cinfo,
...
GLOBAL(void) jsimd_rgb_gray_convert(j_compress_ptr cinfo,
    JSAMPARRAY input_buf, JSAMPIMAGE output_buf,
    JDIMENSION output_row, int num_rows)
{
	void (* sse2fct)(JDIMENSION, JSAMPARRAY, JSAMPIMAGE, JDIMENSION, int);
...
GLOBAL(void) jsimd_ycc_rgb_convert(j_decompress_ptr cinfo,
...
GLOBAL(void) jsimd_ycc_rgb565_convert(j_decompress_ptr cinfo, JSAMPIMAGE input_buf, JDIMENSION input_row, JSAMPARRAY output_buf, int num_rows)
{
}

GLOBAL(int) jsimd_can_h2v2_downsample(void)
{
	init_simd();
...
GLOBAL(int) jsimd_can_h2v1_downsample(void)
{
	init_simd();
...
GLOBAL(int) jsimd_can_h2v2_upsample(void)
{
	init_simd();
...
GLOBAL(int) jsimd_can_h2v1_upsample(void)
{
	init_simd();
...
GLOBAL(int) jsimd_can_h2v2_fancy_upsample(void)
{
	init_simd();
...
GLOBAL(int) jsimd_can_h2v1_fancy_upsample(void)
{
	init_simd();
	/* The code is optimised for these values only */
	if(BITS_IN_JSAMPLE != 8)
...
GLOBAL(int) jsimd_can_h2v2_merged_upsample(void)
{
	init_simd();
	/* The code is optimised for these values only */
	if(BITS_IN_JSAMPLE != 8)
...
GLOBAL(int) jsimd_can_h2v1_merged_upsample(void)
{
	init_simd();
...
GLOBAL(int) jsimd_can_convsamp(void)
{
	init_simd();
...
GLOBAL(int) jsimd_can_convsamp_float(void)
{
	init_simd();
...
GLOBAL(void) jsimd_convsamp(JSAMPARRAY sample_data, JDIMENSION start_col,
    DCTELEM *workspace)
{
	if(simd_support & JSIMD_SSE2)
...
GLOBAL(void) jsimd_convsamp_float(JSAMPARRAY sample_data, JDIMENSION start_col,
...
GLOBAL(int) jsimd_can_fdct_islow(void)
{
	init_simd();
...
GLOBAL(int) jsimd_can_fdct_ifast(void)
{
	init_simd();
...
GLOBAL(int) jsimd_can_fdct_float(void)
{
	init_simd();
...
GLOBAL(void) jsimd_fdct_islow(DCTELEM *data)
{
	if((simd_support & JSIMD_SSE2) && IS_ALIGNED_SSE(jconst_fdct_islow_sse2))
...
GLOBAL(void) jsimd_fdct_ifast(DCTELEM *data)
{
	if((simd_support & JSIMD_SSE2) && IS_ALIGNED_SSE(jconst_fdct_islow_sse2))
...
GLOBAL(void) jsimd_fdct_float(FAST_FLOAT *data)
{
	if((simd_support & JSIMD_SSE) && IS_ALIGNED_SSE(jconst_fdct_float_sse))
...
GLOBAL(int) jsimd_can_quantize(void)
{
	init_simd();
...
GLOBAL(int) jsimd_can_quantize_float(void)
{
	init_simd();
...
GLOBAL(void) jsimd_quantize(JCOEFPTR coef_block, DCTELEM *divisors,
    DCTELEM *workspace)
{
	if(simd_support & JSIMD_SSE2)
...
GLOBAL(int) jsimd_can_idct_2x2(void)
{
	init_simd();
	/* The code is optimised for these values only */
	if(DCTSIZE != 8)
...
GLOBAL(int) jsimd_can_idct_4x4(void)
{
	init_simd();
	/* The code is optimised for these values only */
	if(DCTSIZE != 8)
...
GLOBAL(int) jsimd_can_idct_islow(void)
{
	init_simd();
	/* The code is optimised for these values only */
	if(DCTSIZE != 8)
...
GLOBAL(int) jsimd_can_idct_ifast(void)
{
	init_simd();
	/* The code is optimised for these values only */
	if(DCTSIZE != 8)
...
GLOBAL(int) jsimd_can_idct_float(void)
{
	init_simd();
	if(DCTSIZE != 8)
		return 0;
...
GLOBAL(void) jsimd_idct_islow(j_decompress_ptr cinfo, jpeg_component_info *compptr,
    JCOEFPTR coef_block, JSAMPARRAY output_buf, JDIMENSION output_col)
{
	if((simd_support & JSIMD_SSE2) && IS_ALIGNED_SSE(jconst_idct_islow_sse2))
...
GLOBAL(int) jsimd_can_huff_encode_one_block(void)
{
	init_simd();
	if(DCTSIZE != 8)
		return 0;
