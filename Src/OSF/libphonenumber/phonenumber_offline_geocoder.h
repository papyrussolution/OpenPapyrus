...
namespace i18n {
	namespace phonenumbers {
		...
		public:
			...
			// For tests
			PhoneNumberOfflineGeocoder(const int* country_calling_codes,
			...
			string GetDescriptionForNumber(const PhoneNumber& number, const Locale& locale) const;
		...
		private:
			...
			string GetCountryNameForNumber(const PhoneNumber& number, const Locale& language) const;
