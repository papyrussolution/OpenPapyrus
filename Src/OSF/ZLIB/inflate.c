...
static int updatewindow OF((z_streamp strm, const unsigned char * end, unsigned copy));
#ifdef BUILDFIXED
void makefixed OF((void));
#endif
static unsigned syncsearch OF((unsigned * have, const unsigned char * buf, unsigned len));
