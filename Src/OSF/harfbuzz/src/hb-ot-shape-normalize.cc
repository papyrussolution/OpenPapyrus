...
static bool decompose_unicode(const hb_ot_shape_normalize_context_t * c,
    hb_codepoint_t ab,
    hb_codepoint_t * a,
    hb_codepoint_t * b)
{
...
static bool compose_unicode(const hb_ot_shape_normalize_context_t * c,
    hb_codepoint_t a,
    hb_codepoint_t b,
    hb_codepoint_t * ab)
{
...
void _hb_ot_shape_normalize(const hb_ot_shape_plan_t * plan,
    hb_buffer_t * buffer,
    hb_font_t * font)
{
