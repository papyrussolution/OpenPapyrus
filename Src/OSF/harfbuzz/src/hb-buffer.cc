 ...
 *
 * Return value: %true if all properties of @a equal those of @b, false otherwise.
 *
 * Since: 0.9.7
 **/
...
void hb_buffer_t::add_info(const hb_glyph_info_t &glyph_info)
{
 ...
 * Since: 0.9.7
 **/
hb_buffer_flags_t hb_buffer_get_flags(const hb_buffer_t * buffer) { return buffer->flags; }
/**
 ...
 *
 * Return value: %true if @buffer memory allocation succeeded, %false otherwise.
 *
 * Since: 0.9.2
 **/
