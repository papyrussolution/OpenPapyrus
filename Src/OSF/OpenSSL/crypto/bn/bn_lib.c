...
static void FASTCALL bn_free_d(BIGNUM * a)
{
...
BIGNUM * FASTCALL BN_copy(BIGNUM * a, const BIGNUM * b)
{
	int i;
	BN_ULONG * A;
	const BN_ULONG * B;
...
/* ignore negative */
static int bn2binpad(const BIGNUM * a, uchar * to, int tolen)
{
	int i;
	BN_ULONG l;
	bn_check_top(a);
