...
static int ndef_prefix_free(BIO * b, uchar ** pbuf, int * plen, void * parg);
static int ndef_suffix(BIO * b, uchar ** pbuf, int * plen, void * parg);
static int ndef_suffix_free(BIO * b, uchar ** pbuf, int * plen, void * parg);
...
BIO * BIO_new_NDEF(BIO * out, ASN1_VALUE * val, const ASN1_ITEM * it)
{
	...
	/*
	 * Now let callback prepends any digest, cipher etc BIOs ASN1 structure needs.
	 */
	sarg.out = out;
	sarg.ndef_bio = NULL;
	sarg.boundary = NULL;
