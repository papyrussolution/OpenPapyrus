...
static size_t FASTCALL asn1_put_uint64(uchar * b, uint64_t r)
{
	if(r >= 0x100) {
		uchar * p;
		uint64_t rtmp = r;
 ...
 * overflow warnings.
 */
#define ABS_INT64_MIN ((uint64_t)INT64_MAX + (uint64_t)(-(INT64_MIN + INT64_MAX)))

/* signed version of asn1_get_uint64 */
static int asn1_get_int64(int64_t * pr, const uchar * b, size_t blen, int neg)
{
	uint64_t r;
...
ASN1_INTEGER * c2i_ASN1_INTEGER(ASN1_INTEGER ** a, const uchar ** pp, long len)
{
	ASN1_INTEGER * ret = NULL;
	int neg;
	size_t r = c2i_ibuf(NULL, NULL, *pp, len);
	if(r) {
		if((a == NULL) || ((*a) == NULL)) {
...
static int asn1_string_get_int64(int64_t * pr, const ASN1_STRING * a, int itype)
{
	...
	else if((a->type & ~V_ASN1_NEG) != itype) {
...
static int asn1_string_set_int64(ASN1_STRING * a, int64_t r, int itype)
{
	...
	return (l == 0) ? 0 : ASN1_STRING_set(a, tbuf, l);
}
