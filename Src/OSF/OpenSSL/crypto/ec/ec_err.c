...
static ERR_STRING_DATA EC_str_functs[] = {
	...
	{ERR_FUNC(EC_F_EC_GROUP_GET_ECPKPARAMETERS), "EC_GROUP_get_ecpkparameters"},
	...
	{ERR_FUNC(EC_F_EC_GROUP_NEW_FROM_ECPARAMETERS), "EC_GROUP_new_from_ecparameters"},
	{ERR_FUNC(EC_F_EC_GROUP_NEW_FROM_ECPKPARAMETERS), "EC_GROUP_new_from_ecpkparameters"},
	...
	{ERR_FUNC(EC_F_EC_POINT_GET_AFFINE_COORDINATES), "EC_POINT_get_affine_coordinates" }, // @sobolev @v10.6.3
	{ERR_FUNC(EC_F_EC_POINT_SET_AFFINE_COORDINATES), "EC_POINT_set_affine_coordinates" }, // @sobolev @v10.6.3
