 ...
 */
void ec_GFp_nistp_points_make_affine_internal(size_t num, void * point_array, size_t felem_size, void * tmp_felems,
 ...
 *
 */
void ec_GFp_nistp_recode_scalar_bits(uchar * sign, uchar * digit, uchar in)
{
	uchar s, d;
