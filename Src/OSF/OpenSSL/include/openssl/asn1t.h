...
#define ADB_ENTRY(val, template_) { val, template_ }
...
#define ASN1_TFLG_OPTIONAL      (0x1) /* Field is optional */
#define ASN1_TFLG_SET_OF        (0x1 << 1) /* Field is a SET OF */
#define ASN1_TFLG_SEQUENCE_OF   (0x2 << 1) /* Field is a SEQUENCE OF */
/*
 * Special case: this refers to a SET OF that will be sorted into DER order
 * when encoded *and* the corresponding STACK will be modified to match the new order.
 */
#define ASN1_TFLG_SET_ORDER     (0x3 << 1)
#define ASN1_TFLG_SK_MASK       (0x3 << 1) /* Mask for SET OF or SEQUENCE OF */
/*
 * These flags mean the tag should be taken from the tag field. If EXPLICIT
 * then the underlying type is used for the inner tag.
 */
#define ASN1_TFLG_IMPTAG        (0x1 << 3) /* IMPLICIT tagging */
#define ASN1_TFLG_EXPTAG        (0x2 << 3) /* EXPLICIT tagging, inner tag from underlying type */
#define ASN1_TFLG_TAG_MASK      (0x3 << 3)
#define ASN1_TFLG_IMPLICIT      ASN1_TFLG_IMPTAG|ASN1_TFLG_CONTEXT /* context specific IMPLICIT */
#define ASN1_TFLG_EXPLICIT      ASN1_TFLG_EXPTAG|ASN1_TFLG_CONTEXT /* context specific EXPLICIT */
 ...
 * actual octet format.
 */
#define ASN1_TFLG_UNIVERSAL     (0x0<<6) /* Universal tag */
#define ASN1_TFLG_APPLICATION   (0x1<<6) /* Application tag */
#define ASN1_TFLG_CONTEXT       (0x2<<6) /* Context specific tag */
#define ASN1_TFLG_PRIVATE       (0x3<<6) /* Private tag */
...
/*@funcdef*/ typedef int ASN1_ex_d2i (ASN1_VALUE **pval, const uchar **in, long len, const ASN1_ITEM *it, int tag, int aclass, char opt,
    ASN1_TLC *ctx);
/*@funcdef*/ typedef int ASN1_ex_i2d (ASN1_VALUE **pval, uchar **out, const ASN1_ITEM *it, int tag, int aclass);
/*@funcdef*/ typedef int ASN1_ex_new_func (ASN1_VALUE **pval, const ASN1_ITEM *it);
/*@funcdef*/ typedef void ASN1_ex_free_func (ASN1_VALUE **pval, const ASN1_ITEM *it);
/*@funcdef*/ typedef int ASN1_ex_print_func (BIO *out, ASN1_VALUE **pval, int indent, const char * fname, const ASN1_PCTX *pctx);
/*@funcdef*/ typedef int ASN1_primitive_i2c (ASN1_VALUE **pval, uchar *cont, int * putype, const ASN1_ITEM *it);
/*@funcdef*/ typedef int ASN1_primitive_c2i (ASN1_VALUE **pval, const uchar *cont, int len, int utype, char * free_cont, const ASN1_ITEM *
    it);
/*@funcdef*/ typedef int ASN1_primitive_print (BIO *out, ASN1_VALUE **pval, const ASN1_ITEM *it, int indent, const ASN1_PCTX *pctx);
 ...
 * more appropriate.
 */
/*@funcdef*/ typedef int ASN1_aux_cb (int operation, ASN1_VALUE **in, const ASN1_ITEM *it, void * exarg);
...
#define IMPLEMENT_ASN1_ENCODE_FUNCTIONS_fname(stname, itname, fname) \
	stname *d2i_ ## fname(stname **a, const uchar **in, long len) \
		{ return (stname*)ASN1_item_d2i((ASN1_VALUE**)a, in, len, ASN1_ITEM_rptr(itname)); } \
	int i2d_ ## fname(stname *a, uchar **out) \
		{ return ASN1_item_i2d((ASN1_VALUE*)a, out, ASN1_ITEM_rptr(itname)); }

#define IMPLEMENT_ASN1_NDEF_FUNCTION(stname) \
	int i2d_ ## stname ## _NDEF(stname *a, uchar **out) \
		{ return ASN1_item_ndef_i2d((ASN1_VALUE*)a, out, ASN1_ITEM_rptr(stname)); }

#define IMPLEMENT_STATIC_ASN1_ENCODE_FUNCTIONS(stname) \
	static stname *d2i_ ## stname(stname **a, const uchar **in, long len)	\
		{ return (stname*)ASN1_item_d2i((ASN1_VALUE**)a, in, len, ASN1_ITEM_rptr(stname)); } \
	static int i2d_ ## stname(stname *a, uchar **out) \
...
#define IMPLEMENT_ASN1_ENCODE_FUNCTIONS_const_fname(stname, itname, fname) \
	stname *d2i_ ## fname(stname **a, const uchar **in, long len) \
		{ return (stname*)ASN1_item_d2i((ASN1_VALUE**)a, in, len, ASN1_ITEM_rptr(itname)); } \
	int i2d_ ## fname(const stname *a, uchar **out)	\
		{ return ASN1_item_i2d((ASN1_VALUE*)a, out, ASN1_ITEM_rptr(itname)); }

#define IMPLEMENT_ASN1_DUP_FUNCTION(stname) stname * stname ## _dup(stname *x) { return (stname*)ASN1_item_dup(ASN1_ITEM_rptr(stname), x); }
...
int ASN1_item_ex_i2d(ASN1_VALUE ** pval, uchar ** out, const ASN1_ITEM * it, int tag, int aclass);
