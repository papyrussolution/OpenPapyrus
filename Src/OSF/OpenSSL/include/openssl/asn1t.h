...
typedef int ASN1_ex_i2d(ASN1_VALUE **pval, uchar **out, const ASN1_ITEM *it, int tag, int aclass);
...
typedef int ASN1_primitive_i2c(ASN1_VALUE **pval, uchar *cont, int *putype, const ASN1_ITEM *it);
