...
TS_TST_INFO *d2i_TS_TST_INFO(TS_TST_INFO **a, const uchar **pp,
                             long length);
...
TS_ACCURACY *d2i_TS_ACCURACY(TS_ACCURACY **a, const uchar **pp,
                             long length);
...
ESS_CERT_ID *d2i_ESS_CERT_ID(ESS_CERT_ID **a, const uchar **pp,
                             long length);
