...
#define ASN1_LONG_UNDEF 0x7fffffffL /* Used with ASN1 LONG type: if a long is set to this it is omitted */
...
#define B_ASN1_PRINTABLE B_ASN1_NUMERICSTRING|B_ASN1_PRINTABLESTRING|B_ASN1_T61STRING|B_ASN1_IA5STRING| \
	B_ASN1_BIT_STRING|B_ASN1_UNIVERSALSTRING|B_ASN1_BMPSTRING|B_ASN1_UTF8STRING|B_ASN1_SEQUENCE|B_ASN1_UNKNOWN
...
ASN1_INTEGER * d2i_ASN1_UINTEGER(ASN1_INTEGER **a, const uchar **pp, long length);
ASN1_INTEGER * FASTCALL ASN1_INTEGER_dup(const ASN1_INTEGER * x);
int FASTCALL ASN1_INTEGER_cmp(const ASN1_INTEGER * x, const ASN1_INTEGER * y);
...
int ASN1_OCTET_STRING_set(ASN1_OCTET_STRING * str, const uchar * data, int len);
...
ASN1_OBJECT * ASN1_OBJECT_create(int nid, uchar * data, int len, const char * sn, const char * ln);
...
int SMIME_write_ASN1(BIO *bio, ASN1_VALUE *val, BIO *data, int flags, int ctype_nid, int econt_nid, STACK_OF(
	    X509_ALGOR) *mdalgs, const ASN1_ITEM *it);
