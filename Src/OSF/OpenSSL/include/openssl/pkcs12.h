...
PKCS12_SAFEBAG *PKCS12_SAFEBAG_create_pkcs8_encrypt(int pbe_nid, const char *pass, int passlen, uchar *salt, int saltlen, int iter, PKCS8_PRIV_KEY_INFO *p8inf);
...
X509_SIG *PKCS8_encrypt(int pbe_nid, const EVP_CIPHER *cipher, const char *pass, int passlen, uchar *salt, int saltlen, int iter, PKCS8_PRIV_KEY_INFO *p8);
...
int PKCS12_key_gen_asc(const char *pass, int passlen, uchar *salt, int saltlen, int id, int iter, int n, uchar *out, const EVP_MD *md_type);
int PKCS12_key_gen_uni(uchar *pass, int passlen, uchar *salt, int saltlen, int id, int iter, int n, uchar *out, const EVP_MD *md_type);
int PKCS12_key_gen_utf8(const char *pass, int passlen, uchar *salt, int saltlen, int id, int iter, int n, uchar *out, const EVP_MD *md_type);
...
PKCS12 *PKCS12_create(const char *pass, const char *name, EVP_PKEY *pkey, X509 *cert, STACK_OF(X509) *ca, int nid_key, int nid_cert,
