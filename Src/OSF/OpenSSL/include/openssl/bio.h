...
#define BIO_get_conn_hostname(b)      (static_cast<const char *>(BIO_ptr_ctrl(b,BIO_C_GET_CONNECT,0)))
#define BIO_get_conn_port(b)          (static_cast<const char *>(BIO_ptr_ctrl(b,BIO_C_GET_CONNECT,1)))
#define BIO_get_conn_address(b)       (static_cast<const BIO_ADDR *>(BIO_ptr_ctrl(b,BIO_C_GET_CONNECT,2)))
...
#define BIO_get_accept_name(b)        (static_cast<const char *>(BIO_ptr_ctrl(b,BIO_C_GET_ACCEPT,0)))
#define BIO_get_accept_port(b)        (static_cast<const char *>(BIO_ptr_ctrl(b,BIO_C_GET_ACCEPT,1)))
#define BIO_get_peer_name(b)          (static_cast<const char *>(BIO_ptr_ctrl(b,BIO_C_GET_ACCEPT,2)))
#define BIO_get_peer_port(b)          (static_cast<const char *>(BIO_ptr_ctrl(b,BIO_C_GET_ACCEPT,3)))
/* #define BIO_set_nbio(b,n)    BIO_ctrl(b,BIO_C_SET_NBIO,(n),NULL) */
...
void   FASTCALL BIO_set_data(BIO *a, void *ptr);
void * FASTCALL BIO_get_data(BIO *a);
void   FASTCALL BIO_set_init(BIO *a, int init);
int    FASTCALL BIO_get_init(BIO *a);
 ...
 * Otherwise returns 0 and sets *bio1 and *bio2 to NULL. Size 0 uses default value.
 */
