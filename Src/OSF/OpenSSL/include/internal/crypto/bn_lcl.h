...
//#include <openssl/opensslconf.h>
	...
	// @sobolev #include "internal/bn_conf.h"
#endif
...
#  define bn_check_top(a) \
	do { \
		...
		if(_bnum2 != NULL) { \
			OPENSSL_assert(((_bnum2->top == 0) && !_bnum2->neg) || (_bnum2->top && (_bnum2->d[_bnum2->top - 1] != 0))); \
			bn_pollute(_bnum2); \
		} \
	} while(0)
...
#  define bn_wcheck_size(bn, words) \
	do { \
		...
		OPENSSL_assert((words) <= (_bnum2)->dmax && (words) >= (_bnum2)->top); \
