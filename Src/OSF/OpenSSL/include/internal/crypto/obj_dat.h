...
#define NUM_NID (1211) // @sobolev @v10.6.3 1061-->1211
static const ASN1_OBJECT nid_objs[NUM_NID] = {
	...
	//
	{ NULL, NULL, NID_undef },// {"Poly1305", "poly1305", NID_poly1305},
	{ NULL, NULL, NID_undef },// {"SipHash", "siphash", NID_siphash},
	{ NULL, NULL, NID_undef },// {"KxANY", "kx-any", NID_kx_any},
	{ NULL, NULL, NID_undef },// {"AuthANY", "auth-any", NID_auth_any},
	{ NULL, NULL, NID_undef },// {"ARIA-128-ECB", "aria-128-ecb", NID_aria_128_ecb, 9, &so[6780]},
	{ NULL, NULL, NID_undef },// {"ARIA-128-CBC", "aria-128-cbc", NID_aria_128_cbc, 9, &so[6789]},
	{ NULL, NULL, NID_undef },// {"ARIA-128-CFB", "aria-128-cfb", NID_aria_128_cfb128, 9, &so[6798]},
	{ NULL, NULL, NID_undef },// {"ARIA-128-OFB", "aria-128-ofb", NID_aria_128_ofb128, 9, &so[6807]},
	{ NULL, NULL, NID_undef },// {"ARIA-128-CTR", "aria-128-ctr", NID_aria_128_ctr, 9, &so[6816]},
	{ NULL, NULL, NID_undef },// {"ARIA-192-ECB", "aria-192-ecb", NID_aria_192_ecb, 9, &so[6825]},
	{ NULL, NULL, NID_undef },// {"ARIA-192-CBC", "aria-192-cbc", NID_aria_192_cbc, 9, &so[6834]},
	{ NULL, NULL, NID_undef },// {"ARIA-192-CFB", "aria-192-cfb", NID_aria_192_cfb128, 9, &so[6843]},
	{ NULL, NULL, NID_undef },// {"ARIA-192-OFB", "aria-192-ofb", NID_aria_192_ofb128, 9, &so[6852]},
	{ NULL, NULL, NID_undef },// {"ARIA-192-CTR", "aria-192-ctr", NID_aria_192_ctr, 9, &so[6861]},
	{ NULL, NULL, NID_undef },// {"ARIA-256-ECB", "aria-256-ecb", NID_aria_256_ecb, 9, &so[6870]},
	{ NULL, NULL, NID_undef },// {"ARIA-256-CBC", "aria-256-cbc", NID_aria_256_cbc, 9, &so[6879]},
	{ NULL, NULL, NID_undef },// {"ARIA-256-CFB", "aria-256-cfb", NID_aria_256_cfb128, 9, &so[6888]},
	{ NULL, NULL, NID_undef },// {"ARIA-256-OFB", "aria-256-ofb", NID_aria_256_ofb128, 9, &so[6897]},
	{ NULL, NULL, NID_undef },// {"ARIA-256-CTR", "aria-256-ctr", NID_aria_256_ctr, 9, &so[6906]},
	{ NULL, NULL, NID_undef },// {"ARIA-128-CFB1", "aria-128-cfb1", NID_aria_128_cfb1},
	{ NULL, NULL, NID_undef },// {"ARIA-192-CFB1", "aria-192-cfb1", NID_aria_192_cfb1},
	{ NULL, NULL, NID_undef },// {"ARIA-256-CFB1", "aria-256-cfb1", NID_aria_256_cfb1},
	{ NULL, NULL, NID_undef },// {"ARIA-128-CFB8", "aria-128-cfb8", NID_aria_128_cfb8},
	{ NULL, NULL, NID_undef },// {"ARIA-192-CFB8", "aria-192-cfb8", NID_aria_192_cfb8},
	{ NULL, NULL, NID_undef },// {"ARIA-256-CFB8", "aria-256-cfb8", NID_aria_256_cfb8},
	{ NULL, NULL, NID_undef },// {"id-smime-aa-signingCertificateV2", "id-smime-aa-signingCertificateV2", NID_id_smime_aa_signingCertificateV2, 11, &so[6915]},
	{ NULL, NULL, NID_undef },// {"ED25519", "ED25519", NID_ED25519, 3, &so[6926]},
	{ NULL, NULL, NID_undef },// {"ED448", "ED448", NID_ED448, 3, &so[6929]},
	{ NULL, NULL, NID_undef },// {"organizationIdentifier", "organizationIdentifier", NID_organizationIdentifier, 3, &so[6932]},
	{ NULL, NULL, NID_undef },// {"c3", "countryCode3c", NID_countryCode3c, 3, &so[6935]},
	{ NULL, NULL, NID_undef },// {"n3", "countryCode3n", NID_countryCode3n, 3, &so[6938]},
	{ NULL, NULL, NID_undef },// {"dnsName", "dnsName", NID_dnsName, 3, &so[6941]},
	{ NULL, NULL, NID_undef },// {"x509ExtAdmission", "Professional Information or basis for Admission", NID_x509ExtAdmission, 5, &so[6944]},
	{ NULL, NULL, NID_undef },// {"SHA512-224", "sha512-224", NID_sha512_224, 9, &so[6949]},
	{ NULL, NULL, NID_undef },// {"SHA512-256", "sha512-256", NID_sha512_256, 9, &so[6958]},
	{ NULL, NULL, NID_undef },// {"SHA3-224", "sha3-224", NID_sha3_224, 9, &so[6967]},
	{ NULL, NULL, NID_undef },// {"SHA3-256", "sha3-256", NID_sha3_256, 9, &so[6976]},
	{ NULL, NULL, NID_undef },// {"SHA3-384", "sha3-384", NID_sha3_384, 9, &so[6985]},
	{ NULL, NULL, NID_undef },// {"SHA3-512", "sha3-512", NID_sha3_512, 9, &so[6994]},
	{ NULL, NULL, NID_undef },// {"SHAKE128", "shake128", NID_shake128, 9, &so[7003]},
	{ NULL, NULL, NID_undef },// {"SHAKE256", "shake256", NID_shake256, 9, &so[7012]},
	{ NULL, NULL, NID_undef },// {"id-hmacWithSHA3-224", "hmac-sha3-224", NID_hmac_sha3_224, 9, &so[7021]},
	{ NULL, NULL, NID_undef },// {"id-hmacWithSHA3-256", "hmac-sha3-256", NID_hmac_sha3_256, 9, &so[7030]},
	{ NULL, NULL, NID_undef },// {"id-hmacWithSHA3-384", "hmac-sha3-384", NID_hmac_sha3_384, 9, &so[7039]},
	{ NULL, NULL, NID_undef },// {"id-hmacWithSHA3-512", "hmac-sha3-512", NID_hmac_sha3_512, 9, &so[7048]},
	{ NULL, NULL, NID_undef },// {"id-dsa-with-sha384", "dsa_with_SHA384", NID_dsa_with_SHA384, 9, &so[7057]},
	{ NULL, NULL, NID_undef },// {"id-dsa-with-sha512", "dsa_with_SHA512", NID_dsa_with_SHA512, 9, &so[7066]},
	{ NULL, NULL, NID_undef },// {"id-dsa-with-sha3-224", "dsa_with_SHA3-224", NID_dsa_with_SHA3_224, 9, &so[7075]},
	{ NULL, NULL, NID_undef },// {"id-dsa-with-sha3-256", "dsa_with_SHA3-256", NID_dsa_with_SHA3_256, 9, &so[7084]},
	{ NULL, NULL, NID_undef },// {"id-dsa-with-sha3-384", "dsa_with_SHA3-384", NID_dsa_with_SHA3_384, 9, &so[7093]},
	{ NULL, NULL, NID_undef },// {"id-dsa-with-sha3-512", "dsa_with_SHA3-512", NID_dsa_with_SHA3_512, 9, &so[7102]},
	{ NULL, NULL, NID_undef },// {"id-ecdsa-with-sha3-224", "ecdsa_with_SHA3-224", NID_ecdsa_with_SHA3_224, 9, &so[7111]},
	{ NULL, NULL, NID_undef },// {"id-ecdsa-with-sha3-256", "ecdsa_with_SHA3-256", NID_ecdsa_with_SHA3_256, 9, &so[7120]},
	{ NULL, NULL, NID_undef },// {"id-ecdsa-with-sha3-384", "ecdsa_with_SHA3-384", NID_ecdsa_with_SHA3_384, 9, &so[7129]},
	{ NULL, NULL, NID_undef },// {"id-ecdsa-with-sha3-512", "ecdsa_with_SHA3-512", NID_ecdsa_with_SHA3_512, 9, &so[7138]},
	{ NULL, NULL, NID_undef },// {"id-rsassa-pkcs1-v1_5-with-sha3-224", "RSA-SHA3-224", NID_RSA_SHA3_224, 9, &so[7147]},
	{ NULL, NULL, NID_undef },// {"id-rsassa-pkcs1-v1_5-with-sha3-256", "RSA-SHA3-256", NID_RSA_SHA3_256, 9, &so[7156]},
	{ NULL, NULL, NID_undef },// {"id-rsassa-pkcs1-v1_5-with-sha3-384", "RSA-SHA3-384", NID_RSA_SHA3_384, 9, &so[7165]},
	{ NULL, NULL, NID_undef },// {"id-rsassa-pkcs1-v1_5-with-sha3-512", "RSA-SHA3-512", NID_RSA_SHA3_512, 9, &so[7174]},
	{ NULL, NULL, NID_undef },// {"ARIA-128-CCM", "aria-128-ccm", NID_aria_128_ccm, 9, &so[7183]},
	{ NULL, NULL, NID_undef },// {"ARIA-192-CCM", "aria-192-ccm", NID_aria_192_ccm, 9, &so[7192]},
	{ NULL, NULL, NID_undef },// {"ARIA-256-CCM", "aria-256-ccm", NID_aria_256_ccm, 9, &so[7201]},
	{ NULL, NULL, NID_undef },// {"ARIA-128-GCM", "aria-128-gcm", NID_aria_128_gcm, 9, &so[7210]},
	{ NULL, NULL, NID_undef },// {"ARIA-192-GCM", "aria-192-gcm", NID_aria_192_gcm, 9, &so[7219]},
	{ NULL, NULL, NID_undef },// {"ARIA-256-GCM", "aria-256-gcm", NID_aria_256_gcm, 9, &so[7228]},
	{ NULL, NULL, NID_undef },// {"ffdhe2048", "ffdhe2048", NID_ffdhe2048},
	{ NULL, NULL, NID_undef },// {"ffdhe3072", "ffdhe3072", NID_ffdhe3072},
	{ NULL, NULL, NID_undef },// {"ffdhe4096", "ffdhe4096", NID_ffdhe4096},
	{ NULL, NULL, NID_undef },// {"ffdhe6144", "ffdhe6144", NID_ffdhe6144},
	{ NULL, NULL, NID_undef },// {"ffdhe8192", "ffdhe8192", NID_ffdhe8192},
	{ NULL, NULL, NID_undef },// {"cmcCA", "CMC Certificate Authority", NID_cmcCA, 8, &so[7237]},
	{ NULL, NULL, NID_undef },// {"cmcRA", "CMC Registration Authority", NID_cmcRA, 8, &so[7245]},
	{ NULL, NULL, NID_undef },// {"SM4-ECB", "sm4-ecb", NID_sm4_ecb, 8, &so[7253]},
	{ NULL, NULL, NID_undef },// {"SM4-CBC", "sm4-cbc", NID_sm4_cbc, 8, &so[7261]},
	{ NULL, NULL, NID_undef },// {"SM4-OFB", "sm4-ofb", NID_sm4_ofb128, 8, &so[7269]},
	{ NULL, NULL, NID_undef },// {"SM4-CFB1", "sm4-cfb1", NID_sm4_cfb1, 8, &so[7277]},
	{ NULL, NULL, NID_undef },// {"SM4-CFB", "sm4-cfb", NID_sm4_cfb128, 8, &so[7285]},
	{ NULL, NULL, NID_undef },// {"SM4-CFB8", "sm4-cfb8", NID_sm4_cfb8, 8, &so[7293]},
	{ NULL, NULL, NID_undef },// {"SM4-CTR", "sm4-ctr", NID_sm4_ctr, 8, &so[7301]},
	{ NULL, NULL, NID_undef },// {"ISO-CN", "ISO CN Member Body", NID_ISO_CN, 3, &so[7309]},
	{ NULL, NULL, NID_undef },// {"oscca", "oscca", NID_oscca, 5, &so[7312]},
	{ NULL, NULL, NID_undef },// {"sm-scheme", "sm-scheme", NID_sm_scheme, 6, &so[7317]},
	{ NULL, NULL, NID_undef },// {"SM3", "sm3", NID_sm3, 8, &so[7323]},
	{ NULL, NULL, NID_undef },// {"RSA-SM3", "sm3WithRSAEncryption", NID_sm3WithRSAEncryption, 8, &so[7331]},
	{ NULL, NULL, NID_undef },// {"RSA-SHA512/224", "sha512-224WithRSAEncryption", NID_sha512_224WithRSAEncryption, 9, &so[7339]},
	{ NULL, NULL, NID_undef },// {"RSA-SHA512/256", "sha512-256WithRSAEncryption", NID_sha512_256WithRSAEncryption, 9, &so[7348]},
	{ NULL, NULL, NID_undef },// {"id-tc26-gost-3410-2012-256-constants", "id-tc26-gost-3410-2012-256-constants", NID_id_tc26_gost_3410_2012_256_constants, 8, &so[7357]},
	...
	{ NULL, NULL, NID_undef },// {"ISO-UA", "ISO-UA", NID_ISO_UA, 3, &so[7383]},
	{ NULL, NULL, NID_undef },// {"ua-pki", "ua-pki", NID_ua_pki, 7, &so[7386]},
	{ NULL, NULL, NID_undef },// {"dstu28147", "DSTU Gost 28147-2009", NID_dstu28147, 10, &so[7393]},
	{ NULL, NULL, NID_undef },// {"dstu28147-ofb", "DSTU Gost 28147-2009 OFB mode", NID_dstu28147_ofb, 11, &so[7403]},
	{ NULL, NULL, NID_undef },// {"dstu28147-cfb", "DSTU Gost 28147-2009 CFB mode", NID_dstu28147_cfb, 11, &so[7414]},
	{ NULL, NULL, NID_undef },// {"dstu28147-wrap", "DSTU Gost 28147-2009 key wrap", NID_dstu28147_wrap, 11, &so[7425]},
	{ NULL, NULL, NID_undef },// {"hmacWithDstu34311", "HMAC DSTU Gost 34311-95", NID_hmacWithDstu34311, 10, &so[7436]},
	{ NULL, NULL, NID_undef },// {"dstu34311", "DSTU Gost 34311-95", NID_dstu34311, 10, &so[7446]},
	{ NULL, NULL, NID_undef },// {"dstu4145le", "DSTU 4145-2002 little endian", NID_dstu4145le, 11, &so[7456]},
	{ NULL, NULL, NID_undef },// {"dstu4145be", "DSTU 4145-2002 big endian", NID_dstu4145be, 13, &so[7467]},
	{ NULL, NULL, NID_undef },// {"uacurve0", "DSTU curve 0", NID_uacurve0, 13, &so[7480]},
	{ NULL, NULL, NID_undef },// {"uacurve1", "DSTU curve 1", NID_uacurve1, 13, &so[7493]},
	{ NULL, NULL, NID_undef },// {"uacurve2", "DSTU curve 2", NID_uacurve2, 13, &so[7506]},
	{ NULL, NULL, NID_undef },// {"uacurve3", "DSTU curve 3", NID_uacurve3, 13, &so[7519]},
	{ NULL, NULL, NID_undef },// {"uacurve4", "DSTU curve 4", NID_uacurve4, 13, &so[7532]},
	{ NULL, NULL, NID_undef },// {"uacurve5", "DSTU curve 5", NID_uacurve5, 13, &so[7545]},
	{ NULL, NULL, NID_undef },// {"uacurve6", "DSTU curve 6", NID_uacurve6, 13, &so[7558]},
	{ NULL, NULL, NID_undef },// {"uacurve7", "DSTU curve 7", NID_uacurve7, 13, &so[7571]},
	{ NULL, NULL, NID_undef },// {"uacurve8", "DSTU curve 8", NID_uacurve8, 13, &so[7584]},
	{ NULL, NULL, NID_undef },// {"uacurve9", "DSTU curve 9", NID_uacurve9, 13, &so[7597]},
	{ NULL, NULL, NID_undef },// {"ieee", "ieee", NID_ieee, 2, &so[7610]},
	{ NULL, NULL, NID_undef },// {"ieee-siswg", "IEEE Security in Storage Working Group", NID_ieee_siswg, 5, &so[7612]},
	{ NULL, NULL, NID_undef },// {"SM2", "sm2", NID_sm2, 8, &so[7617]},
	...
	{ NULL, NULL, NID_undef },// {"id-tc26-wrap", "id-tc26-wrap", NID_id_tc26_wrap, 7, &so[7677]},
	{ NULL, NULL, NID_undef },// {"id-tc26-wrap-gostr3412-2015-magma", "id-tc26-wrap-gostr3412-2015-magma", NID_id_tc26_wrap_gostr3412_2015_magma, 8, &so[7684]},
	{ NULL, NULL, NID_undef },// {"id-tc26-wrap-gostr3412-2015-magma-kexp15", "id-tc26-wrap-gostr3412-2015-magma-kexp15", NID_id_tc26_wrap_gostr3412_2015_magma_kexp15, 9, &so[7692]},
	{ NULL, NULL, NID_undef },// {"id-tc26-wrap-gostr3412-2015-kuznyechik", "id-tc26-wrap-gostr3412-2015-kuznyechik", NID_id_tc26_wrap_gostr3412_2015_kuznyechik, 8, &so[7701]},
	{ NULL, NULL, NID_undef },// {"id-tc26-wrap-gostr3412-2015-kuznyechik-kexp15", "id-tc26-wrap-gostr3412-2015-kuznyechik-kexp15", NID_id_tc26_wrap_gostr3412_2015_kuznyechik_kexp15, 9, &so[7709]},
	...
	{ NULL, NULL, NID_undef },// {"hmacWithSHA512-224", "hmacWithSHA512-224", NID_hmacWithSHA512_224, 8, &so[7745]},
	{ NULL, NULL, NID_undef },// {"hmacWithSHA512-256", "hmacWithSHA512-256", NID_hmacWithSHA512_256, 8, &so[7753]},
	{ NULL, NULL, NID_undef },// {"GMAC", "gmac", NID_gmac, 5, &so[7761]},
	{ NULL, NULL, NID_undef },// {"KMAC128", "kmac128", NID_kmac128, 9, &so[7766]},
	{ NULL, NULL, NID_undef },// {"KMAC256", "kmac256", NID_kmac256, 9, &so[7775]},
	{ NULL, NULL, NID_undef },// {"AES-128-SIV", "aes-128-siv", NID_aes_128_siv},
	{ NULL, NULL, NID_undef },// {"AES-192-SIV", "aes-192-siv", NID_aes_192_siv},
	{ NULL, NULL, NID_undef },// {"AES-256-SIV", "aes-256-siv", NID_aes_256_siv},
	{ NULL, NULL, NID_undef },// {"BLAKE2BMAC", "blake2bmac", NID_blake2bmac, 10, &so[7784]},
	{ NULL, NULL, NID_undef },// {"BLAKE2SMAC", "blake2smac", NID_blake2smac, 10, &so[7794]},
	{ NULL, NULL, NID_undef },// {"SSHKDF", "sshkdf", NID_sshkdf},
	{ NULL, NULL, NID_undef },// {"SM2-SM3", "SM2-with-SM3", NID_SM2_with_SM3, 8, &so[7804]},
	{ NULL, NULL, NID_undef },// {"SSKDF", "sskdf", NID_sskdf},
	{ NULL, NULL, NID_undef },// {"X963KDF", "x963kdf", NID_x963kdf},
	{ NULL, NULL, NID_undef },// {"X942KDF", "x942kdf", NID_x942kdf},
	{ NULL, NULL, NID_undef },// {"id-on-SmtpUTF8Mailbox", "Smtp UTF8 Mailbox", NID_id_on_SmtpUTF8Mailbox, 8, &so[7812]},
	{ NULL, NULL, NID_undef },// {"id-on-xmppAddr", "XmppAddr", NID_XmppAddr, 8, &so[7820]},
	{ NULL, NULL, NID_undef },// {"id-on-dnsSRV", "SRVName", NID_SRVName, 8, &so[7828]},
};
