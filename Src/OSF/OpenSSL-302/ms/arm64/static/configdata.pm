...
our %config = (
    ...
    "perlargv" => [
        ...
        "--with-zlib-lib=..\\zlib\\build\\ARM64\\Release\\libz-static.lib",
        "VC-WIN64-ARM",
        "no-shared",
        "no-dynamic-engine",
        "zlib"
...
our %withargs = (
    "zlib_include" => "..\\zlib",
    "zlib_lib" => "..\\zlib\\build\\ARM64\\Release\\libz-static.lib"
);
our %unified_info = (
    "attributes" => {
        "depends" => {
    ...
    "sources" => {
        ...
        "test\\helpers\\ssl_test-bin-handshake.o" => [
            ".\\test\\helpers\\handshake.c"
        ],
        "test\\helpers\\ssl_test-bin-handshake_srp.o" => [
            ".\\test\\helpers\\handshake_srp.c"
        ],
        "test\\helpers\\ssl_test-bin-ssl_test_ctx.o" => [
            ".\\test\\helpers\\ssl_test_ctx.c"
        ],
        "test\\helpers\\ssl_test_ctx_test-bin-ssl_test_ctx.o" => [
            ".\\test\\helpers\\ssl_test_ctx.c"
        ],
        ...
        "test\\testutil\\libtestutil-lib-options.o" => [
            ".\\test\\testutil\\options.c"
        ],
        "test\\testutil\\libtestutil-lib-output.o" => [
            ".\\test\\testutil\\output.c"
        ],
        "test\\testutil\\libtestutil-lib-provider.o" => [
            ".\\test\\testutil\\provider.c"
        ],
        "test\\testutil\\libtestutil-lib-random.o" => [
...
unless (caller) {
    ...
    my ( $t_libdir, $t_cfgdir, $t_modtxt );
    BEGIN {
        use File::Spec::Functions qw/rel2abs catdir catfile/;
        my $t_srcdir = rel2abs($ENV{SRCTOP} || $ENV{TOP} || '.');
        $t_libdir = catdir($t_srcdir, 'util', 'perl');
        $t_cfgdir = catdir($t_srcdir, 'Configurations');
        $t_modtxt = catfile($t_srcdir, 'external', 'perl', 'MODULES.txt');
        $t_modtxt =~ s/\\/\//g; # OpenSSL::fallback can only handle '/' as path separator.
    }

    #use lib './util/perl';
    #use OpenSSL::fallback './external/perl/MODULES.txt';
    use lib $t_libdir;
    use OpenSSL::fallback $t_modtxt;
