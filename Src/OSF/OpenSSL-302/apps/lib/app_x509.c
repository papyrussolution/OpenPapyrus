...
static ASN1_OCTET_STRING * mk_octet_string(void * value, size_t value_n)
{
	...
	else if(!ASN1_OCTET_STRING_set(v, (const unsigned char *)value, (int)value_n)) {
...
static int x509_ctrl(void * object, int cmd, void * value, size_t value_n)
{
	switch(cmd) {
		...
		case EVP_PKEY_CTRL_SET1_ID:
	    {
		    ...
		    X509_set0_distinguishing_id((X509 *)object, v);
		    return 1;
	    }
#endif
		default:
...
static int x509_req_ctrl(void * object, int cmd, void * value, size_t value_n)
{
	switch(cmd) {
		...
		case EVP_PKEY_CTRL_SET1_ID:
	    {
		    ...
		    X509_REQ_set0_distinguishing_id((X509_REQ *)object, v);
		    return 1;
	    }
#endif
		default:
