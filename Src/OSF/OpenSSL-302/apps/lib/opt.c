...
char * opt_progname(const char * argv0)
{
	size_t i;
	char * q;
	const char * p = opt_path_end(argv0);
...
static const char * valtype2param(const OPTIONS * o)
{
	switch(o->valtype) {
		...
		case 'l': return "long";
		case 'u': return "ulong";
		case 'E': return "PEM|DER|ENGINE";
		case 'F': return "PEM|DER";
		case 'f': return "format";
		case 'M': return "intmax";
		case 'N': return "nonneg";
		case 'U': return "uintmax";
	}
	return "parm";
}
...
static void opt_print(const OPTIONS * o, int doingparams, int width)
{
	char start[80 + 1];
	char * p;
	const char* help = o->helpstr ? o->helpstr : "(No additional info)";
