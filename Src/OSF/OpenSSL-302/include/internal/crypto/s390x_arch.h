...
void s390x_kimd(const uchar * in, size_t len, uint fc, void * param);
void s390x_klmd(const uchar * in, size_t inlen, uchar * out, size_t outlen, uint fc, void * param);
void s390x_km(const uchar * in, size_t len, uchar * out, uint fc, void * param);
void s390x_kmac(const uchar * in, size_t len, uint fc, void * param);
void s390x_kmo(const uchar * in, size_t len, uchar * out, uint fc, void * param);
void s390x_kmf(const uchar * in, size_t len, uchar * out, uint fc, void * param);
void s390x_kma(const uchar * aad, size_t alen, const uchar * in, size_t len, uchar * out, uint fc, void * param);
int s390x_pcc(uint fc, void * param);
int s390x_kdsa(uint fc, void * param, const uchar * in, size_t len);
...
int s390x_ed25519_mul(unsigned char x_dst[32], unsigned char y_dst[32], const unsigned char x_src[32], const unsigned char y_src[32], const unsigned char d_src[32]);
int s390x_ed448_mul(unsigned char x_dst[57], unsigned char y_dst[57], const unsigned char x_src[57], const unsigned char y_src[57], const unsigned char d_src[57]);
/*
...
#define S390X_STFLE_MAX       3 /* Max number of 64-bit words currently returned by STFLE */
#define S390X_CAPBIT(i)       (1ULL << (63 - (i) % 64)) /* convert facility bit number or function code to bit mask */
