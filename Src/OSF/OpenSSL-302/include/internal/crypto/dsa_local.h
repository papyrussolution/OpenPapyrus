...
struct dsa_method {
	...
	int (* dsa_paramgen) (DSA * dsa, int bits, const uchar * seed, int seed_len, int * counter_ret, unsigned long * h_ret, BN_GENCB * cb);
	/* If this is non-NULL, it is used to generate DSA keys */
	int (* dsa_keygen) (DSA * dsa);
};

DSA_SIG * ossl_dsa_do_sign_int(const uchar * dgst, int dlen, DSA * dsa);
