...
struct rsa_meth_st {
	char * name;
	int (* rsa_pub_enc) (int flen, const uchar * from, uchar * to, RSA * rsa, int padding);
	int (* rsa_pub_dec) (int flen, const uchar * from, uchar * to, RSA * rsa, int padding);
	int (* rsa_priv_enc) (int flen, const uchar * from, uchar * to, RSA * rsa, int padding);
	int (* rsa_priv_dec) (int flen, const uchar * from, uchar * to, RSA * rsa, int padding);
	/* Can be null */
	 ...
	 */
	int (* rsa_sign) (int type, const uchar * m, uint m_length, uchar * sigret, uint * siglen, const RSA * rsa);
	int (* rsa_verify) (int dtype, const uchar * m, uint m_length, const uchar * sigbuf, uint siglen, const RSA * rsa);
	/*
...
int ossl_rsa_padding_add_PKCS1_type_2_ex(OSSL_LIB_CTX * libctx, uchar * to, int tlen, const uchar * from, int flen);
