...
struct asn1_sctx_st {
	...
	unsigned long flags; /* Various flags associated with field and context */
...
int ossl_asn1_enc_restore(int * len, uchar ** out, const ASN1_VALUE ** pval, const ASN1_ITEM * it);
int ossl_asn1_enc_save(ASN1_VALUE ** pval, const uchar * in, int inlen, const ASN1_ITEM * it);
...
ASN1_OBJECT * ossl_c2i_ASN1_OBJECT(ASN1_OBJECT ** a, const uchar ** pp, long length);
int ossl_i2c_ASN1_BIT_STRING(ASN1_BIT_STRING * a, uchar ** pp);
ASN1_BIT_STRING * ossl_c2i_ASN1_BIT_STRING(ASN1_BIT_STRING ** a, const uchar ** pp, long length);
int ossl_i2c_ASN1_INTEGER(ASN1_INTEGER * a, uchar ** pp);
ASN1_INTEGER * ossl_c2i_ASN1_INTEGER(ASN1_INTEGER ** a, const uchar ** pp, long length);
/* Internal functions used by x_int64.c */
int ossl_c2i_uint64_int(uint64_t * ret, int * neg, const uchar ** pp, long len);
