...
#define MIDR_IMPLEMENTER(midr)   (((midr) & MIDR_IMPLEMENTER_MASK) >> MIDR_IMPLEMENTER_SHIFT)
#define MIDR_ARCHITECTURE_SHIFT  16
#define MIDR_ARCHITECTURE_MASK   (0xf << MIDR_ARCHITECTURE_SHIFT)
#define MIDR_ARCHITECTURE(midr)  (((midr) & MIDR_ARCHITECTURE_MASK) >> MIDR_ARCHITECTURE_SHIFT)
#define MIDR_CPU_MODEL_MASK (MIDR_IMPLEMENTER_MASK | MIDR_PARTNUM_MASK     | MIDR_ARCHITECTURE_MASK)
#define MIDR_CPU_MODEL(imp, partnum) (((imp)     << MIDR_IMPLEMENTER_SHIFT)  | (0xf       << MIDR_ARCHITECTURE_SHIFT) | ((partnum) << MIDR_PARTNUM_SHIFT))
#define MIDR_IS_CPU_MODEL(midr, imp, partnum) (((midr) & MIDR_CPU_MODEL_MASK) == MIDR_CPU_MODEL(imp, partnum))
#endif
