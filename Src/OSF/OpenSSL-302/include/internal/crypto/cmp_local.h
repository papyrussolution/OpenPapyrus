...
int ossl_cmp_asn1_octet_string_set1_bytes(ASN1_OCTET_STRING ** tgt, const uchar * bytes, int len);

/* from cmp_ctx.c */
int ossl_cmp_print_log(OSSL_CMP_severity level, const OSSL_CMP_CTX * ctx, const char * func, const char * file, int line, const char * level_str, const char * format, ...);
...
#define ossl_cmp_log2(level, ctx, fmt, arg1, arg2) ossl_cmp_print_log(OSSL_CMP_LOG_ ## level, ctx, OPENSSL_FUNC, OPENSSL_FILE, OPENSSL_LINE, #level, fmt, arg1, arg2)
#define ossl_cmp_log3(level, ctx, fmt, arg1, arg2, arg3) ossl_cmp_print_log(OSSL_CMP_LOG_ ## level, ctx, OPENSSL_FUNC, OPENSSL_FILE, OPENSSL_LINE, #level, fmt, arg1, arg2, arg3)
#define ossl_cmp_log4(level, ctx, fmt, arg1, arg2, arg3, arg4) ossl_cmp_print_log(OSSL_CMP_LOG_ ## level, ctx, OPENSSL_FUNC, OPENSSL_FILE, OPENSSL_LINE, #level, fmt, arg1, arg2, arg3, arg4)
...
OSSL_CMP_MSG * ossl_cmp_certrep_new(OSSL_CMP_CTX * ctx, int bodytype, int certReqId, const OSSL_CMP_PKISI * si, X509 * cert, const X509 * encryption_recip, STACK_OF(X509) *chain, STACK_OF(X509) *caPubs, int unprotectedErrors);
