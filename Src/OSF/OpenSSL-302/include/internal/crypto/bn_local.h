...
extern "C" void bn_sqr_words(BN_ULONG * rp, const BN_ULONG * ap, int num);
extern "C" BN_ULONG bn_div_words(BN_ULONG h, BN_ULONG l, BN_ULONG d);
extern "C" BN_ULONG bn_add_words(BN_ULONG * rp, const BN_ULONG * ap, const BN_ULONG * bp, int num);
extern "C" BN_ULONG bn_sub_words(BN_ULONG * rp, const BN_ULONG * ap, const BN_ULONG * bp, int num);
...
extern "C" BN_ULONG bn_sub_part_words(BN_ULONG * r, const BN_ULONG * a, const BN_ULONG * b, int cl, int dl);
extern "C" int bn_mul_mont(BN_ULONG * rp, const BN_ULONG * ap, const BN_ULONG * bp, const BN_ULONG * np, const BN_ULONG * n0, int num);
