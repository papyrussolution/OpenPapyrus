...
#define C448_SCALAR_BITS 446 /* The number of bits in a scalar */
#define C448_SCALAR_BYTES 56 /* Number of bytes in a serialized scalar. */
#define X448_ENCODE_RATIO 2 /* X448 encoding ratio. */
#define X448_PUBLIC_BYTES 56 /* Number of bytes in an x448 public key */
#define X448_PRIVATE_BYTES 56 /* Number of bytes in an x448 private key */
 ...
 * modulo that modulus.
 */
c448_error_t ossl_curve448_scalar_decode(curve448_scalar_t out,
 ...
 * b (in): Any point.
 */
static ossl_inline void curve448_point_copy(curve448_point_t a, const curve448_point_t b)
{
	*a = *b;
}
/*
 ...
 */
__owur c448_bool_t ossl_curve448_point_eq(const curve448_point_t a, const curve448_point_t b);
/*
 ...
 */
void ossl_curve448_base_double_scalarmul_non_secret(curve448_point_t combo, const curve448_scalar_t scalar1, const curve448_point_t base2, const curve448_scalar_t scalar2);
/*
