...
#elif defined(_MSC_VER) && _MSC_VER>=1200 && (defined(_M_IX86) || defined(_M_AMD64) || defined(_M_X64) || \
...
#  define tsan_counter(ptr) (sizeof(*(ptr)) == 8 ? _InterlockedExchangeAdd64(reinterpret_cast<volatile LONG64 *>(ptr), 1) : _InterlockedExchangeAdd((ptr), 1))
#  define tsan_decr(ptr) (sizeof(*(ptr)) == 8 ? _InterlockedExchangeAdd64(reinterpret_cast<volatile LONG64 *>(ptr), -1) : _InterlockedExchangeAdd((ptr), -1))
# else
