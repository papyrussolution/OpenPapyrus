 ...
 */
/*
 * Generated from pkcs12.h.in for https://github.com/kiyolee/openssl3-win-build.git.
 */
...
PKCS12_SAFEBAG *PKCS12_SAFEBAG_create_secret(int type, int vtype, const uchar *value, int len);
...
X509_SIG *PKCS8_encrypt(int pbe_nid, const EVP_CIPHER *cipher,
                        const char *pass, int passlen, uchar *salt,
...
uchar *PKCS12_pbe_crypt(const X509_ALGOR *algor,
                                ...
                                uchar **data, int *datalen,
                                int en_de);
uchar *PKCS12_pbe_crypt_ex(const X509_ALGOR *algor,
                                   const char *pass, int passlen,
                                   const uchar *in, int inlen,
                                   uchar **data, int *datalen,
...
int PKCS12_key_gen_asc_ex(const char *pass, int passlen, uchar *salt,
                          int saltlen, int id, int iter, int n,
                          uchar *out, const EVP_MD *md_type,
                          OSSL_LIB_CTX *ctx, const char *propq);
int PKCS12_key_gen_uni(uchar *pass, int passlen, uchar *salt,
                       int saltlen, int id, int iter, int n,
                       uchar *out, const EVP_MD *md_type);
int PKCS12_key_gen_uni_ex(uchar *pass, int passlen, uchar *salt,
                          int saltlen, int id, int iter, int n,
                          uchar *out, const EVP_MD *md_type,
                          OSSL_LIB_CTX *ctx, const char *propq);
int PKCS12_key_gen_utf8(const char *pass, int passlen, uchar *salt,
                        int saltlen, int id, int iter, int n,
                        uchar *out, const EVP_MD *md_type);
int PKCS12_key_gen_utf8_ex(const char *pass, int passlen, uchar *salt,
                           int saltlen, int id, int iter, int n,
                           uchar *out, const EVP_MD *md_type,
                           OSSL_LIB_CTX *ctx, const char *propq);
...
int PKCS12_gen_mac(PKCS12 *p12, const char *pass, int passlen,
                   uchar *mac, unsigned int *maclen);
int PKCS12_verify_mac(PKCS12 *p12, const char *pass, int passlen);
int PKCS12_set_mac(PKCS12 *p12, const char *pass, int passlen,
                   uchar *salt, int saltlen, int iter,
                   const EVP_MD *md_type);
int PKCS12_setup_mac(PKCS12 *p12, int iter, uchar *salt,
