 ...
 */
/*
 * Generated from err.h.in for https://github.com/kiyolee/openssl3-win-build.git.
 */
...
#define ERR_PACK(lib, func, reason)                                      \
	( (((ulong)(lib)    & ERR_LIB_MASK   ) << ERR_LIB_OFFSET) | \
	(((ulong)(reason) & ERR_REASON_MASK)) )
...
#define lh_ERR_STRING_DATA_new(hfn, \
	    cmp) ((LHASH_OF(ERR_STRING_DATA) *)OPENSSL_LH_new(ossl_check_ERR_STRING_DATA_lh_hashfunc_type(hfn), \
...
#define lh_ERR_STRING_DATA_insert(lh, \
	    ptr) ((ERR_STRING_DATA*)OPENSSL_LH_insert(ossl_check_ERR_STRING_DATA_lh_type(lh), \
	ossl_check_ERR_STRING_DATA_lh_plain_type(ptr)))
#define lh_ERR_STRING_DATA_delete(lh, \
	    ptr) ((ERR_STRING_DATA*)OPENSSL_LH_delete(ossl_check_ERR_STRING_DATA_lh_type(lh), \
	ossl_check_const_ERR_STRING_DATA_lh_plain_type(ptr)))
#define lh_ERR_STRING_DATA_retrieve(lh, \
	    ptr) ((ERR_STRING_DATA*)OPENSSL_LH_retrieve(ossl_check_ERR_STRING_DATA_lh_type(lh), \
	ossl_check_const_ERR_STRING_DATA_lh_plain_type(ptr)))
...
#define lh_ERR_STRING_DATA_doall(lh, dfn) OPENSSL_LH_doall(ossl_check_ERR_STRING_DATA_lh_type(lh), \
	    ossl_check_ERR_STRING_DATA_lh_doallfunc_type(dfn))
...
#ifndef OPENSSL_NO_DEPRECATED_3_0
OSSL_DEPRECATEDIN_3_0 unsigned long ERR_peek_error_line_data(const char ** file, int * line, const char ** data, int * flags);
#endif
...
#ifndef OPENSSL_NO_DEPRECATED_3_0
OSSL_DEPRECATEDIN_3_0 unsigned long ERR_peek_last_error_line_data(const char ** file, int * line, const char ** data, int * flags);
#endif
