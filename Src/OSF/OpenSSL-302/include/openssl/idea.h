...
OSSL_DEPRECATEDIN_3_0 void IDEA_ecb_encrypt(const uchar *in,
                                            uchar *out,
                                            IDEA_KEY_SCHEDULE *ks);
OSSL_DEPRECATEDIN_3_0 void IDEA_set_encrypt_key(const uchar *key,
                                                IDEA_KEY_SCHEDULE *ks);
OSSL_DEPRECATEDIN_3_0 void IDEA_set_decrypt_key(IDEA_KEY_SCHEDULE *ek,
                                                IDEA_KEY_SCHEDULE *dk);
OSSL_DEPRECATEDIN_3_0 void IDEA_cbc_encrypt(const uchar *in,
                                            uchar *out, long length,
                                            IDEA_KEY_SCHEDULE *ks,
                                            uchar *iv, int enc);
OSSL_DEPRECATEDIN_3_0 void IDEA_cfb64_encrypt(const uchar *in,
                                              uchar *out, long length,
                                              IDEA_KEY_SCHEDULE *ks,
                                              uchar *iv, int *num,
                                              int enc);
OSSL_DEPRECATEDIN_3_0 void IDEA_ofb64_encrypt(const uchar *in,
                                              uchar *out, long length,
                                              IDEA_KEY_SCHEDULE *ks,
                                              uchar *iv, int *num);
