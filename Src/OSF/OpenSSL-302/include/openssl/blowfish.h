...
OSSL_DEPRECATEDIN_3_0 void BF_ecb_encrypt(const uchar *in,
                                          uchar *out, const BF_KEY *key,
                                          int enc);
OSSL_DEPRECATEDIN_3_0 void BF_cbc_encrypt(const uchar *in,
                                          uchar *out, long length,
                                          const BF_KEY *schedule,
                                          uchar *ivec, int enc);
OSSL_DEPRECATEDIN_3_0 void BF_cfb64_encrypt(const uchar *in,
                                            uchar *out,
                                            long length, const BF_KEY *schedule,
                                            uchar *ivec, int *num,
                                            int enc);
OSSL_DEPRECATEDIN_3_0 void BF_ofb64_encrypt(const uchar *in,
                                            uchar *out,
                                            long length, const BF_KEY *schedule,
                                            uchar *ivec, int *num);
