...
int EVP_PKEY_CTX_get0_dh_kdf_ukm(EVP_PKEY_CTX * ctx, uchar ** ukm);
#endif
...
#ifndef OPENSSL_NO_DEPRECATED_1_1_0
	#define DH_FLAG_NO_EXP_CONSTTIME 0x00 // Does nothing. Previously this switched off constant time behaviour.
#endif
#ifndef OPENSSL_NO_DEPRECATED_3_0
/*
...
#define i2d_DHparams_fp(fp, x) \
	ASN1_i2d_fp(i2d_DHparams, (fp), (uchar *)(x))
...
OSSL_DEPRECATEDIN_3_0 int DH_compute_key(uchar * key, const BIGNUM * pub_key, DH * dh);
OSSL_DEPRECATEDIN_3_0 int DH_compute_key_padded(uchar * key, const BIGNUM * pub_key, DH * dh);
...
/* RFC2631 KDF */
OSSL_DEPRECATEDIN_3_0 int DH_KDF_X9_42(uchar * out, size_t outlen, const uchar * Z, size_t Zlen,
...
OSSL_DEPRECATEDIN_3_0 int(*DH_meth_get_compute_key(const DH_METHOD * dhm)) (uchar * key, const BIGNUM *pub_key, DH *dh);
OSSL_DEPRECATEDIN_3_0 int DH_meth_set_compute_key(DH_METHOD * dhm, int (* compute_key)(uchar * key, const BIGNUM * pub_key, DH * dh));
