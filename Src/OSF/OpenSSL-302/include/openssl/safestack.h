 ...
 */
/*
 * Generated from safestack.h.in for https://github.com/kiyolee/openssl3-win-build.git.
 */
...
#define SKM_DEFINE_STACK_OF_INTERNAL(t1, t2, t3) \
	...
	static ossl_unused ossl_inline const OPENSSL_STACK * ossl_check_const_ ## t1 ## _sk_type(const STACK_OF(t1) * \
	    sk) { return (const OPENSSL_STACK*)sk; } \
	static ossl_unused ossl_inline OPENSSL_STACK * ossl_check_ ## t1 ## _sk_type(STACK_OF(t1) *sk) { return (OPENSSL_STACK*)sk; } \
	static ossl_unused ossl_inline OPENSSL_sk_compfunc ossl_check_ ## t1 ## _compfunc_type(sk_ ## t1 ## _compfunc cmp) { return ( \
																     OPENSSL_sk_compfunc) \
																    cmp; } \
	static ossl_unused ossl_inline OPENSSL_sk_copyfunc ossl_check_ ## t1 ## _copyfunc_type(sk_ ## t1 ## _copyfunc cpy) { return ( \
																     OPENSSL_sk_copyfunc) \
																    cpy; } \
	static ossl_unused ossl_inline OPENSSL_sk_freefunc ossl_check_ ## t1 ## _freefunc_type(sk_ ## t1 ## _freefunc fr) { return ( \
																    OPENSSL_sk_freefunc) \
																   fr; }
...
#define sk_OPENSSL_STRING_new_reserve(cmp, \
	    n) ((STACK_OF(OPENSSL_STRING) *)OPENSSL_sk_new_reserve(ossl_check_OPENSSL_STRING_compfunc_type(cmp), (n)))
...
#define sk_OPENSSL_STRING_delete_ptr(sk, \
	    ptr) ((char*)OPENSSL_sk_delete_ptr(ossl_check_OPENSSL_STRING_sk_type(sk), ossl_check_OPENSSL_STRING_type(ptr)))
...
#define sk_OPENSSL_STRING_pop_free(sk, freefunc) OPENSSL_sk_pop_free(ossl_check_OPENSSL_STRING_sk_type(sk), \
	    ossl_check_OPENSSL_STRING_freefunc_type(freefunc))
#define sk_OPENSSL_STRING_insert(sk, ptr, idx) OPENSSL_sk_insert(ossl_check_OPENSSL_STRING_sk_type(sk), \
	    ossl_check_OPENSSL_STRING_type(ptr), \
	    (idx))
#define sk_OPENSSL_STRING_set(sk, idx, \
	    ptr) ((char*)OPENSSL_sk_set(ossl_check_OPENSSL_STRING_sk_type(sk), (idx), ossl_check_OPENSSL_STRING_type(ptr)))
...
#define sk_OPENSSL_STRING_find_all(sk, ptr, pnum) OPENSSL_sk_find_all(ossl_check_OPENSSL_STRING_sk_type(sk), \
	    ossl_check_OPENSSL_STRING_type(ptr), pnum)
...
#define sk_OPENSSL_STRING_deep_copy(sk, copyfunc, \
	    freefunc) ((STACK_OF(OPENSSL_STRING) *)OPENSSL_sk_deep_copy(ossl_check_const_OPENSSL_STRING_sk_type(sk), \
	ossl_check_OPENSSL_STRING_copyfunc_type(copyfunc), ossl_check_OPENSSL_STRING_freefunc_type(freefunc)))
#define sk_OPENSSL_STRING_set_cmp_func(sk, \
	    cmp) ((sk_OPENSSL_STRING_compfunc)OPENSSL_sk_set_cmp_func(ossl_check_OPENSSL_STRING_sk_type(sk), \
...
#define sk_OPENSSL_CSTRING_new_reserve(cmp, \
	    n) ((STACK_OF(OPENSSL_CSTRING) *)OPENSSL_sk_new_reserve(ossl_check_OPENSSL_CSTRING_compfunc_type(cmp), (n)))
...
#define sk_OPENSSL_CSTRING_delete_ptr(sk, \
	    ptr) ((const char *)OPENSSL_sk_delete_ptr(ossl_check_OPENSSL_CSTRING_sk_type(sk), ossl_check_OPENSSL_CSTRING_type(ptr)))
...
#define sk_OPENSSL_CSTRING_pop_free(sk, freefunc) OPENSSL_sk_pop_free(ossl_check_OPENSSL_CSTRING_sk_type(sk), \
	    ossl_check_OPENSSL_CSTRING_freefunc_type(freefunc))
#define sk_OPENSSL_CSTRING_insert(sk, ptr, idx) OPENSSL_sk_insert(ossl_check_OPENSSL_CSTRING_sk_type(sk), \
	    ossl_check_OPENSSL_CSTRING_type(ptr), (idx))
...
#define sk_OPENSSL_CSTRING_find_all(sk, ptr, pnum) OPENSSL_sk_find_all(ossl_check_OPENSSL_CSTRING_sk_type(sk), \
	    ossl_check_OPENSSL_CSTRING_type(ptr), pnum)
...
#define sk_OPENSSL_CSTRING_deep_copy(sk, copyfunc, \
	    freefunc) ((STACK_OF(OPENSSL_CSTRING) *)OPENSSL_sk_deep_copy(ossl_check_const_OPENSSL_CSTRING_sk_type(sk), \
	ossl_check_OPENSSL_CSTRING_copyfunc_type(copyfunc), ossl_check_OPENSSL_CSTRING_freefunc_type(freefunc)))
#define sk_OPENSSL_CSTRING_set_cmp_func(sk, \
	    cmp) ((sk_OPENSSL_CSTRING_compfunc)OPENSSL_sk_set_cmp_func(ossl_check_OPENSSL_CSTRING_sk_type(sk), \
	ossl_check_OPENSSL_CSTRING_compfunc_type(cmp)))
...
#define sk_OPENSSL_BLOCK_delete_ptr(sk, \
	    ptr) ((void*)OPENSSL_sk_delete_ptr(ossl_check_OPENSSL_BLOCK_sk_type(sk), ossl_check_OPENSSL_BLOCK_type(ptr)))
...
#define sk_OPENSSL_BLOCK_find_all(sk, ptr, pnum) OPENSSL_sk_find_all(ossl_check_OPENSSL_BLOCK_sk_type(sk), \
	    ossl_check_OPENSSL_BLOCK_type(ptr), pnum)
...
#define sk_OPENSSL_BLOCK_deep_copy(sk, copyfunc, freefunc) ((STACK_OF(OPENSSL_BLOCK) *)OPENSSL_sk_deep_copy(ossl_check_const_OPENSSL_BLOCK_sk_type(sk), \
	ossl_check_OPENSSL_BLOCK_copyfunc_type(copyfunc), ossl_check_OPENSSL_BLOCK_freefunc_type(freefunc)))
#define sk_OPENSSL_BLOCK_set_cmp_func(sk, cmp) ((sk_OPENSSL_BLOCK_compfunc)OPENSSL_sk_set_cmp_func(ossl_check_OPENSSL_BLOCK_sk_type(sk), \
