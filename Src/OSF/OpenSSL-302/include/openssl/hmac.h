...
OSSL_DEPRECATEDIN_3_0 int HMAC_Update(HMAC_CTX *ctx, const uchar *data,
                                      size_t len);
OSSL_DEPRECATEDIN_3_0 int HMAC_Final(HMAC_CTX *ctx, uchar *md,
                                     unsigned int *len);
