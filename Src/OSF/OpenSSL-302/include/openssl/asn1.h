 ...
 */
/*
 * Generated from asn1.h.in for https://github.com/kiyolee/openssl3-win-build.git.
 */
...
#define sk_X509_ALGOR_deep_copy(sk, copyfunc, freefunc) ((STACK_OF(X509_ALGOR) *)OPENSSL_sk_deep_copy(ossl_check_const_X509_ALGOR_sk_type(sk), \
	ossl_check_X509_ALGOR_copyfunc_type(copyfunc), ossl_check_X509_ALGOR_freefunc_type(freefunc)))
...
#define ASN1_STRING_FLAG_MSTRING 0x040 // This flag is used by ASN1 code to indicate an ASN1_STRING is an MSTRING type.
#define ASN1_STRING_FLAG_EMBED 0x080 /* String is embedded and only content should be freed */
#define ASN1_STRING_FLAG_X509_TIME 0x100 /* String should be parsed in RFC 5280's time format */
...
#define sk_ASN1_STRING_TABLE_delete_ptr(sk, \
	    ptr) ((ASN1_STRING_TABLE*)OPENSSL_sk_delete_ptr(ossl_check_ASN1_STRING_TABLE_sk_type(sk), \
...
#define sk_ASN1_STRING_TABLE_unshift(sk, ptr) OPENSSL_sk_unshift(ossl_check_ASN1_STRING_TABLE_sk_type(sk), \
	    ossl_check_ASN1_STRING_TABLE_type(ptr))
...
#define sk_ASN1_STRING_TABLE_pop_free(sk, freefunc) OPENSSL_sk_pop_free(ossl_check_ASN1_STRING_TABLE_sk_type(sk), \
...
#define sk_ASN1_STRING_TABLE_set(sk, idx, ptr) ((ASN1_STRING_TABLE*)OPENSSL_sk_set(ossl_check_ASN1_STRING_TABLE_sk_type(sk), (idx), \
	ossl_check_ASN1_STRING_TABLE_type(ptr)))
...
#define sk_ASN1_STRING_TABLE_find_all(sk, ptr, pnum) OPENSSL_sk_find_all(ossl_check_ASN1_STRING_TABLE_sk_type(sk), \
...
#define sk_ASN1_STRING_TABLE_deep_copy(sk, copyfunc, freefunc) ((STACK_OF(ASN1_STRING_TABLE) *)OPENSSL_sk_deep_copy(ossl_check_const_ASN1_STRING_TABLE_sk_type(sk), \
	ossl_check_ASN1_STRING_TABLE_copyfunc_type(copyfunc), ossl_check_ASN1_STRING_TABLE_freefunc_type(freefunc)))
#define sk_ASN1_STRING_TABLE_set_cmp_func(sk, cmp) ((sk_ASN1_STRING_TABLE_compfunc)OPENSSL_sk_set_cmp_func(ossl_check_ASN1_STRING_TABLE_sk_type(sk), \
...
#define DECLARE_ASN1_ENCODE_FUNCTIONS_only_attr(attr, type, name)          \
	attr type *d2i_ ## name(type **a, const uchar ** in, long len);    \
	attr int i2d_ ## name(const type *a, uchar ** out);
...
#define DECLARE_ASN1_NDEF_FUNCTION_attr(attr, name)                        \
	attr int i2d_ ## name ## _NDEF(const name *a, uchar ** out);
...
#define I2D_OF(type) int (*)(const type *, uchar **)
...
#define TYPEDEF_I2D_OF(type) typedef int i2d_of_ ## type (const type *, uchar **)
#define TYPEDEF_D2I2D_OF(type) TYPEDEF_D2I_OF(type); TYPEDEF_I2D_OF(type)

typedef void * d2i_of_void (void **, const uchar **, long);
typedef int i2d_of_void (const void *, uchar **);
...
#define CHARTYPE_PRINTABLESTRING        0x10 /* Character is a valid PrintableString character */
#define CHARTYPE_FIRST_ESC_2253         0x20 /* Character needs escaping if it is the first character */
#define CHARTYPE_LAST_ESC_2253          0x40 /* Character needs escaping if it is the last character */
/*
...
#define ASN1_STRFLGS_SHOW_TYPE          0x40 // If this is set we include the string type in the output
/*
...
#define ASN1_STRFLGS_DUMP_DER           0x200 // These determine what 'dumping' does, we can dump the content octets or the DER encoding: both use the RFC2253 #XXXXX notation.
#define ASN1_STRFLGS_ESC_2254           0x400 // This flag specifies that RC2254 escaping shall be performed.
/*
...
#define sk_ASN1_TYPE_deep_copy(sk, copyfunc, freefunc) ((STACK_OF(ASN1_TYPE) *)OPENSSL_sk_deep_copy(ossl_check_const_ASN1_TYPE_sk_type(sk), \
	ossl_check_ASN1_TYPE_copyfunc_type(copyfunc), ossl_check_ASN1_TYPE_freefunc_type(freefunc)))
...
#define B_ASN1_PRINTABLE B_ASN1_NUMERICSTRING|B_ASN1_PRINTABLESTRING|B_ASN1_T61STRING|B_ASN1_IA5STRING|B_ASN1_BIT_STRING|B_ASN1_UNIVERSALSTRING| \
...
OSSL_DEPRECATEDIN_1_1_0 uchar * ASN1_STRING_data(ASN1_STRING * x);
#endif
...
#define sk_ASN1_INTEGER_new_reserve(cmp, \
	    n) ((STACK_OF(ASN1_INTEGER) *)OPENSSL_sk_new_reserve(ossl_check_ASN1_INTEGER_compfunc_type(cmp), (n)))
...
#define sk_ASN1_INTEGER_delete_ptr(sk, \
	    ptr) ((ASN1_INTEGER*)OPENSSL_sk_delete_ptr(ossl_check_ASN1_INTEGER_sk_type(sk), ossl_check_ASN1_INTEGER_type(ptr)))
...
#define sk_ASN1_INTEGER_pop_free(sk, freefunc) OPENSSL_sk_pop_free(ossl_check_ASN1_INTEGER_sk_type(sk), \
	    ossl_check_ASN1_INTEGER_freefunc_type(freefunc))
#define sk_ASN1_INTEGER_insert(sk, ptr, idx) OPENSSL_sk_insert(ossl_check_ASN1_INTEGER_sk_type(sk), ossl_check_ASN1_INTEGER_type(ptr), \
	    (idx))
#define sk_ASN1_INTEGER_set(sk, idx, \
	    ptr) ((ASN1_INTEGER*)OPENSSL_sk_set(ossl_check_ASN1_INTEGER_sk_type(sk), (idx), ossl_check_ASN1_INTEGER_type(ptr)))
...
#define sk_ASN1_INTEGER_find_all(sk, ptr, pnum) OPENSSL_sk_find_all(ossl_check_ASN1_INTEGER_sk_type(sk), \
...
#define sk_ASN1_INTEGER_deep_copy(sk, copyfunc, \
	    freefunc) ((STACK_OF(ASN1_INTEGER) *)OPENSSL_sk_deep_copy(ossl_check_const_ASN1_INTEGER_sk_type(sk), \
	ossl_check_ASN1_INTEGER_copyfunc_type(copyfunc), ossl_check_ASN1_INTEGER_freefunc_type(freefunc)))
#define sk_ASN1_INTEGER_set_cmp_func(sk, \
	    cmp) ((sk_ASN1_INTEGER_compfunc)OPENSSL_sk_set_cmp_func(ossl_check_ASN1_INTEGER_sk_type(sk), \
...
#define sk_ASN1_UTF8STRING_new_reserve(cmp, \
	    n) ((STACK_OF(ASN1_UTF8STRING) *)OPENSSL_sk_new_reserve(ossl_check_ASN1_UTF8STRING_compfunc_type(cmp), (n)))
...
#define sk_ASN1_UTF8STRING_delete_ptr(sk, \
	    ptr) ((ASN1_UTF8STRING*)OPENSSL_sk_delete_ptr(ossl_check_ASN1_UTF8STRING_sk_type(sk), ossl_check_ASN1_UTF8STRING_type(ptr)))
...
#define sk_ASN1_UTF8STRING_pop_free(sk, freefunc) OPENSSL_sk_pop_free(ossl_check_ASN1_UTF8STRING_sk_type(sk), \
	    ossl_check_ASN1_UTF8STRING_freefunc_type(freefunc))
#define sk_ASN1_UTF8STRING_insert(sk, ptr, idx) OPENSSL_sk_insert(ossl_check_ASN1_UTF8STRING_sk_type(sk), \
	    ossl_check_ASN1_UTF8STRING_type(ptr), (idx))
#define sk_ASN1_UTF8STRING_set(sk, idx, \
	    ptr) ((ASN1_UTF8STRING*)OPENSSL_sk_set(ossl_check_ASN1_UTF8STRING_sk_type(sk), (idx), ossl_check_ASN1_UTF8STRING_type(ptr)))
...
#define sk_ASN1_UTF8STRING_find_all(sk, ptr, pnum) OPENSSL_sk_find_all(ossl_check_ASN1_UTF8STRING_sk_type(sk), \
...
#define sk_ASN1_UTF8STRING_deep_copy(sk, copyfunc, \
	    freefunc) ((STACK_OF(ASN1_UTF8STRING) *)OPENSSL_sk_deep_copy(ossl_check_const_ASN1_UTF8STRING_sk_type(sk), \
	ossl_check_ASN1_UTF8STRING_copyfunc_type(copyfunc), ossl_check_ASN1_UTF8STRING_freefunc_type(freefunc)))
#define sk_ASN1_UTF8STRING_set_cmp_func(sk, \
	    cmp) ((sk_ASN1_UTF8STRING_compfunc)OPENSSL_sk_set_cmp_func(ossl_check_ASN1_UTF8STRING_sk_type(sk), \
...
int UTF8_getc(const uchar * str, int len, unsigned long * val);
int UTF8_putc(uchar * str, int len, unsigned long value);
...
#define sk_ASN1_GENERALSTRING_new_reserve(cmp, \
	    n) ((STACK_OF(ASN1_GENERALSTRING) *)OPENSSL_sk_new_reserve(ossl_check_ASN1_GENERALSTRING_compfunc_type(cmp), (n)))
...
#define sk_ASN1_GENERALSTRING_delete_ptr(sk, \
	    ptr) ((ASN1_GENERALSTRING*)OPENSSL_sk_delete_ptr(ossl_check_ASN1_GENERALSTRING_sk_type(sk), \
	ossl_check_ASN1_GENERALSTRING_type(ptr)))
#define sk_ASN1_GENERALSTRING_push(sk, ptr) OPENSSL_sk_push(ossl_check_ASN1_GENERALSTRING_sk_type(sk), \
	    ossl_check_ASN1_GENERALSTRING_type(ptr))
#define sk_ASN1_GENERALSTRING_unshift(sk, ptr) OPENSSL_sk_unshift(ossl_check_ASN1_GENERALSTRING_sk_type(sk), \
	    ossl_check_ASN1_GENERALSTRING_type(ptr))
...
#define sk_ASN1_GENERALSTRING_pop_free(sk, freefunc) OPENSSL_sk_pop_free(ossl_check_ASN1_GENERALSTRING_sk_type(sk), \
	    ossl_check_ASN1_GENERALSTRING_freefunc_type(freefunc))
#define sk_ASN1_GENERALSTRING_insert(sk, ptr, idx) OPENSSL_sk_insert(ossl_check_ASN1_GENERALSTRING_sk_type(sk), \
	    ossl_check_ASN1_GENERALSTRING_type(ptr), \
	    (idx))
#define sk_ASN1_GENERALSTRING_set(sk, idx, \
	    ptr) ((ASN1_GENERALSTRING*)OPENSSL_sk_set(ossl_check_ASN1_GENERALSTRING_sk_type(sk), (idx), \
	ossl_check_ASN1_GENERALSTRING_type(ptr)))
#define sk_ASN1_GENERALSTRING_find(sk, ptr) OPENSSL_sk_find(ossl_check_ASN1_GENERALSTRING_sk_type(sk), \
	    ossl_check_ASN1_GENERALSTRING_type(ptr))
#define sk_ASN1_GENERALSTRING_find_ex(sk, ptr) OPENSSL_sk_find_ex(ossl_check_ASN1_GENERALSTRING_sk_type(sk), \
	    ossl_check_ASN1_GENERALSTRING_type(ptr))
#define sk_ASN1_GENERALSTRING_find_all(sk, ptr, pnum) OPENSSL_sk_find_all(ossl_check_ASN1_GENERALSTRING_sk_type(sk), \
	    ossl_check_ASN1_GENERALSTRING_type(ptr), \
	    pnum)
...
#define sk_ASN1_GENERALSTRING_deep_copy(sk, copyfunc, \
	    freefunc) ((STACK_OF(ASN1_GENERALSTRING) *)OPENSSL_sk_deep_copy(ossl_check_const_ASN1_GENERALSTRING_sk_type(sk), \
	ossl_check_ASN1_GENERALSTRING_copyfunc_type(copyfunc), ossl_check_ASN1_GENERALSTRING_freefunc_type(freefunc)))
#define sk_ASN1_GENERALSTRING_set_cmp_func(sk, \
	    cmp) ((sk_ASN1_GENERALSTRING_compfunc)OPENSSL_sk_set_cmp_func(ossl_check_ASN1_GENERALSTRING_sk_type(sk), \
...
/* SPECIALS */
int ASN1_get_object(const uchar ** pp, long * plength, int * ptag,
    int * pclass, long omax);
int ASN1_check_infinite_end(uchar ** p, long len);
int ASN1_const_check_infinite_end(const uchar ** p, long len);
void ASN1_put_object(uchar ** pp, int constructed, int length,
    int tag, int xclass);
...
int ASN1_item_sign_ex(const ASN1_ITEM * it, X509_ALGOR * algor1, X509_ALGOR * algor2, ASN1_BIT_STRING * signature,
    const void * data, const ASN1_OCTET_STRING * id, EVP_PKEY * pkey, const EVP_MD * md, OSSL_LIB_CTX * libctx, const char * propq);
...
ASN1_VALUE * ASN1_item_d2i_ex(ASN1_VALUE ** val, const uchar ** in, long len, const ASN1_ITEM * it, OSSL_LIB_CTX * libctx, const char * propq);
