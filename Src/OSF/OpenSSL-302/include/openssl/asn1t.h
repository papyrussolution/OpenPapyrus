 ...
 */
/*
 * Generated from asn1t.h.in for https://github.com/kiyolee/openssl3-win-build.git.
 */
...
typedef int ASN1_ex_d2i (ASN1_VALUE ** pval, const uchar ** in, long len, const ASN1_ITEM * it, int tag, int aclass, char opt, ASN1_TLC * ctx);
typedef int ASN1_ex_d2i_ex (ASN1_VALUE ** pval, const uchar ** in, long len, const ASN1_ITEM * it, int tag, int aclass, char opt, ASN1_TLC * ctx, OSSL_LIB_CTX * libctx, const char * propq);
typedef int ASN1_ex_i2d (const ASN1_VALUE ** pval, uchar ** out, const ASN1_ITEM * it, int tag, int aclass);
...
typedef int ASN1_primitive_i2c (const ASN1_VALUE ** pval, uchar * cont, int * putype, const ASN1_ITEM * it);
typedef int ASN1_primitive_c2i (ASN1_VALUE ** pval, const uchar * cont, int len, int utype, char * free_cont, const ASN1_ITEM * it);
...
typedef struct ASN1_STREAM_ARG_st {
	BIO * out; /* BIO to stream through */
	BIO * ndef_bio; /* BIO with filters appended */
	uchar ** boundary; /* Streaming I/O boundary */
} ASN1_STREAM_ARG;

/* Flags in ASN1_AUX */

#define ASN1_AFLG_REFCOUNT      1 /* Use a reference count */
#define ASN1_AFLG_ENCODING      2 /* Save the encoding of structure (useful for signatures) */
#define ASN1_AFLG_BROKEN        4 /* The Sequence length is invalid */
#define ASN1_AFLG_CONST_CB      8 /* Use the new asn1_const_cb */
...
#define IMPLEMENT_ASN1_NDEF_FUNCTION(stname) \
	int i2d_ ## stname ## _NDEF(const stname *a, uchar ** out) \
	{ \
...
#define IMPLEMENT_STATIC_ASN1_ENCODE_FUNCTIONS(stname) \
	...
	static int i2d_ ## stname(const stname *a, uchar ** out) \
	{ \
...
#define sk_ASN1_VALUE_delete_ptr(sk, \
	    ptr) ((ASN1_VALUE*)OPENSSL_sk_delete_ptr(ossl_check_ASN1_VALUE_sk_type(sk), ossl_check_ASN1_VALUE_type(ptr)))
...
#define sk_ASN1_VALUE_pop_free(sk, freefunc) OPENSSL_sk_pop_free(ossl_check_ASN1_VALUE_sk_type(sk), \
...
#define sk_ASN1_VALUE_set(sk, idx, \
	    ptr) ((ASN1_VALUE*)OPENSSL_sk_set(ossl_check_ASN1_VALUE_sk_type(sk), (idx), ossl_check_ASN1_VALUE_type(ptr)))
...
#define sk_ASN1_VALUE_deep_copy(sk, copyfunc, \
	    freefunc) ((STACK_OF(ASN1_VALUE) *)OPENSSL_sk_deep_copy(ossl_check_const_ASN1_VALUE_sk_type(sk), \
	ossl_check_ASN1_VALUE_copyfunc_type(copyfunc), ossl_check_ASN1_VALUE_freefunc_type(freefunc)))
#define sk_ASN1_VALUE_set_cmp_func(sk, \
	    cmp) ((sk_ASN1_VALUE_compfunc)OPENSSL_sk_set_cmp_func(ossl_check_ASN1_VALUE_sk_type(sk), \
...
int ASN1_item_ex_i2d(const ASN1_VALUE ** pval, uchar ** out,
