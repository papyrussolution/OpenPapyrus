...
OSSL_DEPRECATEDIN_3_0 const uchar * EVP_CIPHER_CTX_iv(const EVP_CIPHER_CTX * ctx);
OSSL_DEPRECATEDIN_3_0 const uchar * EVP_CIPHER_CTX_original_iv(const EVP_CIPHER_CTX * ctx);
OSSL_DEPRECATEDIN_3_0 uchar * EVP_CIPHER_CTX_iv_noconst(EVP_CIPHER_CTX * ctx);
#endif
...
__owur int EVP_DigestUpdate(EVP_MD_CTX * ctx, const void * d,
    size_t cnt);
__owur int EVP_DigestFinal_ex(EVP_MD_CTX * ctx, uchar * md,
    unsigned int * s);
__owur int EVP_Digest(const void * data, size_t count,
    uchar * md, unsigned int * size,
    const EVP_MD * type, ENGINE * impl);
__owur int EVP_Q_digest(OSSL_LIB_CTX * libctx, const char * name,
    const char * propq, const void * data, size_t datalen,
    uchar * md, size_t * mdlen);

__owur int EVP_MD_CTX_copy(EVP_MD_CTX * out, const EVP_MD_CTX * in);
__owur int EVP_DigestInit(EVP_MD_CTX * ctx, const EVP_MD * type);
__owur int EVP_DigestFinal(EVP_MD_CTX * ctx, uchar * md,
    unsigned int * s);
__owur int EVP_DigestFinalXOF(EVP_MD_CTX * ctx, uchar * md,
    size_t len);
...
__owur int EVP_BytesToKey(const EVP_CIPHER * type, const EVP_MD * md,
    const uchar * salt,
    const uchar * data, int datal, int count,
    uchar * key, uchar * iv);
...
__owur int EVP_EncryptInit_ex2(EVP_CIPHER_CTX * ctx, const EVP_CIPHER * cipher,
    ...
    const uchar * iv,
    const OSSL_PARAM params[]);
/*__owur*/ int EVP_EncryptUpdate(EVP_CIPHER_CTX * ctx, uchar * out,
    int * outl, const uchar * in, int inl);
/*__owur*/ int EVP_EncryptFinal_ex(EVP_CIPHER_CTX * ctx, uchar * out,
    int * outl);
/*__owur*/ int EVP_EncryptFinal(EVP_CIPHER_CTX * ctx, uchar * out,
    int * outl);
...
__owur int EVP_DecryptInit_ex2(EVP_CIPHER_CTX * ctx, const EVP_CIPHER * cipher,
    ...
    const uchar * iv,
    const OSSL_PARAM params[]);
/*__owur*/ int EVP_DecryptUpdate(EVP_CIPHER_CTX * ctx, uchar * out,
    int * outl, const uchar * in, int inl);
__owur int EVP_DecryptFinal(EVP_CIPHER_CTX * ctx, uchar * outm,
    int * outl);
/*__owur*/ int EVP_DecryptFinal_ex(EVP_CIPHER_CTX * ctx, uchar * outm,
    int * outl);
...
__owur int EVP_CipherUpdate(EVP_CIPHER_CTX * ctx, uchar * out,
    int * outl, const uchar * in, int inl);
__owur int EVP_CipherFinal(EVP_CIPHER_CTX * ctx, uchar * outm,
    int * outl);
__owur int EVP_CipherFinal_ex(EVP_CIPHER_CTX * ctx, uchar * outm,
    int * outl);

__owur int EVP_SignFinal(EVP_MD_CTX * ctx, uchar * md, unsigned int * s,
    EVP_PKEY * pkey);
__owur int EVP_SignFinal_ex(EVP_MD_CTX * ctx, uchar * md, unsigned int * s,
    EVP_PKEY * pkey, OSSL_LIB_CTX * libctx,
    const char * propq);

__owur int EVP_DigestSign(EVP_MD_CTX * ctx, uchar * sigret,
    size_t * siglen, const uchar * tbs,
    size_t tbslen);

__owur int EVP_VerifyFinal(EVP_MD_CTX * ctx, const uchar * sigbuf,
    unsigned int siglen, EVP_PKEY * pkey);
__owur int EVP_VerifyFinal_ex(EVP_MD_CTX * ctx, const uchar * sigbuf,
    unsigned int siglen, EVP_PKEY * pkey,
    OSSL_LIB_CTX * libctx, const char * propq);

__owur int EVP_DigestVerify(EVP_MD_CTX * ctx, const uchar * sigret,
    size_t siglen, const uchar * tbs,
    size_t tbslen);
...
__owur int EVP_DigestSignFinal(EVP_MD_CTX * ctx, uchar * sigret,
    size_t * siglen);
...
__owur int EVP_DigestVerifyFinal(EVP_MD_CTX * ctx, const uchar * sig,
    size_t siglen);

__owur int EVP_OpenInit(EVP_CIPHER_CTX * ctx, const EVP_CIPHER * type,
    const uchar * ek, int ekl,
    const uchar * iv, EVP_PKEY * priv);
...
uchar * EVP_Q_mac(OSSL_LIB_CTX * libctx, const char * name, const char * propq,
    const char * subalg, const OSSL_PARAM * params, const void * key, size_t keylen,
    const uchar * data, size_t datalen, uchar * out, size_t outsize, size_t * outlen);
int EVP_MAC_init(EVP_MAC_CTX * ctx, const uchar * key, size_t keylen, const OSSL_PARAM params[]);
int EVP_MAC_update(EVP_MAC_CTX * ctx, const uchar * data, size_t datalen);
int EVP_MAC_final(EVP_MAC_CTX * ctx, uchar * out, size_t * outl, size_t outsize);
int EVP_MAC_finalXOF(EVP_MAC_CTX * ctx, uchar * out, size_t outsize);
...
__owur int EVP_RAND_instantiate(EVP_RAND_CTX * ctx, unsigned int strength,
    ...
    const uchar * pstr, size_t pstr_len,
    const OSSL_PARAM params[]);
int EVP_RAND_uninstantiate(EVP_RAND_CTX * ctx);
__owur int EVP_RAND_generate(EVP_RAND_CTX * ctx, uchar * out,
    size_t outlen, unsigned int strength,
    int prediction_resistance,
    const uchar * addin, size_t addin_len);
int EVP_RAND_reseed(EVP_RAND_CTX * ctx, int prediction_resistance,
    const uchar * ent, size_t ent_len,
    const uchar * addin, size_t addin_len);
__owur int EVP_RAND_nonce(EVP_RAND_CTX * ctx, uchar * out, size_t outlen);
...
/* PKEY stuff */
#ifndef OPENSSL_NO_DEPRECATED_3_0
OSSL_DEPRECATEDIN_3_0 int EVP_PKEY_decrypt_old(uchar * dec_key,
    const uchar * enc_key,
    int enc_key_len,
    EVP_PKEY * private_key);
OSSL_DEPRECATEDIN_3_0 int EVP_PKEY_encrypt_old(uchar * enc_key,
    const uchar * key,
...
EVP_PKEY * d2i_PrivateKey_ex(int type, EVP_PKEY ** a, const uchar ** pp,
...
EVP_PKEY * d2i_KeyParams(int type, EVP_PKEY ** a, const uchar ** pp,
    long length);
...
int EVP_PKEY_CTX_set_mac_key(EVP_PKEY_CTX * ctx, const uchar * key,
    int keylen);
...
OSSL_DEPRECATEDIN_3_0 size_t EVP_PKEY_meth_get_count();
...
int EVP_PKEY_encapsulate(EVP_PKEY_CTX * ctx,
    uchar * wrappedkey, size_t * wrappedkeylen,
    uchar * genkey, size_t * genkeylen);
int EVP_PKEY_decapsulate_init(EVP_PKEY_CTX * ctx, const OSSL_PARAM params[]);
int EVP_PKEY_decapsulate(EVP_PKEY_CTX * ctx,
    uchar * unwrapped, size_t * unwrappedlen,
    const uchar * wrapped, size_t wrappedlen);
...
OSSL_DEPRECATEDIN_3_0 void EVP_PKEY_meth_set_verify(EVP_PKEY_METHOD * pmeth, int (* verify_init)(EVP_PKEY_CTX * ctx),
    int (* verify)(EVP_PKEY_CTX * ctx, const uchar * sig, size_t siglen,
    const uchar * tbs, size_t tbslen));
OSSL_DEPRECATEDIN_3_0 void EVP_PKEY_meth_set_verify_recover(EVP_PKEY_METHOD * pmeth, int (* verify_recover_init)(EVP_PKEY_CTX * ctx),
    int (* verify_recover)(EVP_PKEY_CTX * ctx, uchar * sig,
    size_t * siglen, const uchar * tbs,
    size_t tbslen));
OSSL_DEPRECATEDIN_3_0 void EVP_PKEY_meth_set_signctx(EVP_PKEY_METHOD * pmeth, int (* signctx_init)(EVP_PKEY_CTX * ctx,
    EVP_MD_CTX * mctx),
    int (* signctx)(EVP_PKEY_CTX * ctx, uchar * sig, size_t * siglen,
    EVP_MD_CTX * mctx));
OSSL_DEPRECATEDIN_3_0 void EVP_PKEY_meth_set_verifyctx(EVP_PKEY_METHOD * pmeth, int (* verifyctx_init)(EVP_PKEY_CTX * ctx,
    EVP_MD_CTX * mctx),
...
OSSL_DEPRECATEDIN_3_0 void EVP_PKEY_meth_set_encrypt(EVP_PKEY_METHOD * pmeth, int (* encrypt_init)(EVP_PKEY_CTX * ctx),
    int (* encryptfn)(EVP_PKEY_CTX * ctx, uchar * out, size_t * outlen,
    const uchar * in, size_t inlen));
...
OSSL_DEPRECATEDIN_3_0 void EVP_PKEY_meth_set_ctrl(EVP_PKEY_METHOD * pmeth, int (* ctrl)(EVP_PKEY_CTX * ctx, int type, int p1,
    void * p2),
    int (* ctrl_str)(EVP_PKEY_CTX * ctx, const char * type, const char * value));
OSSL_DEPRECATEDIN_3_0 void EVP_PKEY_meth_set_digestsign(EVP_PKEY_METHOD * pmeth,
    int (* digestsign)(EVP_MD_CTX * ctx, uchar * sig, size_t * siglen,
    const uchar * tbs, size_t tbslen));
OSSL_DEPRECATEDIN_3_0 void EVP_PKEY_meth_set_digestverify(EVP_PKEY_METHOD * pmeth,
    int (* digestverify)(EVP_MD_CTX * ctx, const uchar * sig,
    size_t siglen, const uchar * tbs,
    size_t tbslen));
