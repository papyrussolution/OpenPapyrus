...
#ifndef OPENSSL_NO_DEPRECATED_3_0
	OSSL_DEPRECATEDIN_3_0 int EVP_PKEY_CTX_get0_ecdh_kdf_ukm(EVP_PKEY_CTX * ctx, uchar ** ukm);
#endif
...
EC_GROUP * d2i_ECPKParameters(EC_GROUP **, const uchar ** in, long len);
int i2d_ECPKParameters(const EC_GROUP *, uchar ** out);
...
OSSL_DEPRECATEDIN_3_0 int EC_KEY_oct2key(EC_KEY * key, const uchar * buf,
...
OSSL_DEPRECATEDIN_3_0 int EC_KEY_oct2priv(EC_KEY * key, const uchar * buf,
    size_t len);
 ...
 *  \return 1 on success and 0 if an error occurred
 */
OSSL_DEPRECATEDIN_3_0 int i2o_ECPublicKey(const EC_KEY * key, uchar ** out);
 ...
 *  This identifier is retained for backwards compatibility
 */
OSSL_DEPRECATEDIN_3_0 int ECDH_KDF_X9_62(uchar * out, size_t outlen,
 ...
 *  \return pointer to a ECDSA_SIG structure or NULL if an error occurred
 */
OSSL_DEPRECATEDIN_3_0 ECDSA_SIG * ECDSA_do_sign(const uchar * dgst,
 ...
 *  \return pointer to a ECDSA_SIG structure or NULL if an error occurred
 */
OSSL_DEPRECATEDIN_3_0 ECDSA_SIG * ECDSA_do_sign_ex(const uchar * dgst,
 ...
 *          and -1 on error
 */
OSSL_DEPRECATEDIN_3_0 int ECDSA_do_verify(const uchar * dgst, int dgst_len,
 ...
 *  \return 1 on success and 0 otherwise
 */
OSSL_DEPRECATEDIN_3_0 int ECDSA_sign(int type, const uchar * dgst,
    int dgstlen, uchar * sig,
 ...
 *  \return 1 on success and 0 otherwise
 */
OSSL_DEPRECATEDIN_3_0 int ECDSA_sign_ex(int type, const uchar * dgst,
    int dgstlen, uchar * sig,
 ...
 *          and -1 on error
 */
OSSL_DEPRECATEDIN_3_0 int ECDSA_verify(int type, const uchar * dgst,
    int dgstlen, const uchar * sig,
...
OSSL_DEPRECATEDIN_3_0 void EC_KEY_METHOD_set_compute_key(EC_KEY_METHOD * meth,
    int (* ckey)(uchar ** psec, size_t * pseclen,
