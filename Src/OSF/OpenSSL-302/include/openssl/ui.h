 ...
 */
/*
 * Generated from ui.h.in for https://github.com/kiyolee/openssl3-win-build.git.
 */
#ifndef OPENSSL_UI_H
#define OPENSSL_UI_H
#pragma once
...
#define sk_UI_STRING_deep_copy(sk, copyfunc, freefunc) ((STACK_OF(UI_STRING) *)OPENSSL_sk_deep_copy(ossl_check_const_UI_STRING_sk_type(sk), \
	ossl_check_UI_STRING_copyfunc_type(copyfunc), ossl_check_UI_STRING_freefunc_type(freefunc)))
