 ...
 */
/*
 * Generated from bio.h.in for https://github.com/kiyolee/openssl3-win-build.git.
 */
...
#define sk_BIO_deep_copy(sk, copyfunc, \
	    freefunc) ((STACK_OF(BIO) *)OPENSSL_sk_deep_copy(ossl_check_const_BIO_sk_type(sk), ossl_check_BIO_copyfunc_type(copyfunc), \
	ossl_check_BIO_freefunc_type(freefunc)))
#define sk_BIO_set_cmp_func(sk, \
	    cmp) ((sk_BIO_compfunc)OPENSSL_sk_set_cmp_func(ossl_check_BIO_sk_type(sk), ossl_check_BIO_compfunc_type(cmp)))

/* Prefix and suffix callback in ASN1 BIO */
typedef int asn1_ps_func (BIO * b, uchar ** pbuf, int * plen,
    void * parg);
...
OSSL_DEPRECATEDIN_1_1_0 int BIO_get_host_ip(const char * str, uchar * ip);
