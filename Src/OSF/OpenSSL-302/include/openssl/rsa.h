...
OSSL_DEPRECATEDIN_3_0
int RSA_public_encrypt(int flen, const uchar * from, uchar * to,
    RSA * rsa, int padding);
OSSL_DEPRECATEDIN_3_0
int RSA_private_encrypt(int flen, const uchar * from, uchar * to,
    RSA * rsa, int padding);
OSSL_DEPRECATEDIN_3_0
int RSA_public_decrypt(int flen, const uchar * from, uchar * to,
    RSA * rsa, int padding);
OSSL_DEPRECATEDIN_3_0
int RSA_private_decrypt(int flen, const uchar * from, uchar * to,
    RSA * rsa, int padding);
 ...
 */
OSSL_DEPRECATEDIN_3_0 int RSA_sign(int type, const uchar * m,
    unsigned int m_length, uchar * sigret,
    unsigned int * siglen, RSA * rsa);
OSSL_DEPRECATEDIN_3_0 int RSA_verify(int type, const uchar * m,
...
int RSA_verify_ASN1_OCTET_STRING(int type,
    const uchar * m, unsigned int m_length,
    uchar * sigbuf, unsigned int siglen,
    RSA * rsa);
...
int RSA_padding_check_PKCS1_type_2(uchar * to, int tlen,
    const uchar * f, int fl,
    int rsa_len);
OSSL_DEPRECATEDIN_3_0 int PKCS1_MGF1(uchar * mask, long len,
    const uchar * seed, long seedlen,
    const EVP_MD * dgst);
OSSL_DEPRECATEDIN_3_0
...
int RSA_padding_check_PKCS1_OAEP_mgf1(uchar * to, int tlen,
    ...
    const uchar * param, int plen,
    const EVP_MD * md, const EVP_MD * mgf1md);
OSSL_DEPRECATEDIN_3_0 int RSA_padding_add_none(uchar * to, int tlen,
    const uchar * f, int fl);
OSSL_DEPRECATEDIN_3_0 int RSA_padding_check_none(uchar * to, int tlen,
    const uchar * f, int fl,
    int rsa_len);
OSSL_DEPRECATEDIN_3_0 int RSA_padding_add_X931(uchar * to, int tlen,
    const uchar * f, int fl);
OSSL_DEPRECATEDIN_3_0 int RSA_padding_check_X931(uchar * to, int tlen,
    const uchar * f, int fl,
    int rsa_len);
