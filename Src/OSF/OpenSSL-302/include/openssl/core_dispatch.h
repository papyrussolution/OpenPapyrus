...
OSSL_CORE_MAKE_FUNC(int, digest_update,
    (void * dctx, const uchar * in, size_t inl))
OSSL_CORE_MAKE_FUNC(int, digest_final,
    (void * dctx,
    uchar * out, size_t *outl, size_t outsz))
OSSL_CORE_MAKE_FUNC(int, digest_digest,
    (void * provctx, const uchar * in, size_t inl,
    uchar * out, size_t *outl, size_t outsz))
...
OSSL_CORE_MAKE_FUNC(int, cipher_update,
    (void * cctx,
    uchar * out, size_t *outl, size_t outsize,
...
OSSL_CORE_MAKE_FUNC(int, mac_init, (void * mctx, const uchar * key, size_t keylen, const OSSL_PARAM params[]))
OSSL_CORE_MAKE_FUNC(int, mac_update, (void * mctx, const uchar * in, size_t inl)) 
OSSL_CORE_MAKE_FUNC(int, mac_final, (void * mctx, uchar * out, size_t *outl, size_t outsize))
...
OSSL_CORE_MAKE_FUNC(int, kdf_derive, (void * kctx, uchar * key, size_t keylen, const OSSL_PARAM params[]))
...
OSSL_CORE_MAKE_FUNC(int, rand_instantiate, (void * vdrbg, unsigned int strength, int prediction_resistance, const uchar * pstr, size_t pstr_len, const OSSL_PARAM params[]))
OSSL_CORE_MAKE_FUNC(int, rand_uninstantiate, (void * vdrbg))
OSSL_CORE_MAKE_FUNC(int, rand_generate, (void * vctx, uchar * out, size_t outlen, unsigned int strength, int prediction_resistance, const uchar * addin, size_t addin_len))
OSSL_CORE_MAKE_FUNC(int, rand_reseed, (void * vctx, int prediction_resistance, const uchar * ent, size_t ent_len, const uchar * addin, size_t addin_len))
OSSL_CORE_MAKE_FUNC(size_t, rand_nonce, (void * vctx, uchar * out, unsigned int strength, size_t min_noncelen, size_t max_noncelen))
...
OSSL_CORE_MAKE_FUNC(size_t, rand_get_seed, (void * vctx, uchar ** buffer, int entropy, size_t min_len, size_t max_len, int prediction_resistance, const uchar * adin, size_t adin_len))
OSSL_CORE_MAKE_FUNC(void, rand_clear_seed, (void * vctx, uchar * buffer, size_t b_len))
/*-
 * Key management
 *
...
OSSL_CORE_MAKE_FUNC(int, keyexch_init, (void * ctx, void * provkey,
    const OSSL_PARAM params[]))
OSSL_CORE_MAKE_FUNC(int, keyexch_derive, (void * ctx,  uchar * secret,
...
OSSL_CORE_MAKE_FUNC(int, signature_sign_init, (void * ctx, void * provkey,
    const OSSL_PARAM params[]))
OSSL_CORE_MAKE_FUNC(int, signature_sign, (void * ctx,  uchar * sig,
...
OSSL_CORE_MAKE_FUNC(int, signature_verify_recover,
    (void * ctx, uchar * rout, size_t *routlen,
    size_t routsize, const uchar * sig, size_t siglen))
...
OSSL_CORE_MAKE_FUNC(int, signature_digest_sign_update,
    (void * ctx, const uchar * data, size_t datalen))
OSSL_CORE_MAKE_FUNC(int, signature_digest_sign_final,
    (void * ctx, uchar * sig, size_t *siglen,
    size_t sigsize))
OSSL_CORE_MAKE_FUNC(int, signature_digest_sign,
    (void * ctx, uchar * sigret, size_t *siglen,
    size_t sigsize, const uchar * tbs, size_t tbslen))
...
OSSL_CORE_MAKE_FUNC(int, signature_digest_verify_final,
    (void * ctx, const uchar * sig, size_t siglen))
...
OSSL_CORE_MAKE_FUNC(int, asym_cipher_encrypt_init, (void * ctx, void * provkey,
    const OSSL_PARAM params[]))
OSSL_CORE_MAKE_FUNC(int, asym_cipher_encrypt, (void * ctx, uchar * out,
    size_t *outlen,
    size_t outsize,
    const uchar * in,
    size_t inlen))
OSSL_CORE_MAKE_FUNC(int, asym_cipher_decrypt_init, (void * ctx, void * provkey,
    const OSSL_PARAM params[]))
OSSL_CORE_MAKE_FUNC(int, asym_cipher_decrypt, (void * ctx, uchar * out,
    size_t *outlen,
    size_t outsize,
    const uchar * in,
    size_t inlen))
