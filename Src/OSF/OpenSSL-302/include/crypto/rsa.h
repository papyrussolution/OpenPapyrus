...
int ossl_rsa_padding_check_PKCS1_type_2_TLS(OSSL_LIB_CTX * ctx, uchar * to, size_t tlen, const uchar * from, size_t flen, int client_version, int alt_version);
int ossl_rsa_padding_add_PKCS1_OAEP_mgf1_ex(OSSL_LIB_CTX * libctx, uchar * to, int tlen, const uchar * from, int flen, const uchar * param, int plen, const EVP_MD * md, const EVP_MD * mgf1md);
...
int ossl_rsa_verify(int dtype, const uchar * m, unsigned int m_len, uchar * rm, size_t * prm_len, const uchar * sigbuf, size_t siglen, RSA * rsa);
