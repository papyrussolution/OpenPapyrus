 ...
 * names and data need to be SAlloc::F()ed
 */
...
int ossl_asn1_type_set_octetstring_int(ASN1_TYPE * a, long num, uchar * data, int len);
...
EVP_PKEY * ossl_d2i_PrivateKey_legacy(int keytype, EVP_PKEY ** a, const uchar ** pp, long length, OSSL_LIB_CTX * libctx, const char * propq);
