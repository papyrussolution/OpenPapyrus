...
IMPLEMENT_LEGACY_EVP_MD_METH_LC(MD5_SHA1_CTX, md5_sha1_int, ossl_md5_sha1)

static int md5_sha1_int_ctrl(EVP_MD_CTX * ctx, int cmd, int mslen, void * ms)
{
	return ossl_md5_sha1_ctrl((MD5_SHA1_CTX *)EVP_MD_CTX_get0_md_data(ctx), cmd, mslen, ms);
}
...
static const EVP_MD md5_sha1_md = {
	...
	0,
	EVP_ORIG_GLOBAL,
	LEGACY_EVP_MD_METH_TABLE(md5_sha1_int_init, md5_sha1_int_update, md5_sha1_int_final, md5_sha1_int_ctrl, MD5_SHA1_CBLOCK),
};
