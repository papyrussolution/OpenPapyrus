...
int ossl_pkcs5_pbkdf2_hmac_ex(const char * pass, int passlen, const uchar * salt, int saltlen, int iter,
    const EVP_MD * digest, int keylen, uchar * out, OSSL_LIB_CTX * libctx, const char * propq)
{
	const char * empty = "";
	int rv = 1, mode = 1;
	EVP_KDF * kdf;
...
int PKCS5_PBKDF2_HMAC(const char * pass, int passlen, const uchar * salt,
