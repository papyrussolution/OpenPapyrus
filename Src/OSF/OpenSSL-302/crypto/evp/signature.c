...
{
	return (EVP_SIGNATURE *)evp_generic_fetch(ctx, OSSL_OP_SIGNATURE, algorithm, properties, evp_signature_from_algorithm,
...
{
	return (EVP_SIGNATURE *)evp_generic_fetch_from_prov(prov, OSSL_OP_SIGNATURE, algorithm, properties,
