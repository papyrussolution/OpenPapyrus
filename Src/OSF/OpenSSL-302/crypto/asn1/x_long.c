...
static int long_i2c(const ASN1_VALUE ** pval, uchar * cont, int * putype, const ASN1_ITEM * it);
...
static int long_i2c(const ASN1_VALUE ** pval, uchar * cont, int * putype,
    const ASN1_ITEM * it)
{
	long ltmp;
