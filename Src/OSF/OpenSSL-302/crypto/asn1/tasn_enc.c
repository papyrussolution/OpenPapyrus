...
static int asn1_i2d_ex_primitive(const ASN1_VALUE ** pval, uchar ** out, const ASN1_ITEM * it, int tag, int aclass);
static int asn1_set_seq_out(STACK_OF(const_ASN1_VALUE) * sk, uchar ** out, int skcontlen, const ASN1_ITEM * item, int do_sort, int iclass);
static int asn1_template_ex_i2d(const ASN1_VALUE ** pval, uchar ** out, const ASN1_TEMPLATE * tt, int tag, int aclass);
static int asn1_item_flags_i2d(const ASN1_VALUE * val, uchar ** out, const ASN1_ITEM * it, int flags);
static int asn1_ex_i2c(const ASN1_VALUE ** pval, uchar * cout, int * putype, const ASN1_ITEM * it);
/*
 ...
 */
int ASN1_item_ex_i2d(const ASN1_VALUE ** pval, uchar ** out, const ASN1_ITEM * it, int tag, int aclass)
{
	...
	switch(it->itype) {
		...
		case ASN1_ITYPE_CHOICE:
		    ...
		    if((i >= 0) && (i < it->tcount)) {
			    ...
			    const ASN1_VALUE ** pchval = ossl_asn1_get_const_field_ptr(pval, chtt);
...
static int asn1_template_ex_i2d(const ASN1_VALUE ** pval, uchar ** out, const ASN1_TEMPLATE * tt, int tag, int iclass)
{
...
static int asn1_set_seq_out(STACK_OF(const_ASN1_VALUE) * sk, uchar ** out, int skcontlen, const ASN1_ITEM * item, int do_sort, int iclass)
{
	...
	if(do_sort) {
		...
		if(sk_const_ASN1_VALUE_num(sk) < 2)
			...
			derlst = (DER_ENC *)OPENSSL_malloc(sk_const_ASN1_VALUE_num(sk) * sizeof(*derlst));
			if(derlst == NULL) {
				ERR_raise(ERR_LIB_ASN1, ERR_R_MALLOC_FAILURE);
				return 0;
			}
...
static int asn1_i2d_ex_primitive(const ASN1_VALUE ** pval, uchar ** out,
...
static int asn1_ex_i2c(const ASN1_VALUE ** pval, uchar * cout, int * putype,
    const ASN1_ITEM * it)
{
