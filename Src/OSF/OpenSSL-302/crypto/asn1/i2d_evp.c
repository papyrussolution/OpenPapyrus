...
static int i2d_provided(const EVP_PKEY * a, int selection, const struct type_and_structure_st * output_info, uchar ** pp)
{
...
int i2d_KeyParams(const EVP_PKEY * a, uchar ** pp)
{
...
int i2d_PrivateKey(const EVP_PKEY * a, uchar ** pp)
{
	if(evp_pkey_is_provided(a)) {
		static const struct type_and_structure_st output_info[] = {
			{ "DER", "type-specific" },
...
int i2d_PublicKey(const EVP_PKEY * a, uchar ** pp)
{
	if(evp_pkey_is_provided(a)) {
		static const struct type_and_structure_st output_info[] = {
			{ "DER", "type-specific" },
