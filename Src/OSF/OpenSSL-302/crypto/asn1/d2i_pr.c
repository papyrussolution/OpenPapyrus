...
static EVP_PKEY * d2i_PrivateKey_decoder(int keytype, EVP_PKEY ** a, const uchar ** pp,
...
EVP_PKEY * ossl_d2i_PrivateKey_legacy(int keytype, EVP_PKEY ** a, const uchar ** pp,
    long length, OSSL_LIB_CTX * libctx, const char * propq)
{
	EVP_PKEY * ret;
	const uchar * p = *pp;
...
EVP_PKEY * d2i_PrivateKey_ex(int keytype, EVP_PKEY ** a, const uchar ** pp, long length, OSSL_LIB_CTX * libctx, const char * propq)
{
	EVP_PKEY * ret = d2i_PrivateKey_decoder(keytype, a, pp, length, libctx, propq);
 ...
 */
EVP_PKEY * d2i_AutoPrivateKey_ex(EVP_PKEY ** a, const uchar ** pp,
