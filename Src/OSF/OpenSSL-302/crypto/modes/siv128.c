...
__owur static ossl_inline int siv128_do_encrypt(EVP_CIPHER_CTX * ctx, uchar * out,
 ...
 */
SIV128_CONTEXT * ossl_siv128_new(const uchar * key, int klen,
 ...
 */
int ossl_siv128_init(SIV128_CONTEXT * ctx, const uchar * key, int klen, const EVP_CIPHER * cbc, const EVP_CIPHER * ctr,
    OSSL_LIB_CTX * libctx, const char * propq)
{
 ...
 */
int ossl_siv128_aad(SIV128_CONTEXT * ctx, const uchar * aad,
    size_t len)
{
	SIV_BLOCK mac_out;
	size_t out_len = SIV_LEN;
