...
static int x509_name_ex_i2d(const ASN1_VALUE ** val, uchar ** out, const ASN1_ITEM * it, int tag, int aclass);
static int x509_name_ex_new(ASN1_VALUE ** val, const ASN1_ITEM * it);
static void x509_name_ex_free(ASN1_VALUE ** val, const ASN1_ITEM * it);
static int x509_name_encode(X509_NAME * a);
static int x509_name_canon(X509_NAME * a);
static int asn1_string_canon(ASN1_STRING * out, const ASN1_STRING * in);
static int i2d_name_canon(const STACK_OF(STACK_OF_X509_NAME_ENTRY) * intname, uchar ** in);
static int x509_name_ex_print(BIO * out, const ASN1_VALUE ** pval, int indent, const char * fname, const ASN1_PCTX * pctx);
...
static int x509_name_ex_i2d(const ASN1_VALUE ** val, uchar ** out,
    const ASN1_ITEM * it, int tag, int aclass)
{
	int ret;
...
int X509_NAME_get0_der(const X509_NAME * nm, const uchar ** pder,
    size_t * pderlen)
{
