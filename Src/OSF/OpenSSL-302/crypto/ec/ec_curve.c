...
#ifndef OPENSSL_NO_EC2M
	/* IPSec curves */
	{NID_ipsec3, &_EC_IPSEC_155_ID3.h, 0, "\n\tIPSec/IKE/Oakley curve #3 over a 155 bit binary field.\n\tNot suitable for ECDSA.\n\tQuestionable extension field!"}, // @sobolev: x64 test-fault
...
#ifndef FIPS_MODULE
	EC_GROUP * EC_GROUP_new_by_curve_name(int nid) { return EC_GROUP_new_by_curve_name_ex(NULL, NULL, nid); }
#endif
...
const char * EC_curve_nid2nist(int nid) { return ossl_ec_curve_nid2nist_int(nid); }
int EC_curve_nist2nid(const char * name) { return ossl_ec_curve_nist2nid_int(name); }
...
int ossl_ec_curve_nid_from_params(const EC_GROUP * group, BN_CTX * ctx)
{
	...
	param_bytes = (uchar *)OPENSSL_malloc(param_len * NUM_BN_FIELDS);
	if(param_bytes == NULL)
		goto end;
