...
ECDSA_SIG * ECDSA_do_sign_ex(const uchar * dgst, int dlen, const BIGNUM * kinv, const BIGNUM * rp, EC_KEY * eckey)
{
...
int ECDSA_sign(int type, const uchar * dgst, int dlen, uchar * sig, unsigned int * siglen, EC_KEY * eckey)
{
	return ECDSA_sign_ex(type, dgst, dlen, sig, siglen, NULL, NULL, eckey);
}

int ECDSA_sign_ex(int type, const uchar * dgst, int dlen, uchar * sig, unsigned int * siglen, const BIGNUM * kinv,
