...
extern "C" void ecp_nistz256_neg(BN_ULONG res[P256_LIMBS], const BN_ULONG a[P256_LIMBS]);
/* Montgomery mul: res = a*b*2^-256 mod P */
extern "C" void ecp_nistz256_mul_mont(BN_ULONG res[P256_LIMBS], const BN_ULONG a[P256_LIMBS], const BN_ULONG b[P256_LIMBS]);
/* Montgomery sqr: res = a*a*2^-256 mod P */
extern "C" void ecp_nistz256_sqr_mont(BN_ULONG res[P256_LIMBS], const BN_ULONG a[P256_LIMBS]);
/* Convert a number from Montgomery domain, by multiplying with 1 */
extern "C" void ecp_nistz256_from_mont(BN_ULONG res[P256_LIMBS], const BN_ULONG in[P256_LIMBS]);
/* Convert a number to Montgomery domain, by multiplying with 2^512 mod P*/
void ecp_nistz256_to_mont(BN_ULONG res[P256_LIMBS], const BN_ULONG in[P256_LIMBS]);
/* Functions that perform constant time access to the precomputed tables */
extern "C" void ecp_nistz256_scatter_w5(P256_POINT * val, const P256_POINT * in_t, int idx);
extern "C" void ecp_nistz256_gather_w5(P256_POINT * val, const P256_POINT * in_t, int idx);
extern "C" void ecp_nistz256_scatter_w7(P256_POINT_AFFINE * val, const P256_POINT_AFFINE * in_t, int idx);
extern "C" void ecp_nistz256_gather_w7(P256_POINT_AFFINE * val, const P256_POINT_AFFINE * in_t, int idx);
...
extern "C" const PRECOMP256_ROW ecp_nistz256_precomputed[37];
...
extern "C" void ecp_nistz256_point_double(P256_POINT * r, const P256_POINT * a);
extern "C" void ecp_nistz256_point_add(P256_POINT * r, const P256_POINT * a, const P256_POINT * b);
extern "C" void ecp_nistz256_point_add_affine(P256_POINT * r, const P256_POINT * a, const P256_POINT_AFFINE * b);
#else
/* Point double: r = 2*a */
    ...
    size_t num, BN_CTX * ctx)
{
	...
	if((num * 16 + 6) > OPENSSL_MALLOC_MAX_NELEMS(P256_POINT)
	    ...
	    || (p_str = (unsigned char (*)[33])OPENSSL_malloc(num * 33 * sizeof(uchar))) == NULL
...
extern "C" void ecp_nistz256_ord_sqr_mont(BN_ULONG res[P256_LIMBS], const BN_ULONG a[P256_LIMBS], BN_ULONG rep);
