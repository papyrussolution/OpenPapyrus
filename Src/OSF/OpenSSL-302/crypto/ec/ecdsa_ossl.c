...
int ossl_ecdsa_verify_sig(const uchar * dgst, int dgst_len, const ECDSA_SIG * sig, EC_KEY * eckey)
{
...
int ossl_ecdsa_sign(int type, const uchar * dgst, int dlen, uchar * sig, unsigned int * siglen, const BIGNUM * kinv, const BIGNUM * r, EC_KEY * eckey)
{
	ECDSA_SIG * s = ECDSA_do_sign_ex(dgst, dlen, kinv, r, eckey);
	if(!s) {
		*siglen = 0;
		return 0;
	}
...
static int ecdsa_sign_setup(EC_KEY * eckey, BN_CTX * ctx_in, BIGNUM ** kinvp, BIGNUM ** rp, const uchar * dgst, int dlen)
{
	BN_CTX * ctx = NULL;
 ...
 *     -1: error
 */
int ossl_ecdsa_verify(int type, const uchar * dgst, int dgst_len, const uchar * sigbuf, int sig_len, EC_KEY * eckey)
{
...
int ossl_ecdsa_simple_verify_sig(const uchar * dgst, int dgst_len, const ECDSA_SIG * sig, EC_KEY * eckey)
{
	int ret = -1, i;
	BN_CTX * ctx;
	const BIGNUM * order;
