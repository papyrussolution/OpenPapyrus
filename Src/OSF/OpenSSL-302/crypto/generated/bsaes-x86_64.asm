...
PUBLIC	ossl_bsaes_cbc_encrypt

ALIGN	16
ossl_bsaes_cbc_encrypt	PROC PUBLIC
...
ossl_bsaes_cbc_encrypt	ENDP

PUBLIC	ossl_bsaes_ctr32_encrypt_blocks

ALIGN	16
ossl_bsaes_ctr32_encrypt_blocks	PROC PUBLIC
...
ossl_bsaes_ctr32_encrypt_blocks	ENDP
PUBLIC	ossl_bsaes_xts_encrypt

ALIGN	16
ossl_bsaes_xts_encrypt	PROC PUBLIC
...
ossl_bsaes_xts_encrypt	ENDP

PUBLIC	ossl_bsaes_xts_decrypt

ALIGN	16
ossl_bsaes_xts_decrypt	PROC PUBLIC
