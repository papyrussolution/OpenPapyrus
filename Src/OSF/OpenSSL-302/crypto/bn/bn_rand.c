...
static int bnrand(BNRAND_FLAG flag, BIGNUM * rnd, int bits, int top, int bottom, uint strength, BN_CTX * ctx)
{
	uchar * buf = NULL;
...
int BN_rand_ex(BIGNUM * rnd, int bits, int top, int bottom, uint strength, BN_CTX * ctx)
{
...
int BN_priv_rand_ex(BIGNUM * rnd, int bits, int top, int bottom, uint strength, BN_CTX * ctx)
{
...
static int bnrand_range(BNRAND_FLAG flag, BIGNUM * r, const BIGNUM * range, uint strength, BN_CTX * ctx)
{
	int n;
	int count = 100;
...
int BN_rand_range_ex(BIGNUM * r, const BIGNUM * range, uint strength, BN_CTX * ctx)
{
...
int BN_priv_rand_range_ex(BIGNUM * r, const BIGNUM * range, uint strength, BN_CTX * ctx)
{
    ...
    size_t message_len, BN_CTX * ctx)
{
	...
	k_bytes = (uchar *)OPENSSL_malloc(num_k_bytes);
	if(k_bytes == NULL)
		goto err;
