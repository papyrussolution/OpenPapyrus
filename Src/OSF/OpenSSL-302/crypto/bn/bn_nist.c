...
int BN_nist_mod_192(BIGNUM * r, const BIGNUM * a, const BIGNUM * field, BN_CTX * ctx)
{
	...
	union {
		...
		uint ui[BN_NIST_192_TOP * sizeof(BN_ULONG) / sizeof(uint)];
	} buf;

	BN_ULONG c_d[BN_NIST_192_TOP], * res;
	PTR_SIZE_INT mask;
	static const BIGNUM ossl_bignum_nist_p_192_sqr = { (BN_ULONG*)_nist_p_192_sqr, SIZEOFARRAY(_nist_p_192_sqr), SIZEOFARRAY(_nist_p_192_sqr), 0, BN_FLG_STATIC_DATA };
...
int BN_nist_mod_256(BIGNUM * r, const BIGNUM * a, const BIGNUM * field, BN_CTX * ctx)
{
	...
	static const BIGNUM ossl_bignum_nist_p_256_sqr = { (BN_ULONG*)_nist_p_256_sqr, SIZEOFARRAY(_nist_p_256_sqr), SIZEOFARRAY(_nist_p_256_sqr), 0, BN_FLG_STATIC_DATA };
...
int BN_nist_mod_384(BIGNUM * r, const BIGNUM * a, const BIGNUM * field, BN_CTX * ctx)
{
	...
	static const BIGNUM ossl_bignum_nist_p_384_sqr = { (BN_ULONG*)_nist_p_384_sqr, SIZEOFARRAY(_nist_p_384_sqr), SIZEOFARRAY(_nist_p_384_sqr), 0, BN_FLG_STATIC_DATA };
