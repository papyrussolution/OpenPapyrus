...
#define SQR_nibble(w)   ((((w) & 8) << 3) | (((w) & 4) << 2) | (((w) & 2) << 1) | ((w) & 1))
 ...
 */
static extern "C" void bn_GF2m_mul_2x2(BN_ULONG * r, const BN_ULONG a1, const BN_ULONG a0, const BN_ULONG b1, const BN_ULONG b0)
{
	BN_ULONG m1, m0;
...
#else
extern "C" void bn_GF2m_mul_2x2(BN_ULONG * r, BN_ULONG a1, BN_ULONG a0, BN_ULONG b1, BN_ULONG b0);
#endif
    ...
    const BIGNUM * p, BN_CTX * ctx)
{
	...
	bn_check_top(b);
	bn_check_top(p);
	arr = (int *)OPENSSL_malloc(sizeof(*arr) * max);
	if(arr == NULL) {
