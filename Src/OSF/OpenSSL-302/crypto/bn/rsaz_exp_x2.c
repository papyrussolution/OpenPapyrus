...
#define ALIGN_OF(ptr, boundary) \
	((uchar *)(ptr) + (boundary - (((size_t)(ptr)) & (boundary - 1))))
...
/*AMM = Almost Montgomery Multiplication. */
extern "C" void ossl_rsaz_amm52x20_x1_256(BN_ULONG * res, const BN_ULONG * base, const BN_ULONG * exp, const BN_ULONG * m, BN_ULONG k0);
...
extern "C" void ossl_rsaz_amm52x20_x2_256(BN_ULONG * out, const BN_ULONG * a, const BN_ULONG * b, const BN_ULONG * m, const BN_ULONG k0[2]);
extern "C" void ossl_extract_multiplier_2x20_win5(BN_ULONG * red_Y, const BN_ULONG * red_table, int red_table_idx, int tbl_idx);
/*
    ...
    int factor_size)
{
	 ...
	 */
	memzero(coeff_red, exp_digits * sizeof(BN_ULONG));
...
#define DAMS(r, a, m, k0) ossl_rsaz_amm52x20_x2_256((r), (a), (a), (m), (k0))
	...
	int idx;
	memzero(red_Y, sizeof(red_Y));
	memzero(red_table, sizeof(red_table));
	memzero(red_X, sizeof(red_X));
	/*
