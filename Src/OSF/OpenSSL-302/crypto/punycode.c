 ...
 */
static int codepoint2utf8(uchar * out, unsigned long utf)
{
	if(utf <= 0x7F) {
		/* Plain ASCII */
		out[0] = (uchar)utf;
		...
		/* 2-byte unicode */
		out[0] = (uchar)(((utf >> 6) & 0x1F) | 0xC0);
		out[1] = (uchar)(((utf >> 0) & 0x3F) | 0x80);
		out[2] = 0;
		return 2;
	}
	else if(utf <= 0xFFFF) {
		/* 3-byte unicode */
		out[0] = (uchar)(((utf >> 12) & 0x0F) | 0xE0);
		out[1] = (uchar)(((utf >> 6) & 0x3F) | 0x80);
		out[2] = (uchar)(((utf >> 0) & 0x3F) | 0x80);
		out[3] = 0;
		return 3;
	}
	else if(utf <= 0x10FFFF) {
		/* 4-byte unicode */
		out[0] = (uchar)(((utf >> 18) & 0x07) | 0xF0);
		out[1] = (uchar)(((utf >> 12) & 0x3F) | 0x80);
		out[2] = (uchar)(((utf >> 6) & 0x3F) | 0x80);
		out[3] = (uchar)(((utf >> 0) & 0x3F) | 0x80);
		out[4] = 0;
		return 4;
	}
	else {
