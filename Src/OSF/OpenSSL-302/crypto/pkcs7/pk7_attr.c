...
int PKCS7_add_attrib_content_type(PKCS7_SIGNER_INFO * si, ASN1_OBJECT * coid)
{
	...
	return PKCS7_add_signed_attribute(si, NID_pkcs9_contentType, V_ASN1_OBJECT, coid);
}
...
int PKCS7_add1_attrib_digest(PKCS7_SIGNER_INFO * si, const uchar * md, int mdlen)
{
	ASN1_OCTET_STRING * os = ASN1_OCTET_STRING_new();
	if(os == NULL)
		return 0;
	if(!ASN1_STRING_set(os, md, mdlen) || !PKCS7_add_signed_attribute(si, NID_pkcs9_messageDigest, V_ASN1_OCTET_STRING, os)) {
