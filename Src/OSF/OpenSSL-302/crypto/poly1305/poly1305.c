...
static unsigned int U8TOU32(const uchar * p)
{
...
static extern "C" void poly1305_init(void * ctx, const unsigned char key[16])
{
...
/* store a 32-bit unsigned integer in little endian */
static void U32TO8(uchar * p, unsigned int v)
{
	p[0] = (uchar)((v) & 0xff);
	p[1] = (uchar)((v >> 8) & 0xff);
	p[2] = (uchar)((v >> 16) & 0xff);
...
#endif
#else
extern "C" int poly1305_init(void * ctx, const unsigned char key[16], void * func);
extern "C" void poly1305_blocks(void * ctx, const uchar * inp, size_t len, unsigned int padbit);
extern "C" void poly1305_emit(void * ctx, unsigned char mac[16], const unsigned int nonce[4]);
#endif
