...
void DES_ede3_cfb64_encrypt(const uchar * in, uchar * out, long length, DES_key_schedule * ks1,
 ...
 * not what EVP needs.
 */
void DES_ede3_cfb_encrypt(const uchar * in, uchar * out, int numbits, long length, DES_key_schedule * ks1,
