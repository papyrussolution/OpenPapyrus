 ...
 */
static int i2r_ocsp_crlid(const X509V3_EXT_METHOD * method, void * nonce, BIO * out, int indent);
...
static int i2d_ocsp_nonce(const void * a, uchar ** pp);
...
static int i2r_ocsp_acutoff(const X509V3_EXT_METHOD * method, void * cutoff, BIO * bp, int ind)
{
	if(BIO_printf(bp, "%*s", ind, "") <= 0)
		return 0;
	if(!ASN1_GENERALIZEDTIME_print(bp, (ASN1_GENERALIZEDTIME *)cutoff))
		return 0;
	return 1;
}
...
static int i2r_object(const X509V3_EXT_METHOD * method, void * oid, BIO * bp, int ind)
{
	if(BIO_printf(bp, "%*s", ind, "") <= 0)
		return 0;
	if(i2a_ASN1_OBJECT(bp, (ASN1_OBJECT *)oid) <= 0)
		return 0;
	return 1;
}
...
static void * d2i_ocsp_nonce(void * a, const uchar ** pp, long length)
{
	...
	ASN1_OCTET_STRING ** pos = (ASN1_OCTET_STRING**)a;
...
static int i2r_ocsp_nonce(const X509V3_EXT_METHOD * method, void * nonce, BIO * out, int indent)
{
	if(BIO_printf(out, "%*s", indent, "") <= 0)
		return 0;
	if(i2a_ASN1_STRING(out, (ASN1_STRING *)nonce, V_ASN1_OCTET_STRING) <= 0)
		return 0;
	return 1;
}
