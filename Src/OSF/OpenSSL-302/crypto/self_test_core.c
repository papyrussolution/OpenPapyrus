...
{
	SELF_TEST_CB * stcb = (SELF_TEST_CB *)OPENSSL_zalloc(sizeof(*stcb));
	return stcb;
}
...
{
	return (SELF_TEST_CB *)ossl_lib_ctx_get_data(libctx, OSSL_LIB_CTX_SELF_TEST_CB_INDEX, &self_test_set_callback_method);
}
