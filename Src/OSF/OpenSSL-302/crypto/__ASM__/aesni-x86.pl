#! /usr/bin/env perl
# @sobolev patch for @openssl3.0.5
...
# int $PREFIX_set_encrypt_key (const uchar *userKey, int bits,
#                              AES_KEY *key)
...
# int $PREFIX_set_decrypt_key (const uchar *userKey, int bits,
#                              AES_KEY *key)
