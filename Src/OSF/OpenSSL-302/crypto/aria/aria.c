 ...
 */
static ossl_inline void rotnr(uint n, ARIA_u128 * o, const ARIA_u128 * xor, const ARIA_u128 * z)
{
...
int ossl_aria_set_encrypt_key(const uchar * userKey, const int bits, ARIA_KEY * key)
{
	...
	switch(bits) {
		...
		case 192:
		    ...
		    memzero(kr.c + ARIA_BLOCK_SIZE / 2, sizeof(kr) / 2);
		    break;
		case 256:
		    key->rounds = 16;
		    ck1 = &c3;
