...
{
	if(e->ec_meth != NULL)
		return engine_table_register(&dh_table, engine_unregister_all_EC, e, &dummy_nid, 1, 0);
	return 1;
}
...
{
	return ossl_engine_table_select(&dh_table, dummy_nid, OPENSSL_FILE, OPENSSL_LINE);
}
