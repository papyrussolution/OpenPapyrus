...
#pragma hdrstop
/*
 * DES low level APIs are deprecated for public use, but still ok for internal use.  We access the DES_set_odd_parity(3) function here.
 */
...
static int krb5kdf_derive(void * vctx, unsigned char * key, size_t keylen, const OSSL_PARAM params[])
{
	KRB5KDF_CTX * ctx = (KRB5KDF_CTX*)vctx;
