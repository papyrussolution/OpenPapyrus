...
static const uchar clienthello_nocookie[] = {
	0x16, /* Handshake */
	0xFE, 0xFF, /* DTLSv1.0 */
	0x00, 0x00, /* Epoch */
...
static const uchar clienthello_nocookie_frag[] = {
	0x16, /* Handshake */
	0xFE, 0xFF, /* DTLSv1.0 */
	0x00, 0x00, /* Epoch */
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* Record sequence number */
...
static const uchar clienthello_nocookie_short[] = {
	0x16, /* Handshake */
	0xFE, 0xFF, /* DTLSv1.0 */
	0x00, 0x00, /* Epoch */
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* Record sequence number */
...
static const uchar clienthello_2ndfrag[] = {
	0x16, /* Handshake */
	0xFE, 0xFF, /* DTLSv1.0 */
	0x00, 0x00, /* Epoch */
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* Record sequence number */
...
static const uchar clienthello_cookie[] = {
	0x16, /* Handshake */
	0xFE, 0xFF, /* DTLSv1.0 */
	0x00, 0x00, /* Epoch */
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* Record sequence number */
...
static const uchar clienthello_cookie_frag[] = {
	0x16, /* Handshake */
	0xFE, 0xFF, /* DTLSv1.0 */
	0x00, 0x00, /* Epoch */
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* Record sequence number */
...
static const uchar clienthello_badcookie[] = {
	0x16, /* Handshake */
	0xFE, 0xFF, /* DTLSv1.0 */
	0x00, 0x00, /* Epoch */
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* Record sequence number */
...
static const uchar clienthello_cookie_short[] = {
	0x16, /* Handshake */
	0xFE, 0xFF, /* DTLSv1.0 */
	0x00, 0x00, /* Epoch */
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* Record sequence number */
...
static const uchar record_short[] = {
	0x16, /* Handshake */
	0xFE, 0xFF, /* DTLSv1.0 */
	0x00, 0x00, /* Epoch */
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00 /* Record sequence number */
...
static tests testpackets[9] = {
	{ clienthello_nocookie, sizeof(clienthello_nocookie), Tests::VERIFY },
	{ clienthello_nocookie_frag, sizeof(clienthello_nocookie_frag), Tests::VERIFY },
	{ clienthello_nocookie_short, sizeof(clienthello_nocookie_short), Tests::DROP },
	{ clienthello_2ndfrag, sizeof(clienthello_2ndfrag), Tests::DROP },
	{ clienthello_cookie, sizeof(clienthello_cookie), Tests::GOOD },
	{ clienthello_cookie_frag, sizeof(clienthello_cookie_frag), Tests::GOOD },
	{ clienthello_badcookie, sizeof(clienthello_badcookie), Tests::VERIFY },
	{ clienthello_cookie_short, sizeof(clienthello_cookie_short), Tests::DROP },
	{ record_short, sizeof(record_short), Tests::DROP }
};
...
static int dtls_listen_test(int i)
{
	...
	if(tp->outtype == Tests::VERIFY) {
		if(!TEST_int_eq(ret, 0) || !TEST_mem_eq(data, datalen, verify, sizeof(verify)))
			goto err;
	}
	else if(datalen == 0) {
		if(!TEST_true((ret == 0 && tp->outtype == Tests::DROP) || (ret == 1 && tp->outtype == Tests::GOOD)))
			goto err;
	}
	else {
