...
int filter_provider_init(const OSSL_CORE_HANDLE * handle, const OSSL_DISPATCH * in, const OSSL_DISPATCH ** out, void ** provctx)
{
	memzero(&ourglobals, sizeof(ourglobals));
