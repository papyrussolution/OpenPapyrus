...
static uchar ref[CMP_TEST_REFVALUE_LENGTH];
/*
...
static CMP_SES_TEST_FIXTURE * set_up(const char * const test_case_name)
{
	...
	if(!TEST_ptr(fixture = (CMP_SES_TEST_FIXTURE*)OPENSSL_zalloc(sizeof(*fixture))))
		return NULL;
...
{
	X509 * res = OSSL_CMP_exec_certreq(fixture->cmp_ctx, fixture->req_type, NULL);
