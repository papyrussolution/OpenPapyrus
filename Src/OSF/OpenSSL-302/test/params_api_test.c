...
static int test_param_long(int n)
{
	...
	const size_t len = raw_values[n].len >= sizeof(long int) ? sizeof(long int) : raw_values[n].len;
...
static int test_param_construct(int tstid)
{
	...
	for(j = 0; j < SIZEOFARRAY(int_names); j++) {
	...
	for(j = 0; j < SIZEOFARRAY(uint_names); j++) {
...
int setup_tests()
{
	ADD_ALL_TESTS(test_param_int, SIZEOFARRAY(raw_values));
	ADD_ALL_TESTS(test_param_long, SIZEOFARRAY(raw_values));
	ADD_ALL_TESTS(test_param_uint, SIZEOFARRAY(raw_values));
	ADD_ALL_TESTS(test_param_ulong, SIZEOFARRAY(raw_values));
	ADD_ALL_TESTS(test_param_int32, SIZEOFARRAY(raw_values));
	ADD_ALL_TESTS(test_param_uint32, SIZEOFARRAY(raw_values));
	ADD_ALL_TESTS(test_param_size_t, SIZEOFARRAY(raw_values));
	ADD_ALL_TESTS(test_param_time_t, SIZEOFARRAY(raw_values));
	ADD_ALL_TESTS(test_param_int64, SIZEOFARRAY(raw_values));
	ADD_ALL_TESTS(test_param_uint64, SIZEOFARRAY(raw_values));
	ADD_ALL_TESTS(test_param_bignum, SIZEOFARRAY(raw_values));
