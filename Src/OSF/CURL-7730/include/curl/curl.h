...
//#include <limits.h>
	...
	#include <osreldate.h> /* Needed for __FreeBSD_version symbol definition */
#endif
...
/* The check above prevents the winsock2 inclusion if winsock.h already was included, since they can't co-exist without problems */
		#include <winsock2.h>
		#include <ws2tcpip.h>
	#endif
#endif
...
#define CURL_ZERO_TERMINATED ((size_t)-1) /* Special size_t value signaling a null-terminated string. */
...
struct curl_version_info_data {
	...
	int iconv_ver_num; /* Same as '_libiconv_version' if built with HAVE_ICONV */
