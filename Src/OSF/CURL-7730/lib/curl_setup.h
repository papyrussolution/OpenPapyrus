...
#define LIBIDN_REQUIRED_VERSION "0.4.1"
	...
	defined(USE_MBEDTLS) || defined(USE_WOLFSSL) || defined(USE_SCHANNEL) || \
...
#if defined(USE_OPENSSL) || defined(USE_MBEDTLS) || defined(USE_GNUTLS) || defined(USE_NSS) || defined(USE_SECTRANSP) ||  \
	defined(USE_OS400CRYPTO) || defined(USE_WIN32_CRYPTO) || (defined(USE_WOLFSSL) && defined(HAVE_WOLFSSL_DES_ECB_ENCRYPT))
#define USE_CURL_NTLM_CORE
#if defined(USE_MBEDTLS)
	#include <mbedtls/md4.h> /* Get definition of MBEDTLS_MD4_C */
#endif
#endif
...
// 
	...
	#define UNUSED_PARAM_Removed __attribute__((__unused__)) // @sobolev _Removed
	#define WARN_UNUSED_RESULT_Removed __attribute__((warn_unused_result)) // @sobolev _Removed
#else
	#define UNUSED_PARAM_Removed // NOTHING // @sobolev _Removed
	#define WARN_UNUSED_RESULT_Removed // @sobolev _Removed
#endif
*/
/*
