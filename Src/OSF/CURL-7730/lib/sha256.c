...
#define WPA_PUT_BE64(a, val)                                    \
	do {                                                            \
		(a)[0] = (uchar)(((uint64)(val)) >> 56);  \
		(a)[1] = (uchar)(((uint64)(val)) >> 48);  \
		(a)[2] = (uchar)(((uint64)(val)) >> 40);  \
		(a)[3] = (uchar)(((uint64)(val)) >> 32);  \
		(a)[4] = (uchar)(((uint64)(val)) >> 24);  \
		(a)[5] = (uchar)(((uint64)(val)) >> 16);  \
		(a)[6] = (uchar)(((uint64)(val)) >> 8);   \
		(a)[7] = (uchar)(((uint64)(val)) & 0xff); \
	} while(0)
#else
#define WPA_PUT_BE64(a, val)                                  \
	do {                                                          \
...
/*
   ...
   @return CRYPT_OK if successful
 */
static int SHA256_Final(uchar * out,
 ...
 */
void Curl_sha256it(uchar * output, const uchar * input,
    const size_t length)
{
	SHA256_CTX ctx;
