...
struct HTTP {
	...
	enum HttpSendingPhase { // @sobolev anonymous-->HttpSendingPhase
		HTTPSEND_NADA, /* init */
...
#ifndef CURL_DISABLE_HTTP
	struct dynbuf send_buffer; /* used if the request couldn't be sent in one chunk, points to an allocated send_buffer struct */
#endif
#ifdef USE_NGHTTP2
