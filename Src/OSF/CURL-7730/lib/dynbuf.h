...
void FASTCALL Curl_dyn_init(struct dynbuf * s, size_t toobig);
void FASTCALL Curl_dyn_free(struct dynbuf * s);
CURLcode Curl_dyn_addn(struct dynbuf * s, const void * mem, size_t len) CXX_WARN_UNUSED_RESULT;
CURLcode Curl_dyn_add(struct dynbuf * s, const char * str) CXX_WARN_UNUSED_RESULT;
CURLcode Curl_dyn_addf(struct dynbuf * s, const char * fmt, ...) CXX_WARN_UNUSED_RESULT;
CURLcode Curl_dyn_vaddf(struct dynbuf * s, const char * fmt, va_list ap) CXX_WARN_UNUSED_RESULT;
