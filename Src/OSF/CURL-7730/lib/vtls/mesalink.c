...
static ssize_t mesalink_send(struct connectdata * conn, int sockindex, const void * mem,
...
static ssize_t mesalink_recv(struct connectdata * conn, int num, char * buf, size_t buffersize,
    CURLcode * curlcode)
{
...
static CURLcode mesalink_connect_common(struct connectdata * conn, int sockindex,
...
static CURLcode Curl_mesalink_connect_nonblocking(struct connectdata * conn, int sockindex,
    bool * done)
{
...
static void * Curl_mesalink_get_internals(struct ssl_connect_data * connssl,
