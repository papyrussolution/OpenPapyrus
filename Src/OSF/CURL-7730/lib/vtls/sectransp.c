...
static CURLcode sectransp_connect_step3(struct connectdata * conn,
    int sockindex)
{
	struct Curl_easy * data = conn->data;
	struct ssl_connect_data * connssl = &conn->ssl[sockindex];
...
static CURLcode sectransp_connect_common(struct connectdata * conn,
    int sockindex,
    bool nonblocking,
    bool * done)
{
...
static CURLcode Curl_sectransp_md5sum(uchar * tmp, /* input */
    size_t tmplen,
    uchar * md5sum,                                  /* output */
    size_t md5len)
{
...
static CURLcode Curl_sectransp_sha256sum(const uchar * tmp, /* input */
    size_t tmplen,
