...
struct Curl_ssl {
	...
	CURLcode (* random)(struct Curl_easy * data, uchar * entropy,
	    size_t length);
	...
	CURLcode (* md5sum)(uchar * input, size_t inputlen,
	    uchar * md5sum, size_t md5sumlen);
	CURLcode (* sha256sum)(const uchar * input, size_t inputlen,
	    uchar * sha256sum, size_t sha256sumlen);
};
...
CURLcode Curl_none_random(struct Curl_easy * data, uchar * entropy,
    size_t length);
...
CURLcode Curl_none_md5sum(uchar * input, size_t inputlen,
    uchar * md5sum, size_t md5len);
