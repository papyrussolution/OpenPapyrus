...
static int wolfssl_tls13_secret_callback(SSL * ssl, int id, const uchar * secret, int secretSz, void * ctx)
{
	const char * label;
 ...
 */
static CURLcode wolfssl_connect_step1(struct connectdata * conn,
    int sockindex)
{
	char * ciphers;
...
static CURLcode wolfssl_connect_step2(struct connectdata * conn,
    int sockindex)
{
	int ret = -1;
	struct Curl_easy * data = conn->data;
...
static CURLcode wolfssl_connect_step3(struct connectdata * conn,
    int sockindex)
{
...
static CURLcode wolfssl_connect_common(struct connectdata * conn,
    int sockindex,
    bool nonblocking,
    bool * done)
{
...
static CURLcode Curl_wolfssl_sha256sum(const uchar * tmp, /* input */
    size_t tmplen,
