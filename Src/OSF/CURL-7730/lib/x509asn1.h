 ...
 * Prototypes.
 */
const char * Curl_getASN1Element(struct Curl_asn1Element * elem, const char * beg, const char * end);
...
CURLcode Curl_extract_certinfo(struct connectdata * conn, int certnum, const char * beg, const char * end);
