    ...
    bool * done)
{
	...
	uchar * socksreq = &conn->cnnct.socksreq[0];
	CURLcode result;
    ...
    bool * done)
{
	...
	ssize_t len = 0;
	const ulong auth = data->set.socks5auth;
...
CONNECT_REQ_SEND:
		case CONNECT_REQ_SEND:
		    /* PORT MSB */
		    socksreq[len++] = (uchar)((remote_port >> 8) & 0xff);
		    /* PORT LSB */
		    socksreq[len++] = (uchar)(remote_port & 0xff);
