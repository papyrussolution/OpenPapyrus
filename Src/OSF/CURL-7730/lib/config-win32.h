...
#define HAVE_FCNTL_H 1 /* Define if you have the <fcntl.h> header file. */
	...
	#define HAVE_GETOPT_H 1 /* Define if you have the <getopt.h> header file. */
#endif
...
#define HAVE_LOCALE_H 1 /* Define if you have the <locale.h> header file. */
#if !defined(__SALFORDC__) && !defined(__POCC__)
	#define NEED_MALLOC_H 1 /* Define if you need <malloc.h> header even with <stdlib.h> header file. */
#endif
/* #define HAVE_NETDB_H 1 */ /* Define if you have the <netdb.h> header file. */
/* #define HAVE_NETINET_IN_H 1 */ /* Define if you have the <netinet/in.h> header file. */
#ifndef __SALFORDC__
...
#if defined(_MSC_VER) && (_MSC_VER >= 1800)
	#define HAVE_STDBOOL_H 1 /* Define to 1 if you have the <stdbool.h> header file. */
#endif
#define HAVE_STDLIB_H 1 /* Define if you have the <stdlib.h> header file. */
/* #define HAVE_SYS_PARAM_H 1 */ /* Define if you have the <sys/param.h> header file. */
/* #define HAVE_SYS_SELECT_H 1 */ /* Define if you have the <sys/select.h> header file. */
/* #define HAVE_SYS_SOCKET_H 1 */ /* Define if you have the <sys/socket.h> header file. */
/* #define HAVE_SYS_SOCKIO_H 1 */ /* Define if you have the <sys/sockio.h> header file. */
#define HAVE_SYS_STAT_H 1 /* Define if you have the <sys/stat.h> header file. */
/* #define HAVE_SYS_TIME_H 1 */ /* Define if you have the <sys/time.h> header file. */
#define HAVE_SYS_TYPES_H 1 /* Define if you have the <sys/types.h> header file. */
#ifndef __BORLANDC__
	#define HAVE_SYS_UTIME_H 1 /* Define if you have the <sys/utime.h> header file. */
#endif
/* #define HAVE_TERMIO_H 1 */ /* Define if you have the <termio.h> header file. */
/* #define HAVE_TERMIOS_H 1 */ /* Define if you have the <termios.h> header file. */
#define HAVE_TIME_H 1 /* Define if you have the <time.h> header file. */
#if defined(__MINGW32__) || defined(__WATCOMC__) || defined(__LCC__) || defined(__POCC__)
	#define HAVE_UNISTD_H 1 /* Define if you have the <unistd.h> header file. */
#endif
#define HAVE_WINDOWS_H 1 /* Define if you have the <windows.h> header file. */
#define HAVE_WINSOCK_H 1 /* Define if you have the <winsock.h> header file. */
#ifndef __SALFORDC__
	#define HAVE_WINSOCK2_H 1 /* Define if you have the <winsock2.h> header file. */
#endif
#ifndef __SALFORDC__
...
/* #define TIME_WITH_SYS_TIME 1 */ /* Define if you can safely include both <sys/time.h> and <time.h>. */

/* Define to 1 if bool is an available type. */
#if defined(_MSC_VER) && (_MSC_VER >= 1310) // @sobolev 1800-->1310
...
/* #define HAVE_DOPRNT 1 */ /* Define if you don't have vprintf but do have _doprnt. */
/* #define HAVE_FTRUNCATE 1 */ /* Define if you have the ftruncate function. */
...
#define HAVE_GETHOSTBYADDR 1 /* Define if you have the gethostbyaddr function. */
#define HAVE_GETHOSTNAME 1 /* Define if you have the gethostname function. */
/* #define HAVE_GETPASS 1 */ /* Define if you have the getpass function. */
#define HAVE_GETSERVBYNAME 1 /* Define if you have the getservbyname function. */
#define HAVE_GETPROTOBYNAME /* Define if you have the getprotobyname function. */
/* #define HAVE_GETTIMEOFDAY 1 */ /* Define if you have the gettimeofday function. */
#define HAVE_INET_ADDR 1 /* Define if you have the inet_addr function. */
#define HAVE_IOCTLSOCKET 1 /* Define if you have the ioctlsocket function. */
#define HAVE_IOCTLSOCKET_FIONBIO 1 /* Define if you have a working ioctlsocket FIONBIO function. */
#define HAVE_PERROR 1 /* Define if you have the perror function. */
#define HAVE_RAND_SCREEN 1 /* Define if you have the RAND_screen function when using SSL. */
#define HAVE_RAND_STATUS 1 /* Define if you have the `RAND_status' function when using SSL. */
#define HAVE_CRYPTO_CLEANUP_ALL_EX_DATA 1 /* Define if you have the `CRYPTO_cleanup_all_ex_data' function. This is present in OpenSSL versions after 0.9.6b */
#define HAVE_SELECT 1 /* Define if you have the select function. */
#define HAVE_SETLOCALE 1 /* Define if you have the setlocale function. */
#define HAVE_SETMODE 1 /* Define if you have the setmode function. */
#define HAVE_SETVBUF 1 /* Define if you have the setvbuf function. */
#define HAVE_SOCKET 1 /* Define if you have the socket function. */
/* #define HAVE_STRCASECMP 1 */ /* Define if you have the strcasecmp function. */
#define HAVE_STRDUP 1 /* Define if you have the strdup function. */
#define HAVE_STRFTIME 1 /* Define if you have the strftime function. */
#define HAVE_STRICMP 1 /* Define if you have the stricmp function. */
/* #define HAVE_STRNCASECMP 1 */ /* Define if you have the strncasecmp function. */
#define HAVE_STRNICMP 1 /* Define if you have the strnicmp function. */
#define HAVE_STRSTR 1 /* Define if you have the strstr function. */
/* Define if you have the strtoll function. */
#if defined(__MINGW32__) || defined(__WATCOMC__) || defined(__POCC__) || (defined(_MSC_VER) && (_MSC_VER >= 1800))
	#define HAVE_STRTOLL 1
#endif
/* #define HAVE_TCGETATTR 1 */ /* Define if you have the tcgetattr function. */
/* #define HAVE_TCSETATTR 1 */ /* Define if you have the tcsetattr function. */
#ifndef __BORLANDC__
...
#define GETNAMEINFO_TYPE_ARG2 socklen_t /* Define to the type of arg 2 for getnameinfo. */
#define GETNAMEINFO_TYPE_ARG46 DWORD /* Define to the type of args 4 and 6 for getnameinfo. */
#define GETNAMEINFO_TYPE_ARG7 int /* Define to the type of arg 7 for getnameinfo. */
#define HAVE_RECV 1 /* Define if you have the recv function. */
#define RECV_TYPE_ARG1 SOCKET /* Define to the type of arg 1 for recv. */
#define RECV_TYPE_ARG2 char * /* Define to the type of arg 2 for recv. */
#define RECV_TYPE_ARG3 int /* Define to the type of arg 3 for recv. */
#define RECV_TYPE_ARG4 int /* Define to the type of arg 4 for recv. */
#define RECV_TYPE_RETV int /* Define to the function return type for recv. */
#define HAVE_RECVFROM 1 /* Define if you have the recvfrom function. */
#define RECVFROM_TYPE_ARG1 SOCKET /* Define to the type of arg 1 for recvfrom. */
#define RECVFROM_TYPE_ARG2 char /* Define to the type pointed by arg 2 for recvfrom. */
#define RECVFROM_TYPE_ARG3 int /* Define to the type of arg 3 for recvfrom. */
#define RECVFROM_TYPE_ARG4 int /* Define to the type of arg 4 for recvfrom. */
#define RECVFROM_TYPE_ARG5 struct sockaddr /* Define to the type pointed by arg 5 for recvfrom. */
#define RECVFROM_TYPE_ARG6 int /* Define to the type pointed by arg 6 for recvfrom. */
#define RECVFROM_TYPE_RETV int /* Define to the function return type for recvfrom. */
...
typedef struct sockaddr_un {
	/*ADDRESS_FAMILY*/ushort sun_family; // @sobolev vc2003 dosn't know about ADDRESS_FAMILY
