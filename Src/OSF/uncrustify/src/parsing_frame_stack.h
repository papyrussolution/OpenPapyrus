/**
 * @file parsing_frame_stack.h mainly used to handle preprocessor stuff
 * @author  Ben Gardner
 * @license GPL v2+
 */
...
public:
	...
	/**
	 * Pop and return the top element of the frame stack. TODO: return the frame rather than passing it as argument
	 */
