...
static chunk_tag_t keywords[] =
{
	...
	{ "@autoreleasepool",                CT_AUTORELEASEPOOL,
	  LANG_OC                                                                     },
	{ "@available",                      CT_OC_AVAILABLE,
	  LANG_OC                                                                     },
	{ "@catch",                          CT_CATCH,
	  LANG_OC                                                                     },
	{ "@dynamic",                        CT_OC_DYNAMIC,
	  LANG_OC                                                                     },
	{ "@end",                            CT_OC_END,
	  LANG_OC                                                                     },
	{ "@finally",                        CT_FINALLY,
	  LANG_OC                                                                     },
	{ "@implementation",                 CT_OC_IMPL,
	  LANG_OC                                                                     },
	{ "@interface",                      CT_OC_INTF,
	  LANG_OC                                                                     },
	{ "@interface",                      CT_CLASS,
	  LANG_JAVA                                                                   },
	{ "@private",                        CT_ACCESS,
	  LANG_OC                                                                     },
	{ "@property",                       CT_OC_PROPERTY,
	  LANG_OC                                                                     },
	{ "@protected",                      CT_ACCESS,
	  LANG_OC                                                                     },
	{ "@protocol",                       CT_OC_PROTOCOL,
	  LANG_OC                                                                     },
	{ "@public",                         CT_ACCESS,
	  LANG_OC                                                                     },
	{ "@selector",                       CT_OC_SEL,
	  LANG_OC                                                                     },
	{ "@synchronized",                   CT_SYNCHRONIZED,
	  LANG_OC                                                                     },
	{ "@synthesize",                     CT_OC_DYNAMIC,
	  LANG_OC                                                                     },
	{ "@throw",                          CT_THROW,
	  LANG_OC                                                                     },
	{ "@try",                            CT_TRY,
	  LANG_OC                                                                     },
	{ "API_AVAILABLE",                   CT_ATTRIBUTE,
	  LANG_OC                                                                     },
	{ "API_DEPRECATED",                  CT_ATTRIBUTE,
	  LANG_OC                                                                     },
	{ "API_DEPRECATED_WITH_REPLACEMENT", CT_ATTRIBUTE,
	  LANG_OC                                                                     },
	{ "API_UNAVAILABLE",                 CT_ATTRIBUTE,
	  LANG_OC                                                                     },
	{ "BOOL",                            CT_TYPE,
	  LANG_OC                                                                     },
	{ "INT16_C",                         CT_TYPE,
	...
	{ "Q_FOREACH",                       CT_FOR,
	  LANG_CPP                                                                    },
	{ "Q_FOREVER",                       CT_Q_FOREVER,
	  LANG_CPP                                                                    },
	{ "Q_GADGET",                        CT_Q_GADGET,
	  LANG_CPP                                                                    },
	{ "Q_OBJECT",                        CT_COMMENT_EMBED,
	  LANG_CPP                                                                    },
	{ "Q_SIGNALS",                       CT_ACCESS,
	  LANG_CPP                                                                    },
	{ "UINT16_C",                        CT_TYPE,
	...
	{ "_Imaginary",                      CT_TYPE,
	  LANG_C | LANG_CPP                                                           },
	{ "_Nonnull",                        CT_QUALIFIER,
	  LANG_OC                                                                     },
	{ "_Null_unspecified",               CT_QUALIFIER,
	  LANG_OC                                                                     },
	{ "_Nullable",                       CT_QUALIFIER,
	  LANG_OC                                                                     },
	{ "_Pragma",                         CT_PP_PRAGMA,
	  LANG_ALL | FLAG_PP                                                          },
	{ "__DI__",                          CT_DI,
	  LANG_C | LANG_CPP                                                           },
	{ "__HI__",                          CT_HI,
	...
	{ "__asm__",                         CT_ASM,
	  LANG_C | LANG_CPP                                                           },
	{ "__attribute__",                   CT_ATTRIBUTE,
	  LANG_C | LANG_CPP | LANG_OC                                                 },
	{ "__autoreleasing",                 CT_QUALIFIER,
	  LANG_C | LANG_CPP                                                           },
	{ "__block",                         CT_QUALIFIER,
	  LANG_C | LANG_CPP | LANG_OC                                                 },
	{ "__bridge",                        CT_QUALIFIER,
	  LANG_C | LANG_CPP                                                           },
	{ "__bridge_retained",               CT_QUALIFIER,
	  LANG_C | LANG_CPP                                                           },
	{ "__bridge_transfer",               CT_QUALIFIER,
	  LANG_C | LANG_CPP                                                           },
	{ "__const__",                       CT_QUALIFIER,
	  LANG_C | LANG_CPP                                                           },
	{ "__declspec",                      CT_DECLSPEC,
	  LANG_C | LANG_CPP                                                           },
	{ "__except",                        CT_CATCH,
	  LANG_C | LANG_CPP                                                           },
	{ "__finally",                       CT_FINALLY,
	  LANG_C | LANG_CPP                                                           },
	{ "__has_include",                   CT_CNG_HASINC,
	  LANG_C | LANG_CPP | LANG_OC | FLAG_PP                                       },
	{ "__has_include_next",              CT_CNG_HASINCN,
	  LANG_C | LANG_CPP | FLAG_PP                                                 },
	{ "__inline__",                      CT_QUALIFIER,
	  LANG_C | LANG_CPP                                                           },
	{ "__nonnull",                       CT_QUALIFIER,
	  LANG_OC                                                                     },
	{ "__nothrow__",                     CT_NOTHROW,
	  LANG_C | LANG_CPP                                                           },
	{ "__null_unspecified",              CT_QUALIFIER,
	  LANG_OC                                                                     },
	{ "__nullable",                      CT_QUALIFIER,
	  LANG_OC                                                                     },
	{ "__pragma",                        CT_PP_PRAGMA,
	  LANG_ALL | FLAG_PP                                                          },
	{ "__restrict",                      CT_QUALIFIER,
	  LANG_C | LANG_CPP                                                           },
	{ "__signed__",                      CT_TYPE,
	  LANG_C | LANG_CPP                                                           },
	{ "__strong",                        CT_QUALIFIER,
	  LANG_C | LANG_CPP                                                           },
	{ "__thread",                        CT_QUALIFIER,
	  LANG_C | LANG_CPP                                                           },
	{ "__traits",                        CT_QUALIFIER,
	  LANG_D                                                                      },
	{ "__try",                           CT_TRY,
	  LANG_C | LANG_CPP                                                           },
	{ "__typeof",                        CT_DECLTYPE,
	  LANG_C | LANG_CPP | LANG_OC                                                 },
	{ "__typeof__",                      CT_DECLTYPE,
	  LANG_C | LANG_CPP                                                           },
	{ "__unsafe_unretained",             CT_QUALIFIER,
	  LANG_OC                                                                     },
	{ "__unused",                        CT_ATTRIBUTE,
	  LANG_C | LANG_CPP                                                           },
	{ "__volatile__",                    CT_QUALIFIER,
	  LANG_C | LANG_CPP                                                           },
	{ "__weak",                          CT_QUALIFIER,
	  LANG_C | LANG_CPP                                                           },
	{ "__word__",                        CT_WORD_,
	...
	{ "body",                            CT_BODY,
	  LANG_D                                                                      },
	{ "bool",                            CT_TYPE,
	  LANG_C | LANG_CPP | LANG_CS | LANG_VALA                                     },
	{ "boolean",                         CT_TYPE,
	  LANG_JAVA | LANG_ECMA                                                       },
	{ "break",                           CT_BREAK,
	  LANG_ALL                                                                    },
	{ "byte",                            CT_TYPE,
	  LANG_CS | LANG_D | LANG_JAVA | LANG_ECMA                                    },
	{ "callback",                        CT_QUALIFIER,
	  LANG_VALA                                                                   },
	{ "case",                            CT_CASE,
	  LANG_ALL                                                                    },
	{ "cast",                            CT_D_CAST,
	...
	{ "const",                           CT_QUALIFIER,
	  LANG_ALL                                                                    },
	{ "const_cast",                      CT_TYPE_CAST,
	  LANG_CPP                                                                    },
	{ "constexpr",                       CT_QUALIFIER,
	  LANG_CPP                                                                    },
	{ "construct",                       CT_CONSTRUCT,
	  LANG_VALA                                                                   },
	...
	{ "debug",                           CT_DEBUG,
	  LANG_D                                                                      },
	{ "debugger",                        CT_DEBUGGER,
	  LANG_ECMA                                                                   },
	{ "decltype",                        CT_DECLTYPE,
	  LANG_CPP                                                                    },
	{ "default",                         CT_DEFAULT,
	  LANG_ALL                                                                    },
	{ "define",                          CT_PP_DEFINE,
	...
	{ "defined",                         CT_DEFINED,
	  LANG_PAWN                                                                   },
	{ "defined",                         CT_PP_DEFINED,
	  LANG_ALLC | FLAG_PP                                                         },
	{ "delegate",                        CT_DELEGATE,
	  LANG_CS | LANG_VALA | LANG_D                                                },
	{ "delete",                          CT_DELETE,
	  LANG_CPP | LANG_D | LANG_ECMA | LANG_VALA                                   },
	{ "deprecated",                      CT_QUALIFIER,
	  LANG_D                                                                      },
	{ "do",                              CT_DO,
	  LANG_ALL                                                                    },
	{ "double",                          CT_TYPE,
	  LANG_ALLC                                                                   },
	{ "dynamic_cast",                    CT_TYPE_CAST,
	  LANG_CPP                                                                    },
	{ "elif",                            CT_PP_ELSE,
	  LANG_ALLC | FLAG_PP                                                         },
	{ "else",                            CT_ELSE,
	...
	{ "endif",                           CT_PP_ENDIF,
	  LANG_ALL | FLAG_PP                                                          },
	{ "endinput",                        CT_PP_ENDINPUT,
	  LANG_PAWN | FLAG_PP                                                         },
	{ "endregion",                       CT_PP_ENDREGION,
	  LANG_ALL | FLAG_PP                                                          },
	{ "endscript",                       CT_PP_ENDINPUT,
	  LANG_PAWN | FLAG_PP                                                         },
	{ "enum",                            CT_ENUM,
	  LANG_ALL                                                                    },
	{ "error",                           CT_PP_ERROR,
	...
	{ "exit",                            CT_FUNCTION,
	  LANG_PAWN                                                                   },
	{ "explicit",                        CT_QUALIFIER,
	  LANG_CPP | LANG_CS                                                          },
	{ "export",                          CT_EXPORT,
	  LANG_CPP | LANG_D | LANG_ECMA                                               },
	{ "extends",                         CT_QUALIFIER,
	  LANG_JAVA | LANG_ECMA                                                       },
	{ "extern",                          CT_EXTERN,
	  LANG_C | LANG_CPP | LANG_OC | LANG_CS | LANG_D | LANG_VALA                  },
	{ "false",                           CT_WORD,
	  LANG_ALL                                                                    },
	{ "file",                            CT_PP_FILE,
	  LANG_PAWN | FLAG_PP                                                         },
	...
	{ "for",                             CT_FOR,
	  LANG_ALL                                                                    },
	{ "foreach",                         CT_FOR,
	  LANG_CS | LANG_D | LANG_VALA                                                },
	{ "foreach_reverse",                 CT_FOR,
	  LANG_D                                                                      },
	{ "forward",                         CT_FORWARD,
	  LANG_PAWN                                                                   },
	{ "friend",                          CT_FRIEND,
	...
	{ "ifndef",                          CT_PP_IF,
	  LANG_ALLC | FLAG_PP                                                         },
	{ "implements",                      CT_QUALIFIER,
	  LANG_JAVA | LANG_ECMA                                                       },
	{ "implicit",                        CT_QUALIFIER,
	  LANG_CS                                                                     },
	{ "import",                          CT_IMPORT,
	...
	{ "import",                          CT_PP_INCLUDE,
	  LANG_OC | FLAG_PP                                                           },
	{ "in",                              CT_IN,
	  LANG_D | LANG_CS | LANG_VALA | LANG_ECMA | LANG_OC                          },
	{ "include",                         CT_PP_INCLUDE,
	  LANG_C | LANG_CPP | LANG_OC | LANG_PAWN | FLAG_PP                           },
	{ "inline",                          CT_QUALIFIER,
	  LANG_C | LANG_CPP                                                           },
	{ "inout",                           CT_QUALIFIER,
	  LANG_D                                                                      },
	{ "instanceof",                      CT_SIZEOF,
	  LANG_JAVA | LANG_ECMA                                                       },
	{ "int",                             CT_TYPE,
	  LANG_ALLC                                                                   },
	{ "interface",                       CT_CLASS,
	  LANG_CPP | LANG_CS | LANG_D | LANG_JAVA | LANG_VALA | LANG_ECMA             },
	{ "internal",                        CT_QUALIFIER,
	  LANG_CS | LANG_VALA                                                         },
	...
	{ "module",                          CT_D_MODULE,
	  LANG_D                                                                      },
	{ "mutable",                         CT_QUALIFIER,
	  LANG_CPP                                                                    },
	{ "namespace",                       CT_NAMESPACE,
	  LANG_CPP | LANG_CS | LANG_VALA                                              },
	{ "native",                          CT_NATIVE,
	  LANG_PAWN                                                                   },
	{ "native",                          CT_QUALIFIER,
	  LANG_JAVA | LANG_ECMA                                                       },
	{ "new",                             CT_NEW,
	  LANG_CPP | LANG_CS | LANG_D | LANG_JAVA | LANG_PAWN | LANG_VALA | LANG_ECMA },
	{ "noexcept",                        CT_NOEXCEPT,
	  LANG_CPP                                                                    },
	{ "nonnull",                         CT_TYPE,
	  LANG_OC                                                                     },
	{ "not",                             CT_SARITH,
...
//                                    },
	{ "null_resettable",                 CT_OC_PROPERTY_ATTR,
	  LANG_OC                                                                     },
	{ "null_unspecified",                CT_TYPE,
	  LANG_OC                                                                     },
	{ "nullable",                        CT_TYPE,
	  LANG_OC                                                                     },
	{ "object",                          CT_TYPE,
	...
	{ "out",                             CT_QUALIFIER,
	  LANG_CS | LANG_D | LANG_VALA                                                },
	{ "override",                        CT_QUALIFIER,
	  LANG_CPP | LANG_CS | LANG_D | LANG_VALA                                     },
	{ "package",                         CT_ACCESS,
	  LANG_D                                                                      },
	{ "package",                         CT_PACKAGE,
	  LANG_ECMA | LANG_JAVA                                                       },
	...
	{ "region",                          CT_PP_REGION,
	  LANG_ALL | FLAG_PP                                                          },
	{ "register",                        CT_QUALIFIER,
	  LANG_C | LANG_CPP                                                           },
	{ "reinterpret_cast",                CT_TYPE_CAST,
	  LANG_CPP                                                                    },
	{ "remove",                          CT_GETSET,
	  LANG_CS                                                                     },
	{ "restrict",                        CT_QUALIFIER,
	  LANG_C | LANG_CPP                                                           },
	{ "return",                          CT_RETURN,
	  LANG_ALL                                                                    },
	{ "sbyte",                           CT_TYPE,
	...
	{ "size_t",                          CT_TYPE,
	  LANG_ALLC                                                                   },
	{ "sizeof",                          CT_SIZEOF,
	  LANG_C | LANG_CPP | LANG_CS | LANG_VALA | LANG_PAWN                         },
	{ "sleep",                           CT_SIZEOF,
	  LANG_PAWN                                                                   },
	{ "stackalloc",                      CT_NEW,
	  LANG_CS                                                                     },
	...
	{ "static",                          CT_QUALIFIER,
	  LANG_ALL                                                                    },
	{ "static_cast",                     CT_TYPE_CAST,
	  LANG_CPP                                                                    },
	{ "stock",                           CT_STOCK,
	  LANG_PAWN                                                                   },
	{ "strictfp",                        CT_QUALIFIER,
	  LANG_JAVA                                                                   },
	{ "string",                          CT_TYPE,
	  LANG_CS | LANG_VALA                                                         },
	{ "struct",                          CT_STRUCT,
	...
	{ "throw",                           CT_THROW,
	  LANG_CPP | LANG_CS | LANG_VALA | LANG_D | LANG_JAVA | LANG_ECMA             },
	{ "throws",                          CT_QUALIFIER,
	  LANG_JAVA | LANG_ECMA | LANG_VALA                                           },
	{ "transient",                       CT_QUALIFIER,
	  LANG_JAVA | LANG_ECMA                                                       },
	{ "true",                            CT_WORD,
	  LANG_ALL                                                                    },
	{ "try",                             CT_TRY,
	  LANG_CPP | LANG_CS | LANG_D | LANG_JAVA | LANG_ECMA | LANG_VALA             },
	{ "tryinclude",                      CT_PP_INCLUDE,
	  LANG_PAWN | FLAG_PP                                                         },
	{ "typedef",                         CT_TYPEDEF,
	  LANG_C | LANG_CPP | LANG_OC | LANG_D                                        },
	{ "typeid",                          CT_SIZEOF,
	  LANG_CPP | LANG_D                                                           },
	...
	{ "typeof",                          CT_DECLTYPE,
	  LANG_C | LANG_CPP                                                           },
	{ "typeof",                          CT_SIZEOF,
	  LANG_CS | LANG_D | LANG_VALA | LANG_ECMA                                    },
	{ "ubyte",                           CT_TYPE,
	  LANG_D                                                                      },
	{ "ucent",                           CT_TYPE,
	  LANG_D                                                                      },
	...
	{ "ulong",                           CT_TYPE,
	  LANG_CS | LANG_VALA | LANG_D                                                },
	{ "unchecked",                       CT_QUALIFIER,
	  LANG_CS                                                                     },
	{ "undef",                           CT_PP_UNDEF,
	  LANG_ALL | FLAG_PP                                                          },
	{ "union",                           CT_UNION,
	  LANG_C | LANG_CPP | LANG_D                                                  },
	{ "unittest",                        CT_UNITTEST,
	  LANG_D                                                                      },
	{ "unsafe",                          CT_UNSAFE,
	  LANG_CS                                                                     },
	{ "unsafe_unretained",               CT_QUALIFIER,
	  LANG_OC                                                                     },
	{ "unsigned",                        CT_TYPE,
	  LANG_C | LANG_CPP                                                           },
	{ "ushort",                          CT_TYPE,
	...
	{ "using",                           CT_USING,
	  LANG_CPP | LANG_CS | LANG_VALA                                              },
	{ "var",                             CT_TYPE,
	  LANG_CS | LANG_VALA | LANG_ECMA                                             },
	{ "version",                         CT_D_VERSION,
	  LANG_D                                                                      },
	{ "virtual",                         CT_QUALIFIER,
	  LANG_CPP | LANG_CS | LANG_VALA                                              },
	{ "void",                            CT_TYPE,
	  LANG_ALLC                                                                   },
	{ "volatile",                        CT_QUALIFIER,
	  LANG_C | LANG_CPP | LANG_CS | LANG_JAVA | LANG_ECMA                         },
...
void init_keywords_for_language()
{
	...
	size_t keywords_count = SIZEOFARRAY(keywords);
	language_count = 0;
...
static const chunk_tag_t * kw_static_first(const chunk_tag_t * tag)
{
	...
	while(prev >= &keyword_for_lang[0]/*not at beginning of keyword array*/ && sstreq(prev->tag, tag->tag)) { // tags match
		tag = prev;
		prev--;
	}
	return (tag);
...
static const chunk_tag_t * kw_static_match(bool orig_list, const chunk_tag_t * tag, int lang_flags)
{
	...
	for(const chunk_tag_t * iter = kw_static_first(tag); (orig_list) ? (iter < &keywords[SIZEOFARRAY(keywords)]) : (iter < &keyword_for_lang[language_count]); iter++) {
		bool pp_iter = (iter->lang_flags & FLAG_PP) != 0; // forcing value to bool
		if(sstreq(iter->tag, tag->tag) && language_is_set(iter->lang_flags) && (lang_flags & iter->lang_flags) && in_pp == pp_iter) {
			return (iter);
		}
	}
	return nullptr;
...
E_Token find_keyword_type(const char * word, size_t len)
{
	...
	const chunk_tag_t * p_ret = static_cast<const chunk_tag_t *>(bsearch(&key, keyword_for_lang, language_count, sizeof(keyword_for_lang[0]), kw_compare));
	if(p_ret != nullptr) {
		if(sstreq(p_ret->tag, "__pragma") || sstreq(p_ret->tag, "_Pragma")) {
