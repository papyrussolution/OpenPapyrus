/**
 * @file check_template.h prototypes for check_template.cpp
 *
...
/**
 * If there is nothing but CT_WORD and CT_MEMBER, then it's probably a template thingy.  Otherwise, it's likely a
 *comparison.
 *
 * @param start  chunk to start check at
 */
