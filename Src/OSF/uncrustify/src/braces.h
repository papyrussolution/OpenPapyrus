/**
 * @file braces.h prototypes for braces.cpp
 *
 * @author  Ben Gardner
 * @license GPL v2+
 */
 ...
 *   add_long_preprocessor_conditional_block_comment in output.cpp
 */
void add_long_closebrace_comment();
/**
 * Adds a comment after the ref chunk Returns the added chunk or Chunk::NullChunkPtr
 */
