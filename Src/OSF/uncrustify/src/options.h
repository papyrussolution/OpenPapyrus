...
extern Option<line_end_e> newlines; // = LE_AUTO
// The original size of tabs in the input.
extern BoundedOption<unsigned, 1, 32> input_tab_size; // = 8

// The size of tabs in the output (only used if align_with_tabs=true).
extern BoundedOption<unsigned, 1, 32> output_tab_size; // = 8

// The ASCII value of the string escape char, usually 92 (\) or (Pawn) 94 (^).
extern BoundedOption<unsigned, 0, 255> string_escape_char; // = '\\'

// Alternate string escape char (usually only used for Pawn).
// Only works right before the quote char.
extern BoundedOption<unsigned, 0, 255> string_escape_char2;

// Replace tab characters found in string literals with the escape sequence \t
// instead.
extern Option<bool> string_replace_tab_chars;

// Allow interpreting '>=' and '>>=' as part of a template in code like
// 'void f(list<list<B>>=val);'. If true, 'assert(x<0 && y>=3)' will be broken.
// Improvements to template detection may make this option obsolete.
extern Option<bool> tok_split_gte;

// Disable formatting of NL_CONT ('\\n') ended lines (e.g. multi-line macros).
extern Option<bool> disable_processing_nl_cont;

// Specify the marker used in comments to disable processing of part of the
// file.
extern Option<string> disable_processing_cmt; // = UNCRUSTIFY_OFF_TEXT

// Specify the marker used in comments to (re)enable processing in a file.
extern Option<string> enable_processing_cmt; // = UNCRUSTIFY_ON_TEXT

// Enable parsing of digraphs.
extern Option<bool> enable_digraphs;
...
extern Option<bool> processing_cmt_as_regex;

// Add or remove the UTF-8 BOM (recommend 'remove').
extern Option<iarf_e> utf8_bom;

// If the file contains bytes with values between 128 and 255, but is not
// UTF-8, then output as UTF-8.
extern Option<bool> utf8_byte;

// Force the output encoding to UTF-8.
extern Option<bool> utf8_force;
...
// '<<', and so forth).
extern Option<iarf_e> sp_arith;
// Add or remove space around arithmetic operators '+' and '-'.
//
// Overrides sp_arith.
extern Option<iarf_e> sp_arith_additive;

// Add or remove space around assignment operator '=', '+=', etc.
extern Option<iarf_e> sp_assign;

// Add or remove space around '=' in C++11 lambda capture specifications.
//
// Overrides sp_assign.
extern Option<iarf_e> sp_cpp_lambda_assign;

// Add or remove space after the capture specification of a C++11 lambda when
// an argument list is present, as in '[] <here> (int x){ ... }'.
extern Option<iarf_e> sp_cpp_lambda_square_paren;

// Add or remove space after the capture specification of a C++11 lambda with
// no argument list is present, as in '[] <here> { ... }'.
extern Option<iarf_e> sp_cpp_lambda_square_brace;

// Add or remove space after the opening parenthesis and before the closing
// parenthesis of a argument list of a C++11 lambda, as in
// '[]( <here> int x <here> ){ ... }'.
extern Option<iarf_e> sp_cpp_lambda_argument_list;

// Add or remove space after the argument list of a C++11 lambda, as in
// '[](int x) <here> { ... }'.
extern Option<iarf_e> sp_cpp_lambda_paren_brace;

// Add or remove space between a lambda body and its call operator of an
// immediately invoked lambda, as in '[]( ... ){ ... } <here> ( ... )'.
extern Option<iarf_e> sp_cpp_lambda_fparen;
extern Option<iarf_e> sp_assign_default; // Add or remove space around assignment operator '=' in a prototype. If set to ignore, use sp_assign.
extern Option<iarf_e> sp_before_assign; // Add or remove space before assignment operator '=', '+=', etc. Overrides sp_assign.
extern Option<iarf_e> sp_after_assign; // Add or remove space after assignment operator '=', '+=', etc. Overrides sp_assign.
extern Option<iarf_e> sp_enum_brace; // = IARF_ADD // Add or remove space in 'enum {'.
extern Option<iarf_e> sp_enum_paren; // Add or remove space in 'NS_ENUM ('.
extern Option<iarf_e> sp_enum_assign; // Add or remove space around assignment '=' in enum.

// Add or remove space before assignment '=' in enum.
//
// Overrides sp_enum_assign.
extern Option<iarf_e> sp_enum_before_assign;

// Add or remove space after assignment '=' in enum.
//
// Overrides sp_enum_assign.
extern Option<iarf_e> sp_enum_after_assign;

// Add or remove space around assignment ':' in enum.
extern Option<iarf_e> sp_enum_colon;

// Add or remove space around preprocessor '##' concatenation operator.
extern Option<iarf_e> sp_pp_concat; // = IARF_ADD

// Add or remove space after preprocessor '#' stringify operator.
// Also affects the '#@' charizing operator.
extern Option<iarf_e> sp_pp_stringify;

// Add or remove space before preprocessor '#' stringify operator
// as in '#define x(y) L#y'.
extern Option<iarf_e> sp_before_pp_stringify;
extern Option<iarf_e> sp_bool; // Add or remove space around boolean operators '&&' and '||'.
extern Option<iarf_e> sp_compare; // Add or remove space around compare operator '<', '>', '==', etc.
extern Option<iarf_e> sp_inside_paren; // Add or remove space inside '(' and ')'.
extern Option<iarf_e> sp_paren_paren; // Add or remove space between nested parentheses, i.e. '((' vs. ') )'.
extern Option<iarf_e> sp_cparen_oparen; // Add or remove space between back-to-back parentheses, i.e. ')(' vs. ') ('.
extern Option<bool> sp_balance_nested_parens; // Whether to balance spaces inside nested parentheses.
extern Option<iarf_e> sp_paren_brace; // Add or remove space between ')' and '{'.
extern Option<iarf_e> sp_brace_brace; // Add or remove space between nested braces, i.e. '{{' vs. '{ {'.
extern Option<iarf_e> sp_before_ptr_star; // Add or remove space before pointer star '*'.
// Add or remove space before pointer star '*' that isn't followed by a
// variable name. If set to ignore, sp_before_ptr_star is used instead.
extern Option<iarf_e> sp_before_unnamed_ptr_star;
extern Option<iarf_e> sp_between_ptr_star; // Add or remove space between pointer stars '*', as in 'int ***a;'.
// Add or remove space after pointer star '*', if followed by a word.
//
// Overrides sp_type_func.
extern Option<iarf_e> sp_after_ptr_star;
// Add or remove space after pointer caret '^', if followed by a word.
extern Option<iarf_e> sp_after_ptr_block_caret;
// Add or remove space after pointer star '*', if followed by a qualifier.
extern Option<iarf_e> sp_after_ptr_star_qualifier;

// Add or remove space after a pointer star '*', if followed by a function
// prototype or function definition.
//
// Overrides sp_after_ptr_star and sp_type_func.
extern Option<iarf_e> sp_after_ptr_star_func;
// Add or remove space after a pointer star '*' in the trailing return of a
// function prototype or function definition.
extern Option<iarf_e> sp_after_ptr_star_trailing;
// Add or remove space between the pointer star '*' and the name of the variable
// in a function pointer definition.
extern Option<iarf_e> sp_ptr_star_func_var;

// Add or remove space between the pointer star '*' and the name of the type
// in a function pointer type definition.
extern Option<iarf_e> sp_ptr_star_func_type;
...
extern BoundedOption<unsigned, 0, 16> indent_columns; // = 8
...
extern Option<bool> indent_ignore_first_continue;
...
extern BoundedOption<signed, -16, 16> indent_continue;

// The continuation indent, only for class header line(s). If non-zero, this
// overrides the indent of 'class' continuation indents.
// Requires indent_ignore_first_continue=false.
extern BoundedOption<unsigned, 0, 16> indent_continue_class_head;

// Whether to indent empty lines (i.e. lines which contain only spaces before
// the newline character).
extern Option<bool> indent_single_newlines;

// The continuation indent for func_*_param if they are true. If non-zero, this
// overrides the indent.
extern BoundedOption<unsigned, 0, 16> indent_param;
...
extern BoundedOption<unsigned, 0, 2> indent_with_tabs; // = 1

// Whether to indent comments that are not at a brace level with tabs on a
// tabstop. Requires indent_with_tabs=2. If false, will use spaces.
extern Option<bool> indent_cmt_with_tabs;

// Whether to indent strings broken by '\' so that they line up.
extern Option<bool> indent_align_string;

// The number of spaces to indent multi-line XML strings.
// Requires indent_align_string=true.
extern BoundedOption<unsigned, 0, 16> indent_xml_string;
extern BoundedOption<unsigned, 0, 16> indent_brace; // Spaces to indent '{' from level.
extern Option<bool> indent_braces; // Whether braces are indented to the body level.
extern Option<bool> indent_braces_no_func; // Whether to disable indenting function braces if indent_braces=true.
// Whether to disable indenting class braces if indent_braces=true.
extern Option<bool> indent_braces_no_class;
// Whether to disable indenting struct braces if indent_braces=true.
extern Option<bool> indent_braces_no_struct;
// Whether to indent based on the size of the brace parent,
// i.e. 'if' => 3 spaces, 'for' => 4 spaces, etc.
extern Option<bool> indent_brace_parent;
// Whether to indent based on the open parenthesis instead of the open brace
// in '({\n'.
extern Option<bool> indent_paren_open_brace;
// (C#) Whether to indent the brace of a C# delegate by another level.
extern Option<bool> indent_cs_delegate_brace;
// (C#) Whether to indent a C# delegate (to handle delegates with no brace) by another level.
extern Option<bool> indent_cs_delegate_body;
extern Option<bool> indent_namespace; // Whether to indent the body of a 'namespace'.
// Whether to indent only the first namespace, and not any nested namespaces.
// Requires indent_namespace=true.
extern Option<bool> indent_namespace_single_indent;
// The number of spaces to indent a namespace block.
// If set to zero, use the value indent_columns
extern BoundedOption<unsigned, 0, 16> indent_namespace_level;
// If the body of the namespace is longer than this number, it won't be
// indented. Requires indent_namespace=true. 0 means no limit.
extern BoundedOption<unsigned, 0, 255> indent_namespace_limit;
// Whether to indent only in inner namespaces (nested in other namespaces).
// Requires indent_namespace=true.
extern Option<bool> indent_namespace_inner_only;
extern Option<bool> indent_extern; // Whether the 'extern "C"' body is indented.
extern Option<bool> indent_class; // Whether the 'class' body is indented.
extern Option<bool> indent_ignore_before_class_colon; // Whether to ignore indent for the leading base class colon.
...
extern BoundedOption<signed, -16, 16> indent_before_class_colon;
// Whether to indent the stuff after a leading base class colon.
extern Option<bool> indent_class_colon;
// Whether to indent based on a class colon instead of the stuff after the
// colon. Requires indent_class_colon=true.
extern Option<bool> indent_class_on_colon;
extern Option<bool> indent_ignore_before_constr_colon; // Whether to ignore indent for a leading class initializer colon.
extern Option<bool> indent_constr_colon; // Whether to indent the stuff after a leading class initializer colon.
// Virtual indent from the ':' for leading member initializers.
extern BoundedOption<unsigned, 0, 16> indent_ctor_init_leading; // = 2
// Virtual indent from the ':' for following member initializers.
extern BoundedOption<unsigned, 0, 16> indent_ctor_init_following; // = 2
// Additional indent for constructor initializer list.
// Negative values decrease indent down to the first column.
extern BoundedOption<signed, -16, 16> indent_ctor_init;
// Whether to indent 'if' following 'else' as a new block under the 'else'.
// If false, 'else\nif' is treated as 'else if' for indenting purposes.
extern Option<bool> indent_else_if;
// Amount to indent variable declarations after a open brace.
//
//  <0: Relative
// >=0: Absolute
extern BoundedOption<signed, -16, 16> indent_var_def_blk;
// Whether to indent continued variable declarations instead of aligning.
extern Option<bool> indent_var_def_cont;
...
extern BoundedOption<signed, -1, 1> indent_shift;
// Whether to force indentation of function definitions to start in column 1.
extern Option<bool> indent_func_def_force_col1;
// Whether to indent continued function call parameters one indent level,
// rather than aligning parameters under the open parenthesis.
extern Option<bool> indent_func_call_param;
// Whether to indent continued function definition parameters one indent level,
// rather than aligning parameters under the open parenthesis.
extern Option<bool> indent_func_def_param;
...
extern Option<bool> indent_macro_brace; // = true
// The number of spaces to indent a continued '->' or '.'.
// Usually set to 0, 1, or indent_columns.
extern BoundedOption<unsigned, 0, 16> indent_member;
// Whether lines broken at '.' or '->' should be indented by a single indent.
// The indent_member option will not be effective if this is set to true.
extern Option<bool> indent_member_single;
// Spaces to indent single line ('//') comments on lines before code.
extern BoundedOption<unsigned, 0, 16> indent_single_line_comments_before;
// Spaces to indent single line ('//') comments on lines after code.
extern BoundedOption<unsigned, 0, 16> indent_single_line_comments_after;
...
extern BoundedOption<signed, -16, 16> indent_sparen_extra;
// Whether to indent trailing single line ('//') comments relative to the code
// instead of trying to keep the same absolute column.
extern Option<bool> indent_relative_single_line_comments;
// Spaces to indent 'case' from 'switch'. Usually 0 or indent_columns.
// It might be wise to choose the same value for the option indent_case_brace.
extern BoundedOption<unsigned, 0, 16> indent_switch_case;

// Spaces to indent the body of a 'switch' before any 'case'.
// Usually the same as indent_columns or indent_switch_case.
extern BoundedOption<unsigned, 0, 16> indent_switch_body;
// Whether to ignore indent for '{' following 'case'.
extern Option<bool> indent_ignore_case_brace;
// Spaces to indent '{' from 'case'. By default, the brace will appear under
// the 'c' in case. Usually set to 0 or indent_columns. Negative values are OK.
// It might be wise to choose the same value for the option indent_switch_case.
extern BoundedOption<signed, -16, 16> indent_case_brace;
extern Option<bool> indent_switch_break_with_case; // indent 'break' with 'case' from 'switch'.
// Whether to indent preprocessor statements inside of switch statements.
extern Option<bool> indent_switch_pp; // = true
// Spaces to shift the 'case' line, without affecting any other lines.  Usually 0.
extern BoundedOption<unsigned, 0, 16> indent_case_shift;
// Whether to align comments before 'case' with the 'case'.
extern Option<bool> indent_case_comment; // = true
// Whether to indent comments not found in first column.
extern Option<bool> indent_comment; // = true
// Whether to indent comments found in first column.
extern Option<bool> indent_col1_comment;
// Whether to indent multi string literal in first column.
extern Option<bool> indent_col1_multi_string_literal;
// Align comments on adjacent lines that are this many columns apart or less.
extern BoundedOption<unsigned, 0, 16> indent_comment_align_thresh; // = 3
// Whether to ignore indent for goto labels.
extern Option<bool> indent_ignore_label;
// How to indent goto labels. Requires indent_ignore_label=false.
//
//  >0: Absolute column where 1 is the leftmost column
// <=0: Subtract from brace indent
extern BoundedOption<signed, -16, 16> indent_label; // = 1
// How to indent access specifiers that are followed by a
// colon.
//
//  >0: Absolute column where 1 is the leftmost column
// <=0: Subtract from brace indent
extern BoundedOption<signed, -16, 16> indent_access_spec; // = 1
// Whether to indent the code after an access specifier by one level.
// If true, this option forces 'indent_access_spec=0'.
extern Option<bool> indent_access_spec_body;
// If an open parenthesis is followed by a newline, whether to indent the next
// line so that it lines up after the open parenthesis (not recommended).
extern Option<bool> indent_paren_nl;
...
extern Option<bool> indent_square_nl;
// (ESQL/C) Whether to preserve the relative indent of 'EXEC SQL' bodies.
extern Option<bool> indent_preserve_sql;
...
extern Option<bool> use_indent_func_call_param; // = true
...
//
// Requires indent_ignore_first_continue=false.
extern Option<bool> use_indent_continue_only_once;
...
extern Option<bool> indent_cpp_lambda_only_once;

// Whether sp_after_angle takes precedence over sp_inside_fparen. This was the
// historic behavior, but is probably not the desired behavior, so this is off
// by default.
extern Option<bool> use_sp_after_angle_always;
...
extern Option<bool> use_options_overriding_for_qt_macros; // = true
...
extern Option<bool> use_form_feed_no_more_as_whitespace_character;
...
extern BoundedOption<unsigned, 1, 3> warn_level_tabs_found_in_verbatim_string_literals; // = LWARN
