/**
 * @file space.h prototypes for space.cpp
 * @author  Ben Gardner
 * @license GPL v2+
 */
...
/**
 * Calculates the column difference between two chunks. The rules are bent a bit here, as IARF_IGNORE and IARF_ADD
 *become IARF_FORCE. So the column difference is either first->len or first->len + 1.
 *
