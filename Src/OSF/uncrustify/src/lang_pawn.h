/**
 * @file long_pawn.h prototypes for long_pawn.c
 *
 * @author  Ben Gardner
 * @license GPL v2+
 */
...
/**
 * Does a scan of level 0 BEFORE stuff in combine.cpp is called. At this point, VSemis have been added only in VBraces.
