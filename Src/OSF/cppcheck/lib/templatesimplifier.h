...
private:
	 ...
	 */
	void expandTemplate(const TokenAndName &templateDeclaration,
	 ...
	 *                                                         ^ [0]       ^ [1]
	 */
	static void getTemplateParametersInDeclaration(const Token * tok,
	...
	static bool matchSpecialization(const Token * templateDeclarationNameToken,
	 ...
	 */
	std::string getNewName(Token * tok2,
	    std::list<std::string> &typeStringsUsedInTemplateInstantiation);

	void printOut(const TokenAndName &tokenAndName,
