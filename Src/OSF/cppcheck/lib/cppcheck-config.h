...
#ifndef __CPPCHECK_CONFIG_H
#define __CPPCHECK_CONFIG_H
...
#define SUPPRESS_WARNING(warning, \
	    ...)_Pragma("clang diagnostic push") _Pragma(STRINGISIZE(clang diagnostic ignored warning)) __VA_ARGS__ _Pragma( \
