...
#define UNPADDED_SIZE_MIN LZMA_VLI_C(5) /// Minimum Unpadded Size
#define UNPADDED_SIZE_MAX (LZMA_VLI_MAX & ~LZMA_VLI_C(3)) /// Maximum Unpadded Size
...
static inline lzma_vli index_size_unpadded(lzma_vli count, lzma_vli index_list_size)
{
...
static inline lzma_vli index_stream_size(lzma_vli blocks_size, lzma_vli count, lzma_vli index_list_size)
