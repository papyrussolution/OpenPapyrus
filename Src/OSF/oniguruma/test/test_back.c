...
static void xx(char * pattern, char * str, int from, int to, int mem, int not, int error_no, int line_no)
{
	...
	regex_t* reg;
	OnigErrorInfo einfo;
	int r = onig_new(&reg, (uchar *)pattern, (uchar *)(pattern + SLEN(pattern)), ONIG_OPTION_DEFAULT, ONIG_ENCODING_UTF8, ONIG_SYNTAX_DEFAULT, &einfo);
	if(r) {
	...
	r = onig_search(reg, (uchar *)str, (uchar *)(str + SLEN(str)), (uchar *)(str + SLEN(str)), (uchar *)str, OnigTB.region, ONIG_OPTION_NONE);
	if(r < ONIG_MISMATCH) {
		char s[ONIG_MAX_ERROR_MESSAGE_LEN];
		if(error_no == 0) {
...
extern int OnigTestBack_main(FILE * fOut)
{
	...
	x2("c.*\\b", "abc", 2, 3);
	x2("\\b.*abc.*\\b", "abc", 0, 3);
	x2("((?()0+)+++(((0\\g<0>)0)|())++++((?(1)(0\\g<0>))++++++0*())++++((?(1)(0\\g<1>)+)++++++++++*())++++((?(1)((0)\\g<0>)+)++())+0++*+++(((0\\g<0>))*())++++((?(1)(0\\g<0>)+)++++++++++*|)++++*+++((?(1)((0)\\g<0>)+)+++++++++())++*|)++++((?()0))|",
		"abcde", 5, 5);                                                                                                                                                                                                                                                   // #139

	n("(*FAIL)", "abcdefg");
	n("abcd(*FAIL)(*FAIL)(*FAIL)(*FAIL)(*FAIL)(*FAIL)(*FAIL)(*FAIL)(*FAIL)(*FAIL)(*FAIL)(*FAIL)(*FAIL)(*FAIL)(*FAIL)(*FAIL)(*FAIL)(*FAIL)(*FAIL)(*FAIL)(*FAIL)(*FAIL)(*FAIL)(*FAIL)(*FAIL)(*FAIL)(*FAIL)(*FAIL)(*FAIL)(*FAIL)(*FAIL)(*FAIL)(*FAIL)(*FAIL)(*FAIL)(*FAIL)(*FAIL)(*FAIL)(*FAIL)(*FAIL)(*FAIL)(*FAIL)(*FAIL)(*FAIL)(*FAIL)(*FAIL)(*FAIL)(*FAIL)(*FAIL)(*FAIL)(*FAIL)(*FAIL)(*FAIL)(*FAIL)(*FAIL)(*FAIL)",
		"abcdefg");
	x2("(?:[ab]|(*MAX{2}).)*", "abcbaaccaaa", 11, 11);
	x2("(?:(*COUNT[AB]{X})[ab]|(*COUNT[CD]{X})[cd])*(*CMP{AB,<,CD})", "abababcdab", 7, 8);
	x2("(?(?{....})123|456)", "123", 0, 3);
	...
	x2("(?<=()|)\\1{0}", "abc", 3, 3);
	e("(?<!xxxxxxxxxxxxxxxxxxxxxxx{32774}{65521}xxxxxxxx{65521}xxxxxxxxxxxxxx{32774}xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx)",
	...
	x2("(?i)[ǰ]", "j\xcc\x8c", 0, 3);
	//x2("(?i)[j]\xcc\x8c", "ǰ", 0, 2);
	// (@warn C4566) x2("(?i)\ufb00a", "ffa", 0, 3);
	x2("(?i)ffz", "\xef\xac\x80z", 0, 4);
	// (@warn C4566) x2("(?i)\u2126", "\xcf\x89", 0, 2);
	// (@warn C4566) x2("a(?i)\u2126", "a\xcf\x89", 0, 3);
	// (@warn C4566) x2("(?i)A\u2126", "a\xcf\x89", 0, 3);
	// (@warn C4566) x2("(?i)A\u2126=", "a\xcf\x89=", 0, 4);
