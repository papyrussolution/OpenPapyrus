 ...
 */
ZXING_EXPORT_TEST_ONLY DecoderResult DecodeBitStream(ByteArray&& bytes, const Version& version, ErrorCorrectionLevel ecLevel)
{
...
//					throw FormatError("GS1 Indicator (FNC1 in first position) at illegal position");
				...
				case CodecMode::FNC1_SECOND_POSITION:
				    ...
				    // ISO/IEC 18004:2015 7.4.8.3 AIM Application Indicator (FNC1 in second position),
				    // "00-99" or "A-Za-z"
				...
				case CodecMode::STRUCTURED_APPEND:
				    ...
				    // Read next 4 bits of index, 4 bits of symbol count, and 8 bits of parity data,
				    // then continue
