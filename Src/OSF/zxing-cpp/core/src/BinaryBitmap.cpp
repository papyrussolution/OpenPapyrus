...
//
//
ThresholdBinarizer::ThresholdBinarizer(const ImageView& buffer, uint8_t threshold/*= 128*/) : BinaryBitmap(buffer), _threshold(threshold)
{
}

bool ThresholdBinarizer::getPatternRow(int row, int rotation, PatternRow& res) const
{
...
std::shared_ptr<const BitMatrix> ThresholdBinarizer::getBlackMatrix() const
{
