...
// @sobolev #define ZUECI_MIN(x, y) (x < y ? x : y)
    ...
    #define ZUECI_INTERN ZUECI_EXTERN // The test suite references ZUECI_INTERN functions, so they need to be exported
#else
    #define ZUECI_INTERN
#endif
