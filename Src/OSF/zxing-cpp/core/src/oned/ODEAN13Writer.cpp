...
static const int FIRST_DIGIT_ENCODINGS[] = { 0x00, 0x0B, 0x0D, 0xE, 0x13, 0x19, 0x1C, 0x15, 0x16, 0x1A };
...
BitMatrix EAN13Writer::encode(const std::wstring& contents, int width, int height) const
{
