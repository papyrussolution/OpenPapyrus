...
{
	TestMaskAcrossDimensions(0, [](int i, int j) {
		return (i + j) % 2 == 0;
	});
}
...
{
	TestMaskAcrossDimensions(1, [](int i, int) {
		return i % 2 == 0;
	});
}
...
{
	TestMaskAcrossDimensions(2, [](int, int j) {
		return j % 3 == 0;
	});
}
...
{
	TestMaskAcrossDimensions(3, [](int i, int j) {
		return (i + j) % 3 == 0;
	});
}
...
{
	TestMaskAcrossDimensions(4, [](int i, int j) {
		return (i / 2 + j / 3) % 2 == 0;
	});
}
...
{
	TestMaskAcrossDimensions(5, [](int i, int j) {
...
{
	TestMaskAcrossDimensions(6, [](int i, int j) {
...
{
	TestMaskAcrossDimensions(7, [](int i, int j) {
		return ((i + j) % 2 + (i * j) % 3) % 2 == 0;
	});
}
...
{
	TestMicroMaskAcrossDimensions(0, [](int i, int) {
		return i % 2 == 0;
	});
}
...
{
	TestMicroMaskAcrossDimensions(1, [](int i, int j) {
		return (i / 2 + j / 3) % 2 == 0;
	});
}
...
{
	TestMicroMaskAcrossDimensions(2, [](int i, int j) {
		return ((i * j) % 2 + (i * j) % 3) % 2 == 0;
	});
}
...
{
	TestMicroMaskAcrossDimensions(3, [](int i, int j) {
		return ((i + j) % 2 + (i * j) % 3) % 2 == 0;
	});
}
