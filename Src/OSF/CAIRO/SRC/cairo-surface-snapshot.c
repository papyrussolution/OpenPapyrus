...
static cairo_status_t _cairo_surface_snapshot_acquire_source_image(void * abstract_surface,
	cairo_image_surface_t ** image_out, void ** extra_out)
{
	cairo_surface_snapshot_t * surface = (cairo_surface_snapshot_t *)abstract_surface;
	return _cairo_surface_acquire_source_image(surface->target, image_out, extra_out);
}

static void _cairo_surface_snapshot_release_source_image(void * abstract_surface, cairo_image_surface_t * image, void * extra)
{
	cairo_surface_snapshot_t * surface = (cairo_surface_snapshot_t *)abstract_surface;
...
static void _cairo_surface_snapshot_copy_on_write(cairo_surface_t * surface)
{
 ...
 **/
cairo_surface_t * _cairo_surface_snapshot(cairo_surface_t * surface)
{
	...
	if(surface->backend->snapshot != NULL) {
		cairo_surface_t * snap = _cairo_surface_has_snapshot(surface, surface->backend);
		if(snap != NULL)
