...
static cairo_bool_t _surface_pattern_cache_entry_equal(const void * A, const void * B)
{
...
static void _surface_cache_entry_destroy(void * closure)
{
...
static void _pattern_cache_entry_destroy(void * closure)
{
	struct pattern_cache_entry * entry = closure;
...
static cairo_device_t * _xcb_drm_device(xcb_connection_t * xcb_connection,
...
cairo_xcb_screen_t * _cairo_xcb_screen_get(xcb_connection_t * xcb_connection,
	xcb_screen_t * xcb_screen)
{
...
xcb_gcontext_t _cairo_xcb_screen_get_gc(cairo_xcb_screen_t * screen,
	xcb_drawable_t drawable,
	int depth)
{
	int i;
...
void _cairo_xcb_screen_put_gc(cairo_xcb_screen_t * screen, int depth, xcb_gcontext_t gc)
{
	int i;
...
cairo_status_t _cairo_xcb_screen_store_surface_picture(cairo_xcb_screen_t * screen,
	cairo_surface_t * picture,
	unsigned int size)
{
...
void _cairo_xcb_screen_remove_surface_picture(cairo_xcb_screen_t * screen,
	cairo_surface_t * picture)
{
...
cairo_status_t _cairo_xcb_screen_store_linear_picture(cairo_xcb_screen_t * screen,
...
cairo_surface_t * _cairo_xcb_screen_lookup_radial_picture(cairo_xcb_screen_t * screen,
	const cairo_radial_pattern_t * radial)
{
	cairo_surface_t * picture = NULL;
	struct pattern_cache_entry tmpl;
