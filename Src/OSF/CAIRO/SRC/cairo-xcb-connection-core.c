...
void _cairo_xcb_connection_free_pixmap(cairo_xcb_connection_t * connection,
	xcb_pixmap_t pixmap)
{
	struct {
		uint8_t req;
...
void _cairo_xcb_connection_free_gc(cairo_xcb_connection_t * connection,
	xcb_gcontext_t gc)
{
	struct {
		uint8_t req;
...
void _cairo_xcb_connection_copy_area(cairo_xcb_connection_t * connection,
	xcb_drawable_t src,
	xcb_drawable_t dst,
	xcb_gcontext_t gc,
	int16_t src_x,
...
cairo_status_t _cairo_xcb_connection_get_image(cairo_xcb_connection_t * connection,
	xcb_drawable_t src,
	int16_t src_x,
	int16_t src_y,
	uint16_t width,
