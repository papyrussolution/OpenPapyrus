...
#if 0
static cairo_status_t i915_packed_pixel_surface_finish(void * abstract_surface)
{
...
static cairo_surface_t * i915_packed_pixel_surface_create(i915_device_t * device,
...
static cairo_int_status_t i915_clone_yuv(i915_surface_t * surface,
...
static void i915_shader_linear_color(i915_device_t * device,
...
static void i915_shader_radial_init(struct i915_shader_radial * r,
...
static void i915_shader_radial_coord(i915_device_t * device,
...
static inline void i915_shader_yuv_color(i915_device_t * device,
	int y, int u, int v,
...
static inline uint32_t i915_shader_channel_key(const union i915_shader_channel * channel)
{
	return (channel->type.fragment&0x0f)|(channel->base.mode<<FS_DETAILS_SHIFT);
}

static uint32_t i915_shader_channel_get_num_tex_coords(const union i915_shader_channel * channel)
{
...
static uint32_t i915_shader_get_num_tex_coords(const i915_shader_t * shader)
{
...
static void i915_set_shader_program(i915_device_t * device,
...
static cairo_bool_t i915_shader_linear_init(struct i915_shader_linear * l,
...
static cairo_bool_t i915_shader_linear_contains_rectangle(struct i915_shader_linear * l,
...
static cairo_status_t i915_shader_acquire_solid(i915_shader_t * shader,
...
static cairo_status_t i915_shader_acquire_linear(i915_shader_t * shader,
	union i915_shader_channel * src,
	const cairo_linear_pattern_t * linear,
	const cairo_rectangle_int_t * extents)
{
...
static cairo_status_t i915_shader_acquire_radial(i915_shader_t * shader,
	union i915_shader_channel * src,
	const cairo_radial_pattern_t * radial,
	const cairo_rectangle_int_t * extents)
{
...
static cairo_status_t i915_surface_clone(i915_device_t * device,
...
static cairo_status_t i915_surface_clone_subimage(i915_device_t * device,
	cairo_image_surface_t * image,
	const cairo_rectangle_int_t * extents,
	i915_surface_t ** clone_out)
{
...
static cairo_status_t i915_surface_render_pattern(i915_device_t * device,
...
static cairo_status_t i915_shader_acquire_solid_surface(i915_shader_t * shader,
	union i915_shader_channel * src,
...
static cairo_status_t i915_shader_acquire_surface(i915_shader_t * shader,
	union i915_shader_channel * src,
	const cairo_surface_pattern_t * pattern,
	const cairo_rectangle_int_t * extents)
{
				...
				if(image->width  < 2048 &&
				   ...
				   sample.height >= image->height/4) {
					...
					if(likely(status == CAIRO_STATUS_SUCCESS)) {
						...
						status = intel_snapshot_cache_insert(&i915_device(
								shader->target)->intel,
							&s->intel);
						if(unlikely(status)) {
...
cairo_status_t i915_shader_acquire_pattern(i915_shader_t * shader,
	union i915_shader_channel * src,
...
static uint32_t i915_get_blend(cairo_operator_t op,
	i915_surface_t * dst)
{
...
static void i915_shader_channel_init(union i915_shader_channel * channel)
{
...
static void i915_shader_channel_fini(i915_device_t * device,
...
static void i915_shader_channel_reset(i915_device_t * device,
	union i915_shader_channel * channel)
{
...
void i915_shader_init(i915_shader_t * shader,
	i915_surface_t * dst,
	cairo_operator_t op,
	double opacity)
{
...
static void i915_set_shader_samplers(i915_device_t * device,
	const i915_shader_t * shader)
{
...
static uint32_t i915_shader_get_texcoords(const i915_shader_t * shader)
{
	uint32_t texcoords;
	uint32_t tu;
...
static void i915_set_shader_mode(i915_device_t * device,
	const i915_shader_t * shader)
{
	uint32_t texcoords;
	uint32_t mask, cnt;
...
static void i915_set_constants(i915_device_t * device,
...
static uint32_t pack_constants(const union i915_shader_channel * channel,
	uint32_t * constants)
{
	uint32_t count = 0, n;
...
static void i915_set_shader_constants(i915_device_t * device,
	const i915_shader_t * shader)
{
...
static cairo_bool_t i915_shader_needs_update(const i915_shader_t * shader,
...
void i915_set_dst(i915_device_t * device, i915_surface_t * dst)
{
	uint32_t size;
...
static void i915_set_shader_target(i915_device_t * device,
	const i915_shader_t * shader)
{
	i915_set_dst(device, shader->target);
}

int i915_shader_num_texcoords(const i915_shader_t * shader)
{
	int cnt = 0;
...
void i915_shader_fini(i915_shader_t * shader)
{
...
void i915_shader_set_clip(i915_shader_t * shader,
	cairo_clip_t * clip)
{
...
static cairo_status_t i915_shader_check_aperture(i915_shader_t * shader,
	i915_device_t * device)
{
	cairo_status_t status;
...
static void i915_shader_combine_mask(i915_shader_t * shader, i915_device_t * device)
{
...
static void i915_shader_setup_dst(i915_shader_t * shader)
{
	union i915_shader_channel * channel;
	i915_surface_t * s;
...
static void i915_shader_combine_source(i915_shader_t * shader,
	i915_device_t * device)
{
...
static inline float * i915_composite_vertex(float * v,
	const i915_shader_t * shader,
	double x, double y)
{
	double s, t;
...
static inline void i915_shader_add_rectangle_general(const i915_shader_t * shader,
	int x, int y,
	int w, int h)
{
	float * vertices;
...
void i915_vbo_flush(i915_device_t * device)
{
...
cairo_status_t i915_shader_commit(i915_shader_t * shader,
	i915_device_t * device)
{
