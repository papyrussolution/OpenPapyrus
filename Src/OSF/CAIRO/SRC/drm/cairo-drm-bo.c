...
cairo_status_t _cairo_drm_bo_open_for_name(const cairo_drm_device_t * dev,
	cairo_drm_bo_t * bo,
	uint32_t name)
{
...
cairo_status_t _cairo_drm_bo_flink(const cairo_drm_device_t * dev,
	cairo_drm_bo_t * bo)
{
...
void _cairo_drm_bo_close(const cairo_drm_device_t * dev,
	cairo_drm_bo_t * bo)
{
