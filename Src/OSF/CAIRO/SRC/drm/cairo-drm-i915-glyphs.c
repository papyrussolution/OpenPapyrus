...
static void i915_emit_glyph_rectangle_zero(i915_device_t * device,
...
static void i915_emit_glyph_rectangle_constant(i915_device_t * device,
	i915_shader_t * shader,
	int x1, int y1,
	int x2, int y2,
	intel_glyph_t * glyph)
...
static void i915_emit_glyph_rectangle_general(i915_device_t * device,
	i915_shader_t * shader,
	int x1, int y1,
	int x2, int y2,
	intel_glyph_t * glyph)
...
static cairo_status_t i915_surface_mask_internal(i915_surface_t * dst,
	cairo_operator_t op,
...
cairo_int_status_t i915_surface_glyphs(void * abstract_surface,
	cairo_operator_t op,
	const cairo_pattern_t * source,
