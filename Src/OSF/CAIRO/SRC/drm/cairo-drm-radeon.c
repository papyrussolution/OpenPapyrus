...
#define DRM_IOCTL_RADEON_GEM_WAIT_IDLE   DRM_IOW(DRM_COMMAND_BASE+DRM_RADEON_GEM_WAIT_IDLE, \
	struct drm_radeon_gem_wait_idle)
#define DRM_IOCTL_RADEON_GEM_MMAP   DRM_IOWR(DRM_COMMAND_BASE+DRM_RADEON_GEM_MMAP, struct drm_radeon_gem_mmap)
#define DRM_IOCTL_RADEON_GEM_PREAD   DRM_IOWR(DRM_COMMAND_BASE+DRM_RADEON_GEM_PREAD, struct drm_radeon_gem_pread)
#define DRM_IOCTL_RADEON_GEM_PWRITE   DRM_IOWR(DRM_COMMAND_BASE+DRM_RADEON_GEM_PWRITE, struct drm_radeon_gem_pwrite)
#define DRM_IOCTL_RADEON_GEM_SET_DOMAIN  DRM_IOWR(DRM_COMMAND_BASE+DRM_RADEON_GEM_SET_DOMAIN, \
...
cairo_bool_t radeon_info(int fd,
	uint64_t * gart_size,
	uint64_t * vram_size)
{
...
void radeon_bo_write(const radeon_device_t * device,
	radeon_bo_t * bo,
...
void radeon_bo_read(const radeon_device_t * device,
	radeon_bo_t * bo,
	unsigned long offset,
	unsigned long size,
	void * data)
...
cairo_drm_bo_t * radeon_bo_create(radeon_device_t * device,
	uint32_t size,
	uint32_t initial_domain)
{
...
cairo_surface_t * radeon_bo_get_image(const radeon_device_t * device, radeon_bo_t * bo, const cairo_drm_surface_t * surface)
{
	...
	uint8_t * dst;
	int size, row;
	image = (cairo_image_surface_t *)cairo_image_surface_create(surface->format, surface->width, surface->height);
