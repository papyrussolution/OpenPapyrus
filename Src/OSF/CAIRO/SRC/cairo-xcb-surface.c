...
static cairo_status_t _cairo_xcb_surface_create_similar_shm(cairo_xcb_surface_t * other,
...
cairo_surface_t * _cairo_xcb_surface_create_similar_image(cairo_xcb_surface_t * other,
...
#if CAIRO_HAS_XCB_SHM_FUNCTIONS
static cairo_int_status_t _cairo_xcb_surface_create_shm_image(cairo_xcb_surface_t * target,
...
static cairo_status_t _get_shm_image(cairo_xcb_surface_t * surface,
	cairo_image_surface_t ** image_out)
{
#if CAIRO_HAS_XCB_SHM_FUNCTIONS
	cairo_image_surface_t * image;
...
static cairo_status_t _get_image(cairo_xcb_surface_t * surface,
...
static cairo_bool_t _cairo_xcb_surface_get_extents(void * abstract_surface,
	...
	cairo_image_surface_t * image)
{
	...
	if(image->pixman_format == surface->pixman_format) {
		...
		assert(image->stride ==
			(int)CAIRO_STRIDE_FOR_WIDTH_BPP(image->width, PIXMAN_FORMAT_BPP(image->pixman_format)));
...
static cairo_status_t _cairo_xcb_surface_mark_dirty(void * abstract_surface,
	int x, int y,
	int width, int height)
{
	cairo_xcb_surface_t * surface = abstract_surface;
...
static cairo_surface_t * _cairo_xcb_surface_map_to_image(cairo_xcb_surface_t * surface)
{
	cairo_status_t status;
	cairo_image_surface_t * image;
...
#if CAIRO_HAS_DRM_SURFACE && CAIRO_HAS_XCB_DRM_FUNCTIONS
static cairo_surface_t * _xcb_drm_create_surface_for_drawable(cairo_xcb_connection_t * connection,
...
cairo_surface_t * cairo_xcb_surface_create(xcb_connection_t * xcb_connection,
	xcb_drawable_t drawable,
	xcb_visualtype_t * visual,
	int width,
	int height)
...
cairo_surface_t * cairo_xcb_surface_create_for_bitmap(xcb_connection_t * xcb_connection,
	xcb_screen_t * xcb_screen,
	xcb_pixmap_t bitmap,
	int width,
	int height)
 ...
 **/
cairo_surface_t * cairo_xcb_surface_create_with_xrender_format(xcb_connection_t * xcb_connection,
	xcb_screen_t * xcb_screen,
	xcb_drawable_t drawable,
