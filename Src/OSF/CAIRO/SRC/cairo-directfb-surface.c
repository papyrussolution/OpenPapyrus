...
static cairo_content_t _directfb_format_to_content(DFBSurfacePixelFormat format)
{
...
static inline DFBSurfacePixelFormat _cairo_to_directfb_format(cairo_format_t format)
{
	switch(format) {
...
static inline pixman_format_code_t _directfb_to_pixman_format(DFBSurfacePixelFormat format)
{
	switch(format) {
...
static inline DFBSurfacePixelFormat _directfb_from_pixman_format(pixman_format_code_t format)
{
	switch((int)format) {
...
static cairo_status_t _directfb_buffer_surface_create(IDirectFB * dfb,
...
static cairo_status_t _directfb_acquire_surface(cairo_directfb_surface_t * surface,
...
static cairo_surface_t * _cairo_directfb_surface_create_internal(IDirectFB * dfb,
	DFBSurfacePixelFormat format,
...
static cairo_surface_t * _cairo_directfb_surface_create_similar(void * abstract_src,
	cairo_content_t content,
	int width,
	int height)
{
...
static cairo_status_t _cairo_directfb_surface_finish(void * data)
{
...
static cairo_status_t _cairo_directfb_surface_acquire_source_image(void * abstract_surface,
	cairo_image_surface_t ** image_out,
	void ** image_extra)
{
...
static void _cairo_directfb_surface_release_source_image(void * abstract_surface,
...
static cairo_status_t _cairo_directfb_surface_acquire_dest_image(void * abstract_surface,
...
static void _cairo_directfb_surface_release_dest_image(void * abstract_surface,
	cairo_rectangle_int_t * interest_rect,
	cairo_image_surface_t * image,
...
static cairo_status_t _cairo_directfb_surface_clone_similar(void * abstract_surface,
	cairo_surface_t * src,
	int src_x,
	int src_y,
	int width,
...
static cairo_int_status_t _directfb_prepare_composite(cairo_directfb_surface_t * dst,
...
static void _directfb_finish_composite(cairo_directfb_surface_t * dst,
	const cairo_pattern_t * src_pattern,
	cairo_surface_t * src,
	cairo_surface_attributes_t * src_attr)
{
...
#if DFB_COMPOSITE
static DFBAccelerationMask _directfb_categorize_operation(cairo_surface_attributes_t * src_attr)
{
...
static cairo_int_status_t _cairo_directfb_surface_composite(cairo_operator_t op,
	const cairo_pattern_t * src_pattern,
	const cairo_pattern_t * mask_pattern,
	void * abstract_dst,
	int src_x,  int src_y,
...
#if DFB_RECTANGLES
static cairo_int_status_t _cairo_directfb_surface_fill_rectangles(void * abstract_surface,
	cairo_operator_t op,
	const cairo_color_t * color,
...
static cairo_int_status_t _cairo_directfb_surface_composite_trapezoids(cairo_operator_t op,
...
static cairo_bool_t _cairo_directfb_abstract_surface_get_extents(void * abstract_surface,
...
#if DFB_SHOW_GLYPHS
static cairo_status_t _directfb_allocate_font_cache(IDirectFB * dfb,
...
static void _directfb_destroy_font_cache(cairo_directfb_font_cache_t * cache)
{
...
static cairo_status_t _directfb_acquire_font_cache(cairo_directfb_surface_t * surface,
...
static void _cairo_directfb_surface_scaled_font_fini(cairo_scaled_font_t * scaled_font)
{
...
static void _cairo_directfb_surface_scaled_glyph_fini(cairo_scaled_glyph_t * scaled_glyph,
	cairo_scaled_font_t * scaled_font)
{
	D_DEBUG_AT(CairoDFB_Font,
...
static cairo_int_status_t _cairo_directfb_surface_show_glyphs(void * abstract_dst,
	cairo_operator_t op,
	const cairo_pattern_t * pattern,
...
static cairo_bool_t _cairo_directfb_surface_is_similar(void * surface_a, void * surface_b)
{
...
static void cairo_directfb_surface_backend_init(IDirectFB * dfb)
{
	static int done = 0;
	if(done)
		return;
...
cairo_surface_t * cairo_directfb_surface_create(IDirectFB * dfb, IDirectFBSurface * dfbsurface)
{
	cairo_directfb_surface_t * surface;
	DFBSurfacePixelFormat format;
	DFBSurfaceCapabilities caps;
