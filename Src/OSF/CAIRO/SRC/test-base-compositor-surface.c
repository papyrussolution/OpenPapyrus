...
static cairo_image_surface_t * create_composite_mask(cairo_image_surface_t    * dst,
    void                     * draw_closure,
 ...
 */
static cairo_status_t clip_and_composite_with_mask(const cairo_composite_rectangles_t* extents,
 ...
 */
static cairo_status_t clip_and_composite_combine(const cairo_composite_rectangles_t* extents,
    draw_func_t draw_func,
    void                        * draw_closure)
{
	cairo_image_surface_t * dst = (cairo_image_surface_t*)extents->surface;
 ...
 */
static cairo_status_t clip_and_composite_source(const cairo_composite_rectangles_t   * extents,
    draw_func_t draw_func,
    void                                 * draw_closure)
{
	cairo_image_surface_t * dst = (cairo_image_surface_t*)extents->surface;
...
static cairo_status_t fixup_unbounded(const cairo_composite_rectangles_t * extents)
{
	cairo_image_surface_t * dst = (cairo_image_surface_t*)extents->surface;
	pixman_image_t * mask;
	int mask_x, mask_y;
...
static cairo_int_status_t set_clip_region(cairo_composite_rectangles_t * extents)
{
	cairo_image_surface_t * dst = (cairo_image_surface_t*)extents->surface;
...
static cairo_status_t clip_and_composite(cairo_composite_rectangles_t * extents,
    draw_func_t draw_func,
    void                * draw_closure)
{
	cairo_status_t status;
...
static cairo_int_status_t composite_paint(cairo_image_surface_t          * dst,
    void                           * closure,
    cairo_operator_t op,
    const cairo_pattern_t          * pattern,
    int dst_x,
...
static cairo_int_status_t base_compositor_paint(const cairo_compositor_t * _compositor,
...
static cairo_int_status_t composite_mask(cairo_image_surface_t           * dst,
    void                            * closure,
    cairo_operator_t op,
    const cairo_pattern_t           * pattern,
    int dst_x,
    ...
    const cairo_rectangle_int_t      * extents)
{
	...
	_cairo_pattern_sampled_area((cairo_pattern_t *)closure, extents, &sample);
	mask = _pixman_image_for_pattern(dst, (cairo_pattern_t *)closure, TRUE, extents, &sample, &mask_x, &mask_y);
	if(unlikely(mask == NULL)) {
		pixman_image_unref(src);
		return _cairo_error(CAIRO_STATUS_NO_MEMORY);
	}
...
static cairo_int_status_t base_compositor_mask(const cairo_compositor_t * _compositor,
    cairo_composite_rectangles_t * extents)
{
	TRACE((stderr, "%s\n", __FUNCTION__));
...
static cairo_int_status_t composite_traps(cairo_image_surface_t  * dst,
    void                   * closure,
    cairo_operator_t op,
    const cairo_pattern_t  * pattern,
    int dst_x,
...
static cairo_int_status_t base_compositor_stroke(const cairo_compositor_t * _compositor,
    cairo_composite_rectangles_t * extents,
...
static cairo_int_status_t base_compositor_fill(const cairo_compositor_t * _compositor,
    cairo_composite_rectangles_t * extents,
    const cairo_path_fixed_t  * path,
...
static cairo_int_status_t composite_glyphs(cairo_image_surface_t * dst,
    void                   * closure,
    cairo_operator_t op,
    const cairo_pattern_t * pattern,
    int dst_x,
    ...
    const cairo_rectangle_int_t * extents)
{
	cairo_composite_glyphs_info_t * info = (cairo_composite_glyphs_info_t *)closure;
	pixman_image_t * mask;
	cairo_status_t status;
	int i;
...
static cairo_int_status_t base_compositor_glyphs(const cairo_compositor_t        * _compositor,
    cairo_composite_rectangles_t    * extents,
...
{
	return test_compositor_surface_create(&base_compositor, content, width, height);
}
