...
static void clear_bits(cairo_xcb_shm_mem_pool_t * pi, size_t first, size_t last)
{
	size_t i, n = last;
...
static void free_bits(cairo_xcb_shm_mem_pool_t * pi, size_t start, unsigned int bits, cairo_bool_t clear)
{
...
static void free_blocks(cairo_xcb_shm_mem_pool_t * pi, size_t first, size_t last, cairo_bool_t clear)
{
	size_t i;
	size_t bits = 0;
	size_t len = 1;
...
static cairo_status_t _cairo_xcb_shm_mem_pool_init(cairo_xcb_shm_mem_pool_t * pi,
	size_t bytes,
...
static cairo_xcb_shm_mem_block_t * get_buddy(cairo_xcb_shm_mem_pool_t * pi,
	size_t offset,
	unsigned int bits)
{
	cairo_xcb_shm_mem_block_t * block;
...
static void merge_buddies(cairo_xcb_shm_mem_pool_t * pi,
	cairo_xcb_shm_mem_block_t * block,
...
static unsigned int merge_bits(cairo_xcb_shm_mem_pool_t * pi,
	unsigned int max_bits)
{
...
static void * buddy_malloc(cairo_xcb_shm_mem_pool_t * pi,
	unsigned int bits)
{
	unsigned int b;
	size_t offset;
...
static void * _cairo_xcb_shm_mem_pool_malloc(cairo_xcb_shm_mem_pool_t * pi,
	size_t bytes)
{
	unsigned int bits;
	size_t size;
...
static void _cairo_xcb_shm_mem_pool_free(cairo_xcb_shm_mem_pool_t * pi,
	char * storage)
{
	size_t block_offset;
	cairo_xcb_shm_mem_block_t * block;
