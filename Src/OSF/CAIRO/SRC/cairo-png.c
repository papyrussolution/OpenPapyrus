...
*/
	...
	switch(clone->format) {
		case CAIRO_FORMAT_ARGB32:
		    bpc = 8;
			png_color_type = (_cairo_image_analyze_transparency(clone) == CAIRO_IMAGE_IS_OPAQUE) ? PNG_COLOR_TYPE_RGB : PNG_COLOR_TYPE_RGB_ALPHA;
		    break;
	...
	png_set_IHDR(png, info, clone->width, clone->height, bpc, png_color_type,
