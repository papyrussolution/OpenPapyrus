...
static cairo_int_status_t _fill_box_init(struct _fill_box * fb,
...
static void _fill_box_fini(struct _fill_box * fb,
    cairo_xlib_surface_t * dst)
{
	_cairo_xlib_surface_put_gc(dst->display, dst, fb->gc);
...
cairo_int_status_t _cairo_xlib_core_fill_boxes(cairo_xlib_surface_t    * dst,
    const cairo_color_t     * color,
    cairo_boxes_t          * boxes)
{
	cairo_int_status_t status;
...
cairo_int_status_t _cairo_xlib_core_fill_rectangles(cairo_xlib_surface_t    * dst,
    const cairo_color_t     * color,
    int num_rects,
    CairoIRect * rects)
{
...
static cairo_int_status_t fallback_boxes(cairo_xlib_surface_t    * dst,
    const cairo_pattern_t   * pattern,
    cairo_boxes_t           * boxes)
{
...
static cairo_int_status_t render_boxes(cairo_xlib_surface_t      * dst,
    const cairo_pattern_t     * pattern,
    cairo_boxes_t             * boxes)
{
...
static cairo_status_t draw_boxes(cairo_composite_rectangles_t * extents,
    cairo_boxes_t * boxes)
{
...
static cairo_int_status_t _cairo_xlib_core_compositor_paint(const cairo_compositor_t     * compositor,
...
static cairo_int_status_t _cairo_xlib_core_compositor_stroke(const cairo_compositor_t    * compositor,
    cairo_composite_rectangles_t * extents,
...
static cairo_int_status_t _cairo_xlib_core_compositor_fill(const cairo_compositor_t      * compositor,
    cairo_composite_rectangles_t  * extents,
    const cairo_path_fixed_t      * path,
...
const cairo_compositor_t * _cairo_xlib_core_compositor_get(void)
{
