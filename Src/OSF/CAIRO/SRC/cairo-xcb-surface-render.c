...
static cairo_xcb_picture_t * _cairo_xcb_picture_copy(cairo_xcb_surface_t * target)
{
	cairo_xcb_picture_t * surface;
...
static void _cairo_xcb_surface_set_clip_region(cairo_xcb_surface_t * surface,
...
static cairo_bool_t _nearest_sample(const cairo_matrix_t * m,
	cairo_filter_t filter,
	double * tx, double * ty)
{
	*tx = m->x0;
...
static cairo_status_t _cairo_xcb_shm_image_create(cairo_xcb_connection_t * connection,
	pixman_format_code_t pixman_format,
	int width, int height,
...
static cairo_int_status_t _render_composite_boxes(cairo_xcb_surface_t * dst,
	cairo_operator_t op,
...
static cairo_status_t _cairo_xcb_surface_span_renderer_accumulate(void * abstract_renderer,
	int y,
	int height,
...
cairo_int_status_t _cairo_xcb_surface_render_paint(cairo_xcb_surface_t * surface,
	cairo_operator_t op,
	const cairo_pattern_t * source,
	cairo_clip_t * clip)
{
...
cairo_int_status_t _cairo_xcb_surface_render_mask(cairo_xcb_surface_t * surface,
	cairo_operator_t op,
	const cairo_pattern_t * source,
...
static cairo_status_t _cairo_xcb_surface_render_composite_polygon(cairo_xcb_surface_t * dst,
	cairo_operator_t op,
	const cairo_pattern_t * source,
	cairo_polygon_t * polygon,
	cairo_antialias_t antialias,
	...
	cairo_clip_t * clip)
{
	...
	if(traps.traps.has_intersections) {
		if(traps.traps.is_rectangular)
			status = _cairo_bentley_ottmann_tessellate_rectangular_traps(&traps.traps,
				CAIRO_FILL_RULE_WINDING);
		else if(traps.traps.is_rectilinear)
			status = _cairo_bentley_ottmann_tessellate_rectilinear_traps(&traps.traps,
				CAIRO_FILL_RULE_WINDING);
		else
...
static void _clear_image(cairo_surface_t * surface)
{
...
cairo_int_status_t _cairo_xcb_surface_render_stroke(cairo_xcb_surface_t * surface,
	cairo_operator_t op,
	const cairo_pattern_t * source,
	cairo_path_fixed_t * path,
...
cairo_int_status_t _cairo_xcb_surface_render_fill(cairo_xcb_surface_t * surface,
	cairo_operator_t op,
	const cairo_pattern_t * source,
	cairo_path_fixed_t * path,
	cairo_fill_rule_t fill_rule,
...
static cairo_xcb_font_glyphset_info_t * _cairo_xcb_scaled_glyph_get_glyphset_info(cairo_scaled_glyph_t * scaled_glyph)
{
	return scaled_glyph->surface_private;
}

static void _cairo_xcb_scaled_glyph_set_glyphset_info(cairo_scaled_glyph_t * scaled_glyph,
	cairo_xcb_font_glyphset_info_t * glyphset_info)
{
	scaled_glyph->surface_private = glyphset_info;
}

static cairo_status_t _cairo_xcb_surface_font_init(cairo_xcb_connection_t * connection,
	cairo_scaled_font_t * scaled_font)
{
...
void _cairo_xcb_font_finish(cairo_xcb_font_t * font)
{
	cairo_scaled_font_t * scaled_font;
...
void _cairo_xcb_surface_scaled_font_fini(cairo_scaled_font_t * scaled_font)
{
	cairo_xcb_font_t * font_private;
...
void _cairo_xcb_surface_scaled_glyph_fini(cairo_scaled_glyph_t * scaled_glyph,
	cairo_scaled_font_t * scaled_font)
{
	cairo_xcb_font_t * font_private;
	cairo_xcb_font_glyphset_info_t * glyphset_info;
...
static cairo_xcb_font_glyphset_info_t * _cairo_xcb_scaled_font_get_glyphset_info_for_format(
	cairo_scaled_font_t * scaled_font,
	cairo_format_t format)
{
	cairo_xcb_font_t * font_private;
...
static cairo_bool_t _cairo_xcb_glyphset_info_has_pending_free_glyph(
	cairo_xcb_font_glyphset_info_t * glyphset_info,
...
static cairo_xcb_font_glyphset_info_t * _cairo_xcb_scaled_font_get_glyphset_info_for_pending_free_glyph(
	cairo_scaled_font_t * scaled_font,
	unsigned long glyph_index,
	...
	cairo_scaled_glyph_t ** scaled_glyph_out)
{
	...
	glyphset_info = _cairo_xcb_scaled_font_get_glyphset_info_for_pending_free_glyph(scaled_font, glyph_index,
		glyph_surface);
	...
	switch(_cairo_xcb_get_glyphset_index_for_format(scaled_glyph->surface->format)) {
		...
		if(_native_byte_order_lsb() !=
		   (connection->root->bitmap_format_bit_order == XCB_IMAGE_ORDER_LSB_FIRST)) {
...
static cairo_bool_t _surface_owns_font(cairo_xcb_surface_t * dst,
	cairo_scaled_font_t * scaled_font)
{
	cairo_xcb_font_t * font_private;
...
cairo_int_status_t _cairo_xcb_surface_render_glyphs(cairo_xcb_surface_t * surface,
	cairo_operator_t op,
	const cairo_pattern_t * source,
	cairo_scaled_font_t * scaled_font,
	cairo_glyph_t * glyphs,
