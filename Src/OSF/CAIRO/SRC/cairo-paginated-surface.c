...
cairo_surface_t * _cairo_paginated_surface_create(cairo_surface_t * target,
	cairo_content_t content, const cairo_paginated_surface_backend_t * backend)
{
...
cairo_status_t _cairo_paginated_surface_set_size(cairo_surface_t * surface,
	int width,
	int height)
{
	cairo_paginated_surface_t * paginated_surface;
...
static void _cairo_paginated_surface_release_source_image(void * abstract_surface,
...
static cairo_int_status_t _paint_fallback_image(cairo_paginated_surface_t * surface,
	cairo_rectangle_int_t * rect)
{
	...
	width = rect->width;
	height = rect->height;
	image = _cairo_paginated_surface_create_image_surface(surface, (int)ceil(width*x_scale), (int)ceil(height*y_scale));
...
static cairo_bool_t _cairo_paginated_surface_get_extents(void * abstract_surface,
...
static cairo_int_status_t _cairo_paginated_surface_paint(void * abstract_surface,
