...
extern const cairo_surface_backend_t test_paginated_surface_backend;
extern const cairo_paginated_surface_backend_t test_paginated_surface_paginated_backend;
...
cairo_surface_t * _cairo_test_paginated_surface_create(cairo_surface_t * target)
{
	...
	surface = (test_paginated_surface_t *)malloc(sizeof(test_paginated_surface_t));
...
static cairo_status_t _test_paginated_surface_finish(void * abstract_surface)
{
...
static cairo_bool_t _test_paginated_surface_get_extents(void                       * abstract_surface,
...
static cairo_int_status_t _test_paginated_surface_paint(void             * abstract_surface,
    cairo_operator_t op,
...
static cairo_int_status_t _test_paginated_surface_mask(void              * abstract_surface,
    cairo_operator_t op,
    const cairo_pattern_t     * source,
...
static cairo_int_status_t _test_paginated_surface_stroke(void                            * abstract_surface,
    cairo_operator_t op,
    const cairo_pattern_t           * source,
...
static cairo_int_status_t _test_paginated_surface_fill(void                              * abstract_surface,
    cairo_operator_t op,
    const cairo_pattern_t             * source,
    const cairo_path_fixed_t          * path,
...
static cairo_bool_t _test_paginated_surface_has_show_text_glyphs(void * abstract_surface)
{
	test_paginated_surface_t * surface = (test_paginated_surface_t *)abstract_surface;
	return cairo_surface_has_show_text_glyphs(surface->target);
}

static cairo_int_status_t _test_paginated_surface_show_text_glyphs(void                      * abstract_surface,
    cairo_operator_t op,
    const cairo_pattern_t     * source,
    const char                * utf8,
    int utf8_len,
...
static void _test_paginated_surface_set_paginated_mode(void * abstract_surface, cairo_paginated_mode_t mode)
{
	test_paginated_surface_t * surface = (test_paginated_surface_t *)abstract_surface;
