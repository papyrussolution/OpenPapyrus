...
typedef struct cairo_gl_shader_impl {
	void (* compile_shader)(GLuint * shader, GLenum type, const char * text);
	void (* link_shader)(GLuint * program, GLuint vert, GLuint frag);
	void (* destroy_shader)(GLuint shader);
	void (* destroy_program)(GLuint program);
	void (* bind_float)(cairo_gl_shader_t * shader, const char * name, float value);
	void (* bind_vec2)(cairo_gl_shader_t * shader, const char * name, float value0, float value1);
	void (* bind_vec3)(cairo_gl_shader_t * shader, const char * name, float value0, float value1, float value2);
	void (* bind_vec4)(cairo_gl_shader_t * shader, const char * name, float value0, float value1, float value2, float value3);
	void (* bind_matrix)(cairo_gl_shader_t * shader, const char * name, cairo_matrix_t * m);
	void (* bind_texture)(cairo_gl_shader_t * shader, const char * name, cairo_gl_tex_t tex_unit);
	void (* use)(cairo_gl_shader_t * shader);
} shader_impl_t;

static cairo_status_t _cairo_gl_shader_compile(cairo_gl_context_t * ctx, cairo_gl_shader_t * shader,
	cairo_gl_var_type_t src, cairo_gl_var_type_t mask,
	const char * fragment_text);

/* ARB_shader_objects / ARB_vertex_shader / ARB_fragment_shader extensions
   API. */
static void compile_shader_arb(GLuint * shader, GLenum type, const char * text)
{
...
static void link_shader_arb(GLuint * program, GLuint vert, GLuint frag)
{
	GLint gl_status;
...
static void destroy_shader_arb(GLuint shader)
{
	glDeleteObjectARB(shader);
}

static void destroy_program_arb(GLuint shader)
{
	glDeleteObjectARB(shader);
}

static void bind_float_arb(cairo_gl_shader_t * shader,
	const char * name,
	float value)
{
...
static void bind_vec2_arb(cairo_gl_shader_t * shader,
	const char * name,
	float value0,
	float value1)
{
...
static void bind_vec3_arb(cairo_gl_shader_t * shader,
	const char * name,
	float value0,
	float value1,
	float value2)
...
static void bind_vec4_arb(cairo_gl_shader_t * shader,
	const char * name,
	float value0,
	float value1,
	float value2,
...
static void bind_matrix_arb(cairo_gl_shader_t * shader,
	const char * name,
	cairo_matrix_t * m)
{
	GLint location = glGetUniformLocationARB(shader->program, name);
...
static void use_program_arb(cairo_gl_shader_t * shader)
{
	if(shader)
...
/* OpenGL Core 2.0 API. */
static void compile_shader_core_2_0(GLuint * shader, GLenum type, const char * text)
{
	const char * strings[1] = { text };
	GLint gl_status;
...
static void link_shader_core_2_0(GLuint * program, GLuint vert, GLuint frag)
{
	GLint gl_status;
...
static void destroy_shader_core_2_0(GLuint shader)
{
	glDeleteShader(shader);
}

static void destroy_program_core_2_0(GLuint shader)
{
	glDeleteProgram(shader);
}

static void bind_float_core_2_0(cairo_gl_shader_t * shader,
	const char * name,
	float value)
{
...
static void bind_vec2_core_2_0(cairo_gl_shader_t * shader,
	const char * name,
	float value0,
	float value1)
{
...
static void bind_vec3_core_2_0(cairo_gl_shader_t * shader,
	const char * name,
	float value0,
	float value1,
	float value2)
...
static void bind_vec4_core_2_0(cairo_gl_shader_t * shader,
	const char * name,
	float value0,
	float value1,
	float value2,
...
static void bind_matrix_core_2_0(cairo_gl_shader_t * shader, const char * name, cairo_matrix_t * m)
{
	GLint location = glGetUniformLocation(shader->program, name);
	float gl_m[16] = {
		m->xx, m->xy, m->x0,
...
static void bind_texture_core_2_0(cairo_gl_shader_t * shader, const char * name, cairo_gl_tex_t tex_unit)
{
	GLint location = glGetUniformLocation(shader->program, name);
	assert(location != -1);
...
static void use_program_core_2_0(cairo_gl_shader_t * shader)
{
	if(shader)
...
static cairo_bool_t _cairo_gl_shader_cache_equal(const void * key_a, const void * key_b)
{
...
static unsigned long _cairo_gl_shader_cache_hash(const cairo_shader_cache_entry_t * entry)
{
	return (entry->src<<24)|(entry->mask<<16)|(entry->dest<<8)|(entry->in);
}

static void _cairo_gl_shader_cache_destroy(void * data)
{
...
cairo_status_t _cairo_gl_context_init_shaders(cairo_gl_context_t * ctx)
{
...
void _cairo_gl_context_fini_shaders(cairo_gl_context_t * ctx)
{
	int i;
...
void _cairo_gl_shader_fini(cairo_gl_context_t * ctx,
	cairo_gl_shader_t * shader)
{
...
static cairo_gl_var_type_t cairo_gl_operand_get_var_type(cairo_gl_operand_type_t type)
{
	switch(type) {
	    default:
...
static void cairo_gl_shader_emit_color(cairo_output_stream_t * stream,
	GLuint tex_target,
...
static cairo_status_t cairo_gl_shader_get_fragment_source(GLuint tex_target,
	cairo_gl_shader_in_t in,
	cairo_gl_operand_type_t src,
	cairo_gl_operand_type_t mask,
	cairo_gl_operand_type_t dest,
...
static cairo_status_t _cairo_gl_shader_compile(cairo_gl_context_t * ctx,
	cairo_gl_shader_t * shader,
...
void _cairo_gl_shader_bind_float(cairo_gl_context_t * ctx,
	const char * name,
	float value)
{
...
void _cairo_gl_shader_bind_vec2(cairo_gl_context_t * ctx,
	const char * name,
	float value0,
	float value1)
{
...
void _cairo_gl_shader_bind_vec3(cairo_gl_context_t * ctx,
	const char * name,
	float value0,
	float value1,
	float value2)
...
void _cairo_gl_shader_bind_vec4(cairo_gl_context_t * ctx,
	const char * name,
