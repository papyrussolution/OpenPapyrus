...
static cairo_status_t _cairo_bo_edge_end_trap(cairo_bo_edge_t * left,
	int32_t bot, cairo_bool_t do_traps, void * container)
{
...
static inline cairo_status_t _active_edges_to_traps(cairo_bo_edge_t * left,
	int32_t top, cairo_fill_rule_t fill_rule, cairo_bool_t do_traps, void * container)
{
	cairo_bo_edge_t * right;
	cairo_status_t status;
	...
	cairo_fill_rule_t fill_rule)
{
	...
	if(num_events > ARRAY_LENGTH(stack_events)) {
		events = (cairo_bo_event_t *)_cairo_malloc_ab_plus_c(num_events, sizeof(cairo_bo_event_t)+sizeof(cairo_bo_edge_t)+sizeof(cairo_bo_event_t *), sizeof(cairo_bo_event_t *));
...
cairo_status_t _cairo_bentley_ottmann_tessellate_rectilinear_traps(cairo_traps_t * traps, cairo_fill_rule_t fill_rule)
{
	...
	if(i > ARRAY_LENGTH(stack_events)) {
		events = (cairo_bo_event_t *)_cairo_malloc_ab_plus_c(i, sizeof(cairo_bo_event_t)+sizeof(cairo_bo_edge_t)+sizeof(cairo_bo_event_t *), sizeof(cairo_bo_event_t *));
		if(unlikely(events == NULL))
			return _cairo_error(CAIRO_STATUS_NO_MEMORY);
