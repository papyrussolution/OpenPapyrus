...
static cairo_status_t _cairo_base64_stream_write(cairo_output_stream_t * base, const unsigned char * data, unsigned int length)
{
	static char const base64_table[/* @sobolev 64*/] = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
