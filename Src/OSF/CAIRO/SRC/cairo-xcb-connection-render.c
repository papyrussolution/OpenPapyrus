...
void _cairo_xcb_connection_render_create_picture(cairo_xcb_connection_t * connection,
...
void _cairo_xcb_connection_render_change_picture(cairo_xcb_connection_t * connection,
	xcb_render_picture_t picture,
	uint32_t value_mask,
	uint32_t * value_list)
{
...
void _cairo_xcb_connection_render_free_picture(cairo_xcb_connection_t * connection,
	xcb_render_picture_t picture)
{
	struct {
		uint8_t major;
...
void _cairo_xcb_connection_render_spans(cairo_xcb_connection_t * connection,
	xcb_render_picture_t dst,
	int op,
	xcb_render_picture_t src,
...
void _cairo_xcb_connection_render_create_glyph_set(cairo_xcb_connection_t * connection,
...
void _cairo_xcb_connection_render_free_glyph_set(cairo_xcb_connection_t * connection,
...
void _cairo_xcb_connection_render_add_glyphs(cairo_xcb_connection_t * connection,
	xcb_render_glyphset_t glyphset,
	uint32_t num_glyphs,
	uint32_t * glyphs_id,
...
void _cairo_xcb_connection_render_free_glyphs(cairo_xcb_connection_t * connection,
	xcb_render_glyphset_t glyphset,
	uint32_t num_glyphs,
...
void _cairo_xcb_connection_render_set_picture_transform(cairo_xcb_connection_t * connection,
	xcb_render_picture_t picture,
...
void _cairo_xcb_connection_render_create_linear_gradient(cairo_xcb_connection_t * connection,
	xcb_render_picture_t picture,
	...
	xcb_render_color_t * colors)
{
	...
	COMPILE_TIME_ASSERT(sizeof(req) == 28);
	assert(
		(sizeof(req)+num_stops*(sizeof(xcb_render_fixed_t)+sizeof(xcb_render_color_t)))>>2 <
		connection->root->maximum_request_length);
...
void _cairo_xcb_connection_render_create_radial_gradient(cairo_xcb_connection_t * connection,
	xcb_render_picture_t picture,
...
void _cairo_xcb_connection_render_create_conical_gradient(cairo_xcb_connection_t * connection,
	xcb_render_picture_t picture,
