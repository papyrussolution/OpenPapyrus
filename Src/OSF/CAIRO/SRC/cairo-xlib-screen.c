...
void _cairo_xlib_screen_close_display(cairo_xlib_display_t * display,
	cairo_xlib_screen_t * info)
{
	Display * dpy;
	int i;
...
void _cairo_xlib_screen_destroy(cairo_xlib_screen_t * info)
{
...
GC _cairo_xlib_screen_get_gc(cairo_xlib_display_t * display,
	cairo_xlib_screen_t * info,
	int depth,
	Drawable drawable)
{
