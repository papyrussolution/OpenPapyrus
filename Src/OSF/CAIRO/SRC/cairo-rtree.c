...
cairo_rtree_node_t * _cairo_rtree_node_create(cairo_rtree_t * rtree,
	cairo_rtree_node_t * parent, int x, int y, int width, int height)
{
...
cairo_int_status_t _cairo_rtree_evict_random(cairo_rtree_t * rtree,
	int width, int height, cairo_rtree_node_t ** out)
{
...
void _cairo_rtree_unpin(cairo_rtree_t * rtree)
{
	...
	cairo_list_foreach_entry_safe(node, next, cairo_rtree_node_t, &can_collapse, link)
	{
		_cairo_rtree_node_collapse(rtree, node);
	}
}

void _cairo_rtree_init(cairo_rtree_t * rtree, int width, int height, int min_size, int node_size)
{
