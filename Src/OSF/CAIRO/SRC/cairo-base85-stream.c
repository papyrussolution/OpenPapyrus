...
static void _expand_four_tuple_to_five(unsigned char four_tuple[4],
	unsigned char five_tuple[5], cairo_bool_t * all_zero)
{
	int digit, i;
...
static cairo_status_t _cairo_base85_stream_write(cairo_output_stream_t * base,
