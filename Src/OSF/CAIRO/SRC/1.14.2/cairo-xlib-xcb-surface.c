...
static cairo_surface_t * _cairo_xlib_xcb_surface_create(void * dpy,
    void * scr,
    void * visual,
    void * format,
    cairo_surface_t * xcb);

static cairo_surface_t * _cairo_xlib_xcb_surface_create_similar(void * abstract_other,
...
static cairo_status_t _cairo_xlib_xcb_surface_finish(void * abstract_surface)
{
...
static cairo_surface_t * _cairo_xlib_xcb_surface_create_similar_image(void * abstract_other,
...
static cairo_image_surface_t * _cairo_xlib_xcb_surface_map_to_image(void * abstract_surface,
...
static cairo_int_status_t _cairo_xlib_xcb_surface_unmap(void * abstract_surface,
...
static cairo_surface_t * _cairo_xlib_xcb_surface_source(void * abstract_surface,
    CairoIRect * extents)
{
	cairo_xlib_xcb_surface_t * surface = abstract_surface;
...
static cairo_status_t _cairo_xlib_xcb_surface_acquire_source_image(void * abstract_surface,
...
static void _cairo_xlib_xcb_surface_release_source_image(void * abstract_surface,
    cairo_image_surface_t * image_out,
    void * image_extra)
{
	cairo_xlib_xcb_surface_t * surface = abstract_surface;
...
static void _cairo_xlib_xcb_surface_get_font_options(void * abstract_surface,
...
static cairo_int_status_t _cairo_xlib_xcb_surface_paint(void * abstract_surface,
    cairo_operator_t op,
...
static cairo_int_status_t _cairo_xlib_xcb_surface_mask(void * abstract_surface,
    cairo_operator_t op,
    const cairo_pattern_t     * source,
...
static cairo_int_status_t _cairo_xlib_xcb_surface_stroke(void * abstract_surface,
    cairo_operator_t op,
    const cairo_pattern_t           * source,
...
static cairo_int_status_t _cairo_xlib_xcb_surface_fill(void * abstract_surface,
    cairo_operator_t op,
    const cairo_pattern_t     * source,
    const cairo_path_fixed_t  * path,
...
static cairo_int_status_t _cairo_xlib_xcb_surface_glyphs(void * abstract_surface,
    cairo_operator_t op,
    const cairo_pattern_t   * source,
...
static cairo_status_t _cairo_xlib_xcb_surface_flush(void * abstract_surface, unsigned flags)
{
	cairo_xlib_xcb_surface_t * surface = abstract_surface;
...
static cairo_status_t _cairo_xlib_xcb_surface_mark_dirty(void * abstract_surface,
    int x, int y,
...
static void _cairo_xlib_xcb_display_finish(void * abstract_display)
{
...
static int _cairo_xlib_xcb_close_display(Display * dpy, XExtCodes * codes)
{
...
static cairo_device_t * _cairo_xlib_xcb_device_create(Display * dpy, cairo_device_t * xcb_device)
{
	...
	cairo_list_foreach_entry(display, cairo_xlib_xcb_display_t, &displays, link)
	{
		if(display->dpy == dpy) {
			/* Maintain MRU order. */
...
static Screen * _cairo_xlib_screen_from_visual(Display * dpy, Visual * visual)
{
	int s, d, v;
...
static xcb_screen_t * _cairo_xcb_screen_from_root(xcb_connection_t * connection,
    xcb_window_t id)
{
...
void cairo_xlib_surface_set_drawable(cairo_surface_t   * abstract_surface,
    Drawable drawable,
    int width,
    int height)
{
...
Display * cairo_xlib_surface_get_display(cairo_surface_t * abstract_surface)
{
	cairo_xlib_xcb_surface_t * surface = (cairo_xlib_xcb_surface_t*)abstract_surface;
...
Drawable cairo_xlib_surface_get_drawable(cairo_surface_t * abstract_surface)
{
	cairo_xlib_xcb_surface_t * surface = (cairo_xlib_xcb_surface_t*)abstract_surface;
...
Visual * cairo_xlib_surface_get_visual(cairo_surface_t * abstract_surface)
{
	cairo_xlib_xcb_surface_t * surface = (cairo_xlib_xcb_surface_t*)abstract_surface;
...
int cairo_xlib_surface_get_width(cairo_surface_t * abstract_surface)
{
	cairo_xlib_xcb_surface_t * surface = (cairo_xlib_xcb_surface_t*)abstract_surface;
...
int cairo_xlib_surface_get_height(cairo_surface_t * abstract_surface)
{
	cairo_xlib_xcb_surface_t * surface = (cairo_xlib_xcb_surface_t*)abstract_surface;
...
void cairo_xlib_device_debug_cap_xrender_version(cairo_device_t * device,
    int major, int minor)
{
...
void cairo_xlib_device_debug_set_precision(cairo_device_t * device,
    int precision)
{
	cairo_xlib_xcb_display_t * display = (cairo_xlib_xcb_display_t*)device;
