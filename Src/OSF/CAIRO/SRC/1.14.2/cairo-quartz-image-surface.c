...
static cairo_surface_t * _cairo_quartz_image_surface_create_similar(void * asurface,
...
static cairo_surface_t * _cairo_quartz_image_surface_create_similar_image(void * asurface,
...
static cairo_status_t _cairo_quartz_image_surface_finish(void * asurface)
{
...
static cairo_status_t _cairo_quartz_image_surface_acquire_source_image(void * asurface,
...
static cairo_image_surface_t * _cairo_quartz_image_surface_map_to_image(void * asurface,
...
static cairo_int_status_t _cairo_quartz_image_surface_unmap_image(void * asurface,
...
static cairo_status_t _cairo_quartz_image_surface_flush(void * asurface,
    unsigned flags)
{
	cairo_quartz_image_surface_t * surface = (cairo_quartz_image_surface_t*)asurface;
...
static cairo_int_status_t _cairo_quartz_image_surface_paint(void * abstract_surface,
    cairo_operator_t op,
...
static cairo_int_status_t _cairo_quartz_image_surface_mask(void * abstract_surface,
    cairo_operator_t op,
    const cairo_pattern_t         * source,
...
static cairo_int_status_t _cairo_quartz_image_surface_stroke(void * abstract_surface,
    cairo_operator_t op,
    const cairo_pattern_t       * source,
...
static cairo_int_status_t _cairo_quartz_image_surface_fill(void * abstract_surface,
    cairo_operator_t op,
    const cairo_pattern_t        * source,
    const cairo_path_fixed_t     * path,
...
static cairo_int_status_t _cairo_quartz_image_surface_glyphs(void * abstract_surface,
    cairo_operator_t op,
    const cairo_pattern_t       * source,
 ...
 * Since: 1.6
 **/
cairo_surface_t * cairo_quartz_image_surface_create(cairo_surface_t * surface)
{
...
cairo_surface_t * cairo_quartz_image_surface_get_image(cairo_surface_t * asurface)
{
	cairo_quartz_image_surface_t * surface = (cairo_quartz_image_surface_t*)asurface;
