...
static cairo_status_t _cairo_surface_clipper_intersect_clip_boxes(cairo_surface_clipper_t * clipper,
...
void _cairo_surface_clipper_init(cairo_surface_clipper_t * clipper,
