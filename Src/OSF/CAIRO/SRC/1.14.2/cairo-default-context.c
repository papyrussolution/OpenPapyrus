...
void _cairo_default_context_fini(cairo_default_context_t * cr)
{
...
static void _cairo_default_context_destroy(void * abstract_cr)
{
...
static cairo_status_t _cairo_default_context_push_group(void * abstract_cr, cairo_content_t content)
{
	cairo_default_context_t * cr = (cairo_default_context_t *)abstract_cr;
	cairo_surface_t * group_surface;
	cairo_status_t status;
	cairo_clip_t * clip = _cairo_gstate_get_clip(cr->gstate);
...
static cairo_pattern_t * _cairo_default_context_pop_group(void * abstract_cr)
{
	cairo_default_context_t * cr = (cairo_default_context_t *)abstract_cr;
	cairo_surface_t * group_surface;
	...
	_cairo_path_fixed_translate(cr->path,
	    _cairo_fixed_from_int((int)(parent_surface->device_transform.x0 - group_surface->device_transform.x0)),
	    _cairo_fixed_from_int((int)(parent_surface->device_transform.y0 - group_surface->device_transform.y0)));
done:
	cairo_surface_destroy(group_surface);
...
static cairo_status_t _cairo_default_context_set_source_surface(void * abstract_cr, cairo_surface_t * surface, double x, double y)
{
	cairo_default_context_t * cr = (cairo_default_context_t *)abstract_cr;
	cairo_pattern_t * pattern;
...
// Path constructor 
//
static cairo_status_t _cairo_default_context_new_path(void * abstract_cr)
{
	cairo_default_context_t * cr = (cairo_default_context_t *)abstract_cr;
	_cairo_path_fixed_fini(cr->path);
...
static cairo_status_t _cairo_default_context_move_to(void * abstract_cr, double x, double y)
{
	cairo_default_context_t * cr = (cairo_default_context_t *)abstract_cr;
...
static cairo_status_t _cairo_default_context_line_to(void * abstract_cr, double x, double y)
{
	cairo_default_context_t * cr = (cairo_default_context_t *)abstract_cr;
	cairo_fixed_t x_fixed, y_fixed;
	_cairo_gstate_user_to_backend(cr->gstate, &x, &y);
...
static cairo_status_t _cairo_default_context_curve_to(void * abstract_cr, double x1, double y1, 
...
static cairo_status_t _cairo_default_context_rel_move_to(void * abstract_cr, double dx, double dy)
{
	cairo_default_context_t * cr = (cairo_default_context_t *)abstract_cr;
...
static cairo_status_t _cairo_default_context_rel_line_to(void * abstract_cr, double dx, double dy)
{
	cairo_default_context_t * cr = (cairo_default_context_t *)abstract_cr;
	cairo_fixed_t dx_fixed, dy_fixed;
	_cairo_gstate_user_to_backend_distance(cr->gstate, &dx, &dy);
...
static cairo_status_t _cairo_default_context_rel_curve_to(void * abstract_cr, double dx1, double dy1, double dx2, double dy2, double dx3, double dy3)
{
	cairo_default_context_t * cr = (cairo_default_context_t *)abstract_cr;
	...
	return _cairo_path_fixed_rel_curve_to(cr->path, dx1_fixed, dy1_fixed, dx2_fixed, dy2_fixed, dx3_fixed, dy3_fixed);
}
...
static void _cairo_default_context_path_extents(void * abstract_cr, double * x1, double * y1, double * x2, double * y2)
{
	cairo_default_context_t * cr = (cairo_default_context_t *)abstract_cr;
...
static cairo_path_t * _cairo_default_context_copy_path(void * abstract_cr)
{
	cairo_default_context_t * cr = (cairo_default_context_t *)abstract_cr;
	return _cairo_path_create(cr->path, &cr->base);
}

static cairo_path_t * _cairo_default_context_copy_path_flat(void * abstract_cr)
{
	cairo_default_context_t * cr = (cairo_default_context_t *)abstract_cr;
	return _cairo_path_create_flat(cr->path, &cr->base);
}

static cairo_status_t _cairo_default_context_append_path(void * abstract_cr, const cairo_path_t * path)
{
	cairo_default_context_t * cr = (cairo_default_context_t *)abstract_cr;
...
static cairo_status_t _cairo_default_context_stroke(void * abstract_cr)
{
	cairo_default_context_t * cr = (cairo_default_context_t *)abstract_cr;
...
static cairo_status_t _cairo_default_context_fill_preserve(void * abstract_cr)
{
	cairo_default_context_t * cr = (cairo_default_context_t *)abstract_cr;
	return _cairo_gstate_fill(cr->gstate, cr->path);
}

static cairo_status_t _cairo_default_context_fill(void * abstract_cr)
{
	cairo_default_context_t * cr = (cairo_default_context_t *)abstract_cr;
...
static cairo_status_t _cairo_default_context_fill_extents(void * abstract_cr,
    double * x1, double * y1, double * x2, double * y2)
{
	cairo_default_context_t * cr = (cairo_default_context_t *)abstract_cr;
	return _cairo_gstate_fill_extents(cr->gstate, cr->path, x1, y1, x2, y2);
}

static cairo_status_t _cairo_default_context_clip_preserve(void * abstract_cr)
{
	cairo_default_context_t * cr = (cairo_default_context_t *)abstract_cr;
	return _cairo_gstate_clip(cr->gstate, cr->path);
}

static cairo_status_t _cairo_default_context_clip(void * abstract_cr)
{
	cairo_default_context_t * cr = (cairo_default_context_t *)abstract_cr;
	cairo_status_t status = _cairo_gstate_clip(cr->gstate, cr->path);
	if(unlikely(status))
		return status;
	return _cairo_default_context_new_path(cr);
}
...
static cairo_font_face_t * _cairo_default_context_get_font_face(void * abstract_cr)
{
	...
	cairo_status_t status = _cairo_gstate_get_font_face(cr->gstate, &font_face);
	if(unlikely(status)) {
...
static cairo_scaled_font_t * _cairo_default_context_get_scaled_font(void * abstract_cr)
{
	cairo_default_context_t * cr = (cairo_default_context_t *)abstract_cr;
	cairo_scaled_font_t * scaled_font;
	cairo_status_t status = _cairo_gstate_get_scaled_font(cr->gstate, &scaled_font);
	if(unlikely(status))
...
{
	cairo_default_context_t * cr = (cairo_default_context_t *)abstract_cr;
	return _cairo_gstate_glyph_path(cr->gstate, glyphs, num_glyphs, cr->path);
}
...
cairo_status_t _cairo_default_context_init(cairo_default_context_t * cr, void * target)
{
...
cairo_t * _cairo_default_context_create(void * target)
{
	...
	if(unlikely(cr == NULL)) {
		cr = (cairo_default_context_t *)SAlloc::M(sizeof(cairo_default_context_t));
		if(unlikely(cr == NULL))
