...
void _cairo_path_fixed_approximate_clip_extents(const cairo_path_fixed_t * path, CairoIRect * extents)
{
	_cairo_path_fixed_approximate_fill_extents(path, extents);
}

void _cairo_path_fixed_approximate_fill_extents(const cairo_path_fixed_t * path, CairoIRect * extents)
{
...
cairo_status_t _cairo_path_fixed_stroke_extents(const cairo_path_fixed_t * path,
    ...
    const cairo_matrix_t * ctm_inverse, double tolerance, CairoIRect * extents)
{
