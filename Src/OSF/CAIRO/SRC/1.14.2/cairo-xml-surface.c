...
{
	cairo_xml_t * xml = SAlloc::M(sizeof(cairo_xml_t));
...
static cairo_status_t _cairo_xml_surface_emit_clip_boxes(cairo_xml_surface_t * surface,
...
static cairo_status_t _cairo_xml_emit_image(cairo_xml_t * xml,
...
static cairo_status_t _cairo_xml_emit_surface(cairo_xml_t * xml,
...
static cairo_int_status_t _cairo_xml_surface_paint(void * abstract_surface,
    cairo_operator_t op,
...
static cairo_int_status_t _cairo_xml_surface_mask(void * abstract_surface,
    cairo_operator_t op,
    const cairo_pattern_t  * source,
...
static cairo_int_status_t _cairo_xml_surface_glyphs(void * abstract_surface,
    cairo_operator_t op,
    const cairo_pattern_t    * source,
    cairo_glyph_t            * glyphs,
    int num_glyphs,
...
static cairo_surface_t * _cairo_xml_surface_create_internal(cairo_device_t * device,
    cairo_content_t content,
    double width,
    double height)
{
	...
	surface = SAlloc::M(sizeof(cairo_xml_surface_t));
...
cairo_device_t * cairo_xml_create_for_stream(cairo_write_func_t write_func,
    void * closure)
{
	cairo_output_stream_t * stream;
	cairo_status_t status;
...
cairo_surface_t * cairo_xml_surface_create(cairo_device_t * device,
    cairo_content_t content,
...
cairo_status_t cairo_xml_for_recording_surface(cairo_device_t  * device,
