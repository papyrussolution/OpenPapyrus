...
static cairo_int_status_t _clip_to_traps(cairo_clip_t * clip,
    cairo_traps_t * traps)
{
	cairo_int_status_t status;
...
static cairo_bool_t _should_use_unbounded_surface(cairo_composite_rectangles_t * composite)
{
	...
	CairoIRect * source = &composite->source;
...
static cairo_surface_t* _prepare_unbounded_surface(cairo_gl_surface_t * dst)
{
...
static cairo_int_status_t _paint_back_unbounded_surface(const cairo_compositor_t         * compositor,
...
static void _cairo_gl_msaa_compositor_set_clip(cairo_composite_rectangles_t * composite,
    cairo_gl_composite_t * setup)
{
 ...
 */
static cairo_int_status_t _cairo_gl_msaa_compositor_mask_source_operator(const cairo_compositor_t * compositor,
    cairo_composite_rectangles_t * composite)
{
	cairo_gl_composite_t setup;
	cairo_gl_surface_t * dst = (cairo_gl_surface_t*)composite->surface;
...
static cairo_int_status_t _cairo_gl_msaa_compositor_mask(const cairo_compositor_t        * compositor,
    cairo_composite_rectangles_t    * composite)
{
	cairo_gl_composite_t setup;
	cairo_gl_surface_t * dst = (cairo_gl_surface_t*)composite->surface;
...
static cairo_int_status_t _cairo_gl_msaa_compositor_paint(const cairo_compositor_t       * compositor,
    cairo_composite_rectangles_t   * composite)
{
	return _cairo_gl_msaa_compositor_mask(compositor, composite);
}

static cairo_status_t _stroke_shaper_add_triangle(void * closure,
...
static cairo_status_t _stroke_shaper_add_triangle_fan(void * closure,
...
static cairo_status_t _stroke_shaper_add_quad(void * closure,
...
static cairo_int_status_t _prevent_overlapping_strokes(cairo_gl_context_t                * ctx,
    cairo_gl_composite_t              * setup,
    cairo_composite_rectangles_t      * composite,
...
static cairo_int_status_t _cairo_gl_msaa_compositor_stroke(const cairo_compositor_t      * compositor,
    cairo_composite_rectangles_t  * composite,
    const cairo_path_fixed_t      * path,
    const cairo_stroke_style_t    * style,
    const cairo_matrix_t          * ctm,
...
static cairo_int_status_t _draw_simple_quad_path(cairo_gl_context_t * ctx,
    cairo_gl_composite_t * setup,
    const cairo_path_fixed_t * path)
{
	cairo_point_t triangle[3];
...
static cairo_int_status_t _cairo_gl_msaa_compositor_fill(const cairo_compositor_t        * compositor,
    cairo_composite_rectangles_t    * composite,
    const cairo_path_fixed_t        * path,
    CairoFillRule fill_rule,
    double tolerance,
...
static cairo_int_status_t _cairo_gl_msaa_compositor_glyphs(const cairo_compositor_t      * compositor,
    cairo_composite_rectangles_t  * composite,
...
static void _cairo_gl_msaa_compositor_init(cairo_compositor_t       * compositor,
...
const cairo_compositor_t * _cairo_gl_msaa_compositor_get(void)
{
