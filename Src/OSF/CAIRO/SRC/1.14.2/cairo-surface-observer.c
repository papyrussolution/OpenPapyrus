...
static cairo_surface_t * _cairo_surface_create_observer_internal(cairo_device_t * device,
...
static cairo_status_t _cairo_surface_observer_mark_dirty(void * abstract_surface,
    int x, int y,
    int width, int height)
{
	cairo_surface_observer_t * surface = (cairo_surface_observer_t *)abstract_surface;
...
static cairo_bool_t _cairo_surface_observer_get_extents(void * abstract_surface,
    CairoIRect * extents)
{
	cairo_surface_observer_t * surface = (cairo_surface_observer_t *)abstract_surface;
...
static void _cairo_surface_observer_get_font_options(void * abstract_surface,
...
static cairo_surface_t * _cairo_surface_observer_source(void * abstract_surface,
    CairoIRect   * extents)
{
	cairo_surface_observer_t * surface = (cairo_surface_observer_t *)abstract_surface;
...
static cairo_status_t _cairo_surface_observer_acquire_source_image(void * abstract_surface,
...
static void _cairo_surface_observer_release_source_image(void * abstract_surface,
...
static void print_array(cairo_output_stream_t * stream,
    const uint * array,
    const char ** names,
    int count)
{
