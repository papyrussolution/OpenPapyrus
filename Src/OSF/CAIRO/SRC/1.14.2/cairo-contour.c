...
cairo_int_status_t _cairo_contour_add(cairo_contour_t * dst,
...
cairo_int_status_t _cairo_contour_add_reversed(cairo_contour_t * dst,
    const cairo_contour_t * src)
{
...
static cairo_uint64_t point_distance_sq(const cairo_point_t * p1,
