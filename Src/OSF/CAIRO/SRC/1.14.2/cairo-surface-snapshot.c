...
static cairo_surface_t * _cairo_surface_snapshot_source(void * abstract_surface,
    CairoIRect * extents)
{
	cairo_surface_snapshot_t * surface = (cairo_surface_snapshot_t *)abstract_surface;
...
static void _cairo_surface_snapshot_release_source_image(void * abstract_surface,
