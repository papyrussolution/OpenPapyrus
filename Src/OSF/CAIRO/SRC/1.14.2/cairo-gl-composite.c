...
static inline void _cairo_gl_composite_draw_tristrip(cairo_gl_context_t * ctx)
{
	...
	const ushort * indices_array = _cairo_array_index_const(indices, 0);
...
cairo_status_t _cairo_gl_composite_init(cairo_gl_composite_t * setup,
    cairo_operator_t op, cairo_gl_surface_t * dst, cairo_bool_t assume_component_alpha)
{
	cairo_status_t status;
...
cairo_int_status_t _cairo_gl_composite_emit_triangle_as_tristrip(cairo_gl_context_t       * ctx,
    cairo_gl_composite_t     * setup,
