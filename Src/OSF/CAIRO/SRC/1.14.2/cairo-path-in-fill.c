...
static void _cairo_in_fill_init(cairo_in_fill_t    * in_fill, double tolerance, double x, double y)
{
...
static void _cairo_in_fill_fini(cairo_in_fill_t * in_fill)
{
}

static int edge_compare_for_y_against_x(const cairo_point_t * p1,
...
static void _cairo_in_fill_add_edge(cairo_in_fill_t * in_fill,
...
static cairo_status_t _cairo_in_fill_line_to(void * closure,
...
cairo_bool_t _cairo_path_fixed_in_fill(const cairo_path_fixed_t     * path,
    CairoFillRule fill_rule, double tolerance, double x, double y)
{
	...
	status = _cairo_path_fixed_interpret(path, _cairo_in_fill_move_to,
	    _cairo_in_fill_line_to, _cairo_in_fill_curve_to, _cairo_in_fill_close_path, &in_fill);
