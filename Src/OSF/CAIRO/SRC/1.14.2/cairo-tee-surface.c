...
static cairo_status_t _cairo_tee_surface_finish(void * abstract_surface)
{
...
static cairo_surface_t * _cairo_tee_surface_source(void * abstract_surface,
    CairoIRect * extents)
{
	cairo_tee_surface_t * surface = abstract_surface;
...
static void _cairo_tee_surface_release_source_image(void * abstract_surface,
...
static cairo_surface_t * _cairo_tee_surface_snapshot(void * abstract_surface)
{
	cairo_tee_surface_t * surface = abstract_surface;
	cairo_surface_wrapper_t * slaves;
	int num_slaves, n;
...
static void _cairo_tee_surface_get_font_options(void * abstract_surface,
...
static cairo_int_status_t _cairo_tee_surface_paint(void * abstract_surface,
    cairo_operator_t op,
...
static cairo_int_status_t _cairo_tee_surface_mask(void * abstract_surface,
    cairo_operator_t op,
    const cairo_pattern_t  * source,
...
static cairo_int_status_t _cairo_tee_surface_stroke(void * abstract_surface,
    cairo_operator_t op,
    const cairo_pattern_t        * source,
...
static cairo_int_status_t _cairo_tee_surface_fill(void * abstract_surface,
    cairo_operator_t op,
    const cairo_pattern_t          * source,
    const cairo_path_fixed_t       * path,
...
static cairo_int_status_t _cairo_tee_surface_show_text_glyphs(void * abstract_surface,
    cairo_operator_t op,
    const cairo_pattern_t  * source,
    const char             * utf8,
    int utf8_len,
...
void cairo_tee_surface_remove(cairo_surface_t * abstract_surface,
    cairo_surface_t * target)
{
	cairo_tee_surface_t * surface;
	cairo_surface_wrapper_t * slaves;
...
cairo_surface_t * cairo_tee_surface_index(cairo_surface_t * abstract_surface,
    uint index)
{
	cairo_tee_surface_t * surface;
...
cairo_surface_t * _cairo_tee_surface_find_match(void * abstract_surface,
