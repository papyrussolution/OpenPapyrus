...
static void _copy_transformed_pattern(cairo_pattern_t * pattern, const cairo_pattern_t * original, const cairo_matrix_t  * ctm_inverse)
{
...
static void _cairo_surface_wrapper_get_transform(cairo_surface_wrapper_t * wrapper, cairo_matrix_t * m)
{
...
static void _cairo_surface_wrapper_get_inverse_transform(cairo_surface_wrapper_t * wrapper, cairo_matrix_t * m)
{
	cairo_matrix_init_identity(m);
	...
	if(!_cairo_matrix_is_identity(&wrapper->transform)) {
		cairo_matrix_t inv = wrapper->transform;
...
static cairo_clip_t * _cairo_surface_wrapper_get_clip(cairo_surface_wrapper_t * wrapper,
...
cairo_status_t _cairo_surface_wrapper_paint(cairo_surface_wrapper_t * wrapper,
    cairo_operator_t op,
...
cairo_status_t _cairo_surface_wrapper_mask(cairo_surface_wrapper_t * wrapper,
    cairo_operator_t op,
    const cairo_pattern_t * source,
...
cairo_status_t _cairo_surface_wrapper_stroke(cairo_surface_wrapper_t * wrapper,
    cairo_operator_t op,
    const cairo_pattern_t    * source,
...
cairo_status_t _cairo_surface_wrapper_fill_stroke(cairo_surface_wrapper_t * wrapper,
...
cairo_status_t _cairo_surface_wrapper_fill(cairo_surface_wrapper_t    * wrapper,
    cairo_operator_t op,
    const cairo_pattern_t * source,
    const cairo_path_fixed_t   * path,
    CairoFillRule fill_rule,
...
cairo_surface_t * _cairo_surface_wrapper_create_similar(cairo_surface_wrapper_t * wrapper,
...
void _cairo_surface_wrapper_intersect_extents(cairo_surface_wrapper_t * wrapper,
...
void _cairo_surface_wrapper_set_inverse_transform(cairo_surface_wrapper_t * wrapper,
...
cairo_surface_t * _cairo_surface_wrapper_snapshot(cairo_surface_wrapper_t * wrapper)
{
...
void _cairo_surface_wrapper_init(cairo_surface_wrapper_t * wrapper,
...
cairo_bool_t _cairo_surface_wrapper_get_target_extents(cairo_surface_wrapper_t * wrapper,
    CairoIRect * extents)
{
	CairoIRect clip;
