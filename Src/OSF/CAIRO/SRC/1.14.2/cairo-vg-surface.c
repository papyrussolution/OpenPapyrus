...
static VGFillRule _vg_fill_rule_from_cairo(CairoFillRule rule)
{
	switch(rule) {
...
static void egl_destroy_target(cairo_vg_context_t * context,
    cairo_vg_surface_t * surface)
{
...
cairo_vg_context_t * cairo_vg_context_create_for_egl(EGLDisplay egl_display,
