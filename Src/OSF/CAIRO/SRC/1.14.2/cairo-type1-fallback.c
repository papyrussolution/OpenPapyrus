 ...
 */
static void charstring_encode_command(cairo_array_t * data, int command)
{
	cairo_status_t status;
	uint orig_size;
	uchar buf[5];
 ...
 */
static void charstring_encode_integer(cairo_array_t * data, int i, cairo_charstring_type_t type)
{
	cairo_status_t status;
	uint orig_size;
	uchar buf[10];
...
static cairo_status_t _charstring_move_to(void * closure,
...
static cairo_status_t _charstring_line_to(void * closure,
    const cairo_point_t    * point)
{
	t1_path_info_t * path_info = (t1_path_info_t*)closure;
	int dx, dy;
...
static cairo_status_t _charstring_curve_to(void * closure,
...
static cairo_int_status_t cairo_type1_font_create_charstring(cairo_type1_font_t      * font,
    int subset_index,
    int glyph_index,
    cairo_charstring_type_t type,
    cairo_array_t           * data)
...
static void cairo_type1_font_write_header(cairo_type1_font_t * font,
    const char         * name)
{
	uint i;
...
cairo_status_t _cairo_type1_fallback_init_binary(cairo_type1_subset_t * type1_subset, const char * name, cairo_scaled_font_subset_t * scaled_font_subset)
{
	return _cairo_type1_fallback_init_internal(type1_subset, name, scaled_font_subset, FALSE);
}

cairo_status_t _cairo_type1_fallback_init_hex(cairo_type1_subset_t * type1_subset, const char * name, cairo_scaled_font_subset_t * scaled_font_subset)
{
...
cairo_status_t _cairo_type2_charstrings_init(cairo_type2_charstrings_t * type2_subset,
    cairo_scaled_font_subset_t * scaled_font_subset)
{
	cairo_type1_font_t * font;
	uint i;
