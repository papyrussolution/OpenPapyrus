...
void _cairo_raster_source_pattern_release(const cairo_pattern_t * abstract_pattern,
...
cairo_status_t _cairo_raster_source_pattern_init_copy(cairo_pattern_t * abstract_pattern,
 ...
 * Since: 1.12
 **/
void cairo_raster_source_pattern_set_callback_data(cairo_pattern_t * abstract_pattern,
    void * data)
{
	cairo_raster_source_pattern_t * pattern;
 ...
 * Since: 1.12
 **/
void cairo_raster_source_pattern_set_snapshot(cairo_pattern_t * abstract_pattern,
 ...
 * Since: 1.12
 **/
void cairo_raster_source_pattern_set_copy(cairo_pattern_t * abstract_pattern,
 ...
 * Since: 1.12
 **/
void cairo_raster_source_pattern_set_finish(cairo_pattern_t * abstract_pattern,
