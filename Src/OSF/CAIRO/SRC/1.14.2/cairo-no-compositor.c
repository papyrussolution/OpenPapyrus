...
static cairo_int_status_t _cairo_no_compositor_paint(const cairo_compositor_t * _compositor,
...
static cairo_int_status_t _cairo_no_compositor_mask(const cairo_compositor_t * compositor,
    cairo_composite_rectangles_t * extents)
{
	ASSERT_NOT_REACHED;
	return CAIRO_INT_STATUS_NOTHING_TO_DO;
