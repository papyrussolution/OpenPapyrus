...
static cairo_surface_t * _create_recording_surface_for_target(cairo_surface_t * target,
    cairo_content_t content)
{
	CairoIRect rect;
...
static void _cairo_paginated_surface_get_font_options(void * abstract_surface,
    cairo_font_options_t  * options)
{
	cairo_paginated_surface_t * surface = (cairo_paginated_surface_t *)abstract_surface;
