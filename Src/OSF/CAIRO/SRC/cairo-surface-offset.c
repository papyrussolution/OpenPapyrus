...
static void _copy_transformed_pattern(cairo_pattern_t * pattern,
...
cairo_status_t _cairo_surface_offset_paint(cairo_surface_t * target,
	int x, int y,
	cairo_operator_t op,
...
cairo_status_t _cairo_surface_offset_mask(cairo_surface_t * target,
	int x, int y,
	cairo_operator_t op,
	const cairo_pattern_t * source,
...
cairo_status_t _cairo_surface_offset_stroke(cairo_surface_t * surface,
	int x, int y,
	cairo_operator_t op,
	const cairo_pattern_t * source,
...
cairo_status_t _cairo_surface_offset_fill(cairo_surface_t * surface,
	int x, int y,
	cairo_operator_t op,
	const cairo_pattern_t * source,
	cairo_path_fixed_t * path,
	...
	cairo_clip_t * clip)
{
	...
	status = _cairo_surface_show_text_glyphs(surface, op, source, NULL, 0, dev_glyphs, num_glyphs, NULL, 0, CAIRO_TEXT_CLUSTER_FLAG_UNDEF, scaled_font, dev_clip);
FINISH:
	if(dev_clip != clip)
		_cairo_clip_reset(dev_clip);
	free(dev_glyphs);
