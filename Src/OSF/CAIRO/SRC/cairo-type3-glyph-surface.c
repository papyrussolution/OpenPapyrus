    ...
    cairo_scaled_font_subsets_t * font_subsets, cairo_bool_t ps)
{
	...
	_cairo_surface_init(&surface->base, &cairo_type3_glyph_surface_backend, NULL, /* device */ CAIRO_CONTENT_COLOR_ALPHA);
    ...
    int num_glyphs, cairo_scaled_font_t * scaled_font, const cairo_clip_t * clip)
{
	...
	status = _cairo_pdf_operators_show_text_glyphs(&surface->pdf_operators,
	    NULL, 0, glyphs, num_glyphs, NULL, 0, CAIRO_TEXT_CLUSTER_FLAG_NONE, font);
