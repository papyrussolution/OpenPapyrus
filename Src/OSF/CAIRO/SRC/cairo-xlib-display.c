...
static void _cairo_xlib_remove_close_display_hook_internal(cairo_xlib_display_t * display, cairo_xlib_hook_t * hook);

static void _cairo_xlib_call_close_display_hooks(cairo_xlib_display_t * display)
{
...
static void _cairo_xlib_display_notify(cairo_xlib_display_t * display)
{
...
cairo_device_t * _cairo_xlib_device_create(Display * dpy)
{
	...
	if(env && (env = strstr(env, "xrender-version=")) != NULL) {
		...
		if(max_render_major < display->render_major || (max_render_major == display->render_major &&
...
void _cairo_xlib_add_close_display_hook(cairo_xlib_display_t * display,
	cairo_xlib_hook_t * hook)
{
	hook->prev = NULL;
...
static void _cairo_xlib_remove_close_display_hook_internal(cairo_xlib_display_t * display,
	cairo_xlib_hook_t * hook)
{
...
void _cairo_xlib_remove_close_display_hook(cairo_xlib_display_t * display,
	cairo_xlib_hook_t * hook)
{
	_cairo_xlib_remove_close_display_hook_internal(display, hook);
}

cairo_status_t _cairo_xlib_display_queue_resource(cairo_xlib_display_t * display,
	cairo_xlib_notify_resource_func notify,
	XID xid)
{
...
cairo_status_t _cairo_xlib_display_queue_work(cairo_xlib_display_t * display,
	cairo_xlib_notify_func notify,
	void * data,
	void (* destroy)(void *))
{
...
void _cairo_xlib_display_get_xrender_version(cairo_xlib_display_t * display,
	int * major, int * minor)
{
