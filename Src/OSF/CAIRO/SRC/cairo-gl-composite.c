...
static cairo_int_status_t _cairo_gl_create_gradient_texture(cairo_gl_surface_t * dst,
	const cairo_gradient_pattern_t * pattern, cairo_gl_gradient_t ** gradient)
{
...
static cairo_status_t _cairo_gl_pattern_texture_setup(cairo_gl_operand_t * operand,
	const cairo_pattern_t * src, cairo_gl_surface_t * dst,
...
static cairo_status_t _cairo_gl_solid_operand_init(cairo_gl_operand_t * operand,
...
static void _cairo_gl_operand_destroy(cairo_gl_operand_t * operand)
{
	switch(operand->type) {
...
static cairo_int_status_t _cairo_gl_operand_init(cairo_gl_operand_t * operand,
	const cairo_pattern_t * pattern,
	cairo_gl_surface_t * dst,
	int src_x, int src_y,
	int dst_x, int dst_y,
...
void _cairo_gl_composite_set_mask_spans(cairo_gl_composite_t * setup)
{
	_cairo_gl_operand_destroy(&setup->mask);
...
static void _cairo_gl_operand_bind_to_shader(cairo_gl_context_t * ctx,
...
static void _cairo_gl_operand_setup_fixed(cairo_gl_operand_t * operand,
	cairo_gl_tex_t tex_unit)
{
	switch(operand->type) {
	    case CAIRO_GL_OPERAND_CONSTANT:
...
static cairo_bool_t _cairo_gl_operand_needs_setup(cairo_gl_operand_t * dest,
 ...
 */
static void _cairo_gl_set_src_alpha(cairo_gl_context_t * ctx,
...
static void _cairo_gl_set_operator(cairo_gl_context_t * ctx,
	cairo_operator_t op,
...
static unsigned int _cairo_gl_operand_get_vertex_size(cairo_gl_operand_type_t type)
{
	switch(type) {
	    default:
	    case CAIRO_GL_OPERAND_COUNT:
...
static inline void _cairo_gl_composite_draw(cairo_gl_context_t * ctx,
	unsigned int count)
{
	if(!ctx->pre_shader) {
...
static inline void _cairo_gl_operand_emit(cairo_gl_operand_t * operand,
	GLfloat ** vb,
	GLfloat x,
	GLfloat y,
	uint8_t alpha)
...
void _cairo_gl_composite_emit_rect(cairo_gl_context_t * ctx,
	GLfloat x1,
	GLfloat y1,
	GLfloat x2,
	GLfloat y2,
...
void _cairo_gl_composite_emit_glyph(cairo_gl_context_t * ctx,
	GLfloat x1,
	GLfloat y1,
	GLfloat x2,
	GLfloat y2,
