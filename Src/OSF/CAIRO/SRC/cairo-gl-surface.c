 ...
 */
static cairo_status_t _cairo_gl_surface_extract_image_data(cairo_image_surface_t * image,
    int x, int y,
...
static void _cairo_gl_surface_embedded_operand_init(cairo_gl_surface_t * surface)
{
	cairo_gl_operand_t * operand = &surface->operand;
	cairo_surface_attributes_t * attributes = &operand->texture.attributes;
	memzero(operand, sizeof(cairo_gl_operand_t));
...
static cairo_bool_t _cairo_gl_surface_size_valid(cairo_gl_surface_t * surface,
    int width, int height)
{
...
cairo_surface_t * _cairo_gl_surface_create_scratch(cairo_gl_context_t   * ctx,
    cairo_content_t content,
    int width,
    int height)
{
...
cairo_surface_t * _cairo_gl_surface_create_scratch_for_caching(cairo_gl_context_t * ctx,
    cairo_content_t content,
    int width,
    int height)
{
...
static cairo_surface_t * _cairo_gl_surface_create_and_clear_scratch(cairo_gl_context_t * ctx,
    cairo_content_t content,
    int width,
    int height)
{
...
static cairo_int_status_t _cairo_gl_surface_fill_alpha_channel(cairo_gl_surface_t * dst,
    cairo_gl_context_t * ctx,
    int x, int y,
    int width, int height)
{
...
static cairo_image_surface_t * _cairo_gl_surface_map_to_image(void * abstract_surface,
...
cairo_int_status_t _cairo_gl_surface_resolve_multisampling(cairo_gl_surface_t * surface)
{
	cairo_gl_context_t * ctx;
	cairo_int_status_t status;
...
static const cairo_compositor_t * get_compositor(cairo_gl_surface_t * surface)
{
	cairo_gl_context_t * ctx = (cairo_gl_context_t*)surface->base.device;
