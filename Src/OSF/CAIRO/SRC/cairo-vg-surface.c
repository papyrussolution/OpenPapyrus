...
static cairo_surface_t * _vg_surface_create_internal(cairo_vg_context_t * context, VGImage image, VGImageFormat format,
	int width,
	int height);
...
static cairo_status_t _vg_surface_acquire_dest_image(void * abstract_surface,
...
static void unpremultiply_argb(uint8_t * data,
	int width,
	int height,
	int stride)
{
...
static void _vg_surface_release_dest_image(void * abstract_surface,
	cairo_rectangle_int_t * interest_rect,
	cairo_image_surface_t * image,
