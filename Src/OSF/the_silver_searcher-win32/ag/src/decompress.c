...
static void * decompress_lzw(const void * buf, const int buf_len, const char * dir_full_path, int * new_buf_len) 
{
	(void)buf;
	(void)buf_len;
...
static void * decompress_zip(const void * buf, const int buf_len, const char * dir_full_path, int * new_buf_len) 
{
	(void)buf;
	(void)buf_len;
...
#ifdef HAVE_LZMA_H
static void * decompress_lzma(const void * buf, const int buf_len, const char * dir_full_path, int * new_buf_len) 
{
