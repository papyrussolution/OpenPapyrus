...
struct jpeg_compress_struct {
	 ...
	 */
	uint   scale_num; // fraction by which to scale image 
	uint   scale_denom; 
	...
	jpeg_component_info * comp_info; /* comp_info[i] describes component that appears i'th in SOF */
	...
	*/
	...
	jpeg_component_info * cur_comp_info[MAX_COMPS_IN_SCAN]; /* *cur_comp_info[i] describes component that appears i'th in SOS */
	...
	const uint8 * natural_order; /* natural-order position array */ // @sobolev int-->uint8
...
struct jpeg_decompress_struct {
	 ...
	 */
	int block_size; /* the basic DCT block size: 1..16 */
	const uint8 * natural_order; /* natural-order position array for entropy decode */ // @sobolev int-->uint8
...
struct jpeg_memory_mgr {
	...
	JMETHOD(void *, alloc_large, (j_common_ptr cinfo, int pool_id, size_t sizeofobject));
	...
	long max_alloc_chunk; // Maximum allocation request accepted by alloc_large
};
...
extern void jpeg_mem_dest(j_compress_ptr cinfo, uchar ** outbuffer, ulong * outsize);
extern void jpeg_mem_src(j_decompress_ptr cinfo, const uchar * inbuffer, ulong insize);
...
extern void jpeg_add_quant_table(j_compress_ptr cinfo, int which_tbl, const uint * basic_table, int scale_factor, boolean force_baseline);
...
extern void jpeg_write_marker(j_compress_ptr cinfo, int marker, const JOCTET * dataptr, uint datalen);
/* Same, but piecemeal. */
extern void jpeg_write_m_header(j_compress_ptr cinfo, int marker, uint datalen);
...
extern void jpeg_save_markers(j_decompress_ptr cinfo, int marker_code, uint length_limit);
