...
static void ft_smooth_lcd_spans(int y,
    int count,
    const FT_Span*  spans,
    TOrigin*        target)
{
...
static FT_Error ft_smooth_raster_lcd(FT_Renderer render,
    FT_Outline*  outline,
    FT_Bitmap*   bitmap)
{
	FT_Error error = FT_Err_Ok;
...
static FT_Error ft_smooth_raster_lcdv(FT_Renderer render,
    FT_Outline*  outline,
    FT_Bitmap*   bitmap)
{
	FT_Error error = FT_Err_Ok;
...
static void ft_smooth_overlap_spans(int y,
    int count,
    const FT_Span*  spans,
    TOrigin*        target)
{
...
static FT_Error ft_smooth_raster_overlap(FT_Renderer render,
    FT_Outline*  outline,
    FT_Bitmap*   bitmap)
{
	FT_Error error      = FT_Err_Ok;
