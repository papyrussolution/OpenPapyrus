...
FT_LOCAL_DEF(void) psh_globals_set_scale(PSH_Globals globals, FT_Fixed x_scale, FT_Fixed y_scale, FT_Fixed x_delta, FT_Fixed y_delta)
{
	PSH_Dimension dim = &globals->dimension[0];
...
FT_LOCAL_DEF(void) psh_globals_funcs_init(PSH_Globals_FuncsRec*  funcs)
{
