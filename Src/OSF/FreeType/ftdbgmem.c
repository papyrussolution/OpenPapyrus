...
static FT_Pointer ft_mem_debug_alloc(FT_Memory memory,
    FT_Long size)
{
...
static void ft_mem_debug_free(FT_Memory memory,
    FT_Pointer block)
{
	FT_MemTable table = (FT_MemTable)memory->user;
...
static FT_Pointer ft_mem_debug_realloc(FT_Memory memory,
    FT_Long cur_size,
    FT_Long new_size,
    FT_Pointer block)
{
