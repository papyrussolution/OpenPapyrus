...
#define OTV_OPTIONAL_TABLE(_table)  FT_UShort _table; FT_Bytes _table ## _p
#define OTV_OPTIONAL_TABLE32(_table)  FT_ULong _table; FT_Bytes _table ## _p
...
//
//
FT_LOCAL(void) otv_Coverage_validate(FT_Bytes table, OTV_Validator otvalid, FT_Int expected_count);
/* return first covered glyph */
FT_LOCAL(FT_UInt) otv_Coverage_get_first(FT_Bytes table);
/* return last covered glyph */
FT_LOCAL(FT_UInt) otv_Coverage_get_last(FT_Bytes table);
/* return number of covered glyphs */
FT_LOCAL(FT_UInt) otv_Coverage_get_count(FT_Bytes table);
//
//
/*****                                                               *****/
...
//
//
FT_LOCAL(void) otv_ClassDef_validate(FT_Bytes table, OTV_Validator otvalid);
//
//
/*****                                                               *****/
/*****                      DEVICE TABLE                             *****/
...
FT_LOCAL(void) otv_LookupList_validate(FT_Bytes table, OTV_Validator otvalid);
...
FT_LOCAL(void) otv_x_Ox(FT_Bytes table, OTV_Validator otvalid);
...
FT_LOCAL(void) otv_u_C_x_Ox(FT_Bytes table, OTV_Validator otvalid);
...
FT_LOCAL(void) otv_x_ux(FT_Bytes table, OTV_Validator otvalid);
...
FT_LOCAL(void) otv_x_y_ux_sy(FT_Bytes table, OTV_Validator otvalid);
...
FT_LOCAL(void) otv_x_ux_y_uy_z_uz_p_sp(FT_Bytes table, OTV_Validator otvalid);

#define ContextPosFormat2Func    otv_u_O_O_x_Onx
#define ContextSubstFormat2Func  otv_u_O_O_x_Onx

FT_LOCAL(void) otv_u_O_O_x_Onx(FT_Bytes table, OTV_Validator otvalid);

#define ContextPosFormat3Func    otv_u_x_y_Ox_sy
#define ContextSubstFormat3Func  otv_u_x_y_Ox_sy

FT_LOCAL(void) otv_u_x_y_Ox_sy(FT_Bytes table, OTV_Validator otvalid);

#define ChainContextPosFormat2Func    otv_u_O_O_O_O_x_Onx
#define ChainContextSubstFormat2Func  otv_u_O_O_O_O_x_Onx

FT_LOCAL(void) otv_u_O_O_O_O_x_Onx(FT_Bytes table, OTV_Validator otvalid);

#define ChainContextPosFormat3Func    otv_u_x_Ox_y_Oy_z_Oz_p_sp
#define ChainContextSubstFormat3Func  otv_u_x_Ox_y_Oy_z_Oz_p_sp

FT_LOCAL(void) otv_u_x_Ox_y_Oy_z_Oz_p_sp(FT_Bytes table, OTV_Validator otvalid);
FT_LOCAL(FT_UInt) otv_GSUBGPOS_get_Lookup_count(FT_Bytes table);
FT_LOCAL(FT_UInt) otv_GSUBGPOS_have_MarkAttachmentType_flag(FT_Bytes table);
