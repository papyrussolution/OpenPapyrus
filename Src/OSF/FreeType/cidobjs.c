 ...
 *   FreeType error code.  0 means success.
 */
FT_LOCAL_DEF(FT_Error) cid_driver_init(FT_Module module)
{
	...
	seed = (FT_UInt32)( (FT_Offset)(char*)&seed ^ (FT_Offset)(char*)&module ^ (FT_Offset)(char*)module->memory);
 ...
 */
FT_LOCAL_DEF(void) cid_driver_done(FT_Module driver)
{
	FT_UNUSED(driver);
}
