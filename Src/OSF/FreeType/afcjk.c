...
static void af_cjk_metrics_init_blues(AF_CJKMetrics metrics,
    FT_Face face)
{
...
FT_LOCAL_DEF(void) af_cjk_metrics_check_digits(AF_CJKMetrics metrics, FT_Face face)
{
...
static void af_cjk_metrics_scale_dim(AF_CJKMetrics metrics,
    AF_Scaler scaler,
    AF_Dimension dim)
{
	FT_Fixed scale;
