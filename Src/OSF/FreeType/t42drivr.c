...
/*FT_LOCAL_DEF(FT_Error)*/extern FT_Error T42_Size_Select(FT_Size t42size/* T42_Size */, FT_ULong strike_index); // @sobolev @prototype
/*
 * GLYPH DICT SERVICE
 *
 */
...
static FT_UInt t42_get_name_index(T42_Face face, const FT_String*  glyph_name)
{
	FT_Int i;
