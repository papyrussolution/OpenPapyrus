...
static FT_Error T42_Open_Face(T42_Face face)
{
	...
	if(type1->encoding_type == T1_ENCODING_TYPE_ARRAY) {
		...
		for(; charcode < loader.encoding_table.max_elems; charcode++) {
			const FT_String*  char_name = (const FT_String*)loader.encoding_table.elements[charcode];
...
// Driver Functions
//
/*FT_LOCAL_DEF(FT_Error)*/FT_Error T42_Face_Init(FT_Stream stream, FT_Face t42face/* T42_Face */, FT_Int face_index, FT_Int num_params, FT_Parameter*  params)
{
...
/*FT_LOCAL_DEF(void)*/void T42_Face_Done(FT_Face t42face)
{
	T42_Face face = (T42_Face)t42face;
	T1_Font type1;
	PS_FontInfo info;
 ...
 */
/*FT_LOCAL_DEF(FT_Error)*/FT_Error T42_Driver_Init(FT_Module module/* T42_Driver */)
{
	T42_Driver driver = (T42_Driver)module;
	FT_Module ttmodule = FT_Get_Module(module->library, "truetype");
	if(!ttmodule) {
...
/*FT_LOCAL_DEF(void)*/void T42_Driver_Done(FT_Module module)
{
	FT_UNUSED(module);
}

/*FT_LOCAL_DEF(FT_Error)*/FT_Error T42_Size_Init(FT_Size size/* T42_Size */)
{
	T42_Size t42size = (T42_Size)size;
	FT_Face face = size->face;
	T42_Face t42face = (T42_Face)face;
	FT_Size ttsize;
	FT_Error error = FT_New_Size(t42face->ttf_face, &ttsize);
	t42size->ttsize = ttsize;
	FT_Activate_Size(ttsize);
	return error;
}

/*FT_LOCAL_DEF(FT_Error)*/FT_Error T42_Size_Request(FT_Size t42size/* T42_Size */, FT_Size_Request req)
{
...
/*FT_LOCAL_DEF(FT_Error)*/FT_Error T42_Size_Select(FT_Size t42size/* T42_Size */, FT_ULong strike_index)
{
	T42_Size size = (T42_Size)t42size;
	T42_Face face = (T42_Face)t42size->face;
	FT_Error error;
...
/*FT_LOCAL_DEF(void)*/void T42_Size_Done(FT_Size t42size/* T42_Size */)
{
	T42_Size size = (T42_Size)t42size;
	FT_Face face = t42size->face;
	T42_Face t42face = (T42_Face)face;
	FT_ListNode node = FT_List_Find(&t42face->ttf_face->sizes_list, size->ttsize);
	if(node) {
...
/*FT_LOCAL_DEF(FT_Error)*/FT_Error T42_GlyphSlot_Init(FT_GlyphSlot t42slot/* T42_GlyphSlot */)
{
...
/*FT_LOCAL_DEF(void)*/void T42_GlyphSlot_Done(FT_GlyphSlot t42slot/* T42_GlyphSlot */)
{
	T42_GlyphSlot slot = (T42_GlyphSlot)t42slot;
...
/*FT_LOCAL_DEF(FT_Error)*/FT_Error T42_GlyphSlot_Load(FT_GlyphSlot glyph, FT_Size size, FT_UInt glyph_index, FT_Int32 load_flags)
{
	FT_Error error;
