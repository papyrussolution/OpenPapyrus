...
static void af_latin2_hints_compute_blue_edges(AF_GlyphHints hints,
...
static void af_latin2_hint_edges(AF_GlyphHints hints,
    AF_Dimension dim)
{
	AF_AxisHints axis       = &hints->axis[dim];
	AF_Edge edges      = axis->edges;
...
static FT_Error af_latin2_hints_apply(FT_UInt glyph_index,
    AF_GlyphHints hints,
    FT_Outline*      outline,
    AF_LatinMetrics metrics)
{
...
AF_DEFINE_WRITING_SYSTEM_CLASS(af_latin2_writing_system_class, AF_WRITING_SYSTEM_LATIN2,
