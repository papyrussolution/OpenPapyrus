...
#include "ftlcdfil.c"
#include "ftmac.c"
// (included into project) #include "ftobjs.c"
#include "ftoutln.c"
#include "ftpsprop.c"
// (included into project) #include "ftrfork.c"
//#include "ftsnames.c"
    ...
    FT_Long new_count, void *  block, FT_Error  *p_error)
{
	...
	// order to cover very weird cases where an ALLOC_MULT macro would be called.
