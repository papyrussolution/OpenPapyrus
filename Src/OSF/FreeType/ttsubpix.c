...
static FT_Bool is_member_of_family_class(const FT_String*  detected_font_name,
...
static FT_Bool is_member_of_style_class(const FT_String*  detected_font_style,
...
#else /* !(TT_USE_BYTECODE_INTERPRETER && TT_SUPPORT_SUBPIXEL_HINTING_INFINALITY) */
	typedef int _tt_subpix_dummy; /* ANSI C doesn't like empty source files */
