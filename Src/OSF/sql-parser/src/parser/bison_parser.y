...
opt_file_type : WITH FORMAT file_type { $$ = $3; } | /* empty */ { $$ = kImportAuto; };
...
| CREATE UNIQUE INDEX opt_not_exists opt_index_name ON table_name '(' ident_commalist ')' { // @sobolev
    $$ = new CreateStatement(kCreateIndex);
    $$->indexName = $5;
    $$->ifNotExists = $4;
    $$->fUnique = true;
