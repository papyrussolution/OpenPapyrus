...
#pragma hdrstop
#define GSL_SF_GAMMA_XMAX  171.0 // The maximum x such that gamma(x) is not considered an overflow.
#define GSL_SF_FACT_NMAX   170 // The maximum n such that gsl_sf_fact(n) does not give an overflow.

int gamma_inc_Q_e(const double a, const double x, SMathResult * result); // @prototype
//
//
//
