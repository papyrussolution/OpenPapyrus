...
//#include "tif_config.h"
	...
	#define PACKAGE_STRING "LibTIFF Software " /* Define to the full name and version of this package. */
	#define PACKAGE_TARNAME "tiff" /* Define to the one symbol short name of this package. */
	#define PACKAGE_URL "" /* Define to the home page for this package. */
	#define PACKAGE_VERSION "" /* Define to the version of this package. */
	#define SIZEOF_SIGNED_INT 4 /* The size of `signed int', as computed by sizeof. */
	#define SIZEOF_SIGNED_LONG 4 /* The size of `signed long', as computed by sizeof. */
	#define SIZEOF_SIGNED_LONG_LONG 8 /* The size of `signed long long', as computed by sizeof. */
	#define SIZEOF_SIGNED_SHORT 2 /* The size of `signed short', as computed by sizeof. */
	#define SIZEOF_UNSIGNED_CHAR_P 4 /* The size of `unsigned char *', as computed by sizeof. */
	#define SIZEOF_UNSIGNED_INT 4 /* The size of `unsigned int', as computed by sizeof. */
	#define SIZEOF_UNSIGNED_LONG 4 /* The size of `unsigned long', as computed by sizeof. */
	#define SIZEOF_UNSIGNED_LONG_LONG 8 /* The size of `unsigned long long', as computed by sizeof. */
	#define SIZEOF_UNSIGNED_SHORT 2 /* The size of `unsigned short', as computed by sizeof. */
	#define STRIP_SIZE_DEFAULT 8192 /* Default size of the strip in bytes (when strip chopping enabled) */
	#define TIFF_INT32_FORMAT "%d" /* Signed 32-bit type formatter */
	#define TIFF_INT64_FORMAT "%lld" /* Signed 64-bit type formatter */
	#define TIFF_PTRDIFF_FORMAT "%ld" /* Pointer difference type formatter */
	#define TIFF_SIZE_FORMAT "%u" /* Unsigned size type formatter */
	...
	#define VERSION "" /* Version number of package */
	...
	//#endif
	#undef off_t /* Define to `long int' if <sys/types.h> does not define. */
...
#define TIFFhowmany_32(x, y) (((uint32)x < (0xffffffff - (uint32)(y-1))) ? ((((uint32)(x))+(((uint32)(y))-1))/((uint32)(y))) : 0U)
