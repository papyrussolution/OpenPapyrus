...
uintptr_t _mi_heap_random_next(mi_heap_t* heap) { return _mi_random_next(&heap->random); }
...
static void mi_heap_reset_pages(mi_heap_t* heap) 
{
	...
	memzero(&heap->pages_free_direct, sizeof(heap->pages_free_direct));
#ifdef MI_MEDIUM_DIRECT
	memzero(&heap->pages_free_medium, sizeof(heap->pages_free_medium));
#endif
