...
SpcSymbEntry SpcSymbTab[] = {
	{ '\x26', 1, "amp"    },  // & @anchor ќб€зательно на первом месте (замещающие строки содержат &)
	{ '\x21', 0, "exclam" },  // !
	{ '\x23', 0, "sharp"  },  // #
	{ '\x25', 0, "pct"    },  // %
	{ '\x27', 0, "apos"   },  // '
...
int SoapPacket::Parse(const char * pMethodName, void * pDoc, const char * pDebugFileName)
{
	...
	if(p_child) {
		...
		if(p_child) {
			...
			SoapPacketStruc resolve_items(*this); // —юда временно сбрасываютс€ разрешенные ссылки, которые потом разнос€тс€ по структурам
						...
						<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
  						<soapenv:Body>
    						<soapenv:Fault>
      						...
      						<faultstring>java.rmi.RemoteException: Ќеверное им€ пользовател€ или пароль</faultstring>
      						<detail>
