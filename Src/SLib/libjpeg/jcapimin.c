 ...
 */
void  jpeg_destroy_compress(j_compress_ptr cinfo) { jpeg_destroy(reinterpret_cast<j_common_ptr>(cinfo)); /* use common routine */ }
/*
 * Abort processing of a JPEG compression operation,
 * but don't destroy the object itself.
 */
void  jpeg_abort_compress(j_compress_ptr cinfo) { jpeg_abort(reinterpret_cast<j_common_ptr>(cinfo)); /* use common routine */ }
/*
