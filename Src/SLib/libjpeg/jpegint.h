...
// @v11.9.0 (replaced with idivroundup) EXTERN(long) FASTCALL jdiv_round_up(long a, long b);
// @v11.9.0 (replaced with idivroundup) EXTERN(JDIMENSION) FASTCALL jdiv_round_up_jd_Removed(long a, long b); // @sobolev
