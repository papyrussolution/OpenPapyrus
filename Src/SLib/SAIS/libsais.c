...
{
	LIBSAIS_THREAD_STATE *  _RESTRICT thread_state    = (LIBSAIS_THREAD_STATE *)libsais_alloc_aligned((size_t)threads * sizeof(LIBSAIS_THREAD_STATE), 4096);
	sa_sint_t *             _RESTRICT thread_buckets  = (sa_sint_t *)libsais_alloc_aligned((size_t)threads * 4 * ALPHABET_SIZE * sizeof(sa_sint_t), 4096);
	LIBSAIS_THREAD_CACHE *  _RESTRICT thread_cache    = (LIBSAIS_THREAD_CACHE *)libsais_alloc_aligned((size_t)threads * LIBSAIS_PER_THREAD_CACHE_SIZE * sizeof(LIBSAIS_THREAD_CACHE), 4096);
	if(thread_state != NULL && thread_buckets != NULL && thread_cache != NULL) {
		for(fast_sint_t t = 0; t < threads; ++t) {
...
{
	LIBSAIS_CONTEXT * _RESTRICT ctx            = (LIBSAIS_CONTEXT *)libsais_alloc_aligned(sizeof(LIBSAIS_CONTEXT), 64);
	sa_sint_t *       _RESTRICT buckets        = (sa_sint_t *)libsais_alloc_aligned(8 * ALPHABET_SIZE * sizeof(sa_sint_t), 4096);
	LIBSAIS_THREAD_STATE *  _RESTRICT thread_state   = threads > 1 ? libsais_alloc_thread_state(threads) : NULL;
	if(ctx && buckets && (thread_state || threads == 1)) {
		ctx->buckets = buckets;
		ctx->threads = threads;
...
static sa_sint_t libsais_count_negative_marked_suffixes(sa_sint_t * _RESTRICT SA, fast_sint_t omp_block_start, fast_sint_t omp_block_size)
{
	sa_sint_t count = 0;
...
static sa_sint_t libsais_count_zero_marked_suffixes(sa_sint_t * _RESTRICT SA, fast_sint_t omp_block_start, fast_sint_t omp_block_size)
{
	sa_sint_t count = 0;
	fast_sint_t i; for(i = omp_block_start; i < omp_block_start + omp_block_size; ++i) {
		count += (SA[i] == 0);
...
static void libsais_place_cached_suffixes(sa_sint_t * _RESTRICT SA, LIBSAIS_THREAD_CACHE * _RESTRICT cache, fast_sint_t omp_block_start, fast_sint_t omp_block_size)
{
...
static void libsais_compact_and_place_cached_suffixes(sa_sint_t * _RESTRICT SA, LIBSAIS_THREAD_CACHE * _RESTRICT cache, fast_sint_t omp_block_start, fast_sint_t omp_block_size)
{
	const fast_sint_t prefetch_distance = 32;
	fast_sint_t i, j, l;
...
static void libsais_accumulate_counts_s32_2(sa_sint_t * _RESTRICT bucket00, fast_sint_t bucket_size, fast_sint_t bucket_stride)
{
...
static void libsais_accumulate_counts_s32_3(sa_sint_t * _RESTRICT bucket00, fast_sint_t bucket_size, fast_sint_t bucket_stride)
{
	sa_sint_t * _RESTRICT bucket01 = bucket00 - bucket_stride;
...
static void libsais_accumulate_counts_s32_4(sa_sint_t * _RESTRICT bucket00, fast_sint_t bucket_size, fast_sint_t bucket_stride)
{
	sa_sint_t * _RESTRICT bucket01 = bucket00 - bucket_stride;
	sa_sint_t * _RESTRICT bucket02 = bucket01 - bucket_stride;
...
static void libsais_accumulate_counts_s32_5(sa_sint_t * _RESTRICT bucket00, fast_sint_t bucket_size, fast_sint_t bucket_stride)
{
	sa_sint_t * _RESTRICT bucket01 = bucket00 - bucket_stride;
	sa_sint_t * _RESTRICT bucket02 = bucket01 - bucket_stride;
	sa_sint_t * _RESTRICT bucket03 = bucket02 - bucket_stride;
...
static void libsais_accumulate_counts_s32_6(sa_sint_t * _RESTRICT bucket00, fast_sint_t bucket_size, fast_sint_t bucket_stride)
{
	sa_sint_t * _RESTRICT bucket01 = bucket00 - bucket_stride;
	sa_sint_t * _RESTRICT bucket02 = bucket01 - bucket_stride;
	sa_sint_t * _RESTRICT bucket03 = bucket02 - bucket_stride;
...
static void libsais_accumulate_counts_s32_7(sa_sint_t * _RESTRICT bucket00, fast_sint_t bucket_size, fast_sint_t bucket_stride)
{
	sa_sint_t * _RESTRICT bucket01 = bucket00 - bucket_stride;
	sa_sint_t * _RESTRICT bucket02 = bucket01 - bucket_stride;
	sa_sint_t * _RESTRICT bucket03 = bucket02 - bucket_stride;
...
static void libsais_accumulate_counts_s32_8(sa_sint_t * _RESTRICT bucket00, fast_sint_t bucket_size, fast_sint_t bucket_stride)
{
	sa_sint_t * _RESTRICT bucket01 = bucket00 - bucket_stride;
	sa_sint_t * _RESTRICT bucket02 = bucket01 - bucket_stride;
	sa_sint_t * _RESTRICT bucket03 = bucket02 - bucket_stride;
...
static void libsais_accumulate_counts_s32_9(sa_sint_t * _RESTRICT bucket00, fast_sint_t bucket_size, fast_sint_t bucket_stride)
{
	sa_sint_t * _RESTRICT bucket01 = bucket00 - bucket_stride;
	sa_sint_t * _RESTRICT bucket02 = bucket01 - bucket_stride;
	sa_sint_t * _RESTRICT bucket03 = bucket02 - bucket_stride;
...
static void libsais_accumulate_counts_s32(sa_sint_t * _RESTRICT buckets, fast_sint_t bucket_size, fast_sint_t bucket_stride, fast_sint_t num_buckets)
{
	while(num_buckets >= 9) {
...
static void libsais_gather_lms_suffixes_8u(const uint8 * _RESTRICT T, sa_sint_t * _RESTRICT SA, sa_sint_t n, fast_sint_t m, fast_sint_t omp_block_start, fast_sint_t omp_block_size)
{
	if(omp_block_size > 0) {
...
static void libsais_gather_lms_suffixes_8u_omp(const uint8 * _RESTRICT T, sa_sint_t * _RESTRICT SA, sa_sint_t n, sa_sint_t threads, LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
#if defined(LIBSAIS_OPENMP)
...
static sa_sint_t libsais_gather_lms_suffixes_32s(const sa_sint_t * _RESTRICT T, sa_sint_t * _RESTRICT SA, sa_sint_t n)
{
	const fast_sint_t prefetch_distance = 32;
	sa_sint_t i   = n - 2;
	sa_sint_t m   = n - 1;
...
static sa_sint_t libsais_gather_compacted_lms_suffixes_32s(const sa_sint_t * _RESTRICT T, sa_sint_t * _RESTRICT SA, sa_sint_t n)
{
	const fast_sint_t prefetch_distance = 32;
	sa_sint_t i   = n - 2;
	sa_sint_t m   = n - 1;
...
static void libsais_count_lms_suffixes_32s_4k(const sa_sint_t * _RESTRICT T, sa_sint_t n, sa_sint_t k, sa_sint_t * _RESTRICT buckets)
{
	const fast_sint_t prefetch_distance = 32;
...
static void libsais_count_lms_suffixes_32s_2k(const sa_sint_t * _RESTRICT T, sa_sint_t n, sa_sint_t k, sa_sint_t * _RESTRICT buckets)
{
	const fast_sint_t prefetch_distance = 32;
...
static void libsais_count_compacted_lms_suffixes_32s_2k(const sa_sint_t * _RESTRICT T, sa_sint_t n, sa_sint_t k, sa_sint_t * _RESTRICT buckets)
{
	const fast_sint_t prefetch_distance = 32;
	memzero(buckets, 2 * (size_t)k * sizeof(sa_sint_t));
	sa_sint_t i   = n - 2;
...
static sa_sint_t libsais_count_and_gather_lms_suffixes_8u(const uint8 * _RESTRICT T,
...
static sa_sint_t libsais_count_and_gather_lms_suffixes_8u_omp(const uint8 * _RESTRICT T, sa_sint_t * _RESTRICT SA,
    sa_sint_t n, sa_sint_t * _RESTRICT buckets, sa_sint_t threads, LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
	sa_sint_t m = 0;
#if defined(LIBSAIS_OPENMP)
    #pragma omp parallel num_threads(threads) if(threads > 1 && n >= 65536 && omp_get_dynamic() == 0)
#endif
	{
		...
		if(omp_num_threads == 1) {
		...
		else {
			{
				...
				thread_state[omp_thread_num].state.m = libsais_count_and_gather_lms_suffixes_8u(T,
					SA, n, thread_state[omp_thread_num].state.buckets, omp_block_start, omp_block_size);
				if(thread_state[omp_thread_num].state.m > 0) {
...
static sa_sint_t libsais_count_and_gather_lms_suffixes_32s_4k(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA, sa_sint_t n, sa_sint_t k, sa_sint_t * _RESTRICT buckets,
...
static sa_sint_t libsais_count_and_gather_lms_suffixes_32s_2k(const sa_sint_t * _RESTRICT T, sa_sint_t * _RESTRICT SA,
    sa_sint_t n, sa_sint_t k, sa_sint_t * _RESTRICT buckets, fast_sint_t omp_block_start, fast_sint_t omp_block_size)
{
	memzero(buckets, 2 * (size_t)k * sizeof(sa_sint_t));
	fast_sint_t m = omp_block_start + omp_block_size - 1;
	if(omp_block_size > 0) {
...
static sa_sint_t libsais_count_and_gather_compacted_lms_suffixes_32s_2k(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA, sa_sint_t n, sa_sint_t k, sa_sint_t * _RESTRICT buckets,
    fast_sint_t omp_block_start, fast_sint_t omp_block_size)
{
	memzero(buckets, 2 * (size_t)k * sizeof(sa_sint_t));
...
static sa_sint_t libsais_count_and_gather_lms_suffixes_32s_4k_fs_omp(const sa_sint_t * _RESTRICT T,
    ...
    LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
...
#endif
	{
		...
		if(omp_num_threads == 1) {
			...
			{
				thread_state[omp_thread_num].state.position = omp_block_start + omp_block_size;
				thread_state[omp_thread_num].state.count = libsais_count_and_gather_lms_suffixes_32s_4k(T,
					SA,
					n,
					k,
...
static sa_sint_t libsais_count_and_gather_lms_suffixes_32s_2k_fs_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t k,
    sa_sint_t * _RESTRICT buckets,
    ...
    LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
...
#endif
	{
		...
		if(omp_num_threads == 1) {
			...
			{
				thread_state[omp_thread_num].state.position = omp_block_start + omp_block_size;
				thread_state[omp_thread_num].state.count = libsais_count_and_gather_lms_suffixes_32s_2k(T,
					SA,
					n,
					k,
					buckets - (omp_thread_num * bucket_stride),
...
static void libsais_count_and_gather_compacted_lms_suffixes_32s_2k_fs_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t k,
    sa_sint_t * _RESTRICT buckets,
		...
		if(omp_num_threads == 1) {
...

			{
				...
				thread_state[omp_thread_num].state.count =
				    libsais_count_and_gather_compacted_lms_suffixes_32s_2k(T,
					SA + n,
					n,
					k,
					buckets - (omp_thread_num * bucket_stride),
...
static sa_sint_t libsais_count_and_gather_lms_suffixes_32s_4k_nofs_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t k,
    sa_sint_t * _RESTRICT buckets,
...
static sa_sint_t libsais_count_and_gather_lms_suffixes_32s_2k_nofs_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t k,
    sa_sint_t * _RESTRICT buckets,
...
static sa_sint_t libsais_count_and_gather_compacted_lms_suffixes_32s_2k_nofs_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t k,
    sa_sint_t * _RESTRICT buckets,
...
static sa_sint_t libsais_count_and_gather_lms_suffixes_32s_4k_omp(const sa_sint_t * _RESTRICT T, sa_sint_t * _RESTRICT SA,
...
static sa_sint_t libsais_count_and_gather_lms_suffixes_32s_2k_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t k,
    sa_sint_t * _RESTRICT buckets,
...
static void libsais_count_and_gather_compacted_lms_suffixes_32s_2k_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t k,
    sa_sint_t * _RESTRICT buckets,
...
{
#if defined(LIBSAIS_OPENMP)
	sa_sint_t max_threads = (sa_sint_t)((buckets - &SA[(fast_sint_t)n + (fast_sint_t)n]) / ((2 * (fast_sint_t)k + 15) & (-16))); 
	if(max_threads > threads) {
		max_threads = threads;
	}
	if(max_threads > 1 && n >= 65536 && n / k >= 2) {
...
static void libsais_count_suffixes_32s(const sa_sint_t * _RESTRICT T, sa_sint_t n, sa_sint_t k, sa_sint_t * _RESTRICT buckets)
{
	const fast_sint_t prefetch_distance = 32;
...
static void libsais_initialize_buckets_start_and_end_8u(sa_sint_t * _RESTRICT buckets, sa_sint_t * _RESTRICT freq)
{
...
static void libsais_initialize_buckets_start_and_end_32s_6k(sa_sint_t k, sa_sint_t * _RESTRICT buckets)
{
...
static void libsais_initialize_buckets_start_and_end_32s_4k(sa_sint_t k, sa_sint_t * _RESTRICT buckets)
{
...
static void libsais_initialize_buckets_end_32s_2k(sa_sint_t k, sa_sint_t * _RESTRICT buckets)
{
...
static void libsais_initialize_buckets_start_and_end_32s_2k(sa_sint_t k, sa_sint_t * _RESTRICT buckets)
{
	fast_sint_t i, j;
	for(i = BUCKETS_INDEX2(0, 0), j = 0; i <= BUCKETS_INDEX2((fast_sint_t)k - 1, 0); i += BUCKETS_INDEX2(1, 0), j += 1) {
		buckets[j] = buckets[i];
...
static void libsais_initialize_buckets_start_32s_1k(sa_sint_t k, sa_sint_t * _RESTRICT buckets)
{
...
static void libsais_initialize_buckets_end_32s_1k(sa_sint_t k, sa_sint_t * _RESTRICT buckets)
{
	fast_sint_t i; sa_sint_t sum = 0;
	for(i = 0; i <= (fast_sint_t)k - 1; i += 1) {
...
static sa_sint_t libsais_initialize_buckets_for_lms_suffixes_radix_sort_8u(const uint8 * _RESTRICT T, sa_sint_t * _RESTRICT buckets, sa_sint_t first_lms_suffix)
{
	{
		fast_uint_t s = 0;
...
static void libsais_initialize_buckets_for_lms_suffixes_radix_sort_32s_2k(const sa_sint_t * _RESTRICT T, sa_sint_t k, sa_sint_t * _RESTRICT buckets, sa_sint_t first_lms_suffix)
{
...
static sa_sint_t libsais_initialize_buckets_for_lms_suffixes_radix_sort_32s_6k(const sa_sint_t * _RESTRICT T, sa_sint_t k, sa_sint_t * _RESTRICT buckets, sa_sint_t first_lms_suffix)
{
	{
		fast_uint_t s = 0;
		fast_sint_t c0 = T[first_lms_suffix];
...
static void libsais_initialize_buckets_for_radix_and_partial_sorting_32s_4k(const sa_sint_t * _RESTRICT T, sa_sint_t k, sa_sint_t * _RESTRICT buckets, sa_sint_t first_lms_suffix)
{
	sa_sint_t * _RESTRICT bucket_start = &buckets[2 * (fast_sint_t)k];
	sa_sint_t * _RESTRICT bucket_end   = &buckets[3 * (fast_sint_t)k];
...
static void libsais_radix_sort_lms_suffixes_8u(const uint8 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
...
static void libsais_radix_sort_lms_suffixes_8u_omp(const uint8 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t m,
    sa_sint_t * _RESTRICT buckets,
...
static void libsais_radix_sort_lms_suffixes_32s_6k(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT induction_bucket,
    fast_sint_t omp_block_start,
    fast_sint_t omp_block_size)
...
static void libsais_radix_sort_lms_suffixes_32s_2k(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT induction_bucket,
    fast_sint_t omp_block_start,
    fast_sint_t omp_block_size)
...
static void libsais_radix_sort_lms_suffixes_32s_block_gather(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
...
static void libsais_radix_sort_lms_suffixes_32s_6k_block_sort(sa_sint_t * _RESTRICT induction_bucket,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t omp_block_start,
    fast_sint_t omp_block_size)
{
...
static void libsais_radix_sort_lms_suffixes_32s_2k_block_sort(sa_sint_t * _RESTRICT induction_bucket,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t omp_block_start,
    fast_sint_t omp_block_size)
{
...
static void libsais_radix_sort_lms_suffixes_32s_2k_block_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT induction_bucket,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
...
static void libsais_radix_sort_lms_suffixes_32s_6k_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t m,
    sa_sint_t * _RESTRICT induction_bucket,
    ...
    LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
	if(threads == 1 || m < 65536) {
		...
		for(block_start = 0; block_start < (fast_sint_t)m - 1; block_start = block_end) {
			...
			libsais_radix_sort_lms_suffixes_32s_6k_block_omp(T,
			    SA,
			    induction_bucket,
...
static void libsais_radix_sort_lms_suffixes_32s_2k_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t m,
    sa_sint_t * _RESTRICT induction_bucket,
    ...
    LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
	if(threads == 1 || m < 65536) {
		...
		for(block_start = 0; block_start < (fast_sint_t)m - 1; block_start = block_end) {
			...
			libsais_radix_sort_lms_suffixes_32s_2k_block_omp(T,
			    SA,
			    induction_bucket,
			    thread_state[0].state.cache,
			    (fast_sint_t)n - block_end,
...
static sa_sint_t libsais_radix_sort_lms_suffixes_32s_1k(const sa_sint_t * _RESTRICT T, sa_sint_t * _RESTRICT SA, sa_sint_t n, sa_sint_t * _RESTRICT buckets)
{
	const fast_sint_t prefetch_distance = 32;
...
static void libsais_radix_sort_set_markers_32s_6k(sa_sint_t * _RESTRICT SA, sa_sint_t * _RESTRICT induction_bucket, fast_sint_t omp_block_start, fast_sint_t omp_block_size)
{
	const fast_sint_t prefetch_distance = 32;
...
static void libsais_radix_sort_set_markers_32s_4k(sa_sint_t * _RESTRICT SA, sa_sint_t * _RESTRICT induction_bucket, fast_sint_t omp_block_start, fast_sint_t omp_block_size)
{
	const fast_sint_t prefetch_distance = 32;
...
static void libsais_radix_sort_set_markers_32s_6k_omp(sa_sint_t * _RESTRICT SA, sa_sint_t k, sa_sint_t * _RESTRICT induction_bucket, sa_sint_t threads)
{
#if defined(LIBSAIS_OPENMP)
...
static void libsais_radix_sort_set_markers_32s_4k_omp(sa_sint_t * _RESTRICT SA, sa_sint_t k, sa_sint_t * _RESTRICT induction_bucket, sa_sint_t threads)
{
#if defined(LIBSAIS_OPENMP)
    #pragma omp parallel num_threads(threads) if(threads > 1 && k >= 65536)
#endif
...
static void libsais_initialize_buckets_for_partial_sorting_8u(const uint8 * _RESTRICT T, sa_sint_t * _RESTRICT buckets, sa_sint_t first_lms_suffix, sa_sint_t left_suffixes_count)
{
	sa_sint_t * _RESTRICT temp_bucket = &buckets[4 * ALPHABET_SIZE];
...
static void libsais_initialize_buckets_for_partial_sorting_32s_6k(const sa_sint_t * _RESTRICT T,
    sa_sint_t k,
    sa_sint_t * _RESTRICT buckets,
...
static sa_sint_t libsais_partial_sorting_scan_left_to_right_8u(const uint8 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t d,
    fast_sint_t omp_block_start,
...
static void libsais_partial_sorting_scan_left_to_right_8u_block_prepare(const uint8 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA, sa_sint_t * _RESTRICT buckets, LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t omp_block_start, fast_sint_t omp_block_size, LIBSAIS_THREAD_STATE * _RESTRICT state)
{
	const fast_sint_t prefetch_distance = 32;
...
static void libsais_partial_sorting_scan_left_to_right_8u_block_place(sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT buckets,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t count,
    sa_sint_t d)
...
static sa_sint_t libsais_partial_sorting_scan_left_to_right_8u_block_omp(const uint8 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t d,
    fast_sint_t block_start,
    ...
    LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
...
#endif
	{
		...
		if(omp_num_threads == 1) {
			...
			{
				libsais_partial_sorting_scan_left_to_right_8u_block_prepare(T,
				    SA,
	    ...
	    #pragma omp barrier
			...
			{
				libsais_partial_sorting_scan_left_to_right_8u_block_place(SA,
				    thread_state[omp_thread_num].state.buckets,
				    thread_state[omp_thread_num].state.cache,
				    thread_state[omp_thread_num].state.count,
...
static sa_sint_t libsais_partial_sorting_scan_left_to_right_8u_omp(const uint8 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t left_suffixes_count,
...
static sa_sint_t libsais_partial_sorting_scan_left_to_right_32s_6k(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t d,
    fast_sint_t omp_block_start,
...
static sa_sint_t libsais_partial_sorting_scan_left_to_right_32s_4k(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t k,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t d,
    ...
    fast_sint_t omp_block_size)
{
	...
	for(i = omp_block_start, j = omp_block_start + omp_block_size - 2 * prefetch_distance - 1; i < j; i += 2) {
		...
		sa_sint_t s0 = SA[i + 2 * prefetch_distance + 0]; const sa_sint_t * Ts0 = &T[s0 & ~SUFFIX_GROUP_MARKER] - 1; libsais_prefetchr(s0 > 0 ? Ts0 : NULL); Ts0--;
		libsais_prefetchr(s0 > 0 ? Ts0 : NULL);
		sa_sint_t s1 = SA[i + 2 * prefetch_distance + 1]; const sa_sint_t * Ts1 = &T[s1 & ~SUFFIX_GROUP_MARKER] - 1; libsais_prefetchr(s1 > 0 ? Ts1 : NULL); Ts1--;
		libsais_prefetchr(s1 > 0 ? Ts1 : NULL);
		sa_sint_t s2 = SA[i + 1 * prefetch_distance + 0]; 
		if(s2 > 0) {
			const fast_sint_t Ts2 = T[(s2 & ~SUFFIX_GROUP_MARKER) - 1]; libsais_prefetchw(&induction_bucket[Ts2]);
			libsais_prefetchw(&distinct_names[BUCKETS_INDEX2(Ts2, 0)]);
		}
		sa_sint_t s3 = SA[i + 1 * prefetch_distance + 1]; 
		if(s3 > 0) {
			const fast_sint_t Ts3 = T[(s3 & ~SUFFIX_GROUP_MARKER) - 1]; libsais_prefetchw(&induction_bucket[Ts3]);
...
static void libsais_partial_sorting_scan_left_to_right_32s_1k(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT induction_bucket,
    fast_sint_t omp_block_start,
    fast_sint_t omp_block_size)
{
	...
	for(i = omp_block_start, j = omp_block_start + omp_block_size - 2 * prefetch_distance - 1; i < j; i += 2) {
		...
		sa_sint_t s2 = SA[i + 1 * prefetch_distance + 0]; 
		if(s2 > 0) {
			libsais_prefetchw(&induction_bucket[T[s2 - 1]]); libsais_prefetchr(&T[s2] - 2);
		}
		sa_sint_t s3 = SA[i + 1 * prefetch_distance + 1]; 
		if(s3 > 0) {
			libsais_prefetchw(&induction_bucket[T[s3 - 1]]); libsais_prefetchr(&T[s3] - 2);
		}
...
static void libsais_partial_sorting_scan_left_to_right_32s_6k_block_gather(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t omp_block_start,
    fast_sint_t omp_block_size)
{
	...
	for(i = omp_block_start, j = omp_block_start + omp_block_size-prefetch_distance-1; i < j; i += 2) {
		...
		sa_sint_t p0 = cache[i + 0].index = SA[i + 0]; sa_sint_t symbol0 = 0; p0 &= SAINT_MAX; 
		if(p0 != 0) {
			symbol0 = BUCKETS_INDEX4(T[p0 - 1], T[p0 - 2] >= T[p0 - 1]);
		}
		cache[i + 0].symbol = symbol0;
		sa_sint_t p1 = cache[i + 1].index = SA[i + 1]; sa_sint_t symbol1 = 0; p1 &= SAINT_MAX; 
		if(p1 != 0) {
	...
	for(j += prefetch_distance + 1; i < j; i += 1) {
		sa_sint_t p = cache[i].index = SA[i]; sa_sint_t symbol = 0; p &= SAINT_MAX; 
		if(p != 0) {
...
static void libsais_partial_sorting_scan_left_to_right_32s_4k_block_gather(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t omp_block_start,
    fast_sint_t omp_block_size)
{
	...
	for(i = omp_block_start, j = omp_block_start + omp_block_size-prefetch_distance-1; i < j; i += 2) {
		...
		sa_sint_t s0 = SA[i + prefetch_distance + 0]; const sa_sint_t * Ts0 = &T[s0 & ~SUFFIX_GROUP_MARKER] - 1; libsais_prefetchr(s0 > 0 ? Ts0 : NULL); Ts0--;
		libsais_prefetchr(s0 > 0 ? Ts0 : NULL);
		sa_sint_t s1 = SA[i + prefetch_distance + 1]; const sa_sint_t * Ts1 = &T[s1 & ~SUFFIX_GROUP_MARKER] - 1; libsais_prefetchr(s1 > 0 ? Ts1 : NULL); Ts1--;
		libsais_prefetchr(s1 > 0 ? Ts1 : NULL);
...
static void libsais_partial_sorting_scan_left_to_right_32s_1k_block_gather(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t omp_block_start,
    fast_sint_t omp_block_size)
{
	...
	for(i = omp_block_start, j = omp_block_start + omp_block_size-prefetch_distance-1; i < j; i += 2) {
		...
		sa_sint_t s0 = SA[i + prefetch_distance + 0]; const sa_sint_t * Ts0 = &T[s0] - 1; libsais_prefetchr(s0 > 0 ? Ts0 : NULL); Ts0--; libsais_prefetchr(
			s0 > 0 ? Ts0 : NULL);
		sa_sint_t s1 = SA[i + prefetch_distance + 1]; const sa_sint_t * Ts1 = &T[s1] - 1; libsais_prefetchr(s1 > 0 ? Ts1 : NULL); Ts1--; libsais_prefetchr(
			s1 > 0 ? Ts1 : NULL);
...
static sa_sint_t libsais_partial_sorting_scan_left_to_right_32s_6k_block_sort(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t d,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t omp_block_start,
...
static sa_sint_t libsais_partial_sorting_scan_left_to_right_32s_4k_block_sort(const sa_sint_t * _RESTRICT T,
    sa_sint_t k,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t d,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    ...
    fast_sint_t omp_block_size)
{
	...
	for(i = omp_block_start, j = omp_block_end-prefetch_distance-1; i < j; i += 2) {
		...
		sa_sint_t s0 = cache[i + prefetch_distance + 0].symbol; const sa_sint_t * Is0 = &induction_bucket[s0 >> 1]; libsais_prefetchw(s0 >= 0 ? Is0 : NULL);
		const sa_sint_t * Ds0 = &distinct_names[s0]; libsais_prefetchw(s0 >= 0 ? Ds0 : NULL);
		sa_sint_t s1 = cache[i + prefetch_distance + 1].symbol; const sa_sint_t * Is1 = &induction_bucket[s1 >> 1]; libsais_prefetchw(s1 >= 0 ? Is1 : NULL);
		const sa_sint_t * Ds1 = &distinct_names[s1]; libsais_prefetchw(s1 >= 0 ? Ds1 : NULL);
...
static void libsais_partial_sorting_scan_left_to_right_32s_1k_block_sort(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT induction_bucket,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t omp_block_start,
    fast_sint_t omp_block_size)
...
static sa_sint_t libsais_partial_sorting_scan_left_to_right_32s_6k_block_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t d,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
...
static sa_sint_t libsais_partial_sorting_scan_left_to_right_32s_4k_block_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t k,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t d,
...
static void libsais_partial_sorting_scan_left_to_right_32s_1k_block_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT buckets,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t block_start,
...
static sa_sint_t libsais_partial_sorting_scan_left_to_right_32s_6k_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t left_suffixes_count,
    ...
    LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
	...
	if(threads == 1 || left_suffixes_count < 65536) {
		...
		for(block_start = 0; block_start < left_suffixes_count; block_start = block_end) {
			...
			d = libsais_partial_sorting_scan_left_to_right_32s_6k_block_omp(T,
				SA,
				buckets,
				d,
				thread_state[0].state.cache,
...
static sa_sint_t libsais_partial_sorting_scan_left_to_right_32s_4k_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t k,
    sa_sint_t * _RESTRICT buckets,
...
static void libsais_partial_sorting_scan_left_to_right_32s_1k_omp(const sa_sint_t * _RESTRICT T, sa_sint_t * _RESTRICT SA,
    sa_sint_t n, sa_sint_t * _RESTRICT buckets, sa_sint_t threads, LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
...
static void libsais_partial_sorting_shift_markers_8u_omp(sa_sint_t * _RESTRICT SA, sa_sint_t n, const sa_sint_t * _RESTRICT buckets, sa_sint_t threads)
{
	const fast_sint_t prefetch_distance = 32;
...
static void libsais_partial_sorting_shift_markers_32s_6k_omp(sa_sint_t * _RESTRICT SA, sa_sint_t k, const sa_sint_t * _RESTRICT buckets, sa_sint_t threads)
{
	const fast_sint_t prefetch_distance = 32;
...
static void libsais_partial_sorting_shift_markers_32s_4k(sa_sint_t * _RESTRICT SA, sa_sint_t n)
{
	const fast_sint_t prefetch_distance = 32;
...
static void libsais_partial_sorting_shift_buckets_32s_6k(sa_sint_t k, sa_sint_t * _RESTRICT buckets)
{
	sa_sint_t * _RESTRICT temp_bucket = &buckets[4 * (fast_sint_t)k];
...
static sa_sint_t libsais_partial_sorting_scan_right_to_left_8u(const uint8 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t d,
    fast_sint_t omp_block_start,
...
static void libsais_partial_sorting_scan_right_to_left_8u_block_prepare(const uint8 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA, sa_sint_t * _RESTRICT buckets, LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t omp_block_start, fast_sint_t omp_block_size, LIBSAIS_THREAD_STATE * _RESTRICT state)
{
	const fast_sint_t prefetch_distance = 32;
...
static void libsais_partial_sorting_scan_right_to_left_8u_block_place(sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT buckets,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t count,
    sa_sint_t d)
...
static sa_sint_t libsais_partial_sorting_scan_right_to_left_8u_block_omp(const uint8 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t d,
    fast_sint_t block_start,
    ...
    LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
...
#endif
	{
		...
		if(omp_num_threads == 1) {
			...
			{
				libsais_partial_sorting_scan_right_to_left_8u_block_prepare(T,
				    SA,
				    thread_state[omp_thread_num].state.buckets,
				    thread_state[omp_thread_num].state.cache,
				    omp_block_start,
	    ...
	    #pragma omp barrier
			...
			{
				libsais_partial_sorting_scan_right_to_left_8u_block_place(SA,
				    thread_state[omp_thread_num].state.buckets,
				    thread_state[omp_thread_num].state.cache,
				    thread_state[omp_thread_num].state.count,
				    (sa_sint_t)thread_state[omp_thread_num].state.position);
...
static void libsais_partial_sorting_scan_right_to_left_8u_omp(const uint8 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t first_lms_suffix,
...
static sa_sint_t libsais_partial_sorting_scan_right_to_left_32s_6k(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t d,
    fast_sint_t omp_block_start,
...
static sa_sint_t libsais_partial_sorting_scan_right_to_left_32s_4k(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t k,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t d,
...
static void libsais_partial_sorting_scan_right_to_left_32s_1k(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT induction_bucket,
    fast_sint_t omp_block_start,
    fast_sint_t omp_block_size)
...
static void libsais_partial_sorting_scan_right_to_left_32s_6k_block_gather(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t omp_block_start,
    fast_sint_t omp_block_size)
...
static void libsais_partial_sorting_scan_right_to_left_32s_4k_block_gather(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t omp_block_start,
    fast_sint_t omp_block_size)
...
static void libsais_partial_sorting_scan_right_to_left_32s_1k_block_gather(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t omp_block_start,
    fast_sint_t omp_block_size)
...
static sa_sint_t libsais_partial_sorting_scan_right_to_left_32s_6k_block_sort(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t d,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t omp_block_start,
...
static sa_sint_t libsais_partial_sorting_scan_right_to_left_32s_4k_block_sort(const sa_sint_t * _RESTRICT T,
    sa_sint_t k,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t d,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
...
static void libsais_partial_sorting_scan_right_to_left_32s_1k_block_sort(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT induction_bucket,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t omp_block_start,
    fast_sint_t omp_block_size)
...
static sa_sint_t libsais_partial_sorting_scan_right_to_left_32s_6k_block_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t d,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
...
static sa_sint_t libsais_partial_sorting_scan_right_to_left_32s_4k_block_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t k,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t d,
...
static void libsais_partial_sorting_scan_right_to_left_32s_1k_block_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT buckets,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t block_start,
...
static sa_sint_t libsais_partial_sorting_scan_right_to_left_32s_6k_omp(const sa_sint_t * _RESTRICT T, sa_sint_t * _RESTRICT SA, sa_sint_t n,
    sa_sint_t * _RESTRICT buckets, sa_sint_t first_lms_suffix, sa_sint_t left_suffixes_count, sa_sint_t d, sa_sint_t threads, LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
	fast_sint_t scan_start    = (fast_sint_t)left_suffixes_count + 1;
	fast_sint_t scan_end      = (fast_sint_t)n - (fast_sint_t)first_lms_suffix;
	if(threads == 1 || (scan_end - scan_start) < 65536) {
		...
		for(block_start = scan_end - 1; block_start >= scan_start; block_start = block_end) {
			...
			d = libsais_partial_sorting_scan_right_to_left_32s_6k_block_omp(T, SA, buckets, d, thread_state[0].state.cache, block_end + 1,
...
static sa_sint_t libsais_partial_sorting_scan_right_to_left_32s_4k_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t k,
    sa_sint_t * _RESTRICT buckets,
    ...
    LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
	if(threads == 1 || n < 65536) {
		...
		for(block_start = (fast_sint_t)n - 1; block_start >= 0; block_start = block_end) {
			...
			d = libsais_partial_sorting_scan_right_to_left_32s_4k_block_omp(T,
				SA,
				k,
				buckets,
				d,
...
static void libsais_partial_sorting_scan_right_to_left_32s_1k_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t threads,
...
static fast_sint_t libsais_partial_sorting_gather_lms_suffixes_32s_4k(sa_sint_t * _RESTRICT SA, fast_sint_t omp_block_start, fast_sint_t omp_block_size)
{
	const fast_sint_t prefetch_distance = 32;
...
static fast_sint_t libsais_partial_sorting_gather_lms_suffixes_32s_1k(sa_sint_t * _RESTRICT SA, fast_sint_t omp_block_start, fast_sint_t omp_block_size)
{
	const fast_sint_t prefetch_distance = 32;
...
static void libsais_partial_sorting_gather_lms_suffixes_32s_4k_omp(sa_sint_t * _RESTRICT SA, sa_sint_t n, sa_sint_t threads, LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
#if defined(LIBSAIS_OPENMP)
    #pragma omp parallel num_threads(threads) if(threads > 1 && n >= 65536)
#endif
	{
		...
		if(omp_num_threads == 1) {
		...
		else {
			{
				...
				thread_state[omp_thread_num].state.count =
				    libsais_partial_sorting_gather_lms_suffixes_32s_4k(SA, omp_block_start, omp_block_size) - omp_block_start;
			}
...
static void libsais_partial_sorting_gather_lms_suffixes_32s_1k_omp(sa_sint_t * _RESTRICT SA, sa_sint_t n, sa_sint_t threads, LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
#if defined(LIBSAIS_OPENMP)
    #pragma omp parallel num_threads(threads) if(threads > 1 && n >= 65536)
#endif
	{
		...
		if(omp_num_threads == 1) {
		...
		else {
			{
				thread_state[omp_thread_num].state.position = omp_block_start;
				thread_state[omp_thread_num].state.count =
				    libsais_partial_sorting_gather_lms_suffixes_32s_1k(SA, omp_block_start, omp_block_size) - omp_block_start;
			}
...
static void libsais_induce_partial_order_8u_omp(const uint8 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA, sa_sint_t n, sa_sint_t * _RESTRICT buckets,
    sa_sint_t first_lms_suffix, sa_sint_t left_suffixes_count, sa_sint_t threads,
    LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
...
static void libsais_induce_partial_order_32s_6k_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t k,
    sa_sint_t * _RESTRICT buckets,
...
static void libsais_induce_partial_order_32s_4k_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA, sa_sint_t n, sa_sint_t k, sa_sint_t * _RESTRICT buckets,
    sa_sint_t threads, LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
	memzero(buckets, 2 * (size_t)k * sizeof(sa_sint_t));
...
static void libsais_induce_partial_order_32s_2k_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t k,
    sa_sint_t * _RESTRICT buckets,
...
static void libsais_induce_partial_order_32s_1k_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t k,
    sa_sint_t * _RESTRICT buckets,
...
static sa_sint_t libsais_renumber_lms_suffixes_8u(sa_sint_t * _RESTRICT SA, sa_sint_t m, sa_sint_t name, fast_sint_t omp_block_start, fast_sint_t omp_block_size)
{
	const fast_sint_t prefetch_distance = 32;
...
static fast_sint_t libsais_gather_marked_suffixes_8u(sa_sint_t * _RESTRICT SA, sa_sint_t m, fast_sint_t l, fast_sint_t omp_block_start, fast_sint_t omp_block_size)
{
	const fast_sint_t prefetch_distance = 32;
...
static sa_sint_t libsais_renumber_lms_suffixes_8u_omp(sa_sint_t * _RESTRICT SA, sa_sint_t m, sa_sint_t threads, LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
	sa_sint_t name = 0;
...
static void libsais_gather_marked_lms_suffixes_8u_omp(sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t m,
    sa_sint_t fs,
    sa_sint_t threads,
    LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
...
#endif
	{
		...
		if(omp_num_threads == 1) {
			...
			{
				if(omp_thread_num < omp_num_threads - 1) {
					thread_state[omp_thread_num].state.position = libsais_gather_marked_suffixes_8u(SA,
						m,
...
static sa_sint_t libsais_renumber_and_gather_lms_suffixes_8u_omp(sa_sint_t * _RESTRICT SA,
    sa_sint_t n, sa_sint_t m, sa_sint_t fs, sa_sint_t threads, LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
...
static sa_sint_t libsais_renumber_distinct_lms_suffixes_32s_4k(sa_sint_t * _RESTRICT SA, sa_sint_t m, sa_sint_t name, fast_sint_t omp_block_start, fast_sint_t omp_block_size)
{
	const fast_sint_t prefetch_distance = 32;
...
static void libsais_mark_distinct_lms_suffixes_32s(sa_sint_t * _RESTRICT SA, sa_sint_t m, fast_sint_t omp_block_start, fast_sint_t omp_block_size)
{
	const fast_sint_t prefetch_distance = 32;
...
static void libsais_clamp_lms_suffixes_length_32s(sa_sint_t * _RESTRICT SA, sa_sint_t m, fast_sint_t omp_block_start, fast_sint_t omp_block_size)
{
	const fast_sint_t prefetch_distance = 32;
...
static sa_sint_t libsais_renumber_distinct_lms_suffixes_32s_4k_omp(sa_sint_t * _RESTRICT SA, sa_sint_t m, sa_sint_t threads, LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
	sa_sint_t name = 0;
...
static void libsais_mark_distinct_lms_suffixes_32s_omp(sa_sint_t * _RESTRICT SA, sa_sint_t n, sa_sint_t m, sa_sint_t threads)
{
#if defined(LIBSAIS_OPENMP)
    #pragma omp parallel num_threads(threads) if(threads > 1 && n >= 131072)
#endif
...
static void libsais_clamp_lms_suffixes_length_32s_omp(sa_sint_t * _RESTRICT SA, sa_sint_t n, sa_sint_t m, sa_sint_t threads)
{
#if defined(LIBSAIS_OPENMP)
    #pragma omp parallel num_threads(threads) if(threads > 1 && n >= 131072)
#endif
...
static sa_sint_t libsais_renumber_and_mark_distinct_lms_suffixes_32s_4k_omp(sa_sint_t * _RESTRICT SA,
...
static sa_sint_t libsais_renumber_and_mark_distinct_lms_suffixes_32s_1k_omp(sa_sint_t * _RESTRICT T, sa_sint_t * _RESTRICT SA, sa_sint_t n, sa_sint_t m, sa_sint_t threads)
{
	const fast_sint_t prefetch_distance = 32;
	sa_sint_t * _RESTRICT SAm = &SA[m];
	{
...
static void libsais_reconstruct_lms_suffixes(sa_sint_t * _RESTRICT SA, sa_sint_t n, sa_sint_t m, fast_sint_t omp_block_start, fast_sint_t omp_block_size)
{
	const fast_sint_t prefetch_distance = 32;
...
static void libsais_reconstruct_lms_suffixes_omp(sa_sint_t * _RESTRICT SA, sa_sint_t n, sa_sint_t m, sa_sint_t threads)
{
#if defined(LIBSAIS_OPENMP)
    #pragma omp parallel num_threads(threads) if(threads > 1 && m >= 65536)
#endif
...
static void libsais_place_lms_suffixes_interval_8u(sa_sint_t * _RESTRICT SA, sa_sint_t n, sa_sint_t m, const sa_sint_t * _RESTRICT buckets)
{
...
static void libsais_place_lms_suffixes_interval_32s_4k(sa_sint_t * _RESTRICT SA, sa_sint_t n, sa_sint_t k, sa_sint_t m, const sa_sint_t * _RESTRICT buckets)
{
...
static void libsais_place_lms_suffixes_interval_32s_2k(sa_sint_t * _RESTRICT SA, sa_sint_t n, sa_sint_t k, sa_sint_t m, const sa_sint_t * _RESTRICT buckets)
{
	fast_sint_t j = n;
...
static void libsais_place_lms_suffixes_interval_32s_1k(const sa_sint_t * _RESTRICT T, sa_sint_t * _RESTRICT SA, sa_sint_t k, sa_sint_t m, sa_sint_t * _RESTRICT buckets)
{
	const fast_sint_t prefetch_distance = 32;
...
static void libsais_place_lms_suffixes_histogram_32s_6k(sa_sint_t * _RESTRICT SA, sa_sint_t n, sa_sint_t k, sa_sint_t m, const sa_sint_t * _RESTRICT buckets)
{
...
static void libsais_place_lms_suffixes_histogram_32s_4k(sa_sint_t * _RESTRICT SA, sa_sint_t n, sa_sint_t k, sa_sint_t m, const sa_sint_t * _RESTRICT buckets)
{
	const sa_sint_t * _RESTRICT bucket_end = &buckets[3 * (fast_sint_t)k];
	fast_sint_t c, j = n;
	for(c = (fast_sint_t)k - 2; c >= 0; --c) {
...
static void libsais_place_lms_suffixes_histogram_32s_2k(sa_sint_t * _RESTRICT SA, sa_sint_t n, sa_sint_t k, sa_sint_t m, const sa_sint_t * _RESTRICT buckets)
{
	fast_sint_t j = n;
...
static void libsais_final_bwt_scan_left_to_right_8u(const uint8 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT induction_bucket,
    fast_sint_t omp_block_start,
    fast_sint_t omp_block_size)
{
	...
	for(i = omp_block_start, j = omp_block_start + omp_block_size-prefetch_distance-1; i < j; i += 2) {
		...
		sa_sint_t s0 = SA[i + prefetch_distance + 0]; const uint8 * Ts0 = &T[s0] - 1; libsais_prefetchr(s0 > 0 ? Ts0 : NULL); Ts0--;
		libsais_prefetchr(s0 > 0 ? Ts0 : NULL);
		sa_sint_t s1 = SA[i + prefetch_distance + 1]; const uint8 * Ts1 = &T[s1] - 1; libsais_prefetchr(s1 > 0 ? Ts1 : NULL); Ts1--;
		libsais_prefetchr(s1 > 0 ? Ts1 : NULL);
...
static void libsais_final_bwt_aux_scan_left_to_right_8u(const uint8 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t rm,
...
static void libsais_final_sorting_scan_left_to_right_8u(const uint8 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT induction_bucket,
    fast_sint_t omp_block_start,
    fast_sint_t omp_block_size)
{
	...
	for(i = omp_block_start, j = omp_block_start + omp_block_size-prefetch_distance-1; i < j; i += 2) {
		...
		sa_sint_t p0 = SA[i + 0]; SA[i + 0] = p0 ^ SAINT_MIN; 
		if(p0 > 0) {
			p0--; SA[induction_bucket[T[p0]]++] = p0 | ((sa_sint_t)(T[p0 - (p0 > 0)] < T[p0]) << (SAINT_BIT - 1));
		}
		sa_sint_t p1 = SA[i + 1]; SA[i + 1] = p1 ^ SAINT_MIN; 
		if(p1 > 0) {
	...
	for(j += prefetch_distance + 1; i < j; i += 1) {
		sa_sint_t p = SA[i]; SA[i] = p ^ SAINT_MIN; 
		if(p > 0) {
...
static void libsais_final_sorting_scan_left_to_right_32s(const sa_sint_t * _RESTRICT T, sa_sint_t * _RESTRICT SA, sa_sint_t * _RESTRICT induction_bucket,
    fast_sint_t omp_block_start, fast_sint_t omp_block_size)
{
	const fast_sint_t prefetch_distance = 32;
	fast_sint_t i, j;
...
static fast_sint_t libsais_final_bwt_scan_left_to_right_8u_block_prepare(const uint8 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT buckets,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t omp_block_start,
...
static fast_sint_t libsais_final_sorting_scan_left_to_right_8u_block_prepare(const uint8 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT buckets,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t omp_block_start,
...
static void libsais_final_order_scan_left_to_right_8u_block_place(sa_sint_t * _RESTRICT SA, sa_sint_t * _RESTRICT buckets, LIBSAIS_THREAD_CACHE * _RESTRICT cache, fast_sint_t count)
{
	const fast_sint_t prefetch_distance = 32;
...
static void libsais_final_bwt_aux_scan_left_to_right_8u_block_place(sa_sint_t * _RESTRICT SA,
    sa_sint_t rm,
    sa_sint_t * _RESTRICT I,
    sa_sint_t * _RESTRICT buckets,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
...
static void libsais_final_sorting_scan_left_to_right_32s_block_gather(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t omp_block_start,
    fast_sint_t omp_block_size)
{
	...
	for(i = omp_block_start, j = omp_block_start + omp_block_size-prefetch_distance-1; i < j; i += 2) {
		...
		sa_sint_t symbol0 = SAINT_MIN, p0 = SA[i + 0]; SA[i + 0] = p0 ^ SAINT_MIN; 
		if(p0 > 0) {
			p0--; cache[i + 0].index = p0 | ((sa_sint_t)(T[p0 - (p0 > 0)] < T[p0]) << (SAINT_BIT - 1)); symbol0 = T[p0];
		}
		cache[i + 0].symbol = symbol0;
		sa_sint_t symbol1 = SAINT_MIN, p1 = SA[i + 1]; SA[i + 1] = p1 ^ SAINT_MIN; 
		if(p1 > 0) {
	...
	for(j += prefetch_distance + 1; i < j; i += 1) {
		sa_sint_t symbol = SAINT_MIN, p = SA[i]; SA[i] = p ^ SAINT_MIN; 
		if(p > 0) {
...
static void libsais_final_sorting_scan_left_to_right_32s_block_sort(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT induction_bucket,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t omp_block_start,
    fast_sint_t omp_block_size)
{
	...
	for(i = omp_block_start, j = omp_block_end-prefetch_distance-1; i < j; i += 2) {
		...
		if(v0 >= 0) {
			cache[i + 0].symbol = induction_bucket[v0]++;
			if(cache[i + 0].symbol < omp_block_end) {
				sa_sint_t ni = cache[i + 0].symbol, np = cache[i + 0].index; cache[i + 0].index = np ^ SAINT_MIN; 
				if(np > 0) {
		...
		if(v1 >= 0) {
			cache[i + 1].symbol = induction_bucket[v1]++;
			if(cache[i + 1].symbol < omp_block_end) {
				sa_sint_t ni = cache[i + 1].symbol, np = cache[i + 1].index; cache[i + 1].index = np ^ SAINT_MIN; 
				if(np > 0) {
					np--; cache[ni].index = np | ((sa_sint_t)(T[np - (np > 0)] < T[np]) << (SAINT_BIT - 1)); cache[ni].symbol = T[np];
				}
			}
	...
	for(j += prefetch_distance + 1; i < j; i += 1) {
		...
		if(v >= 0) {
			cache[i].symbol = induction_bucket[v]++;
			if(cache[i].symbol < omp_block_end) {
				sa_sint_t ni = cache[i].symbol, np = cache[i].index; cache[i].index = np ^ SAINT_MIN; 
				if(np > 0) {
					np--; cache[ni].index = np | ((sa_sint_t)(T[np - (np > 0)] < T[np]) << (SAINT_BIT - 1)); cache[ni].symbol = T[np];
				}
			}
...
static void libsais_final_bwt_scan_left_to_right_8u_block_omp(const uint8 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT induction_bucket,
    fast_sint_t block_start,
    fast_sint_t block_size,
    ...
    LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
...
#endif
	{
		...
		if(omp_num_threads == 1) {
			...
			{
				thread_state[omp_thread_num].state.count = libsais_final_bwt_scan_left_to_right_8u_block_prepare(T,
					SA,
					thread_state[omp_thread_num].state.buckets,
					thread_state[omp_thread_num].state.cache,
					omp_block_start,
	    ...
	    #pragma omp barrier
			...
			{
				libsais_final_order_scan_left_to_right_8u_block_place(SA,
				    thread_state[omp_thread_num].state.buckets,
				    thread_state[omp_thread_num].state.cache,
				    thread_state[omp_thread_num].state.count);
			}
...
static void libsais_final_bwt_aux_scan_left_to_right_8u_block_omp(const uint8 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t rm,
    sa_sint_t * _RESTRICT I,
    sa_sint_t * _RESTRICT induction_bucket,
    ...
    LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
...
#endif
	{
	    ...
	    #pragma omp barrier
			...
			{
				libsais_final_bwt_aux_scan_left_to_right_8u_block_place(SA,
				    rm,
				    I,
				    thread_state[omp_thread_num].state.buckets,
				    thread_state[omp_thread_num].state.cache,
...
static void libsais_final_sorting_scan_left_to_right_8u_block_omp(const uint8 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT induction_bucket,
    fast_sint_t block_start,
    fast_sint_t block_size,
    ...
    LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
...
#endif
	{
		...
		if(omp_num_threads == 1) {
			...
			{
				thread_state[omp_thread_num].state.count = libsais_final_sorting_scan_left_to_right_8u_block_prepare(T,
					SA,
					thread_state[omp_thread_num].state.buckets,
					thread_state[omp_thread_num].state.cache,
					omp_block_start,
...
static void libsais_final_sorting_scan_left_to_right_32s_block_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT buckets,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t block_start,
...
static void libsais_final_bwt_scan_left_to_right_8u_omp(const uint8 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    fast_sint_t n,
    sa_sint_t * _RESTRICT induction_bucket,
    sa_sint_t threads,
	...
	if(threads == 1 || n < 65536) {
		...
		for(block_start = 0; block_start < n;) {
			if(SA[block_start] == 0) {
				...
				if(block_size < 32) {
					for(; block_start < block_end; block_start += 1) {
						sa_sint_t p = SA[block_start]; SA[block_start] = p & SAINT_MAX; 
						if(p > 0) {
...
static void libsais_final_bwt_aux_scan_left_to_right_8u_omp(const uint8 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    fast_sint_t n,
    sa_sint_t rm,
    sa_sint_t * _RESTRICT I,
...
static void libsais_final_sorting_scan_left_to_right_8u_omp(const uint8 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    fast_sint_t n,
    sa_sint_t * _RESTRICT induction_bucket,
    sa_sint_t threads,
	...
	if(threads == 1 || n < 65536) {
		...
		for(block_start = 0; block_start < n;) {
			if(SA[block_start] == 0) {
				...
				if(block_size < 32) {
					for(; block_start < block_end; block_start += 1) {
						sa_sint_t p = SA[block_start]; SA[block_start] = p ^ SAINT_MIN; 
						if(p > 0) {
							p--; SA[induction_bucket[T[p]]++] = p | ((sa_sint_t)(T[p - (p > 0)] < T[p]) << (SAINT_BIT - 1));
						}
					}
...
static void libsais_final_sorting_scan_left_to_right_32s_omp(const sa_sint_t * _RESTRICT T, sa_sint_t * _RESTRICT SA,
    sa_sint_t n, sa_sint_t * _RESTRICT induction_bucket, sa_sint_t threads, LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
...
static sa_sint_t libsais_final_bwt_scan_right_to_left_8u(const uint8 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT induction_bucket,
    fast_sint_t omp_block_start,
    fast_sint_t omp_block_size)
{
	...
	for(i = omp_block_start + omp_block_size - 1, j = omp_block_start + prefetch_distance + 1; i >= j; i -= 2) {
		...
		SA[i - 0] = p0 & SAINT_MAX; 
		if(p0 > 0) {
			p0--; uint8 c0 = T[p0 - (p0 > 0)], c1 = T[p0]; SA[i - 0] = c1; sa_sint_t t = c0 | SAINT_MIN; SA[--induction_bucket[c1]] = (c0 <= c1) ? p0 : t;
		}

		sa_sint_t p1 = SA[i - 1]; index = (p1 == 0) ? (sa_sint_t)(i - 1) : index;
		SA[i - 1] = p1 & SAINT_MAX; 
		if(p1 > 0) {
			p1--; uint8 c0 = T[p1 - (p1 > 0)], c1 = T[p1]; SA[i - 1] = c1; sa_sint_t t = c0 | SAINT_MIN; SA[--induction_bucket[c1]] = (c0 <= c1) ? p1 : t;
		}
	}
	...
	for(j -= prefetch_distance + 1; i >= j; i -= 1) {
		...
		SA[i] = p & SAINT_MAX; 
		if(p > 0) {
			p--; uint8 c0 = T[p - (p > 0)], c1 = T[p]; SA[i] = c1; sa_sint_t t = c0 | SAINT_MIN; SA[--induction_bucket[c1]] = (c0 <= c1) ? p : t;
		}
	}
...
static void libsais_final_bwt_aux_scan_right_to_left_8u(const uint8 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t rm,
    sa_sint_t * _RESTRICT I,
    sa_sint_t * _RESTRICT induction_bucket,
    ...
    fast_sint_t omp_block_size)
{
	...
	for(j -= prefetch_distance + 1; i >= j; i -= 1) {
		...
		if(p > 0) {
			p--; 
			uint8 c0 = T[p - (p > 0)], c1 = T[p]; SA[i] = c1; sa_sint_t t = c0 | SAINT_MIN; SA[--induction_bucket[c1]] = (c0 <= c1) ? p : t; 
			if((p & rm) == 0) {
...
static void libsais_final_sorting_scan_right_to_left_8u(const uint8 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT induction_bucket,
    fast_sint_t omp_block_start,
    fast_sint_t omp_block_size)
...
static void libsais_final_sorting_scan_right_to_left_32s(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT induction_bucket,
    fast_sint_t omp_block_start,
    fast_sint_t omp_block_size)
...
static fast_sint_t libsais_final_bwt_scan_right_to_left_8u_block_prepare(const uint8 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA, sa_sint_t * _RESTRICT buckets, LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t omp_block_start, fast_sint_t omp_block_size)
{
	const fast_sint_t prefetch_distance = 32;
	...
	for(i = omp_block_start + omp_block_size - 1, j = omp_block_start + prefetch_distance + 1; i >= j; i -= 2) {
		...
		sa_sint_t p0 = SA[i - 0]; SA[i - 0] = p0 & SAINT_MAX; 
		if(p0 > 0) {
			p0--; uint8 c0 = T[p0 - (p0 > 0)], c1 = T[p0]; SA[i - 0] = c1; sa_sint_t t = c0 | SAINT_MIN; buckets[cache[count].symbol = c1]++;
			cache[count++].index = (c0 <= c1) ? p0 : t;
		}
		sa_sint_t p1 = SA[i - 1]; SA[i - 1] = p1 & SAINT_MAX; 
		if(p1 > 0) {
			p1--; uint8 c0 = T[p1 - (p1 > 0)], c1 = T[p1]; SA[i - 1] = c1; sa_sint_t t = c0 | SAINT_MIN; buckets[cache[count].symbol = c1]++;
	...
	for(j -= prefetch_distance + 1; i >= j; i -= 1) {
		sa_sint_t p = SA[i]; SA[i] = p & SAINT_MAX; 
		if(p > 0) {
			p--; uint8 c0 = T[p - (p > 0)], c1 = T[p]; SA[i] = c1; sa_sint_t t = c0 | SAINT_MIN; buckets[cache[count].symbol = c1]++;
...
static fast_sint_t libsais_final_bwt_aux_scan_right_to_left_8u_block_prepare(const uint8 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA, sa_sint_t * _RESTRICT buckets, LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t omp_block_start, fast_sint_t omp_block_size)
{
	const fast_sint_t prefetch_distance = 32;
...
static fast_sint_t libsais_final_sorting_scan_right_to_left_8u_block_prepare(const uint8 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA, sa_sint_t * _RESTRICT buckets, LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t omp_block_start, fast_sint_t omp_block_size)
{
	const fast_sint_t prefetch_distance = 32;
...
static void libsais_final_order_scan_right_to_left_8u_block_place(sa_sint_t * _RESTRICT SA, sa_sint_t * _RESTRICT buckets, LIBSAIS_THREAD_CACHE * _RESTRICT cache, fast_sint_t count)
{
	const fast_sint_t prefetch_distance = 32;
	fast_sint_t i, j;
	for(i = 0, j = count - 3; i < j; i += 4) {
...
static void libsais_final_bwt_aux_scan_right_to_left_8u_block_place(sa_sint_t * _RESTRICT SA,
    sa_sint_t rm, sa_sint_t * _RESTRICT I, sa_sint_t * _RESTRICT buckets, LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t count)
{
	const fast_sint_t prefetch_distance = 32;
	fast_sint_t i, j;
...
static void libsais_final_sorting_scan_right_to_left_32s_block_gather(const sa_sint_t * _RESTRICT T, sa_sint_t * _RESTRICT SA,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache, fast_sint_t omp_block_start, fast_sint_t omp_block_size)
{
	const fast_sint_t prefetch_distance = 32;
	fast_sint_t i, j;
	for(i = omp_block_start, j = omp_block_start + omp_block_size-prefetch_distance-1; i < j; i += 2) {
		...
		sa_sint_t symbol0 = SAINT_MIN, p0 = SA[i + 0]; SA[i + 0] = p0 & SAINT_MAX; 
		if(p0 > 0) {
			p0--; cache[i + 0].index = p0 | ((sa_sint_t)(T[p0 - (p0 > 0)] > T[p0]) << (SAINT_BIT - 1)); symbol0 = T[p0];
		}
		cache[i + 0].symbol = symbol0;
		sa_sint_t symbol1 = SAINT_MIN, p1 = SA[i + 1]; SA[i + 1] = p1 & SAINT_MAX; 
		if(p1 > 0) {
			p1--; cache[i + 1].index = p1 | ((sa_sint_t)(T[p1 - (p1 > 0)] > T[p1]) << (SAINT_BIT - 1)); symbol1 = T[p1];
		}
		cache[i + 1].symbol = symbol1;
	...
	for(j += prefetch_distance + 1; i < j; i += 1) {
		sa_sint_t symbol = SAINT_MIN, p = SA[i]; SA[i] = p & SAINT_MAX; 
		if(p > 0) {
			p--; cache[i].index = p | ((sa_sint_t)(T[p - (p > 0)] > T[p]) << (SAINT_BIT - 1)); symbol = T[p];
		}
		cache[i].symbol = symbol;
...
static void libsais_final_sorting_scan_right_to_left_32s_block_sort(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT induction_bucket,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t omp_block_start,
    fast_sint_t omp_block_size)
{
	...
	for(i = omp_block_start + omp_block_size - 1, j = omp_block_start + prefetch_distance + 1; i >= j; i -= 2) {
		...
		if(v0 >= 0) {
			cache[i - 0].symbol = --induction_bucket[v0];
			if(cache[i - 0].symbol >= omp_block_start) {
				sa_sint_t ni = cache[i - 0].symbol, np = cache[i - 0].index; cache[i - 0].index = np & SAINT_MAX; 
				if(np > 0) {
					np--; cache[ni].index = np | ((sa_sint_t)(T[np - (np > 0)] > T[np]) << (SAINT_BIT - 1)); cache[ni].symbol = T[np];
				}
			}
		...
		if(v1 >= 0) {
			cache[i - 1].symbol = --induction_bucket[v1];
			if(cache[i - 1].symbol >= omp_block_start) {
				sa_sint_t ni = cache[i - 1].symbol, np = cache[i - 1].index; cache[i - 1].index = np & SAINT_MAX; 
				if(np > 0) {
					np--; cache[ni].index = np | ((sa_sint_t)(T[np - (np > 0)] > T[np]) << (SAINT_BIT - 1)); cache[ni].symbol = T[np];
				}
			}
	...
	for(j -= prefetch_distance + 1; i >= j; i -= 1) {
		...
		if(v >= 0) {
			cache[i].symbol = --induction_bucket[v];
			if(cache[i].symbol >= omp_block_start) {
				sa_sint_t ni = cache[i].symbol, np = cache[i].index; cache[i].index = np & SAINT_MAX; 
				if(np > 0) {
					np--; cache[ni].index = np | ((sa_sint_t)(T[np - (np > 0)] > T[np]) << (SAINT_BIT - 1)); cache[ni].symbol = T[np];
				}
			}
...
static void libsais_final_bwt_scan_right_to_left_8u_block_omp(const uint8 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT induction_bucket,
    fast_sint_t block_start,
    fast_sint_t block_size,
    ...
    LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
...
#endif
	{
		...
		if(omp_num_threads == 1) {
			...
			{
				thread_state[omp_thread_num].state.count = libsais_final_bwt_scan_right_to_left_8u_block_prepare(T,
					SA,
					thread_state[omp_thread_num].state.buckets,
					thread_state[omp_thread_num].state.cache,
					omp_block_start,
	    ...
	    #pragma omp barrier
			...
			{
				libsais_final_order_scan_right_to_left_8u_block_place(SA,
				    thread_state[omp_thread_num].state.buckets,
				    thread_state[omp_thread_num].state.cache,
				    thread_state[omp_thread_num].state.count);
			}
...
static void libsais_final_bwt_aux_scan_right_to_left_8u_block_omp(const uint8 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t rm,
    sa_sint_t * _RESTRICT I,
    sa_sint_t * _RESTRICT induction_bucket,
    ...
    LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
...
#endif
	{
		...
		if(omp_num_threads == 1) {
			...
			{
				thread_state[omp_thread_num].state.count = libsais_final_bwt_aux_scan_right_to_left_8u_block_prepare(T,
					SA,
					thread_state[omp_thread_num].state.buckets,
					thread_state[omp_thread_num].state.cache,
					omp_block_start,
	    ...
	    #pragma omp barrier
			...
			{
				libsais_final_bwt_aux_scan_right_to_left_8u_block_place(SA,
				    rm,
				    I,
				    thread_state[omp_thread_num].state.buckets,
				    thread_state[omp_thread_num].state.cache,
...
static void libsais_final_sorting_scan_right_to_left_8u_block_omp(const uint8 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT induction_bucket,
    fast_sint_t block_start,
    fast_sint_t block_size,
    ...
    LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
...
#endif
	{
		...
		if(omp_num_threads == 1) {
			...
			{
				thread_state[omp_thread_num].state.count = libsais_final_sorting_scan_right_to_left_8u_block_prepare(T,
					SA,
					thread_state[omp_thread_num].state.buckets,
					thread_state[omp_thread_num].state.cache,
					omp_block_start,
...
static void libsais_final_sorting_scan_right_to_left_32s_block_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT buckets,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t block_start,
...
static sa_sint_t libsais_final_bwt_scan_right_to_left_8u_omp(const uint8 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t * _RESTRICT induction_bucket,
    sa_sint_t threads,
			...
			if(SA[block_start] == 0) {
				...
				if(block_size < 32) {
					for(; block_start > block_end; block_start -= 1) {
						sa_sint_t p = SA[block_start]; SA[block_start] = p & SAINT_MAX; 
						if(p > 0) {
							p--; uint8 c0 = T[p - (p > 0)], c1 = T[p]; SA[block_start] = c1; sa_sint_t t = c0 | SAINT_MIN;
...
static void libsais_final_bwt_aux_scan_right_to_left_8u_omp(const uint8 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t rm,
    sa_sint_t * _RESTRICT I,
...
static void libsais_final_sorting_scan_right_to_left_8u_omp(const uint8 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t * _RESTRICT induction_bucket,
    sa_sint_t threads,
...
static void libsais_final_sorting_scan_right_to_left_32s_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t * _RESTRICT induction_bucket,
    sa_sint_t threads,
    LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
	if(threads == 1 || n < 65536) {
		...
		for(block_start = (fast_sint_t)n - 1; block_start >= 0; block_start = block_end) {
			...
			libsais_final_sorting_scan_right_to_left_32s_block_omp(T, SA, induction_bucket, thread_state[0].state.cache, block_end + 1, block_start - block_end,
			    threads);
		}
	}
#else
...
static void libsais_clear_lms_suffixes_omp(sa_sint_t * _RESTRICT SA, sa_sint_t n, sa_sint_t k, sa_sint_t * _RESTRICT bucket_start, sa_sint_t * _RESTRICT bucket_end, sa_sint_t threads)
{
	fast_sint_t c;
...
static sa_sint_t libsais_induce_final_order_8u_omp(const uint8 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t bwt,
    sa_sint_t r,
...
static void libsais_induce_final_order_32s_6k(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t k,
    sa_sint_t * _RESTRICT buckets,
...
static void libsais_induce_final_order_32s_4k(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t k,
    sa_sint_t * _RESTRICT buckets,
...
static void libsais_induce_final_order_32s_2k(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t k,
    sa_sint_t * _RESTRICT buckets,
...
static void libsais_induce_final_order_32s_1k(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t k,
    sa_sint_t * _RESTRICT buckets,
...
static sa_sint_t libsais_renumber_unique_and_nonunique_lms_suffixes_32s(sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t m,
    sa_sint_t f,
    fast_sint_t omp_block_start,
    fast_sint_t omp_block_size)
{
	...
	for(i = (sa_sint_t)omp_block_start, j = (sa_sint_t)omp_block_start + (sa_sint_t)omp_block_size - 2 * (sa_sint_t)prefetch_distance - 3; i < j; i += 4) {
		...
		sa_uint_t p0 = (sa_uint_t)SA[i + 0]; sa_sint_t s0 = SAm[p0 >> 1]; 
		if(s0 < 0) {
			T[p0] |= SAINT_MIN; f++; s0 = i + 0 + SAINT_MIN + f;
		}
		SAm[p0 >> 1] = s0 - f;
		sa_uint_t p1 = (sa_uint_t)SA[i + 1]; sa_sint_t s1 = SAm[p1 >> 1]; 
		if(s1 < 0) {
			T[p1] |= SAINT_MIN; f++; s1 = i + 1 + SAINT_MIN + f;
		}
		SAm[p1 >> 1] = s1 - f;
		sa_uint_t p2 = (sa_uint_t)SA[i + 2]; sa_sint_t s2 = SAm[p2 >> 1]; 
		if(s2 < 0) {
			T[p2] |= SAINT_MIN; f++; s2 = i + 2 + SAINT_MIN + f;
		}
		SAm[p2 >> 1] = s2 - f;
		sa_uint_t p3 = (sa_uint_t)SA[i + 3]; sa_sint_t s3 = SAm[p3 >> 1]; 
		if(s3 < 0) {
	...
	for(j += 2 * (sa_sint_t)prefetch_distance + 3; i < j; i += 1) {
		sa_uint_t p = (sa_uint_t)SA[i]; sa_sint_t s = SAm[p >> 1]; 
		if(s < 0) {
...
static void libsais_compact_unique_and_nonunique_lms_suffixes_32s(sa_sint_t * _RESTRICT SA,
    sa_sint_t m,
    fast_sint_t * pl,
    fast_sint_t * pr,
    fast_sint_t omp_block_start,
...
static sa_sint_t libsais_count_unique_suffixes(sa_sint_t * _RESTRICT SA, sa_sint_t m, fast_sint_t omp_block_start, fast_sint_t omp_block_size)
{
	const fast_sint_t prefetch_distance = 32;
...
static sa_sint_t libsais_renumber_unique_and_nonunique_lms_suffixes_32s_omp(sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t m,
    sa_sint_t threads,
    LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
...
static void libsais_compact_unique_and_nonunique_lms_suffixes_32s_omp(sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t m,
    sa_sint_t fs,
    sa_sint_t f,
...
#endif
	{
		...
		if(omp_num_threads == 1) {
		...
		else {
			{
				...
				libsais_compact_unique_and_nonunique_lms_suffixes_32s(SA,
				    m,
...
static sa_sint_t libsais_compact_lms_suffixes_32s_omp(sa_sint_t * _RESTRICT T, sa_sint_t * _RESTRICT SA, sa_sint_t n, sa_sint_t m,
    sa_sint_t fs, sa_sint_t threads, LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
...
static void libsais_merge_unique_lms_suffixes_32s(sa_sint_t * _RESTRICT T, sa_sint_t * _RESTRICT SA, sa_sint_t n, sa_sint_t m,
...
static void libsais_merge_nonunique_lms_suffixes_32s(sa_sint_t * _RESTRICT SA, sa_sint_t n, sa_sint_t m, fast_sint_t l, fast_sint_t omp_block_start, fast_sint_t omp_block_size)
{
	const fast_sint_t prefetch_distance = 32;
...
static void libsais_merge_unique_lms_suffixes_32s_omp(sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t m,
    sa_sint_t threads,
...
static void libsais_merge_nonunique_lms_suffixes_32s_omp(sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t m,
    sa_sint_t f,
    sa_sint_t threads,
...
static void libsais_merge_compacted_lms_suffixes_32s_omp(sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t m,
    sa_sint_t f,
...
static void libsais_reconstruct_compacted_lms_suffixes_32s_2k_omp(sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t k,
    sa_sint_t m,
...
static void libsais_reconstruct_compacted_lms_suffixes_32s_1k_omp(sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA, sa_sint_t n, sa_sint_t m, sa_sint_t fs, sa_sint_t f,
    sa_sint_t threads, LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
	if(f > 0) {
		memmove(&SA[n - m - 1], &SA[n + fs - m], (size_t)f * sizeof(sa_sint_t));
...
static sa_sint_t libsais_main_32s(sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t k,
    sa_sint_t fs,
    ...
    LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
	...
	if(k > 0 && fs / k >= 6) {
		...
		sa_sint_t * _RESTRICT buckets = (fs - alignment) / k >=
		    6 ? (sa_sint_t *)libsais_align_up(&SA[n + fs - 6 * (fast_sint_t)k - alignment], (size_t)alignment * sizeof(sa_sint_t)) : &SA[n + fs - 6 * (fast_sint_t)k];
		...
		sa_sint_t * _RESTRICT buckets = (fs - alignment) / k >=
		    4 ? (sa_sint_t *)libsais_align_up(&SA[n + fs - 4 * (fast_sint_t)k - alignment], (size_t)alignment * sizeof(sa_sint_t)) : &SA[n + fs - 4 * (fast_sint_t)k];
		...
		sa_sint_t * _RESTRICT buckets = (fs - alignment) / k >= 2 ? 
			(sa_sint_t *)libsais_align_up(&SA[n + fs - 2 * (fast_sint_t)k - alignment], (size_t)alignment * sizeof(sa_sint_t)) : &SA[n + fs - 2 * (fast_sint_t)k];
		sa_sint_t m = libsais_count_and_gather_lms_suffixes_32s_2k_omp(T, SA, n, k, buckets, threads, thread_state);
		if(m > 1) {
		...
		sa_sint_t * _RESTRICT buckets = fs - alignment >= k ? 
			(sa_sint_t *)libsais_align_up(&SA[n + fs - k - alignment], (size_t)alignment * sizeof(sa_sint_t)) : fs >= k ? &SA[n + fs - k] : buffer;
		if(!buckets) {
			return -2;
		}
		...
		if(m > 1) {
			...
			if(names < m) {
				if(buffer) {
					libsais_free_aligned(buffer); buckets = NULL;
				}
				sa_sint_t f = libsais_compact_lms_suffixes_32s_omp(T, SA, n, m, fs, threads, thread_state);
				if(libsais_main_32s(SA + n + fs - m + f, SA, m - f, names - f, fs + n - 2 * m + f, threads, thread_state) != 0) {
					return -2;
...
static sa_sint_t libsais_main_8u(const uint8 * T, sa_sint_t * SA, sa_sint_t n,
    sa_sint_t * _RESTRICT buckets, sa_sint_t bwt, sa_sint_t r, sa_sint_t * _RESTRICT I,
    sa_sint_t fs, sa_sint_t * freq, sa_sint_t threads, LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
	fs = fs < (SAINT_MAX - n) ? fs : (SAINT_MAX - n);
...
static sa_sint_t libsais_main(const uint8 * T, sa_sint_t * SA, sa_sint_t n, sa_sint_t bwt, sa_sint_t r, sa_sint_t * I, sa_sint_t fs, sa_sint_t * freq, sa_sint_t threads)
{
	LIBSAIS_THREAD_STATE *  _RESTRICT thread_state   = threads > 1 ? libsais_alloc_thread_state(threads) : NULL;
	sa_sint_t *             _RESTRICT buckets        = (sa_sint_t *)libsais_alloc_aligned(8 * ALPHABET_SIZE * sizeof(sa_sint_t), 4096);
	sa_sint_t index = buckets != NULL && (thread_state != NULL || threads == 1) ? 
		libsais_main_8u(T, SA, n, buckets, bwt, r, I, fs, freq, threads, thread_state) : -2;
	libsais_free_aligned(buckets);
	libsais_free_thread_state(thread_state);
	return index;
}
...
static void libsais_bwt_copy_8u(uint8 * _RESTRICT U, sa_sint_t * _RESTRICT A, sa_sint_t n)
{
	const fast_sint_t prefetch_distance = 32;
...
static void libsais_bwt_copy_8u_omp(uint8 * _RESTRICT U, sa_sint_t * _RESTRICT A, sa_sint_t n, sa_sint_t threads)
{
#if defined(LIBSAIS_OPENMP)
    #pragma omp parallel num_threads(threads) if(threads > 1 && n >= 65536)
#endif
...
{
	LIBSAIS_UNBWT_CONTEXT *     _RESTRICT ctx            = (LIBSAIS_UNBWT_CONTEXT *)libsais_alloc_aligned(sizeof(LIBSAIS_UNBWT_CONTEXT), 64);
	sa_uint_t *                 _RESTRICT bucket2        = (sa_uint_t *)libsais_alloc_aligned(ALPHABET_SIZE * ALPHABET_SIZE * sizeof(sa_uint_t), 4096);
	uint16 *                  _RESTRICT fastbits       = (uint16 *)libsais_alloc_aligned((1 + (1 << UNBWT_FASTBITS)) * sizeof(uint16), 4096);
	sa_uint_t *                 _RESTRICT buckets        = threads > 1 ? (sa_uint_t *)libsais_alloc_aligned(
		(size_t)threads * (ALPHABET_SIZE + (ALPHABET_SIZE * ALPHABET_SIZE)) * sizeof(sa_uint_t), 4096) : NULL;
...
static void libsais_unbwt_compute_histogram(const uint8 * _RESTRICT T, fast_sint_t n, sa_uint_t * _RESTRICT count)
{
	...
	if(n >= 1024) {
		...
		for(; T_p < (uint8 *)((ptrdiff_t)(T + 63) & (-64)); T_p += 1) {
			copy0[T_p[0]]++;
		}
		fast_uint_t x = ((const uint32_t *)(const void *)T_p)[0], y = ((const uint32_t *)(const void *)T_p)[1];
		for(; T_p < (uint8 *)((ptrdiff_t)(T + n - 8) & (-64)); T_p += 64) {
			libsais_prefetchr(&T_p[prefetch_distance]);

			fast_uint_t z = ((const uint32_t *)(const void *)T_p)[2], w = ((const uint32_t *)(const void *)T_p)[3];
			copy0[(uint8)x]++; x >>= 8; copy1[(uint8)x]++; x >>= 8; copy2[(uint8)x]++; x >>= 8; copy3[x]++;
			copy0[(uint8)y]++; y >>= 8; copy1[(uint8)y]++; y >>= 8; copy2[(uint8)y]++; y >>= 8; copy3[y]++;

			x = ((const uint32_t *)(const void *)T_p)[4]; y = ((const uint32_t *)(const void *)T_p)[5];
			copy0[(uint8)z]++; z >>= 8; copy1[(uint8)z]++; z >>= 8; copy2[(uint8)z]++; z >>= 8; copy3[z]++;
			copy0[(uint8)w]++; w >>= 8; copy1[(uint8)w]++; w >>= 8; copy2[(uint8)w]++; w >>= 8; copy3[w]++;
...
static void libsais_unbwt_transpose_bucket2(sa_uint_t * _RESTRICT bucket2)
{
	fast_uint_t c;
	for(fast_uint_t x = 0; x != ALPHABET_SIZE; x += 16) {
		for(c = x; c != x + 16; ++c) {
			for(fast_uint_t d = c + 1; d != x + 16; ++d) {
				sa_uint_t tmp = bucket2[(d << 8) + c]; bucket2[(d << 8) + c] = bucket2[(c << 8) + d]; bucket2[(c << 8) + d] = tmp;
			}
		}
		for(fast_uint_t y = x + 16; y != ALPHABET_SIZE; y += 16) {
			for(c = x; c != x + 16; ++c) {
...
static void libsais_unbwt_compute_bigram_histogram_single(const uint8 * _RESTRICT T, sa_uint_t * _RESTRICT bucket1, sa_uint_t * _RESTRICT bucket2, fast_uint_t index)
{
	fast_uint_t sum, c;
...
static void libsais_unbwt_calculate_fastbits(sa_uint_t * _RESTRICT bucket2, uint16 * _RESTRICT fastbits, fast_uint_t lastc, fast_uint_t shift)
{
...
static void libsais_unbwt_calculate_biPSI(const uint8 * _RESTRICT T, sa_uint_t * _RESTRICT P, sa_uint_t * _RESTRICT bucket1, sa_uint_t * _RESTRICT bucket2,
    fast_uint_t index, fast_sint_t omp_block_start, fast_sint_t omp_block_end)
{
	{
		fast_sint_t i = omp_block_start;
		fast_sint_t j = (fast_sint_t)index; 
		if(omp_block_end < j) {
			j = omp_block_end;
		}
		for(; i < j; ++i) {
	...
	{
		fast_sint_t i = (fast_sint_t)index;
		fast_sint_t j = omp_block_end; 
...
static void libsais_unbwt_init_single(const uint8 * _RESTRICT T, sa_uint_t * _RESTRICT P, sa_sint_t n, const sa_sint_t * freq,
    const sa_uint_t * _RESTRICT I, sa_uint_t * _RESTRICT bucket2, uint16 * _RESTRICT fastbits)
{
...
static void libsais_unbwt_compute_bigram_histogram_parallel(const uint8 * _RESTRICT T, fast_uint_t index, sa_uint_t * _RESTRICT bucket1,
    sa_uint_t * _RESTRICT bucket2, fast_sint_t omp_block_start, fast_sint_t omp_block_size)
{
	fast_sint_t i;
...
static void libsais_unbwt_init_parallel(const uint8 * _RESTRICT T, sa_uint_t * _RESTRICT P, sa_sint_t n, const sa_sint_t * freq,
    const sa_uint_t * _RESTRICT I, sa_uint_t * _RESTRICT bucket2, uint16 * _RESTRICT fastbits, sa_uint_t * _RESTRICT buckets,
    sa_sint_t threads)
{
	sa_uint_t bucket1[ALPHABET_SIZE];
...
static void libsais_unbwt_decode_1(uint8 * _RESTRICT U, sa_uint_t * _RESTRICT P,
    sa_uint_t * _RESTRICT bucket2, uint16 * _RESTRICT fastbits, fast_uint_t shift,
    fast_uint_t * i0, fast_uint_t k)
{
	uint16 * _RESTRICT U0 = (uint16 *)(void *)U;
	fast_uint_t i, p0 = *i0;
	for(i = 0; i != k; ++i) {
		uint16 c0 = fastbits[p0 >> shift]; 
		if(bucket2[c0] <= p0) {
			do {
				c0++;
			} while(bucket2[c0] <= p0);
		...
		p0 = P[p0]; 
		U0[i] = /*libsais_bswap16*/SMem::CBe(c0);
	}
	*i0 = p0;
}

static void libsais_unbwt_decode_2(uint8 * _RESTRICT U, sa_uint_t * _RESTRICT P,
    sa_uint_t * _RESTRICT bucket2, uint16 * _RESTRICT fastbits, fast_uint_t shift,
    fast_uint_t r, fast_uint_t * i0, fast_uint_t * i1, fast_uint_t k)
{
	uint16 * _RESTRICT U0 = (uint16 *)(void *)U;
	...
	for(i = 0; i != k; ++i) {
		...
		p0 = P[p0]; 
		U0[i] = /*libsais_bswap16*/SMem::CBe(c0);
		uint16 c1 = fastbits[p1 >> shift]; 
		if(bucket2[c1] <= p1) {
			do {
				c1++;
			} while(bucket2[c1] <= p1);
		}
		p1 = P[p1]; U1[i] = /*libsais_bswap16*/SMem::CBe(c1);
	}

	*i0 = p0; *i1 = p1;
}

static void libsais_unbwt_decode_3(uint8 * _RESTRICT U, sa_uint_t * _RESTRICT P, sa_uint_t * _RESTRICT bucket2, uint16 * _RESTRICT fastbits,
    fast_uint_t shift, fast_uint_t r, fast_uint_t * i0, fast_uint_t * i1, fast_uint_t * i2, fast_uint_t k)
{
	uint16 * _RESTRICT U0 = (uint16 *)(void *)U;
	uint16 * _RESTRICT U1 = (uint16 *)(void *)(((uint8 *)U0) + r);
	...
	for(i = 0; i != k; ++i) {
		...
		p0 = P[p0]; U0[i] = /*libsais_bswap16*/SMem::CBe(c0);
		uint16 c1 = fastbits[p1 >> shift]; 
		if(bucket2[c1] <= p1) {
			do {
				c1++;
		...
		p1 = P[p1]; U1[i] = /*libsais_bswap16*/SMem::CBe(c1);
		uint16 c2 = fastbits[p2 >> shift]; 
		if(bucket2[c2] <= p2) {
			do {
				c2++;
			} while(bucket2[c2] <= p2);
		}
		p2 = P[p2]; U2[i] = /*libsais_bswap16*/SMem::CBe(c2);
	}
	*i0 = p0; *i1 = p1; *i2 = p2;
}

static void libsais_unbwt_decode_4(uint8 * _RESTRICT U, sa_uint_t * _RESTRICT P, sa_uint_t * _RESTRICT bucket2, uint16 * _RESTRICT fastbits,
    fast_uint_t shift, fast_uint_t r, fast_uint_t * i0, fast_uint_t * i1, fast_uint_t * i2, fast_uint_t * i3, fast_uint_t k)
{
	uint16 * _RESTRICT U0 = (uint16 *)(void *)U;
	uint16 * _RESTRICT U1 = (uint16 *)(void *)(((uint8 *)U0) + r);
	uint16 * _RESTRICT U2 = (uint16 *)(void *)(((uint8 *)U1) + r);
	...
	for(i = 0; i != k; ++i) {
		...
		p2 = P[p2]; U2[i] = /*libsais_bswap16*/SMem::CBe(c2);
		uint16 c3 = fastbits[p3 >> shift]; 
		if(bucket2[c3] <= p3) {
			do {
				c3++;
			} while(bucket2[c3] <= p3);
		}
		p3 = P[p3]; U3[i] = /*libsais_bswap16*/SMem::CBe(c3);
	}
	*i0 = p0; *i1 = p1; *i2 = p2; *i3 = p3;
}

static void libsais_unbwt_decode_5(uint8 * _RESTRICT U, sa_uint_t * _RESTRICT P, sa_uint_t * _RESTRICT bucket2, uint16 * _RESTRICT fastbits,
    fast_uint_t shift, fast_uint_t r, fast_uint_t * i0, fast_uint_t * i1, fast_uint_t * i2, fast_uint_t * i3, fast_uint_t * i4, fast_uint_t k)
{
	uint16 * _RESTRICT U0 = (uint16 *)(void *)U;
	uint16 * _RESTRICT U1 = (uint16 *)(void *)(((uint8 *)U0) + r);
	uint16 * _RESTRICT U2 = (uint16 *)(void *)(((uint8 *)U1) + r);
	uint16 * _RESTRICT U3 = (uint16 *)(void *)(((uint8 *)U2) + r);
	uint16 * _RESTRICT U4 = (uint16 *)(void *)(((uint8 *)U3) + r);
	...
	for(i = 0; i != k; ++i) {
		...
		p3 = P[p3]; U3[i] = /*libsais_bswap16*/SMem::CBe(c3);
		uint16 c4 = fastbits[p4 >> shift]; 
		if(bucket2[c4] <= p4) {
			do {
				c4++;
			} while(bucket2[c4] <= p4);
		}
		p4 = P[p4]; U4[i] = /*libsais_bswap16*/SMem::CBe(c4);
	}

	*i0 = p0; *i1 = p1; *i2 = p2; *i3 = p3; *i4 = p4;
}

static void libsais_unbwt_decode_6(uint8 * _RESTRICT U, sa_uint_t * _RESTRICT P, sa_uint_t * _RESTRICT bucket2, uint16 * _RESTRICT fastbits,
    fast_uint_t shift, fast_uint_t r, fast_uint_t * i0, fast_uint_t * i1, fast_uint_t * i2, fast_uint_t * i3, fast_uint_t * i4,
    fast_uint_t * i5, fast_uint_t k)
{
	...
	uint16 * _RESTRICT U3 = (uint16 *)(void *)(((uint8 *)U2) + r);
	uint16 * _RESTRICT U4 = (uint16 *)(void *)(((uint8 *)U3) + r);
	uint16 * _RESTRICT U5 = (uint16 *)(void *)(((uint8 *)U4) + r);
	...
	for(i = 0; i != k; ++i) {
		...
		p4 = P[p4]; U4[i] = /*libsais_bswap16*/SMem::CBe(c4);
		uint16 c5 = fastbits[p5 >> shift]; 
		if(bucket2[c5] <= p5) {
			do {
				c5++;
			} while(bucket2[c5] <= p5);
		}
		p5 = P[p5]; U5[i] = /*libsais_bswap16*/SMem::CBe(c5);
	}

	*i0 = p0; *i1 = p1; *i2 = p2; *i3 = p3; *i4 = p4; *i5 = p5;
}

static void libsais_unbwt_decode_7(uint8 * _RESTRICT U, sa_uint_t * _RESTRICT P, sa_uint_t * _RESTRICT bucket2, uint16 * _RESTRICT fastbits,
    fast_uint_t shift, fast_uint_t r, fast_uint_t * i0, fast_uint_t * i1, fast_uint_t * i2, fast_uint_t * i3, fast_uint_t * i4,
    fast_uint_t * i5, fast_uint_t * i6, fast_uint_t k)
{
	...
	uint16 * _RESTRICT U4 = (uint16 *)(void *)(((uint8 *)U3) + r);
	uint16 * _RESTRICT U5 = (uint16 *)(void *)(((uint8 *)U4) + r);
	uint16 * _RESTRICT U6 = (uint16 *)(void *)(((uint8 *)U5) + r);
	...
	for(i = 0; i != k; ++i) {
		...
		p5 = P[p5]; U5[i] = /*libsais_bswap16*/SMem::CBe(c5);
		uint16 c6 = fastbits[p6 >> shift]; 
		if(bucket2[c6] <= p6) {
			do {
				c6++;
			} while(bucket2[c6] <= p6);
		}
		p6 = P[p6]; U6[i] = /*libsais_bswap16*/SMem::CBe(c6);
	}
	*i0 = p0; *i1 = p1; *i2 = p2; *i3 = p3; *i4 = p4; *i5 = p5; *i6 = p6;
}

static void libsais_unbwt_decode_8(uint8 * _RESTRICT U, sa_uint_t * _RESTRICT P, sa_uint_t * _RESTRICT bucket2, uint16 * _RESTRICT fastbits,
    fast_uint_t shift, fast_uint_t r, fast_uint_t * i0, fast_uint_t * i1, fast_uint_t * i2, fast_uint_t * i3, fast_uint_t * i4, fast_uint_t * i5, fast_uint_t * i6,
    fast_uint_t * i7, fast_uint_t k)
{
	...
	uint16 * _RESTRICT U5 = (uint16 *)(void *)(((uint8 *)U4) + r);
	uint16 * _RESTRICT U6 = (uint16 *)(void *)(((uint8 *)U5) + r);
	uint16 * _RESTRICT U7 = (uint16 *)(void *)(((uint8 *)U6) + r);
	...
	for(i = 0; i != k; ++i) {
		...
		p7 = P[p7]; 
		U7[i] = /*libsais_bswap16*/SMem::CBe(c7);
	}
	*i0 = p0; *i1 = p1; *i2 = p2; *i3 = p3; *i4 = p4; *i5 = p5; *i6 = p6; *i7 = p7;
}

static void libsais_unbwt_decode(uint8 * _RESTRICT U, sa_uint_t * _RESTRICT P, sa_sint_t n, sa_sint_t r,
    const sa_uint_t * _RESTRICT I, sa_uint_t * _RESTRICT bucket2, uint16 * _RESTRICT fastbits, fast_sint_t blocks, fast_uint_t remainder)
{
	fast_uint_t shift = 0; 
	...
	if(blocks == 1) {
		...
		libsais_unbwt_decode_4(U + offset + 2 * (remainder >> 1), P, bucket2, fastbits, shift, (fast_uint_t)r, &i0, &i1, &i2, &i3,
		...
		libsais_unbwt_decode_5(U + offset + 2 * (remainder >> 1), P, bucket2, fastbits, shift, (fast_uint_t)r, &i0, &i1, &i2, &i3, &i4,
		    ((fast_uint_t)r >> 1) - (remainder >> 1));
	}
	else if(blocks == 7) {
		...
		libsais_unbwt_decode_6(U + offset + 2 * (remainder >> 1), P, bucket2, fastbits, shift, (fast_uint_t)r, &i0, &i1, &i2, &i3, &i4, &i5,
		    ((fast_uint_t)r >> 1) - (remainder >> 1));
	}
	else {
		fast_uint_t i0 = I[0], i1 = I[1], i2 = I[2], i3 = I[3], i4 = I[4], i5 = I[5], i6 = I[6], i7 = I[7];
		libsais_unbwt_decode_8(U + offset, P, bucket2, fastbits, shift, (fast_uint_t)r, &i0, &i1, &i2, &i3, &i4, &i5, &i6, &i7, remainder >> 1);
		libsais_unbwt_decode_7(U + offset + 2 * (remainder >> 1), P, bucket2, fastbits, shift, (fast_uint_t)r, &i0, &i1, &i2, &i3, &i4, &i5, &i6,
		    ((fast_uint_t)r >> 1) - (remainder >> 1));
	}
}

static void libsais_unbwt_decode_omp(const uint8 * _RESTRICT T, uint8 * _RESTRICT U, sa_uint_t * _RESTRICT P, sa_sint_t n, sa_sint_t r,
    const sa_uint_t * _RESTRICT I, sa_uint_t * _RESTRICT bucket2, uint16 * _RESTRICT fastbits, sa_sint_t threads)
{
	fast_uint_t lastc  = T[0];
...
#endif
	{
		...
		libsais_unbwt_decode(U + r * omp_block_start, P, n, r, I + omp_block_start, bucket2,
		    fastbits, omp_block_size, omp_thread_num < omp_num_threads - 1 ? (fast_uint_t)r : remainder);
	}
	U[n - 1] = (uint8)lastc;
}

static sa_sint_t libsais_unbwt_core(const uint8 * _RESTRICT T, uint8 * _RESTRICT U, sa_uint_t * _RESTRICT P, sa_sint_t n,
    const sa_sint_t * freq, sa_sint_t r, const sa_uint_t * _RESTRICT I, sa_uint_t * _RESTRICT bucket2, uint16 * _RESTRICT fastbits, sa_uint_t * _RESTRICT buckets,
    sa_sint_t threads)
{
#if defined(LIBSAIS_OPENMP)
...
static sa_sint_t libsais_unbwt_main(const uint8 * T, uint8 * U, sa_uint_t * P, sa_sint_t n, const sa_sint_t * freq, sa_sint_t r, const sa_uint_t * I, sa_sint_t threads)
{
	fast_uint_t shift = 0; while((n >> shift) > (1 << UNBWT_FASTBITS)) {
		shift++;
	}
	sa_uint_t * _RESTRICT bucket2  = (sa_uint_t *)libsais_alloc_aligned(ALPHABET_SIZE * ALPHABET_SIZE * sizeof(sa_uint_t), 4096);
	uint16    * _RESTRICT fastbits = (uint16 *)libsais_alloc_aligned(((size_t)1 + (size_t)(n >> shift)) * sizeof(uint16), 4096);
	sa_uint_t * _RESTRICT buckets  = threads > 1 && n >= 262144 ? (sa_uint_t *)libsais_alloc_aligned(
		(size_t)threads * (ALPHABET_SIZE + (ALPHABET_SIZE * ALPHABET_SIZE)) * sizeof(sa_uint_t), 4096) : NULL;
	sa_sint_t index = bucket2 != NULL && fastbits != NULL && (buckets != NULL || threads == 1 || n < 262144) ? 
		libsais_unbwt_core(T, U, P, n, freq, r, I, bucket2, fastbits, buckets, threads) : -2;
	libsais_free_aligned(buckets);
	libsais_free_aligned(fastbits);
	libsais_free_aligned(bucket2);
	return index;
...
static sa_sint_t libsais_unbwt_main_ctx(const LIBSAIS_UNBWT_CONTEXT * ctx, const uint8 * T,
    uint8 * U, sa_uint_t * P, sa_sint_t n, const sa_sint_t * freq, sa_sint_t r, const sa_uint_t * I)
{
	return ctx != NULL && ctx->bucket2 != NULL && ctx->fastbits != NULL && (ctx->buckets != NULL || ctx->threads == 1) ? 
		libsais_unbwt_core(T, U, P, n, freq, r, I, ctx->bucket2, ctx->fastbits, ctx->buckets, (sa_sint_t)ctx->threads) : -2;
}
...
static void libsais_compute_phi(const sa_sint_t * _RESTRICT SA, sa_sint_t * _RESTRICT PLCP, sa_sint_t n, fast_sint_t omp_block_start, fast_sint_t omp_block_size)
{
	const fast_sint_t prefetch_distance = 32;
...
static void libsais_compute_phi_omp(const sa_sint_t * _RESTRICT SA, sa_sint_t * _RESTRICT PLCP, sa_sint_t n, sa_sint_t threads)
{
#if defined(LIBSAIS_OPENMP)
    #pragma omp parallel num_threads(threads) if(threads > 1 && n >= 65536)
#endif
...
static void libsais_compute_plcp(const uint8 * _RESTRICT T, sa_sint_t * _RESTRICT PLCP, fast_sint_t n, fast_sint_t omp_block_start, fast_sint_t omp_block_size)
{
	const fast_sint_t prefetch_distance = 32;
	fast_sint_t i;
	fast_sint_t j;
...
static void libsais_compute_plcp_omp(const uint8 * _RESTRICT T, sa_sint_t * _RESTRICT PLCP, sa_sint_t n, sa_sint_t threads)
{
#if defined(LIBSAIS_OPENMP)
    #pragma omp parallel num_threads(threads) if(threads > 1 && n >= 65536)
#endif
...
static void libsais_compute_lcp(const sa_sint_t * _RESTRICT PLCP, const sa_sint_t * _RESTRICT SA, sa_sint_t * _RESTRICT LCP, fast_sint_t omp_block_start, fast_sint_t omp_block_size)
{
	const fast_sint_t prefetch_distance = 32;
	fast_sint_t i, j;
	for(i = omp_block_start, j = omp_block_start + omp_block_size-prefetch_distance-3; i < j; i += 4) {
...
static void libsais_compute_lcp_omp(const sa_sint_t * _RESTRICT PLCP, const sa_sint_t * _RESTRICT SA, sa_sint_t * _RESTRICT LCP, sa_sint_t n, sa_sint_t threads)
{
#if defined(LIBSAIS_OPENMP)
    #pragma omp parallel num_threads(threads) if(threads > 1 && n >= 65536)
#endif
