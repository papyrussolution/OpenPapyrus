...
#include "..\slib\sais\include\libsais64.h"
...
//#endif
    ...
    #include <intrin.h>
    #define libsais64_prefetchr(address) _mm_prefetch((const char *)(address), _MM_HINT_T0)
...
{
	LIBSAIS_THREAD_STATE *  _RESTRICT thread_state    = (LIBSAIS_THREAD_STATE *)libsais64_alloc_aligned((size_t)threads * sizeof(LIBSAIS_THREAD_STATE), 4096);
	sa_sint_t *             _RESTRICT thread_buckets  = (sa_sint_t *)libsais64_alloc_aligned((size_t)threads * 4 * ALPHABET_SIZE * sizeof(sa_sint_t), 4096);
	LIBSAIS_THREAD_CACHE *  _RESTRICT thread_cache    = (LIBSAIS_THREAD_CACHE *)libsais64_alloc_aligned((size_t)threads * LIBSAIS_PER_THREAD_CACHE_SIZE * sizeof(LIBSAIS_THREAD_CACHE), 4096);
...
static sa_sint_t libsais64_count_negative_marked_suffixes(sa_sint_t * _RESTRICT SA, fast_sint_t omp_block_start, fast_sint_t omp_block_size)
{
	sa_sint_t count = 0;
...
static sa_sint_t libsais64_count_zero_marked_suffixes(sa_sint_t * _RESTRICT SA, fast_sint_t omp_block_start, fast_sint_t omp_block_size)
{
	sa_sint_t count = 0;
	fast_sint_t i; for(i = omp_block_start; i < omp_block_start + omp_block_size; ++i) {
		count += (SA[i] == 0);
...
static void libsais64_place_cached_suffixes(sa_sint_t * _RESTRICT SA, LIBSAIS_THREAD_CACHE * _RESTRICT cache, fast_sint_t omp_block_start, fast_sint_t omp_block_size)
{
...
static void libsais64_compact_and_place_cached_suffixes(sa_sint_t * _RESTRICT SA, LIBSAIS_THREAD_CACHE * _RESTRICT cache, fast_sint_t omp_block_start, fast_sint_t omp_block_size)
{
	const fast_sint_t prefetch_distance = 32;
	fast_sint_t i, j, l;
...
static void libsais64_accumulate_counts_s32_2(sa_sint_t * _RESTRICT bucket00, fast_sint_t bucket_size, fast_sint_t bucket_stride)
{
...
static void libsais64_accumulate_counts_s32_3(sa_sint_t * _RESTRICT bucket00, fast_sint_t bucket_size, fast_sint_t bucket_stride)
{
	sa_sint_t * _RESTRICT bucket01 = bucket00 - bucket_stride;
...
static void libsais64_accumulate_counts_s32_4(sa_sint_t * _RESTRICT bucket00, fast_sint_t bucket_size, fast_sint_t bucket_stride)
{
	sa_sint_t * _RESTRICT bucket01 = bucket00 - bucket_stride;
	sa_sint_t * _RESTRICT bucket02 = bucket01 - bucket_stride;
...
static void libsais64_accumulate_counts_s32_5(sa_sint_t * _RESTRICT bucket00, fast_sint_t bucket_size, fast_sint_t bucket_stride)
{
	sa_sint_t * _RESTRICT bucket01 = bucket00 - bucket_stride;
	sa_sint_t * _RESTRICT bucket02 = bucket01 - bucket_stride;
	sa_sint_t * _RESTRICT bucket03 = bucket02 - bucket_stride;
...
static void libsais64_accumulate_counts_s32_6(sa_sint_t * _RESTRICT bucket00, fast_sint_t bucket_size, fast_sint_t bucket_stride)
{
	sa_sint_t * _RESTRICT bucket01 = bucket00 - bucket_stride;
	sa_sint_t * _RESTRICT bucket02 = bucket01 - bucket_stride;
	sa_sint_t * _RESTRICT bucket03 = bucket02 - bucket_stride;
...
static void libsais64_accumulate_counts_s32_7(sa_sint_t * _RESTRICT bucket00, fast_sint_t bucket_size, fast_sint_t bucket_stride)
{
	sa_sint_t * _RESTRICT bucket01 = bucket00 - bucket_stride;
	sa_sint_t * _RESTRICT bucket02 = bucket01 - bucket_stride;
	sa_sint_t * _RESTRICT bucket03 = bucket02 - bucket_stride;
...
static void libsais64_accumulate_counts_s32_8(sa_sint_t * _RESTRICT bucket00, fast_sint_t bucket_size, fast_sint_t bucket_stride)
{
	sa_sint_t * _RESTRICT bucket01 = bucket00 - bucket_stride;
	sa_sint_t * _RESTRICT bucket02 = bucket01 - bucket_stride;
	sa_sint_t * _RESTRICT bucket03 = bucket02 - bucket_stride;
...
static void libsais64_accumulate_counts_s32_9(sa_sint_t * _RESTRICT bucket00, fast_sint_t bucket_size, fast_sint_t bucket_stride)
{
	sa_sint_t * _RESTRICT bucket01 = bucket00 - bucket_stride;
	sa_sint_t * _RESTRICT bucket02 = bucket01 - bucket_stride;
	sa_sint_t * _RESTRICT bucket03 = bucket02 - bucket_stride;
...
static void libsais64_accumulate_counts_s32(sa_sint_t * _RESTRICT buckets, fast_sint_t bucket_size, fast_sint_t bucket_stride, fast_sint_t num_buckets)
{
	while(num_buckets >= 9) {
...
static void libsais64_gather_lms_suffixes_8u(const uint8_t * _RESTRICT T, sa_sint_t * _RESTRICT SA, sa_sint_t n,
    fast_sint_t m, fast_sint_t omp_block_start, fast_sint_t omp_block_size)
{
	if(omp_block_size > 0) {
...
static void libsais64_gather_lms_suffixes_8u_omp(const uint8_t * _RESTRICT T, sa_sint_t * _RESTRICT SA, sa_sint_t n, sa_sint_t threads, LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
#if defined(LIBSAIS_OPENMP)
...
static sa_sint_t libsais64_gather_lms_suffixes_32s(const sa_sint_t * _RESTRICT T, sa_sint_t * _RESTRICT SA, sa_sint_t n)
{
	const fast_sint_t prefetch_distance = 32;
	sa_sint_t i   = n - 2;
	sa_sint_t m   = n - 1;
...
static sa_sint_t libsais64_gather_compacted_lms_suffixes_32s(const sa_sint_t * _RESTRICT T, sa_sint_t * _RESTRICT SA, sa_sint_t n)
{
	const fast_sint_t prefetch_distance = 32;
	sa_sint_t i   = n - 2;
	sa_sint_t m   = n - 1;
...
static void libsais64_count_lms_suffixes_32s_4k(const sa_sint_t * _RESTRICT T, sa_sint_t n, sa_sint_t k, sa_sint_t * _RESTRICT buckets)
{
	const fast_sint_t prefetch_distance = 32;
...
static void libsais64_count_lms_suffixes_32s_2k(const sa_sint_t * _RESTRICT T, sa_sint_t n, sa_sint_t k, sa_sint_t * _RESTRICT buckets)
{
	const fast_sint_t prefetch_distance = 32;
...
static void libsais64_count_compacted_lms_suffixes_32s_2k(const sa_sint_t * _RESTRICT T, sa_sint_t n, sa_sint_t k, sa_sint_t * _RESTRICT buckets)
{
	const fast_sint_t prefetch_distance = 32;
...
static sa_sint_t libsais64_count_and_gather_lms_suffixes_8u(const uint8_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA, sa_sint_t n, sa_sint_t * _RESTRICT buckets, fast_sint_t omp_block_start, fast_sint_t omp_block_size)
{
...
static sa_sint_t libsais64_count_and_gather_lms_suffixes_8u_omp(const uint8_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA, sa_sint_t n, sa_sint_t * _RESTRICT buckets, sa_sint_t threads, LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
	sa_sint_t m = 0;
#if defined(LIBSAIS_OPENMP)
    #pragma omp parallel num_threads(threads) if(threads > 1 && n >= 65536 && omp_get_dynamic() == 0)
#endif
	{
		...
		if(omp_num_threads == 1) {
		...
		else {
			{
				...
				thread_state[omp_thread_num].state.m = libsais64_count_and_gather_lms_suffixes_8u(T,
					SA,
					n,
...
static sa_sint_t libsais64_count_and_gather_lms_suffixes_32s_4k(const sa_sint_t * _RESTRICT T,
...
static sa_sint_t libsais64_count_and_gather_lms_suffixes_32s_2k(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t k,
    sa_sint_t * _RESTRICT buckets,
...
static sa_sint_t libsais64_count_and_gather_compacted_lms_suffixes_32s_2k(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t k,
    sa_sint_t * _RESTRICT buckets,
...
static sa_sint_t libsais64_count_and_gather_lms_suffixes_32s_4k_fs_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA, sa_sint_t n, sa_sint_t k, sa_sint_t * _RESTRICT buckets, sa_sint_t threads, LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
	sa_sint_t m = 0;
...
#endif
	{
		...
		if(omp_num_threads == 1) {
			...
			{
				thread_state[omp_thread_num].state.position = omp_block_start + omp_block_size;
				thread_state[omp_thread_num].state.count = libsais64_count_and_gather_lms_suffixes_32s_4k(T,
					SA,
					n,
					k,
...
static sa_sint_t libsais64_count_and_gather_lms_suffixes_32s_2k_fs_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t k,
    sa_sint_t * _RESTRICT buckets,
    ...
    LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
...
#endif
	{
		...
		if(omp_num_threads == 1) {
			...
			{
				thread_state[omp_thread_num].state.position = omp_block_start + omp_block_size;
				thread_state[omp_thread_num].state.count = libsais64_count_and_gather_lms_suffixes_32s_2k(T,
					SA,
					n,
					k,
					buckets - (omp_thread_num * bucket_stride),
...
static void libsais64_count_and_gather_compacted_lms_suffixes_32s_2k_fs_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t k,
    sa_sint_t * _RESTRICT buckets,
		...
		if(omp_num_threads == 1) {
...

			{
				...
				thread_state[omp_thread_num].state.count =
				    libsais64_count_and_gather_compacted_lms_suffixes_32s_2k(T,
					SA + n,
					n,
					k,
					buckets - (omp_thread_num * bucket_stride),
...
static sa_sint_t libsais64_count_and_gather_lms_suffixes_32s_4k_nofs_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t k,
    sa_sint_t * _RESTRICT buckets,
...
static sa_sint_t libsais64_count_and_gather_lms_suffixes_32s_2k_nofs_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t k,
    sa_sint_t * _RESTRICT buckets,
...
static sa_sint_t libsais64_count_and_gather_compacted_lms_suffixes_32s_2k_nofs_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t k,
    sa_sint_t * _RESTRICT buckets,
...
static sa_sint_t libsais64_count_and_gather_lms_suffixes_32s_4k_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t k,
    sa_sint_t * _RESTRICT buckets,
...
static sa_sint_t libsais64_count_and_gather_lms_suffixes_32s_2k_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t k,
    sa_sint_t * _RESTRICT buckets,
...
static void libsais64_count_and_gather_compacted_lms_suffixes_32s_2k_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t k,
    sa_sint_t * _RESTRICT buckets,
...
static void libsais64_count_suffixes_32s(const sa_sint_t * _RESTRICT T, sa_sint_t n, sa_sint_t k, sa_sint_t * _RESTRICT buckets)
{
	const fast_sint_t prefetch_distance = 32;
...
static void libsais64_initialize_buckets_start_and_end_8u(sa_sint_t * _RESTRICT buckets, sa_sint_t * _RESTRICT freq)
{
...
static void libsais64_initialize_buckets_start_and_end_32s_6k(sa_sint_t k, sa_sint_t * _RESTRICT buckets)
{
...
static void libsais64_initialize_buckets_start_and_end_32s_4k(sa_sint_t k, sa_sint_t * _RESTRICT buckets)
{
...
static void libsais64_initialize_buckets_end_32s_2k(sa_sint_t k, sa_sint_t * _RESTRICT buckets)
{
...
static void libsais64_initialize_buckets_start_and_end_32s_2k(sa_sint_t k, sa_sint_t * _RESTRICT buckets)
{
	fast_sint_t i, j;
	for(i = BUCKETS_INDEX2(0, 0), j = 0; i <= BUCKETS_INDEX2((fast_sint_t)k - 1, 0); i += BUCKETS_INDEX2(1, 0), j += 1) {
		buckets[j] = buckets[i];
...
static void libsais64_initialize_buckets_start_32s_1k(sa_sint_t k, sa_sint_t * _RESTRICT buckets)
{
...
static void libsais64_initialize_buckets_end_32s_1k(sa_sint_t k, sa_sint_t * _RESTRICT buckets)
{
	fast_sint_t i; sa_sint_t sum = 0;
	for(i = 0; i <= (fast_sint_t)k - 1; i += 1) {
...
static sa_sint_t libsais64_initialize_buckets_for_lms_suffixes_radix_sort_8u(const uint8_t * _RESTRICT T, sa_sint_t * _RESTRICT buckets, sa_sint_t first_lms_suffix)
{
	{
		fast_uint_t s = 0;
...
static void libsais64_initialize_buckets_for_lms_suffixes_radix_sort_32s_2k(const sa_sint_t * _RESTRICT T, sa_sint_t k, sa_sint_t * _RESTRICT buckets, sa_sint_t first_lms_suffix)
{
...
static sa_sint_t libsais64_initialize_buckets_for_lms_suffixes_radix_sort_32s_6k(const sa_sint_t * _RESTRICT T, sa_sint_t k, sa_sint_t * _RESTRICT buckets,
...
static void libsais64_initialize_buckets_for_radix_and_partial_sorting_32s_4k(const sa_sint_t * _RESTRICT T, sa_sint_t k, sa_sint_t * _RESTRICT buckets, sa_sint_t first_lms_suffix)
{
	sa_sint_t * _RESTRICT bucket_start = &buckets[2 * (fast_sint_t)k];
	sa_sint_t * _RESTRICT bucket_end   = &buckets[3 * (fast_sint_t)k];
...
static void libsais64_radix_sort_lms_suffixes_8u(const uint8_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
...
static void libsais64_radix_sort_lms_suffixes_8u_omp(const uint8_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t m,
    sa_sint_t * _RESTRICT buckets,
...
static void libsais64_radix_sort_lms_suffixes_32s_6k(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT induction_bucket,
    fast_sint_t omp_block_start,
    fast_sint_t omp_block_size)
...
static void libsais64_radix_sort_lms_suffixes_32s_2k(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT induction_bucket,
    fast_sint_t omp_block_start,
    fast_sint_t omp_block_size)
...
static void libsais64_radix_sort_lms_suffixes_32s_block_gather(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
...
static void libsais64_radix_sort_lms_suffixes_32s_6k_block_sort(sa_sint_t * _RESTRICT induction_bucket,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t omp_block_start,
    fast_sint_t omp_block_size)
{
...
static void libsais64_radix_sort_lms_suffixes_32s_2k_block_sort(sa_sint_t * _RESTRICT induction_bucket,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t omp_block_start,
    fast_sint_t omp_block_size)
{
...
static void libsais64_radix_sort_lms_suffixes_32s_6k_block_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT induction_bucket,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
...
static void libsais64_radix_sort_lms_suffixes_32s_2k_block_omp(const sa_sint_t * _RESTRICT T, sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT induction_bucket, LIBSAIS_THREAD_CACHE * _RESTRICT cache, fast_sint_t block_start, fast_sint_t block_size, sa_sint_t threads)
{
#if defined(LIBSAIS_OPENMP)
    #pragma omp parallel num_threads(threads) if(threads > 1 && block_size >= 16384)
#endif
...
static void libsais64_radix_sort_lms_suffixes_32s_6k_omp(const sa_sint_t * _RESTRICT T, sa_sint_t * _RESTRICT SA,
    sa_sint_t n, sa_sint_t m, sa_sint_t * _RESTRICT induction_bucket, sa_sint_t threads, LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
	if(threads == 1 || m < 65536) {
		...
		for(block_start = 0; block_start < (fast_sint_t)m - 1; block_start = block_end) {
			...
			libsais64_radix_sort_lms_suffixes_32s_6k_block_omp(T, SA, induction_bucket, thread_state[0].state.cache, (fast_sint_t)n - block_end,
...
static void libsais64_radix_sort_lms_suffixes_32s_2k_omp(const sa_sint_t * _RESTRICT T, sa_sint_t * _RESTRICT SA,
    sa_sint_t n, sa_sint_t m, sa_sint_t * _RESTRICT induction_bucket, sa_sint_t threads, LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
	if(threads == 1 || m < 65536) {
		...
		for(block_start = 0; block_start < (fast_sint_t)m - 1; block_start = block_end) {
			...
			libsais64_radix_sort_lms_suffixes_32s_2k_block_omp(T, SA, induction_bucket, thread_state[0].state.cache, (fast_sint_t)n - block_end,
			    block_end - block_start, threads);
		}
	}
#else
...
static sa_sint_t libsais64_radix_sort_lms_suffixes_32s_1k(const sa_sint_t * _RESTRICT T, sa_sint_t * _RESTRICT SA, sa_sint_t n, sa_sint_t * _RESTRICT buckets)
{
	const fast_sint_t prefetch_distance = 32;
...
static void libsais64_radix_sort_set_markers_32s_6k(sa_sint_t * _RESTRICT SA, sa_sint_t * _RESTRICT induction_bucket, fast_sint_t omp_block_start, fast_sint_t omp_block_size)
{
	const fast_sint_t prefetch_distance = 32;
...
static void libsais64_radix_sort_set_markers_32s_4k(sa_sint_t * _RESTRICT SA, sa_sint_t * _RESTRICT induction_bucket, fast_sint_t omp_block_start, fast_sint_t omp_block_size)
{
	const fast_sint_t prefetch_distance = 32;
...
static void libsais64_radix_sort_set_markers_32s_6k_omp(sa_sint_t * _RESTRICT SA, sa_sint_t k, sa_sint_t * _RESTRICT induction_bucket, sa_sint_t threads)
{
#if defined(LIBSAIS_OPENMP)
...
static void libsais64_radix_sort_set_markers_32s_4k_omp(sa_sint_t * _RESTRICT SA, sa_sint_t k, sa_sint_t * _RESTRICT induction_bucket, sa_sint_t threads)
{
#if defined(LIBSAIS_OPENMP)
    #pragma omp parallel num_threads(threads) if(threads > 1 && k >= 65536)
#endif
...
static void libsais64_initialize_buckets_for_partial_sorting_8u(const uint8_t * _RESTRICT T, sa_sint_t * _RESTRICT buckets, sa_sint_t first_lms_suffix, sa_sint_t left_suffixes_count)
{
	sa_sint_t * _RESTRICT temp_bucket = &buckets[4 * ALPHABET_SIZE];
...
static void libsais64_initialize_buckets_for_partial_sorting_32s_6k(const sa_sint_t * _RESTRICT T,
    sa_sint_t k,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t first_lms_suffix,
...
static sa_sint_t libsais64_partial_sorting_scan_left_to_right_8u(const uint8_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t d,
    fast_sint_t omp_block_start,
...
static void libsais64_partial_sorting_scan_left_to_right_8u_block_prepare(const uint8_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT buckets,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t omp_block_start,
...
static void libsais64_partial_sorting_scan_left_to_right_8u_block_place(sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT buckets,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t count,
    sa_sint_t d)
...
static sa_sint_t libsais64_partial_sorting_scan_left_to_right_8u_block_omp(const uint8_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t d,
    fast_sint_t block_start,
    ...
    LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
...
#endif
	{
		...
		if(omp_num_threads == 1) {
			...
			{
				libsais64_partial_sorting_scan_left_to_right_8u_block_prepare(T,
				    SA,
				    thread_state[omp_thread_num].state.buckets,
	    ...
	    #pragma omp barrier
			...
			{
				libsais64_partial_sorting_scan_left_to_right_8u_block_place(SA,
				    thread_state[omp_thread_num].state.buckets,
				    thread_state[omp_thread_num].state.cache,
				    thread_state[omp_thread_num].state.count,
...
static sa_sint_t libsais64_partial_sorting_scan_left_to_right_8u_omp(const uint8_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t left_suffixes_count,
...
static sa_sint_t libsais64_partial_sorting_scan_left_to_right_32s_6k(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t d,
    fast_sint_t omp_block_start,
...
static sa_sint_t libsais64_partial_sorting_scan_left_to_right_32s_4k(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t k,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t d,
    ...
    fast_sint_t omp_block_size)
{
	...
	for(i = omp_block_start, j = omp_block_start + omp_block_size - 2 * prefetch_distance - 1; i < j; i += 2) {
		...
		sa_sint_t s0 = SA[i + 2 * prefetch_distance + 0]; const sa_sint_t * Ts0 = &T[s0 & ~SUFFIX_GROUP_MARKER] - 1; libsais64_prefetchr(s0 > 0 ? Ts0 : NULL); Ts0--;
		libsais64_prefetchr(s0 > 0 ? Ts0 : NULL);
		sa_sint_t s1 = SA[i + 2 * prefetch_distance + 1]; const sa_sint_t * Ts1 = &T[s1 & ~SUFFIX_GROUP_MARKER] - 1; libsais64_prefetchr(s1 > 0 ? Ts1 : NULL); Ts1--;
		libsais64_prefetchr(s1 > 0 ? Ts1 : NULL);
		sa_sint_t s2 = SA[i + 1 * prefetch_distance + 0]; if(s2 > 0) {
			const fast_sint_t Ts2 = T[(s2 & ~SUFFIX_GROUP_MARKER) - 1]; libsais64_prefetchw(&induction_bucket[Ts2]);
			libsais64_prefetchw(&distinct_names[BUCKETS_INDEX2(Ts2, 0)]);
		}
		sa_sint_t s3 = SA[i + 1 * prefetch_distance + 1]; if(s3 > 0) {
			const fast_sint_t Ts3 = T[(s3 & ~SUFFIX_GROUP_MARKER) - 1]; libsais64_prefetchw(&induction_bucket[Ts3]);
			libsais64_prefetchw(&distinct_names[BUCKETS_INDEX2(Ts3, 0)]);
		}
...
static void libsais64_partial_sorting_scan_left_to_right_32s_1k(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT induction_bucket,
    fast_sint_t omp_block_start,
    fast_sint_t omp_block_size)
{
	...
	for(i = omp_block_start, j = omp_block_start + omp_block_size - 2 * prefetch_distance - 1; i < j; i += 2) {
		...
		sa_sint_t s2 = SA[i + 1 * prefetch_distance + 0]; if(s2 > 0) {
			libsais64_prefetchw(&induction_bucket[T[s2 - 1]]); libsais64_prefetchr(&T[s2] - 2);
		}
		sa_sint_t s3 = SA[i + 1 * prefetch_distance + 1]; if(s3 > 0) {
			libsais64_prefetchw(&induction_bucket[T[s3 - 1]]); libsais64_prefetchr(&T[s3] - 2);
		}
...
static void libsais64_partial_sorting_scan_left_to_right_32s_6k_block_gather(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t omp_block_start,
    fast_sint_t omp_block_size)
...
static void libsais64_partial_sorting_scan_left_to_right_32s_4k_block_gather(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t omp_block_start,
    fast_sint_t omp_block_size)
{
	...
	for(i = omp_block_start, j = omp_block_start + omp_block_size - prefetch_distance - 1; i < j; i += 2) {
		...
		sa_sint_t s0 = SA[i + prefetch_distance + 0]; const sa_sint_t * Ts0 = &T[s0 & ~SUFFIX_GROUP_MARKER] - 1; libsais64_prefetchr(s0 > 0 ? Ts0 : NULL); Ts0--;
		libsais64_prefetchr(s0 > 0 ? Ts0 : NULL);
		sa_sint_t s1 = SA[i + prefetch_distance + 1]; const sa_sint_t * Ts1 = &T[s1 & ~SUFFIX_GROUP_MARKER] - 1; libsais64_prefetchr(s1 > 0 ? Ts1 : NULL); Ts1--;
		libsais64_prefetchr(s1 > 0 ? Ts1 : NULL);
...
static void libsais64_partial_sorting_scan_left_to_right_32s_1k_block_gather(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t omp_block_start,
    fast_sint_t omp_block_size)
{
	...
	for(i = omp_block_start, j = omp_block_start + omp_block_size - prefetch_distance - 1; i < j; i += 2) {
		...
		sa_sint_t s0 = SA[i + prefetch_distance + 0]; const sa_sint_t * Ts0 = &T[s0] - 1; libsais64_prefetchr(s0 > 0 ? Ts0 : NULL); Ts0--; libsais64_prefetchr(
			s0 > 0 ? Ts0 : NULL);
		sa_sint_t s1 = SA[i + prefetch_distance + 1]; const sa_sint_t * Ts1 = &T[s1] - 1; libsais64_prefetchr(s1 > 0 ? Ts1 : NULL); Ts1--; libsais64_prefetchr(
			s1 > 0 ? Ts1 : NULL);
...
static sa_sint_t libsais64_partial_sorting_scan_left_to_right_32s_6k_block_sort(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t d,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t omp_block_start,
...
static sa_sint_t libsais64_partial_sorting_scan_left_to_right_32s_4k_block_sort(const sa_sint_t * _RESTRICT T,
    sa_sint_t k,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t d,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    ...
    fast_sint_t omp_block_size)
{
	...
	for(i = omp_block_start, j = omp_block_end - prefetch_distance - 1; i < j; i += 2) {
		...
		sa_sint_t s0 = cache[i + prefetch_distance + 0].symbol; const sa_sint_t * Is0 = &induction_bucket[s0 >> 1]; libsais64_prefetchw(s0 >= 0 ? Is0 : NULL);
		const sa_sint_t * Ds0 = &distinct_names[s0]; libsais64_prefetchw(s0 >= 0 ? Ds0 : NULL);
		sa_sint_t s1 = cache[i + prefetch_distance + 1].symbol; const sa_sint_t * Is1 = &induction_bucket[s1 >> 1]; libsais64_prefetchw(s1 >= 0 ? Is1 : NULL);
		const sa_sint_t * Ds1 = &distinct_names[s1]; libsais64_prefetchw(s1 >= 0 ? Ds1 : NULL);
...
static void libsais64_partial_sorting_scan_left_to_right_32s_1k_block_sort(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT induction_bucket,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t omp_block_start,
    fast_sint_t omp_block_size)
...
static sa_sint_t libsais64_partial_sorting_scan_left_to_right_32s_6k_block_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t d,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
...
static sa_sint_t libsais64_partial_sorting_scan_left_to_right_32s_4k_block_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t k,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t d,
...
static void libsais64_partial_sorting_scan_left_to_right_32s_1k_block_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT buckets,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t block_start,
...
static sa_sint_t libsais64_partial_sorting_scan_left_to_right_32s_6k_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t left_suffixes_count,
    ...
    LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
	...
	if(threads == 1 || left_suffixes_count < 65536) {
		...
		for(block_start = 0; block_start < left_suffixes_count; block_start = block_end) {
			...
			d = libsais64_partial_sorting_scan_left_to_right_32s_6k_block_omp(T,
				SA,
				buckets,
				d,
...
static sa_sint_t libsais64_partial_sorting_scan_left_to_right_32s_4k_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t k,
    sa_sint_t * _RESTRICT buckets,
    ...
    LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
	...
	if(threads == 1 || n < 65536) {
		...
		for(block_start = 0; block_start < n; block_start = block_end) {
			...
			d = libsais64_partial_sorting_scan_left_to_right_32s_4k_block_omp(T,
				SA,
				k,
				buckets,
				d,
...
static void libsais64_partial_sorting_scan_left_to_right_32s_1k_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t threads,
...
static void libsais64_partial_sorting_shift_markers_8u_omp(sa_sint_t * _RESTRICT SA, sa_sint_t n, const sa_sint_t * _RESTRICT buckets, sa_sint_t threads)
{
	const fast_sint_t prefetch_distance = 32;
...
static void libsais64_partial_sorting_shift_markers_32s_6k_omp(sa_sint_t * _RESTRICT SA, sa_sint_t k, const sa_sint_t * _RESTRICT buckets, sa_sint_t threads)
{
	const fast_sint_t prefetch_distance = 32;
...
static void libsais64_partial_sorting_shift_markers_32s_4k(sa_sint_t * _RESTRICT SA, sa_sint_t n)
{
	const fast_sint_t prefetch_distance = 32;
...
static void libsais64_partial_sorting_shift_buckets_32s_6k(sa_sint_t k, sa_sint_t * _RESTRICT buckets)
{
	sa_sint_t * _RESTRICT temp_bucket = &buckets[4 * (fast_sint_t)k];
...
static sa_sint_t libsais64_partial_sorting_scan_right_to_left_8u(const uint8_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t d,
    fast_sint_t omp_block_start,
...
static void libsais64_partial_sorting_scan_right_to_left_8u_block_prepare(const uint8_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT buckets,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t omp_block_start,
...
static void libsais64_partial_sorting_scan_right_to_left_8u_block_place(sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT buckets,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t count,
    sa_sint_t d)
...
static sa_sint_t libsais64_partial_sorting_scan_right_to_left_8u_block_omp(const uint8_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t d,
    fast_sint_t block_start,
    ...
    LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
...
#endif
	{
		...
		if(omp_num_threads == 1) {
			...
			{
				libsais64_partial_sorting_scan_right_to_left_8u_block_prepare(T,
				    SA,
				    thread_state[omp_thread_num].state.buckets,
				    thread_state[omp_thread_num].state.cache,
				    omp_block_start,
	    ...
	    #pragma omp barrier
			...
			{
				libsais64_partial_sorting_scan_right_to_left_8u_block_place(SA,
				    thread_state[omp_thread_num].state.buckets,
				    thread_state[omp_thread_num].state.cache,
				    thread_state[omp_thread_num].state.count,
				    (sa_sint_t)thread_state[omp_thread_num].state.position);
...
static void libsais64_partial_sorting_scan_right_to_left_8u_omp(const uint8_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t first_lms_suffix,
...
static sa_sint_t libsais64_partial_sorting_scan_right_to_left_32s_6k(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t d,
    fast_sint_t omp_block_start,
...
static sa_sint_t libsais64_partial_sorting_scan_right_to_left_32s_4k(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t k,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t d,
...
static void libsais64_partial_sorting_scan_right_to_left_32s_1k(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT induction_bucket,
    fast_sint_t omp_block_start,
    fast_sint_t omp_block_size)
...
static void libsais64_partial_sorting_scan_right_to_left_32s_6k_block_gather(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t omp_block_start,
    fast_sint_t omp_block_size)
...
static void libsais64_partial_sorting_scan_right_to_left_32s_4k_block_gather(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t omp_block_start,
    fast_sint_t omp_block_size)
...
static void libsais64_partial_sorting_scan_right_to_left_32s_1k_block_gather(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t omp_block_start,
    fast_sint_t omp_block_size)
...
static sa_sint_t libsais64_partial_sorting_scan_right_to_left_32s_6k_block_sort(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t d,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t omp_block_start,
...
static sa_sint_t libsais64_partial_sorting_scan_right_to_left_32s_4k_block_sort(const sa_sint_t * _RESTRICT T,
    sa_sint_t k,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t d,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
...
static void libsais64_partial_sorting_scan_right_to_left_32s_1k_block_sort(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT induction_bucket,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t omp_block_start,
    fast_sint_t omp_block_size)
...
static sa_sint_t libsais64_partial_sorting_scan_right_to_left_32s_6k_block_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t d,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
...
static sa_sint_t libsais64_partial_sorting_scan_right_to_left_32s_4k_block_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t k,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t d,
...
static void libsais64_partial_sorting_scan_right_to_left_32s_1k_block_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT buckets,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t block_start,
...
static sa_sint_t libsais64_partial_sorting_scan_right_to_left_32s_6k_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t first_lms_suffix,
    ...
    LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
	...
	if(threads == 1 || (scan_end - scan_start) < 65536) {
		...
		for(block_start = scan_end - 1; block_start >= scan_start; block_start = block_end) {
			...
			d = libsais64_partial_sorting_scan_right_to_left_32s_6k_block_omp(T,
				SA,
				buckets,
				d,
				thread_state[0].state.cache,
...
static sa_sint_t libsais64_partial_sorting_scan_right_to_left_32s_4k_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t k,
    sa_sint_t * _RESTRICT buckets,
    ...
    LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
	if(threads == 1 || n < 65536) {
		...
		for(block_start = (fast_sint_t)n - 1; block_start >= 0; block_start = block_end) {
			...
			d = libsais64_partial_sorting_scan_right_to_left_32s_4k_block_omp(T,
				SA,
				k,
				buckets,
				d,
...
static void libsais64_partial_sorting_scan_right_to_left_32s_1k_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t threads,
...
static fast_sint_t libsais64_partial_sorting_gather_lms_suffixes_32s_4k(sa_sint_t * _RESTRICT SA, fast_sint_t omp_block_start, fast_sint_t omp_block_size)
{
	const fast_sint_t prefetch_distance = 32;
...
static fast_sint_t libsais64_partial_sorting_gather_lms_suffixes_32s_1k(sa_sint_t * _RESTRICT SA, fast_sint_t omp_block_start, fast_sint_t omp_block_size)
{
	const fast_sint_t prefetch_distance = 32;
...
static void libsais64_partial_sorting_gather_lms_suffixes_32s_4k_omp(sa_sint_t * _RESTRICT SA, sa_sint_t n, sa_sint_t threads, LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
#if defined(LIBSAIS_OPENMP)
    #pragma omp parallel num_threads(threads) if(threads > 1 && n >= 65536)
#endif
	{
		...
		if(omp_num_threads == 1) {
		...
		else {
			{
				...
				thread_state[omp_thread_num].state.count =
				    libsais64_partial_sorting_gather_lms_suffixes_32s_4k(SA, omp_block_start, omp_block_size) - omp_block_start;
			}
...
static void libsais64_partial_sorting_gather_lms_suffixes_32s_1k_omp(sa_sint_t * _RESTRICT SA, sa_sint_t n, sa_sint_t threads, LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
#if defined(LIBSAIS_OPENMP)
    #pragma omp parallel num_threads(threads) if(threads > 1 && n >= 65536)
#endif
	{
		...
		if(omp_num_threads == 1) {
		...
		else {
			{
				thread_state[omp_thread_num].state.position = omp_block_start;
				thread_state[omp_thread_num].state.count =
				    libsais64_partial_sorting_gather_lms_suffixes_32s_1k(SA, omp_block_start, omp_block_size) - omp_block_start;
			}
...
static void libsais64_induce_partial_order_8u_omp(const uint8_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t first_lms_suffix,
...
static void libsais64_induce_partial_order_32s_6k_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t k,
    sa_sint_t * _RESTRICT buckets,
...
static void libsais64_induce_partial_order_32s_4k_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t k,
    sa_sint_t * _RESTRICT buckets,
...
static void libsais64_induce_partial_order_32s_2k_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t k,
    sa_sint_t * _RESTRICT buckets,
...
static void libsais64_induce_partial_order_32s_1k_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t k,
    sa_sint_t * _RESTRICT buckets,
...
static sa_sint_t libsais64_renumber_lms_suffixes_8u(sa_sint_t * _RESTRICT SA, sa_sint_t m, sa_sint_t name, fast_sint_t omp_block_start, fast_sint_t omp_block_size)
{
	const fast_sint_t prefetch_distance = 32;
...
static fast_sint_t libsais64_gather_marked_suffixes_8u(sa_sint_t * _RESTRICT SA, sa_sint_t m, fast_sint_t l, fast_sint_t omp_block_start, fast_sint_t omp_block_size)
{
	const fast_sint_t prefetch_distance = 32;
...
static sa_sint_t libsais64_renumber_lms_suffixes_8u_omp(sa_sint_t * _RESTRICT SA, sa_sint_t m, sa_sint_t threads, LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
	sa_sint_t name = 0;
...
static void libsais64_gather_marked_lms_suffixes_8u_omp(sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t m,
    sa_sint_t fs,
    sa_sint_t threads,
    LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
...
#endif
	{
		...
		if(omp_num_threads == 1) {
			...
			{
				if(omp_thread_num < omp_num_threads - 1) {
					thread_state[omp_thread_num].state.position = libsais64_gather_marked_suffixes_8u(SA,
						m,
...
static sa_sint_t libsais64_renumber_and_gather_lms_suffixes_8u_omp(sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t m,
    sa_sint_t fs,
    sa_sint_t threads,
...
static sa_sint_t libsais64_renumber_distinct_lms_suffixes_32s_4k(sa_sint_t * _RESTRICT SA, sa_sint_t m, sa_sint_t name, fast_sint_t omp_block_start, fast_sint_t omp_block_size)
{
	const fast_sint_t prefetch_distance = 32;
...
static void libsais64_mark_distinct_lms_suffixes_32s(sa_sint_t * _RESTRICT SA, sa_sint_t m, fast_sint_t omp_block_start, fast_sint_t omp_block_size)
{
	const fast_sint_t prefetch_distance = 32;
...
static void libsais64_clamp_lms_suffixes_length_32s(sa_sint_t * _RESTRICT SA, sa_sint_t m, fast_sint_t omp_block_start, fast_sint_t omp_block_size)
{
	const fast_sint_t prefetch_distance = 32;
...
static sa_sint_t libsais64_renumber_distinct_lms_suffixes_32s_4k_omp(sa_sint_t * _RESTRICT SA, sa_sint_t m, sa_sint_t threads, LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
	sa_sint_t name = 0;
...
static void libsais64_mark_distinct_lms_suffixes_32s_omp(sa_sint_t * _RESTRICT SA, sa_sint_t n, sa_sint_t m, sa_sint_t threads)
{
#if defined(LIBSAIS_OPENMP)
    #pragma omp parallel num_threads(threads) if(threads > 1 && n >= 131072)
#endif
...
static void libsais64_clamp_lms_suffixes_length_32s_omp(sa_sint_t * _RESTRICT SA, sa_sint_t n, sa_sint_t m, sa_sint_t threads)
{
#if defined(LIBSAIS_OPENMP)
    #pragma omp parallel num_threads(threads) if(threads > 1 && n >= 131072)
#endif
...
static sa_sint_t libsais64_renumber_and_mark_distinct_lms_suffixes_32s_4k_omp(sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t m,
    sa_sint_t threads,
    LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
...
static sa_sint_t libsais64_renumber_and_mark_distinct_lms_suffixes_32s_1k_omp(sa_sint_t * _RESTRICT T, sa_sint_t * _RESTRICT SA, sa_sint_t n, sa_sint_t m, sa_sint_t threads)
{
	const fast_sint_t prefetch_distance = 32;
...
static void libsais64_reconstruct_lms_suffixes(sa_sint_t * _RESTRICT SA, sa_sint_t n, sa_sint_t m, fast_sint_t omp_block_start, fast_sint_t omp_block_size)
{
	const fast_sint_t prefetch_distance = 32;
...
static void libsais64_reconstruct_lms_suffixes_omp(sa_sint_t * _RESTRICT SA, sa_sint_t n, sa_sint_t m, sa_sint_t threads)
{
#if defined(LIBSAIS_OPENMP)
    #pragma omp parallel num_threads(threads) if(threads > 1 && m >= 65536)
#endif
...
static void libsais64_place_lms_suffixes_interval_8u(sa_sint_t * _RESTRICT SA, sa_sint_t n, sa_sint_t m, const sa_sint_t * _RESTRICT buckets)
{
...
static void libsais64_place_lms_suffixes_interval_32s_4k(sa_sint_t * _RESTRICT SA, sa_sint_t n, sa_sint_t k, sa_sint_t m, const sa_sint_t * _RESTRICT buckets)
{
...
static void libsais64_place_lms_suffixes_interval_32s_2k(sa_sint_t * _RESTRICT SA, sa_sint_t n, sa_sint_t k, sa_sint_t m, const sa_sint_t * _RESTRICT buckets)
{
	fast_sint_t j = n;
	if(k > 1) {
		fast_sint_t c;
...
static void libsais64_place_lms_suffixes_interval_32s_1k(const sa_sint_t * _RESTRICT T, sa_sint_t * _RESTRICT SA, sa_sint_t k, sa_sint_t m, sa_sint_t * _RESTRICT buckets)
{
	const fast_sint_t prefetch_distance = 32;
	...
	for(i = (fast_sint_t)m - 1; i >= prefetch_distance + 3; i -= 4) {
		...
		sa_sint_t p0 = SA[i - 0]; if(T[p0] != c) {
			c = T[p0]; 
			memzero(&SA[buckets[c]], (size_t)(l - buckets[c]) * sizeof(sa_sint_t)); l = buckets[c];
		}
		SA[--l] = p0;
...
static void libsais64_place_lms_suffixes_histogram_32s_6k(sa_sint_t * _RESTRICT SA, sa_sint_t n, sa_sint_t k, sa_sint_t m, const sa_sint_t * _RESTRICT buckets)
{
...
static void libsais64_place_lms_suffixes_histogram_32s_4k(sa_sint_t * _RESTRICT SA, sa_sint_t n, sa_sint_t k, sa_sint_t m, const sa_sint_t * _RESTRICT buckets)
{
	const sa_sint_t * _RESTRICT bucket_end = &buckets[3 * (fast_sint_t)k];
...
static void libsais64_place_lms_suffixes_histogram_32s_2k(sa_sint_t * _RESTRICT SA, sa_sint_t n, sa_sint_t k, sa_sint_t m, const sa_sint_t * _RESTRICT buckets)
{
	fast_sint_t j = n;
...
static void libsais64_final_bwt_scan_left_to_right_8u(const uint8_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT induction_bucket,
    fast_sint_t omp_block_start,
    fast_sint_t omp_block_size)
{
	...
	for(i = omp_block_start, j = omp_block_start + omp_block_size - prefetch_distance - 1; i < j; i += 2) {
		...
		sa_sint_t s0 = SA[i + prefetch_distance + 0]; const uint8_t * Ts0 = &T[s0] - 1; libsais64_prefetchr(s0 > 0 ? Ts0 : NULL); Ts0--; libsais64_prefetchr(
			s0 > 0 ? Ts0 : NULL);
		sa_sint_t s1 = SA[i + prefetch_distance + 1]; const uint8_t * Ts1 = &T[s1] - 1; libsais64_prefetchr(s1 > 0 ? Ts1 : NULL); Ts1--; libsais64_prefetchr(
			s1 > 0 ? Ts1 : NULL);
...
static void libsais64_final_bwt_aux_scan_left_to_right_8u(const uint8_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t rm,
...
static void libsais64_final_sorting_scan_left_to_right_8u(const uint8_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT induction_bucket,
    fast_sint_t omp_block_start,
    fast_sint_t omp_block_size)
...
static void libsais64_final_sorting_scan_left_to_right_32s(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT induction_bucket,
    fast_sint_t omp_block_start,
    fast_sint_t omp_block_size)
...
static fast_sint_t libsais64_final_bwt_scan_left_to_right_8u_block_prepare(const uint8_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT buckets,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t omp_block_start,
...
static fast_sint_t libsais64_final_sorting_scan_left_to_right_8u_block_prepare(const uint8_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT buckets,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t omp_block_start,
...
static void libsais64_final_order_scan_left_to_right_8u_block_place(sa_sint_t * _RESTRICT SA, sa_sint_t * _RESTRICT buckets, LIBSAIS_THREAD_CACHE * _RESTRICT cache, fast_sint_t count)
{
	const fast_sint_t prefetch_distance = 32;
...
static void libsais64_final_bwt_aux_scan_left_to_right_8u_block_place(sa_sint_t * _RESTRICT SA,
    sa_sint_t rm,
    sa_sint_t * _RESTRICT I,
    sa_sint_t * _RESTRICT buckets,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
...
static void libsais64_final_sorting_scan_left_to_right_32s_block_gather(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t omp_block_start,
    fast_sint_t omp_block_size)
...
static void libsais64_final_sorting_scan_left_to_right_32s_block_sort(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT induction_bucket,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t omp_block_start,
    fast_sint_t omp_block_size)
...
static void libsais64_final_bwt_scan_left_to_right_8u_block_omp(const uint8_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT induction_bucket,
    fast_sint_t block_start,
    fast_sint_t block_size,
    ...
    LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
...
#endif
	{
		...
		if(omp_num_threads == 1) {
			...
			{
				thread_state[omp_thread_num].state.count = libsais64_final_bwt_scan_left_to_right_8u_block_prepare(T,
					SA,
					thread_state[omp_thread_num].state.buckets,
					thread_state[omp_thread_num].state.cache,
					omp_block_start,
	    ...
	    #pragma omp barrier
			...
			{
				libsais64_final_order_scan_left_to_right_8u_block_place(SA,
				    thread_state[omp_thread_num].state.buckets,
				    thread_state[omp_thread_num].state.cache,
				    thread_state[omp_thread_num].state.count);
			}
...
static void libsais64_final_bwt_aux_scan_left_to_right_8u_block_omp(const uint8_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t rm,
    sa_sint_t * _RESTRICT I,
    sa_sint_t * _RESTRICT induction_bucket,
    ...
    LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
...
#endif
	{
	    ...
	    #pragma omp barrier
			...
			{
				libsais64_final_bwt_aux_scan_left_to_right_8u_block_place(SA,
				    rm,
				    I,
				    thread_state[omp_thread_num].state.buckets,
				    thread_state[omp_thread_num].state.cache,
...
static void libsais64_final_sorting_scan_left_to_right_8u_block_omp(const uint8_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT induction_bucket,
    fast_sint_t block_start,
    fast_sint_t block_size,
    ...
    LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
...
#endif
	{
		...
		if(omp_num_threads == 1) {
			...
			{
				thread_state[omp_thread_num].state.count = libsais64_final_sorting_scan_left_to_right_8u_block_prepare(T,
					SA,
					thread_state[omp_thread_num].state.buckets,
					thread_state[omp_thread_num].state.cache,
					omp_block_start,
...
static void libsais64_final_sorting_scan_left_to_right_32s_block_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT buckets,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t block_start,
...
static void libsais64_final_bwt_scan_left_to_right_8u_omp(const uint8_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    fast_sint_t n,
    sa_sint_t * _RESTRICT induction_bucket,
    sa_sint_t threads,
...
static void libsais64_final_bwt_aux_scan_left_to_right_8u_omp(const uint8_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    fast_sint_t n,
    sa_sint_t rm,
    sa_sint_t * _RESTRICT I,
...
static void libsais64_final_sorting_scan_left_to_right_8u_omp(const uint8_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    fast_sint_t n,
    sa_sint_t * _RESTRICT induction_bucket,
    sa_sint_t threads,
...
static void libsais64_final_sorting_scan_left_to_right_32s_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t * _RESTRICT induction_bucket,
    sa_sint_t threads,
    LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
	...
	if(threads == 1 || n < 65536) {
		...
		for(block_start = 0; block_start < n; block_start = block_end) {
			...
			libsais64_final_sorting_scan_left_to_right_32s_block_omp(T, SA, induction_bucket, thread_state[0].state.cache, block_start, block_end - block_start,
			    threads);
		}
	}
#else
...
static sa_sint_t libsais64_final_bwt_scan_right_to_left_8u(const uint8_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT induction_bucket,
    fast_sint_t omp_block_start,
    fast_sint_t omp_block_size)
{
	...
	for(i = omp_block_start + omp_block_size - 1, j = omp_block_start + prefetch_distance + 1; i >= j; i -= 2) {
		...
		SA[i - 0] = p0 & SAINT_MAX; if(p0 > 0) {
			p0--; uint8_t c0 = T[p0 - (p0 > 0)], c1 = T[p0]; SA[i - 0] = c1; sa_sint_t t = c0 | SAINT_MIN; SA[--induction_bucket[c1]] = (c0 <= c1) ? p0 : t;
		}

		sa_sint_t p1 = SA[i - 1]; index = (p1 == 0) ? (sa_sint_t)(i - 1) : index;
		SA[i - 1] = p1 & SAINT_MAX; if(p1 > 0) {
			p1--; uint8_t c0 = T[p1 - (p1 > 0)], c1 = T[p1]; SA[i - 1] = c1; sa_sint_t t = c0 | SAINT_MIN; SA[--induction_bucket[c1]] = (c0 <= c1) ? p1 : t;
		}
	}
	...
	for(j -= prefetch_distance + 1; i >= j; i -= 1) {
		...
		SA[i] = p & SAINT_MAX; if(p > 0) {
			p--; uint8_t c0 = T[p - (p > 0)], c1 = T[p]; SA[i] = c1; sa_sint_t t = c0 | SAINT_MIN; SA[--induction_bucket[c1]] = (c0 <= c1) ? p : t;
		}
	}
...
static void libsais64_final_bwt_aux_scan_right_to_left_8u(const uint8_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t rm,
    sa_sint_t * _RESTRICT I,
    sa_sint_t * _RESTRICT induction_bucket,
    ...
    fast_sint_t omp_block_size)
{
	...
	for(j -= prefetch_distance + 1; i >= j; i -= 1) {
		sa_sint_t p = SA[i];
		SA[i] = p & SAINT_MAX; if(p > 0) {
			p--; uint8_t c0 = T[p - (p > 0)], c1 = T[p]; SA[i] = c1; sa_sint_t t = c0 | SAINT_MIN; SA[--induction_bucket[c1]] = (c0 <= c1) ? p : t; if((p & rm) == 0) {
...
static void libsais64_final_sorting_scan_right_to_left_8u(const uint8_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT induction_bucket,
    fast_sint_t omp_block_start,
    fast_sint_t omp_block_size)
...
static void libsais64_final_sorting_scan_right_to_left_32s(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT induction_bucket,
    fast_sint_t omp_block_start,
    fast_sint_t omp_block_size)
...
static fast_sint_t libsais64_final_bwt_scan_right_to_left_8u_block_prepare(const uint8_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT buckets,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t omp_block_start,
    fast_sint_t omp_block_size)
{
	...
	for(i = omp_block_start + omp_block_size - 1, j = omp_block_start + prefetch_distance + 1; i >= j; i -= 2) {
		...
		sa_sint_t p0 = SA[i - 0]; SA[i - 0] = p0 & SAINT_MAX; if(p0 > 0) {
			p0--; uint8_t c0 = T[p0 - (p0 > 0)], c1 = T[p0]; SA[i - 0] = c1; sa_sint_t t = c0 | SAINT_MIN; buckets[cache[count].symbol = c1]++;
			cache[count++].index = (c0 <= c1) ? p0 : t;
		}
		sa_sint_t p1 = SA[i - 1]; SA[i - 1] = p1 & SAINT_MAX; if(p1 > 0) {
			p1--; uint8_t c0 = T[p1 - (p1 > 0)], c1 = T[p1]; SA[i - 1] = c1; sa_sint_t t = c0 | SAINT_MIN; buckets[cache[count].symbol = c1]++;
	...
	for(j -= prefetch_distance + 1; i >= j; i -= 1) {
		sa_sint_t p = SA[i]; SA[i] = p & SAINT_MAX; if(p > 0) {
			p--; uint8_t c0 = T[p - (p > 0)], c1 = T[p]; SA[i] = c1; sa_sint_t t = c0 | SAINT_MIN; buckets[cache[count].symbol = c1]++;
...
static fast_sint_t libsais64_final_bwt_aux_scan_right_to_left_8u_block_prepare(const uint8_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT buckets,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t omp_block_start,
...
static fast_sint_t libsais64_final_sorting_scan_right_to_left_8u_block_prepare(const uint8_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT buckets,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t omp_block_start,
...
static void libsais64_final_order_scan_right_to_left_8u_block_place(sa_sint_t * _RESTRICT SA, sa_sint_t * _RESTRICT buckets, LIBSAIS_THREAD_CACHE * _RESTRICT cache, fast_sint_t count)
{
	const fast_sint_t prefetch_distance = 32;
...
static void libsais64_final_bwt_aux_scan_right_to_left_8u_block_place(sa_sint_t * _RESTRICT SA,
    sa_sint_t rm,
    sa_sint_t * _RESTRICT I,
    sa_sint_t * _RESTRICT buckets,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
...
static void libsais64_final_sorting_scan_right_to_left_32s_block_gather(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t omp_block_start,
    fast_sint_t omp_block_size)
...
static void libsais64_final_sorting_scan_right_to_left_32s_block_sort(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT induction_bucket,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t omp_block_start,
    fast_sint_t omp_block_size)
...
static void libsais64_final_bwt_scan_right_to_left_8u_block_omp(const uint8_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT induction_bucket,
    fast_sint_t block_start,
    fast_sint_t block_size,
    ...
    LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
...
#endif
	{
		...
		if(omp_num_threads == 1) {
			...
			{
				thread_state[omp_thread_num].state.count = libsais64_final_bwt_scan_right_to_left_8u_block_prepare(T,
					SA,
					thread_state[omp_thread_num].state.buckets,
					thread_state[omp_thread_num].state.cache,
					omp_block_start,
	    ...
	    #pragma omp barrier
			...
			{
				libsais64_final_order_scan_right_to_left_8u_block_place(SA,
				    thread_state[omp_thread_num].state.buckets,
				    thread_state[omp_thread_num].state.cache,
				    thread_state[omp_thread_num].state.count);
			}
...
static void libsais64_final_bwt_aux_scan_right_to_left_8u_block_omp(const uint8_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t rm,
    sa_sint_t * _RESTRICT I,
    sa_sint_t * _RESTRICT induction_bucket,
    ...
    LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
...
#endif
	{
		...
		if(omp_num_threads == 1) {
			...
			{
				thread_state[omp_thread_num].state.count = libsais64_final_bwt_aux_scan_right_to_left_8u_block_prepare(T,
					SA,
					thread_state[omp_thread_num].state.buckets,
					thread_state[omp_thread_num].state.cache,
					omp_block_start,
	    ...
	    #pragma omp barrier
			...
			{
				libsais64_final_bwt_aux_scan_right_to_left_8u_block_place(SA,
				    rm,
				    I,
				    thread_state[omp_thread_num].state.buckets,
				    thread_state[omp_thread_num].state.cache,
...
static void libsais64_final_sorting_scan_right_to_left_8u_block_omp(const uint8_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT induction_bucket,
    fast_sint_t block_start,
    fast_sint_t block_size,
    ...
    LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
...
#endif
	{
		...
		if(omp_num_threads == 1) {
			...
			{
				thread_state[omp_thread_num].state.count = libsais64_final_sorting_scan_right_to_left_8u_block_prepare(T,
					SA,
					thread_state[omp_thread_num].state.buckets,
					thread_state[omp_thread_num].state.cache,
					omp_block_start,
...
static void libsais64_final_sorting_scan_right_to_left_32s_block_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT buckets,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t block_start,
...
static sa_sint_t libsais64_final_bwt_scan_right_to_left_8u_omp(const uint8_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t * _RESTRICT induction_bucket,
    sa_sint_t threads,
		...
		for(block_start = (fast_sint_t)n - 1; block_start >= 0; ) {
			if(SA[block_start] == 0) {
				...
				if(block_size < 32) {
					for(; block_start > block_end; block_start -= 1) {
						sa_sint_t p = SA[block_start]; SA[block_start] = p & SAINT_MAX; if(p > 0) {
							p--; uint8_t c0 = T[p - (p > 0)], c1 = T[p]; SA[block_start] = c1; sa_sint_t t = c0 | SAINT_MIN;
...
static void libsais64_final_bwt_aux_scan_right_to_left_8u_omp(const uint8_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t rm,
    sa_sint_t * _RESTRICT I,
...
static void libsais64_final_sorting_scan_right_to_left_8u_omp(const uint8_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t * _RESTRICT induction_bucket,
    sa_sint_t threads,
...
static void libsais64_final_sorting_scan_right_to_left_32s_omp(const sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t * _RESTRICT induction_bucket,
    sa_sint_t threads,
    LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
	if(threads == 1 || n < 65536) {
		...
		for(block_start = (fast_sint_t)n - 1; block_start >= 0; block_start = block_end) {
			...
			libsais64_final_sorting_scan_right_to_left_32s_block_omp(T,
			    SA,
			    induction_bucket,
			    thread_state[0].state.cache,
			    block_end + 1,
...
static void libsais64_clear_lms_suffixes_omp(sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t k,
...
static sa_sint_t libsais64_induce_final_order_8u_omp(const uint8_t * _RESTRICT T, sa_sint_t * _RESTRICT SA,
    sa_sint_t n, sa_sint_t bwt, sa_sint_t r, sa_sint_t * _RESTRICT I, sa_sint_t * _RESTRICT buckets, sa_sint_t threads, LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
	if(!bwt) {
		libsais64_final_sorting_scan_left_to_right_8u_omp(T, SA, n, &buckets[6 * ALPHABET_SIZE], threads, thread_state);
		if(threads > 1 && n >= 65536) {
			libsais64_clear_lms_suffixes_omp(SA, n, ALPHABET_SIZE, &buckets[6 * ALPHABET_SIZE], &buckets[7 * ALPHABET_SIZE], threads);
		}
...
static void libsais64_induce_final_order_32s_6k(const sa_sint_t * _RESTRICT T, sa_sint_t * _RESTRICT SA,
    sa_sint_t n, sa_sint_t k, sa_sint_t * _RESTRICT buckets, sa_sint_t threads, LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
...
static void libsais64_induce_final_order_32s_4k(const sa_sint_t * _RESTRICT T, sa_sint_t * _RESTRICT SA,
    sa_sint_t n, sa_sint_t k, sa_sint_t * _RESTRICT buckets, sa_sint_t threads, LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
...
static void libsais64_induce_final_order_32s_2k(const sa_sint_t * _RESTRICT T, sa_sint_t * _RESTRICT SA,
    sa_sint_t n, sa_sint_t k, sa_sint_t * _RESTRICT buckets, sa_sint_t threads, LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
...
static void libsais64_induce_final_order_32s_1k(const sa_sint_t * _RESTRICT T, sa_sint_t * _RESTRICT SA,
    sa_sint_t n, sa_sint_t k, sa_sint_t * _RESTRICT buckets, sa_sint_t threads, LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
	libsais64_count_suffixes_32s(T, n, k, buckets);
	libsais64_initialize_buckets_start_32s_1k(k, buckets);
...
static sa_sint_t libsais64_renumber_unique_and_nonunique_lms_suffixes_32s(sa_sint_t * _RESTRICT T, sa_sint_t * _RESTRICT SA,
    sa_sint_t m, sa_sint_t f, fast_sint_t omp_block_start, fast_sint_t omp_block_size)
{
	const fast_sint_t prefetch_distance = 32;
	sa_sint_t * _RESTRICT SAm = &SA[m];
	sa_sint_t i, j;
...
static void libsais64_compact_unique_and_nonunique_lms_suffixes_32s(sa_sint_t * _RESTRICT SA,
    sa_sint_t m,
    fast_sint_t * pl,
    fast_sint_t * pr,
    fast_sint_t omp_block_start,
...
static sa_sint_t libsais64_count_unique_suffixes(sa_sint_t * _RESTRICT SA, sa_sint_t m, fast_sint_t omp_block_start, fast_sint_t omp_block_size)
{
	const fast_sint_t prefetch_distance = 32;
...
static sa_sint_t libsais64_renumber_unique_and_nonunique_lms_suffixes_32s_omp(sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t m,
    sa_sint_t threads,
    LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
...
static void libsais64_compact_unique_and_nonunique_lms_suffixes_32s_omp(sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t m,
    sa_sint_t fs,
    sa_sint_t f,
...
#endif
	{
		...
		if(omp_num_threads == 1) {
		...
		else {
			{
				...
				libsais64_compact_unique_and_nonunique_lms_suffixes_32s(SA,
				    m,
...
static sa_sint_t libsais64_compact_lms_suffixes_32s_omp(sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t m,
    sa_sint_t fs,
...
static void libsais64_merge_unique_lms_suffixes_32s(sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t m,
    fast_sint_t l,
...
static void libsais64_merge_nonunique_lms_suffixes_32s(sa_sint_t * _RESTRICT SA, sa_sint_t n, sa_sint_t m, fast_sint_t l, fast_sint_t omp_block_start, fast_sint_t omp_block_size)
{
	const fast_sint_t prefetch_distance = 32;
...
static void libsais64_merge_unique_lms_suffixes_32s_omp(sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t m,
    sa_sint_t threads,
...
static void libsais64_merge_nonunique_lms_suffixes_32s_omp(sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t m,
    sa_sint_t f,
    sa_sint_t threads,
...
static void libsais64_merge_compacted_lms_suffixes_32s_omp(sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t m,
    sa_sint_t f,
...
static void libsais64_reconstruct_compacted_lms_suffixes_32s_2k_omp(sa_sint_t * _RESTRICT T, sa_sint_t * _RESTRICT SA,
...
static void libsais64_reconstruct_compacted_lms_suffixes_32s_1k_omp(sa_sint_t * _RESTRICT T, sa_sint_t * _RESTRICT SA,
...
{
	fast_sint_t i, j; for(i = omp_block_start + omp_block_size - 1, j = omp_block_start; i >= j; i -= 1) {
		D[i] = (uint64_t)S[i];
	}
}

static void libsais64_convert_left_to_right_32u_to_64u(uint32_t * _RESTRICT S, uint64_t * _RESTRICT D, fast_sint_t omp_block_start, fast_sint_t omp_block_size)
{
	fast_sint_t i, j; for(i = omp_block_start, j = omp_block_start + omp_block_size; i < j; i += 1) {
		D[i] = (uint64_t)S[i];
	}
}
...
static sa_sint_t libsais64_main_32s(sa_sint_t * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t k,
    sa_sint_t fs,
    ...
    LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
	...
	if(k > 0 && fs / k >= 6) {
		...
		sa_sint_t * _RESTRICT buckets = (fs - alignment) / k >=
		    6 ? (sa_sint_t *)libsais64_align_up(&SA[n + fs - 6 * (fast_sint_t)k - alignment], (size_t)alignment * sizeof(sa_sint_t)) : &SA[n + fs - 6 * (fast_sint_t)k];
		...
		sa_sint_t * _RESTRICT buckets = (fs - alignment) / k >=
		    4 ? (sa_sint_t *)libsais64_align_up(&SA[n + fs - 4 * (fast_sint_t)k - alignment], (size_t)alignment * sizeof(sa_sint_t)) : &SA[n + fs - 4 * (fast_sint_t)k];
		...
		sa_sint_t * _RESTRICT buckets = (fs - alignment) / k >=
		    2 ? (sa_sint_t *)libsais64_align_up(&SA[n + fs - 2 * (fast_sint_t)k - alignment], (size_t)alignment * sizeof(sa_sint_t)) : &SA[n + fs - 2 * (fast_sint_t)k];
		...
		sa_sint_t * _RESTRICT buckets = fs - alignment >= k ? (sa_sint_t *)libsais64_align_up(&SA[n + fs - k - alignment], (size_t)alignment * sizeof(sa_sint_t)) : fs >= k ? &SA[n + fs - k] : buffer;
		if(!buckets) {
			return -2;
		}
		...
		if(m > 1) {
			...
			if(names < m) {
				if(buffer) {
					libsais64_free_aligned(buffer); buckets = NULL;
				}
				sa_sint_t f = libsais64_compact_lms_suffixes_32s_omp(T, SA, n, m, fs, threads, thread_state);
				if(libsais64_main_32s(SA + n + fs - m + f, SA, m - f, names - f, fs + n - 2 * m + f, threads, thread_state) != 0) {
					return -2;
				...
				if(!buckets) {
					buckets = buffer = (sa_sint_t *)libsais64_alloc_aligned((size_t)k * sizeof(sa_sint_t), 4096);
				}
				if(!buckets) {
					return -2;
				}
...
static sa_sint_t libsais64_main_8u(const uint8_t * T,
    sa_sint_t * SA,
    sa_sint_t n,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t bwt,
...
{
	LIBSAIS_THREAD_STATE *  _RESTRICT thread_state   = threads > 1 ? libsais64_alloc_thread_state(threads) : NULL;
	sa_sint_t *             _RESTRICT buckets        = (sa_sint_t *)libsais64_alloc_aligned(8 * ALPHABET_SIZE * sizeof(sa_sint_t), 4096);
...
static void libsais64_bwt_copy_8u(uint8_t * _RESTRICT U, sa_sint_t * _RESTRICT A, sa_sint_t n)
{
	const fast_sint_t prefetch_distance = 32;
...
static void libsais64_bwt_copy_8u_omp(uint8_t * _RESTRICT U, sa_sint_t * _RESTRICT A, sa_sint_t n, sa_sint_t threads)
{
#if defined(LIBSAIS_OPENMP)
    #pragma omp parallel num_threads(threads) if(threads > 1 && n >= 65536)
#endif
...
int64_t libsais64(const uint8_t * T, int64_t * SA, int64_t n, int64_t fs, int64_t * freq)
{
	if((T == NULL) || (SA == NULL) || (n < 0) || (fs < 0)) {
		...
		if(freq) {
			memzero(freq, ALPHABET_SIZE * sizeof(int64_t));
		}
		if(n == 1) {
			SA[0] = 0; if(freq) {
				freq[T[0]]++;
	...
	if(n <= INT32_MAX) {
		...
		if(index >= 0) {
			...
			if(freq) {
				libsais64_convert_inplace_32u_to_64u_omp((uint32_t *)freq, (uint64_t *)freq, ALPHABET_SIZE, 1);
			}
		}
...
static void libsais64_unbwt_compute_histogram(const uint8_t * _RESTRICT T, fast_sint_t n, sa_uint_t * _RESTRICT count)
{
	const fast_sint_t prefetch_distance = 256;

	const uint8_t * _RESTRICT T_p = T;
	...
	if(n >= 1024) {
		...
		sa_uint_t * _RESTRICT copy3 = copy + 3 * (ALPHABET_SIZE + 16);
		...
		fast_uint_t i; for(i = 0; i < ALPHABET_SIZE; i++) {
...
static void libsais64_unbwt_transpose_bucket2(sa_uint_t * _RESTRICT bucket2)
{
	fast_uint_t x, y, c, d;
...
static void libsais64_unbwt_compute_bigram_histogram_single(const uint8_t * _RESTRICT T, sa_uint_t * _RESTRICT bucket1, sa_uint_t * _RESTRICT bucket2, fast_uint_t index)
{
	fast_uint_t sum, c;
	for(sum = 1, c = 0; c < ALPHABET_SIZE; ++c) {
		fast_uint_t prev = sum; sum += bucket1[c]; bucket1[c] = (sa_uint_t)prev;
		if(prev != sum) {
			sa_uint_t * _RESTRICT bucket2_p = &bucket2[c << 8];

			{
				fast_uint_t hi = index; if(sum < hi) {
					hi = sum;
				}
			...
			{
				fast_uint_t lo = index + 1; if(prev > lo) {
					lo = prev;
				}
...
static void libsais64_unbwt_calculate_fastbits(sa_uint_t * _RESTRICT bucket2, uint16_t * _RESTRICT fastbits, fast_uint_t lastc, fast_uint_t shift)
{
...
static void libsais64_unbwt_calculate_biPSI(const uint8_t * _RESTRICT T,
    sa_uint_t * _RESTRICT P,
    sa_uint_t * _RESTRICT bucket1,
...
static void libsais64_unbwt_init_single(const uint8_t * _RESTRICT T,
    sa_uint_t * _RESTRICT P,
    sa_sint_t n,
...
static void libsais64_unbwt_compute_bigram_histogram_parallel(const uint8_t * _RESTRICT T,
    fast_uint_t index,
    sa_uint_t * _RESTRICT bucket1,
    sa_uint_t * _RESTRICT bucket2,
    fast_sint_t omp_block_start,
...
static void libsais64_unbwt_init_parallel(const uint8_t * _RESTRICT T,
    sa_uint_t * _RESTRICT P,
    sa_sint_t n,
    const sa_sint_t * freq,
    const sa_uint_t * _RESTRICT I,
    ...
    sa_sint_t threads)
{
    ...
    #pragma omp parallel num_threads(threads) if(threads > 1 && n >= 65536)
	{
		...
		if(omp_num_threads == 1) {
			...
			sa_uint_t * _RESTRICT bucket1_local  = buckets + omp_thread_num * (ALPHABET_SIZE + (ALPHABET_SIZE * ALPHABET_SIZE));
			sa_uint_t * _RESTRICT bucket2_local  = bucket1_local + ALPHABET_SIZE;
	    ...
	    #pragma omp master
			{
				{
					sa_uint_t * _RESTRICT bucket1_temp = buckets;

					fast_sint_t t;
					for(t = 0; t < omp_num_threads; ++t, bucket1_temp += ALPHABET_SIZE + (ALPHABET_SIZE * ALPHABET_SIZE)) {
						fast_sint_t c; for(c = 0; c < ALPHABET_SIZE; c += 1) {
							sa_uint_t A = bucket1[c], B = bucket1_temp[c]; bucket1[c] = A + B; bucket1_temp[c] = A;
						}
					}
				}
	    ...
	    #pragma omp barrier

			{
				...
				sa_uint_t * _RESTRICT bucket2_temp = buckets + ALPHABET_SIZE;

				fast_sint_t t;
				for(t = 0; t < omp_num_threads; ++t, bucket2_temp += ALPHABET_SIZE + (ALPHABET_SIZE * ALPHABET_SIZE)) {
					fast_sint_t c; for(c = omp_bucket2_start; c < omp_bucket2_start + omp_bucket2_size; c += 1) {
	    ...
	    #pragma omp master
			{
...

				{
					...
					for(t = omp_num_threads - 1; t >= 1; --t) {
						sa_uint_t * _RESTRICT dst_bucket1 = buckets + t * (ALPHABET_SIZE + (ALPHABET_SIZE * ALPHABET_SIZE));
						sa_uint_t * _RESTRICT src_bucket1 = dst_bucket1 - (ALPHABET_SIZE + (ALPHABET_SIZE * ALPHABET_SIZE));
	    ...
	    #pragma omp barrier
			...
			{
				fast_sint_t c; for(c = 0; c < ALPHABET_SIZE * ALPHABET_SIZE; c += 1) {
	    ...
	    #pragma omp master
			{
				memcpy(bucket2,
				    buckets + ALPHABET_SIZE + (omp_num_threads - 1) * (ALPHABET_SIZE + (ALPHABET_SIZE * ALPHABET_SIZE)),
...
static void libsais64_unbwt_decode_1(uint8_t * _RESTRICT U,
    sa_uint_t * _RESTRICT P,
    sa_uint_t * _RESTRICT bucket2,
    uint16_t * _RESTRICT fastbits,
    fast_uint_t shift,
    ...
    fast_uint_t k)
{
	uint16_t * _RESTRICT U0 = (uint16_t *)(void *)U;
	...
	for(i = 0; i != k; ++i) {
		...
		p0 = P[p0]; U0[i] = libsais64_bswap16(c0);
	}

	*i0 = p0;
}

static void libsais64_unbwt_decode_2(uint8_t * _RESTRICT U,
    sa_uint_t * _RESTRICT P,
    sa_uint_t * _RESTRICT bucket2,
    uint16_t * _RESTRICT fastbits,
    fast_uint_t shift,
...
{
	uint16_t * _RESTRICT U0 = (uint16_t *)(void *)U;
	uint16_t * _RESTRICT U1 = (uint16_t *)(void *)(((uint8_t *)U0) + r);
	...
	for(i = 0; i != k; ++i) {
		...
		p1 = P[p1]; U1[i] = libsais64_bswap16(c1);
	}

	*i0 = p0; *i1 = p1;
}

static void libsais64_unbwt_decode_3(uint8_t * _RESTRICT U,
    sa_uint_t * _RESTRICT P,
    sa_uint_t * _RESTRICT bucket2,
    uint16_t * _RESTRICT fastbits,
    fast_uint_t shift,
    ...
    fast_uint_t k)
{
	uint16_t * _RESTRICT U0 = (uint16_t *)(void *)U;
	uint16_t * _RESTRICT U1 = (uint16_t *)(void *)(((uint8_t *)U0) + r);
	uint16_t * _RESTRICT U2 = (uint16_t *)(void *)(((uint8_t *)U1) + r);
	...
	for(i = 0; i != k; ++i) {
		...
		p2 = P[p2]; U2[i] = libsais64_bswap16(c2);
	}

	*i0 = p0; *i1 = p1; *i2 = p2;
}

static void libsais64_unbwt_decode_4(uint8_t * _RESTRICT U,
    sa_uint_t * _RESTRICT P,
    sa_uint_t * _RESTRICT bucket2,
    uint16_t * _RESTRICT fastbits,
    fast_uint_t shift,
    ...
    fast_uint_t k)
{
	...
	uint16_t * _RESTRICT U1 = (uint16_t *)(void *)(((uint8_t *)U0) + r);
	uint16_t * _RESTRICT U2 = (uint16_t *)(void *)(((uint8_t *)U1) + r);
	uint16_t * _RESTRICT U3 = (uint16_t *)(void *)(((uint8_t *)U2) + r);
	...
	for(i = 0; i != k; ++i) {
		...
		p3 = P[p3]; U3[i] = libsais64_bswap16(c3);
	}

	*i0 = p0; *i1 = p1; *i2 = p2; *i3 = p3;
}

static void libsais64_unbwt_decode_5(uint8_t * _RESTRICT U,
    sa_uint_t * _RESTRICT P,
    sa_uint_t * _RESTRICT bucket2,
    uint16_t * _RESTRICT fastbits,
    fast_uint_t shift,
    ...
    fast_uint_t k)
{
	...
	uint16_t * _RESTRICT U2 = (uint16_t *)(void *)(((uint8_t *)U1) + r);
	uint16_t * _RESTRICT U3 = (uint16_t *)(void *)(((uint8_t *)U2) + r);
	uint16_t * _RESTRICT U4 = (uint16_t *)(void *)(((uint8_t *)U3) + r);
	...
	for(i = 0; i != k; ++i) {
		...
		p4 = P[p4]; U4[i] = libsais64_bswap16(c4);
	}

	*i0 = p0; *i1 = p1; *i2 = p2; *i3 = p3; *i4 = p4;
}

static void libsais64_unbwt_decode_6(uint8_t * _RESTRICT U,
    sa_uint_t * _RESTRICT P,
    sa_uint_t * _RESTRICT bucket2,
    uint16_t * _RESTRICT fastbits,
    fast_uint_t shift,
    ...
    fast_uint_t k)
{
	...
	uint16_t * _RESTRICT U3 = (uint16_t *)(void *)(((uint8_t *)U2) + r);
	uint16_t * _RESTRICT U4 = (uint16_t *)(void *)(((uint8_t *)U3) + r);
	uint16_t * _RESTRICT U5 = (uint16_t *)(void *)(((uint8_t *)U4) + r);
	...
	for(i = 0; i != k; ++i) {
		...
		p5 = P[p5]; U5[i] = libsais64_bswap16(c5);
	}
	*i0 = p0; *i1 = p1; *i2 = p2; *i3 = p3; *i4 = p4; *i5 = p5;
}

static void libsais64_unbwt_decode_7(uint8_t * _RESTRICT U, sa_uint_t * _RESTRICT P, sa_uint_t * _RESTRICT bucket2, uint16_t * _RESTRICT fastbits,
    fast_uint_t shift, fast_uint_t r, fast_uint_t * i0, fast_uint_t * i1, fast_uint_t * i2, fast_uint_t * i3, fast_uint_t * i4, fast_uint_t * i5,
    fast_uint_t * i6, fast_uint_t k)
{
	uint16_t * _RESTRICT U0 = (uint16_t *)(void *)U;
	uint16_t * _RESTRICT U1 = (uint16_t *)(void *)(((uint8_t *)U0) + r);
	uint16_t * _RESTRICT U2 = (uint16_t *)(void *)(((uint8_t *)U1) + r);
	...
	uint16_t * _RESTRICT U4 = (uint16_t *)(void *)(((uint8_t *)U3) + r);
	uint16_t * _RESTRICT U5 = (uint16_t *)(void *)(((uint8_t *)U4) + r);
	uint16_t * _RESTRICT U6 = (uint16_t *)(void *)(((uint8_t *)U5) + r);
	...
	for(i = 0; i != k; ++i) {
		...
		p6 = P[p6]; U6[i] = libsais64_bswap16(c6);
	}
	*i0 = p0; *i1 = p1; *i2 = p2; *i3 = p3; *i4 = p4; *i5 = p5; *i6 = p6;
}

static void libsais64_unbwt_decode_8(uint8_t * _RESTRICT U, sa_uint_t * _RESTRICT P, sa_uint_t * _RESTRICT bucket2, uint16_t * _RESTRICT fastbits,
    fast_uint_t shift, fast_uint_t r, fast_uint_t * i0, fast_uint_t * i1, fast_uint_t * i2, fast_uint_t * i3, fast_uint_t * i4, fast_uint_t * i5,
    fast_uint_t * i6, fast_uint_t * i7, fast_uint_t k)
{
	uint16_t * _RESTRICT U0 = (uint16_t *)(void *)U;
	uint16_t * _RESTRICT U1 = (uint16_t *)(void *)(((uint8_t *)U0) + r);
	uint16_t * _RESTRICT U2 = (uint16_t *)(void *)(((uint8_t *)U1) + r);
	...
	uint16_t * _RESTRICT U5 = (uint16_t *)(void *)(((uint8_t *)U4) + r);
	uint16_t * _RESTRICT U6 = (uint16_t *)(void *)(((uint8_t *)U5) + r);
	uint16_t * _RESTRICT U7 = (uint16_t *)(void *)(((uint8_t *)U6) + r);
	...
	for(i = 0; i != k; ++i) {
		...
		p7 = P[p7]; U7[i] = libsais64_bswap16(c7);
	}

	*i0 = p0; *i1 = p1; *i2 = p2; *i3 = p3; *i4 = p4; *i5 = p5; *i6 = p6; *i7 = p7;
}

static void libsais64_unbwt_decode(uint8_t * _RESTRICT U,
    sa_uint_t * _RESTRICT P,
    sa_sint_t n,
    sa_sint_t r,
    const sa_uint_t * _RESTRICT I,
    ...
    fast_uint_t remainder)
{
	...
	if(blocks == 1) {
		...
		libsais64_unbwt_decode_4(U + offset + 2 * (remainder >> 1),
		    P,
		    bucket2,
		    fastbits,
		    shift,
		...
		libsais64_unbwt_decode_5(U + offset + 2 * (remainder >> 1), P, bucket2, fastbits, shift, (fast_uint_t)r, &i0, &i1, &i2, &i3, &i4,
		    ((fast_uint_t)r >> 1) - (remainder >> 1));
	}
	else if(blocks == 7) {
		...
		libsais64_unbwt_decode_6(U + offset + 2 * (remainder >> 1), P, bucket2, fastbits, shift, (fast_uint_t)r, &i0, &i1, &i2, &i3, &i4, &i5,
		    ((fast_uint_t)r >> 1) - (remainder >> 1));
	}
	else {
		fast_uint_t i0 = I[0], i1 = I[1], i2 = I[2], i3 = I[3], i4 = I[4], i5 = I[5], i6 = I[6], i7 = I[7];
		libsais64_unbwt_decode_8(U + offset, P, bucket2, fastbits, shift, (fast_uint_t)r, &i0, &i1, &i2, &i3, &i4, &i5, &i6, &i7, remainder >> 1);
		libsais64_unbwt_decode_7(U + offset + 2 * (remainder >> 1),
		    P,
		    bucket2,
		    fastbits,
		    shift,
...
static void libsais64_unbwt_decode_omp(const uint8_t * _RESTRICT T,
    uint8_t * _RESTRICT U,
    sa_uint_t * _RESTRICT P,
    sa_sint_t n,
    sa_sint_t r,
    ...
    sa_sint_t threads)
{
...
#endif
	{
		...
		libsais64_unbwt_decode(U + r * omp_block_start,
		    P,
		    n,
		    r,
		    I + omp_block_start,
...
static sa_sint_t libsais64_unbwt_core(const uint8_t * _RESTRICT T,
    uint8_t * _RESTRICT U,
    sa_uint_t * _RESTRICT P,
    sa_sint_t n,
    const sa_sint_t * freq,
...
static sa_sint_t libsais64_unbwt_main(const uint8_t * T, uint8_t * U, sa_uint_t * P, sa_sint_t n, const sa_sint_t * freq, sa_sint_t r, const sa_uint_t * I, sa_sint_t threads)
{
	...
	sa_uint_t *     _RESTRICT bucket2        = (sa_uint_t *)libsais64_alloc_aligned(ALPHABET_SIZE * ALPHABET_SIZE * sizeof(sa_uint_t), 4096);
	uint16_t *      _RESTRICT fastbits       = (uint16_t *)libsais64_alloc_aligned(((size_t)1 + (size_t)(n >> shift)) * sizeof(uint16_t), 4096);
	sa_uint_t *     _RESTRICT buckets        = threads > 1 &&
	    n >= 262144 ? (sa_uint_t *)libsais64_alloc_aligned((size_t)threads * (ALPHABET_SIZE + (ALPHABET_SIZE * ALPHABET_SIZE)) * sizeof(sa_uint_t), 4096) : NULL;
...
int64_t libsais64_unbwt_aux(const uint8_t * T, uint8_t * U, int64_t * A, int64_t n, const int64_t * freq, int64_t r, const int64_t * I)
{
	...
	if(n <= INT32_MAX && r <= INT32_MAX && (n - 1) / r < 1024) {
		int32_t indexes[1024]; for(t = 0; t <= (n - 1) / r; ++t) {
			indexes[t] = (int32_t)I[t];
		}
		int32_t frequencies[ALPHABET_SIZE]; if(freq) {
			for(t = 0; t < ALPHABET_SIZE; ++t) {
				frequencies[t] = (int32_t)freq[t];
			}
		}
...
static void libsais64_compute_phi(const sa_sint_t * _RESTRICT SA, sa_sint_t * _RESTRICT PLCP, sa_sint_t n, fast_sint_t omp_block_start, fast_sint_t omp_block_size)
{
	const fast_sint_t prefetch_distance = 32;
...
static void libsais64_compute_phi_omp(const sa_sint_t * _RESTRICT SA, sa_sint_t * _RESTRICT PLCP, sa_sint_t n, sa_sint_t threads)
{
#if defined(LIBSAIS_OPENMP)
    #pragma omp parallel num_threads(threads) if(threads > 1 && n >= 65536)
#endif
...
static void libsais64_compute_plcp(const uint8_t * _RESTRICT T, sa_sint_t * _RESTRICT PLCP, fast_sint_t n, fast_sint_t omp_block_start, fast_sint_t omp_block_size)
{
	const fast_sint_t prefetch_distance = 32;
...
static void libsais64_compute_plcp_omp(const uint8_t * _RESTRICT T, sa_sint_t * _RESTRICT PLCP, sa_sint_t n, sa_sint_t threads)
{
#if defined(LIBSAIS_OPENMP)
    #pragma omp parallel num_threads(threads) if(threads > 1 && n >= 65536)
#endif
...
static void libsais64_compute_lcp(const sa_sint_t * _RESTRICT PLCP, const sa_sint_t * _RESTRICT SA, sa_sint_t * _RESTRICT LCP, fast_sint_t omp_block_start, fast_sint_t omp_block_size)
{
	const fast_sint_t prefetch_distance = 32;
...
static void libsais64_compute_lcp_omp(const sa_sint_t * _RESTRICT PLCP, const sa_sint_t * _RESTRICT SA, sa_sint_t * _RESTRICT LCP, sa_sint_t n, sa_sint_t threads)
{
#if defined(LIBSAIS_OPENMP)
    #pragma omp parallel num_threads(threads) if(threads > 1 && n >= 65536)
#endif
