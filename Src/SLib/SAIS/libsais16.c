...
static void libsais16_gather_lms_suffixes_16u(const uint16 * _RESTRICT T,
...
static void libsais16_gather_lms_suffixes_16u_omp(const uint16 * _RESTRICT T, sa_sint_t * _RESTRICT SA, sa_sint_t n, sa_sint_t threads,
...
static sa_sint_t libsais16_count_and_gather_lms_suffixes_16u(const uint16 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
...
static sa_sint_t libsais16_count_and_gather_lms_suffixes_16u_omp(const uint16 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t threads,
...
static sa_sint_t libsais16_initialize_buckets_for_lms_suffixes_radix_sort_16u(const uint16 * _RESTRICT T, sa_sint_t * _RESTRICT buckets, sa_sint_t first_lms_suffix)
{
	{
		fast_uint_t s = 0;
...
static void libsais16_radix_sort_lms_suffixes_16u(const uint16 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
...
static void libsais16_radix_sort_lms_suffixes_16u_omp(const uint16 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t m,
    sa_sint_t * _RESTRICT buckets,
...
static void libsais16_initialize_buckets_for_partial_sorting_16u(const uint16 * _RESTRICT T,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t first_lms_suffix,
...
static sa_sint_t libsais16_partial_sorting_scan_left_to_right_16u(const uint16 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t d,
    fast_sint_t omp_block_start,
...
static void libsais16_partial_sorting_scan_left_to_right_16u_block_prepare(const uint16 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT buckets,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t omp_block_start,
...
static sa_sint_t libsais16_partial_sorting_scan_left_to_right_16u_block_omp(const uint16 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t d,
    fast_sint_t block_start,
...
static sa_sint_t libsais16_partial_sorting_scan_left_to_right_16u_omp(const uint16 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t left_suffixes_count,
...
static sa_sint_t libsais16_partial_sorting_scan_right_to_left_16u(const uint16 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t d,
    fast_sint_t omp_block_start,
...
static void libsais16_partial_sorting_scan_right_to_left_16u_block_prepare(const uint16 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT buckets,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t omp_block_start,
...
static sa_sint_t libsais16_partial_sorting_scan_right_to_left_16u_block_omp(const uint16 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t d,
    fast_sint_t block_start,
...
static void libsais16_partial_sorting_scan_right_to_left_16u_omp(const uint16 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t first_lms_suffix,
...
static void libsais16_induce_partial_order_16u_omp(const uint16 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t first_lms_suffix,
...
static void libsais16_final_bwt_scan_left_to_right_16u(const uint16 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT induction_bucket,
    fast_sint_t omp_block_start,
    fast_sint_t omp_block_size)
{
	...
	for(i = omp_block_start, j = omp_block_start + omp_block_size - prefetch_distance - 1; i < j; i += 2) {
		...
		sa_sint_t s0 = SA[i + prefetch_distance + 0]; const uint16 * Ts0 = &T[s0] - 1; libsais16_prefetchr(s0 > 0 ? Ts0 : NULL); Ts0--; libsais16_prefetchr(
			s0 > 0 ? Ts0 : NULL);
		sa_sint_t s1 = SA[i + prefetch_distance + 1]; const uint16 * Ts1 = &T[s1] - 1; libsais16_prefetchr(s1 > 0 ? Ts1 : NULL); Ts1--; libsais16_prefetchr(
			s1 > 0 ? Ts1 : NULL);
...
static void libsais16_final_bwt_aux_scan_left_to_right_16u(const uint16 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t rm,
...
static void libsais16_final_sorting_scan_left_to_right_16u(const uint16 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT induction_bucket,
    fast_sint_t omp_block_start,
    fast_sint_t omp_block_size)
...
static fast_sint_t libsais16_final_bwt_scan_left_to_right_16u_block_prepare(const uint16 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT buckets,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t omp_block_start,
...
static fast_sint_t libsais16_final_sorting_scan_left_to_right_16u_block_prepare(const uint16 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT buckets,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t omp_block_start,
...
static void libsais16_final_bwt_scan_left_to_right_16u_block_omp(const uint16 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT induction_bucket,
    fast_sint_t block_start,
    fast_sint_t block_size,
...
static void libsais16_final_bwt_aux_scan_left_to_right_16u_block_omp(const uint16 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t rm,
    sa_sint_t * _RESTRICT I,
    sa_sint_t * _RESTRICT induction_bucket,
...
static void libsais16_final_sorting_scan_left_to_right_16u_block_omp(const uint16 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT induction_bucket,
    fast_sint_t block_start,
    fast_sint_t block_size,
...
static void libsais16_final_bwt_scan_left_to_right_16u_omp(const uint16 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    fast_sint_t n,
    sa_sint_t * _RESTRICT induction_bucket,
    sa_sint_t threads,
...
static void libsais16_final_bwt_aux_scan_left_to_right_16u_omp(const uint16 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    fast_sint_t n,
    sa_sint_t rm,
    sa_sint_t * _RESTRICT I,
...
static void libsais16_final_sorting_scan_left_to_right_16u_omp(const uint16 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    fast_sint_t n,
    sa_sint_t * _RESTRICT induction_bucket,
    sa_sint_t threads,
...
static sa_sint_t libsais16_final_bwt_scan_right_to_left_16u(const uint16 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT induction_bucket,
    fast_sint_t omp_block_start,
    fast_sint_t omp_block_size)
{
	...
	for(i = omp_block_start + omp_block_size - 1, j = omp_block_start + prefetch_distance + 1; i >= j; i -= 2) {
		...
		SA[i - 0] = p0 & SAINT_MAX; if(p0 > 0) {
			p0--; uint16 c0 = T[p0 - (p0 > 0)], c1 = T[p0]; SA[i - 0] = c1; sa_sint_t t = c0 | SAINT_MIN; SA[--induction_bucket[c1]] = (c0 <= c1) ? p0 : t;
		}

		sa_sint_t p1 = SA[i - 1]; index = (p1 == 0) ? (sa_sint_t)(i - 1) : index;
		SA[i - 1] = p1 & SAINT_MAX; if(p1 > 0) {
			p1--; uint16 c0 = T[p1 - (p1 > 0)], c1 = T[p1]; SA[i - 1] = c1; sa_sint_t t = c0 | SAINT_MIN; SA[--induction_bucket[c1]] = (c0 <= c1) ? p1 : t;
		}
	}
	...
	for(j -= prefetch_distance + 1; i >= j; i -= 1) {
		...
		SA[i] = p & SAINT_MAX; if(p > 0) {
			p--; uint16 c0 = T[p - (p > 0)], c1 = T[p]; SA[i] = c1; sa_sint_t t = c0 | SAINT_MIN; SA[--induction_bucket[c1]] = (c0 <= c1) ? p : t;
		}
	}
...
static void libsais16_final_bwt_aux_scan_right_to_left_16u(const uint16 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t rm,
    sa_sint_t * _RESTRICT I,
    sa_sint_t * _RESTRICT induction_bucket,
    ...
    fast_sint_t omp_block_size)
{
	...
	for(j -= prefetch_distance + 1; i >= j; i -= 1) {
		sa_sint_t p = SA[i];
		SA[i] = p & SAINT_MAX; if(p > 0) {
			p--; uint16 c0 = T[p - (p > 0)], c1 = T[p]; SA[i] = c1; sa_sint_t t = c0 | SAINT_MIN; SA[--induction_bucket[c1]] = (c0 <= c1) ? p : t; if((p & rm) == 0) {
...
static void libsais16_final_sorting_scan_right_to_left_16u(const uint16 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT induction_bucket,
    fast_sint_t omp_block_start,
    fast_sint_t omp_block_size)
...
static fast_sint_t libsais16_final_bwt_scan_right_to_left_16u_block_prepare(const uint16 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT buckets,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t omp_block_start,
    fast_sint_t omp_block_size)
{
	...
	for(i = omp_block_start + omp_block_size - 1, j = omp_block_start + prefetch_distance + 1; i >= j; i -= 2) {
		...
		sa_sint_t p0 = SA[i - 0]; SA[i - 0] = p0 & SAINT_MAX; if(p0 > 0) {
			p0--; uint16 c0 = T[p0 - (p0 > 0)], c1 = T[p0]; SA[i - 0] = c1; sa_sint_t t = c0 | SAINT_MIN; buckets[cache[count].symbol = c1]++;
			cache[count++].index = (c0 <= c1) ? p0 : t;
		}
		sa_sint_t p1 = SA[i - 1]; SA[i - 1] = p1 & SAINT_MAX; if(p1 > 0) {
			p1--; uint16 c0 = T[p1 - (p1 > 0)], c1 = T[p1]; SA[i - 1] = c1; sa_sint_t t = c0 | SAINT_MIN; buckets[cache[count].symbol = c1]++;
	...
	for(j -= prefetch_distance + 1; i >= j; i -= 1) {
		sa_sint_t p = SA[i]; SA[i] = p & SAINT_MAX; if(p > 0) {
			p--; uint16 c0 = T[p - (p > 0)], c1 = T[p]; SA[i] = c1; sa_sint_t t = c0 | SAINT_MIN; buckets[cache[count].symbol = c1]++;
...
static fast_sint_t libsais16_final_bwt_aux_scan_right_to_left_16u_block_prepare(const uint16 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT buckets,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t omp_block_start,
...
static fast_sint_t libsais16_final_sorting_scan_right_to_left_16u_block_prepare(const uint16 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT buckets,
    LIBSAIS_THREAD_CACHE * _RESTRICT cache,
    fast_sint_t omp_block_start,
...
static void libsais16_final_bwt_scan_right_to_left_16u_block_omp(const uint16 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT induction_bucket,
    fast_sint_t block_start,
    fast_sint_t block_size,
...
static void libsais16_final_bwt_aux_scan_right_to_left_16u_block_omp(const uint16 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t rm,
    sa_sint_t * _RESTRICT I,
    sa_sint_t * _RESTRICT induction_bucket,
...
static void libsais16_final_sorting_scan_right_to_left_16u_block_omp(const uint16 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t * _RESTRICT induction_bucket,
    fast_sint_t block_start,
    fast_sint_t block_size,
...
static sa_sint_t libsais16_final_bwt_scan_right_to_left_16u_omp(const uint16 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t * _RESTRICT induction_bucket,
    sa_sint_t threads,
		...
		for(block_start = (fast_sint_t)n - 1; block_start >= 0; ) {
			if(SA[block_start] == 0) {
				...
				if(block_size < 32) {
					for(; block_start > block_end; block_start -= 1) {
						sa_sint_t p = SA[block_start]; SA[block_start] = p & SAINT_MAX; if(p > 0) {
							p--; uint16 c0 = T[p - (p > 0)], c1 = T[p]; SA[block_start] = c1; sa_sint_t t = c0 | SAINT_MIN;
...
static void libsais16_final_bwt_aux_scan_right_to_left_16u_omp(const uint16 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t rm,
    sa_sint_t * _RESTRICT I,
...
static void libsais16_final_sorting_scan_right_to_left_16u_omp(const uint16 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t * _RESTRICT induction_bucket,
    sa_sint_t threads,
...
static sa_sint_t libsais16_induce_final_order_16u_omp(const uint16 * _RESTRICT T,
    sa_sint_t * _RESTRICT SA,
    sa_sint_t n,
    sa_sint_t bwt,
    sa_sint_t r,
...
static void libsais16_compact_unique_and_nonunique_lms_suffixes_32s_omp(sa_sint_t * _RESTRICT SA, sa_sint_t n, sa_sint_t m, sa_sint_t fs,
    sa_sint_t f, sa_sint_t threads, LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
#if defined(LIBSAIS_OPENMP)
...
#endif
	{
		...
		if(omp_num_threads == 1) {
		...
		else {
			{
				...
				libsais16_compact_unique_and_nonunique_lms_suffixes_32s(SA, m, &thread_state[omp_thread_num].state.position,
...
static sa_sint_t libsais16_compact_lms_suffixes_32s_omp(sa_sint_t * _RESTRICT T, sa_sint_t * _RESTRICT SA, sa_sint_t n, sa_sint_t m,
...
static void libsais16_merge_unique_lms_suffixes_32s(sa_sint_t * _RESTRICT T, sa_sint_t * _RESTRICT SA, sa_sint_t n, sa_sint_t m, fast_sint_t l,
...
static void libsais16_merge_nonunique_lms_suffixes_32s_omp(sa_sint_t * _RESTRICT SA, sa_sint_t n, sa_sint_t m, sa_sint_t f, sa_sint_t threads, LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
#if defined(LIBSAIS_OPENMP)
    #pragma omp parallel num_threads(threads) if(threads > 1 && m >= 65536)
#endif
    ...
    sa_sint_t n, sa_sint_t k, sa_sint_t fs, sa_sint_t threads, LIBSAIS_THREAD_STATE * _RESTRICT thread_state)
{
	...
	if(k > 0 && fs / k >= 6) {
		...
		sa_sint_t * _RESTRICT buckets = fs - alignment >= k ? 
			(sa_sint_t *)libsais16_align_up(&SA[n + fs - k - alignment], (size_t)alignment * sizeof(sa_sint_t)) : fs >= k ? &SA[n + fs - k] : buffer;
		if(!buckets) {
			return -2;
		}
...
static sa_sint_t libsais16_main_16u(const uint16 * T,
    sa_sint_t * SA,
    sa_sint_t n,
    sa_sint_t * _RESTRICT buckets,
    sa_sint_t bwt,
...
static sa_sint_t libsais16_main(const uint16 * T, sa_sint_t * SA, sa_sint_t n, sa_sint_t bwt, sa_sint_t r, sa_sint_t * I, sa_sint_t fs, sa_sint_t * freq, sa_sint_t threads)
{
	LIBSAIS_THREAD_STATE *  _RESTRICT thread_state   = threads > 1 ? libsais16_alloc_thread_state(threads) : NULL;
	sa_sint_t *             _RESTRICT buckets        = (sa_sint_t *)libsais16_alloc_aligned(8 * ALPHABET_SIZE * sizeof(sa_sint_t), 4096);
...
static void libsais16_bwt_copy_16u(uint16 * _RESTRICT U, sa_sint_t * _RESTRICT A, sa_sint_t n)
{
	const fast_sint_t prefetch_distance = 32;
...
static void libsais16_bwt_copy_16u_omp(uint16 * _RESTRICT U, sa_sint_t * _RESTRICT A, sa_sint_t n, sa_sint_t threads)
{
#if defined(LIBSAIS_OPENMP)
    #pragma omp parallel num_threads(threads) if(threads > 1 && n >= 65536)
#endif
...
static LIBSAIS_UNBWT_CONTEXT * libsais16_unbwt_create_ctx_main(sa_sint_t threads)
{
	...
	uint16 *                  _RESTRICT fastbits       = (uint16 *)libsais16_alloc_aligned((1 + (1 << UNBWT_FASTBITS)) * sizeof(uint16), 4096);
...
static void libsais16_unbwt_compute_histogram(const uint16 * _RESTRICT T, fast_sint_t n, sa_uint_t * _RESTRICT count)
{
...
static void libsais16_unbwt_calculate_fastbits(sa_uint_t * _RESTRICT bucket2, uint16 * _RESTRICT fastbits, fast_uint_t shift)
{
	fast_uint_t v, w, sum;
...
static void libsais16_unbwt_calculate_P(const uint16 * _RESTRICT T,
...
static void libsais16_unbwt_init_single(const uint16 * _RESTRICT T,
    sa_uint_t * _RESTRICT P,
    sa_sint_t n,
...
static void libsais16_unbwt_init_parallel(const uint16 * _RESTRICT T,
    sa_uint_t * _RESTRICT P,
    sa_sint_t n,
    const sa_sint_t * freq,
    const sa_uint_t * _RESTRICT I,
...
static void libsais16_unbwt_decode_1(uint16 * _RESTRICT U, sa_uint_t * _RESTRICT P,
    sa_uint_t * _RESTRICT bucket2, uint16 * _RESTRICT fastbits, fast_uint_t shift, fast_uint_t * i0, fast_uint_t k)
{
	uint16 * _RESTRICT U0 = U;
	fast_uint_t i, p0 = *i0;
	for(i = 0; i != k; ++i) {
...
static void libsais16_unbwt_decode_2(uint16 * _RESTRICT U, sa_uint_t * _RESTRICT P, sa_uint_t * _RESTRICT bucket2,
    uint16 * _RESTRICT fastbits, fast_uint_t shift, fast_uint_t r, fast_uint_t * i0, fast_uint_t * i1, fast_uint_t k)
{
	uint16 * _RESTRICT U0 = U;
	uint16 * _RESTRICT U1 = U0 + r;
...
static void libsais16_unbwt_decode_3(uint16 * _RESTRICT U,
    sa_uint_t * _RESTRICT P,
    sa_uint_t * _RESTRICT bucket2,
    uint16 * _RESTRICT fastbits,
    fast_uint_t shift,
...
static void libsais16_unbwt_decode_4(uint16 * _RESTRICT U,
    sa_uint_t * _RESTRICT P,
    sa_uint_t * _RESTRICT bucket2,
    uint16 * _RESTRICT fastbits,
    fast_uint_t shift,
...
static void libsais16_unbwt_decode_5(uint16 * _RESTRICT U,
    sa_uint_t * _RESTRICT P,
    sa_uint_t * _RESTRICT bucket2,
    uint16 * _RESTRICT fastbits,
    fast_uint_t shift,
...
static void libsais16_unbwt_decode_6(uint16 * _RESTRICT U,
    sa_uint_t * _RESTRICT P,
    sa_uint_t * _RESTRICT bucket2,
    uint16 * _RESTRICT fastbits,
    fast_uint_t shift,
...
static void libsais16_unbwt_decode_7(uint16 * _RESTRICT U,
    sa_uint_t * _RESTRICT P,
    sa_uint_t * _RESTRICT bucket2,
    uint16 * _RESTRICT fastbits,
    fast_uint_t shift,
...
static void libsais16_unbwt_decode_8(uint16 * _RESTRICT U,
    sa_uint_t * _RESTRICT P,
    sa_uint_t * _RESTRICT bucket2,
    uint16 * _RESTRICT fastbits,
    fast_uint_t shift,
...
static void libsais16_unbwt_decode(uint16 * _RESTRICT U,
    sa_uint_t * _RESTRICT P,
    sa_sint_t n,
    sa_sint_t r,
    const sa_uint_t * _RESTRICT I,
...
static void libsais16_unbwt_decode_omp(uint16 * _RESTRICT U,
    sa_uint_t * _RESTRICT P,
    sa_sint_t n,
    sa_sint_t r,
    const sa_uint_t * _RESTRICT I,
...
static sa_sint_t libsais16_unbwt_core(const uint16 * _RESTRICT T,
    uint16 * _RESTRICT U,
    sa_uint_t * _RESTRICT P,
    sa_sint_t n,
    const sa_sint_t * freq,
...
static sa_sint_t libsais16_unbwt_main(const uint16 * T, uint16 * U, sa_uint_t * P, sa_sint_t n, const sa_sint_t * freq, sa_sint_t r, const sa_uint_t * I, sa_sint_t threads)
{
	fast_uint_t shift = 0; while((n >> shift) > (1 << UNBWT_FASTBITS)) {
		shift++;
	}
	sa_uint_t * _RESTRICT bucket2  = (sa_uint_t *)libsais16_alloc_aligned(ALPHABET_SIZE * sizeof(sa_uint_t), 4096);
	uint16  * _RESTRICT fastbits = (uint16 *)libsais16_alloc_aligned(((size_t)1 + (size_t)(n >> shift)) * sizeof(uint16), 4096);
...
static sa_sint_t libsais16_unbwt_main_ctx(const LIBSAIS_UNBWT_CONTEXT * ctx, const uint16 * T, uint16 * U,
...
static void libsais16_compute_plcp(const uint16 * _RESTRICT T, sa_sint_t * _RESTRICT PLCP, fast_sint_t n, fast_sint_t omp_block_start, fast_sint_t omp_block_size)
{
	const fast_sint_t prefetch_distance = 32;
	fast_sint_t i, j, l = 0;
...
static void libsais16_compute_plcp_omp(const uint16 * _RESTRICT T, sa_sint_t * _RESTRICT PLCP, sa_sint_t n, sa_sint_t threads)
{
#if defined(LIBSAIS_OPENMP)
    #pragma omp parallel num_threads(threads) if(threads > 1 && n >= 65536)
#endif
