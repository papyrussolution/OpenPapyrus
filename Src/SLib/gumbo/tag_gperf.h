...
//
//
static uint FASTCALL tag_hash(const char * str, uint len)
{
	static ushort asso_values[] = {296, 296, 296, 296, 296, 296, 296, 296,
	...
	switch(hval) {
		default:
		    hval += asso_values[(uchar)str[1] + 3];
		// @fallthrough
		case 1:
		    hval += asso_values[(uchar)str[0]];
		    break;
	}
	return hval + asso_values[(uchar)str[len - 1]];
}

static const uchar kGumboTagMap[] = {GUMBO_TAG_LAST, GUMBO_TAG_LAST,
