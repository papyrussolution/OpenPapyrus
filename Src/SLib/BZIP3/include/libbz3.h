 ...
 */
int bz3_compress(uint32_t block_size, const uint8 * in, uint8 * out, size_t in_size, size_t * out_size);
/**
 ...
 */
int32_t bz3_encode_block(struct bz3_state * state, uint8 * buffer, int32_t size);
 ...
 */
int32_t bz3_decode_block(struct bz3_state * state, uint8 * buffer, int32_t size, int32_t orig_size);
 ...
 */
void bz3_encode_blocks(struct bz3_state * states[], uint8 * buffers[], int32_t sizes[], int32_t n);

/**
 * @brief Decode `n' blocks, all in parallel.
 * Same specifics as `bz3_encode_blocks', but doesn't overwrite `sizes'.
 */
void bz3_decode_blocks(struct bz3_state * states[], uint8 * buffers[], int32_t sizes[], int32_t orig_sizes[], int32_t n);
