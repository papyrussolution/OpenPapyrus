/*
 * chvalid.c:	this module implements the character range validation APIs
 *
...
// possible characters.  If the table byte is set, the character is allowed.
// 
const uchar xmlIsPubidChar_tab[256] = {
...
// 
int xmlIsBaseChar(uint ch) { return xmlIsBaseCharQ(ch); }
// 
// @ch:  character to validate
// 
...
// Returns true if argument valid, false otherwise
// 
int xmlIsBlank(uint ch) { return xmlIsBlankQ(ch); }
// 
// @ch:  character to validate
// 
...
// Returns true if argument valid, false otherwise
// 
int xmlIsChar(uint ch) { return xmlIsCharQ(ch); }
// 
// @ch:  character to validate
// 
