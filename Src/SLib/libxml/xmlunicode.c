 ...
 */
int xmlUCSIsAegeanNumbers(int code) { return (((code >= 0x10100) && (code <= 0x1013F))); }
/**
 ...
 * Returns 1 if true 0 otherwise
 */
int xmlUCSIsAlphabeticPresentationForms(int code) { return (((code >= 0xFB00) && (code <= 0xFB4F))); }
/**
 * xmlUCSIsArabic:
 * @code: UCS code point
 *
 ...
 * Returns 1 if true 0 otherwise
 */
int xmlUCSIsArabic(int code) { return (((code >= 0x0600) && (code <= 0x06FF))); }
/**
 ...
 * Returns 1 if true 0 otherwise
 */
int xmlUCSIsArabicPresentationFormsA(int code) { return (((code >= 0xFB50) && (code <= 0xFDFF))); }
/**
 ...
 * Returns 1 if true 0 otherwise
 */
int xmlUCSIsArabicPresentationFormsB(int code) { return (((code >= 0xFE70) && (code <= 0xFEFF))); }
/**
 * xmlUCSIsArmenian:
 * @code: UCS code point
 *
...
{
	xmlIntFunc * func = xmlUnicodeLookup(&xmlUnicodeBlockTbl, block);
	return func ? func(code) : -1;
}
/**
 * xmlUCSIsCatC:
 * @code: UCS code point
...
{
	return (xmlCharInRange((uint)code, &xmlCG));
}
/**
 * xmlUCSIsCatCc:
 * @code: UCS code point
...
{
	return xmlCharInRange((uint)code, &xmlLG);
}
...
int xmlUCSIsCatLl(int code) {
	return (xmlCharInRange((uint)code, &xmlLlG));
}
/**
 * @code: UCS code point
 ...
 * Returns 1 if true 0 otherwise
 */
int xmlUCSIsCatLm(int code) { return (xmlCharInRange((uint)code, &xmlLmG)); }
/**
 * @code: UCS code point
 * Check whether the character is part of Lo UCS Category
 * Returns 1 if true 0 otherwise
 */
int xmlUCSIsCatLo(int code) { return (xmlCharInRange((uint)code, &xmlLoG)); }
/**
 * @code: UCS code point
 * Check whether the character is part of Lt UCS Category
 * Returns 1 if true 0 otherwise
 */
int xmlUCSIsCatLt(int code) { return (xmlCharInRange((uint)code, &xmlLtG)); }
/**
 * @code: UCS code point
 * Check whether the character is part of Lu UCS Category
 * Returns 1 if true 0 otherwise
 */
int xmlUCSIsCatLu(int code) { return (xmlCharInRange((uint)code, &xmlLuG)); }
/**
 * @code: UCS code point
 * Check whether the character is part of M UCS Category
 * Returns 1 if true 0 otherwise
 */
int xmlUCSIsCatM(int code) { return (xmlCharInRange((uint)code, &xmlMG)); }
/**
 * @code: UCS code point
 * Check whether the character is part of Mc UCS Category
 * Returns 1 if true 0 otherwise
 */
int xmlUCSIsCatMc(int code) { return (xmlCharInRange((uint)code, &xmlMcG)); }
/**
 * @code: UCS code point
 ...
 * Returns 1 if true 0 otherwise
 */
int xmlUCSIsCatMn(int code) { return (xmlCharInRange((uint)code, &xmlMnG)); }
/**
 * @code: UCS code point
 * Check whether the character is part of N UCS Category
 * Returns 1 if true 0 otherwise
 */
int xmlUCSIsCatN(int code) { return (xmlCharInRange((uint)code, &xmlNG)); }
/**
 * @code: UCS code point
 * Check whether the character is part of Nd UCS Category
 * Returns 1 if true 0 otherwise
 */
int xmlUCSIsCatNd(int code) { return (xmlCharInRange((uint)code, &xmlNdG)); }
/**
 * @code: UCS code point
...
{
	return (((code >= 0x16ee) && (code <= 0x16f0)) || ((code >= 0x2160) && (code <= 0x2183)) ||
	    (code == 0x3007) || ((code >= 0x3021) && (code <= 0x3029)) ||
 ...
 * Returns 1 if true 0 otherwise
 */
int xmlUCSIsCatNo(int code) { return xmlCharInRange((uint)code, &xmlNoG); }
/**
 * @code: UCS code point
 * Check whether the character is part of P UCS Category
 * Returns 1 if true 0 otherwise
 */
int xmlUCSIsCatP(int code) { return xmlCharInRange((uint)code, &xmlPG); }
/**
 * xmlUCSIsCatPc:
 * @code: UCS code point
 *
 ...
 * Returns 1 if true 0 otherwise
 */
int xmlUCSIsCatPd(int code) { return xmlCharInRange((uint)code, &xmlPdG); }
/**
 * xmlUCSIsCatPe:
 * @code: UCS code point
...
{
	return (xmlCharInRange((uint)code, &xmlSG));
}
...
{
	xmlIntFunc * func = xmlUnicodeLookup(&xmlUnicodeCatTbl, cat);
	return func ? func(code) : -1;
}
