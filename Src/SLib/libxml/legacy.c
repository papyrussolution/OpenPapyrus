 ...
 *      must deallocate it !
 */
xmlChar * htmlDecodeEntities(htmlParserCtxt * ctxt ATTRIBUTE_UNUSED, int len ATTRIBUTE_UNUSED, xmlChar end ATTRIBUTE_UNUSED,
    xmlChar end2 ATTRIBUTE_UNUSED, xmlChar end3 ATTRIBUTE_UNUSED)
{
	static int deprecated = 0;
	if(!deprecated) {
		xmlGenericError(xmlGenericErrorContext, "htmlDecodeEntities() deprecated function reached\n");
		deprecated = 1;
	}
	return (NULL);
}
 ...
 *      must deallocate it !
 */
xmlChar * xmlDecodeEntities(xmlParserCtxt * ctxt ATTRIBUTE_UNUSED, int len ATTRIBUTE_UNUSED, int what ATTRIBUTE_UNUSED,
...
xmlChar * xmlNamespaceParseNCName(xmlParserCtxt * ctxt ATTRIBUTE_UNUSED)
{
	static int deprecated = 0;
	if(!deprecated) {
...
xmlChar * xmlNamespaceParseQName(xmlParserCtxt * ctxt ATTRIBUTE_UNUSED, xmlChar ** prefix ATTRIBUTE_UNUSED)
{
	static int deprecated = 0;
	if(!deprecated) {
...
xmlChar * xmlNamespaceParseNSDef(xmlParserCtxt * ctxt ATTRIBUTE_UNUSED)
{
	static int deprecated = 0;
	if(!deprecated) {
 ...
 */
xmlChar * xmlParseQuotedString(xmlParserCtxt * ctxt ATTRIBUTE_UNUSED)
{
	static int deprecated = 0;
	if(!deprecated) {
...
void xmlParseNamespace(xmlParserCtxt * ctxt ATTRIBUTE_UNUSED)
{
	static int deprecated = 0;
	if(!deprecated) {
...
xmlChar * xmlScanName(xmlParserCtxt * ctxt ATTRIBUTE_UNUSED)
{
	static int deprecated = 0;
	if(!deprecated) {
 ...
 */
void xmlParserHandleReference(xmlParserCtxt * ctxt ATTRIBUTE_UNUSED)
{
	static int deprecated = 0;
	if(!deprecated) {
...
void xmlHandleEntity(xmlParserCtxt * ctxt ATTRIBUTE_UNUSED, xmlEntity * entity ATTRIBUTE_UNUSED)
{
	static int deprecated = 0;
	if(!deprecated) {
 ...
 */
xmlNs * xmlNewGlobalNs(xmlDocPtr doc ATTRIBUTE_UNUSED, const xmlChar * href ATTRIBUTE_UNUSED, const xmlChar * prefix ATTRIBUTE_UNUSED)
{
	static int deprecated = 0;
	if(!deprecated) {
		xmlGenericError(xmlGenericErrorContext, "xmlNewGlobalNs() deprecated function reached\n");
		deprecated = 1;
	}
	return (NULL);
}
 ...
 */
void internalSubset(void * ctx, const xmlChar * name,
 ...
 */
void unparsedEntityDecl(void * ctx, const xmlChar * name,
    const xmlChar * publicId, const xmlChar * systemId,
 ...
 * DEPRECATED
 */
void setDocumentLocator(void * ctx ATTRIBUTE_UNUSED, xmlSAXLocator * loc ATTRIBUTE_UNUSED)
{
...
void setNamespace(void * ctx ATTRIBUTE_UNUSED, const xmlChar * name ATTRIBUTE_UNUSED)
{
...
xmlNs * getNamespace(void * ctx ATTRIBUTE_UNUSED)
{
 ...
 * DEPRECATED
 */
void namespaceDecl(void * ctx ATTRIBUTE_UNUSED, const xmlChar * href ATTRIBUTE_UNUSED, const xmlChar * prefix ATTRIBUTE_UNUSED)
{
