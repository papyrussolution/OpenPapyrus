 ...
 */
static xmlParserInput * testExternalEntityLoader(const char * URL, const char * ID, xmlParserCtxt * ctxt) 
{
	xmlParserInput * ret;
...
static void xmlParserPrintFileContextInternal(xmlParserInput * input, xmlGenericErrorFunc chanl, void * data) 
{
...
static void testStructuredErrorHandler(void * ctx ATTRIBUTE_UNUSED, xmlError * err) 
{
	char * file = NULL;
	int line = 0;
	int code = -1;
	...
	domain = err->domain;
	level = err->level;
	node = (xmlNode *)err->P_Node;
	if((domain == XML_FROM_PARSER) || (domain == XML_FROM_HTML) || (domain == XML_FROM_DTD) || (domain == XML_FROM_NAMESPACE) ||
	    (domain == XML_FROM_IO) || (domain == XML_FROM_VALID)) {
		ctxt = (xmlParserCtxt *)err->ctxt;
	}
	str = err->message;
	if(code == XML_ERR_OK)
		return;
	...
	if(code == XML_ERR_OK)
		return;
	if(str != NULL) {
		int len = sstrleni((const xmlChar*)str);
		if((len > 0) && (str[len - 1] != '\n'))
			channel(data, "%s\n", str);
		else
			channel(data, "%s", str);
	...
	if((domain == XML_FROM_XPATH) && (err->str1 != NULL) && (err->int1 < 100) && (err->int1 < sstrleni((const xmlChar*)err->str1))) {
		xmlChar buf[150];
		int i;
		channel(data, "%s\n", err->str1);
...
static void initializeLibxml2(void) 
{
	...
	// @sobolev xmlMemSetup(xmlMemFree, xmlMemMalloc, xmlMemRealloc, xmlMemoryStrdup);
	xmlInitParser();
 ...
 */
static xmlParserInput * resolveEntityCallback(void * ctx ATTRIBUTE_UNUSED, const xmlChar * publicId ATTRIBUTE_UNUSED, const xmlChar * systemId ATTRIBUTE_UNUSED)
{
	callbacks++;
	return (NULL);
}
 ...
 * Returns the xmlParserInputPtr if inlined or NULL for DOM behaviour.
 */
static xmlEntity * getEntityCallback(void * ctx ATTRIBUTE_UNUSED, const xmlChar * name ATTRIBUTE_UNUSED)
{
	callbacks++;
	return (NULL);
}
 ...
 */
static xmlEntity * getParameterEntityCallback(void * ctx ATTRIBUTE_UNUSED, const xmlChar * name ATTRIBUTE_UNUSED)
{
	callbacks++;
	return (NULL);
}
 ...
 */
static void attributeDeclCallback(void * ctx ATTRIBUTE_UNUSED, const xmlChar * elem ATTRIBUTE_UNUSED,
    const xmlChar * name ATTRIBUTE_UNUSED, int type ATTRIBUTE_UNUSED, int def ATTRIBUTE_UNUSED,
    const xmlChar * defaultValue ATTRIBUTE_UNUSED, xmlEnumeration * tree ATTRIBUTE_UNUSED)
{
	callbacks++;
	return;
}
 ...
 */
static void elementDeclCallback(void * ctx ATTRIBUTE_UNUSED, const xmlChar * name ATTRIBUTE_UNUSED,
    int type ATTRIBUTE_UNUSED, xmlElementContent * content ATTRIBUTE_UNUSED)
{
	callbacks++;
	return;
}
 ...
 */
static void unparsedEntityDeclCallback(void * ctx ATTRIBUTE_UNUSED,
    const xmlChar * name ATTRIBUTE_UNUSED,
    const xmlChar * publicId ATTRIBUTE_UNUSED,
    const xmlChar * systemId ATTRIBUTE_UNUSED,
 ...
 */
static void setDocumentLocatorCallback(void * ctx ATTRIBUTE_UNUSED, xmlSAXLocator * loc ATTRIBUTE_UNUSED)
{
	callbacks++;
	return;
}
 ...
 */
static void startElementCallback(void * ctx ATTRIBUTE_UNUSED,
    const xmlChar * name ATTRIBUTE_UNUSED,
 ...
 */
static void endElementCallback(void * ctx ATTRIBUTE_UNUSED,
    const xmlChar * name ATTRIBUTE_UNUSED)
{
	callbacks++;
	return;
 ...
 */
static void processingInstructionCallback(void * ctx ATTRIBUTE_UNUSED,
 ...
 * extra parameters.
 */
static void XMLCDECL warningCallback(void * ctx ATTRIBUTE_UNUSED,
 ...
 * extra parameters.
 */
static void XMLCDECL fatalErrorCallback(void * ctx ATTRIBUTE_UNUSED,
    const char * msg ATTRIBUTE_UNUSED, ...)
{
	return;
}
 ...
 * called when an opening tag has been processed.
 */
static void startElementNsCallback(void * ctx ATTRIBUTE_UNUSED,
...
static xmlSAXHandler * callbackSAX2Handler = &callbackSAX2HandlerStruct;
//
