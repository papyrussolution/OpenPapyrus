...
void SGeoGridTab::SetSrcCountLat(uint64 c) { SrcCountLat = c; }
void SGeoGridTab::SetSrcCountLon(uint64 c) { SrcCountLon = c; }
uint SGeoGridTab::GetDim() const { return Dim; }
uint SGeoGridTab::GetDensityLat() const { return (uint)(SrcCountLat / (1ULL << Dim)); }
uint SGeoGridTab::GetDensityLon() const { return (uint)(SrcCountLon / (1ULL << Dim)); }
...
uint SGeoGridTab::GetCountLat() const { return LatIdx.getCount(); }
uint SGeoGridTab::GetCountLon() const { return LonIdx.getCount(); }
...
{
	Init(SMathConst::WGS84_A, SMathConst::WGS84_Flattening);
}
