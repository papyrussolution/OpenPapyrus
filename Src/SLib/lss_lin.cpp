// LSS_LIN.CPP
// Copyright (c) A.Sobolev 2004, 2007, 2010, 2016, 2018, 2019, 2020, 2023
// @codepage UTF-8
//
...
#if(_MSC_VER >= 1910) // {
//
// Черт его знает почему, но эта, якобы ускоренная всякими SSE-AVX версия почти в 2 раза медленнее тупого варианта Solve_Simple.
