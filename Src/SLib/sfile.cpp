...
int SFileFormat::Register()
{
	...
	Register(Exe,              0, "exe",   "4D5A"); // @v9.0.9 binary:exe   0:4D5A
	Register(Dll,              0, "dll",   "4D5A"); // @v9.0.9 binary:dll   0:4D5A
	...
	Register(VCProj,           0, "vcproj", "T<?xml"); // @v9.1.2
