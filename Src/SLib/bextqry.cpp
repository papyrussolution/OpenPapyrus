// BEXTQRY.CPP
// Copyright (c) A.Sobolev 1996, 1997, 1998, 1999, 2000, 2001, 2004, 2006, 2007, 2008, 2009, 2010, 2013, 2015, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2025, 2026
// @codepage UTF-8
...
__again:
	...
	if(State & stSqlProvider) {
		...
		//
		// Распределяем память для данных. Размер буфера кратен максимальному числу извлекаемых за один раз записей.
		//
