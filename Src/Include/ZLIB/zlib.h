...
/*
ZEXTERN int ZEXPORT inflateBackInit OF((z_streamp strm, int windowBits, uchar FAR *window));
...
typedef unsigned (*in_func) OF((void FAR *, z_const uchar FAR * FAR *));
typedef int (*out_func) OF((void FAR *, uchar FAR *, unsigned));
...
ZEXTERN int ZEXPORT inflateBackInit_ OF((z_streamp strm, int windowBits, uchar FAR *window, const char *version, int stream_size));
