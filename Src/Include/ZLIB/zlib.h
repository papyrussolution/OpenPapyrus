...
/*
   ZEXTERN int ZEXPORT inflateBackInit(z_streamp strm, int windowBits, uchar * window);
...
// decompression code will be included the application when linking to a static zlib library.
// 
