...
inline static boolint _cairo_xlib_vendor_is_xorg(Display * dpy)
{
...
cairo_private boolint _cairo_xlib_display_has_repeat(cairo_device_t * device);
cairo_private boolint _cairo_xlib_display_has_reflect(cairo_device_t * device);
cairo_private boolint _cairo_xlib_display_has_gradients(cairo_device_t * device);
...
cairo_private cairo_int_status_t _cairo_xlib_surface_set_attributes(cairo_xlib_display_t * display,
    cairo_xlib_surface_t * surface, cairo_surface_attributes_t * attributes, double xc, double yc);
cairo_private cairo_status_t _cairo_xlib_surface_draw_image(cairo_xlib_surface_t * surface, cairo_image_surface_t  * image,
    int src_x, int src_y, int width, int height, int dst_x, int dst_y);
cairo_private cairo_surface_t * _cairo_xlib_source_create_for_pattern(cairo_surface_t * dst, const cairo_pattern_t * pattern,
 ...
 */
static inline boolint _cairo_xlib_surface_same_screen(cairo_xlib_surface_t * dst, cairo_xlib_surface_t * src)
{
...
cairo_private cairo_int_status_t _cairo_xlib_core_fill_rectangles(cairo_xlib_surface_t * dst, const cairo_color_t * color, int num_rects, cairo_rectangle_int_t * rects);
...
cairo_private cairo_surface_t * _cairo_xlib_surface_get_shm(cairo_xlib_surface_t * surface, boolint overwrite);
...
cairo_private boolint _cairo_xlib_shm_surface_is_active(cairo_surface_t * surface);
cairo_private boolint _cairo_xlib_shm_surface_is_idle(cairo_surface_t * surface);
