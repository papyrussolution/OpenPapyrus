...
cairo_public cairo_surface_t * cairo_xcb_surface_create(xcb_connection_t * connection,
...
cairo_public void cairo_xcb_surface_set_size(cairo_surface_t * surface,
    int width,
    int height);

cairo_public void cairo_xcb_surface_set_drawable(cairo_surface_t * surface,
    xcb_drawable_t drawable,
    int width,
    int height);
...
cairo_public void cairo_xcb_device_debug_cap_xshm_version(cairo_device_t * device,
    int major_version,
    int minor_version);

cairo_public void cairo_xcb_device_debug_cap_xrender_version(cairo_device_t * device,
    int major_version,
    int minor_version);
 ...
 */
cairo_public void cairo_xcb_device_debug_set_precision(cairo_device_t * device,
    int precision);
