 ...
 * Contributor(s): Carl D. Worth <cworth@cworth.org> Kristian Høgsberg <krh@redhat.com> Keith Packard
 *<keithp@keithp.com>
 */
...
typedef struct _cairo_ps_form {
	...
	cairo_rectangle_int_t required_extents; // Union of source extents required for all operations using this form 
} cairo_ps_form_t;
