...
#define DISPATCH_ENTRY_ARB(name) { { "gl"#name, "gl"#name "ARB", "gl"#name }, offsetof(cairo_gl_dispatch_t, name) }
#define DISPATCH_ENTRY_EXT(name) { { "gl"#name, "gl"#name "EXT", "gl"#name }, offsetof(cairo_gl_dispatch_t, name) }
#define DISPATCH_ENTRY_ARB_OES(name) { { "gl"#name, "gl"#name "ARB", "gl"#name "OES" }, offsetof(cairo_gl_dispatch_t, name) }
#define DISPATCH_ENTRY_EXT_IMG(name) { { "gl"#name, "gl"#name "EXT", "gl"#name "IMG" }, offsetof(cairo_gl_dispatch_t, name) }
#define DISPATCH_ENTRY_CUSTOM(name, name2) { { "gl"#name, "gl"#name2, "gl"#name }, offsetof(cairo_gl_dispatch_t, name)}
