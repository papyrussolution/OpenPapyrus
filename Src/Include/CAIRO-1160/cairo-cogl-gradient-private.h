...
#define CAIRO_COGL_GRADIENT_CAN_EXTEND_ALL (CAIRO_COGL_GRADIENT_CAN_EXTEND_PAD | \
	CAIRO_COGL_GRADIENT_CAN_EXTEND_REPEAT|CAIRO_COGL_GRADIENT_CAN_EXTEND_REFLECT|CAIRO_COGL_GRADIENT_CAN_EXTEND_NONE)
...
boolint _cairo_cogl_linear_gradient_equal(const void * key_a, const void * key_b);
