...
cairo_private void * FASTCALL _cairo_hash_table_lookup(cairo_hash_table_t * hash_table, const cairo_hash_entry_t * key);
...
cairo_private void FASTCALL _cairo_hash_table_remove(cairo_hash_table_t * hash_table, const cairo_hash_entry_t * key);
cairo_private void FASTCALL _cairo_hash_table_foreach(cairo_hash_table_t * hash_table, cairo_hash_callback_func_t  hash_callback, void * closure);
