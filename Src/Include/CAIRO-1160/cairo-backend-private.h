...
struct _cairo_backend {
	...
	cairo_status_t (* arc) (void * cr, double xc, double yc, double radius, double angle1, double angle2, boolint forward);
	...
	boolint (* has_current_point) (void * cr);
	boolint (* get_current_point) (void * cr, double * x, double * y);
	...
	cairo_status_t (* in_clip) (void * cr, double x, double y, boolint * inside);
	...
	cairo_status_t (* in_stroke) (void * cr, double x, double y, boolint * inside);
	...
	cairo_status_t (* in_fill) (void * cr, double x, double y, boolint * inside);
...
static inline void _cairo_backend_to_user(cairo_t * cr, double * x, double * y) { cr->backend->backend_to_user(cr, x, y); }
static inline void _cairo_backend_to_user_distance(cairo_t * cr, double * x, double * y) { cr->backend->backend_to_user_distance(cr, x, y); }
static inline void _cairo_user_to_backend(cairo_t * cr, double * x, double * y) { cr->backend->user_to_backend(cr, x, y); }
static inline void _cairo_user_to_backend_distance(cairo_t * cr, double * x, double * y) { cr->backend->user_to_backend_distance(cr, x, y); }
