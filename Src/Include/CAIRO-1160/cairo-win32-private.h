...
enum {
	...
	CAIRO_WIN32_SURFACE_CAN_CHECK_PNG = (1<<8), /* Whether we can use the CHECKPNGFORMAT escape function */
	CAIRO_WIN32_SURFACE_CAN_RGB_BRUSH = (1<<9), /* Whether we can use gdi drawing with solid rgb brush with this surface */
};
