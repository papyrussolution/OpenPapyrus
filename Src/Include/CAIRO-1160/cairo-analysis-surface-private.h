 ...
 * Contributor(s): Keith Packard <keithp@keithp.com>
 */
...
cairo_private boolint FASTCALL _cairo_analysis_surface_has_supported(const cairo_surface_t * surface);
cairo_private boolint FASTCALL _cairo_analysis_surface_has_unsupported(const cairo_surface_t * surface);
cairo_private void FASTCALL _cairo_analysis_surface_get_bounding_box(const cairo_surface_t * surface, cairo_box_t * bbox);
