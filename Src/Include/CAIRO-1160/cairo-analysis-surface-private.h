...
cairo_private boolint _cairo_analysis_surface_has_supported(cairo_surface_t * surface);
cairo_private boolint _cairo_analysis_surface_has_unsupported(cairo_surface_t * surface);
