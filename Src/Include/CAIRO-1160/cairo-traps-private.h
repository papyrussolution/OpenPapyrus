...
cairo_private void FASTCALL _cairo_traps_add_trap(cairo_traps_t * traps, cairo_fixed_t top, cairo_fixed_t bottom, const cairo_line_t * left, const cairo_line_t * right);
...
cairo_private boolint _cairo_traps_to_boxes(cairo_traps_t * traps, cairo_antialias_t antialias, cairo_boxes_t * boxes);
