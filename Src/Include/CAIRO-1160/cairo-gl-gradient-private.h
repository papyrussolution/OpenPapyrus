...
cairo_private cairo_int_status_t _cairo_gl_gradient_create(cairo_gl_context_t           * ctx,
    uint n_stops, const cairo_gradient_stop_t  * stops, cairo_gl_gradient_t         ** gradient_out);
...
cairo_private boolint _cairo_gl_gradient_equal(const void * key_a, const void * key_b);
