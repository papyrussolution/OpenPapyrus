...
typedef cairo_status_t (* cairo_output_stream_write_func_t) (cairo_output_stream_t * output_stream, const unsigned char   * data, uint length);
...
cairo_private void _cairo_output_stream_write(cairo_output_stream_t * stream,
...
cairo_private void _cairo_output_stream_vprintf(cairo_output_stream_t * stream,
    const char * fmt,
    va_list ap) CAIRO_PRINTF_FORMAT(2, 0);

cairo_private void _cairo_output_stream_printf(cairo_output_stream_t * stream,
    const char * fmt,
    ...) CAIRO_PRINTF_FORMAT(2, 3);

/* Print matrix element values with rounding of insignificant digits. */
cairo_private void _cairo_output_stream_print_matrix(cairo_output_stream_t * stream,
...
cairo_private void _cairo_memory_stream_copy(cairo_output_stream_t * base,
    cairo_output_stream_t * dest);

cairo_private int _cairo_memory_stream_length(cairo_output_stream_t * stream);

cairo_private cairo_status_t _cairo_memory_stream_destroy(cairo_output_stream_t * abstract_stream,
