 ...
 * Since: 1.0
 **/
// @sobolev typedef struct _cairo_surface cairo_surface_t;
 ...
 * Since: 1.0
 **/
// @sobolev typedef struct _cairo_pattern cairo_pattern_t;
...
cairo_public const char * cairo_font_options_get_variations(const cairo_font_options_t * options);
...
cairo_public cairo_status_t cairo_font_face_set_user_data(cairo_font_face_t * font_face, const cairo_user_data_key_t * key,
    void * user_data, cairo_destroy_func_t destroy);
//
// Portable interface to general font features. 
//
cairo_public cairo_scaled_font_t * cairo_scaled_font_create(cairo_font_face_t * font_face, const cairo_matrix_t * font_matrix, 
 ...
 * Since: 1.8
 **/
typedef cairo_status_t (* cairo_user_scaled_font_unicode_to_glyph_func_t) (cairo_scaled_font_t * scaled_font, ulong unicode, ulong * glyph_index);
...
cairo_public cairo_status_t cairo_pattern_status(const cairo_pattern_t * pattern);
...
cairo_public cairo_pattern_type_t cairo_pattern_get_type(const cairo_pattern_t * pattern);
...
cairo_public void cairo_pattern_get_matrix(const cairo_pattern_t * pattern, cairo_matrix_t * matrix);
...
cairo_public cairo_extend_t cairo_pattern_get_extend(const cairo_pattern_t * pattern);
...
cairo_public cairo_filter_t cairo_pattern_get_filter(const cairo_pattern_t * pattern);
