 ...
 ************************************************************************/
 ...
 #define UCL_OS_WIN32          1
  ...
  #error "check your limits.h header"
 #endif
#elif defined(__DOS__) || defined(__MSDOS__) || defined(_MSDOS) || defined(MSDOS) || (defined(__PACIFIC__) && \
        defined(DOS))
 #if (UINT_MAX == UCL_0xffffL)
  #define UCL_OS_DOS16        1
 #elif (UINT_MAX == UCL_0xffffffffL)
...
#if (UINT_MAX == UCL_0xffffL)
 #if (defined(__MSDOS__) && defined(__TURBOC__) && (__TURBOC__ < 0x0410)) || (defined(MSDOS) && defined(_MSC_VER) && \
        (_MSC_VER < 700))
  #if !defined(__cdecl)
...
typedef int (__UCL_CDECL*ucl_compress_dict_t)(const ucl_bytep src, ucl_uint src_len, ucl_bytep dst, ucl_uintp dst_len, ucl_voidp wrkmem, const ucl_bytep dict, ucl_uint dict_len );
typedef int (__UCL_CDECL*ucl_decompress_dict_t)(const ucl_bytep src, ucl_uint src_len, ucl_bytep dst, ucl_uintp dst_len, ucl_voidp wrkmem, const ucl_bytep dict, ucl_uint dict_len );
...
#define ucl_init() __ucl_init2(UCL_VERSION, (int)sizeof(short), (int)sizeof(int), \
	...
	(int)-1, (int)sizeof(char *), (int)sizeof(ucl_voidp), (int)sizeof(ucl_compress_t))
...
/* string functions */
UCL_EXTERN(int) ucl_memcmp(const ucl_voidp _s1, const ucl_voidp _s2, ucl_uint _len);
UCL_EXTERN(ucl_voidp) ucl_memcpy(ucl_voidp _dest, const ucl_voidp _src, ucl_uint _len);
UCL_EXTERN(ucl_voidp) ucl_memmove(ucl_voidp _dest, const ucl_voidp _src, ucl_uint _len);
UCL_EXTERN(ucl_voidp) ucl_memset(ucl_voidp _s, int _c, ucl_uint _len);

/* checksum functions */
UCL_EXTERN(ucl_uint32) ucl_adler32(ucl_uint32 _adler, const ucl_bytep _buf, ucl_uint _len);
UCL_EXTERN(ucl_uint32) ucl_crc32(ucl_uint32 _c, const ucl_bytep _buf, ucl_uint _len);
UCL_EXTERN(const ucl_uint32p) ucl_get_crc32_table(void);
