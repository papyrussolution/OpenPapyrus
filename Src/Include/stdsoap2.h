...
/* DEBUG macros */
  ...
  #define SOAP_DELETE_ARRAY(obj) delete[] obj
   ...
   #define DBGFUN1(FNAME, FMT, ARG) DBGLOG(TEST, \
	SOAP_MESSAGE(fdebug, "%s(%d): %s("FMT ")\n", __FILE__, __LINE__, FNAME, (ARG)))
...
class soap_multipart_iterator { public:
...
SOAP_FMAC1 struct soap_clist * SOAP_FMAC2 soap_link(struct soap *, void *, int, int, int (* fdelete)(
		struct soap_clist *));
...
SOAP_FMAC1 void * SOAP_FMAC2 soap_id_forward(struct soap *, const char * id, void * p, size_t len, int st, int tt,
	size_t n, unsigned int k, void (* fcopy)(struct soap *, int, int, void *, size_t, const void *,
		size_t));
 #endif
...
SOAP_FMAC1 int SOAP_FMAC2 soap_element_id(struct soap *, const char * tag, int id, const void * p,
	const struct soap_array * a, int d, const char * type,
	int n);
...
SOAP_FMAC1 int SOAP_FMAC2 soap_outdateTime(struct soap *, const char * tag, int id, const time_t * p, const char *, int);
 ...
 #ifndef WITH_LEANER
SOAP_FMAC1 int SOAP_FMAC2 soap_outwstring(struct soap *, const char * tag, int id, wchar_t * const * p, const char *,
	int);
...
SOAP_FMAC1 int SOAP_FMAC2 soap_register_plugin_arg(struct soap *, int (* fcreate)(struct soap *, struct soap_plugin *,
		void *), void *);
