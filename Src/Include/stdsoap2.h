...
/* Portability: define SOAP_SOCKLEN_T */
  ...
  #define SOAP_SOCKLEN_T SOCKLEN_T
	...
	defined(__FreeBSD__) || defined(OPENBSD) || defined(__QNX__) || defined(QNX) || defined(OS390) || defined(HP_UX)
  #define SOAP_SOCKLEN_T socklen_t
...
//extern const char soap_base64o[];
extern const char soap_base64i[];
...
/* gSOAP error codes */
 ...
 #define soap_xml_error_check(e) oneof12((e), SOAP_TAG_MISMATCH, SOAP_NO_TAG, SOAP_SYNTAX_ERROR, SOAP_NAMESPACE, SOAP_DUPLICATE_ID, SOAP_MISSING_ID, SOAP_REQUIRED, SOAP_PROHIBITED, SOAP_OCCURS, SOAP_LENGTH, SOAP_NULL, SOAP_HREF)
 #define soap_soap_error_check(e) oneof6((e), SOAP_CLI_FAULT, SOAP_SVR_FAULT, SOAP_VERSIONMISMATCH, SOAP_MUSTUNDERSTAND, SOAP_FAULT, SOAP_NO_METHOD)
...
#define SOAP_SSL_SKIP_HOST_CHECK                0x04   /* client does not check the common name of the host in
	                                                certificate */
#define SOAP_SSL_ALLOW_EXPIRED_CERTIFICATE      0x08   /* client does not check the expiration date of the host
	                                                certificate */
...
#endif
#ifndef SOAP_MALLOC
	#define SOAP_MALLOC(soap, size) SAlloc::M(size)
#endif
#ifndef SOAP_FREE
	#define SOAP_FREE(soap, ptr) SAlloc::F(ptr)
#endif
...
FILE * FASTCALL soap_get_dbg_file(struct soap * pSoap, int idx);
   ...
   #define DBGFUN2(FNAME, FMT1, ARG1, FMT2, ARG2) DBGLOG(TEST, SOAP_MESSAGE(fdebug, "%s(%d): %s("FMT 1 ", "FMT 2 ")\n", __FILE__, __LINE__, FNAME, (ARG1), (ARG2)))
   #define DBGFUN3(FNAME, FMT1, ARG1, FMT2, ARG2, FMT3, ARG3) DBGLOG(TEST, SOAP_MESSAGE(fdebug, "%s(%d): %s("FMT 1 ", "FMT 2 ", "FMT 3 ")\n", __FILE__, __LINE__, FNAME, (ARG1), (ARG2), (ARG3)))
  #endif
  #ifndef DBGHEX
...
struct soap_attribute {
	...
	short visible; // @v11.2.0
	char * value;
	size_t size;
	const char * ns;
	// @v11.2.0 (moved up for alignment) short visible;
...
struct soap_code_map { // @todo replace with SIntToSymbTabEntry
	long code;
	const char * string; 
};
...
#ifndef WITH_LEAN
	#ifdef __cplusplus
		#define soap_get0(soap) ((soap)->Get0())
		#define soap_get1(soap) ((soap)->Get1())
	#else
		#define soap_get0(soap) (((soap)->bufidx>=(soap)->buflen && soap_recv(soap)) ? EOF : (uchar)(soap)->buf[(soap)->bufidx])
		#define soap_get1(soap) (((soap)->bufidx>=(soap)->buflen && soap_recv(soap)) ? EOF : (uchar)(soap)->buf[(soap)->bufidx++])
	#endif
...
SOAP_FMAC1 void /*SOAP_FMAC4*/ FASTCALL soap_fault(struct soap *);
...
SOAP_FMAC1 void /*SOAP_FMAC2*/ FASTCALL soap_serializeheader(struct soap *);
SOAP_FMAC1 int /*SOAP_FMAC2*/ FASTCALL soap_putheader(struct soap *);
...
SOAP_FMAC1 int SOAP_FMAC2 soap_ssl_server_context(struct soap *, ushort, const char *, const char *, const char *, const char *, const char *, const char *, const char *);
SOAP_FMAC1 int SOAP_FMAC2 soap_ssl_client_context(struct soap *, ushort, const char *, const char *, const char *, const char *, const char *);
SOAP_FMAC1 int SOAP_FMAC2 soap_puthttphdr(struct soap *, int status, size_t count);
SOAP_FMAC1 const char * /*SOAP_FMAC2*/FASTCALL soap_get_header_attribute(struct soap *, const char *, const char *);
SOAP_FMAC1 const char * /*SOAP_FMAC2*/FASTCALL soap_decode_key(char *, size_t, const char *);
SOAP_FMAC1 const char * /*SOAP_FMAC2*/FASTCALL soap_decode_val(char *, size_t, const char *);
SOAP_FMAC1 size_t /*SOAP_FMAC2*/FASTCALL soap_hash(const char *);
...
SOAP_FMAC1 soap_wchar /*SOAP_FMAC2*/FASTCALL soap_get(struct soap *);
SOAP_FMAC1 soap_wchar /*SOAP_FMAC2*/FASTCALL soap_getchar(struct soap *);
SOAP_FMAC1 int /*SOAP_FMAC2*/FASTCALL soap_tag_cmp(const char *, const char *);
...
SOAP_FMAC1 soap_wchar /*SOAP_FMAC2*/FASTCALL soap_getutf8(struct soap *);
SOAP_FMAC1 int SOAP_FMAC2 soap_putbase64(struct soap *, const uchar *, int);
SOAP_FMAC1 uchar * SOAP_FMAC2 soap_getbase64(struct soap *, int *, int);
SOAP_FMAC1 int SOAP_FMAC2 soap_puthex(struct soap *, const uchar *, int);
SOAP_FMAC1 uchar * SOAP_FMAC2 soap_gethex(struct soap *, int *);
#ifndef WITH_LEANER
	SOAP_FMAC1 int SOAP_FMAC2 soap_xop_forward(struct soap *, uchar **, int *, char **, char **, char **);
	SOAP_FMAC1 int SOAP_FMAC2 soap_dime_forward(struct soap *, uchar **, int *, char **, char **, char **);
#endif
#ifndef WITH_NOIDREF
	...
	SOAP_FMAC1 struct soap_ilist * /*SOAP_FMAC2*/FASTCALL soap_lookup(struct soap *, const char *);
	SOAP_FMAC1 struct soap_ilist * /*SOAP_FMAC2*/FASTCALL soap_enter(struct soap *, const char *);
	SOAP_FMAC1 int SOAP_FMAC2 soap_resolve(struct soap *);
	SOAP_FMAC1 void /*SOAP_FMAC2*/ FASTCALL soap_embedded(struct soap *, const void * p, int t);
...
SOAP_FMAC1 int /*SOAP_FMAC2*/ FASTCALL soap_begin_send(struct soap *);
SOAP_FMAC1 int /*SOAP_FMAC2*/ FASTCALL soap_end_send(struct soap *);
SOAP_FMAC1 const struct soap_code_map * /*SOAP_FMAC2*/ FASTCALL soap_code(const struct soap_code_map *, const char *);
SOAP_FMAC1 long SOAP_FMAC2 soap_code_int(const struct soap_code_map *, const char *, long);
SOAP_FMAC1 const char * /*SOAP_FMAC2*/ FASTCALL soap_code_str(const struct soap_code_map *, long);
...
SOAP_FMAC1 int /*SOAP_FMAC2*/FASTCALL soap_getline(struct soap *, char *, int);
SOAP_FMAC1 int SOAP_FMAC2 soap_begin_serve(struct soap *);
SOAP_FMAC1 int /*SOAP_FMAC2*/ FASTCALL soap_begin_recv(struct soap *);
...
#ifndef WITH_NOIDREF
	SOAP_FMAC1 int /*SOAP_FMAC2*/ FASTCALL soap_lookup_type(struct soap *, const char * id);
	SOAP_FMAC1 void * /*SOAP_FMAC2*/FASTCALL soap_id_lookup(struct soap *, const char * id, void ** p, int t, size_t n, unsigned int k);
	SOAP_FMAC1 void * /*SOAP_FMAC2*/FASTCALL soap_id_forward(struct soap *, const char * id, void * p, size_t len, int st, int tt,
		size_t n, uint k, void (* fcopy)(struct soap *, int, int, void *, size_t, const void *, size_t));
#endif
SOAP_FMAC1 void * /*SOAP_FMAC2*/FASTCALL soap_id_enter(struct soap *, const char * id, void * p, int t, size_t n, unsigned int k,
...
SOAP_FMAC1 int /*SOAP_FMAC2*/FASTCALL soap_closesock(struct soap *);
...
SOAP_FMAC1 void /*SOAP_FMAC2*/ FASTCALL soap_begin(struct soap *);
SOAP_FMAC1 void /*SOAP_FMAC2*/ FASTCALL soap_end(struct soap *);
SOAP_FMAC1 void /*SOAP_FMAC2*/ FASTCALL soap_delete(struct soap *, void *);
...
SOAP_FMAC1 int /*SOAP_FMAC2*/ STDCALL soap_match_tag(struct soap *, const char *, const char *);
SOAP_FMAC1 int SOAP_FMAC2 soap_match_array(struct soap *, const char *);
SOAP_FMAC1 int /*SOAP_FMAC2*/STDCALL soap_element(struct soap *, const char *, int, const char *);
SOAP_FMAC1 int /*SOAP_FMAC2*/STDCALL soap_element_begin_out(struct soap *, const char * tag, int id, const char * type);
...
SOAP_FMAC1 int /*SOAP_FMAC2*/STDCALL soap_element_href(struct soap *, const char * tag, int id, const char * ref, const char * val);
...
SOAP_FMAC1 int /*SOAP_FMAC2*/FASTCALL soap_element_start_end_out(struct soap *, const char * tag);
...
SOAP_FMAC1 int /*SOAP_FMAC2*/FASTCALL soap_string_out(struct soap *, const char * s, int flag);
...
SOAP_FMAC1 int /*SOAP_FMAC2*/FASTCALL soap_append_lab(struct soap *, const char *, size_t);
SOAP_FMAC1 struct soap_blist * /*SOAP_FMAC2*/ FASTCALL soap_new_block(struct soap *);
SOAP_FMAC1 void * /*SOAP_FMAC2*/ FASTCALL soap_push_block(struct soap *, struct soap_blist *, size_t);
SOAP_FMAC1 void /*SOAP_FMAC2*/ FASTCALL soap_pop_block(struct soap *, struct soap_blist *);
SOAP_FMAC1 size_t /*SOAP_FMAC2*/FASTCALL soap_size_block(struct soap *, struct soap_blist *, size_t);
SOAP_FMAC1 char * /*SOAP_FMAC2*/FASTCALL soap_first_block(struct soap *, struct soap_blist *);
SOAP_FMAC1 char * /*SOAP_FMAC2*/FASTCALL soap_next_block(struct soap *, struct soap_blist *);
SOAP_FMAC1 size_t /*SOAP_FMAC2*/FASTCALL soap_block_size(struct soap *, struct soap_blist *);
SOAP_FMAC1 char * SOAP_FMAC2 soap_save_block(struct soap *, struct soap_blist *, char *, int);
SOAP_FMAC1 void /*SOAP_FMAC2*/ FASTCALL soap_end_block(struct soap *, struct soap_blist *);
SOAP_FMAC1 void SOAP_FMAC2 soap_update_pointers(struct soap * soap, char * start, char * end, char * p1, char * p2);
SOAP_FMAC1 int /*SOAP_FMAC2*/ FASTCALL soap_envelope_begin_out(struct soap *);
SOAP_FMAC1 int /*SOAP_FMAC2*/ FASTCALL soap_envelope_end_out(struct soap *);
SOAP_FMAC1 char * SOAP_FMAC2 soap_get_http_body(struct soap *);
SOAP_FMAC1 int /*SOAP_FMAC2*/ FASTCALL soap_envelope_begin_in(struct soap *);
SOAP_FMAC1 int /*SOAP_FMAC2*/ FASTCALL soap_envelope_end_in(struct soap *);
SOAP_FMAC1 int /*SOAP_FMAC2*/ FASTCALL soap_body_begin_out(struct soap *);
SOAP_FMAC1 int /*SOAP_FMAC2*/ FASTCALL soap_body_end_out(struct soap *);
SOAP_FMAC1 int /*SOAP_FMAC2*/ FASTCALL soap_body_begin_in(struct soap *);
SOAP_FMAC1 int /*SOAP_FMAC2*/ FASTCALL soap_body_end_in(struct soap *);
SOAP_FMAC1 int /*SOAP_FMAC2*/ FASTCALL soap_recv_header(struct soap *);
...
SOAP_FMAC1 int SOAP_FMAC2 soap_s2unsignedByte(struct soap *, const char *, uchar *);
SOAP_FMAC1 int SOAP_FMAC2 soap_s2unsignedShort(struct soap *, const char *, ushort *);
SOAP_FMAC1 int SOAP_FMAC2 soap_s2unsignedInt(struct soap *, const char *, unsigned int *);
SOAP_FMAC1 int SOAP_FMAC2 soap_s2unsignedLong(struct soap *, const char *, ulong *);
...
SOAP_FMAC1 int SOAP_FMAC2 soap_s2QName(struct soap *, const char *, char **, long minlen, long maxlen);
	...
	SOAP_FMAC1 char * SOAP_FMAC2 soap_s2base64(struct soap *, const uchar *, char *, int);
	SOAP_FMAC1 char * SOAP_FMAC2 soap_s2hex(struct soap *, const uchar *, char *, int);
#endif
...
SOAP_FMAC1 const char * /*SOAP_FMAC2*/FASTCALL soap_long2s(struct soap *, long);
...
SOAP_FMAC1 const char * SOAP_FMAC2 soap_unsignedByte2s(struct soap *, uchar);
SOAP_FMAC1 const char * SOAP_FMAC2 soap_unsignedShort2s(struct soap *, ushort);
...
SOAP_FMAC1 uchar * SOAP_FMAC2 soap_inunsignedByte(struct soap *, const char * tag, uchar * p, const char *, int);
SOAP_FMAC1 ushort * SOAP_FMAC2 soap_inunsignedShort(struct soap *, const char * tag, ushort * p, const char *, int);
SOAP_FMAC1 unsigned int * SOAP_FMAC2 soap_inunsignedInt(struct soap *, const char * tag, unsigned int * p, const char *, int);
SOAP_FMAC1 ulong * SOAP_FMAC2 soap_inunsignedLong(struct soap *, const char * tag, ulong * p, const char *, int);
SOAP_FMAC1 ULONG64 * SOAP_FMAC2 soap_inULONG64(struct soap *, const char * tag, ULONG64 * p, const char *, int);
SOAP_FMAC1 char ** /*SOAP_FMAC2*/ FASTCALL soap_instring(struct soap *, const char * tag, char ** p, const char *, int, int, long, long);
...
SOAP_FMAC1 int SOAP_FMAC2 soap_outunsignedByte(struct soap *, const char * tag, int id, const uchar * p, const char *, int);
SOAP_FMAC1 int SOAP_FMAC2 soap_outunsignedShort(struct soap *, const char * tag, int id, const ushort * p, const char *, int);
SOAP_FMAC1 int SOAP_FMAC2 soap_outunsignedInt(struct soap *, const char * tag, int id, const unsigned int * p, const char *, int);
SOAP_FMAC1 int SOAP_FMAC2 soap_outunsignedLong(struct soap *, const char * tag, int id, const ulong * p, const char *, int);
SOAP_FMAC1 int SOAP_FMAC2 soap_outULONG64(struct soap *, const char * tag, int id, const ULONG64 * p, const char *, int);
SOAP_FMAC1 int /*SOAP_FMAC2*/ FASTCALL soap_outstring(struct soap *, const char * tag, int id, char * const * p, const char *, int);
SOAP_FMAC1 int SOAP_FMAC2 soap_outliteral(struct soap *, const char * tag, char * const * p, const char * type);
	...
	SOAP_FMAC1 int SOAP_FMAC2 soap_set_dime_attachment(struct soap *, char * ptr, size_t size, const char * type, const char * id, ushort optype, const char * option);
	SOAP_FMAC1 int SOAP_FMAC2 soap_set_mime_attachment(struct soap *, char * ptr, size_t size,
		enum soap_mime_encoding encoding, const char * type, const char * id, const char * location, const char * description);
