...
/* Copyright (c) Oracle Corporation 1994, 1995, 1996, 1997, 1999, 2000.  All Rights Reserved. */
...
sword OCITypeIterNew(/*_ OCIEnv *env, OCIError *err, OCIType *tdo,
                       OCITypeIter **iterator_ort _*/);
#else
...
/* ** OBSOLETE ** */
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCITypeIterSet(/*_ OCIEnv *env, OCIError *err, OCIType *tdo,
                  OCITypeIter *iterator_ort _*/);
#else
...
/* ** OBSOLETE ** */
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCITypeIterFree(/*_ OCIEnv *env, OCIError *err, OCITypeIter
                       *iterator_ort _*/);
#else
...
/* ** OBSOLETE ** */
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCITypeByName(/*_ OCIEnv *env, OCIError *err,
                        CONST OCISvcCtx *svc, CONST oratext *schema_name,
                        ub4 s_length, CONST oratext *type_name,
...
sword
    OCITypeArrayByName(/*_ OCIEnv *env, OCIError *err, CONST OCISvcCtx *svc,
                           ub4 array_len, CONST oratext *schema_name[],
                           ub4 s_length[], CONST oratext *type_name[],
                           ub4 t_length[], CONST oratext *version_name[],
                           ub4 v_length[], OCIDuration pin_duration,
                           OCITypeGetOpt get_option, OCIType *tdo[] _*/);
...
/* ** OBSOLETE ** */
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
oratext* OCITypeName(/*_ OCIEnv *env, OCIError *err, CONST OCIType *tdo, 
                    ub4 *n_length _*/);
#else /* ANSI C */
...
/* ** OBSOLETE ** */
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
oratext* OCITypeSchema(/*_ OCIEnv *env, OCIError *err, CONST OCIType *tdo, 
                   ub4 *n_length _*/);
#else /* ANSI C */
...
/* ** OBSOLETE ** */
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
oratext* OCITypeVersion(/*_ OCIEnv *env, OCIError *err, CONST OCIType *tdo, 
                       ub4 *v_length _*/);
#else /* ANSI C */
...
/* ** OBSOLETE ** */
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
oratext* OCITypeElemName(/*_ OCIEnv *env, OCIError *err, CONST OCITypeElem *elem, 
                        ub4 *n_length _*/);
#else /* ANSI C */
oratext* OCITypeElemName(    OCIEnv *env, OCIError *err, CONST OCITypeElem *elem, 
                          ub4 *n_length    );
#endif
/*
...
/* ** OBSOLETE ** */
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
ub1 OCITypeElemNumPrec(/*_ OCIEnv *env, OCIError *err,
                           CONST OCITypeElem *elem _*/);
#else /* ANSI C */
...
/* ** OBSOLETE ** */
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sb1 OCITypeElemNumScale(/*_ OCIEnv *env, OCIError *err,
                            CONST OCITypeElem *elem _*/);
#else /* ANSI C */
...
/* ** OBSOLETE ** */
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
ub4 OCITypeElemLength(/*_ OCIEnv *env, OCIError *err,
                          CONST OCITypeElem *elem _*/);
#else /* ANSI C */
...
/* ** OBSOLETE ** */
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
ub2 OCITypeElemCharSetID(/*_ OCIEnv *env, OCIError *err,
                             CONST OCITypeElem *elem _*/);
#else /* ANSI C */
...
/* ** OBSOLETE ** */
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
ub2 OCITypeElemCharSetForm(/*_ OCIEnv *env, OCIError *err,
                               CONST OCITypeElem *elem _*/);
#else /* ANSI C */
...
/* ** OBSOLETE ** */
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCITypeElemParameterizedType(/*_ OCIEnv *env, OCIError *err,
                                       CONST OCITypeElem *elem, 
                                       OCIType **type_stored _*/);
#else /* ANSI C */
...
/* ** OBSOLETE ** */
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
OCITypeCode OCITypeElemExtTypeCode(/*_ OCIEnv *env, OCIError *err,
                                       CONST OCITypeElem *elem _*/);
#else /* ANSI C */
...
/* ** OBSOLETE ** */
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCITypeAttrByName(/*_ OCIEnv *env, OCIError *err, CONST OCIType *tdo, 
...
/* ** OBSOLETE ** */
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCITypeAttrNext(/*_ OCIEnv *env, OCIError *err, OCITypeIter *iterator_ort,
                        OCITypeElem **elem _*/);
#else /* ANSI C */
sword OCITypeAttrNext(    OCIEnv *env, OCIError *err, OCITypeIter *iterator_ort,
                          OCITypeElem **elem   );
#endif
...
/* ** OBSOLETE ** */
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCITypeCollElem(/*_ OCIEnv *env, OCIError *err, CONST OCIType *tdo,
                        OCITypeElem **element _*/);
#else /* ANSI C */
...
/* ** OBSOLETE ** */
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCITypeCollSize(/*_ OCIEnv *env, OCIError *err, CONST OCIType *tdo, 
                          ub4 *num_elems _*/);
#else /* ANSI C */
...
/* ** OBSOLETE ** */
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCITypeCollExtTypeCode(/*_ OCIEnv *env, OCIError *err,
                               CONST OCIType *tdo, OCITypeCode *sqt_code _*/);
#else /* ANSI C */
...
/* ** OBSOLETE ** */
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
ub4 OCITypeMethodOverload(/*_ OCIEnv *env, OCIError *err, CONST OCIType *tdo, 
                              CONST oratext *method_name, ub4 m_length _*/);
#else /* ANSI C */
...
/* ** OBSOLETE ** */
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCITypeMethodByName(/*_ OCIEnv *env, OCIError *err, CONST OCIType *tdo, 
                              CONST oratext *method_name, ub4 m_length,
                              OCITypeMethod **mdos _*/);
#else /* ANSI C */
...
/* ** OBSOLETE ** */
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCITypeMethodNext(/*_ OCIEnv *env, OCIError *err, OCITypeIter *iterator_ort,
                          OCITypeMethod **mdo _*/);
#else /* ANSI C */
sword OCITypeMethodNext(    OCIEnv *env, OCIError *err, OCITypeIter *iterator_ort,
                            OCITypeMethod **mdo   );
#endif
...
/* ** OBSOLETE ** */
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
oratext *OCITypeMethodName(/*_ OCIEnv *env, OCIError *err,
                            CONST OCITypeMethod *mdo, ub4 *n_length _*/);
#else /* ANSI C */
...
/* ** OBSOLETE ** */
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
OCITypeEncap OCITypeMethodEncap(/*_ OCIEnv *env, OCIError *err,
                                    CONST OCITypeMethod *mdo _*/);
#else /* ANSI C */
...
/* ** OBSOLETE ** */
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
OCITypeMethodFlag OCITypeMethodFlags(/*_ OCIEnv *env, OCIError *err,
                                         CONST OCITypeMethod *mdo _*/);
#else /* ANSI C */
...
/* ** OBSOLETE ** */
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCITypeMethodMap(/*_ OCIEnv *env, OCIError *err, CONST OCIType *tdo, 
                           OCITypeMethod **mdo _*/);
#else /* ANSI C */
...
/* ** OBSOLETE ** */
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCITypeMethodOrder(/*_ OCIEnv *env, OCIError *err, CONST OCIType *tdo, 
                             OCITypeMethod **mdo _*/);
#else /* ANSI C */
...
/* ** OBSOLETE ** */
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
ub4 OCITypeMethodParams(/*_ OCIEnv *env, OCIError *err,
                            CONST OCITypeMethod *mdo _*/);
#else /* ANSI C */
...
/* ** OBSOLETE ** */
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCITypeResult(/*_ OCIEnv *env, OCIError *err, CONST OCITypeMethod *mdo,
                        OCITypeElem **rdo _*/);
#else /* ANSI C */
...
/* ** OBSOLETE ** */
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCITypeParamByPos(/*_ OCIEnv *env, OCIError *err,
...
/* ** OBSOLETE ** */
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCITypeParamByName(/*_ OCIEnv *env, OCIError *err,
                           CONST OCITypeMethod *mdo,
                           CONST oratext *name, ub4 n_length,
                           OCITypeElem **elem _*/);
#else /* ANSI C */
...
/* ** OBSOLETE ** */
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCITypeParamPos(/*_ OCIEnv *env, OCIError *err,
                          CONST OCITypeMethod *mdo, 
...
/* ** OBSOLETE ** */
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
OCITypeParamMode OCITypeElemParamMode(/*_ OCIEnv *env, OCIError *err,
                                          CONST OCITypeElem *elem _*/);
#else /* ANSI C */
...
/* ** OBSOLETE ** */
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
oratext* OCITypeElemDefaultValue(/*_ OCIEnv *env, OCIError *err,
                                  CONST OCITypeElem *elem,
                                  ub4 *d_v_length _*/);
#else /* ANSI C */
...
/* ** OBSOLETE ** */
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCITypeVTInit(/*_ OCIEnv *env, OCIError *err _*/);
#else /* ANSI C */
...
/* ** OBSOLETE ** */
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCITypeVTInsert(/*_ OCIEnv *env, OCIError *err, CONST oratext *schema_name,
                        ub4 s_n_length, CONST oratext *type_name,
                        ub4 t_n_length, CONST oratext *user_version,
                        ub4 u_v_length _*/);
#else /* ANSI C */
sword OCITypeVTInsert(  OCIEnv *env, OCIError *err, CONST oratext *schema_name,
                        ub4 s_n_length, CONST oratext *type_name,
                        ub4 t_n_length, CONST oratext *user_version,
                        ub4 u_v_length    );
#endif
...
/* ** OBSOLETE ** */
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCITypeVTSelect(/*_ OCIEnv *env, OCIError *err, CONST oratext *schema_name,
                          ub4 s_n_length, CONST oratext *type_name,
                          ub4 t_n_length, oratext **user_version, ub4 *u_v_length,
                          ub2 *version _*/);
#else /* ANSI C */
sword OCITypeVTSelect(  OCIEnv *env, OCIError *err, CONST oratext *schema_name,
                        ub4 s_n_length, CONST oratext *type_name,
                        ub4 t_n_length, oratext **user_version, ub4 *u_v_length,
                        ub2 *version );
#endif
...
/* Compatibility function - following function prototype retained for 
   compatibility only */
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword ortgcty(/*_ OCIEnv *env, OCIError *err, OCIType *coll_tdo,
                  OCIType **collelem_tdo _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCITypeBeginCreate(/*_ OCISvcCtx *svchp, OCIError *errhp, OCITypeCode tc,
                             OCIDuration dur, OCIType **type _*/);
#else  /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCITypeSetCollection(/*_ OCISvcCtx *svchp, OCIError *errhp,
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCITypeSetBuiltin(/*_ OCISvcCtx *svchp, OCIError *errhp, OCIType *type,
                            OCIParam *builtin_info _*/);
#else  /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCITypeAddAttr(/*_ OCISvcCtx *svchp, OCIError *errhp, OCIType *type,
                         CONST oratext *a_name, ub4 a_length, OCIParam *attr_info
                     _*/);
#else  /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCITypeEndCreate(/*_ OCISvcCtx *svchp, OCIError *errhp, OCIType *type
                       _*/);
#else  /* ANSI C */
