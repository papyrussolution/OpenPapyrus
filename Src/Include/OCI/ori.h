...
sword OCIObjectNew(/*_ OCIEnv *env, OCIError *err, CONST OCISvcCtx *svc,
...
/*--------------------------- OCIObjectPin ----------------------------------*/
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCIObjectPin(/*_ OCIEnv *env, OCIError *err, OCIRef *object_ref, 
...
/*------------------------------ OCIObjectUnpin -----------------------------*/
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCIObjectUnpin(/*_ OCIEnv *env, OCIError *err, dvoid *object _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCIObjectGetObjectRef(/*_ OCIEnv *env, OCIError *err, dvoid *object, 
                                OCIRef *object_ref _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCIObjectMakeObjectRef(/*_ OCIEnv *env, OCIError *err,
                                 CONST OCISvcCtx *svc, dvoid *table,
                                 dvoid **attrlist, ub4 attrcnt, 
                                 OCIRef *object_ref _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCIObjectGetPrimaryKeyTypeRef(/*_ OCIEnv *env, OCIError *err,
                                        CONST OCISvcCtx *svc, dvoid *table, 
                                        OCIRef *type_ref _*/);
#else /* ANSI C */
...
/*-------------------------- OCIObjectGetInd --------------------------------*/
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCIObjectGetInd(/*_ OCIEnv *env, OCIError *err, dvoid *instance, 
                          dvoid **null_struct _*/);
#else /* ANSI C */
...
/*------------------------- OCIObjectExists --------------------------------*/
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCIObjectExists(/*_ OCIEnv *env, OCIError *err, dvoid *ins, 
                         boolean *exist _*/); 
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCIObjectGetProperty(/*_ OCIEnv *envh, OCIError *errh, 
                               CONST dvoid *obj, OCIObjectPropId propertyId,
			       dvoid *property, ub4 *size _*/);
#else /* ANSI C */
...
/*---------------------------- OCIObjectIsLocked --------------------------*/
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCIObjectIsLocked(/*_ OCIEnv *env, OCIError *err, dvoid *ins,
                              boolean *lock _*/);
#else /* ANSI C */
...
/*------------------------- OCIObjectIsDirty ------------------------------*/
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCIObjectIsDirty(/*_ OCIEnv *env, OCIError *err, dvoid *ins,
                           boolean *dirty _*/);
#else /* ANSI C */
...
/*--------------------------- OCIObjectPinTable -----------------------------*/
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCIObjectPinTable(/*_ OCIEnv *env, OCIError *err, CONST OCISvcCtx *svc, 
...
/*--------------------------- OCICacheFlush ---------------------------------*/
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCICacheFlush(/*_ OCIEnv *env, OCIError *err, CONST OCISvcCtx *svc, 
...
/*--------------------------- OCICacheRefresh -------------------------------*/
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCICacheRefresh(/*_ OCIEnv *env,OCIError *err,CONST OCISvcCtx *svc,
                  OCIRefreshOpt option, dvoid *context,
                  OCIRef *(*get)(dvoid *context), OCIRef **ref _*/);
#else /* ANSI C */
...
/*---------------------------- OCICacheUnpin --------------------------------*/
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCICacheUnpin(/*_ OCIEnv *env, OCIError *err, CONST OCISvcCtx *svc _*/);
#else /* ANSI C */
...
/*----------------------------- OCICacheFree --------------------------------*/
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCICacheFree(/*_ OCIEnv *env, OCIError *err, CONST OCISvcCtx *svc _*/); 
#else /* ANSI C */
...
/*---------------------------- OCICacheUnmark -------------------------------*/
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCICacheUnmark(/*_ OCIEnv *env, OCIError *err, CONST OCISvcCtx *svc _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCIDurationBegin(/*_ OCIEnv *env, OCIError *err, CONST OCISvcCtx *svc, 
                           OCIDuration parent, OCIDuration *dur _*/);
#else /* ANSI C */ 
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCIDurationEnd(/*_ OCIEnv *env, OCIError *err, CONST OCISvcCtx *svc, 
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCIDurationGetParent(/*_ OCIEnv *env, OCIError *err, 
                               OCIDuration duration, OCIDuration *parent _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCIObjectAlwaysLatest(/*_ OCIEnv *env, OCIError *err, dvoid *object _*/);
#else /* ANSI C */
sword OCIObjectAlwaysLatest(    OCIEnv *env, OCIError *err, dvoid *object    );
#endif

#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCIObjectNotAlwaysLatest(/*_ OCIEnv *env, OCIError *err,
                                   dvoid *object _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCIObjectFlushRefresh(/*_ OCIEnv *env, OCIError *err, dvoid *object _*/);
#else /* ANSI C */
sword OCIObjectFlushRefresh(    OCIEnv *env, OCIError *err, dvoid *object);
#endif

#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCIObjectIsLoaded(/*_ OCIEnv *env, OCIError *err, dvoid *ins,
                              boolean *load _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCIObjectIsDirtied(/*_ OCIEnv *env, OCIError *err, dvoid *ins,
                              boolean *dirty _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCICacheGetObjects(/*_    OCIEnv *env, OCIError *err,
                                CONST OCISvcCtx *svc,
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCICacheRegister(/*_   OCIEnv *env, OCIError *err,
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCICacheFlushRefresh(/*_ OCIEnv *env, OCIError *err, 
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCIObjectSetData(/*_ OCIEnv *env, OCIError *err, dvoid *obj_hdr,
                dvoid *data _*/);
#else /* ANSI C */
...
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCIObjectGetNewOID(/*_ OCIEnv *env, OCIError *err, OCISvcCtx *svc,
                ub1 *oid _*/);
#else /* ANSI C */
