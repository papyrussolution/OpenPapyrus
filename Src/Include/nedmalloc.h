 ...
 */
 #ifdef HAVE_CPP0XVARIADICTEMPLATES
template <typename T, class allocator = nedallocator <T>, typename ... Parameters> inline T * New(
...
template <typename T> inline void Delete(const T * obj)
{
