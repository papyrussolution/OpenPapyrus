...
static __inline FT_Int32 FT_MulFix_arm(FT_Int32 a,
    FT_Int32 b)
{
	FT_Int32 t, t2;
	__asm
...
static __inline__ FT_Int32 FT_MulFix_arm(FT_Int32 a,
    FT_Int32 b)
{
	FT_Int32 t, t2;
...
static __inline__ FT_Int32 FT_MulFix_i386(FT_Int32 a,
    FT_Int32 b)
{
	FT_Int32 result;
...
static __inline FT_Int32 FT_MulFix_i386(FT_Int32 a,
    FT_Int32 b)
{
	FT_Int32 result;
	__asm
...
static __inline__ FT_Int32 FT_MulFix_x86_64(FT_Int32 a,
    FT_Int32 b)
{
 ...
 */
FT_BASE(FT_Bool) FT_Matrix_Check(const FT_Matrix*  matrix);
/*
 * A variant of FT_Vector_Transform.  See comments for
 * FT_Matrix_Multiply_Scaled.
 */
FT_BASE(void) FT_Vector_Transform_Scaled(FT_Vector * vector, const FT_Matrix*  matrix, FT_Long scaling);
/*
 ...
 * instead.
 */
FT_BASE(FT_UInt32) FT_Vector_NormLen(FT_Vector*  vector);
/*
 ...
 */
FT_BASE(FT_Int) ft_corner_orientation(FT_Pos in_x, FT_Pos in_y, FT_Pos out_x, FT_Pos out_y);
/*
