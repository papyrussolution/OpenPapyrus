...
// @sobolev #define FT_MEM_ZERO(dest, count)  FT_MEM_SET(dest, 0, count)
#define FT_ZERO(p)                 memzero(p, sizeof(*(p)))
#define FT_ARRAY_ZERO(dest, count) memzero(dest, (FT_Offset)(count) * sizeof( *(dest)))
