...
enum { /* pthread_attr_{get,set}detachstate
	 */
...
public:
	...
	PThreadCleanup(__ptw32_cleanup_callback_t routine, void * arg) : cleanUpRout(routine), obj(arg), executeIt(1)
		/*
...
__PTW32_DLLPORT int __PTW32_CDECL pthread_attr_getaffinity_np(const pthread_attr_t * attr, size_t cpusetsize, cpu_set_t * cpuset);
__PTW32_DLLPORT int __PTW32_CDECL pthread_attr_getdetachstate(const pthread_attr_t * attr, int * detachstate);
__PTW32_DLLPORT int __PTW32_CDECL pthread_attr_getstackaddr(const pthread_attr_t * attr, void ** stackaddr);
__PTW32_DLLPORT int __PTW32_CDECL pthread_attr_getstacksize(const pthread_attr_t * attr, size_t * stacksize);
__PTW32_DLLPORT int __PTW32_CDECL pthread_attr_setaffinity_np(pthread_attr_t * attr, size_t cpusetsize, const cpu_set_t * cpuset);
__PTW32_DLLPORT int __PTW32_CDECL pthread_attr_setdetachstate(pthread_attr_t * attr, int detachstate);
__PTW32_DLLPORT int __PTW32_CDECL pthread_attr_setstackaddr(pthread_attr_t * attr, void * stackaddr);
__PTW32_DLLPORT int __PTW32_CDECL pthread_attr_setstacksize(pthread_attr_t * attr, size_t stacksize);
__PTW32_DLLPORT int __PTW32_CDECL pthread_attr_getschedparam(const pthread_attr_t * attr, struct sched_param * param);
__PTW32_DLLPORT int __PTW32_CDECL pthread_attr_setschedparam(pthread_attr_t * attr, const struct sched_param * param);
__PTW32_DLLPORT int __PTW32_CDECL pthread_attr_setschedpolicy(pthread_attr_t *, int);
__PTW32_DLLPORT int __PTW32_CDECL pthread_attr_getschedpolicy(const pthread_attr_t *, int *);
__PTW32_DLLPORT int __PTW32_CDECL pthread_attr_setinheritsched(pthread_attr_t * attr, int inheritsched);
__PTW32_DLLPORT int __PTW32_CDECL pthread_attr_getinheritsched(const pthread_attr_t * attr, int * inheritsched);
__PTW32_DLLPORT int __PTW32_CDECL pthread_attr_setscope(pthread_attr_t *, int);
__PTW32_DLLPORT int __PTW32_CDECL pthread_attr_getscope(const pthread_attr_t *, int *);
/*
 * PThread Functions
 */
__PTW32_DLLPORT int __PTW32_CDECL pthread_create(pthread_t * tid, const pthread_attr_t * attr, void * (__PTW32_CDECL * start)(void *), void * arg);
 ...
 */
__PTW32_DLLPORT int __PTW32_CDECL pthread_key_create(pthread_key_t * key, void (__PTW32_CDECL * destructor)(void *));
__PTW32_DLLPORT int __PTW32_CDECL pthread_key_delete(pthread_key_t key);
__PTW32_DLLPORT int __PTW32_CDECL pthread_setspecific(pthread_key_t key, const void * value);
...
__PTW32_DLLPORT int __PTW32_CDECL pthread_mutexattr_getpshared(const pthread_mutexattr_t * attr, int * pshared);
__PTW32_DLLPORT int __PTW32_CDECL pthread_mutexattr_setpshared(pthread_mutexattr_t * attr, int pshared);
...
__PTW32_DLLPORT int __PTW32_CDECL pthread_mutexattr_setrobust(pthread_mutexattr_t * attr, int robust);
__PTW32_DLLPORT int __PTW32_CDECL pthread_mutexattr_getrobust(const pthread_mutexattr_t * attr, int * robust);
/*
...
__PTW32_DLLPORT int __PTW32_CDECL pthread_barrierattr_getpshared(const pthread_barrierattr_t * attr, int * pshared);
__PTW32_DLLPORT int __PTW32_CDECL pthread_barrierattr_setpshared(pthread_barrierattr_t * attr, int pshared);
/*
 * Mutex Functions
 */
__PTW32_DLLPORT int __PTW32_CDECL pthread_mutex_init(pthread_mutex_t * mutex, const pthread_mutexattr_t * attr);
...
__PTW32_DLLPORT int __PTW32_CDECL pthread_mutex_timedlock(pthread_mutex_t * mutex, const struct timespec * abstime);
 ...
 * Barrier Functions
 */
__PTW32_DLLPORT int __PTW32_CDECL pthread_barrier_init(pthread_barrier_t * barrier, const pthread_barrierattr_t * attr, unsigned int count);
...
__PTW32_DLLPORT int __PTW32_CDECL pthread_condattr_getpshared(const pthread_condattr_t * attr, int * pshared);
__PTW32_DLLPORT int __PTW32_CDECL pthread_condattr_setpshared(pthread_condattr_t * attr, int pshared);
/*
 * Condition Variable Functions
 */
__PTW32_DLLPORT int __PTW32_CDECL pthread_cond_init(pthread_cond_t * cond, const pthread_condattr_t * attr);
__PTW32_DLLPORT int __PTW32_CDECL pthread_cond_destroy(pthread_cond_t * cond);
__PTW32_DLLPORT int __PTW32_CDECL pthread_cond_wait(pthread_cond_t * cond, pthread_mutex_t * mutex);
__PTW32_DLLPORT int __PTW32_CDECL pthread_cond_timedwait(pthread_cond_t * cond, pthread_mutex_t * mutex, const struct timespec * abstime);
 ...
 */
__PTW32_DLLPORT int __PTW32_CDECL pthread_rwlock_init(pthread_rwlock_t * lock, const pthread_rwlockattr_t * attr);
...
__PTW32_DLLPORT int __PTW32_CDECL pthread_rwlock_timedrdlock(pthread_rwlock_t * lock, const struct timespec * abstime);
__PTW32_DLLPORT int __PTW32_CDECL pthread_rwlock_wrlock(pthread_rwlock_t * lock);
__PTW32_DLLPORT int __PTW32_CDECL pthread_rwlock_timedwrlock(pthread_rwlock_t * lock, const struct timespec * abstime);
...
__PTW32_DLLPORT int __PTW32_CDECL pthread_rwlockattr_getpshared(const pthread_rwlockattr_t * attr, int * pshared);
__PTW32_DLLPORT int __PTW32_CDECL pthread_rwlockattr_setpshared(pthread_rwlockattr_t * attr, int pshared);
 ...
 */
__PTW32_DLLPORT int __PTW32_CDECL pthread_mutexattr_setkind_np(pthread_mutexattr_t * attr, int kind);
__PTW32_DLLPORT int __PTW32_CDECL pthread_mutexattr_getkind_np(pthread_mutexattr_t * attr, int * kind);
__PTW32_DLLPORT int __PTW32_CDECL pthread_timedjoin_np(pthread_t thread, void ** value_ptr, const struct timespec * abstime);
__PTW32_DLLPORT int __PTW32_CDECL pthread_tryjoin_np(pthread_t thread, void ** value_ptr);
__PTW32_DLLPORT int __PTW32_CDECL pthread_setaffinity_np(pthread_t thread, size_t cpusetsize, const cpu_set_t * cpuset);
__PTW32_DLLPORT int __PTW32_CDECL pthread_getaffinity_np(pthread_t thread, size_t cpusetsize, cpu_set_t * cpuset);
/*
