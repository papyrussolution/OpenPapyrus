...
#define CAIRO_VERSION_MAJOR 1  // USE_cairo_version_OR_cairo_version_string_INSTEAD
#define CAIRO_VERSION_MINOR 10 // USE_cairo_version_OR_cairo_version_string_INSTEAD
#define CAIRO_VERSION_MICRO 2  // USE_cairo_version_OR_cairo_version_string_INSTEAD
