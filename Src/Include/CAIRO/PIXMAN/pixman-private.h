 ...
 */
	 ...
	 * are the things that end up in bleeding edge distributions such as Rawhide etc.
	 *
	 * For performance reasons we don't turn it on for stable releases or
	 * random git checkouts. (Random git checkouts are often used for performance work).
	 */
	#define DEBUG
#endif
