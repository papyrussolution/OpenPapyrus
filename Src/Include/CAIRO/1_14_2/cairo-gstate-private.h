...
cairo_private cairo_status_t _cairo_gstate_show_surface(cairo_gstate_t * gstate, cairo_surface_t * surface,
...
cairo_private cairo_status_t _cairo_gstate_glyph_extents(cairo_gstate_t * gstate, const cairo_glyph_t * glyphs,
...
cairo_private cairo_status_t _cairo_gstate_glyph_path(cairo_gstate_t * gstate, const cairo_glyph_t * glyphs,
    int num_glyphs, cairo_path_fixed_t  * path);
