...
cairo_private void _cairo_boxes_init_with_clip(cairo_boxes_t * boxes, cairo_clip_t * clip);
...
cairo_private void _cairo_boxes_extents(const cairo_boxes_t * boxes, cairo_box_t * box);
