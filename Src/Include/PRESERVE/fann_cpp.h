 ...
 *       except that the Fann *ann/FannTrainData *data
...
namespace FANN {
    /* Class: neural_net
        ...
        Encapsulation of a neural network <Fann> and
        associated C API functions.
    */
    class neural_net {
    public:
        /* Constructor: neural_net(network_type_enum net_type, uint num_layers, const uint *layers)
            ...
            Example:
              >FANN::neural_net net(LAYER, 3, (uint[]) {2, 3, 1});

            This function appears in FANN >= 2.3.0.
         */
        neural_net(network_type_enum net_type, uint num_layers, const uint *layers) {
            switch (net_type){
        ...
        /* Constructor: neural_net(network_type_enum net_type, InputIterator layersBeginIterator, InputIterator layersEndIterator)
            ...
            Parameters:
                net_type - The desired network type of the neural network
                layersBeginIterator - begin iterator to the collection of uint layers
                layersEndIterator - end iterator to the collection of uint layers
        ...
        neural_net(network_type_enum net_type, InputIterator layersBeginIterator, InputIterator layersEndIterator) {
            uint num_layers = static_cast<uint>(std::distance(layersBeginIterator, layersEndIterator));
            uint *layers = new uint[num_layers];
        ...
        /* Constructor: neural_net(network_type_enum net_type, uint num_layers, ...)
	        ...
	        This function appears in FANN >= 2.3.0.
        */
        neural_net(network_type_enum net_type, uint num_layers, ...)
        {
            std::unique_ptr<uint[]> data(new uint[num_layers]);
            va_list layers;
            ...
            va_end(layers);
            switch (net_type){
                case LAYER: ann = fann_create_standard_array(num_layers, data.get()); break;
                case SHORTCUT: ann = fann_create_shortcut_array(num_layers, data.get()); break;
            }
            assert(ann != NULL);
        }
        /* Constructor: neural_net(float connection_rate, uint num_layers, ...)
        ...
        */
        neural_net(float connection_rate, uint num_layers, ...)
        {
            ...
            va_start(layers, num_layers);
            for (uint i = 0; i < num_layers; i++)
                data.get()[i] = va_arg(layers, uint);
            va_end(layers);
            ann = fann_create_sparse_array(connection_rate, num_layers, data.get());
            assert(ann != NULL);
        }
        /* Constructor: neural_net(float connection_rate, uint num_layers, const uint *layers)
	        ...
	        This function appears in FANN >= 2.3.0.
        */
        neural_net(float connection_rate, uint num_layers, const uint *layers)
        {
        ...
        /* Constructor: neural_net(Fann *other)

           Creates a copy the other neural_net.
            */
        neural_net(Fann *other) {
        ...
        */
        ...
        /* Method: copy_from_struct_fann - DEPRECATED
           ...
           an empty network and setting the internal structure of that. This method is hence discouraged and will be deprecated later on.
        */
        void copy_from_struct_fann(Fann *other)
        {
            destroy();
            if (other != NULL)
                ann = fann_copy(other);
        ...
        */
        bool create_standard(uint num_layers, ...) {
            std::unique_ptr<uint[]> data(new uint[num_layers]);
        ...
        /* Method: create_standard_array - DEPRECATED
           ...
           an empty network and setting the internal structure of that. This method is hence discouraged and will be deprecated later on.
	        ...
	        This function appears in FANN >= 2.0.0.
        */
        bool create_standard_array(uint num_layers, const uint *layers) {
            destroy();
        ...
        /* Method: create_sparse - DEPRECATED
           ...
           an empty network and setting the internal structure of that. This method is hence discouraged and will be deprecated later on.
	        ...
	        This function appears in FANN >= 2.0.0.
        */
        bool create_sparse(float connection_rate, uint num_layers, ...) {
            std::unique_ptr<uint[]> data(new uint[num_layers]);
        ...
        */
        bool create_sparse_array(float connection_rate,
                                 uint num_layers, const uint *layers) {
            destroy();
            ann = fann_create_sparse_array(connection_rate, num_layers, layers);
            return (ann != NULL);
        }
        ...
        /* Method: create_shortcut - DEPRECATED
	        ...
	        This function appears in FANN >= 2.0.0.
        */
        bool create_shortcut(uint num_layers, ...)
		{
            std::unique_ptr<uint[]> data(new uint[num_layers]);
            va_list layers;
            va_start(layers, num_layers);
        ...
        /* Method: create_shortcut_array - DEPRECATED
           ...
           instead of individual parameters.
	        ...
	        This function appears in FANN >= 2.0.0.
        */
        bool create_shortcut_array(uint num_layers, const uint *layers)
		{
            destroy();
		...
		//
	    // See also: <test>, <fann_run>
		//
		// This function appears in FANN >= 1.0.0.
        //
        fann_type * run(fann_type *input)
		{
			return ann ? fann_run(ann, input) : NULL;
        }
        ...
        */
        ...
        /* Method: train_on_data
           ...
           Parameters:
	        ...
	        This function appears in FANN >= 1.0.0.
        */
        void train_on_data(const training_data &data, uint max_epochs,
                           uint epochs_between_reports, float desired_error) {
            if ((ann != NULL) && (data.train_data != NULL)) {
        ...
        /* Method: train_on_file
           ...
           See also:
	        ...
	        This function appears in FANN >= 1.0.0.
        */
        void train_on_file(const std::string &filename, uint max_epochs,
                           uint epochs_between_reports, float desired_error) {
            if (ann != NULL) {
        ...
        */
        ...
        /* Method: get_layer_array
            ...
            sizeof(uint) * get_num_layers() long.
           ...
           This function appears in FANN >= 2.1.0
        */
        void get_layer_array(uint *layers) {
            if (ann != NULL) {
        ...
        */
        ...
        /* Method: set_weight_array
           ...
           This function appears in FANN >= 2.1.0
        */
        void set_weight_array(connection *connections, uint num_connections) {
            if (ann != NULL) {
        ...
        /* Method: set_weight
           ...
           This function appears in FANN >= 2.1.0
        */
        void set_weight(uint from_neuron, uint to_neuron, fann_type weight) {
            if (ann != NULL) {
        ...
        */
        ...
        /* Method: cascadetrain_on_data
           ...
           Parameters:
	        ...
	        This function appears in FANN >= 2.0.0.
        */
        void cascadetrain_on_data(const training_data &data, uint max_neurons,
                                  uint neurons_between_reports, float desired_error) {
            if ((ann != NULL) && (data.train_data != NULL)) {
        ...
        /* Method: cascadetrain_on_file
           ...
           See also:
	        ...
	        This function appears in FANN >= 2.0.0.
        */
        void cascadetrain_on_file(const std::string &filename, uint max_neurons,
                                  uint neurons_between_reports, float desired_error) {
            if (ann != NULL) {
        ...
        /* Method: get_cascade_output_stagnation_epochs
           ...
           See also:
	        ...
	        This function appears in FANN >= 2.0.0.
         */
        uint get_cascade_output_stagnation_epochs() {
            uint stagnation_epochs = 0;
            if (ann != NULL) {
        ...
        /* Method: set_cascade_output_stagnation_epochs
           ...
           See also:
	        ...
	        This function appears in FANN >= 2.0.0.
         */
        void set_cascade_output_stagnation_epochs(uint cascade_output_stagnation_epochs) {
            if (ann != NULL) {
        ...
        /* Method: get_cascade_candidate_stagnation_epochs
           ...
           See also:
	        ...
	        This function appears in FANN >= 2.0.0.
         */
        uint get_cascade_candidate_stagnation_epochs() {
            uint stagnation_epochs = 0;
            if (ann != NULL) {
        ...
        /* Method: set_cascade_candidate_stagnation_epochs
           ...
           See also:
	        ...
	        This function appears in FANN >= 2.0.0.
         */
        void set_cascade_candidate_stagnation_epochs(uint cascade_candidate_stagnation_epochs) {
            if (ann != NULL) {
        ...
        /* Method: get_cascade_max_out_epochs
           ...
           See also:
	        ...
	        This function appears in FANN >= 2.0.0.
         */
        uint get_cascade_max_out_epochs() {
            uint max_out_epochs = 0;
            if (ann != NULL) {
        ...
        /* Method: set_cascade_max_out_epochs
           ...
           See also:
	        ...
	        This function appears in FANN >= 2.0.0.
         */
        void set_cascade_max_out_epochs(uint cascade_max_out_epochs) {
            if (ann != NULL) {
        ...
        /* Method: get_cascade_max_cand_epochs
           ...
           See also:
	        ...
	        This function appears in FANN >= 2.0.0.
         */
        uint get_cascade_max_cand_epochs()
		{
            uint max_cand_epochs = 0;
            if(ann != NULL) {
        ...
        /* Method: set_cascade_max_cand_epochs
           ...
           See also:
	        ...
	        This function appears in FANN >= 2.0.0.
         */
        void set_cascade_max_cand_epochs(uint cascade_max_cand_epochs) {
            if (ann != NULL) {
        ...
        /* Method: get_cascade_num_candidates
           ...
           See also:
	        ...
	        This function appears in FANN >= 2.0.0.
         */
        uint get_cascade_num_candidates()
		{
            return ann ? ann->GetCascadeNumCandidates() : 0;
        }
        ...
        /* Method: get_cascade_activation_functions_count
           ...
           See also:
	        ...
	        This function appears in FANN >= 2.0.0.
         */
        uint get_cascade_activation_functions_count() {
            uint activation_functions_count = 0;
            if (ann != NULL) {
        ...
        /* Method: get_cascade_activation_steepnesses_count
           ...
           See also:
	        ...
	        This function appears in FANN >= 2.0.0.
         */
        uint get_cascade_activation_steepnesses_count() {
            uint activation_steepness_count = 0;
            if (ann != NULL) {
        ...
        /* Method: get_cascade_num_candidate_groups
           ...
           See also:
	        ...
	        This function appears in FANN >= 2.0.0.
         */
        uint get_cascade_num_candidate_groups() {
            uint num_candidate_groups = 0;
            if (ann != NULL) {
        ...
        /* Method: set_cascade_num_candidate_groups
           ...
           See also:
	        ...
	        This function appears in FANN >= 2.0.0.
         */
        void set_cascade_num_candidate_groups(uint cascade_num_candidate_groups) {
            if (ann != NULL) {
        ...
        /* Method: set_error_log
           ...
           See also:
                <FannError>, <fann_set_error_log>

           This function appears in FANN >= 1.1.0.
         */
        void set_error_log(FILE *log_file) {
            fann_set_error_log(reinterpret_cast<FannError *>(ann), log_file);
        }
         ...
         */
        uint get_errno() {
            return fann_get_errno(reinterpret_cast<FannError *>(ann));
        }
         ...
         */
        void reset_errno() {
            fann_reset_errno(reinterpret_cast<FannError *>(ann));
        }
         ...
         */
        void reset_errstr() {
            fann_reset_errstr(reinterpret_cast<FannError *>(ann));
        }
        ...
        std::string get_errstr() {
            return std::string(fann_get_errstr(reinterpret_cast <FannError *>(ann)));
        }
         ...
         */
        void print_error() {
            fann_print_error(reinterpret_cast<FannError *>(ann));
        }
    ...
    private:
        ...
        static int FANN_API internal_callback(Fann *ann, FannTrainData *train,
