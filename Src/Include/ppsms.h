...
private:
	...
	//
	// Массив с информацией об ошибочных запросах посылки смс. Сруктура записи:
	//		номер_получателя;описание_ошибки
	//
	StrAssocArray ErrorSubmitArr;
	//
	// Массив структур состояний сообщений, в том числе и ошибочных. Сруктура записи:
	//		номер_получателя;состояние_сообщения
	//
