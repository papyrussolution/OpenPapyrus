...
// Always last, if you add new error codes please update the value for CR_MYSQL_LAST_ERROR 
...
// Always last, if you add new error codes please update the value for CR_MARIADB_LAST_ERROR 
