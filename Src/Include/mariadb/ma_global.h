...
/* The client defines this to avoid all thread code */
	...
	#undef HAVE_SYS_UN_H /* MIT pthreads does not work with unix sockets */
#endif
...
#define ONCE_ALLOC_INIT		((uint) (4096-MALLOC_OVERHEAD)) /* get memory in huncs */
#define RECORD_CACHE_SIZE	((uint) (64*1024-MALLOC_OVERHEAD)) /* Typical record cash */
#define KEY_CACHE_SIZE		((uint) (8*1024*1024-MALLOC_OVERHEAD)) /* Typical key cash */
...
#define NO_HASH			/* Not needed anymore */
	...
	#ifdef _MSC_VER
		// @sobolev typedef SSIZE_T ssize_t;
	#endif
#endif
...
#else
	#define UNINIT_VAR(x) x= x /* GCC specific self-initialization which inhibits the warning. */
#endif
...
*/
	...
	#define shortget(V,M)   do { V = (short) (((short) ((uchar) (M)[1]))+((short) ((short) (M)[0]) << 8)); } while(0)
