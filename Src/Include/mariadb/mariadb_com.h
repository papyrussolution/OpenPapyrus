...
#define IS_MARIADB_EXTENDED_SERVER(mysql) (!(mysql->server_capabilities & CLIENT_MYSQL))

#define MARIADB_CLIENT_SUPPORTED_FLAGS (MARIADB_CLIENT_PROGRESS|MARIADB_CLIENT_STMT_BULK_OPERATIONS|MARIADB_CLIENT_EXTENDED_METADATA)

#define CLIENT_SUPPORTED_FLAGS  (CLIENT_MYSQL|CLIENT_FOUND_ROWS|CLIENT_LONG_FLAG|CLIENT_CONNECT_WITH_DB|CLIENT_NO_SCHEMA | \
	CLIENT_COMPRESS |CLIENT_ODBC |CLIENT_LOCAL_FILES |CLIENT_IGNORE_SPACE |CLIENT_INTERACTIVE |CLIENT_SSL | \
	CLIENT_IGNORE_SIGPIPE |CLIENT_TRANSACTIONS |CLIENT_PROTOCOL_41 |CLIENT_RESERVED |CLIENT_SECURE_CONNECTION |CLIENT_MULTI_STATEMENTS | \
	CLIENT_MULTI_RESULTS |CLIENT_PROGRESS | \
	CLIENT_SSL_VERIFY_SERVER_CERT|CLIENT_REMEMBER_OPTIONS|CLIENT_PLUGIN_AUTH|CLIENT_SESSION_TRACKING|CLIENT_CONNECT_ATTRS)
