...
long APIENTRY UmSlotGetDisplayName(DWORD dwUserId, DWORD dwSlotId, TCHAR * pszSlotDisplayName, long * plSize);
long APIENTRY UmSlotGetInstallDirectory(DWORD dwUserId, DWORD dwSlotId, TCHAR * pszSlotInstallDir, long * plSize);
