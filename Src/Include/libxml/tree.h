...
XMLPUBFUN xmlAttrPtr XMLCALL xmlNewDocProp(xmlDoc * doc, const xmlChar * name, const xmlChar * value);
 ...
 * Namespaces.
 */
XMLPUBFUN xmlNs * XMLCALL xmlSearchNs(xmlDoc * doc, xmlNode * P_Node, const xmlChar * nameSpace);
