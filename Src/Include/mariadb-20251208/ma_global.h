...
#include <slib.h>
	...
	#endif
	// @sobolev #define STDCALL __stdcall
#endif
#include <ma_config.h>
//#include <assert.h>
#ifndef __GNUC__
...
#define DONT_REMEMBER_SIGNAL
	...
	#define LINT_INIT_STRUCT(var) memzero(&var, sizeof(var)) /* No uninitialize-warning */
#else
...
#endif
#ifndef HAVE_UCHAR
	typedef uchar uchar;    /* Short for uchar */
#endif
typedef uchar uint8;    /* Short for unsigned integer >= 8  bits */
typedef unsigned short uint16;  /* Short for unsigned integer >= 16 bits */

/* @sobolev #if SIZEOF_INT == 4
	#ifndef HAVE_INT_8_16_32
		typedef int int32;
	#endif
	typedef uint uint32; // Short for unsigned integer >= 32 bits
	#elif SIZEOF_LONG == 4
		#ifndef HAVE_INT_8_16_32
			typedef long int32;
		#endif
...
typedef unsigned long ulong;    /* Short for ulong */
#endif
#ifndef longlong_defined
	#if defined(HAVE_LONG_LONG) && SIZEOF_LONG != 8
		typedef unsigned long long int ulonglong; /* ulong or uint64 */
...
//typedef char my_bool__; /* Small bool */
...
#define longlongstore(T, V) memcpy((T), &V, sizeof(ulonglong))
	...
	#define dlopen(libname, unused) LoadLibraryExA(libname, NULL, 0) // @sobolev LoadLibraryEx-->LoadLibraryExA
...
#include <secure/ma_schannel.h>
#include <secure/schannel_certs.h>
#include <ma_tls.h>
