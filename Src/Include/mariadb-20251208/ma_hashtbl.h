...
bool _ma_hashtbl_init(MA_HASHTBL * hash, uint default_array_elements, uint key_offset,
...
bool ma_hashtbl_insert(MA_HASHTBL * info, const uchar * data);
bool ma_hashtbl_delete(MA_HASHTBL * hash, uchar * record);
bool ma_hashtbl_update(MA_HASHTBL * hash, uchar * record, uchar * old_key, uint old_key_length);
bool ma_hashtbl_check(MA_HASHTBL * hash);                        /* Only in debug library */
