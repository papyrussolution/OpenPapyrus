...
struct mysql_async_context {
	...
	/*
	   ...
	   completes. It uses a union, as different calls have different return types.
	 */
	union {
		void * r_ptr;
		const void * r_const_ptr;
		MYSQL_RES * P_RetMsRes;  // @sobolev
		MYSQL * P_RetMs;         // @sobolev 
		MYSQL_ROW P_RetMsRow;    // @sobolev 
		const char * P_RetCPtrC; // @sobolev
		int r_int;
		bool r_my_bool;
	} ret_result;
	/*
