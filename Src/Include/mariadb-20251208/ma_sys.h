...
/* tbr
   ...
   extern int (*fatal_ma_error_handler_hook)(uint my_err, const char *str, myf MyFlags);
 */
...
extern bool open_cached_file(IO_CACHE * cache, const char * dir, const char * prefix, uint cache_size, myf cache_myflags);
