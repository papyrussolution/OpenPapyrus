 ...
 */
typedef SColorRGB * png_colorp;
typedef const SColorRGB * png_const_colorp;
typedef SColorRGB ** png_colorpp;
...
uint32 png_access_version_number();
...
PNG_EXPORT(34, uint8, png_get_rgb_to_gray_status, (png_const_structrp png_ptr));
#endif
...
PNG_EXPORT(39, void, png_set_filler, (png_structrp png_ptr, uint32 filler, int flags));
/* The values of the PNG_FILLER_ defines should NOT be changed */
#define PNG_FILLER_BEFORE 0
#define PNG_FILLER_AFTER 1
/* Add an alpha byte to 8-bit or 16-bit Gray or 24-bit or 48-bit RGB images. */
PNG_EXPORT(40, void, png_set_add_alpha, (png_structrp png_ptr, uint32 filler, int flags));
...
PNG_FP_EXPORT(68, void, png_set_filter_heuristics, (png_structrp png_ptr, int heuristic_method, int num_weights, png_const_doublep filter_weights,
    png_const_doublep filter_costs))
PNG_FIXED_EXPORT(209, void, png_set_filter_heuristics_fixed, (png_structrp png_ptr, int heuristic_method, int num_weights,
...
PNG_EXPORT(86, void, png_set_user_transform_info,
    (png_structrp png_ptr, void * user_transform_ptr, int user_transform_depth, int user_transform_channels));
 ...
 */
PNG_EXPORT(88, void, png_set_read_user_chunk_fn, (png_structrp png_ptr, void * user_chunk_ptr, png_user_chunk_ptr read_user_chunk_fn));
#endif
 ...
 */
PNG_EXPORT(90, void, png_set_progressive_read_fn, (png_structrp png_ptr, void * progressive_ptr, png_progressive_info_ptr info_fn,
    png_progressive_row_ptr row_fn, png_progressive_end_ptr end_fn));

/* Returns the user pointer associated with the push read functions */
PNG_EXPORT(91, void *, png_get_progressive_ptr, (png_const_structrp png_ptr));
...
PNG_EXPORT(126, int32_t, png_get_x_offset_pixels, (png_const_structrp png_ptr, png_const_inforp info_ptr));
PNG_EXPORT(127, int32_t, png_get_y_offset_pixels, (png_const_structrp png_ptr, png_const_inforp info_ptr));
PNG_EXPORT(128, int32_t, png_get_x_offset_microns, (png_const_structrp png_ptr, png_const_inforp info_ptr));
PNG_EXPORT(129, int32_t, png_get_y_offset_microns, (png_const_structrp png_ptr, png_const_inforp info_ptr));
...
PNG_EXPORT(145, uint32, png_get_oFFs, (png_const_structrp png_ptr, png_const_inforp info_ptr, int32_t *offset_x, int32_t *offset_y, int * unit_type));
#endif
#ifdef PNG_oFFs_SUPPORTED
PNG_EXPORT(146, void, png_set_oFFs, (png_const_structrp png_ptr, png_inforp info_ptr, int32_t offset_x, int32_t offset_y, int unit_type));
#endif

#ifdef PNG_pCAL_SUPPORTED
PNG_EXPORT(147, uint32, png_get_pCAL, (png_const_structrp png_ptr, png_inforp info_ptr, char ** purpose, int32_t *X0,
    int32_t *X1, int * type, int * nparams, char ** units, png_charpp *params));
#endif

#ifdef PNG_pCAL_SUPPORTED
PNG_EXPORT(148, void, png_set_pCAL, (png_const_structrp png_ptr, png_inforp info_ptr, const char * purpose, int32_t X0, int32_t X1,
    int type, int nparams, const char * units, png_charpp params));
#endif
#ifdef PNG_pHYs_SUPPORTED
PNG_EXPORT(149, uint32, png_get_pHYs, (png_const_structrp png_ptr, png_const_inforp info_ptr, uint32 *res_x, uint32 *res_y,
    int * unit_type));
#endif

#ifdef PNG_pHYs_SUPPORTED
PNG_EXPORT(150, void, png_set_pHYs, (png_const_structrp png_ptr, png_inforp info_ptr, uint32 res_x, uint32 res_y, int unit_type));
#endif
PNG_EXPORT(151, uint32, png_get_PLTE, (png_const_structrp png_ptr, png_inforp info_ptr, png_colorp *palette, int * num_palette));
PNG_EXPORT(152, void, png_set_PLTE, (png_structrp png_ptr, png_inforp info_ptr, png_const_colorp palette, int num_palette));
#ifdef PNG_sBIT_SUPPORTED
PNG_EXPORT(153, uint32, png_get_sBIT, (png_const_structrp png_ptr, png_inforp info_ptr, png_color_8p *sig_bit));
#endif
#ifdef PNG_sBIT_SUPPORTED
PNG_EXPORT(154, void, png_set_sBIT, (png_const_structrp png_ptr, png_inforp info_ptr, png_const_color_8p sig_bit));
#endif
#ifdef PNG_sRGB_SUPPORTED
PNG_EXPORT(155, uint32, png_get_sRGB, (png_const_structrp png_ptr, png_const_inforp info_ptr, int * file_srgb_intent));
#endif
#ifdef PNG_sRGB_SUPPORTED
...
PNG_EXPORT(158, uint32, png_get_iCCP, (png_const_structrp png_ptr, png_inforp info_ptr, png_charpp name, int * compression_type, png_bytepp profile, uint32 *proflen));
#endif
#ifdef PNG_iCCP_SUPPORTED
PNG_EXPORT(159, void, png_set_iCCP, (png_const_structrp png_ptr, png_inforp info_ptr, const char * name, int compression_type, png_const_bytep profile, uint32 proflen));
#endif
...
PNG_EXPORT(164, uint32, png_get_tIME, (png_const_structrp png_ptr, png_inforp info_ptr, png_timep *mod_time));
#endif
#ifdef PNG_tIME_SUPPORTED
PNG_EXPORT(165, void, png_set_tIME, (png_const_structrp png_ptr, png_inforp info_ptr, png_const_timep mod_time));
#endif
#ifdef PNG_tRNS_SUPPORTED
PNG_EXPORT(166, uint32, png_get_tRNS, (png_const_structrp png_ptr, png_inforp info_ptr, png_bytep *trans_alpha, int * num_trans, png_color_16p *trans_color));
#endif
#ifdef PNG_tRNS_SUPPORTED
...
PNG_FP_EXPORT(168, uint32, png_get_sCAL, (png_const_structrp png_ptr, png_const_inforp info_ptr, int * unit, double * width, double * height))
 ...
 */
PNG_FIXED_EXPORT(214, uint32, png_get_sCAL_fixed, (png_const_structrp png_ptr, png_const_inforp info_ptr, int * unit, png_fixed_point *width, png_fixed_point *height))
#endif
PNG_EXPORT(169, uint32, png_get_sCAL_s, (png_const_structrp png_ptr, png_const_inforp info_ptr, int * unit, png_charpp swidth, png_charpp sheight));

PNG_FP_EXPORT(170, void, png_set_sCAL, (png_const_structrp png_ptr, png_inforp info_ptr, int unit, double width, double height))
PNG_FIXED_EXPORT(213, void, png_set_sCAL_fixed, (png_const_structrp png_ptr, png_inforp info_ptr, int unit, png_fixed_point width,
    png_fixed_point height))
PNG_EXPORT(171, void, png_set_sCAL_s, (png_const_structrp png_ptr, png_inforp info_ptr, int unit, const char * swidth, const char * sheight));
#endif /* sCAL */
...
// the result is therefore true (non-zero) if special handling is required, false for the default handling.
//
...
#ifdef PNG_SEQUENTIAL_READ_SUPPORTED
    PNG_EXPORT(178, void, png_read_png, (png_structrp png_ptr, png_inforp info_ptr, int transforms, void * params));
#endif
#ifdef PNG_WRITE_SUPPORTED
    PNG_EXPORT(179, void, png_write_png, (png_structrp png_ptr, png_inforp info_ptr, int transforms, void * params));
#endif
#endif

PNG_EXPORT(180, const char *, png_get_copyright, (png_const_structrp png_ptr));
PNG_EXPORT(181, const char *, png_get_header_ver, (png_const_structrp png_ptr));
PNG_EXPORT(182, const char *, png_get_header_version, (png_const_structrp png_ptr));
PNG_EXPORT(183, const char *, png_get_libpng_ver, (png_const_structrp png_ptr));
#ifdef PNG_MNG_FEATURES_SUPPORTED
    PNG_EXPORT(184, uint32, png_permit_mng_features, (png_structrp png_ptr, uint32 mng_features_permitted));
#endif
 ...
 */
    ...
    void png_set_strip_error_numbers(png_structrp png_ptr, uint32 strip_mode);
#endif

/* Added in libpng-1.2.6 */
#ifdef PNG_SET_USER_LIMITS_SUPPORTED
PNG_EXPORT(186, void, png_set_user_limits, (png_structrp png_ptr, uint32 user_width_max, uint32 user_height_max));
PNG_EXPORT(187, uint32, png_get_user_width_max, (png_const_structrp png_ptr));
PNG_EXPORT(188, uint32, png_get_user_height_max, (png_const_structrp png_ptr));
/* Added in libpng-1.4.0 */
PNG_EXPORT(189, void, png_set_chunk_cache_max, (png_structrp png_ptr, uint32 user_chunk_cache_max));
PNG_EXPORT(190, uint32, png_get_chunk_cache_max, (png_const_structrp png_ptr));
...
PNG_EXPORT(193, uint32, png_get_pixels_per_inch, (png_const_structrp png_ptr, png_const_inforp info_ptr));
PNG_EXPORT(194, uint32, png_get_x_pixels_per_inch, (png_const_structrp png_ptr, png_const_inforp info_ptr));
PNG_EXPORT(195, uint32, png_get_y_pixels_per_inch, (png_const_structrp png_ptr, png_const_inforp info_ptr));
...
#ifdef PNG_pHYs_SUPPORTED
uint32 png_get_pHYs_dpi(png_const_structrp png_ptr, png_const_inforp info_ptr, uint32 *res_x, uint32 *res_y, int * unit_type);
#endif /* pHYs */
#endif  /* INCH_CONVERSIONS */

/* Added in libpng-1.4.0 */
#ifdef PNG_IO_STATE_SUPPORTED
uint32 png_get_io_state(png_const_structrp png_ptr);

/* Removed from libpng 1.6; use png_get_io_chunk_type. */
PNG_REMOVED(200, png_const_bytep, png_get_io_chunk_name, (png_structrp png_ptr), PNG_DEPRECATED)
PNG_EXPORT(216, uint32, png_get_io_chunk_type, (png_const_structrp png_ptr));
...
#define png_composite(composite, fg, alpha, bg)         \
	{ uint16 temp = \
	      (uint16)((uint16)(fg) * (uint16)(alpha) + (uint16)(bg)*(uint16)(255 - (uint16)(alpha)) + 128); \
	  (composite) = (uint8)(((temp + (temp >> 8)) >> 8) & 0xff); }

#define png_composite_16(composite, fg, alpha, bg)       \
	{ uint32 temp = (uint32)((uint32)(fg) * (uint32)(alpha) + (uint32)(bg)*(65535 - (uint32)(alpha)) + 32768); \
	  (composite) = (uint16)(0xffff & ((temp + (temp >> 16)) >> 16)); }

#else  /* Standard method using integer division */

#define png_composite(composite, fg, alpha, bg)                        \
	(composite) =                                                       \
	    (uint8)(0xff & (((uint16)(fg) * (uint16)(alpha) +  \
	    (uint16)(bg) * (uint16)(255 - (uint16)(alpha)) + \
	    127) / 255))

#define png_composite_16(composite, fg, alpha, bg)                         \
	(composite) =                                                           \
	    (uint16)(0xffff & (((uint32)(fg) * (uint32)(alpha) + \
	    (uint32)(bg)*(uint32)(65535 - (uint32)(alpha)) +     \
	    32767) / 65535))
#endif /* READ_COMPOSITE_NODIV */
#ifdef PNG_READ_INT_FUNCTIONS_SUPPORTED
    uint32 png_get_uint_32(png_const_bytep buf);
    uint16 png_get_uint_16(png_const_bytep buf);
    int32_t png_get_int_32(png_const_bytep buf);
#endif
uint32 png_get_uint_31(png_const_structrp png_ptr, png_const_bytep buf);
/* No png_get_int_16 -- may be added if there's a real need for it. */
/* Place a 32-bit number into a buffer in PNG byte order (big-endian). */
#ifdef PNG_WRITE_INT_FUNCTIONS_SUPPORTED
    void png_save_uint_32(png_bytep buf, uint32 i);
#endif
 ...
 */
#define PNG_get_uint_32(buf) (((uint32)(*(buf)) << 24) + ((uint32)(*((buf) + 1)) << 16) + ((uint32)(*((buf) + 2)) << 8) + \
	((uint32)(*((buf) + 3))))

/* From libpng-1.4.0 until 1.4.4, the png_get_uint_16 macro (but not the
 * function) incorrectly returned a value of type uint32.
 */
#define PNG_get_uint_16(buf) ((uint16)(((uint)(*(buf)) << 8) + ((uint)(*((buf) + 1)))))
#define PNG_get_int_32(buf) ((int32_t)((*(buf) & 0x80) ? -((int32_t)(((png_get_uint_32(buf)^0xffffffffU)+1U)&0x7fffffffU)) : (int32_t)png_get_uint_32(buf)))
 ...
 * color-map:
 *
 * uint16 colormap[PNG_IMAGE_MAXIMUM_COLORMAP_COMPONENTS(linear_fmt)];
 *
...
#endif /* STDIO */
int png_image_begin_read_from_memory(png_imagep image, const void * memory, size_t size);
/* The PNG header is read from the given memory buffer. */
int png_image_finish_read(png_imagep image, png_const_colorp background, void * buffer, int32_t row_stride, void * colormap);
...
int png_image_write_to_file(png_imagep image, const char * file, int convert_to_8bit, const void * buffer, int32_t row_stride, const void * colormap);
/* Write the image to the named file. */
int png_image_write_to_stdio(png_imagep image, FILE *file, int convert_to_8_bit, const void * buffer, int32_t row_stride, const void * colormap);
 ...
 */
int png_image_write_to_memory(png_imagep image, void * memory, png_alloc_size_t * _RESTRICT memory_bytes, int convert_to_8_bit,
    const void * buffer, int32_t row_stride, const void * colormap);
...
#endif
#define PNG_OPTION_NEXT  6 // Next option - numbers must be even // @libpng-1629 6-->12
//
