...
protected:
	...
	enum {
		...
		stDataSetting   = 0x0010, // @v12.7.9 Флаг состояния устанавливается в прологе функции setText и снимает в эпилоге той же функции.
			// Цель: дать знать внутренним подсистемам, что изменение данных обусловено не пользовательским вводом, а инициирующим действием.
	};
	long   InlSt;
	//
...
public:
	...
	enum {
		...
		tbiWhitePen         = 71,
		//
		tbiInvalInpBrush    = 80, // invalidinput_bg Кисть для индикации недопустимого ввода данных
		tbiInvalInp2Brush   = 81, // invalidinput2_bg Кисть для индикации недопустимого ввода данных (вариант 2)
		tbiInvalInp3Brush   = 82, // invalidinput3_bg Кисть для индикации недопустимого ввода данных (вариант 3)
...
protected:
	...
	enum {
		...
		penDaySeparator,        // Вертикальные линии на весь экран, отстоящие друг от друга на расстоянии, равном одному дню //
