...
private:
	 ...
	 *         false otherwise.
	 */
	static bool U_EXPORT2 stringNumeric(int32_t fieldWidth,
	 ...
	 */
	static IntervalPatternIndex U_EXPORT2 calendarFieldToIntervalIndex(UCalendarDateFields field,
	    UErrorCode & status);
