...
public:
	 ...
	 * @stable ICU 2.4
	 */
	virtual UMatchDegree matches(const Replaceable& text, int32_t& offset, int32_t limit, bool incremental) = 0;
	/**
	 ...
	 * @stable ICU 2.4
	 */
	virtual UnicodeString & toPattern(UnicodeString & result, bool escapeUnprintable = false) const = 0;
	/**
