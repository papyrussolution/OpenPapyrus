...
public:
	 ...
	 * @stable ICU 56
	 */
	virtual bool suppressBreakAfter(const UnicodeString & string, UErrorCode & status) = 0;
	 ...
	 * @stable ICU 56
	 */
	virtual bool unsuppressBreakAfter(const UnicodeString & string, UErrorCode & status) = 0;
