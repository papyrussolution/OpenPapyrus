...
public:
	 ...
	 * @stable ICU 67
	 */
	static ListFormatter* createInstance(const Locale& locale, UListFormatterType type, UListFormatterWidth width,
...
private:
	...
	UnicodeString & format_(const UnicodeString items[], int32_t n_items, UnicodeString & appendTo,
