 ...
 *
   ...
   <tr><td>%n</td><td>int32_t</td><td>int32_t</td><td>count (write the number of UTF-16 codeunits
    *read/written)</td></tr>
   ...
   <tr><td>%+</td><td>%d, %i, %o, %x, %e, %f, %g, %E, %G</td><td>N/A</td><td>Always show the plus or minus sign. Needs
    *data for plus sign.</td></tr>
   <tr><td>% </td><td>%d, %i, %o, %x, %e, %f, %g, %E, %G</td><td>N/A</td><td>Instead of a "+" output a blank character
    *for positive numbers.</td></tr>
   <tr><td>%#</td><td>%d, %i, %o, %x, %e, %f, %g, %E, %G</td><td>N/A</td><td>Precede octal value with 0, hex with 0x and
    *show the
   ...
   <tr><td>%.<i>n</i></td><td>%e, %f, %g, %E, %F, %G</td><td>N/A</td><td>Significant digits precision. num is an actual
    *number from
                0 to some large number.<br>If * is used in printf, then the precision is passed in as an argument before
 ...
 * @stable ICU 3.0
 */
U_CAPI int32_t U_EXPORT2 u_fsetlocale(UFILE      * file,
    const char * locale);
 ...
 * @stable ICU 3.0
 */
U_CAPI UChar32 U_EXPORT2 u_fungetc(UChar32 c,
    UFILE        * f);
