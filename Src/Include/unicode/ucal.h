 ...
 * @stable ICU 4.8
 */
U_CAPI UEnumeration* U_EXPORT2 ucal_openTimeZoneIDEnumeration(USystemTimeZoneType zoneType, const char * region, const int32_t* rawOffset, UErrorCode* ec);
/**
 ...
 * @stable ICU 4.0
 */
U_CAPI UCalendar* U_EXPORT2 ucal_clone(const UCalendar* cal,
    UErrorCode*      status);
 ...
 * @stable ICU 2.0
 */
U_CAPI bool U_EXPORT2 ucal_inDaylightTime(const UCalendar*  cal,
    UErrorCode*       status);
 ...
 * @stable ICU 3.6
 */
U_CAPI void U_EXPORT2 ucal_setGregorianChange(UCalendar * cal, UDate date, UErrorCode * pErrorCode);
 ...
 * @stable ICU 3.6
 */
U_CAPI UDate U_EXPORT2 ucal_getGregorianChange(const UCalendar * cal, UErrorCode * pErrorCode);
 ...
 * @stable ICU 2.0
 */
U_CAPI const char * U_EXPORT2 ucal_getAvailable(int32_t localeIndex);
 ...
 * @stable ICU 2.0
 */
U_CAPI bool U_EXPORT2 ucal_equivalentTo(const UCalendar*  cal1,
 ...
 * @stable ICU 2.0
 */
U_CAPI bool U_EXPORT2 ucal_isSet(const UCalendar*     cal,
    UCalendarDateFields field);
 ...
 *  @stable ICU 2.8
 */
U_CAPI const char * U_EXPORT2 ucal_getLocaleByType(const UCalendar * cal, ULocDataLocaleType type, UErrorCode* status);
 ...
 * @stable ICU 4.2
 */
U_CAPI const char * U_EXPORT2 ucal_getType(const UCalendar * cal, UErrorCode* status);
 ...
 * @stable ICU 4.2
 */
U_CAPI UEnumeration* U_EXPORT2 ucal_getKeywordValuesForLocale(const char * key,
    const char * locale,
    bool commonlyUsed,
    UErrorCode* status);
 ...
 * @stable ICU 4.4
 */
U_CAPI UCalendarWeekdayType U_EXPORT2 ucal_getDayOfWeekType(const UCalendar * cal, UCalendarDaysOfWeek dayOfWeek, UErrorCode* status);
 ...
 * @stable ICU 4.4
 */
U_CAPI int32_t U_EXPORT2 ucal_getWeekendTransition(const UCalendar * cal, UCalendarDaysOfWeek dayOfWeek, UErrorCode * status);
 ...
 * @stable ICU 4.4
 */
U_CAPI bool U_EXPORT2 ucal_isWeekend(const UCalendar * cal, UDate date, UErrorCode * status);
 ...
 * @stable ICU 4.8
 */
U_CAPI int32_t U_EXPORT2 ucal_getFieldDifference(UCalendar* cal,
    UDate target,
    UCalendarDateFields field,
    UErrorCode* status);
 ...
 * @stable ICU 50
 */
U_CAPI bool U_EXPORT2 ucal_getTimeZoneTransitionDate(const UCalendar* cal, UTimeZoneTransitionType type,
 ...
 * please read the ICU user guide section <a
 ...
 * @draft ICU 69
 */
U_CAPI void U_EXPORT2 ucal_getTimeZoneOffsetFromLocal(const UCalendar* cal,
