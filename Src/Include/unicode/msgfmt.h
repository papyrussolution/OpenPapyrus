...
public:
	 ...
	 * @stable ICU 4.8
	 */
	UMessagePatternApostropheMode getApostropheMode() const { return msgPattern.getApostropheMode(); }
	/**
	 ...
	 * @internal
	 */
	static bool equalFormats(const void * left, const void * right);
#endif  /* U_HIDE_INTERNAL_API */
...
private:
	 ...
	 */
	bool hasArgTypeConflicts;

	// Variable-size array management
	bool allocateArgTypes(int32_t capacity, UErrorCode & status);
