...
// 02/19/01    swquek      Removed CollationElementsIterator() since it is private constructor and no calls are made to it
...
public:
	 ...
	 * @stable ICU 2.0
	 */
	static inline bool isIgnorable(int32_t order);
