...
// 10/15/99    aliu        Fixed j31, incorrect WEEK_OF_YEAR computation. Added documentation of WEEK_OF_YEAR computation.
...
public:
	 ...
	 * @stable ICU 2.0
	 */
	bool isLeapYear(int32_t year) const;
	 ...
	 * @stable ICU 2.4
	 */
	virtual bool isEquivalentTo(const Calendar& other) const override;
...
private:
	 ...
	 * @return
	 */
	static double computeJulianDayOfYear(bool isGregorian, int32_t year, bool& isLeap);
	/**
	 * Validates the values of the set time fields.  True if they're all valid.
	 * @return    True if the set time fields are all valid.
	 */
	bool validateFields(void) const;
	/**
	 * Validates the value of the given time field.  True if it's valid.
	 */
	bool boundsCheck(int32_t value, UCalendarDateFields field) const;
	/**
