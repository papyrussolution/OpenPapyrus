 ...
 * @stable ICU 3.2
 */
U_CAPI UEnumeration * U_EXPORT2 ucurr_openISOCurrencies(uint32_t currType, UErrorCode * pErrorCode);
/**
 ...
 * @stable ICU 4.2
 */
U_CAPI UEnumeration* U_EXPORT2 ucurr_getKeywordValuesForLocale(const char * key, const char * locale, bool commonlyUsed, UErrorCode * status);
/**
