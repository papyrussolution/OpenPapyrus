...
public:
	 ...
	 * @stable ICU 2.0
	 */
	virtual void setLenient(bool enabled) override;
	 ...
	 * @stable ICU 2.0
	 */
	virtual inline bool isLenient(void) const override;
...
private:
	...
	bool capitalizationInfoSet;
	bool capitalizationForUIListMenu;
