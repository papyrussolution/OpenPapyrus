 ...
 */
typedef enum {
	UCOL_EQUAL    = 0, /** string a == string b */
	UCOL_GREATER    = 1, /** string a > string b */
	UCOL_LESS    = -1 /** string a < string b */
} UCollationResult;
 ...
 */
typedef enum {
	UCOL_DEFAULT = -1, /** accepted by most attributes */
	UCOL_PRIMARY = 0, /** Primary collation strength */
	UCOL_SECONDARY = 1, /** Secondary collation strength */
	UCOL_TERTIARY = 2, /** Tertiary collation strength */
	UCOL_DEFAULT_STRENGTH = UCOL_TERTIARY, /** Default collation strength */
	UCOL_CE_STRENGTH_LIMIT,
	UCOL_QUATERNARY = 3, /** Quaternary collation strength */
	
	UCOL_IDENTICAL = 15, /** Identical collation strength */
	UCOL_STRENGTH_LIMIT,
 ...
 * @stable ICU 3.4
 */
U_CAPI void U_EXPORT2 ucol_getContractionsAndExpansions(const UCollator * coll,
    USet * contractions, USet * expansions,
    bool addPrefixes, UErrorCode * status);
 ...
 * @stable ICU 50
 */
U_CAPI UCollationResult U_EXPORT2 ucol_strcollUTF8(const UCollator * coll,
    const char      * source,
    int32_t sourceLength,
    const char      * target,
    int32_t targetLength,
 ...
 * @stable ICU 2.6
 */
U_CAPI UCollationResult U_EXPORT2 ucol_strcollIter(const UCollator    * coll,
    UCharIterator * sIter,
    UCharIterator * tIter,
    UErrorCode * status);
 ...
 * @stable ICU 4.8
 */
U_CAPI int32_t U_EXPORT2 ucol_getReorderCodes(const UCollator* coll,
    int32_t* dest,
 ...
 * @stable ICU 4.8
 */
U_CAPI void U_EXPORT2 ucol_setReorderCodes(UCollator* coll,
 ...
 * @stable ICU 4.8
 */
U_CAPI int32_t U_EXPORT2 ucol_getEquivalentReorderCodes(int32_t reorderCode,
    int32_t* dest,
    int32_t destCapacity,
    UErrorCode * pErrorCode);
 ...
 * @stable ICU 4.2
 */
U_CAPI UEnumeration* U_EXPORT2 ucol_getKeywordValuesForLocale(const char * key,
    const char * locale,
    bool commonlyUsed,
    UErrorCode* status);
 ...
 *  @deprecated ICU 54
 */
U_DEPRECATED int32_t U_EXPORT2 ucol_getShortDefinitionString(const UCollator * coll,
    const char * locale,
    char * buffer,
    int32_t capacity,
    UErrorCode * status);
...
U_DEPRECATED int32_t U_EXPORT2 ucol_normalizeShortDefinitionString(const char * source,
    char * destination,
    int32_t capacity,
    UParseError * parseError,
    UErrorCode * status);
 ...
 *  @stable ICU 2.6
 */
U_CAPI int32_t U_EXPORT2 ucol_nextSortKeyPart(const UCollator * coll,
    UCharIterator * iter,
    uint32_t state[2],
 ...
 * @internal ICU 3.2.1
 */
U_CAPI void U_EXPORT2 ucol_prepareShortStringOpen(const char * definition, bool forceDefaults, UParseError * parseError, UErrorCode * status);
