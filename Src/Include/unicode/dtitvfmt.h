...
public:
	 ...
	 * @stable ICU 4.0
	 */
	static DateIntervalFormat* U_EXPORT2 createInstance(const UnicodeString & skeleton,
	    UErrorCode & status);
...
private:
	 ...
	 *  @return A copy of the skeleton, which "j" and any other special hour metacharacters converted to the regular
	 *ones.
	 *
	 */
	 ...
	 *                       false otherwise.
	 */
	bool setSeparateDateTimePtn(const UnicodeString & dateSkeleton,
	 ...
	 */
	static bool U_EXPORT2 fieldExistsInSkeleton(UCalendarDateFields field,
	    const UnicodeString & skeleton);
...
inline bool DateIntervalFormat::operator !=(const Format& other) const {
