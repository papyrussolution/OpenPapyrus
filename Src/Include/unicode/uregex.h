 ...
 * @stable ICU 4.6
 */
U_CAPI URegularExpression *  U_EXPORT2 uregex_openUText(UText          * pattern,
    uint32_t flags,
    UParseError * pe,
    UErrorCode * status);
 ...
 * @stable ICU 3.0
 */
U_CAPI URegularExpression * U_EXPORT2 uregex_openC(const char * pattern,
    uint32_t flags,
    UParseError * pe,
    UErrorCode * status);
#endif
 ...
 * @stable ICU 3.0
 */
U_CAPI void U_EXPORT2 uregex_close(URegularExpression * regexp);
 ...
 * @stable ICU 3.0
 */
U_CAPI URegularExpression * U_EXPORT2 uregex_clone(const URegularExpression * regexp, UErrorCode * status);
 ...
 * @stable ICU 4.6
 */
U_CAPI UText * U_EXPORT2 uregex_patternUText(const URegularExpression * regexp,
    UErrorCode         * status);
 ...
 * @stable ICU 3.0
 */
U_CAPI int32_t U_EXPORT2 uregex_flags(const URegularExpression   * regexp,
    UErrorCode           * status);
 ...
 * @stable ICU 4.6
 */
U_CAPI void U_EXPORT2 uregex_setUText(URegularExpression * regexp,
    UText              * text,
    UErrorCode         * status);
 ...
 * @stable ICU 4.6
 */
U_CAPI UText * U_EXPORT2 uregex_getUText(URegularExpression * regexp,
    UText              * dest,
    UErrorCode         * status);
 ...
 * @stable ICU 4.8
 */
U_CAPI void U_EXPORT2 uregex_refreshUText(URegularExpression * regexp,
    UText              * text,
    UErrorCode         * status);
 ...
 *    @stable ICU 3.0
 */
U_CAPI bool U_EXPORT2 uregex_matches(URegularExpression * regexp,
    int32_t startIndex,
    UErrorCode        * status);
 ...
 *   @stable ICU 4.6
 */
U_CAPI bool U_EXPORT2 uregex_matches64(URegularExpression * regexp,
    int64_t startIndex,
    UErrorCode        * status);
 ...
 *    @stable ICU 3.0
 */
U_CAPI bool U_EXPORT2 uregex_lookingAt(URegularExpression * regexp,
    int32_t startIndex,
    UErrorCode         * status);
 ...
 *    @stable ICU 4.6
 */
U_CAPI bool U_EXPORT2 uregex_lookingAt64(URegularExpression * regexp,
    int64_t startIndex,
    UErrorCode         * status);
 ...
 *   @stable ICU 3.0
 */
U_CAPI bool U_EXPORT2 uregex_find(URegularExpression * regexp,
    int32_t startIndex,
    UErrorCode         * status);
 ...
 *   @stable ICU 4.6
 */
U_CAPI bool U_EXPORT2 uregex_find64(URegularExpression * regexp,
    int64_t startIndex,
    UErrorCode         * status);
 ...
 *  @stable ICU 3.0
 */
U_CAPI bool U_EXPORT2 uregex_findNext(URegularExpression * regexp,
    UErrorCode         * status);
 ...
 *   @stable ICU 3.0
 */
U_CAPI int32_t U_EXPORT2 uregex_groupCount(URegularExpression * regexp,
    UErrorCode         * status);
 ...
 * @stable ICU 55
 */
U_CAPI int32_t U_EXPORT2 uregex_groupNumberFromCName(URegularExpression * regexp,
 ...
 *    @stable ICU 3.0
 */
U_CAPI int32_t U_EXPORT2 uregex_start(URegularExpression * regexp,
    int32_t groupNum,
    UErrorCode          * status);
 ...
 *   @stable ICU 4.6
 */
U_CAPI int64_t U_EXPORT2 uregex_start64(URegularExpression * regexp,
    int32_t groupNum,
    UErrorCode          * status);
 ...
 *    @stable ICU 3.0
 */
U_CAPI int32_t U_EXPORT2 uregex_end(URegularExpression   * regexp,
    int32_t groupNum,
    UErrorCode           * status);
 ...
 *   @stable ICU 4.6
 */
U_CAPI int64_t U_EXPORT2 uregex_end64(URegularExpression * regexp,
    int32_t groupNum,
    UErrorCode           * status);
 ...
 *    @stable ICU 3.0
 */
U_CAPI void U_EXPORT2 uregex_reset(URegularExpression    * regexp,
    int32_t index,
    UErrorCode * status);
 ...
 *    @stable ICU 4.6
 */
U_CAPI void U_EXPORT2 uregex_reset64(URegularExpression  * regexp,
    int64_t index,
    UErrorCode * status);
 ...
 * @stable ICU 4.0
 */
U_CAPI void U_EXPORT2 uregex_setRegion(URegularExpression   * regexp,
    int32_t regionStart,
    int32_t regionLimit,
    UErrorCode           * status);
 ...
 * @stable ICU 4.6
 */
U_CAPI void U_EXPORT2 uregex_setRegion64(URegularExpression * regexp,
    int64_t regionStart,
    int64_t regionLimit,
    UErrorCode           * status);
 ...
 * @stable ICU 4.6
 */
U_CAPI void U_EXPORT2 uregex_setRegionAndStart(URegularExpression * regexp,
    int64_t regionStart,
    int64_t regionLimit,
    int64_t startIndex,
    UErrorCode           * status);
 ...
 * @stable ICU 4.0
 */
U_CAPI int32_t U_EXPORT2 uregex_regionStart(const URegularExpression   * regexp,
    UErrorCode           * status);
 ...
 * @stable ICU 4.6
 */
U_CAPI int64_t U_EXPORT2 uregex_regionStart64(const URegularExpression   * regexp,
    UErrorCode           * status);
 ...
 * @stable ICU 4.0
 */
U_CAPI int32_t U_EXPORT2 uregex_regionEnd(const URegularExpression   * regexp,
    UErrorCode           * status);
 ...
 * @stable ICU 4.6
 */
U_CAPI int64_t U_EXPORT2 uregex_regionEnd64(const URegularExpression   * regexp,
    UErrorCode           * status);
 ...
 * @stable ICU 4.0
 */
U_CAPI bool U_EXPORT2 uregex_hasTransparentBounds(const URegularExpression   * regexp,
    UErrorCode           * status);
 ...
 * @stable ICU 4.0
 **/
U_CAPI void U_EXPORT2 uregex_useTransparentBounds(URegularExpression   * regexp,
    bool b,
    UErrorCode           * status);
 ...
 * @stable ICU 4.0
 */
U_CAPI bool U_EXPORT2 uregex_hasAnchoringBounds(const URegularExpression   * regexp,
    UErrorCode           * status);
 ...
 * @stable ICU 4.0
 */
U_CAPI void U_EXPORT2 uregex_useAnchoringBounds(URegularExpression   * regexp,
    bool b,
    UErrorCode           * status);
 ...
 *  @stable ICU 4.0
 */
U_CAPI bool U_EXPORT2 uregex_hitEnd(const URegularExpression   * regexp,
    UErrorCode           * status);
 ...
 * @stable ICU 4.0
 */
U_CAPI bool U_EXPORT2 uregex_requireEnd(const URegularExpression   * regexp,
    UErrorCode           * status);
 ...
 *    @stable ICU 4.6
 */
U_CAPI UText * U_EXPORT2 uregex_replaceAllUText(URegularExpression * regexp,
    UText              * replacement,
    UText              * dest,
    UErrorCode         * status);
 ...
 *    @stable ICU 4.6
 */
U_CAPI UText * U_EXPORT2 uregex_replaceFirstUText(URegularExpression * regexp,
    UText              * replacement,
    UText              * dest,
    UErrorCode         * status);
 ...
 *   @stable ICU 4.6
 */
U_CAPI void U_EXPORT2 uregex_appendReplacementUText(URegularExpression    * regexp,
 ...
 *   @stable ICU 4.6
 */
U_CAPI UText * U_EXPORT2 uregex_appendTailUText(URegularExpression    * regexp,
    UText * dest,
    UErrorCode * status);
 ...
 * @stable ICU 4.6
 */
U_CAPI int32_t U_EXPORT2 uregex_splitUText(URegularExpression    * regexp,
    UText * destFields[],
    int32_t destFieldsCapacity,
    UErrorCode * status);
 ...
 * @stable ICU 4.0
 */
U_CAPI void U_EXPORT2 uregex_setTimeLimit(URegularExpression      * regexp,
    int32_t limit,
    UErrorCode              * status);
 ...
 * @stable ICU 4.0
 */
U_CAPI int32_t U_EXPORT2 uregex_getTimeLimit(const URegularExpression      * regexp,
    UErrorCode              * status);
 ...
 * @stable ICU 4.0
 */
U_CAPI void U_EXPORT2 uregex_setStackLimit(URegularExpression      * regexp,
    int32_t limit,
    UErrorCode              * status);
 ...
 * @stable ICU 4.0
 */
U_CAPI int32_t U_EXPORT2 uregex_getStackLimit(const URegularExpression      * regexp,
    UErrorCode              * status);
 ...
 */
U_CDECL_BEGIN
typedef bool U_CALLCONV URegexMatchCallback (
	const void * context,
	int32_t steps);
U_CDECL_END
 ...
 * @stable ICU 4.0
 */
U_CAPI void U_EXPORT2 uregex_setMatchCallback(URegularExpression      * regexp,
 ...
 * @stable ICU 4.0
 */
U_CAPI void U_EXPORT2 uregex_getMatchCallback(const URegularExpression    * regexp, URegexMatchCallback        ** callback, const void ** context, UErrorCode * status);
 ...
 */
U_CDECL_BEGIN
typedef bool U_CALLCONV URegexFindProgressCallback(const void * context, int64_t matchIndex);
U_CDECL_END
 ...
 * @stable ICU 4.6
 */
U_CAPI void U_EXPORT2 uregex_setFindProgressCallback(URegularExpression              * regexp, URegexFindProgressCallback      * callback, const void * context, UErrorCode * status);
 ...
 * @stable ICU 4.6
 */
U_CAPI void U_EXPORT2 uregex_getFindProgressCallback(const URegularExpression          * regexp,
