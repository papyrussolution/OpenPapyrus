...
public:
	 ...
	 * @deprecated ICU 56 Use Normalizer2 instead.
	 */
	static inline bool isNormalized(const UnicodeString & src, UNormalizationMode mode, UErrorCode & errorCode);
	 ...
	 * @deprecated ICU 56 Use Normalizer2 instead.
	 */
	static bool isNormalized(const UnicodeString & src, UNormalizationMode mode, int32_t options, UErrorCode & errorCode);
	 ...
	 * @stable ICU 2.2
	 */
	static inline int32_t compare(const UnicodeString & s1, const UnicodeString & s2,
	    uint32_t options,
	    UErrorCode & errorCode);
...
inline bool Normalizer::isNormalized(const UnicodeString & source, UNormalizationMode mode, UErrorCode & status) 
{
