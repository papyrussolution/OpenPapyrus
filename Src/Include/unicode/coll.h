...
public:
	 ...
	 * @stable ICU 2.0
	 */
	bool greater(const UnicodeString & source, const UnicodeString & target)
	const;
	 ...
	 * @stable ICU 2.0
	 */
	bool greaterOrEqual(const UnicodeString & source,
	    const UnicodeString & target) const;
	 ...
	 * @stable ICU 2.0
	 */
	bool equals(const UnicodeString & source, const UnicodeString & target) const;
	 ...
	 * @param status error code. If error code is set, the return value is undefined. Errors set by this function
	 *are: <br>
	 ...
	 * and it must not be beyond the last of those groups.
	 * See setMaxVariable().
	 * @param varTop a UnicodeString size 1 or more (if contraction) of char16_ts to which the variable top should
	 *be set
	 * @param status error code. If error code is set, the return value is undefined. Errors set by this function
	 *are: <br>
	 *    U_CE_NOT_FOUND_ERROR if more than one character was passed and there is no such contraction<br>
