...
public:
	 ...
	 * @stable ICU 2.0
	 */
	UnicodeString getNextString(const char ** key,
	    UErrorCode & status);
	 ...
	 * @stable ICU 2.0
	 */
	ResourceBundle get(int32_t index,
	 ...
	 * @stable ICU 2.0
	 */
	UnicodeString getStringEx(int32_t index,
	    UErrorCode & status) const;
	 ...
	 * @stable ICU 2.0
	 */
	UnicodeString getStringEx(const char * key,
	    UErrorCode & status) const;
