 ...
 * @stable ICU 2.8
 */
U_CAPI void U_EXPORT2 utrace_setLevel(int32_t traceLevel);
 ...
 * @stable ICU 2.8
 */
U_CAPI int32_t U_EXPORT2 utrace_getLevel();
 ...
 *  @stable ICU 2.8
 */
U_CAPI int32_t U_EXPORT2 utrace_vformat(char * outBuf, int32_t capacity,
