...
// 04/03/97    aliu        Rewrote parsing and formatting completely, and cleaned up and debugged.  Actually works now.
// 04/17/97    aliu        Changed DigitCount to int per code review.
// 07/10/97    helena      Made ParsePosition a class and get rid of the function hiding problems.
...
public:
	 ...
	 * @stable ICU 53
	 */
	void setGroupingUsed(bool newValue) U_OVERRIDE;
	/**
	 ...
	 * @stable ICU 53
	 */
	void setParseIntegerOnly(bool value) U_OVERRIDE;
	/**
	 ...
	 * @stable ICU 4.8
	 */
	void setLenient(bool enable) U_OVERRIDE;
	/**
	 * Create a DecimalFormat from the given pattern and symbols.
	 * Use this constructor when you need to completely customize the
	 * behavior of the format.
	 ...
	 * @stable ICU 64
	 */
	void setSignAlwaysShown(bool value);
	 ...
	 * @stable ICU 2.0
	 */
	virtual bool isScientificNotation(void) const;
	 ...
	 * @stable ICU 2.0
	 */
	virtual void setScientificNotation(bool useScientific);
	 ...
	 * @stable ICU 2.0
	 */
	virtual bool isExponentSignAlwaysShown(void) const;
	 ...
	 * @stable ICU 2.0
	 */
	virtual void setExponentSignAlwaysShown(bool expSignAlways);
	 ...
	 * @stable ICU 54
	 */
	bool isDecimalPatternMatchRequired(void) const;
	 ...
	 * @stable ICU 54
	 */
	virtual void setDecimalPatternMatchRequired(bool newValue);
	 ...
	 * @stable ICU 64
	 */
	void setParseNoExponent(bool value);
	 ...
	 * @stable ICU 64
	 */
	bool isParseCaseSensitive() const;
	 ...
	 * @stable ICU 64
	 */
	void setParseCaseSensitive(bool value);
	 ...
	 * @stable ICU 64
	 */
	bool isFormatFailIfMoreThanMaxDigits() const;
	 ...
	 * @stable ICU 64
	 */
	void setFormatFailIfMoreThanMaxDigits(bool value);
...
private:
	 ...
	 */
	void setPropertiesFromPattern(const UnicodeString & pattern, int32_t ignoreRounding, UErrorCode & status);
	...
	static void fieldPositionHelper(const number::impl::UFormattedNumberData& formatted, FieldPosition& fieldPosition, int32_t offset, UErrorCode & status);
	static void fieldPositionIteratorHelper(const number::impl::UFormattedNumberData& formatted, FieldPositionIterator* fpi, int32_t offset, UErrorCode & status);
