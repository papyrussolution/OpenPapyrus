...
typedef enum UProperty {
	...
	/** Binary property Default_Ignorable_Code_Point (new in Unicode 3.2).
	    ...
	    <2060..206F, FFF0..FFFB, E0000..E0FFF>+Other_Default_Ignorable_Code_Point+(Cf+Cc+Cs-White_Space) @stable ICU
	       2.1 */
 ...
 * @stable ICU 63
 */
U_CAPI const USet * U_EXPORT2 u_getBinaryPropertySet(UProperty property, UErrorCode * pErrorCode);
 ...
 * @stable ICU 2.1
 */
U_CAPI bool U_EXPORT2 u_isULowercase(UChar32 c);
 ...
 * @stable ICU 2.1
 */
U_CAPI bool U_EXPORT2 u_isUUppercase(UChar32 c);
 ...
 * @stable ICU 2.1
 */
U_CAPI bool U_EXPORT2 u_isUWhiteSpace(UChar32 c);
 ...
 * bool b=(bool)u_getIntPropertyValue(c, UCHAR_IDEOGRAPHIC);
 *
 * @param c Code point to test.
 ...
 * @stable ICU 63
 */
U_CAPI const UCPMap * U_EXPORT2 u_getIntPropertyMap(UProperty property, UErrorCode * pErrorCode);
 ...
 * @stable ICU 2.6
 */
U_CAPI bool U_EXPORT2 u_isgraph(UChar32 c);
 ...
 * @stable ICU 2.6
 */
U_CAPI bool U_EXPORT2 u_isblank(UChar32 c);
 ...
 * @stable ICU 2.0
 */
U_CAPI bool U_EXPORT2 u_isprint(UChar32 c);
 ...
 * @stable ICU 2.0
 */
U_CAPI bool U_EXPORT2 u_isMirrored(UChar32 c);
 ...
 * @stable ICU 1.7
 */
typedef bool U_CALLCONV UEnumCharNamesFn (void * context,
    UChar32 code,
