...
public:
	 ...
	 * @stable ICU 3.8
	 */
	virtual bool isEquivalentTo(const TimeZoneRule& other) const;
	 ...
	 * @stable ICU 3.8
	 */
	virtual bool getFirstStart(int32_t prevRawOffset, int32_t prevDSTSavings, UDate& result) const = 0;
	 ...
	 * @stable ICU 3.8
	 */
	virtual bool getFinalStart(int32_t prevRawOffset, int32_t prevDSTSavings, UDate& result) const = 0;
	...
	virtual bool getNextStart(UDate base, int32_t prevRawOffset, int32_t prevDSTSavings,
	    bool inclusive, UDate& result) const = 0;
...
public:
	 ...
	 * @stable ICU 3.8
	 */
	bool getStartTimeAt(int32_t index, UDate& result) const;
...
private:
	...
	bool initStartTimes(const UDate source[], int32_t size, UErrorCode& ec);
