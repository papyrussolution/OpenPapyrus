 ...
 *    07/20/98    stephen        JDK 1.2 sync up. Added scientific support. Changed naming conventions to match C++ guidelines Deprecated Java style constants (eg, INTEGER_FIELD)
 */
#ifndef NUMFMT_H
#define NUMFMT_H
...
// Can't use #ifndef U_HIDE_INTERNAL_API because these are virtual methods
	 ...
	 * @stable ICU 2.0
	 */
	bool isParseIntegerOnly(void) const;
	 ...
	 * @stable ICU 4.8
	 */
	virtual bool isLenient(void) const;
	 ...
	 * @stable ICU 2.0
	 */
	bool isGroupingUsed(void) const;
...
private:
	...
	static bool isStyleSupported(UNumberFormatStyle style);
...
private:
	bool fParseIntegerOnly;
	bool fLenient;  // true => lenient parse is enabled
...
public:
	 ...
	 * @stable ICU 2.6
	 */
	SimpleNumberFormatFactory(const Locale& locale, bool visible = true);
	 ...
	 * @stable ICU 2.6
	 */
	virtual bool visible(void) const override;
...
inline bool NumberFormat::isParseIntegerOnly() const { return fParseIntegerOnly; }
inline bool NumberFormat::isLenient() const { return fLenient; }
