...
public:
	 ...
	 * @stable ICU 4.6
	 */
	virtual bool getDecomposition(UChar32 c, UnicodeString & decomposition) const = 0;
	 ...
	 * @stable ICU 49
	 */
	virtual bool getRawDecomposition(UChar32 c, UnicodeString & decomposition) const;
	 ...
	 * @stable ICU 49
	 */
	virtual uint8 getCombiningClass(UChar32 c) const;
	 ...
	 * @stable ICU 4.4
	 */
	virtual bool isNormalized(const UnicodeString & s, UErrorCode & errorCode) const = 0;
	/**
	 ...
	 * @stable ICU 60
	 */
	virtual bool isNormalizedUTF8(StringPiece s, UErrorCode & errorCode) const;
	 ...
	 * @stable ICU 4.4
	 */
	virtual bool hasBoundaryBefore(UChar32 c) const = 0;
	 ...
	 * @stable ICU 4.4
	 */
	virtual bool hasBoundaryAfter(UChar32 c) const = 0;
	 ...
	 * @stable ICU 4.4
	 */
	virtual bool isInert(UChar32 c) const = 0;
};
...
public:
	 ...
	 * @stable ICU 4.6
	 */
	virtual bool getDecomposition(UChar32 c, UnicodeString & decomposition) const U_OVERRIDE;
	 ...
	 * @stable ICU 49
	 */
	virtual bool getRawDecomposition(UChar32 c, UnicodeString & decomposition) const U_OVERRIDE;
	 ...
	 * @stable ICU 49
	 */
	virtual uint8 getCombiningClass(UChar32 c) const U_OVERRIDE;
	 ...
	 * @stable ICU 4.4
	 */
	virtual bool isNormalized(const UnicodeString & s, UErrorCode & errorCode) const U_OVERRIDE;
	/**
	 * Tests if the UTF-8 string is normalized.
	 * Internally, in cases where the quickCheck() method would return "maybe"
	 * (which is only possible for the two COMPOSE modes) this method
	 ...
	 * @stable ICU 60
	 */
	virtual bool isNormalizedUTF8(StringPiece s, UErrorCode & errorCode) const U_OVERRIDE;
	/**
	 * Tests if the string is normalized.
	 * For details see the Normalizer2 base class documentation.
	 * @param s input string
	 ...
	 * @stable ICU 4.4
	 */
	virtual bool hasBoundaryBefore(UChar32 c) const U_OVERRIDE;
	 ...
	 * @stable ICU 4.4
	 */
	virtual bool hasBoundaryAfter(UChar32 c) const U_OVERRIDE;
	 ...
	 * @stable ICU 4.4
	 */
	virtual bool isInert(UChar32 c) const U_OVERRIDE;
private:
	...
	void normalizeUTF8(uint32_t options, const char * src, int32_t length,
