...
public:
	 ...
	 * @stable ICU 53
	 */
	virtual bool isCalendarLenient(void) const;
	 ...
	 * @stable ICU 53
	 */
	virtual void setCalendarLenient(bool lenient);
	 ...
	 * To parse to a calendar, use {@link #parse(const UnicodeString &, Calendar& cal, ParsePosition&) const
	 *parse(const UnicodeString &, Calendar& cal, ParsePosition&)}
	 ...
	 * @stable ICU 53
	 */
	virtual bool U_EXPORT2 getBooleanAttribute(UDateFormatBooleanAttribute attr, UErrorCode & status) const;
protected:
	/**
