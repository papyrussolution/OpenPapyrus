...
public:
	 ...
	 * @stable ICU 2.0
	 */
	UnicodeString & getDisplayName(bool inDaylight, EDisplayType style, UnicodeString & result) const;
	 ...
	 * @stable ICU 2.0
	 */
	UnicodeString & getDisplayName(bool inDaylight, EDisplayType style, const Locale& locale, UnicodeString & result) const;
	 ...
	 * @stable ICU 2.0
	 */
	virtual bool useDaylightTime(void) const = 0;
	 ...
	 * @stable ICU 2.0
	 */
	virtual bool hasSameRules(const TimeZone& other) const;
...
private:
	 ...
	 */
	static bool parseCustomID(const UnicodeString & id, int32_t& sign, int32_t& hour, int32_t& minute, int32_t& second);
	/**
	 ...
	 */
	static UnicodeString & formatCustomID(int32_t hour, int32_t min, int32_t sec, bool negative, UnicodeString & id);
