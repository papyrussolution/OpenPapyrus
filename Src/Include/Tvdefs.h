...
#define cmMouseHoverCtrl     1019   // @v12.7.7 evCommand Когда курсор мыши задерживается на определенное время над управляющим элементом окна (диалога),
	// то владельцу управляющего элемента посылается это сообщение. В infoPtr содержится указатель на управляющий элемент.
//
