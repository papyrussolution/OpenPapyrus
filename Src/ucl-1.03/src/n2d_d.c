...
UCL_PUBLIC(int) ucl_nrv2d_decompress_8(const ucl_bytep src, ucl_uint  src_len,
...
UCL_PUBLIC(int) ucl_nrv2d_decompress_le16(const ucl_bytep src, 
	ucl_uint src_len, ucl_bytep dst, ucl_uintp dst_len, ucl_voidp wrkmem )
{
...
UCL_PUBLIC(int) ucl_nrv2d_decompress_le32(const ucl_bytep src, 
	ucl_uint src_len, ucl_bytep dst, ucl_uintp dst_len, ucl_voidp wrkmem)
{
    unsigned bc = 0;
