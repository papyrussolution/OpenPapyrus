...
//
//
int Rc2Data::Init(const char * pInputFileName, const char * pRcName, const char * pHdrName, const char * pEmbedRcName)
{
...
int Rc2Data::AddSymb(int kind, const char * pSymb, long * pID, SString & rErrMsg)
{
	long   id = pID ? *pID : 0;
...
int Rc2Data::AddReportStub(const ReportStubDefinition * pRep, SString & rErrMsg)
{
...
int Rc2Data::GenerateRecordStruct(const SdRecord * pRec)
{
	SString type_text;
	SdbField fld;
...
int Rc2Data::GenerateSymbDefinitions()
{
	fprintf(pHdr, "\n");
...
int Rc2Data::GenerateJobDefinitions()
{
...
int Rc2Data::GenerateObjDefinitions()
{
...
int Rc2Data::GenerateRecDefinitions()
{
	SString name;
...
int Rc2Data::GenerateReportStubDefinitions()
{
	SString name;
...
int Rc2Data::GenerateViewDefinitions()
{
...
int Rc2Data::GenerateCtrlMenuDefinitions()
{
	//
...
int Rc2Data::GenerateBitmapDefinitions()
{
...
int Rc2Data::GenerateRFileDefinitions()
{
