...
int DlContext::AddConst(const void * pData, size_t dataSize, CtmExprConst * pResult)
	{ return AddConst("raw", pData, dataSize, pResult); }
int DlContext::AddConst(const char * pData, CtmExprConst * pResult)
	{ return AddConst("string", pData, strlen(pData)+1, pResult); }
int DlContext::AddConst(const SString & rData, CtmExprConst * pResult)
	{ return AddConst("string", (const char *)rData, rData.Len()+1, pResult); }
int DlContext::AddConst(uint32 data, CtmExprConst * pResult)
	{ return AddConst("uint32", &data, sizeof(data), pResult); }
int DlContext::AddConst(int32 data, CtmExprConst * pResult)
	{ return AddConst("int32", &data, sizeof(data), pResult); }
int DlContext::AddConst(int8 data, CtmExprConst * pResult)
	{ return AddConst("int8", &data, sizeof(data), pResult); }
int DlContext::AddConst(double data, CtmExprConst * pResult)
	{ return AddConst("double", &data, sizeof(data), pResult); }
int DlContext::AddConst(LDATE data, CtmExprConst * pResult)
	{ return AddConst("date", &data, sizeof(data), pResult); }
int DlContext::AddConst(LTIME data, CtmExprConst * pResult)
	{ return AddConst("time", &data, sizeof(data), pResult); }
