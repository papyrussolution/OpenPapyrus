...
SLTEST_R(SRegExp)
{
	...
	static const Entry entry_list[] = {
		{ "240", "240", 1}, // @v12.5.12
		{ "240(.*)", "2401919", 1}, // @v12.5.12
		{ "240(.*?)00", "24019190012345", 1}, // @v12.5.12
		{ "240(.*?)00(.*)11", "24019190001461008040149227611", 1}, // @v12.5.12
		{ "^240(.*?)00(.*)11(.*)10(.*)37(.*)$", "2402359717001461008040149227611126021510PL12600444374", 1}, // @v12.5.12
		{ "^240(.*?)00(\\d{18})11(\\d{6})10(.*?)37(\\d{1,8})$", "2402359717001461008040149227611126021510PL12600444374", 1}, // @v12.5.12
		{ "{.*} ", "{abc{efg}} ", 1 },
